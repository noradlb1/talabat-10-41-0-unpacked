...
public class FontRequestEmojiCompatConfig extends EmojiCompat.Config {
    ...
    public static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public EmojiCompat.MetadataRepoLoaderCallback f35906a;
        @NonNull
        ...
        public void a() {
            /*
                ...
                monitor-enter(r0)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r1 = r7.f35906a     // Catch:{ all -> 0x00a7 }
            ...
            L_0x0034:
                ...
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r2 = r7.f35906a     // Catch:{ all -> 0x0068 }
            ...
            L_0x0094:
                ...
                monitor-enter(r1)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r2 = r7.f35906a     // Catch:{ all -> 0x00a4 }
            ...
            L_0x00a7:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.emoji2.text.FontRequestEmojiCompatConfig.FontRequestMetadataLoader.a():void");
        }
            ...
            synchronized (this.mLock) {
                if (this.f35906a != null) {
                    if (this.mExecutor == null) {
                        ThreadPoolExecutor c11 = ConcurrencyHelpers.c("emojiCompat");
                        this.mMyThreadPoolExecutor = c11;
                        this.mExecutor = c11;
                    }
        ...
        public void load(@NonNull EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback) {
            ...
            synchronized (this.mLock) {
                this.f35906a = metadataRepoLoaderCallback;
            }
            b();
        }
