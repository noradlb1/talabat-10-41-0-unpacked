...
public final class TrustedWebActivityServiceConnection {
    ...
    public static class ActiveNotificationsArgs {
        ...
        public static ActiveNotificationsArgs fromBundle(Bundle bundle) {
            TrustedWebActivityServiceConnection.a(bundle, TrustedWebActivityServiceConnection.KEY_ACTIVE_NOTIFICATIONS);
    ...
    public static class CancelNotificationArgs {
        ...
        public CancelNotificationArgs(String str, int i11) {
    ...
    public static class NotifyNotificationArgs {
        ...
        public NotifyNotificationArgs(String str, int i11, Notification notification2, String str2) {
            this.platformTag = str;
            this.platformId = i11;
    ...
    public static class ResultArgs {
        ...
        public static ResultArgs fromBundle(Bundle bundle) {
            TrustedWebActivityServiceConnection.a(bundle, TrustedWebActivityServiceConnection.KEY_NOTIFICATION_SUCCESS);
    ...
    public void cancel(@NonNull String str, int i11) throws RemoteException {
        this.mService.cancelNotification(new CancelNotificationArgs(str, i11).toBundle());
    }
    ...
    public boolean notify(@NonNull String str, int i11, @NonNull Notification notification, @NonNull String str2) throws RemoteException {
        return ResultArgs.fromBundle(this.mService.notifyNotificationWithChannel(new NotifyNotificationArgs(str, i11, notification, str2).toBundle())).success;
    }
