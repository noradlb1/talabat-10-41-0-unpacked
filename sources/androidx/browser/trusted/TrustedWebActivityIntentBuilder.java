...
public class TrustedWebActivityIntentBuilder {
    ...
    @NonNull
    public TrustedWebActivityIntentBuilder setColorScheme(int i11) {
        this.mIntentBuilder.setColorScheme(i11);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setColorSchemeParams(int i11, @NonNull CustomTabColorSchemeParams customTabColorSchemeParams) {
        this.mIntentBuilder.setColorSchemeParams(i11, customTabColorSchemeParams);
        return this;
    }
    ...
    @NonNull
    public TrustedWebActivityIntentBuilder setNavigationBarColor(@ColorInt int i11) {
        this.mIntentBuilder.setNavigationBarColor(i11);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setNavigationBarDividerColor(@ColorInt int i11) {
        this.mIntentBuilder.setNavigationBarDividerColor(i11);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setScreenOrientation(int i11) {
    ...
    @NonNull
    public TrustedWebActivityIntentBuilder setToolbarColor(@ColorInt int i11) {
        this.mIntentBuilder.setToolbarColor(i11);
        return this;
    }
}
