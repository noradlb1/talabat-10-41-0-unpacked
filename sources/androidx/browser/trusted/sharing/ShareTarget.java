...
public final class ShareTarget {
    ...
    public static final class FileFormField {
        ...
        public Bundle b() {
            ...
            bundle.putString(KEY_NAME, this.f1013name);
    ...
    public static class Params {
        ...
        public static Params a(@Nullable Bundle bundle) {
            ...
            if (parcelableArrayList != null) {
                ...
                for (Bundle a11 : parcelableArrayList) {
                    arrayList.add(FileFormField.a(a11));
                }
            }
        ...
        public Bundle b() {
            ...
            if (this.files != null) {
                ...
                for (FileFormField b11 : this.files) {
                    arrayList.add(b11.b());
                }
    ...
    public static ShareTarget fromBundle(@NonNull Bundle bundle) {
        ...
        Params a11 = Params.a(bundle.getBundle(KEY_PARAMS));
    ...
    public Bundle toBundle() {
        ...
        bundle.putBundle(KEY_PARAMS, this.params.b());
        return bundle;
    }
}
