...
public class TrustedWebUtils {
    ...
    public static void launchBrowserSiteSettings(@NonNull Context context, @NonNull CustomTabsSession customTabsSession, @NonNull Uri uri) {
        ...
        BundleCompat.putBinder(bundle, CustomTabsIntent.EXTRA_SESSION, customTabsSession.a());
        intent.putExtras(bundle);
        PendingIntent c11 = customTabsSession.c();
        if (c11 != null) {
            intent.putExtra(CustomTabsIntent.EXTRA_SESSION_ID, c11);
        }
