...
public final class CustomTabsSession {
    ...
    public boolean receiveFile(@NonNull Uri uri, int i11, @Nullable Bundle bundle) {
        try {
            return this.mService.receiveFile(this.mCallback, uri, i11, createBundleWithId(bundle));
        } catch (RemoteException unused) {
            return false;
        }
    }
    ...
    @Deprecated
    public boolean setToolbarItem(int i11, @NonNull Bitmap bitmap, @NonNull String str) {
        Bundle bundle = new Bundle();
    ...
    public boolean validateRelationship(int i11, @NonNull Uri uri, @Nullable Bundle bundle) {
        if (i11 >= 1 && i11 <= 2) {
            try {
                return this.mService.validateRelationship(this.mCallback, i11, uri, createBundleWithId(bundle));
            } catch (RemoteException unused) {
            }
        }
        return false;
