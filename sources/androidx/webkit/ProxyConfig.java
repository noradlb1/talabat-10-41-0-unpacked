...
public final class ProxyConfig {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setReverseBypassEnabled(boolean z11) {
            this.mReverseBypass = z11;
            return this;
        }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public ProxyConfig(@NonNull List<ProxyRule> list, @NonNull List<String> list2, boolean z11) {
