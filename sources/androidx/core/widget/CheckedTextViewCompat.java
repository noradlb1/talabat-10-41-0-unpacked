        ...
        public static Drawable getCheckMarkDrawable(@NonNull CheckedTextView checkedTextView) {
            if (!sResolved) {
                try {
                    ...
                    Log.i(CheckedTextViewCompat.TAG, "Failed to retrieve mCheckMarkDrawable field", e11);
                }
                sResolved = true;
            }
            ...
            if (field != null) {
                try {
                    ...
                    Log.i(CheckedTextViewCompat.TAG, "Failed to get check mark drawable via reflection", e12);
