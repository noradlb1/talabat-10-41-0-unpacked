...
public final class BitmapCompat {
    ...
    public static class Api27Impl {
        ...
        @DoNotInline
        public static Bitmap b(int i11, int i12, Bitmap bitmap, boolean z11) {
            Bitmap.Config config = bitmap.getConfig();
            ColorSpace a11 = bitmap.getColorSpace();
            ColorSpace a12 = ColorSpace.get(ColorSpace.Named.LINEAR_EXTENDED_SRGB);
            if (z11 && !bitmap.getColorSpace().equals(a12)) {
            ...
            return Bitmap.createBitmap(i11, i12, config, bitmap.hasAlpha(), a11);
        }

        @DoNotInline
        public static boolean c(Bitmap bitmap) {
            ColorSpace a11 = ColorSpace.get(ColorSpace.Named.LINEAR_EXTENDED_SRGB);
            if (bitmap.getConfig() != Bitmap.Config.RGBA_F16 || !bitmap.getColorSpace().equals(a11)) {
                return false;
            }
            return true;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:109:0x01a6, code lost:
        if (androidx.core.graphics.BitmapCompat.Api27Impl.c(r11) == false) goto L_0x01b8;
     */
