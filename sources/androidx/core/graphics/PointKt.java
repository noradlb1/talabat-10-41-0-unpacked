...
public final class PointKt {
    ...
    @NotNull
    public static final Point minus(@NotNull Point point, int i11) {
        Intrinsics.checkNotNullParameter(point, "<this>");
    ...
    @NotNull
    public static final Point plus(@NotNull Point point, int i11) {
        Intrinsics.checkNotNullParameter(point, "<this>");
        Point point2 = new Point(point.x, point.y);
    ...
    @NotNull
    public static final PointF minus(@NotNull PointF pointF, float f11) {
        Intrinsics.checkNotNullParameter(pointF, "<this>");
    ...
    @NotNull
    public static final PointF plus(@NotNull PointF pointF, float f11) {
        Intrinsics.checkNotNullParameter(pointF, "<this>");
        PointF pointF2 = new PointF(pointF.x, pointF.y);
