...
public final class RectKt {
    ...
    @NotNull
    public static final Rect times(@NotNull Rect rect, int i11) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
    ...
    @NotNull
    public static final Rect plus(@NotNull Rect rect, int i11) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        Rect rect2 = new Rect(rect);
    ...
    @NotNull
    public static final RectF times(@NotNull RectF rectF, float f11) {
        Intrinsics.checkNotNullParameter(rectF, "<this>");
    ...
    @NotNull
    public static final RectF plus(@NotNull RectF rectF, float f11) {
        Intrinsics.checkNotNullParameter(rectF, "<this>");
        RectF rectF2 = new RectF(rectF);
    ...
    @NotNull
    public static final Rect minus(@NotNull Rect rect, int i11) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        Rect rect2 = new Rect(rect);
        int i12 = -i11;
    ...
    @NotNull
    public static final RectF times(@NotNull RectF rectF, int i11) {
        Intrinsics.checkNotNullParameter(rectF, "<this>");
        float f11 = (float) i11;
        RectF rectF2 = new RectF(rectF);
        rectF2.top *= f11;
    ...
    @NotNull
    public static final RectF minus(@NotNull RectF rectF, float f11) {
        Intrinsics.checkNotNullParameter(rectF, "<this>");
        RectF rectF2 = new RectF(rectF);
        float f12 = -f11;
