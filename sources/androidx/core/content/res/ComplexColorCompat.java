...
public final class ComplexColorCompat {
    ...
    public static ComplexColorCompat a(@ColorInt int i11) {
        return new ComplexColorCompat((Shader) null, (ColorStateList) null, i11);
    }

    public static ComplexColorCompat b(@NonNull ColorStateList colorStateList) {
        return new ComplexColorCompat((Shader) null, colorStateList, colorStateList.getDefaultColor());
    }

    public static ComplexColorCompat c(@NonNull Shader shader) {
    ...
    private static androidx.core.content.res.ComplexColorCompat createFromXml(@androidx.annotation.NonNull android.content.res.Resources r4, @androidx.annotation.ColorRes int r5, @androidx.annotation.Nullable android.content.res.Resources.Theme r6) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        ...
        L_0x0013:
            ...
            androidx.core.content.res.ComplexColorCompat r4 = b(r4)
            return r4
        L_0x0035:
            ...
            throw r4
        L_0x0053:
            android.graphics.Shader r4 = androidx.core.content.res.GradientColorInflaterCompat.a(r4, r5, r0, r6)
