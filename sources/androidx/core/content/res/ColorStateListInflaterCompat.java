...
public final class ColorStateListInflaterCompat {
    ...
    public static ColorStateList createFromXmlInner(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        throw new XmlPullParserException(xmlPullParser.getPositionDescription() + ": invalid color state list tag " + name2);
    }
    ...
    private static int modulateColorAlpha(@ColorInt int i11, @FloatRange(from = 0.0d, to = 1.0d) float f11, @FloatRange(from = 0.0d, to = 100.0d) float f12) {
        ...
        int clamp = MathUtils.clamp((int) ((((float) Color.alpha(i11)) * f11) + 0.5f), 0, 255);
        if (z11) {
            CamColor b11 = CamColor.b(i11);
            i11 = CamColor.j(b11.g(), b11.f(), f12);
        }
