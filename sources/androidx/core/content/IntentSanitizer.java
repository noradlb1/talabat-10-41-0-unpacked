...
public class IntentSanitizer {
    ...
    public static class Api16Impl {
        ...
        public static class Api31Impl {
            ...
            public static void a(int i11, ClipData.Item item, Consumer<String> consumer) {
                if (item.getHtmlText() != null || item.getIntent() != null || j.a(item) != null) {
        ...
        public static void a(@androidx.annotation.NonNull android.content.Intent r7, android.content.Intent r8, androidx.core.util.Predicate<android.content.ClipData> r9, boolean r10, androidx.core.util.Predicate<android.net.Uri> r11, androidx.core.util.Consumer<java.lang.String> r12) {
            /*
            ...
            L_0x0017:
                ...
                androidx.core.content.IntentSanitizer.Api16Impl.Api31Impl.a(r0, r2, r12)
                goto L_0x002e
            L_0x002b:
            ...
            L_0x00de:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.content.IntentSanitizer.Api16Impl.a(android.content.Intent, android.content.Intent, androidx.core.util.Predicate, boolean, androidx.core.util.Predicate, androidx.core.util.Consumer):void");
        }
    ...
    public static final class Builder {
        ...
        private Predicate<String> mAllowedActions = new x();
        private Predicate<String> mAllowedCategories = new a0();
        private Predicate<ClipData> mAllowedClipData = new e0();
        private Predicate<Uri> mAllowedClipDataUri = new d0();
        private Predicate<ComponentName> mAllowedComponents = new c0();
        private Predicate<Uri> mAllowedData = new y();
        private Map<String, Predicate<Object>> mAllowedExtras = new HashMap();
        private int mAllowedFlags;
        private Predicate<String> mAllowedPackages = new b0();
        private Predicate<String> mAllowedTypes = new z();
        ...
        public Builder allowAction(@NonNull String str) {
            ...
            allowAction((Predicate<String>) new o(str));
            return this;
        }
        ...
        public Builder allowCategory(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory((Predicate<String>) new o(str));
        }
        ...
        public Builder allowClipDataUriWithAuthority(@NonNull String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new n(str));
        }
        ...
        public Builder allowComponent(@NonNull ComponentName componentName) {
            ...
            return allowComponent((Predicate<ComponentName>) new v(componentName));
        }
        ...
        public Builder allowComponentWithPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            return allowComponent((Predicate<ComponentName>) new s(str));
        }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Class<?> cls) {
            return allowExtra(str, cls, new w());
        }

        @SuppressLint({"BuilderSetStyle"})
        @NonNull
        public Builder allowExtraOutput(@NonNull String str) {
            allowExtra("output", Uri.class, new u(str));
            return this;
        }
        ...
        public Builder allowExtraStreamUriWithAuthority(@NonNull String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new p(str));
            return this;
        }
        ...
        public Builder allowPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage((Predicate<String>) new o(str));
        }
        ...
        public Builder allowType(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowType((Predicate<String>) new o(str));
        }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull Class<T> cls, @NonNull Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, (Predicate<Object>) new r(cls, predicate));
        }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0012: CONSTRUCTOR  (r0v5 ? I:b1.m) =  call: b1.m.<init>():void type: CONSTRUCTOR in method: androidx.core.content.IntentSanitizer.Builder.allowExtra(java.lang.String, androidx.core.util.Predicate):androidx.core.content.IntentSanitizer$Builder, dex: classes.dex
        ...
        public Intent sanitize(@NonNull Intent intent, @NonNull Consumer<String> consumer) {
            ...
            Api16Impl.a(intent, intent2, this.mAllowedClipData, this.mAllowClipDataText, this.mAllowedClipDataUri, consumer);
            if (i12 >= 29) {
            ...
            if (this.mAllowSelector) {
                Api15Impl.b(intent2, Api15Impl.a(intent));
            } else if (Api15Impl.a(intent) != null) {
                consumer.accept("Selector is not allowed: " + Api15Impl.a(intent));
            }
        ...
        public Intent sanitizeByFiltering(@NonNull Intent intent) {
            return sanitize(intent, new h());
        }

        @NonNull
        public Intent sanitizeByThrowing(@NonNull Intent intent) {
            return sanitize(intent, new i());
        }
