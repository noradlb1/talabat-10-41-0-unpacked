...
public final class ContextKt {
    ...
    public static final void withStyledAttributes(@NotNull Context context, @Nullable AttributeSet attributeSet, @NotNull int[] iArr, @AttrRes int i11, @StyleRes int i12, @NotNull Function1<? super TypedArray, Unit> function1) {
        Intrinsics.checkNotNullParameter(context, "<this>");
    ...
    public static /* synthetic */ void withStyledAttributes$default(Context context, AttributeSet attributeSet, int[] iArr, int i11, int i12, Function1 function1, int i13, Object obj) {
        if ((i13 & 1) != 0) {
            attributeSet = null;
        }
        if ((i13 & 4) != 0) {
    ...
    public static final void withStyledAttributes(@NotNull Context context, @StyleRes int i11, @NotNull int[] iArr, @NotNull Function1<? super TypedArray, Unit> function1) {
        Intrinsics.checkNotNullParameter(context, "<this>");
        Intrinsics.checkNotNullParameter(iArr, UserAttributesCacheManager.USER_ATTRIBUTES_CACHE_KEY);
        Intrinsics.checkNotNullParameter(function1, "block");
