...
public final class HandlerKt {
    @NotNull
    public static final Runnable postAtTime(@NotNull Handler handler, long j11, @Nullable Object obj, @NotNull Function0<Unit> function0) {
    ...
    public static /* synthetic */ Runnable postAtTime$default(Handler handler, long j11, Object obj, Function0 function0, int i11, Object obj2) {
        if ((i11 & 2) != 0) {
            obj = null;
        }
        Intrinsics.checkNotNullParameter(handler, "<this>");
    ...
    @NotNull
    public static final Runnable postDelayed(@NotNull Handler handler, long j11, @Nullable Object obj, @NotNull Function0<Unit> function0) {
        Intrinsics.checkNotNullParameter(handler, "<this>");
        Intrinsics.checkNotNullParameter(function0, NativeProtocol.WEB_DIALOG_ACTION);
    ...
    public static /* synthetic */ Runnable postDelayed$default(Handler handler, long j11, Object obj, Function0 function0, int i11, Object obj2) {
        if ((i11 & 2) != 0) {
            obj = null;
        }
        Intrinsics.checkNotNullParameter(handler, "<this>");
