...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    public static class Api16Impl {
        ...
        @DoNotInline
        public static PendingIntent getActivities(Context context, int i11, Intent[] intentArr, int i12, Bundle bundle) {
    ...
    public PendingIntent getPendingIntent(int i11, int i12) {
        return getPendingIntent(i11, i12, (Bundle) null);
    }
    ...
    public PendingIntent getPendingIntent(int i11, int i12, @Nullable Bundle bundle) {
        if (!this.mIntents.isEmpty()) {
            ...
            return Api16Impl.getActivities(this.mSourceContext, i11, intentArr, i12, bundle);
        }
