...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f11231id, this.tag, this.notif);
        }

        @NonNull
        public String toString() {
            return "NotifyTask[" + "packageName:" + this.packageName + ", id:" + this.f11231id + ", tag:" + this.tag + "]";
        }
    }
    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        public static class ListenerRecord {
            ...
            INotificationSideChannel f11232service;
        ...
        private void ensureServiceUnbound(ListenerRecord listenerRecord) {
            ...
            listenerRecord.f11232service = null;
        }
        ...
        private void handleServiceConnected(ComponentName componentName, IBinder iBinder) {
            ListenerRecord listenerRecord = this.mRecordMap.get(componentName);
            if (listenerRecord != null) {
                listenerRecord.f11232service = INotificationSideChannel.Stub.asInterface(iBinder);
                listenerRecord.retryCount = 0;
                processListenerQueue(listenerRecord);
            }
        }
        ...
        private void processListenerQueue(ListenerRecord listenerRecord) {
            ...
            if (!listenerRecord.taskQueue.isEmpty()) {
                if (!ensureServiceBound(listenerRecord) || listenerRecord.f11232service == null) {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        peek.send(listenerRecord.f11232service);
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            if (!this.mHandler.hasMessages(3, listenerRecord.componentName)) {
                int i11 = listenerRecord.retryCount + 1;
                ...
                this.mHandler.sendMessageDelayed(this.mHandler.obtainMessage(3, listenerRecord.componentName), (long) i12);
            }
        }
    ...
    public NotificationChannelGroupCompat getNotificationChannelGroupCompat(@NonNull String str) {
        ...
        if (i11 >= 28) {
            ...
            return null;
        } else if (i11 < 26 || (notificationChannelGroup = getNotificationChannelGroup(str)) == null) {
            return null;
        } else {
    ...
    public void notify(int i11, @NonNull Notification notification) {
        notify((String) null, i11, notification);
    }
    ...
    public static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f11230id, this.tag);
            }
        }

        @NonNull
        public String toString() {
            return "CancelTask[" + "packageName:" + this.packageName + ", id:" + this.f11230id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
