...
public final class CursorKt {
    @Nullable
    public static final byte[] getBlobOrNull(@NotNull Cursor cursor, int i11) {
    ...
    @Nullable
    public static final Double getDoubleOrNull(@NotNull Cursor cursor, int i11) {
        Intrinsics.checkNotNullParameter(cursor, "<this>");
        if (cursor.isNull(i11)) {
            return null;
        }
    ...
    @Nullable
    public static final Float getFloatOrNull(@NotNull Cursor cursor, int i11) {
        Intrinsics.checkNotNullParameter(cursor, "<this>");
        if (cursor.isNull(i11)) {
            return null;
        }
    ...
    @Nullable
    public static final Integer getIntOrNull(@NotNull Cursor cursor, int i11) {
        Intrinsics.checkNotNullParameter(cursor, "<this>");
        if (cursor.isNull(i11)) {
            return null;
        }
    ...
    @Nullable
    public static final Long getLongOrNull(@NotNull Cursor cursor, int i11) {
        Intrinsics.checkNotNullParameter(cursor, "<this>");
        if (cursor.isNull(i11)) {
            return null;
        }
    ...
    @Nullable
    public static final Short getShortOrNull(@NotNull Cursor cursor, int i11) {
        Intrinsics.checkNotNullParameter(cursor, "<this>");
        if (cursor.isNull(i11)) {
            return null;
        }
    ...
    @Nullable
    public static final String getStringOrNull(@NotNull Cursor cursor, int i11) {
        Intrinsics.checkNotNullParameter(cursor, "<this>");
        if (cursor.isNull(i11)) {
            return null;
        }
