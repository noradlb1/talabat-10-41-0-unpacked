...
public final class InputConnectionCompat {
    ...
    public static class Api25Impl {
        ...
        @DoNotInline
        public static boolean a(InputConnection inputConnection, InputContentInfo inputContentInfo, int i11, Bundle bundle) {
    ...
    public static boolean b(@androidx.annotation.Nullable java.lang.String r7, @androidx.annotation.Nullable android.os.Bundle r8, @androidx.annotation.NonNull androidx.core.view.inputmethod.InputConnectionCompat.OnCommitContentListener r9) {
        /*
            r0 = 0
        ...
        L_0x0081:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.view.inputmethod.InputConnectionCompat.b(java.lang.String, android.os.Bundle, androidx.core.view.inputmethod.InputConnectionCompat$OnCommitContentListener):boolean");
    }
    ...
    public static boolean commitContent(@NonNull InputConnection inputConnection, @NonNull EditorInfo editorInfo, @NonNull InputContentInfoCompat inputContentInfoCompat, int i11, @Nullable Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return Api25Impl.a(inputConnection, (InputContentInfo) inputContentInfoCompat.unwrap(), i11, bundle);
        }
        int a11 = EditorInfoCompat.a(editorInfo);
        if (a11 != 2) {
            z11 = false;
            if (!(a11 == 3 || a11 == 4)) {
                return false;
