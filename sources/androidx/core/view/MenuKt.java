...
public final class MenuKt {
    public static final boolean contains(@NotNull Menu menu, @NotNull MenuItem menuItem) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            if (Intrinsics.areEqual((Object) menu.getItem(i11), (Object) menuItem)) {
                return true;
            }
        }
        return false;
    ...
    @NotNull
    public static final MenuItem get(@NotNull Menu menu, int i11) {
        Intrinsics.checkNotNullParameter(menu, "<this>");
        MenuItem item = menu.getItem(i11);
        Intrinsics.checkNotNullExpressionValue(item, "getItem(index)");
        return item;
    ...
    public static final void removeItemAt(@NotNull Menu menu, int i11) {
        Unit unit;
        Intrinsics.checkNotNullParameter(menu, "<this>");
        MenuItem item = menu.getItem(i11);
        if (item != null) {
