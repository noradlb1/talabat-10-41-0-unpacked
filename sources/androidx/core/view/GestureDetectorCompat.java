...
public final class GestureDetectorCompat {
    ...
    public static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        public final GestureDetector.OnGestureListener f11463a;

        /* renamed from: b  reason: collision with root package name */
        public GestureDetector.OnDoubleTapListener f11464b;
        ...
        public class GestureHandler extends Handler {
            ...
            /* renamed from: a  reason: collision with root package name */
            public final /* synthetic */ GestureDetectorCompatImplBase f11468a;

            public void handleMessage(Message message) {
                int i11 = message.what;
                if (i11 == 1) {
                    GestureDetectorCompatImplBase gestureDetectorCompatImplBase = this.f11468a;
                    gestureDetectorCompatImplBase.f11463a.onShowPress(gestureDetectorCompatImplBase.f11467e);
                } else if (i11 == 2) {
                    this.f11468a.a();
                } else if (i11 == 3) {
                    GestureDetectorCompatImplBase gestureDetectorCompatImplBase2 = this.f11468a;
                    GestureDetector.OnDoubleTapListener onDoubleTapListener = gestureDetectorCompatImplBase2.f11464b;
                    if (onDoubleTapListener == null) {
                        return;
                    }
                    if (!gestureDetectorCompatImplBase2.f11465c) {
                        onDoubleTapListener.onSingleTapConfirmed(gestureDetectorCompatImplBase2.f11467e);
                    } else {
                        gestureDetectorCompatImplBase2.f11466d = true;
                    }
                } else {
        ...
        private boolean isConsideredDoubleTap(MotionEvent motionEvent, MotionEvent motionEvent2, MotionEvent motionEvent3) {
            ...
            if ((x11 * x11) + (y11 * y11) < this.mDoubleTapSlopSquare) {
                return true;
            }
            return false;
        }
        ...
        public void a() {
            ...
            this.f11463a.onLongPress(this.f11467e);
        }
        ...
        public boolean onTouchEvent(android.view.MotionEvent r13) {
            ...
            L_0x00be:
                ...
                android.view.GestureDetector$OnDoubleTapListener r0 = r12.f11464b
            ...
            L_0x00d1:
                ...
                android.view.GestureDetector$OnGestureListener r7 = r12.f11463a
                android.view.MotionEvent r8 = r12.f11467e
            ...
            L_0x011f:
                android.view.GestureDetector$OnGestureListener r2 = r12.f11463a
                android.view.MotionEvent r3 = r12.f11467e
            ...
            L_0x012d:
                ...
                android.view.GestureDetector$OnDoubleTapListener r1 = r12.f11464b
            ...
            L_0x014b:
                ...
                android.view.GestureDetector$OnGestureListener r1 = r12.f11463a
                boolean r1 = r1.onSingleTapUp(r13)
                boolean r5 = r12.f11466d
                if (r5 == 0) goto L_0x0160
                android.view.GestureDetector$OnDoubleTapListener r5 = r12.f11464b
                if (r5 == 0) goto L_0x0160
            ...
            L_0x018d:
                ...
                goto L_0x0197
            L_0x018f:
                android.view.GestureDetector$OnGestureListener r5 = r12.f11463a
                android.view.MotionEvent r7 = r12.f11467e
            ...
            L_0x01cc:
                android.view.MotionEvent r1 = r12.f11467e
        ...
        public void setOnDoubleTapListener(GestureDetector.OnDoubleTapListener onDoubleTapListener) {
            this.f11464b = onDoubleTapListener;
        }
    }
    ...
    public void setIsLongpressEnabled(boolean z11) {
        this.mImpl.setIsLongpressEnabled(z11);
    }
