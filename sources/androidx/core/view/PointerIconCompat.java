...
public final class PointerIconCompat {
    ...
    public static PointerIconCompat create(@NonNull Bitmap bitmap, float f11, float f12) {
        if (Build.VERSION.SDK_INT >= 24) {
            return new PointerIconCompat(Api24Impl.a(bitmap, f11, f12));
        }
    ...
    public static PointerIconCompat getSystemIcon(@NonNull Context context, int i11) {
        if (Build.VERSION.SDK_INT >= 24) {
            return new PointerIconCompat(Api24Impl.b(context, i11));
        }
        return new PointerIconCompat((PointerIcon) null);
    }
    ...
    public static PointerIconCompat load(@NonNull Resources resources, int i11) {
        if (Build.VERSION.SDK_INT >= 24) {
            return new PointerIconCompat(Api24Impl.c(resources, i11));
        }
        return new PointerIconCompat((PointerIcon) null);
    }
