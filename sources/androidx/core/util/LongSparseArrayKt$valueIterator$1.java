...
public final class LongSparseArrayKt$valueIterator$1 implements Iterator<T>, KMappedMarker, j$.util.Iterator {
    ...
    public final /* synthetic */ LongSparseArray<T> f11444b;
    private int index;

    public LongSparseArrayKt$valueIterator$1(LongSparseArray<T> longSparseArray) {
        this.f11444b = longSparseArray;
    }
    ...
    public boolean hasNext() {
        return this.index < this.f11444b.size();
    }

    @SuppressLint({"ClassVerificationFailure"})
    public T next() {
        LongSparseArray<T> longSparseArray = this.f11444b;
        int i11 = this.index;
        this.index = i11 + 1;
