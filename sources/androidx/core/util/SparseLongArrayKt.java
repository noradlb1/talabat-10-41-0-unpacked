...
public final class SparseLongArrayKt {
    ...
    public static final boolean contains(@NotNull SparseLongArray sparseLongArray, int i11) {
    ...
    @RequiresApi(18)
    @SuppressLint({"ClassVerificationFailure"})
    public static final boolean containsKey(@NotNull SparseLongArray sparseLongArray, int i11) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
        if (sparseLongArray.indexOfKey(i11) >= 0) {
            return true;
        }
    ...
    @RequiresApi(18)
    @SuppressLint({"ClassVerificationFailure"})
    public static final boolean containsValue(@NotNull SparseLongArray sparseLongArray, long j11) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
        if (sparseLongArray.indexOfValue(j11) >= 0) {
            return true;
        }
        return false;
    }
    ...
    public static final void forEach(@NotNull SparseLongArray sparseLongArray, @NotNull Function2<? super Integer, ? super Long, Unit> function2) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            function2.invoke(Integer.valueOf(sparseLongArray.keyAt(i11)), Long.valueOf(sparseLongArray.valueAt(i11)));
        }
    }

    @RequiresApi(18)
    @SuppressLint({"ClassVerificationFailure"})
    public static final long getOrDefault(@NotNull SparseLongArray sparseLongArray, int i11, long j11) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
    ...
    @RequiresApi(18)
    @SuppressLint({"ClassVerificationFailure"})
    public static final long getOrElse(@NotNull SparseLongArray sparseLongArray, int i11, @NotNull Function0<Long> function0) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
    ...
    @RequiresApi(18)
    @SuppressLint({"ClassVerificationFailure"})
    public static final boolean remove(@NotNull SparseLongArray sparseLongArray, int i11, long j11) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
        int indexOfKey = sparseLongArray.indexOfKey(i11);
    ...
    @RequiresApi(18)
    @SuppressLint({"ClassVerificationFailure"})
    public static final void set(@NotNull SparseLongArray sparseLongArray, int i11, long j11) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
