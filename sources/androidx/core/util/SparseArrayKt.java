...
public final class SparseArrayKt {
    public static final <T> boolean contains(@NotNull SparseArray<T> sparseArray, int i11) {
    ...
    public static final <T> boolean containsKey(@NotNull SparseArray<T> sparseArray, int i11) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        if (sparseArray.indexOfKey(i11) >= 0) {
            return true;
        }
    ...
    public static final <T> boolean containsValue(@NotNull SparseArray<T> sparseArray, T t11) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        if (sparseArray.indexOfValue(t11) >= 0) {
            return true;
        }
        return false;
    }
    ...
    public static final <T> T getOrDefault(@NotNull SparseArray<T> sparseArray, int i11, T t11) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
    ...
    public static final <T> T getOrElse(@NotNull SparseArray<T> sparseArray, int i11, @NotNull Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
    ...
    public static final <T> boolean remove(@NotNull SparseArray<T> sparseArray, int i11, T t11) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        int indexOfKey = sparseArray.indexOfKey(i11);
        if (indexOfKey < 0 || !Intrinsics.areEqual((Object) t11, (Object) sparseArray.valueAt(indexOfKey))) {
            return false;
        }
    ...
    public static final <T> void set(@NotNull SparseArray<T> sparseArray, int i11, T t11) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
