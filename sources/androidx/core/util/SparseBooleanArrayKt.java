...
public final class SparseBooleanArrayKt {
    public static final boolean contains(@NotNull SparseBooleanArray sparseBooleanArray, int i11) {
        Intrinsics.checkNotNullParameter(sparseBooleanArray, "<this>");
        if (sparseBooleanArray.indexOfKey(i11) >= 0) {
            return true;
        }
        return false;
    }

    public static final boolean containsKey(@NotNull SparseBooleanArray sparseBooleanArray, int i11) {
        Intrinsics.checkNotNullParameter(sparseBooleanArray, "<this>");
        if (sparseBooleanArray.indexOfKey(i11) >= 0) {
            return true;
        }
    ...
    public static final boolean containsValue(@NotNull SparseBooleanArray sparseBooleanArray, boolean z11) {
        Intrinsics.checkNotNullParameter(sparseBooleanArray, "<this>");
        if (sparseBooleanArray.indexOfValue(z11) >= 0) {
            return true;
        }
        return false;
    }
    ...
    public static final boolean getOrDefault(@NotNull SparseBooleanArray sparseBooleanArray, int i11, boolean z11) {
        Intrinsics.checkNotNullParameter(sparseBooleanArray, "<this>");
        return sparseBooleanArray.get(i11, z11);
    }

    public static final boolean getOrElse(@NotNull SparseBooleanArray sparseBooleanArray, int i11, @NotNull Function0<Boolean> function0) {
        Intrinsics.checkNotNullParameter(sparseBooleanArray, "<this>");
    ...
    public static final boolean remove(@NotNull SparseBooleanArray sparseBooleanArray, int i11, boolean z11) {
        Intrinsics.checkNotNullParameter(sparseBooleanArray, "<this>");
        int indexOfKey = sparseBooleanArray.indexOfKey(i11);
    ...
    public static final void set(@NotNull SparseBooleanArray sparseBooleanArray, int i11, boolean z11) {
        Intrinsics.checkNotNullParameter(sparseBooleanArray, "<this>");
