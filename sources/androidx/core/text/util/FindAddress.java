...
class FindAddress {
    ...
    public static class ZipRange {
        ...
        public boolean a(String str) {
            ...
            if ((this.f11425a <= parseInt && parseInt <= this.f11426b) || parseInt == this.f11427c || parseInt == this.f11428d) {
                return true;
            }
            return false;
        }
    ...
    private static boolean isValidZipCode(String str, MatchResult matchResult) {
        ...
        if (!sZipCodeRe.matcher(str).matches() || !sStateZipCodeRanges[groupCount].a(str)) {
            return false;
        }
        return true;
    }
