...
public final class FoldingFeatureObserver$registerLayoutStateChangeCallback$1$invokeSuspend$$inlined$mapNotNull$1 implements Flow<FoldingFeature> {
    ...
    public final /* synthetic */ Flow f37587b;

    /* renamed from: c  reason: collision with root package name */
    public final /* synthetic */ FoldingFeatureObserver f37588c;
    ...
    public FoldingFeatureObserver$registerLayoutStateChangeCallback$1$invokeSuspend$$inlined$mapNotNull$1(Flow flow, FoldingFeatureObserver foldingFeatureObserver) {
        this.f37587b = flow;
        this.f37588c = foldingFeatureObserver;
    }

    @Nullable
    public Object collect(@NotNull final FlowCollector flowCollector, @NotNull Continuation continuation) {
        Flow flow = this.f37587b;
        final FoldingFeatureObserver foldingFeatureObserver = this.f37588c;
        Object collect = flow.collect(new FlowCollector<WindowLayoutInfo>() {
            ...
            public java.lang.Object emit(java.lang.Object r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation r6) {
                ...
                L_0x0013:
                    ...
                    r0.<init>(r4, r6)
                L_0x0018:
                    java.lang.Object r6 = r0.f37591h
