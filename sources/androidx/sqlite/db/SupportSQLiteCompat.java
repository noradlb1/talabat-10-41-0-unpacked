...
public final class SupportSQLiteCompat {
    ...
    public static final class Api16Impl {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public static void setForeignKeyConstraintsEnabled(@NonNull SQLiteDatabase sQLiteDatabase, boolean z11) {
            sQLiteDatabase.setForeignKeyConstraintsEnabled(z11);
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public static void setWriteAheadLoggingEnabled(@NonNull SQLiteOpenHelper sQLiteOpenHelper, boolean z11) {
