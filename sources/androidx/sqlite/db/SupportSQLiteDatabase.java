...
public interface SupportSQLiteDatabase extends Closeable {
    ...
    long insert(String str, int i11, ContentValues contentValues) throws SQLException;
    ...
    int update(String str, int i11, ContentValues contentValues, String str2, Object[] objArr);
