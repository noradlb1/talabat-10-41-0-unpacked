...
public class AppCompatViewInflater {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z11, boolean z12) {
        ...
        if (z11) {
            i11 = obtainStyledAttributes.getResourceId(R.styleable.View_android_theme, 0);
        } else {
            i11 = 0;
        }
        if (z12 && i11 == 0 && (i11 = obtainStyledAttributes.getResourceId(R.styleable.View_theme, 0)) != 0) {
        ...
        if (!(context instanceof ContextThemeWrapper) || ((ContextThemeWrapper) context).getThemeResId() != i11) {
