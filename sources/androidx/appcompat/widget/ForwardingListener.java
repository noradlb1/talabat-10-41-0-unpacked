...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public class DisallowIntercept implements Runnable {
        ...
        public void run() {
            ViewParent parent = ForwardingListener.this.f828b.getParent();
            if (parent != null) {
    ...
    private void clearCallbacks() {
        ...
        if (runnable != null) {
            this.f828b.removeCallbacks(runnable);
        }
        Runnable runnable2 = this.mDisallowIntercept;
        if (runnable2 != null) {
            this.f828b.removeCallbacks(runnable2);
        }
    }
    ...
    private static boolean pointInView(View view, float f11, float f12, float f13) {
        float f14 = -f13;
        if (f11 < f14 || f12 < f14 || f11 >= ((float) (view.getRight() - view.getLeft())) + f13 || f12 >= ((float) (view.getBottom() - view.getTop())) + f13) {
            return false;
        }
        return true;
    }
