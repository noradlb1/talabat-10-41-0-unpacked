...
class ActivityChooserModel extends DataSetObservable {
    ...
    public static final String f780d = "ActivityChooserModel";
    ...
    public static final class HistoricalRecord {
        ...
        public int hashCode() {
            ...
            long j11 = this.time;
            return ((((i11 + 31) * 31) + ((int) (j11 ^ (j11 >>> 32)))) * 31) + Float.floatToIntBits(this.weight);
        }
    ...
    public final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r15) {
            /*
                ...
                android.content.Context r7 = r7.f781a     // Catch:{ FileNotFoundException -> 0x00de }
            ...
            L_0x0073:
                r0 = move-exception
                java.lang.String r1 = androidx.appcompat.widget.ActivityChooserModel.f780d     // Catch:{ all -> 0x0071 }
                ...
                java.lang.String r2 = r2.f782b     // Catch:{ all -> 0x0071 }
                r3.append(r2)     // Catch:{ all -> 0x0071 }
            ...
            L_0x00de:
                r0 = move-exception
                java.lang.String r1 = androidx.appcompat.widget.ActivityChooserModel.f780d
    ...
    private ActivityChooserModel(Context context, String str) {
        ...
        this.f782b = str + HISTORY_FILE_EXTENSION;
    }
    ...
    private boolean loadActivitiesIfNeeded() {
        ...
        List<ResolveInfo> queryIntentActivities = this.f781a.getPackageManager().queryIntentActivities(this.mIntent, 0);
    ...
    private void persistHistoricalDataIfNeeded() {
        if (!this.mReadShareHistoryCalled) {
            ...
            if (!TextUtils.isEmpty(this.f782b)) {
                new PersistHistoryAsyncTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Object[]{new ArrayList(this.mHistoricalRecords), this.f782b});
            }
        }
    }
    ...
    private boolean readHistoricalDataIfNeeded() {
        if (!this.f783c || !this.mHistoricalRecordsChanged || TextUtils.isEmpty(this.f782b)) {
            return false;
        }
        this.f783c = false;
    ...
    private void readHistoricalDataImpl() {
        try {
            FileInputStream openFileInput = this.f781a.openFileInput(this.f782b);
            try {
                ...
                String str = f780d;
                Log.e(str, "Error reading historical recrod file: " + this.f782b, e11);
                if (openFileInput == null) {
                }
            } catch (IOException e12) {
                String str2 = f780d;
                Log.e(str2, "Error reading historical recrod file: " + this.f782b, e12);
                if (openFileInput == null) {
                }
            } catch (Throwable th2) {
                if (openFileInput != null) {
    ...
    public void setDefaultActivity(int i11) {
        ...
        synchronized (this.mInstanceLock) {
            ...
            if (activityResolveInfo2 != null) {
                f11 = (activityResolveInfo2.weight - activityResolveInfo.weight) + 5.0f;
            } else {
                f11 = 1.0f;
            }
            ActivityInfo activityInfo = activityResolveInfo.resolveInfo.activityInfo;
