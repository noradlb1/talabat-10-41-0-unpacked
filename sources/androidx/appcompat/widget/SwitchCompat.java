...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public static final /* synthetic */ int f892b = 0;
    @NonNull
    ...
    private void animateThumbToCheckedState(boolean z11) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, THUMB_POS, new float[]{f11});
    ...
    private Layout makeLayout(CharSequence charSequence) {
        ...
        if (charSequence != null) {
            i11 = (int) Math.ceil((double) Layout.getDesiredWidth(charSequence, textPaint));
        } else {
            i11 = 0;
        }
        return new StaticLayout(charSequence, textPaint, i11, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
    }
    ...
    public void onLayout(boolean z11, int i11, int i12, int i13, int i14) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            i22 = Math.max(0, opticalBounds.right - rect.right);
        } else {
            i15 = 0;
        }
        if (ViewUtils.isLayoutRtl(this)) {
    ...
    public void onMeasure(int i11, int i12) {
        ...
        if (this.mShowText) {
            i15 = Math.max(this.mOnLayout.getWidth(), this.mOffLayout.getWidth()) + (this.mThumbTextPadding * 2);
        } else {
            i15 = 0;
        }
        this.mThumbWidth = Math.max(i15, i14);
        Drawable drawable2 = this.mTrackDrawable;
        if (drawable2 != null) {
            drawable2.getPadding(rect);
            i17 = this.mTrackDrawable.getIntrinsicHeight();
        } else {
            rect.setEmpty();
        }
        int i18 = rect.left;
        ...
        if (drawable3 != null) {
            ...
            i18 = Math.max(i18, opticalBounds.left);
            i19 = Math.max(i19, opticalBounds.right);
        }
        if (this.mEnforceSwitchWidth) {
            i16 = Math.max(this.mSwitchMinWidth, (this.mThumbWidth * 2) + i18 + i19);
        } else {
            i16 = this.mSwitchMinWidth;
        }
        int max = Math.max(i17, i13);
        this.mSwitchWidth = i16;
