...
public final class AppCompatDrawableManager {
            ...
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() {
                    ...
                    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i11) {
                        ...
                        return new ColorStateList(new int[][]{ThemeUtils.f893a, ThemeUtils.f896d, ThemeUtils.f894b, ThemeUtils.f900h}, new int[]{disabledThemeAttrColor, ColorUtils.compositeColors(themeAttrColor, i11), ColorUtils.compositeColors(themeAttrColor, i11), i11});
                    }
                    ...
                    public boolean tintDrawable(@NonNull Context context, int i11, @NonNull Drawable drawable) {
                        if (i11 == R.drawable.abc_seekbar_track_material) {
                            ...
                            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, i12), AppCompatDrawableManager.DEFAULT_MODE);
                            ...
                            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, i13), AppCompatDrawableManager.DEFAULT_MODE);
                            return true;
                        }
                    }
    ...
    public synchronized Drawable b(@NonNull Context context, @DrawableRes int i11, boolean z11) {
        return this.mResourceManager.a(context, i11, z11);
    }

    public synchronized ColorStateList c(@NonNull Context context, @DrawableRes int i11) {
        return this.mResourceManager.b(context, i11);
    }
