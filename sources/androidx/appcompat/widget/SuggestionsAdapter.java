...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r7) {
        /*
            ...
            android.graphics.drawable.Drawable r7 = r6.c(r7)     // Catch:{ NotFoundException -> 0x0016 }
            return r7
        L_0x0016:
    ...
    public Cursor d(SearchableInfo searchableInfo, String str, int i11) {
        ...
        if (i11 > 0) {
            fragment.appendQueryParameter(UrlConstantsKt.LIMIT, String.valueOf(i11));
        }
    ...
    public void onClick(View view) {
        ...
        if (tag instanceof CharSequence) {
            this.mSearchView.h((CharSequence) tag);
        }
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        ...
        if (this.mSearchView.getVisibility() == 0 && this.mSearchView.getWindowVisibility() == 0) {
            try {
                Cursor d11 = d(this.mSearchable, str, 50);
                if (d11 != null) {
                    d11.getCount();
                    return d11;
                }
