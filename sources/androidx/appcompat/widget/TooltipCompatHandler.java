...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mHideRunnable = new b(this);
    private final int mHoverSlop;
    private TooltipPopup mPopup;
    private final Runnable mShowRunnable = new a(this);
    ...
    public void c(boolean z11) {
        ...
        if (ViewCompat.isAttachedToWindow(this.mAnchor)) {
            ...
            tooltipPopup.c(this.mAnchor, this.mAnchorX, this.mAnchorY, this.mFromTouch, this.mTooltipText);
            this.mAnchor.addOnAttachStateChangeListener(this);
            if (this.mFromTouch) {
                j11 = LONG_CLICK_HIDE_TIMEOUT_MS;
            } else {
                if ((ViewCompat.getWindowSystemUiVisibility(this.mAnchor) & 1) == 1) {
                    j13 = (long) ViewConfiguration.getLongPressTimeout();
                    j12 = 3000;
                } else {
                    j13 = (long) ViewConfiguration.getLongPressTimeout();
                    j12 = 15000;
