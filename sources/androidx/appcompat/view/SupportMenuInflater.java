...
public class SupportMenuInflater extends MenuInflater {
    ...
    public static final Class<?>[] f677d;

    /* renamed from: e  reason: collision with root package name */
    public static final Class<?>[] f678e;
    ...
    public class MenuState {
        ...
        private <T> T newInstance(String str, Class<?>[] clsArr, Object[] objArr) {
            try {
                Constructor<?> constructor = Class.forName(str, false, SupportMenuInflater.this.f681c.getClassLoader()).getConstructor(clsArr);
        ...
        private void setItem(MenuItem menuItem) {
            ...
            enabled.setCheckable(z11).setTitleCondensed(this.itemTitleCondensed).setIcon(this.itemIconResId);
            int i11 = this.itemShowAsAction;
            if (i11 >= 0) {
                menuItem.setShowAsAction(i11);
            }
            if (this.itemListenerMethodName != null) {
                if (!SupportMenuInflater.this.f681c.isRestricted()) {
            ...
            if (str != null) {
                menuItem.setActionView((View) newInstance(str, SupportMenuInflater.f677d, SupportMenuInflater.this.f679a));
                z12 = true;
            }
            ...
            ActionProvider actionProvider = this.f682a;
        ...
        public void readGroup(AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = SupportMenuInflater.this.f681c.obtainStyledAttributes(attributeSet, R.styleable.MenuGroup);
        ...
        public void readItem(AttributeSet attributeSet) {
            boolean z11;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(SupportMenuInflater.this.f681c, attributeSet, R.styleable.MenuItem);
            ...
            if (z11 && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                this.f682a = (ActionProvider) newInstance(string, SupportMenuInflater.f678e, SupportMenuInflater.this.f680b);
            } else {
                if (z11) {
                    ...
                    if (eventType == 3) {
                        ...
                        if (z12 && name3.equals(str)) {
                            ...
                            if (!menuState.hasAddedItem()) {
                                ActionProvider actionProvider = menuState.f682a;
    ...
    public Object a() {
        if (this.mRealOwner == null) {
            this.mRealOwner = findRealOwner(this.f681c);
        }
    ...
    public void inflate(@LayoutRes int i11, Menu menu) {
        ...
        try {
            xmlResourceParser = this.f681c.getResources().getLayout(i11);
