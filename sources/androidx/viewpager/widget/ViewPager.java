...
public class ViewPager extends ViewGroup {
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i11, ItemInfo itemInfo2) {
        ...
        if (itemInfo2 != null) {
            ...
            if (i14 < i15) {
                float f14 = itemInfo2.offset + itemInfo2.widthFactor + f11;
                int i16 = i14 + 1;
                int i17 = 0;
                while (i16 <= itemInfo.position && i17 < this.mItems.size()) {
                    ...
                    while (i16 < itemInfo4.position) {
                        f14 += this.mAdapter.getPageWidth(i16) + f11;
                        i16++;
                    }
                    itemInfo4.offset = f14;
                    f14 += itemInfo4.widthFactor + f11;
                    i16++;
                }
            } else if (i14 > i15) {
                ...
                while (true) {
                    ...
                    while (i14 > itemInfo3.position) {
                        f15 -= this.mAdapter.getPageWidth(i14) + f11;
                        i14--;
                    }
                    f15 -= itemInfo3.widthFactor + f11;
                    itemInfo3.offset = f15;
                }
            }
        }
        ...
        int i21 = count - 1;
        if (i18 == i21) {
            f13 = (itemInfo.widthFactor + f16) - 1.0f;
        } else {
            f13 = Float.MAX_VALUE;
        }
        ...
        while (i22 >= 0) {
            ...
            while (true) {
                ...
                f16 -= this.mAdapter.getPageWidth(i19) + f11;
                i19--;
            }
            f16 -= itemInfo5.widthFactor + f11;
            itemInfo5.offset = f16;
            if (i13 == 0) {
        ...
        float f17 = itemInfo.offset + itemInfo.widthFactor + f11;
        ...
        while (i24 < size2) {
            ...
            while (true) {
                ...
                f17 += this.mAdapter.getPageWidth(i23) + f11;
                i23++;
            }
            if (i12 == i21) {
                this.mLastOffset = (itemInfo6.widthFactor + f17) - 1.0f;
            }
            itemInfo6.offset = f17;
            f17 += itemInfo6.widthFactor + f11;
            i24++;
            i23++;
        }
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        float f13 = 0.0f;
        if (clientWidth > 0) {
            f11 = ((float) getScrollX()) / ((float) clientWidth);
        } else {
            f11 = 0.0f;
        }
        if (clientWidth > 0) {
            f12 = ((float) this.mPageMargin) / ((float) clientWidth);
        } else {
            f12 = 0.0f;
        }
        int i12 = 0;
        ...
        while (i12 < this.mItems.size()) {
            ...
            if (!z11 && itemInfo2.position != (i11 = i13 + 1)) {
                ...
                itemInfo2.offset = f13 + f14 + f12;
                itemInfo2.position = i11;
                itemInfo2.widthFactor = this.mAdapter.getPageWidth(i11);
                i12--;
            }
            ItemInfo itemInfo3 = itemInfo2;
            f13 = itemInfo3.offset;
            float f15 = itemInfo3.widthFactor + f13 + f12;
            if (!z11 && f11 < f13) {
                return itemInfo;
            }
            if (f11 < f15 || i12 == this.mItems.size() - 1) {
                return itemInfo3;
            }
            int i14 = itemInfo3.position;
            float f16 = itemInfo3.widthFactor;
            i12++;
            z11 = false;
    ...
    private void recomputeScrollPosition(int i11, int i12, int i13, int i14) {
        ...
        if (i12 <= 0 || this.mItems.isEmpty()) {
            ...
            if (infoForPosition != null) {
                f11 = Math.min(infoForPosition.offset, this.mLastOffset);
            } else {
                f11 = 0.0f;
            }
            int paddingLeft = (int) (f11 * ((float) ((i11 - getPaddingLeft()) - getPaddingRight())));
    ...
    private void scrollToItem(int i11, boolean z11, int i12, boolean z12) {
        ...
        if (infoForPosition != null) {
            i13 = (int) (((float) getClientWidth()) * Math.max(this.mFirstOffset, Math.min(infoForPosition.offset, this.mLastOffset)));
        } else {
            i13 = 0;
        }
        if (z11) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (i11 != -1) {
                ...
                float f12 = x12 - this.mLastMotionX;
                ...
                if (i12 != 0 && !isGutterDrag(this.mLastMotionX, f12)) {
                    if (canScroll(this, false, (int) f12, (int) x12, (int) y12)) {
                ...
                if (abs > ((float) i13) && abs * 0.5f > abs2) {
                    ...
                    float f14 = (float) this.mTouchSlop;
                    if (i12 > 0) {
                        f11 = f13 + f14;
                    } else {
                        f11 = f13 - f14;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            int scrollX = getScrollX();
            ItemInfo infoForCurrentScrollPosition = infoForCurrentScrollPosition();
            float f13 = (float) clientWidth;
            setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.position, ((((float) scrollX) / f13) - infoForCurrentScrollPosition.offset) / (infoForCurrentScrollPosition.widthFactor + (((float) this.mPageMargin) / f13)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, xVelocity);
            z11 = resetTouch();
        }
        if (z11) {
            ViewCompat.postInvalidateOnAnimation(this);
