...
final class Utf8 {
    ...
    private static final Processor processor = ((!UnsafeProcessor.o() || Android.b()) ? new SafeProcessor() : new UnsafeProcessor());
    ...
    public static abstract class Processor {
        private static int partialIsValidUtf8(ByteBuffer byteBuffer, int i11, int i12) {
            int e11 = i11 + Utf8.estimateConsecutiveAscii(byteBuffer, i11, i12);
            while (e11 < i12) {
                int i13 = e11 + 1;
        ...
        public final boolean i(ByteBuffer byteBuffer, int i11, int i12) {
            return k(0, byteBuffer, i11, i12) == 0;
        }

        public final boolean j(byte[] bArr, int i11, int i12) {
            return l(0, bArr, i11, i12) == 0;
        }

        public final int k(int i11, ByteBuffer byteBuffer, int i12, int i13) {
            if (byteBuffer.hasArray()) {
                int arrayOffset = byteBuffer.arrayOffset();
                return l(i11, byteBuffer.array(), i12 + arrayOffset, arrayOffset + i13);
            } else if (byteBuffer.isDirect()) {
                return n(i11, byteBuffer, i12, i13);
            } else {
                return m(i11, byteBuffer, i12, i13);
            }
        }

        public abstract int l(int i11, byte[] bArr, int i12, int i13);
        ...
        public final int m(int r7, java.nio.ByteBuffer r8, int r9, int r10) {
            /*
                r6 = this;
        ...
        public abstract int n(int i11, ByteBuffer byteBuffer, int i12, int i13);
    }
    ...
    public static final class SafeProcessor extends Processor {
        ...
        public int n(int i11, ByteBuffer byteBuffer, int i12, int i13) {
            return m(i11, byteBuffer, i12, i13);
        }
    }
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        private static int partialIsValidUtf8(byte[] r8, long r9, int r11) {
            ...
            L_0x0009:
                ...
                long r4 = r9 + r2
                byte r1 = androidx.datastore.preferences.protobuf.UnsafeUtil.o(r8, r9)
            ...
            L_0x0029:
                ...
                long r2 = r2 + r9
                byte r9 = androidx.datastore.preferences.protobuf.UnsafeUtil.o(r8, r9)
            ...
            L_0x005c:
                long r2 = r2 + r6
                byte r9 = androidx.datastore.preferences.protobuf.UnsafeUtil.o(r8, r6)
                if (r9 <= r4) goto L_0x0037
            L_0x0063:
                return r5
            L_0x0064:
            ...
            L_0x006c:
                ...
                long r9 = r6 + r2
                byte r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.o(r8, r6)
        ...
        private static int unsafeIncompleteStateFor(byte[] bArr, int i11, long j11, int i12) {
            ...
            if (i12 == 1) {
                return Utf8.incompleteStateFor(i11, UnsafeUtil.o(bArr, j11));
            }
            if (i12 == 2) {
                return Utf8.incompleteStateFor(i11, (int) UnsafeUtil.o(bArr, j11), (int) UnsafeUtil.o(bArr, j11 + 1));
            }
        ...
        public String b(byte[] bArr, int i11, int i12) throws InvalidProtocolBufferException {
            if ((i11 | i12 | ((bArr.length - i11) - i12)) >= 0) {
                ...
                int i14 = 0;
                while (r13 < i13) {
                    byte o11 = UnsafeUtil.o(bArr, (long) r13);
                    if (!DecodeUtil.isOneByte(o11)) {
                        break;
                    }
                    i11 = r13 + 1;
                    DecodeUtil.handleOneByte(o11, cArr, i14);
                    i14++;
                }
                int i15 = i14;
                while (r13 < i13) {
                    int i16 = r13 + 1;
                    byte o12 = UnsafeUtil.o(bArr, (long) r13);
                    if (DecodeUtil.isOneByte(o12)) {
                        int i17 = i15 + 1;
                        DecodeUtil.handleOneByte(o12, cArr, i15);
                        while (i16 < i13) {
                            byte o13 = UnsafeUtil.o(bArr, (long) i16);
                            if (!DecodeUtil.isOneByte(o13)) {
                                break;
                            }
                            i16++;
                            DecodeUtil.handleOneByte(o13, cArr, i17);
                            i17++;
                        }
                        r13 = i16;
                        i15 = i17;
                    } else if (DecodeUtil.isTwoBytes(o12)) {
                        if (i16 < i13) {
                            DecodeUtil.handleTwoBytes(o12, UnsafeUtil.o(bArr, (long) i16), cArr, i15);
                            r13 = i16 + 1;
                            i15++;
                        } else {
                            throw InvalidProtocolBufferException.c();
                        }
                    } else if (DecodeUtil.isThreeBytes(o12)) {
                        if (i16 < i13 - 1) {
                            int i18 = i16 + 1;
                            DecodeUtil.handleThreeBytes(o12, UnsafeUtil.o(bArr, (long) i16), UnsafeUtil.o(bArr, (long) i18), cArr, i15);
                            r13 = i18 + 1;
                            i15++;
                        } else {
                            throw InvalidProtocolBufferException.c();
                        ...
                        int i19 = i16 + 1;
                        byte o14 = UnsafeUtil.o(bArr, (long) i16);
                        int i21 = i19 + 1;
                        DecodeUtil.handleFourBytes(o12, o14, UnsafeUtil.o(bArr, (long) i19), UnsafeUtil.o(bArr, (long) i21), cArr, i15);
                        r13 = i21 + 1;
                        i15 = i15 + 1 + 1;
                    } else {
                        throw InvalidProtocolBufferException.c();
        ...
        public String d(ByteBuffer byteBuffer, int i11, int i12) throws InvalidProtocolBufferException {
            ...
            if ((i13 | i14 | ((byteBuffer.limit() - i13) - i14)) >= 0) {
                long i15 = UnsafeUtil.i(byteBuffer) + ((long) i13);
                long j12 = ((long) i14) + i15;
                char[] cArr = new char[i14];
                int i16 = 0;
                while (i15 < j12) {
                    byte n11 = UnsafeUtil.n(i15);
                    if (!DecodeUtil.isOneByte(n11)) {
                        break;
                    }
                    i15++;
                    DecodeUtil.handleOneByte(n11, cArr, i16);
                    i16++;
                }
                while (true) {
                    int i17 = i16;
                    while (j11 < j12) {
                        long j13 = j11 + 1;
                        byte n12 = UnsafeUtil.n(j11);
                        if (DecodeUtil.isOneByte(n12)) {
                            int i18 = i17 + 1;
                            DecodeUtil.handleOneByte(n12, cArr, i17);
                            while (j13 < j12) {
                                byte n13 = UnsafeUtil.n(j13);
                                if (!DecodeUtil.isOneByte(n13)) {
                                    break;
                                }
                                j13++;
                                DecodeUtil.handleOneByte(n13, cArr, i18);
                                i18++;
                            }
                            i17 = i18;
                            j11 = j13;
                        } else if (DecodeUtil.isTwoBytes(n12)) {
                            if (j13 < j12) {
                                j11 = j13 + 1;
                                DecodeUtil.handleTwoBytes(n12, UnsafeUtil.n(j13), cArr, i17);
                                i17++;
                            } else {
                                throw InvalidProtocolBufferException.c();
                            }
                        } else if (DecodeUtil.isThreeBytes(n12)) {
                            if (j13 < j12 - 1) {
                                long j14 = j13 + 1;
                                DecodeUtil.handleThreeBytes(n12, UnsafeUtil.n(j13), UnsafeUtil.n(j14), cArr, i17);
                                i17++;
                                j11 = j14 + 1;
                            } else {
                                throw InvalidProtocolBufferException.c();
                            ...
                            long j15 = j13 + 1;
                            byte n14 = UnsafeUtil.n(j13);
                            long j16 = j15 + 1;
                            byte n15 = UnsafeUtil.n(j15);
                            i15 = j16 + 1;
                            DecodeUtil.handleFourBytes(n12, n14, n15, UnsafeUtil.n(j16), cArr, i17);
                            i16 = i17 + 1 + 1;
                        } else {
                            throw InvalidProtocolBufferException.c();
                        }
        ...
        public int e(java.lang.CharSequence r22, byte[] r23, int r24, int r25) {
            ...
            L_0x001a:
                ...
                long r11 = r11 + r4
                byte r3 = (byte) r13
                androidx.datastore.preferences.protobuf.UnsafeUtil.B(r1, r4, r3)
                int r2 = r2 + 1
                r4 = r11
                goto L_0x001a
            L_0x002f:
            ...
            L_0x0033:
                ...
                long r14 = r4 + r11
                byte r13 = (byte) r13
                androidx.datastore.preferences.protobuf.UnsafeUtil.B(r1, r4, r13)
                r4 = r11
                r12 = r14
                r11 = r3
                goto L_0x00fc
            L_0x004a:
                ...
                r5 = r5 | r13
                byte r5 = (byte) r5
                androidx.datastore.preferences.protobuf.UnsafeUtil.B(r1, r14, r5)
                r19 = r11
            ...
            L_0x007e:
                ...
                r5 = r5 | r11
                byte r5 = (byte) r5
                androidx.datastore.preferences.protobuf.UnsafeUtil.B(r1, r3, r5)
                r12 = r17
                r4 = 1
                r11 = 128(0x80, float:1.794E-43)
                goto L_0x00fc
            L_0x00af:
                ...
                byte r15 = (byte) r15
                androidx.datastore.preferences.protobuf.UnsafeUtil.B(r1, r4, r15)
                long r4 = r13 + r11
                int r15 = r2 >>> 12
                r15 = r15 & 63
                r11 = 128(0x80, float:1.794E-43)
                ...
                byte r12 = (byte) r12
                androidx.datastore.preferences.protobuf.UnsafeUtil.B(r1, r13, r12)
                r12 = 1
                long r14 = r4 + r12
                int r16 = r2 >>> 6
                r12 = r16 & 63
                r12 = r12 | r11
                byte r12 = (byte) r12
                androidx.datastore.preferences.protobuf.UnsafeUtil.B(r1, r4, r12)
                r4 = 1
                long r12 = r14 + r4
                r2 = r2 & 63
                r2 = r2 | r11
                byte r2 = (byte) r2
                androidx.datastore.preferences.protobuf.UnsafeUtil.B(r1, r14, r2)
                r2 = r3
            L_0x00fc:
                int r2 = r2 + 1
                r3 = r11
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void h(java.lang.CharSequence r22, java.nio.ByteBuffer r23) {
            /*
                r21 = this;
                r0 = r22
                r1 = r23
                long r2 = androidx.datastore.preferences.protobuf.UnsafeUtil.i(r23)
                int r4 = r23.position()
                long r4 = (long) r4
                long r4 = r4 + r2
                int r6 = r23.limit()
            ...
            L_0x0024:
                ...
                long r12 = r4 + r13
                byte r14 = (byte) r15
                androidx.datastore.preferences.protobuf.UnsafeUtil.A(r4, r14)
                int r9 = r9 + 1
                r4 = r12
                goto L_0x0024
            L_0x003a:
            ...
            L_0x0042:
                ...
                long r16 = r4 + r13
                byte r15 = (byte) r15
                androidx.datastore.preferences.protobuf.UnsafeUtil.A(r4, r15)
                r19 = r6
                r1 = r9
                r9 = r12
                r4 = r16
            ...
            L_0x005e:
                ...
                r3 = r3 | 960(0x3c0, float:1.345E-42)
                byte r3 = (byte) r3
                androidx.datastore.preferences.protobuf.UnsafeUtil.A(r4, r3)
                long r3 = r1 + r13
                r5 = r15 & 63
                r12 = 128(0x80, float:1.794E-43)
                r5 = r5 | r12
                byte r5 = (byte) r5
                androidx.datastore.preferences.protobuf.UnsafeUtil.A(r1, r5)
                r4 = r3
            L_0x0082:
                r19 = r6
                r1 = r9
            ...
            L_0x0095:
                ...
                r5 = r5 | r12
                byte r5 = (byte) r5
                androidx.datastore.preferences.protobuf.UnsafeUtil.A(r3, r5)
                r4 = r1
                goto L_0x0082
            L_0x00bf:
                r19 = 4
                ...
                r5 = r5 | r9
                byte r5 = (byte) r5
                androidx.datastore.preferences.protobuf.UnsafeUtil.A(r6, r5)
                long r5 = r3 + r13
                int r7 = r2 >>> 6
                r7 = r7 & 63
                r7 = r7 | r9
                byte r7 = (byte) r7
                androidx.datastore.preferences.protobuf.UnsafeUtil.A(r3, r7)
                long r3 = r5 + r13
                r2 = r2 & 63
                r2 = r2 | r9
                byte r2 = (byte) r2
                androidx.datastore.preferences.protobuf.UnsafeUtil.A(r5, r2)
                r4 = r3
            L_0x0107:
                int r1 = r1 + 1
                r12 = r9
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0059, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.o(r13, r2) > -65) goto L_0x005e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x009e, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.o(r13, r2) > -65) goto L_0x00a0;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int l(int r12, byte[] r13, int r14, int r15) {
            ...
            L_0x0011:
                ...
                long r7 = r7 + r2
                byte r12 = androidx.datastore.preferences.protobuf.UnsafeUtil.o(r13, r2)
            ...
            L_0x005f:
                ...
                long r9 = r2 + r7
                byte r4 = androidx.datastore.preferences.protobuf.UnsafeUtil.o(r13, r2)
            ...
            L_0x0079:
                ...
                long r9 = r2 + r7
                byte r1 = androidx.datastore.preferences.protobuf.UnsafeUtil.o(r13, r2)
                int r12 = (r9 > r14 ? 1 : (r9 == r14 ? 0 : -1))
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0063, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.n(r2) > -65) goto L_0x0068;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x00a8, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.n(r2) > -65) goto L_0x00aa;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int n(int r11, java.nio.ByteBuffer r12, int r13, int r14) {
            /*
                r10 = this;
                r0 = r13 | r14
                int r1 = r12.limit()
                ...
                long r2 = androidx.datastore.preferences.protobuf.UnsafeUtil.i(r12)
                long r4 = (long) r13
                long r2 = r2 + r4
                int r14 = r14 - r13
                long r12 = (long) r14
            ...
            L_0x001b:
                ...
                long r6 = r6 + r2
                byte r11 = androidx.datastore.preferences.protobuf.UnsafeUtil.n(r2)
            ...
            L_0x0083:
                ...
                long r8 = r2 + r6
                byte r1 = androidx.datastore.preferences.protobuf.UnsafeUtil.n(r2)
                int r11 = (r8 > r12 ? 1 : (r8 == r12 ? 0 : -1))
        ...
        private static int unsafeEstimateConsecutiveAscii(long j11, int i11) {
            ...
            int i14 = i11 - i12;
            while (i14 >= 8 && (UnsafeUtil.s(j11) & Utf8.ASCII_MASK_LONG) == 0) {
                j11 += 8;
                i14 -= 8;
            }
            return i11 - i14;
        ...
        private static int unsafeIncompleteStateFor(long j11, int i11, int i12) {
            ...
            if (i12 == 1) {
                return Utf8.incompleteStateFor(i11, UnsafeUtil.n(j11));
            }
            if (i12 == 2) {
                return Utf8.incompleteStateFor(i11, (int) UnsafeUtil.n(j11), (int) UnsafeUtil.n(j11 + 1));
            }
            throw new AssertionError();
        }
        ...
        private static int partialIsValidUtf8(long r8, int r10) {
            ...
            L_0x0009:
                ...
                long r4 = r8 + r2
                byte r1 = androidx.datastore.preferences.protobuf.UnsafeUtil.n(r8)
                if (r1 < 0) goto L_0x0019
                int r10 = r10 + -1
                r8 = r4
                goto L_0x0009
            ...
            L_0x0029:
                ...
                if (r1 < r0) goto L_0x0039
                long r2 = r2 + r8
                byte r8 = androidx.datastore.preferences.protobuf.UnsafeUtil.n(r8)
            ...
            L_0x005c:
                long r2 = r2 + r6
                byte r8 = androidx.datastore.preferences.protobuf.UnsafeUtil.n(r6)
                if (r8 <= r4) goto L_0x0037
            L_0x0063:
                return r5
            L_0x0064:
            ...
            L_0x006c:
                ...
                long r8 = r6 + r2
                byte r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.n(r6)
                if (r0 > r4) goto L_0x008e
                long r2 = r2 + r8
                byte r8 = androidx.datastore.preferences.protobuf.UnsafeUtil.n(r8)
                if (r8 <= r4) goto L_0x0037
    ...
    public static int m(int i11, ByteBuffer byteBuffer, int i12, int i13) {
        return processor.k(i11, byteBuffer, i12, i13);
    }

    public static int partialIsValidUtf8(int i11, byte[] bArr, int i12, int i13) {
        return processor.l(i11, bArr, i12, i13);
    }

    public static boolean isValidUtf8(byte[] bArr, int i11, int i12) {
        return processor.j(bArr, i11, i12);
    }
