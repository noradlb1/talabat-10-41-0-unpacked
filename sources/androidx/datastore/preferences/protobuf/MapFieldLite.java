...
public final class MapFieldLite<K, V> extends LinkedHashMap<K, V> {
    ...
    public static <K, V> boolean b(java.util.Map<K, V> r4, java.util.Map<K, V> r5) {
        /*
            r0 = 1
        ...
        L_0x0042:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.MapFieldLite.b(java.util.Map, java.util.Map):boolean");
    }
