...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public class DescendingEntryIterator implements Iterator<Map.Entry<K, V>>, j$.util.Iterator {
        ...
        public Map.Entry<K, V> next() {
            ...
            List b11 = SmallSortedMap.this.entryList;
            int i11 = this.pos - 1;
            this.pos = i11;
    ...
    public static class EmptySet {
        ...
        /* access modifiers changed from: private */
        public static final java.util.Iterator<Object> ITERATOR = new Object() {
            public /* synthetic */ void forEachRemaining(Consumer consumer) {
                Iterator.CC.$default$forEachRemaining(this, consumer);
            }
    ...
    public static <FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> SmallSortedMap<FieldDescriptorType, Object> g(int i11) {
    ...
    public int hashCode() {
        ...
        if (getNumOverflowEntries() > 0) {
            return i11 + this.overflowEntries.hashCode();
        }
        return i11;
    }
