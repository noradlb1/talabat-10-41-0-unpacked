...
public final class Struct extends GeneratedMessageLite<Struct, Builder> implements StructOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Struct, Builder> implements StructOrBuilder {
        ...
        public Builder clearFields() {
            d();
            ((Struct) this.f35783b).getMutableFieldsMap().clear();
            return this;
        }

        public boolean containsFields(String str) {
            str.getClass();
            return ((Struct) this.f35783b).getFieldsMap().containsKey(str);
        }
        ...
        public int getFieldsCount() {
            return ((Struct) this.f35783b).getFieldsMap().size();
        }

        public Map<String, Value> getFieldsMap() {
            return Collections.unmodifiableMap(((Struct) this.f35783b).getFieldsMap());
        }

        public Value getFieldsOrDefault(String str, Value value) {
            str.getClass();
            Map<String, Value> fieldsMap = ((Struct) this.f35783b).getFieldsMap();
        ...
        public Builder putAllFields(Map<String, Value> map) {
            d();
            ((Struct) this.f35783b).getMutableFieldsMap().putAll(map);
            return this;
        }
        ...
        public Builder putFields(String str, Value value) {
            ...
            value.getClass();
            d();
            ((Struct) this.f35783b).getMutableFieldsMap().put(str, value);
            return this;
        }
        ...
        public Builder removeFields(String str) {
            str.getClass();
            d();
            ((Struct) this.f35783b).getMutableFieldsMap().remove(str);
            return this;
        }
    ...
    public static final class FieldsDefaultEntryHolder {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final MapEntryLite<String, Value> f35827a = MapEntryLite.newDefaultInstance(WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Value.getDefaultInstance());
    ...
    public final Object m(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.f35826a[methodToInvoke.ordinal()]) {
            case 1:
                return new Struct();
            case 2:
                return new Builder((AnonymousClass1) null);
            case 3:
                return GeneratedMessageLite.v(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0001\u0000\u0000\u00012", new Object[]{"fields_", FieldsDefaultEntryHolder.f35827a});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
