...
public final class BoolValue extends GeneratedMessageLite<BoolValue, Builder> implements BoolValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<BoolValue, Builder> implements BoolValueOrBuilder {
        ...
        public Builder clearValue() {
            d();
            ((BoolValue) this.f35783b).clearValue();
            return this;
        }

        public boolean getValue() {
            return ((BoolValue) this.f35783b).getValue();
        }

        public Builder setValue(boolean z11) {
            d();
            ((BoolValue) this.f35783b).setValue(z11);
            return this;
        }
    ...
    public final Object m(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.f35747a[methodToInvoke.ordinal()]) {
            case 1:
