...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f35777b     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f35777b     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                r3 = 4
                int[] r4 = f35777b     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                r4 = 5
                int[] r5 = f35777b     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                r5 = 6
                int[] r6 = f35777b     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                r6 = 7
                int[] r7 = f35777b     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                r7 = 8
                int[] r8 = f35777b     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                r8 = 9
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r9 = f35777b     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00e9:
                int[] r1 = f35776a     // Catch:{ NoSuchFieldError -> 0x00f3 }
            ...
            L_0x00f3:
                int[] r0 = f35776a     // Catch:{ NoSuchFieldError -> 0x00fd }
            ...
            L_0x00fd:
                int[] r0 = f35776a     // Catch:{ NoSuchFieldError -> 0x0107 }
            ...
            L_0x0107:
                int[] r0 = f35776a     // Catch:{ NoSuchFieldError -> 0x0111 }
            ...
            L_0x0111:
                int[] r0 = f35776a     // Catch:{ NoSuchFieldError -> 0x011b }
            ...
            L_0x011b:
                int[] r0 = f35776a     // Catch:{ NoSuchFieldError -> 0x0125 }
            ...
            L_0x0125:
                int[] r0 = f35776a     // Catch:{ NoSuchFieldError -> 0x012f }
            ...
            L_0x012f:
                int[] r0 = f35776a     // Catch:{ NoSuchFieldError -> 0x0139 }
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private void mergeFromField(Map.Entry<T, Object> entry) {
            ...
            if (fieldDescriptorLite.isRepeated()) {
                ...
                for (Object g11 : (List) value) {
                    ((List) field).add(FieldSet.cloneIfMutable(g11));
                }
        ...
        public void addRepeatedField(T t11, Object obj) {
            ...
            if (t11.isRepeated()) {
                ...
                verifyType(t11.getLiteType(), obj);
        ...
        public Object b(T t11, int i11) {
            if (t11.isRepeated()) {
                Object a11 = a(t11);
                if (a11 != null) {
                    return ((List) a11).get(i11);
                }
        ...
        public Map<T, Object> getAllFields() {
            if (this.hasLazyField) {
                SmallSortedMap a11 = FieldSet.cloneAllFieldsMap(this.fields, false);
        ...
        public Object getField(T t11) {
            return replaceBuilders(t11, a(t11));
        }
        ...
        public Object getRepeatedField(T t11, int i11) {
            ...
            return replaceBuilder(b(t11, i11));
        }
        ...
        public boolean isInitialized() {
            ...
            for (Map.Entry<T, Object> f11 : this.fields.getOverflowEntries()) {
                if (!FieldSet.isInitialized(f11)) {
                    return false;
                }
            }
            return true;
        ...
        public void setField(T t11, Object obj) {
            ...
            if (!t11.isRepeated()) {
                ...
                for (Object next : arrayList) {
                    verifyType(t11.getLiteType(), next);
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z11) {
        SmallSortedMap<T, Object> g11 = SmallSortedMap.g(16);
        for (int i11 = 0; i11 < smallSortedMap.getNumArrayEntries(); i11++) {
            cloneFieldEntry(g11, smallSortedMap.getArrayEntryAt(i11), z11);
        }
        for (Map.Entry<T, Object> cloneFieldEntry : smallSortedMap.getOverflowEntries()) {
            cloneFieldEntry(g11, cloneFieldEntry, z11);
        }
        return g11;
    }
    ...
    public static int h(WireFormat.FieldType fieldType, int i11, Object obj) {
    ...
    public static int i(WireFormat.FieldType fieldType, Object obj) {
        switch (AnonymousClass1.f35777b[fieldType.ordinal()]) {
            case 1:
    ...
    public static boolean isValidType(WireFormat.FieldType fieldType, Object obj) {
        Internal.a(obj);
        switch (AnonymousClass1.f35776a[fieldType.getJavaType().ordinal()]) {
            case 1:
    ...
    public static int k(WireFormat.FieldType fieldType, boolean z11) {
        if (z11) {
            return 2;
        }
    ...
    public static void m(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i11, Object obj) throws IOException {
        if (fieldType == WireFormat.FieldType.GROUP) {
            codedOutputStream.writeGroup(i11, (MessageLite) obj);
            return;
        }
        codedOutputStream.writeTag(i11, k(fieldType, false));
    ...
    public static void n(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, Object obj) throws IOException {
        switch (AnonymousClass1.f35777b[fieldType.ordinal()]) {
            case 1:
    ...
    public static void writeField(FieldDescriptorLite<?> fieldDescriptorLite, Object obj, CodedOutputStream codedOutputStream) throws IOException {
        ...
        if (fieldDescriptorLite.isRepeated()) {
            ...
            if (fieldDescriptorLite.isPacked()) {
                ...
                for (Object n11 : list) {
                    n(codedOutputStream, liteType, n11);
                }
                return;
            }
            for (Object m11 : list) {
                m(codedOutputStream, liteType, number, m11);
            }
    ...
    public Iterator<Map.Entry<T, Object>> j() {
        if (this.hasLazyField) {
            return new LazyField.LazyIterator(this.fields.f().iterator());
        }
        return this.fields.f().iterator();
    }
    ...
    public void setField(T t11, Object obj) {
        if (!t11.isRepeated()) {
            ...
            for (Object verifyType : arrayList) {
                verifyType(t11.getLiteType(), verifyType);
            }
            obj = arrayList;
        } else {
            throw new IllegalArgumentException("Wrong object type used with protocol message reflection.");
