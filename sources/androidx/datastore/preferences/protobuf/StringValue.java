...
public final class StringValue extends GeneratedMessageLite<StringValue, Builder> implements StringValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<StringValue, Builder> implements StringValueOrBuilder {
        ...
        public Builder clearValue() {
            d();
            ((StringValue) this.f35783b).clearValue();
            return this;
        }

        public String getValue() {
            return ((StringValue) this.f35783b).getValue();
        }

        public ByteString getValueBytes() {
            return ((StringValue) this.f35783b).getValueBytes();
        }

        public Builder setValue(String str) {
            d();
            ((StringValue) this.f35783b).setValue(str);
            return this;
        }

        public Builder setValueBytes(ByteString byteString) {
            d();
            ((StringValue) this.f35783b).setValueBytes(byteString);
            return this;
        }
    ...
    public final Object m(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.f35825a[methodToInvoke.ordinal()]) {
            case 1:
                return new StringValue();
            case 2:
                return new Builder((AnonymousClass1) null);
            case 3:
                return GeneratedMessageLite.v(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001Ȉ", new Object[]{"value_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
