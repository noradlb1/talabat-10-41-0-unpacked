...
public final class FloatValue extends GeneratedMessageLite<FloatValue, Builder> implements FloatValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<FloatValue, Builder> implements FloatValueOrBuilder {
        ...
        public Builder clearValue() {
            d();
            ((FloatValue) this.f35783b).clearValue();
            return this;
        }

        public float getValue() {
            return ((FloatValue) this.f35783b).getValue();
        }

        public Builder setValue(float f11) {
            d();
            ((FloatValue) this.f35783b).setValue(f11);
            return this;
        }
    ...
    public final Object m(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (AnonymousClass1.f35781a[methodToInvoke.ordinal()]) {
            case 1:
