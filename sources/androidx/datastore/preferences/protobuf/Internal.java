...
public final class Internal {
    ...
    public static final Charset f35797a = Charset.forName("UTF-8");

    /* renamed from: b  reason: collision with root package name */
    public static final Charset f35798b = Charset.forName("ISO-8859-1");
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        public class IteratorAdapter implements Iterator<Map.Entry<K, V>>, j$.util.Iterator {
    ...
    public static ByteString bytesDefaultValue(String str) {
        return ByteString.copyFrom(str.getBytes(f35798b));
    }

    public static int c(byte[] bArr, int i11, int i12) {
    ...
    public static String stringDefaultValue(String str) {
        return new String(str.getBytes(f35798b), f35797a);
    }

    public static byte[] toByteArray(String str) {
        return str.getBytes(f35797a);
    }

    public static String toStringUtf8(byte[] bArr) {
        return new String(bArr, f35797a);
    }
    ...
    public static int hashCodeByteBuffer(ByteBuffer byteBuffer) {
        if (byteBuffer.hasArray()) {
            int e11 = e(byteBuffer.capacity(), byteBuffer.array(), byteBuffer.arrayOffset(), byteBuffer.capacity());
            if (e11 == 0) {
                return 1;
            }
            return e11;
        ...
        while (duplicate.remaining() > 0) {
            ...
            capacity = e(capacity, bArr, 0, remaining);
        }
        if (capacity == 0) {
            return 1;
        }
