...
final class CodedOutputStreamWriter implements Writer {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f35762a     // Catch:{ NoSuchFieldError -> 0x0090 }
    ...
    private CodedOutputStreamWriter(CodedOutputStream codedOutputStream) {
        ...
        codedOutputStream2.f35757a = this;
    }

    public static CodedOutputStreamWriter forCodedOutput(CodedOutputStream codedOutputStream) {
        CodedOutputStreamWriter codedOutputStreamWriter = codedOutputStream.f35757a;
    ...
    private <V> void writeDeterministicBooleanMapEntry(int i11, boolean z11, V v11, MapEntryLite.Metadata<Boolean, V> metadata) throws IOException {
        ...
        this.output.writeUInt32NoTag(MapEntryLite.a(metadata, Boolean.valueOf(z11), v11));
        MapEntryLite.e(this.output, metadata, Boolean.valueOf(z11), v11);
    }
    ...
    private <V> void writeDeterministicIntegerMap(int i11, MapEntryLite.Metadata<Integer, V> metadata, Map<Integer, V> map) throws IOException {
        ...
        for (int i13 = 0; i13 < size; i13++) {
            ...
            this.output.writeTag(i11, 2);
            this.output.writeUInt32NoTag(MapEntryLite.a(metadata, Integer.valueOf(i14), v11));
            MapEntryLite.e(this.output, metadata, Integer.valueOf(i14), v11);
        }
    }
    ...
    private <V> void writeDeterministicLongMap(int i11, MapEntryLite.Metadata<Long, V> metadata, Map<Long, V> map) throws IOException {
        ...
        for (int i13 = 0; i13 < size; i13++) {
            ...
            this.output.writeTag(i11, 2);
            this.output.writeUInt32NoTag(MapEntryLite.a(metadata, Long.valueOf(j11), v11));
            MapEntryLite.e(this.output, metadata, Long.valueOf(j11), v11);
        }
    }

    private <K, V> void writeDeterministicMap(int i11, MapEntryLite.Metadata<K, V> metadata, Map<K, V> map) throws IOException {
        switch (AnonymousClass1.f35762a[metadata.keyType.ordinal()]) {
            case 1:
    ...
    private <V> void writeDeterministicStringMap(int i11, MapEntryLite.Metadata<String, V> metadata, Map<String, V> map) throws IOException {
        ...
        for (int i13 = 0; i13 < size; i13++) {
            ...
            V v11 = map.get(str2);
            this.output.writeTag(i11, 2);
            this.output.writeUInt32NoTag(MapEntryLite.a(metadata, str2, v11));
            MapEntryLite.e(this.output, metadata, str2, v11);
        }
    }
    ...
    public <K, V> void writeMap(int i11, MapEntryLite.Metadata<K, V> metadata, Map<K, V> map) throws IOException {
        ...
        for (Map.Entry next : map.entrySet()) {
            this.output.writeTag(i11, 2);
            this.output.writeUInt32NoTag(MapEntryLite.a(metadata, next.getKey(), next.getValue()));
            MapEntryLite.e(this.output, metadata, next.getKey(), next.getValue());
        }
    }
    ...
    public void writeGroup(int i11, Object obj, Schema schema) throws IOException {
        this.output.l(i11, (MessageLite) obj, schema);
    }

    public void writeMessage(int i11, Object obj, Schema schema) throws IOException {
        this.output.n(i11, (MessageLite) obj, schema);
    }
