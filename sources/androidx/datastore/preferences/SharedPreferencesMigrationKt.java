...
public final class SharedPreferencesMigrationKt {
    ...
    public static /* synthetic */ SharedPreferencesMigration SharedPreferencesMigration$default(Function0 function0, Set<String> set, int i11, Object obj) {
        if ((i11 & 2) != 0) {
    ...
    public static /* synthetic */ SharedPreferencesMigration SharedPreferencesMigration$default(Context context, String str, Set<String> set, int i11, Object obj) {
        if ((i11 & 4) != 0) {
            set = MIGRATE_ALL_KEYS;
        }
