...
public final class PreferenceDataStore implements DataStore<Preferences> {
    ...
    public PreferenceDataStore(@NotNull DataStore<Preferences> dataStore) {
        Intrinsics.checkNotNullParameter(dataStore, MethodDelegation.ImplementationDelegate.FIELD_NAME_PREFIX);
    ...
    public Object updateData(@NotNull Function2<? super Preferences, ? super Continuation<? super Preferences>, ? extends Object> function2, @NotNull Continuation<? super Preferences> continuation) {
        return this.delegate.updateData(new PreferenceDataStore$updateData$2(function2, (Continuation<? super PreferenceDataStore$updateData$2>) null), continuation);
    }
}
