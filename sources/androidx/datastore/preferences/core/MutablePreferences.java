...
public final class MutablePreferences extends Preferences {
    ...
    public /* synthetic */ MutablePreferences(Map map, boolean z11, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof MutablePreferences) {
            return Intrinsics.areEqual((Object) this.preferencesMap, (Object) ((MutablePreferences) obj).preferencesMap);
        }
        return false;
    }
    ...
    public final <T> void set(@NotNull Preferences.Key<T> key, T t11) {
        Intrinsics.checkNotNullParameter(key, "key");
        setUnchecked$datastore_preferences_core(key, t11);
    }
    ...
    public MutablePreferences(@NotNull Map<Preferences.Key<?>, Object> map, boolean z11) {
