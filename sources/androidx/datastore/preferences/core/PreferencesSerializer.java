...
public final class PreferencesSerializer implements Serializer<Preferences> {
    ...
    private final void addProtoEntryToPreferences(String str, PreferencesProto.Value value, MutablePreferences mutablePreferences) {
        ...
        if (valueCase == null) {
            ...
            i11 = WhenMappings.$EnumSwitchMapping$0[valueCase.ordinal()];
        }
        switch (i11) {
            case -1:
    ...
    @Nullable
    public Object writeTo(@NotNull Preferences preferences, @NotNull OutputStream outputStream, @NotNull Continuation<? super Unit> continuation) throws IOException, CorruptionException {
