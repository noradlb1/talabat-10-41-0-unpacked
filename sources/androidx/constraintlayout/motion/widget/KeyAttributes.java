...
public class KeyAttributes extends Key {
        ...
        public static void read(KeyAttributes keyAttributes, TypedArray typedArray) {
            ...
            for (int i11 = 0; i11 < indexCount; i11++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 10:
                        if (!MotionLayout.IS_IN_EDIT_MODE) {
                            if (typedArray.peekValue(index).type != 3) {
                                keyAttributes.f10872b = typedArray.getResourceId(index, keyAttributes.f10872b);
                                break;
                            } else {
                                keyAttributes.f10873c = typedArray.getString(index);
                                break;
                            }
                        } else {
                            int resourceId = typedArray.getResourceId(index, keyAttributes.f10872b);
                            keyAttributes.f10872b = resourceId;
                            if (resourceId != -1) {
                                break;
                            } else {
                                keyAttributes.f10873c = typedArray.getString(index);
                    ...
                    case 12:
                        keyAttributes.f10871a = typedArray.getInt(index, keyAttributes.f10871a);
                        break;
                    case 13:
    ...
    public void addValues(java.util.HashMap<java.lang.String, androidx.constraintlayout.motion.utils.ViewSpline> r7) {
        ...
        L_0x001d:
            ...
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r3 = r6.f10875e
