...
public class KeyTimeCycle extends Key {
        ...
        public static void read(KeyTimeCycle keyTimeCycle, TypedArray typedArray) {
            ...
            for (int i11 = 0; i11 < indexCount; i11++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 10:
                        if (!MotionLayout.IS_IN_EDIT_MODE) {
                            if (typedArray.peekValue(index).type != 3) {
                                keyTimeCycle.f10872b = typedArray.getResourceId(index, keyTimeCycle.f10872b);
                                break;
                            } else {
                                keyTimeCycle.f10873c = typedArray.getString(index);
                                break;
                            }
                        } else {
                            int resourceId = typedArray.getResourceId(index, keyTimeCycle.f10872b);
                            keyTimeCycle.f10872b = resourceId;
                            if (resourceId != -1) {
                                break;
                            } else {
                                keyTimeCycle.f10873c = typedArray.getString(index);
                    ...
                    case 12:
                        keyTimeCycle.f10871a = typedArray.getInt(index, keyTimeCycle.f10871a);
                        break;
                    case 13:
    ...
    public void addTimeValues(java.util.HashMap<java.lang.String, androidx.constraintlayout.motion.utils.ViewTimeCycle> r11) {
        ...
        L_0x001e:
            ...
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r2 = r10.f10875e
