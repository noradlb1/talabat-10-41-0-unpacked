...
public class KeyCycle extends Key {
        ...
        public static void read(KeyCycle keyCycle, TypedArray typedArray) {
            ...
            for (int i11 = 0; i11 < indexCount; i11++) {
                ...
                switch (mAttrMap.get(index)) {
                    case 1:
                        if (!MotionLayout.IS_IN_EDIT_MODE) {
                            if (typedArray.peekValue(index).type != 3) {
                                keyCycle.f10872b = typedArray.getResourceId(index, keyCycle.f10872b);
                                break;
                            } else {
                                keyCycle.f10873c = typedArray.getString(index);
                                break;
                            }
                        } else {
                            int resourceId = typedArray.getResourceId(index, keyCycle.f10872b);
                            keyCycle.f10872b = resourceId;
                            if (resourceId != -1) {
                                break;
                            } else {
                                keyCycle.f10873c = typedArray.getString(index);
                    ...
                    case 2:
                        keyCycle.f10871a = typedArray.getInt(index, keyCycle.f10871a);
                        break;
                    case 3:
    ...
    public void addCycleValues(HashMap<String, ViewOscillator> hashMap) {
        ...
        for (String next : hashMap.keySet()) {
            if (next.startsWith("CUSTOM")) {
                ConstraintAttribute constraintAttribute = this.f10875e.get(next.substring(7));
                if (!(constraintAttribute == null || constraintAttribute.getType() != ConstraintAttribute.AttributeType.FLOAT_TYPE || (viewOscillator2 = hashMap2.get(next)) == null)) {
                    viewOscillator2.setPoint(this.f10871a, this.mWaveShape, this.mCustomWaveShape, this.mWaveVariesBy, this.mWavePeriod, this.mWaveOffset, this.mWavePhase, constraintAttribute.getValueToInterpolate(), constraintAttribute);
                }
            } else {
                float value = getValue(next);
                if (!Float.isNaN(value) && (viewOscillator = hashMap2.get(next)) != null) {
                    viewOscillator.setPoint(this.f10871a, this.mWaveShape, this.mCustomWaveShape, this.mWaveVariesBy, this.mWavePeriod, this.mWaveOffset, this.mWavePhase, value);
                }
            }
        }
    }
    ...
    public void addValues(HashMap<String, ViewSpline> hashMap) {
        ...
        for (String next : hashMap.keySet()) {
            ...
            if (splineSet != null) {
                ...
                switch (c11) {
                    case 0:
                        splineSet.setPoint(this.f10871a, this.mRotationX);
                        break;
                    case 1:
                        splineSet.setPoint(this.f10871a, this.mRotationY);
                        break;
                    case 2:
                        splineSet.setPoint(this.f10871a, this.mTranslationX);
                        break;
                    case 3:
                        splineSet.setPoint(this.f10871a, this.mTranslationY);
                        break;
                    case 4:
                        splineSet.setPoint(this.f10871a, this.mTranslationZ);
                        break;
                    case 5:
                        splineSet.setPoint(this.f10871a, this.mProgress);
                        break;
                    case 6:
                        splineSet.setPoint(this.f10871a, this.mScaleX);
                        break;
                    case 7:
                        splineSet.setPoint(this.f10871a, this.mScaleY);
                        break;
                    case 8:
                        splineSet.setPoint(this.f10871a, this.mRotation);
                        break;
                    case 9:
                        splineSet.setPoint(this.f10871a, this.mElevation);
                        break;
                    case 10:
                        splineSet.setPoint(this.f10871a, this.mTransitionPathRotate);
                        break;
                    case 11:
                        splineSet.setPoint(this.f10871a, this.mAlpha);
                        break;
                    case 12:
                        splineSet.setPoint(this.f10871a, this.mWaveOffset);
                        break;
                    case 13:
                        splineSet.setPoint(this.f10871a, this.mWavePhase);
                        break;
                    default:
                        if (next.startsWith("CUSTOM")) {
                            break;
    ...
    public void getAttributeNames(HashSet<String> hashSet) {
        ...
        if (this.f10875e.size() > 0) {
            for (String str : this.f10875e.keySet()) {
