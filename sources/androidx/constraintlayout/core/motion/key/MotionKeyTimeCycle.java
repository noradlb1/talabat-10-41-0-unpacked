...
public class MotionKeyTimeCycle extends MotionKey {
    ...
    public boolean setValue(int i11, float f11) {
        if (i11 == 315) {
            this.mProgress = a(Float.valueOf(f11));
            return true;
        } else if (i11 == 401) {
            this.mCurveFit = b(Float.valueOf(f11));
            return true;
        } else if (i11 == 403) {
            this.mAlpha = f11;
            return true;
        } else if (i11 == 416) {
            this.mTransitionPathRotate = a(Float.valueOf(f11));
            return true;
        } else if (i11 == 423) {
            this.mWavePeriod = a(Float.valueOf(f11));
            return true;
        } else if (i11 != 424) {
            switch (i11) {
                case 304:
                    this.mTranslationX = a(Float.valueOf(f11));
                    return true;
                case 305:
                    this.mTranslationY = a(Float.valueOf(f11));
                    return true;
                case 306:
                    this.mTranslationZ = a(Float.valueOf(f11));
                    return true;
                case 307:
                    this.mElevation = a(Float.valueOf(f11));
                    return true;
                case 308:
                    this.mRotationX = a(Float.valueOf(f11));
                    return true;
                case 309:
                    this.mRotationY = a(Float.valueOf(f11));
                    return true;
                case 310:
                    this.mRotation = a(Float.valueOf(f11));
                    return true;
                case 311:
                    this.mScaleX = a(Float.valueOf(f11));
                    return true;
                case 312:
                    this.mScaleY = a(Float.valueOf(f11));
                    return true;
                default:
                    return super.setValue(i11, f11);
            }
        } else {
            this.mWaveOffset = a(Float.valueOf(f11));
            return true;
        }
    }
