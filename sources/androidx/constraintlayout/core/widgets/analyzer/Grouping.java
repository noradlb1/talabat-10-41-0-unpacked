...
public class Grouping {
    ...
    public static WidgetGroup findDependents(ConstraintWidget constraintWidget, int i11, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        ...
        if (i11 == 0) {
            i12 = constraintWidget.horizontalGroup;
        } else {
            i12 = constraintWidget.verticalGroup;
        }
        int i13 = 0;
        if (i12 != -1 && (widgetGroup == null || i12 != widgetGroup.f10819b)) {
            int i14 = 0;
            while (true) {
                if (i14 >= arrayList.size()) {
                    break;
                }
                WidgetGroup widgetGroup2 = arrayList.get(i14);
        ...
        if (widgetGroup == null) {
            if ((constraintWidget instanceof HelperWidget) && (findGroupInDependents = ((HelperWidget) constraintWidget).findGroupInDependents(i11)) != -1) {
                ...
                while (true) {
                    ...
                    WidgetGroup widgetGroup3 = arrayList.get(i15);
        ...
        if (widgetGroup.add(constraintWidget)) {
            if (constraintWidget instanceof Guideline) {
                ...
                anchor.findDependents(i13, arrayList, widgetGroup);
            }
            if (i11 == 0) {
