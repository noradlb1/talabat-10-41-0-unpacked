...
public class Direct {
    ...
    private static void horizontalSolvingPass(int i11, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z11) {
        ...
        if (!constraintWidget.isHorizontalSolvingPassDone()) {
            ...
            if (!(constraintWidget2 instanceof ConstraintWidgetContainer) && constraintWidget.isMeasureRequested()) {
                int i12 = i11 + 1;
                if (canMeasure(i12, constraintWidget2)) {
                    ConstraintWidgetContainer.measure(i12, constraintWidget2, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                }
            }
            ...
            if (anchor.getDependents() != null && anchor.hasFinalValue()) {
                ...
                while (it.hasNext()) {
                    ...
                    int i13 = i11 + 1;
                    boolean canMeasure = canMeasure(i13, constraintWidget3);
                    if (constraintWidget3.isMeasureRequested() && canMeasure) {
                        ConstraintWidgetContainer.measure(i13, constraintWidget3, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                    }
                    ...
                    if (horizontalDimensionBehaviour != dimensionBehaviour || canMeasure) {
                        if (!constraintWidget3.isMeasureRequested()) {
                            ...
                            if (next == constraintAnchor5 && constraintWidget3.mRight.mTarget == null) {
                                ...
                                horizontalSolvingPass(i13, constraintWidget3, measurer2, z14);
                            } else {
                                ...
                                if (next == constraintAnchor6 && constraintAnchor5.mTarget == null) {
                                    ...
                                    solveHorizontalCenterConstraints(i13, measurer2, constraintWidget3, z14);
                                }
                            }
                        }
                    } else if (constraintWidget3.getHorizontalDimensionBehaviour() == dimensionBehaviour && constraintWidget3.mMatchConstraintMaxWidth >= 0 && constraintWidget3.mMatchConstraintMinWidth >= 0 && ((constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultWidth == 0 && constraintWidget3.getDimensionRatio() == 0.0f)) && !constraintWidget3.isInHorizontalChain() && !constraintWidget3.isInVirtualLayout() && z13 && !constraintWidget3.isInHorizontalChain())) {
                        solveHorizontalMatchConstraint(i13, constraintWidget2, measurer2, constraintWidget3, z14);
                    }
                    z15 = true;
                }
            }
            if (!(constraintWidget2 instanceof Guideline)) {
                if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        int i14 = i11 + 1;
                        boolean canMeasure2 = canMeasure(i14, constraintWidget4);
                        if (constraintWidget4.isMeasureRequested() && canMeasure2) {
                            ConstraintWidgetContainer.measure(i14, constraintWidget4, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                        }
                        ...
                        if (horizontalDimensionBehaviour2 != dimensionBehaviour2 || canMeasure2) {
                            if (!constraintWidget4.isMeasureRequested()) {
                                ...
                                if (next2 == constraintAnchor7 && constraintWidget4.mRight.mTarget == null) {
                                    ...
                                    horizontalSolvingPass(i14, constraintWidget4, measurer2, z14);
                                } else {
                                    ...
                                    if (next2 == constraintAnchor8 && constraintAnchor7.mTarget == null) {
                                        ...
                                        horizontalSolvingPass(i14, constraintWidget4, measurer2, z14);
                                    } else if (z12 && !constraintWidget4.isInHorizontalChain()) {
                                        solveHorizontalCenterConstraints(i14, measurer2, constraintWidget4, z14);
                                    }
                                }
                            }
                            ...
                            if ((constraintWidget4.getVisibility() == 8 || (constraintWidget4.mMatchConstraintDefaultWidth == 0 && constraintWidget4.getDimensionRatio() == 0.0f)) && !constraintWidget4.isInHorizontalChain() && !constraintWidget4.isInVirtualLayout() && z12 && !constraintWidget4.isInHorizontalChain()) {
                                solveHorizontalMatchConstraint(i14, constraintWidget2, measurer2, constraintWidget4, z14);
                            }
                        }
                    }
                }
    ...
    private static void solveHorizontalCenterConstraints(int i11, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget, boolean z11) {
        ...
        if (i12 > 0) {
            f11 = (horizontalBiasPercent * ((float) i12)) + 0.5f;
        } else {
            f11 = horizontalBiasPercent * ((float) i12);
        }
        int i13 = ((int) f11) + finalValue;
        int i14 = i13 + width;
        if (finalValue > finalValue2) {
            i14 = i13 - width;
        }
            ...
            if (constraintWidget2.getVisibility() != 8) {
                ...
                if (i13 == 2) {
                    if (constraintWidget instanceof ConstraintWidgetContainer) {
                        i12 = constraintWidget.getWidth();
                    } else {
                        i12 = constraintWidget.getParent().getWidth();
                    }
                    width = (int) (constraintWidget2.getHorizontalBiasPercent() * 0.5f * ((float) i12));
                } else if (i13 == 0) {
                    width = finalValue2 - finalValue;
                }
                width = Math.max(constraintWidget2.mMatchConstraintMinWidth, width);
                int i14 = constraintWidget2.mMatchConstraintMaxWidth;
                if (i14 > 0) {
                    width = Math.min(i14, width);
                }
            }
            int i15 = finalValue + ((int) ((horizontalBiasPercent * ((float) ((finalValue2 - finalValue) - width))) + 0.5f));
            constraintWidget2.setFinalHorizontal(i15, width + i15);
    ...
    private static void solveVerticalCenterConstraints(int i11, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget) {
        ...
        if (i12 > 0) {
            f11 = (verticalBiasPercent * ((float) i12)) + 0.5f;
        } else {
            f11 = verticalBiasPercent * ((float) i12);
        }
        int i13 = (int) f11;
    ...
    private static void solveVerticalMatchConstraint(int i11, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2) {
        ...
        if (finalValue2 >= finalValue) {
            ...
            if (constraintWidget2.getVisibility() != 8) {
                ...
                if (i13 == 2) {
                    if (constraintWidget instanceof ConstraintWidgetContainer) {
                        i12 = constraintWidget.getHeight();
                    } else {
                        i12 = constraintWidget.getParent().getHeight();
                    }
                    height = (int) (verticalBiasPercent * 0.5f * ((float) i12));
                } else if (i13 == 0) {
            ...
            int i15 = finalValue + ((int) ((verticalBiasPercent * ((float) ((finalValue2 - finalValue) - height))) + 0.5f));
            constraintWidget2.setFinalVertical(i15, height + i15);
                    ...
                    if (verticalDimensionBehaviour != dimensionBehaviour || canMeasure) {
                        if (!constraintWidget3.isMeasureRequested()) {
                            ...
                            if (next == constraintAnchor5 && constraintWidget3.mBottom.mTarget == null) {
                                ...
                                verticalSolvingPass(i13, constraintWidget3, measurer2);
                            } else {
                                ...
                                if (next == constraintAnchor6 && constraintAnchor5.mTarget == null) {
                                    ...
                                    verticalSolvingPass(i13, constraintWidget3, measurer2);
                                } else if (z12 && !constraintWidget3.isInVerticalChain()) {
                                    solveVerticalCenterConstraints(i13, measurer2, constraintWidget3);
                                }
                            }
                        }
                        ...
                        if ((constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultHeight == 0 && constraintWidget3.getDimensionRatio() == 0.0f)) && !constraintWidget3.isInVerticalChain() && !constraintWidget3.isInVirtualLayout() && z12 && !constraintWidget3.isInVerticalChain()) {
                            solveVerticalMatchConstraint(i13, constraintWidget2, measurer2, constraintWidget3);
                        }
                    }
                }
            }
            if (!(constraintWidget2 instanceof Guideline)) {
                        ...
                        if (verticalDimensionBehaviour2 != dimensionBehaviour2 || canMeasure2) {
                            if (!constraintWidget4.isMeasureRequested()) {
                                ...
                                if (next2 == constraintAnchor7 && constraintWidget4.mBottom.mTarget == null) {
                                    ...
                                    verticalSolvingPass(i14, constraintWidget4, measurer2);
                                } else {
                                    ...
                                    if (next2 == constraintAnchor8 && constraintAnchor7.mTarget == null) {
                                        ...
                                        verticalSolvingPass(i14, constraintWidget4, measurer2);
                                    } else if (z11 && !constraintWidget4.isInVerticalChain()) {
                                        solveVerticalCenterConstraints(i14, measurer2, constraintWidget4);
                                    }
                                }
                            }
                            ...
                            if ((constraintWidget4.getVisibility() == 8 || (constraintWidget4.mMatchConstraintDefaultHeight == 0 && constraintWidget4.getDimensionRatio() == 0.0f)) && !constraintWidget4.isInVerticalChain() && !constraintWidget4.isInVirtualLayout() && z11 && !constraintWidget4.isInVerticalChain()) {
                                solveVerticalMatchConstraint(i14, constraintWidget2, measurer2, constraintWidget4);
                            }
                        }
                    }
                }
                ...
                if (anchor3.getDependents() != null && anchor3.hasFinalValue()) {
                    ...
                    while (it3.hasNext()) {
                        ...
                        int i15 = i11 + 1;
                        boolean canMeasure3 = canMeasure(i15, constraintWidget5);
                        if (constraintWidget5.isMeasureRequested() && canMeasure3) {
                            ConstraintWidgetContainer.measure(i15, constraintWidget5, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                        }
                        if ((constraintWidget5.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure3) && !constraintWidget5.isMeasureRequested() && next3 == constraintWidget5.mBaseline) {
                            ...
                            try {
                                verticalSolvingPass(i15, constraintWidget5, measurer2);
                            } catch (Throwable th2) {
                                throw th2;
                            }
                        }
