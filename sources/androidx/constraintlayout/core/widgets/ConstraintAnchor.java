...
public class ConstraintAnchor {
    ...
    public int f10763a = Integer.MIN_VALUE;

    /* renamed from: b  reason: collision with root package name */
    public SolverVariable f10764b;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f10765a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f10765a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f10765a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f10765a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f10765a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f10765a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f10765a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f10765a     // Catch:{ NoSuchFieldError -> 0x006c }
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i11, int i12, boolean z11) {
        if (constraintAnchor == null) {
            reset();
            return true;
        } else if (!z11 && !isValidConnection(constraintAnchor)) {
            return false;
        } else {
    ...
    public void copyFrom(ConstraintAnchor constraintAnchor, HashMap<ConstraintWidget, ConstraintWidget> hashMap) {
        ...
        this.f10763a = constraintAnchor.f10763a;
    }
    ...
    public int getMargin() {
        ...
        if (this.f10763a == Integer.MIN_VALUE || (constraintAnchor = this.mTarget) == null || constraintAnchor.mOwner.getVisibility() != 8) {
            return this.mMargin;
        }
        return this.f10763a;
    }
    ...
    public final ConstraintAnchor getOpposite() {
        switch (AnonymousClass1.f10765a[this.mType.ordinal()]) {
            case 1:
            case 6:
            case 7:
            case 8:
    ...
    public boolean isSimilarDimensionConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (AnonymousClass1.f10765a[type2.ordinal()]) {
            case 1:
    ...
    public void reset() {
        ...
        this.mTarget = null;
        this.mMargin = 0;
        this.f10763a = Integer.MIN_VALUE;
    ...
    public void resetSolverVariable(Cache cache) {
        SolverVariable solverVariable = this.f10764b;
        if (solverVariable == null) {
            this.f10764b = new SolverVariable(SolverVariable.Type.UNRESTRICTED, (String) null);
        } else {
