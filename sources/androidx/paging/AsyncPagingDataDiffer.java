...
public final class AsyncPagingDataDiffer<T> {
    ...
    @JvmOverloads
    public AsyncPagingDataDiffer(@NotNull DiffUtil.ItemCallback<T> itemCallback, @NotNull ListUpdateCallback listUpdateCallback, @NotNull CoroutineDispatcher coroutineDispatcher) {
        this(itemCallback, listUpdateCallback, coroutineDispatcher, (CoroutineDispatcher) null, 8, (DefaultConstructorMarker) null);
    }

    @JvmOverloads
    public AsyncPagingDataDiffer(@NotNull DiffUtil.ItemCallback<T> itemCallback, @NotNull ListUpdateCallback listUpdateCallback, @NotNull CoroutineDispatcher coroutineDispatcher, @NotNull CoroutineDispatcher coroutineDispatcher2) {
    ...
    public final Object submitData(@NotNull PagingData<T> pagingData, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (collectFrom == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            return collectFrom;
        }
    ...
    public /* synthetic */ AsyncPagingDataDiffer(DiffUtil.ItemCallback itemCallback, ListUpdateCallback listUpdateCallback, CoroutineDispatcher coroutineDispatcher, CoroutineDispatcher coroutineDispatcher2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(itemCallback, listUpdateCallback, (i11 & 4) != 0 ? Dispatchers.getMain() : coroutineDispatcher, (i11 & 8) != 0 ? Dispatchers.getDefault() : coroutineDispatcher2);
    }
}
