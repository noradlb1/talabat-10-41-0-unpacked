...
public final class Multicaster$flow$1 extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ Multicaster f37225i;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Multicaster$flow$1(Multicaster multicaster, Continuation continuation) {
        super(2, continuation);
        this.f37225i = multicaster;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        Intrinsics.checkNotNullParameter(continuation, "completion");
        Multicaster$flow$1 multicaster$flow$1 = new Multicaster$flow$1(this.f37225i, continuation);
