...
public final class SharedFlowProducer<T> {
    ...
    public SharedFlowProducer(@NotNull CoroutineScope coroutineScope, @NotNull Flow<? extends T> flow, @NotNull Function2<? super ChannelManager.Message.Dispatch<T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
    ...
    public final Object cancelAndJoin(@NotNull Continuation<? super Unit> continuation) {
        ...
        if (cancelAndJoin == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
