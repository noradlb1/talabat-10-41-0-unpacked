...
public final class SimpleProducerScopeImpl<T> implements SimpleProducerScope<T>, CoroutineScope, SendChannel<T> {
    ...
    public SimpleProducerScopeImpl(@NotNull CoroutineScope coroutineScope, @NotNull SendChannel<? super T> sendChannel) {
    ...
    public java.lang.Object awaitClose(@org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function0<kotlin.Unit> r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L_0x0013:
            ...
            r0.<init>(r5, r7)
        L_0x0018:
            java.lang.Object r7 = r0.f37141h
            java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()
            int r2 = r0.f37142i
            r3 = 1
            if (r2 == 0) goto L_0x0039
            if (r2 != r3) goto L_0x0031
            java.lang.Object r6 = r0.f37145l
            kotlinx.coroutines.Job r6 = (kotlinx.coroutines.Job) r6
            java.lang.Object r6 = r0.f37144k
            kotlin.jvm.functions.Function0 r6 = (kotlin.jvm.functions.Function0) r6
            kotlin.ResultKt.throwOnFailure(r7)     // Catch:{ all -> 0x0086 }
            goto L_0x0074
        L_0x0031:
        ...
        L_0x0039:
            ...
            kotlin.coroutines.CoroutineContext r7 = r5.getCoroutineContext()     // Catch:{ all -> 0x0086 }
            kotlinx.coroutines.Job$Key r2 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x0086 }
            kotlin.coroutines.CoroutineContext$Element r7 = r7.get(r2)     // Catch:{ all -> 0x0086 }
            if (r7 == 0) goto L_0x007a
            kotlinx.coroutines.Job r7 = (kotlinx.coroutines.Job) r7     // Catch:{ all -> 0x0086 }
            r0.f37144k = r6     // Catch:{ all -> 0x0086 }
            r0.f37145l = r7     // Catch:{ all -> 0x0086 }
            r0.f37142i = r3     // Catch:{ all -> 0x0086 }
            kotlinx.coroutines.CancellableContinuationImpl r2 = new kotlinx.coroutines.CancellableContinuationImpl     // Catch:{ all -> 0x0086 }
            kotlin.coroutines.Continuation r4 = kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.intercepted(r0)     // Catch:{ all -> 0x0086 }
            r2.<init>(r4, r3)     // Catch:{ all -> 0x0086 }
            r2.initCancellability()     // Catch:{ all -> 0x0086 }
            ...
            r7.invokeOnCompletion(r3)     // Catch:{ all -> 0x0086 }
            java.lang.Object r7 = r2.getResult()     // Catch:{ all -> 0x0086 }
            java.lang.Object r2 = kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch:{ all -> 0x0086 }
            if (r7 != r2) goto L_0x0071
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r0)     // Catch:{ all -> 0x0086 }
        L_0x0071:
    ...
    public boolean offer(T t11) {
        return this.channel.offer(t11);
    }

    @Nullable
    public Object send(T t11, @NotNull Continuation<? super Unit> continuation) {
        return this.channel.send(t11, continuation);
    }
}
