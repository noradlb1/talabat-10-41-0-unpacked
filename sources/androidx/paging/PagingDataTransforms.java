...
public final class PagingDataTransforms {
    ...
    @NotNull
    @JvmOverloads
    public static final <T> PagingData<T> insertFooterItem(@NotNull PagingData<T> pagingData, @NotNull TerminalSeparatorType terminalSeparatorType, @NotNull T t11) {
        ...
        return insertSeparators(pagingData, terminalSeparatorType, new PagingDataTransforms$insertFooterItem$1(t11, (Continuation) null));
    }

    @CheckResult
    @NotNull
    @JvmOverloads
    public static final <T> PagingData<T> insertFooterItem(@NotNull PagingData<T> pagingData, @NotNull T t11) {
        return insertFooterItem$default(pagingData, (TerminalSeparatorType) null, t11, 1, (Object) null);
    }

    public static /* synthetic */ PagingData insertFooterItem$default(PagingData pagingData, TerminalSeparatorType terminalSeparatorType, Object obj, int i11, Object obj2) {
        if ((i11 & 1) != 0) {
    ...
    @NotNull
    @JvmOverloads
    public static final <T> PagingData<T> insertHeaderItem(@NotNull PagingData<T> pagingData, @NotNull TerminalSeparatorType terminalSeparatorType, @NotNull T t11) {
        Intrinsics.checkNotNullParameter(pagingData, "$this$insertHeaderItem");
        Intrinsics.checkNotNullParameter(terminalSeparatorType, "terminalSeparatorType");
        Intrinsics.checkNotNullParameter(t11, "item");
        return insertSeparators(pagingData, terminalSeparatorType, new PagingDataTransforms$insertHeaderItem$1(t11, (Continuation) null));
    }

    @CheckResult
    @NotNull
    @JvmOverloads
    public static final <T> PagingData<T> insertHeaderItem(@NotNull PagingData<T> pagingData, @NotNull T t11) {
        return insertHeaderItem$default(pagingData, (TerminalSeparatorType) null, t11, 1, (Object) null);
    }

    public static /* synthetic */ PagingData insertHeaderItem$default(PagingData pagingData, TerminalSeparatorType terminalSeparatorType, Object obj, int i11, Object obj2) {
        if ((i11 & 1) != 0) {
            terminalSeparatorType = TerminalSeparatorType.FULLY_COMPLETE;
        }
    ...
    public static /* synthetic */ PagingData insertSeparators$default(PagingData pagingData, TerminalSeparatorType terminalSeparatorType, Function3 function3, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            terminalSeparatorType = TerminalSeparatorType.FULLY_COMPLETE;
        }
    ...
    public static /* synthetic */ PagingData insertSeparators$default(PagingData pagingData, TerminalSeparatorType terminalSeparatorType, Executor executor, Function2 function2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            terminalSeparatorType = TerminalSeparatorType.FULLY_COMPLETE;
        }
    ...
    @NotNull
    @JvmName(name = "filter")
    public static final <T> PagingData<T> filter(@NotNull PagingData<T> pagingData, @NotNull Executor executor, @NotNull Function1<? super T, Boolean> function1) {
        Intrinsics.checkNotNullParameter(pagingData, "$this$filter");
        Intrinsics.checkNotNullParameter(executor, "executor");
    ...
    @CheckResult
    @NotNull
    public static final <T, R> PagingData<R> flatMap(@NotNull PagingData<T> pagingData, @NotNull Executor executor, @NotNull Function1<? super T, ? extends Iterable<? extends R>> function1) {
        Intrinsics.checkNotNullParameter(pagingData, "$this$flatMap");
        Intrinsics.checkNotNullParameter(executor, "executor");
    ...
    @CheckResult
    @NotNull
    public static final <T, R> PagingData<R> map(@NotNull PagingData<T> pagingData, @NotNull Executor executor, @NotNull Function1<? super T, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(pagingData, "$this$map");
        Intrinsics.checkNotNullParameter(executor, "executor");
        Intrinsics.checkNotNullParameter(function1, "transform");
