...
public final class PagingDataAdapter$withLoadStateHeader$1 extends Lambda implements Function1<CombinedLoadStates, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ LoadStateAdapter f36876g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PagingDataAdapter$withLoadStateHeader$1(LoadStateAdapter loadStateAdapter) {
        super(1);
        this.f36876g = loadStateAdapter;
    }
    ...
    public final void invoke(@NotNull CombinedLoadStates combinedLoadStates) {
        ...
        this.f36876g.setLoadState(combinedLoadStates.getPrepend());
    }
}
