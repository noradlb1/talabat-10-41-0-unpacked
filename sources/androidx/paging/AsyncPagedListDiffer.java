...
public class AsyncPagedListDiffer<T> {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bg\u0018\u0000*\b\b\u0001\u0010\u0001*\u00020\u00022\u00020\u0002J(\u0010\u0003\u001a\u00020\u00042\u000e\u0010\u0005\u001a\n\u0012\u0004\u0012\u00028\u0001\u0018\u00010\u00062\u000e\u0010\u0007\u001a\n\u0012\u0004\u0012\u00028\u0001\u0018\u00010\u0006H&¨\u0006\b"}, d2 = {"Landroidx/paging/AsyncPagedListDiffer$PagedListListener;", "T", "", "onCurrentListChanged", "", "previousList", "Landroidx/paging/PagedList;", "currentList", "paging-runtime_release"}, k = 1, mv = {1, 4, 2})
    ...
    public void addPagedListListener(@NotNull PagedListListener<T> pagedListListener) {
        Intrinsics.checkNotNullParameter(pagedListListener, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
    ...
    public T getItem(int i11) {
        ...
        if (pagedList3 != null) {
            pagedList3.loadAround(i11);
            return pagedList3.get(i11);
        }
    ...
    public final void latchPagedList$paging_runtime_release(@NotNull PagedList<T> pagedList2, @NotNull PagedList<T> pagedList3, @NotNull NullPaddedDiffResult nullPaddedDiffResult, @NotNull RecordingCallback recordingCallback, int i11, @Nullable Runnable runnable) {
        ...
        if (!pagedList2.isEmpty()) {
            pagedList2.loadAround(RangesKt___RangesKt.coerceIn(NullPaddedListDiffHelperKt.transformAnchorIndex(pagedList4.getNullPaddedList(), nullPaddedDiffResult, pagedList3.getNullPaddedList(), i11), 0, pagedList2.size() - 1));
        }
    ...
    public void submitList(@Nullable PagedList<T> pagedList2) {
        submitList(pagedList2, (Runnable) null);
    }

    public final void addPagedListListener(@NotNull Function2<? super PagedList<T>, ? super PagedList<T>, Unit> function2) {
        Intrinsics.checkNotNullParameter(function2, "callback");
        this.listeners.add(new OnCurrentListChangedWrapper(function2));
    }

    public final void removePagedListListener(@NotNull Function2<? super PagedList<T>, ? super PagedList<T>, Unit> function2) {
        Intrinsics.checkNotNullParameter(function2, "callback");
        boolean unused = CollectionsKt__MutableCollectionsKt.removeAll(this.listeners, new AsyncPagedListDiffer$removePagedListListener$1(function2));
    }

    public void submitList(@Nullable PagedList<T> pagedList2, @Nullable Runnable runnable) {
        ...
        if (pagedList2 != this.pagedList) {
            ...
            if (pagedList2 == null) {
                ...
                if (snapshot3 != null) {
                    ...
                    this.config.getBackgroundThreadExecutor().execute(new AsyncPagedListDiffer$submitList$2(this, pagedList5, (PagedList) snapshot3, i11, pagedList2, recordingCallback, runnable));
                    return;
                }
                throw new NullPointerException("null cannot be cast to non-null type androidx.paging.PagedList<T>");
            }
    ...
    public AsyncPagedListDiffer(@NotNull ListUpdateCallback listUpdateCallback, @NotNull AsyncDifferConfig<T> asyncDifferConfig) {
        ...
        Intrinsics.checkNotNullParameter(asyncDifferConfig, DarkstoresMainActivity.CONFIG_EXTRA_KEY);
        Executor mainThreadExecutor2 = ArchTaskExecutor.getMainThreadExecutor();
        Intrinsics.checkNotNullExpressionValue(mainThreadExecutor2, "ArchTaskExecutor.getMainThreadExecutor()");
        this.mainThreadExecutor = mainThreadExecutor2;
        AsyncPagedListDiffer$loadStateManager$1 asyncPagedListDiffer$loadStateManager$1 = new AsyncPagedListDiffer$loadStateManager$1(this);
