...
public class WrapperDataSource<Key, ValueFrom, ValueTo> extends DataSource<Key, ValueTo> {
    ...
    public WrapperDataSource(@NotNull DataSource<Key, ValueFrom> dataSource, @NotNull Function<List<ValueFrom>, List<ValueTo>> function) {
    ...
    public static /* synthetic */ java.lang.Object a(androidx.paging.WrapperDataSource r4, androidx.paging.DataSource.Params r5, kotlin.coroutines.Continuation r6) {
        ...
        L_0x0013:
            ...
            r0.<init>(r4, r6)
        L_0x0018:
            java.lang.Object r6 = r0.f37173h
            java.lang.Object r1 = kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()
            int r2 = r0.f37174i
            r3 = 1
            if (r2 == 0) goto L_0x0035
            if (r2 != r3) goto L_0x002d
            java.lang.Object r4 = r0.f37176k
    ...
    public final void stashKeysIfNeeded(@NotNull List<? extends ValueFrom> list, @NotNull List<? extends ValueTo> list2) {
        ...
        if (identityHashMap != null) {
            synchronized (identityHashMap) {
                ...
                while (i11 < size) {
                    ...
                    if (dataSource != null) {
                        identityHashMap2.put(obj, ((ItemKeyedDataSource) dataSource).getKey(list.get(i11)));
                        i11++;
                    } else {
