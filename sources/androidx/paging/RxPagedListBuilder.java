...
public final class RxPagedListBuilder<Key, Value> {
    ...
    public static final class PagingObservableOnSubscribe<Key, Value> implements ObservableOnSubscribe<PagedList<Value>>, Cancellable {
        ...
        public PagingObservableOnSubscribe(@Nullable Key key, @NotNull PagedList.Config config2, @Nullable PagedList.BoundaryCallback<Value> boundaryCallback2, @NotNull Function0<? extends PagingSource<Key, Value>> function0, @NotNull CoroutineDispatcher coroutineDispatcher, @NotNull CoroutineDispatcher coroutineDispatcher2) {
            ...
            RxPagedListBuilder$PagingObservableOnSubscribe$refreshRetryCallback$1 rxPagedListBuilder$PagingObservableOnSubscribe$refreshRetryCallback$1 = new RxPagedListBuilder$PagingObservableOnSubscribe$refreshRetryCallback$1(this);
            this.refreshRetryCallback = rxPagedListBuilder$PagingObservableOnSubscribe$refreshRetryCallback$1;
            InitialPagedList initialPagedList = new InitialPagedList(new InitialPagingSource(), GlobalScope.INSTANCE, coroutineDispatcher, coroutineDispatcher2, config2, key);
        ...
        public void subscribe(@NotNull ObservableEmitter<PagedList<Value>> observableEmitter) {
    ...
    public RxPagedListBuilder(@NotNull Function0<? extends PagingSource<Key, Value>> function0, @NotNull PagedList.Config config2) {
        Intrinsics.checkNotNullParameter(function0, "pagingSourceFactory");
        Intrinsics.checkNotNullParameter(config2, DarkstoresMainActivity.CONFIG_EXTRA_KEY);
        this.pagingSourceFactory = function0;
    ...
    public final Observable<PagedList<Value>> buildObservable() {
        ...
        SchedulerCoroutineDispatcher schedulerCoroutineDispatcher3 = this.fetchDispatcher;
        ...
        if (function0 == null) {
            ...
            if (factory != null) {
                function0 = factory.asPagingSourceFactory(schedulerCoroutineDispatcher4);
            } else {
                function0 = null;
            }
        }
        ...
        if (z11) {
            Observable<PagedList<Value>> subscribeOn = Observable.create(new PagingObservableOnSubscribe(this.initialLoadKey, this.config, this.boundaryCallback, function02, schedulerCoroutineDispatcher2, schedulerCoroutineDispatcher4)).observeOn(scheduler).subscribeOn(scheduler2);
    ...
    @NotNull
    public final RxPagedListBuilder<Key, Value> setBoundaryCallback(@Nullable PagedList.BoundaryCallback<Value> boundaryCallback2) {
        this.boundaryCallback = boundaryCallback2;
        return this;
    }
    ...
    public RxPagedListBuilder(@NotNull Function0<? extends PagingSource<Key, Value>> function0, int i11) {
        this(function0, new PagedList.Config.Builder().setPageSize(i11).build());
        Intrinsics.checkNotNullParameter(function0, "pagingSourceFactory");
    }
    ...
    public RxPagedListBuilder(@NotNull DataSource.Factory<Key, Value> factory, @NotNull PagedList.Config config2) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    @Deprecated(message = "PagedList is deprecated and has been replaced by PagingData", replaceWith = @ReplaceWith(expression = "Pager(\n                config = PagingConfig(pageSize),\n                initialKey = null,\n                pagingSourceFactory = dataSourceFactory.asPagingSourceFactory(Dispatchers.IO)\n            ).flowable", imports = {"androidx.paging.PagingConfig", "androidx.paging.Pager", "androidx.paging.rxjava2.getFlowable", "kotlinx.coroutines.Dispatchers"}))
    public RxPagedListBuilder(@NotNull DataSource.Factory<Key, Value> factory, int i11) {
