...
public final class PageKeyedDataSource$map$2<I, O> implements Function<List<? extends Value>, List<? extends ToValue>> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ Function1 f36851a;

    public PageKeyedDataSource$map$2(Function1 function1) {
        this.f36851a = function1;
    }

    public final List<ToValue> apply(List<? extends Value> list) {
        Intrinsics.checkNotNullExpressionValue(list, DefaultCardView.CARD_LIST);
        Iterable<Object> iterable = list;
        Function1 function1 = this.f36851a;
