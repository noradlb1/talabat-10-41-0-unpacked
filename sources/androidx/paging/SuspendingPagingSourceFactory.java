...
public final class SuspendingPagingSourceFactory<Key, Value> implements Function0<PagingSource<Key, Value>> {
    ...
    public SuspendingPagingSourceFactory(@NotNull CoroutineDispatcher coroutineDispatcher, @NotNull Function0<? extends PagingSource<Key, Value>> function0) {
        Intrinsics.checkNotNullParameter(coroutineDispatcher, "dispatcher");
        Intrinsics.checkNotNullParameter(function0, MethodDelegation.ImplementationDelegate.FIELD_NAME_PREFIX);
