...
public final class PageFetcherSnapshotState$consumePrependGenerationIdAsFlow$1 extends SuspendLambda implements Function2<FlowCollector<? super Integer>, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ PageFetcherSnapshotState f36843i;
    ...
    public PageFetcherSnapshotState$consumePrependGenerationIdAsFlow$1(PageFetcherSnapshotState pageFetcherSnapshotState, Continuation continuation) {
        ...
        this.f36843i = pageFetcherSnapshotState;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        Intrinsics.checkNotNullParameter(continuation, "completion");
        return new PageFetcherSnapshotState$consumePrependGenerationIdAsFlow$1(this.f36843i, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.f36842h == 0) {
            ...
            this.f36843i.prependGenerationIdCh.offer(Boxing.boxInt(this.f36843i.prependGenerationId));
