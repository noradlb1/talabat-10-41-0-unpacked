...
public final class SparseArrayKt {
    public static final <T> boolean contains(@NotNull SparseArrayCompat<T> sparseArrayCompat, int i11) {
    ...
    public static final <T> void forEach(@NotNull SparseArrayCompat<T> sparseArrayCompat, @NotNull Function2<? super Integer, ? super T, Unit> function2) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            function2.invoke(Integer.valueOf(sparseArrayCompat.keyAt(i11)), sparseArrayCompat.valueAt(i11));
        }
    }

    public static final <T> T getOrDefault(@NotNull SparseArrayCompat<T> sparseArrayCompat, int i11, T t11) {
        Intrinsics.checkParameterIsNotNull(sparseArrayCompat, "receiver$0");
        return sparseArrayCompat.get(i11, t11);
    }

    public static final <T> T getOrElse(@NotNull SparseArrayCompat<T> sparseArrayCompat, int i11, @NotNull Function0<? extends T> function0) {
        Intrinsics.checkParameterIsNotNull(sparseArrayCompat, "receiver$0");
    ...
    public static final <T> boolean remove(@NotNull SparseArrayCompat<T> sparseArrayCompat, int i11, T t11) {
        Intrinsics.checkParameterIsNotNull(sparseArrayCompat, "receiver$0");
        return sparseArrayCompat.remove(i11, t11);
    }

    public static final <T> void set(@NotNull SparseArrayCompat<T> sparseArrayCompat, int i11, T t11) {
        Intrinsics.checkParameterIsNotNull(sparseArrayCompat, "receiver$0");
