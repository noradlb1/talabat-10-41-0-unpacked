...
public class LruCache<K, V> {
    ...
    public void entryRemoved(boolean z11, @NonNull K k11, @NonNull V v11, @Nullable V v12) {
    }
    ...
    @Nullable
    public final V remove(@NonNull K k11) {
        V remove;
        if (k11 != null) {
            synchronized (this) {
    ...
    public int sizeOf(@NonNull K k11, @NonNull V v11) {
        return 1;
    }
    ...
    public final synchronized String toString() {
        ...
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i11)});
    }
