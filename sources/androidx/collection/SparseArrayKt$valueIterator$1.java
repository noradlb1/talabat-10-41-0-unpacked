...
public final class SparseArrayKt$valueIterator$1 implements Iterator<T>, KMappedMarker, j$.util.Iterator {

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ SparseArrayCompat f1048b;
    private int index;

    public SparseArrayKt$valueIterator$1(SparseArrayCompat<T> sparseArrayCompat) {
        this.f1048b = sparseArrayCompat;
    }
    ...
    public boolean hasNext() {
        return this.index < this.f1048b.size();
    }

    public T next() {
        SparseArrayCompat sparseArrayCompat = this.f1048b;
        int i11 = this.index;
        this.index = i11 + 1;
