...
public final class FragmentStrictMode {
    ...
    public static final class Policy {
        ...
        @NotNull
        @JvmField
        public static final Policy LAX = new Policy(SetsKt__SetsKt.emptySet(), (OnViolationListener) null, MapsKt__MapsKt.emptyMap());
        @NotNull
        ...
        public static final class Builder {
            ...
            public final Builder allowViolation(@NotNull Class<? extends Fragment> cls, @NotNull Class<? extends Violation> cls2) {
                ...
                Intrinsics.checkNotNullExpressionValue(name2, "fragmentClassString");
                return allowViolation(name2, cls2);
            }
    ...
    private final void handlePolicyViolation(Policy policy, Violation violation) {
        ...
        if (policy.getFlags$fragment_release().contains(Flag.PENALTY_DEATH)) {
            runOnHostThread(fragment, new b(name2, violation));
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: handlePolicyViolation$lambda-0  reason: not valid java name */
    public static final void m9082handlePolicyViolation$lambda0(Policy policy, Violation violation) {
    ...
    public static final void m9083handlePolicyViolation$lambda1(String str, Violation violation) {
        Intrinsics.checkNotNullParameter(violation, "$violation");
    ...
    @JvmStatic
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static final void onSetTargetFragmentUsage(@NotNull Fragment fragment, @NotNull Fragment fragment2, int i11) {
    ...
    private final boolean shouldHandlePolicyViolation(Policy policy, Class<? extends Fragment> cls, Class<? extends Violation> cls2) {
        ...
        if (Intrinsics.areEqual((Object) cls2.getSuperclass(), (Object) Violation.class) || !CollectionsKt___CollectionsKt.contains(set, cls2.getSuperclass())) {
