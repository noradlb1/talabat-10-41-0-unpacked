...
public abstract class Violation extends RuntimeException {
    ...
    public /* synthetic */ Violation(Fragment fragment2, String str, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public Violation(@NotNull Fragment fragment2, @Nullable String str) {
        super(str);
