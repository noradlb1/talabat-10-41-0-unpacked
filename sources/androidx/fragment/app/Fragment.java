...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public boolean performCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater menuInflater) {
        ...
        return z11 | this.mChildFragmentManager.dispatchCreateOptionsMenu(menu, menuInflater);
    }
    ...
    public void performMultiWindowModeChanged(boolean z11) {
        ...
        this.mChildFragmentManager.dispatchMultiWindowModeChanged(z11);
    }
    ...
    public void performPictureInPictureModeChanged(boolean z11) {
        ...
        this.mChildFragmentManager.dispatchPictureInPictureModeChanged(z11);
    }
    ...
    public boolean performPrepareOptionsMenu(@NonNull Menu menu) {
        ...
        return z11 | this.mChildFragmentManager.dispatchPrepareOptionsMenu(menu);
    }
    ...
    public void startIntentSenderForResult(@SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i11, @Nullable Intent intent, int i12, int i13, int i14, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (this.mHost != null) {
            ...
            getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i11, intent, i12, i13, i14, bundle);
            return;
        }
        throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    }
