...
public abstract class SpecificationComputer<T> {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ SpecificationComputer startSpecification$default(Companion companion, Object obj, String str, VerificationMode verificationMode, Logger logger, int i11, Object obj2) {
            if ((i11 & 2) != 0) {
        ...
        @NotNull
        public final <T> SpecificationComputer<T> startSpecification(@NotNull T t11, @NotNull String str, @NotNull VerificationMode verificationMode, @NotNull Logger logger) {
            Intrinsics.checkNotNullParameter(t11, "<this>");
            Intrinsics.checkNotNullParameter(str, "tag");
            Intrinsics.checkNotNullParameter(verificationMode, "verificationMode");
            Intrinsics.checkNotNullParameter(logger, "logger");
            return new ValidSpecification(t11, str, verificationMode, logger);
        }
    }
