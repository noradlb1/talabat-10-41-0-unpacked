...
final class FailedSpecification<T> extends SpecificationComputer<T> {
    ...
    public FailedSpecification(@NotNull T t11, @NotNull String str, @NotNull String str2, @NotNull Logger logger2, @NotNull SpecificationComputer.VerificationMode verificationMode2) {
        ...
        WindowStrictModeException windowStrictModeException = new WindowStrictModeException(createMessage(t11, str2));
        StackTraceElement[] stackTrace = windowStrictModeException.getStackTrace();
        Intrinsics.checkNotNullExpressionValue(stackTrace, "stackTrace");
        Object[] array = ArraysKt___ArraysKt.drop((T[]) stackTrace, 2).toArray(new StackTraceElement[0]);
        if (array != null) {
    ...
    @Nullable
    public T compute() {
        int i11 = WhenMappings.$EnumSwitchMapping$0[this.verificationMode.ordinal()];
        if (i11 == 1) {
