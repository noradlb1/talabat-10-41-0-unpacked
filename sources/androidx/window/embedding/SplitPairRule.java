...
public final class SplitPairRule extends SplitRule {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Intrinsics.areEqual((Object) this.filters, (Object) splitPairRule.filters) && this.finishPrimaryWithSecondary == splitPairRule.finishPrimaryWithSecondary && this.finishSecondaryWithPrimary == splitPairRule.finishSecondaryWithPrimary && this.clearTop == splitPairRule.clearTop) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((super.hashCode() * 31) + this.filters.hashCode()) * 31) + e.a(this.finishPrimaryWithSecondary)) * 31) + e.a(this.finishSecondaryWithPrimary)) * 31) + e.a(this.clearTop);
    }
    ...
    public SplitPairRule(@NotNull Set<SplitPairFilter> set, boolean z11, boolean z12, boolean z13, int i11, int i12, float f11, int i13) {
        super(i11, i12, f11, i13);
        Intrinsics.checkNotNullParameter(set, ShareConstants.WEB_DIALOG_PARAM_FILTERS);
        this.finishPrimaryWithSecondary = z11;
        this.finishSecondaryWithPrimary = z12;
        this.clearTop = z13;
