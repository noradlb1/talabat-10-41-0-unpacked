...
class PreferenceInflater {
    ...
    private void init(PreferenceManager preferenceManager) {
        ...
        setDefaultPackages(new String[]{Preference.class.getPackage().getName() + RealDiscoveryConfigurationRepository.VERSION_DELIMETER, SwitchPreference.class.getPackage().getName() + RealDiscoveryConfigurationRepository.VERSION_DELIMETER});
    }
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if ("intent".equals(name2)) {
                    ...
                    Preference createItemFromTag = createItemFromTag(name2, attributeSet);
    ...
    public Preference inflate(int i11, @Nullable PreferenceGroup preferenceGroup) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public androidx.preference.Preference inflate(org.xmlpull.v1.XmlPullParser r6, @androidx.annotation.Nullable androidx.preference.PreferenceGroup r7) {
        /*
            r5 = this;
