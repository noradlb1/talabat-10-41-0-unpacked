...
public final class AnimatedContentMeasurePolicy$maxIntrinsicHeight$1 extends Lambda implements Function1<IntrinsicMeasurable, Integer> {
    ...
    public final /* synthetic */ int f1086g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnimatedContentMeasurePolicy$maxIntrinsicHeight$1(int i11) {
        super(1);
        this.f1086g = i11;
    }
    ...
    public final Integer invoke(@NotNull IntrinsicMeasurable intrinsicMeasurable) {
        ...
        return Integer.valueOf(intrinsicMeasurable.maxIntrinsicHeight(this.f1086g));
    }
}
