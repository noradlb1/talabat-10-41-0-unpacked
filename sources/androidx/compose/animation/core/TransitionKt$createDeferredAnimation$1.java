...
public final class TransitionKt$createDeferredAnimation$1 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    public final /* synthetic */ Transition<S> f1425g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ Transition<S>.DeferredAnimation<T, V> f1426h;
    ...
    public TransitionKt$createDeferredAnimation$1(Transition<S> transition, Transition<S>.DeferredAnimation<T, V> deferredAnimation) {
        super(1);
        this.f1425g = transition;
        this.f1426h = deferredAnimation;
    }

    @NotNull
    public final DisposableEffectResult invoke(@NotNull DisposableEffectScope disposableEffectScope) {
        Intrinsics.checkNotNullParameter(disposableEffectScope, "$this$DisposableEffect");
        return new TransitionKt$createDeferredAnimation$1$invoke$$inlined$onDispose$1(this.f1425g, this.f1426h);
    }
}
