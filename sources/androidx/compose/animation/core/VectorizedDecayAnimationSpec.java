...
public interface VectorizedDecayAnimationSpec<V extends AnimationVector> {
    ...
    long getDurationNanos(@NotNull V v11, @NotNull V v12);

    @NotNull
    V getTargetValue(@NotNull V v11, @NotNull V v12);

    @NotNull
    V getValueFromNanos(long j11, @NotNull V v11, @NotNull V v12);

    @NotNull
    V getVelocityFromNanos(long j11, @NotNull V v11, @NotNull V v12);
}
