...
public final class AnimationVector2D extends AnimationVector {
    ...
    private float f1309v1;

    /* renamed from: v2  reason: collision with root package name */
    private float f1310v2;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(animationVector2D.f1309v1 == this.f1309v1)) {
            return false;
        }
        return (animationVector2D.f1310v2 > this.f1310v2 ? 1 : (animationVector2D.f1310v2 == this.f1310v2 ? 0 : -1)) == 0;
    }
    ...
    public int hashCode() {
        return (Float.floatToIntBits(this.f1309v1) * 31) + Float.floatToIntBits(this.f1310v2);
    }
    ...
    public String toString() {
        return "AnimationVector2D: v1 = " + this.f1309v1 + ", v2 = " + this.f1310v2;
    }
