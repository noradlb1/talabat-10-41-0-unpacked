    ...
    public final TwoWayConverter<Color, AnimationVector4D> invoke(@NotNull final ColorSpace colorSpace) {
        ...
        return VectorConvertersKt.TwoWayConverter(AnonymousClass1.INSTANCE, new Function1<AnimationVector4D, Color>() {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                return Color.m2909boximpl(m43invokevNxB06k((AnimationVector4D) obj));
            }

            /* renamed from: invoke-vNxB06k  reason: not valid java name */
            public final long m43invokevNxB06k(@NotNull AnimationVector4D animationVector4D) {
                Intrinsics.checkNotNullParameter(animationVector4D, "it");
                double d11 = (double) 3.0f;
                float pow = (float) Math.pow((double) animationVector4D.getV2(), d11);
                float pow2 = (float) Math.pow((double) animationVector4D.getV3(), d11);
                float pow3 = (float) Math.pow((double) animationVector4D.getV4(), d11);
                ...
                return Color.m2916convertvNxB06k(ColorKt.Color(RangesKt___RangesKt.coerceIn(access$multiplyColumn, -2.0f, 2.0f), RangesKt___RangesKt.coerceIn(access$multiplyColumn2, -2.0f, 2.0f), RangesKt___RangesKt.coerceIn(access$multiplyColumn3, -2.0f, 2.0f), RangesKt___RangesKt.coerceIn(animationVector4D.getV1(), 0.0f, 1.0f), ColorSpaces.INSTANCE.getCieXyz()), colorSpace);
            }
        });
    }
}
