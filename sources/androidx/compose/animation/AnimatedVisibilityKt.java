...
public final class AnimatedVisibilityKt {
    ...
    public static final <T> void AnimatedEnterExitImpl(androidx.compose.animation.core.Transition<T> r19, kotlin.jvm.functions.Function1<? super T, java.lang.Boolean> r20, androidx.compose.ui.Modifier r21, androidx.compose.animation.EnterTransition r22, androidx.compose.animation.ExitTransition r23, kotlin.jvm.functions.Function3<? super androidx.compose.animation.AnimatedVisibilityScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r24, androidx.compose.runtime.Composer r25, int r26) {
        /*
            r6 = r19
            r7 = r20
            r8 = r21
        ...
        L_0x0259:
            ...
            androidx.compose.runtime.Updater.m2543setimpl((androidx.compose.runtime.Composer) r13, r5, r14)
            kotlin.jvm.functions.Function2 r5 = r12.getSetDensity()
            androidx.compose.runtime.Updater.m2543setimpl((androidx.compose.runtime.Composer) r13, r6, r5)
            kotlin.jvm.functions.Function2 r5 = r12.getSetLayoutDirection()
            androidx.compose.runtime.Updater.m2543setimpl((androidx.compose.runtime.Composer) r13, r7, r5)
            kotlin.jvm.functions.Function2 r5 = r12.getSetViewConfiguration()
            androidx.compose.runtime.Updater.m2543setimpl((androidx.compose.runtime.Composer) r13, r11, r5)
            r2.enableReusing()
    ...
    @Composable
    private static final <T> EnterExitState targetEnterExit(Transition<T> transition, Function1<? super T, Boolean> function1, T t11, Composer composer, int i11) {
    ...
    @Composable
    private static final void AnimatedEnterExitImpl(Transition<EnterExitState> transition, Modifier modifier, EnterTransition enterTransition, ExitTransition exitTransition, Function3<? super AnimatedVisibilityScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, int i11) {
        ...
        if (currentState == enterExitState || transition.getTargetState() == enterExitState) {
            ...
            int i13 = i11 >> 3;
            Modifier then = modifier.then(EnterExitTransitionKt.createModifier(transition, enterTransition, exitTransition, "Built-in", composer, i12 | KfsConstant.KFS_RSA_KEY_LEN_3072 | (i13 & 112) | (i13 & 896)));
            composer.startReplaceableGroup(-492369756);
            ...
            function3.invoke(animatedVisibilityScopeImpl, composer, Integer.valueOf(((i11 >> 9) & 112) | 8));
            composer.endReplaceableGroup();
            composer.endReplaceableGroup();
            composer.endNode();
            composer.endReplaceableGroup();
