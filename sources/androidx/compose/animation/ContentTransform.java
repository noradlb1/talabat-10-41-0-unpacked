...
public final class ContentTransform {
    ...
    public ContentTransform(@NotNull EnterTransition enterTransition, @NotNull ExitTransition exitTransition, float f11, @Nullable SizeTransform sizeTransform2) {
        ...
        this.targetContentZIndex$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Float.valueOf(f11), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public final void setSizeTransform$animation_release(@Nullable SizeTransform sizeTransform2) {
        this.sizeTransform = sizeTransform2;
    }
    ...
    public /* synthetic */ ContentTransform(EnterTransition enterTransition, ExitTransition exitTransition, float f11, SizeTransform sizeTransform2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(enterTransition, exitTransition, (i11 & 4) != 0 ? 0.0f : f11, (i11 & 8) != 0 ? AnimatedContentKt.SizeTransform$default(false, (Function2) null, 3, (Object) null) : sizeTransform2);
    }
}
