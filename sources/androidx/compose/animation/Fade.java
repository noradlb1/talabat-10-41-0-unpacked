...
public final class Fade {
    ...
    public Fade(float f11, @NotNull FiniteAnimationSpec<Float> finiteAnimationSpec) {
        Intrinsics.checkNotNullParameter(finiteAnimationSpec, "animationSpec");
        this.alpha = f11;
        this.animationSpec = finiteAnimationSpec;
    }

    public static /* synthetic */ Fade copy$default(Fade fade, float f11, FiniteAnimationSpec<Float> finiteAnimationSpec, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            f11 = fade.alpha;
        }
        if ((i11 & 2) != 0) {
    ...
    @NotNull
    public final Fade copy(float f11, @NotNull FiniteAnimationSpec<Float> finiteAnimationSpec) {
        Intrinsics.checkNotNullParameter(finiteAnimationSpec, "animationSpec");
