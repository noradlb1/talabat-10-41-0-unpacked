...
public final class SaversKt {
    ...
    public static final /* synthetic */ <T extends Saver<Original, Saveable>, Original, Saveable, Result> Result restore(Saveable saveable, T t11) {
        Intrinsics.checkNotNullParameter(t11, "saver");
        if (Intrinsics.areEqual((Object) saveable, (Object) Boolean.FALSE) || saveable == null) {
            return null;
        }
        Result restore = t11.restore(saveable);
    ...
    @NotNull
    public static final <T extends Saver<Original, Saveable>, Original, Saveable> Object save(@Nullable Original original, @NotNull T t11, @NotNull SaverScope saverScope) {
        Object save;
        Intrinsics.checkNotNullParameter(t11, "saver");
        Intrinsics.checkNotNullParameter(saverScope, "scope");
        if (original == null || (save = t11.save(saverScope, original)) == null) {
