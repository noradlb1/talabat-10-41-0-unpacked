...
public final class AnnotatedStringKt {
    ...
    public static final <T> List<AnnotatedString.Range<T>> filterRanges(List<? extends AnnotatedString.Range<? extends T>> list, int i11, int i12) {
        ...
        if (z11) {
            ...
            for (int i14 = 0; i14 < size2; i14++) {
                ...
                arrayList2.add(new AnnotatedString.Range(range2.getItem(), Math.max(i11, range2.getStart()) - i11, Math.min(i12, range2.getEnd()) - i11, range2.getTag()));
            }
            return arrayList2;
        }
    ...
    private static final List<AnnotatedString.Range<SpanStyle>> getLocalStyles(AnnotatedString annotatedString, int i11, int i12) {
        ...
        for (int i14 = 0; i14 < size2; i14++) {
            ...
            arrayList2.add(new AnnotatedString.Range(range3.getItem(), RangesKt___RangesKt.coerceIn(range3.getStart(), i11, i12) - i11, RangesKt___RangesKt.coerceIn(range3.getEnd(), i11, i12) - i11));
        }
        return arrayList2;
    }

    public static final boolean intersect(int i11, int i12, int i13, int i14) {
        if (Math.max(i11, i13) < Math.min(i12, i14) || contains(i11, i12, i13, i14) || contains(i13, i14, i11, i12)) {
            return true;
        }
        return false;
    }
    ...
    public static final List<AnnotatedString.Range<ParagraphStyle>> normalizedParagraphStyles(@NotNull AnnotatedString annotatedString, @NotNull ParagraphStyle paragraphStyle) {
        ...
        int i12 = 0;
        while (i11 < size) {
            AnnotatedString.Range range = paragraphStyles.get(i11);
    ...
    public static final AnnotatedString substringWithoutParagraphStyles(AnnotatedString annotatedString, int i11, int i12) {
        ...
        return new AnnotatedString(str, getLocalStyles(annotatedString, i11, i12), (List) null, 4, (DefaultConstructorMarker) null);
    }
