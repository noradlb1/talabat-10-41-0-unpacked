...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    private AndroidPreloadedFont(FontWeight fontWeight, int i11, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m5116getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, settings, (DefaultConstructorMarker) null);
        this.weight = fontWeight;
        this.style = i11;
    }

    public /* synthetic */ AndroidPreloadedFont(FontWeight fontWeight, int i11, FontVariation.Settings settings, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public final int m5078getStyle_LCdwA() {
        return this.style;
    }
    ...
    public final void setTypeface$ui_text_release(@Nullable Typeface typeface2) {
