...
public interface PlatformTypefaces {
    ...
    Typeface m5151createDefaultFO1MlWM(@NotNull FontWeight fontWeight, int i11);

    @NotNull
    /* renamed from: createNamed-RetOiIg  reason: not valid java name */
    Typeface m5152createNamedRetOiIg(@NotNull GenericFontFamily genericFontFamily, @NotNull FontWeight fontWeight, int i11);

    @Nullable
    /* renamed from: optionalOnDeviceFontFamilyByName-78DK7lM  reason: not valid java name */
    Typeface m5153optionalOnDeviceFontFamilyByName78DK7lM(@NotNull String str, @NotNull FontWeight fontWeight, int i11, @NotNull FontVariation.Settings settings, @NotNull Context context);
}
