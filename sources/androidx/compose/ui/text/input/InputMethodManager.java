...
public interface InputMethodManager {
    ...
    void updateExtractedText(@NotNull View view, int i11, @NotNull ExtractedText extractedText);

    void updateSelection(@NotNull View view, int i11, int i12, int i13, int i14);
}
