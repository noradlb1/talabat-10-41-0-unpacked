...
public final class TextFieldValue$Companion$Saver$1 extends Lambda implements Function2<SaverScope, TextFieldValue, Object> {
    ...
    public final Object invoke(@NotNull SaverScope saverScope, @NotNull TextFieldValue textFieldValue) {
        ...
        return CollectionsKt__CollectionsKt.arrayListOf(SaversKt.save(textFieldValue.getAnnotatedString(), SaversKt.getAnnotatedStringSaver(), saverScope), SaversKt.save(TextRange.m5026boximpl(textFieldValue.m5234getSelectiond9O1mEE()), SaversKt.getSaver(TextRange.Companion), saverScope));
    }
}
