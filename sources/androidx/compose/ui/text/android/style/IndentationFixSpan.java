...
public final class IndentationFixSpan implements LeadingMarginSpan {
    ...
    public void drawLeadingMargin(@Nullable Canvas canvas, @Nullable Paint paint, int i11, int i12, int i13, int i14, int i15, @Nullable CharSequence charSequence, int i16, int i17, boolean z11, @Nullable Layout layout) {
