...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph ActualParagraph(@NotNull String str, @NotNull TextStyle textStyle, @NotNull List<AnnotatedString.Range<SpanStyle>> list, @NotNull List<AnnotatedString.Range<Placeholder>> list2, int i11, boolean z11, float f11, @NotNull Density density, @NotNull Font.ResourceLoader resourceLoader) {
        ...
        return new AndroidParagraph(new AndroidParagraphIntrinsics(str, textStyle2, list3, list4, DelegatingFontLoaderForDeprecatedUsage_androidKt.createFontFamilyResolver(resourceLoader), density2), i11, z11, ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(f11), 0, 0, 13, (Object) null), (DefaultConstructorMarker) null);
    }

    @NotNull
    /* renamed from: ActualParagraph--hBUhpc  reason: not valid java name */
    public static final Paragraph m5245ActualParagraphhBUhpc(@NotNull ParagraphIntrinsics paragraphIntrinsics, int i11, boolean z11, long j11) {
        Intrinsics.checkNotNullParameter(paragraphIntrinsics, "paragraphIntrinsics");
        return new AndroidParagraph((AndroidParagraphIntrinsics) paragraphIntrinsics, i11, z11, j11, (DefaultConstructorMarker) null);
    }

    @NotNull
    /* renamed from: ActualParagraph-O3s9Psw  reason: not valid java name */
    public static final Paragraph m5246ActualParagraphO3s9Psw(@NotNull String str, @NotNull TextStyle textStyle, @NotNull List<AnnotatedString.Range<SpanStyle>> list, @NotNull List<AnnotatedString.Range<Placeholder>> list2, int i11, boolean z11, long j11, @NotNull Density density, @NotNull FontFamily.Resolver resolver) {
        Intrinsics.checkNotNullParameter(str, "text");
        ...
        return new AndroidParagraph(new AndroidParagraphIntrinsics(str, textStyle, list, list2, resolver2, density2), i11, z11, j11, (DefaultConstructorMarker) null);
    }
}
