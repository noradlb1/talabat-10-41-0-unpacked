...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface m5238getNativeTypefacePYhJU0U(@NotNull FontWeight fontWeight, int i11, int i12) {
        Intrinsics.checkNotNullParameter(fontWeight, TtmlNode.ATTR_TTS_FONT_WEIGHT);
        if (Build.VERSION.SDK_INT < 28) {
            Typeface defaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m5077getAndroidTypefaceStyleFO1MlWM(fontWeight, i11));
        ...
        return typefaceHelperMethodsApi28.create(typeface, fontWeight.getWeight(), FontStyle.m5124equalsimpl0(i11, FontStyle.Companion.m5128getItalic_LCdwA()));
    }
}
