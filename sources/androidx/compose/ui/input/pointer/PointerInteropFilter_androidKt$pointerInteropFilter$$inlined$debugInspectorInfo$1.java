...
public final class PointerInteropFilter_androidKt$pointerInteropFilter$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ RequestDisallowInterceptTouchEvent f9792g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ Function1 f9793h;
    ...
    public PointerInteropFilter_androidKt$pointerInteropFilter$$inlined$debugInspectorInfo$1(RequestDisallowInterceptTouchEvent requestDisallowInterceptTouchEvent, Function1 function1) {
        super(1);
        this.f9792g = requestDisallowInterceptTouchEvent;
        this.f9793h = function1;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("requestDisallowInterceptTouchEvent", this.f9792g);
        inspectorInfo.getProperties().set("onTouchEvent", this.f9793h);
    }
}
