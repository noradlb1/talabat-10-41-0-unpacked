...
public final class PointerInteropFilter_androidKt {
    ...
    public static /* synthetic */ Modifier pointerInteropFilter$default(Modifier modifier, RequestDisallowInterceptTouchEvent requestDisallowInterceptTouchEvent, Function1 function1, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    @ExperimentalComposeUiApi
    @NotNull
    public static final Modifier pointerInteropFilter(@NotNull Modifier modifier, @Nullable RequestDisallowInterceptTouchEvent requestDisallowInterceptTouchEvent, @NotNull Function1<? super MotionEvent, Boolean> function1) {
        Intrinsics.checkNotNullParameter(modifier, "<this>");
