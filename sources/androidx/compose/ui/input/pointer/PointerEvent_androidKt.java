...
public final class PointerEvent_androidKt {
    public static final int EmptyPointerKeyboardModifiers() {
        return PointerKeyboardModifiers.m4356constructorimpl(0);
    }

    /* renamed from: getAreAnyPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4269getAreAnyPressedaHzCxE(int i11) {
        return i11 != 0;
    }

    /* renamed from: indexOfFirstPressed-aHzCx-E  reason: not valid java name */
    public static final int m4270indexOfFirstPressedaHzCxE(int i11) {
        if (i11 == 0) {
            return -1;
        }
        int i12 = 0;
    ...
    public static final int m4271indexOfLastPressedaHzCxE(int i11) {
        int i12 = -1;
    ...
    public static final boolean m4272isAltGraphPressed5xRPYO0(int i11) {
        return false;
    }

    /* renamed from: isAltPressed-5xRPYO0  reason: not valid java name */
    public static final boolean m4273isAltPressed5xRPYO0(int i11) {
        return (i11 & 2) != 0;
    }

    /* renamed from: isBackPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4274isBackPressedaHzCxE(int i11) {
        return (i11 & 8) != 0;
    }

    /* renamed from: isCapsLockOn-5xRPYO0  reason: not valid java name */
    public static final boolean m4275isCapsLockOn5xRPYO0(int i11) {
        return (i11 & 1048576) != 0;
    }

    /* renamed from: isCtrlPressed-5xRPYO0  reason: not valid java name */
    public static final boolean m4276isCtrlPressed5xRPYO0(int i11) {
        return (i11 & 4096) != 0;
    }

    /* renamed from: isForwardPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4277isForwardPressedaHzCxE(int i11) {
        return (i11 & 16) != 0;
    }

    /* renamed from: isFunctionPressed-5xRPYO0  reason: not valid java name */
    public static final boolean m4278isFunctionPressed5xRPYO0(int i11) {
        return (i11 & 8) != 0;
    }

    /* renamed from: isMetaPressed-5xRPYO0  reason: not valid java name */
    public static final boolean m4279isMetaPressed5xRPYO0(int i11) {
        return (i11 & 65536) != 0;
    }

    /* renamed from: isNumLockOn-5xRPYO0  reason: not valid java name */
    public static final boolean m4280isNumLockOn5xRPYO0(int i11) {
        return (i11 & 2097152) != 0;
    }

    /* renamed from: isPressed-bNIWhpI  reason: not valid java name */
    public static final boolean m4281isPressedbNIWhpI(int i11, int i12) {
        if (i12 == 0) {
            return m4282isPrimaryPressedaHzCxE(i11);
        }
        if (i12 == 1) {
            return m4284isSecondaryPressedaHzCxE(i11);
        }
    ...
    public static final boolean m4282isPrimaryPressedaHzCxE(int i11) {
        return (i11 & 33) != 0;
    }

    /* renamed from: isScrollLockOn-5xRPYO0  reason: not valid java name */
    public static final boolean m4283isScrollLockOn5xRPYO0(int i11) {
        return (i11 & 4194304) != 0;
    }

    /* renamed from: isSecondaryPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4284isSecondaryPressedaHzCxE(int i11) {
        return (i11 & 66) != 0;
    }

    /* renamed from: isShiftPressed-5xRPYO0  reason: not valid java name */
    public static final boolean m4285isShiftPressed5xRPYO0(int i11) {
        return (i11 & 1) != 0;
    }

    /* renamed from: isSymPressed-5xRPYO0  reason: not valid java name */
    public static final boolean m4286isSymPressed5xRPYO0(int i11) {
        return (i11 & 4) != 0;
    }

    /* renamed from: isTertiaryPressed-aHzCx-E  reason: not valid java name */
    public static final boolean m4287isTertiaryPressedaHzCxE(int i11) {
        return (i11 & 4) != 0;
    }
}
