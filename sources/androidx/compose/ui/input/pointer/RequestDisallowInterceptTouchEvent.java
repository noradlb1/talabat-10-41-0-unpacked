...
public final class RequestDisallowInterceptTouchEvent implements Function1<Boolean, Unit> {
    ...
    public final void setPointerInteropFilter$ui_release(@Nullable PointerInteropFilter pointerInteropFilter2) {
    ...
    public void invoke(boolean z11) {
        ...
        if (pointerInteropFilter2 != null) {
            pointerInteropFilter2.setDisallowIntercept$ui_release(z11);
        }
    }
}
