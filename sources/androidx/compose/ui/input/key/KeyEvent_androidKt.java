...
public final class KeyEvent_androidKt {
    ...
    public static final long m4183getKeyZmokQxo(@NotNull KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$key");
        return Key_androidKt.Key(keyEvent.getKeyCode());
    }

    /* renamed from: getType-ZmokQxo  reason: not valid java name */
    public static final int m4184getTypeZmokQxo(@NotNull KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$type");
        int action = keyEvent.getAction();
        if (action == 0) {
            return KeyEventType.Companion.m4180getKeyDownCS__XNY();
        }
        if (action != 1) {
            return KeyEventType.Companion.m4182getUnknownCS__XNY();
        }
        return KeyEventType.Companion.m4181getKeyUpCS__XNY();
    }

    /* renamed from: getUtf16CodePoint-ZmokQxo  reason: not valid java name */
    public static final int m4185getUtf16CodePointZmokQxo(@NotNull KeyEvent keyEvent) {
    ...
    public static final boolean m4186isAltPressedZmokQxo(@NotNull KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$isAltPressed");
        return keyEvent.isAltPressed();
    }

    /* renamed from: isCtrlPressed-ZmokQxo  reason: not valid java name */
    public static final boolean m4187isCtrlPressedZmokQxo(@NotNull KeyEvent keyEvent) {
    ...
    public static final boolean m4188isMetaPressedZmokQxo(@NotNull KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$isMetaPressed");
        return keyEvent.isMetaPressed();
    }

    /* renamed from: isShiftPressed-ZmokQxo  reason: not valid java name */
    public static final boolean m4189isShiftPressedZmokQxo(@NotNull KeyEvent keyEvent) {
