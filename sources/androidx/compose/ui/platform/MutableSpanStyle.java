...
final class MutableSpanStyle {
    ...
    public /* synthetic */ MutableSpanStyle(long j11, long j12, FontWeight fontWeight2, FontStyle fontStyle2, FontSynthesis fontSynthesis2, FontFamily fontFamily2, String str, long j13, BaselineShift baselineShift2, TextGeometricTransform textGeometricTransform2, LocaleList localeList2, long j14, TextDecoration textDecoration2, Shadow shadow2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public final long m4845getBackground0d7_KjU() {
        return this.background;
    }

    @Nullable
    /* renamed from: getBaselineShift-5SSeXJ0  reason: not valid java name */
    public final BaselineShift m4846getBaselineShift5SSeXJ0() {
        return this.baselineShift;
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public final long m4847getColor0d7_KjU() {
        return this.color;
    }
    ...
    public final long m4848getFontSizeXSAIIZE() {
        return this.fontSize;
    }

    @Nullable
    /* renamed from: getFontStyle-4Lr2A7w  reason: not valid java name */
    public final FontStyle m4849getFontStyle4Lr2A7w() {
        return this.fontStyle;
    }

    @Nullable
    /* renamed from: getFontSynthesis-ZQGJjVo  reason: not valid java name */
    public final FontSynthesis m4850getFontSynthesisZQGJjVo() {
    ...
    public final long m4851getLetterSpacingXSAIIZE() {
    ...
    public final void m4852setBackground8_81llA(long j11) {
        this.background = j11;
    }

    /* renamed from: setBaselineShift-_isdbwI  reason: not valid java name */
    public final void m4853setBaselineShift_isdbwI(@Nullable BaselineShift baselineShift2) {
        this.baselineShift = baselineShift2;
    }

    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public final void m4854setColor8_81llA(long j11) {
        this.color = j11;
    }

    public final void setFontFamily(@Nullable FontFamily fontFamily2) {
        this.fontFamily = fontFamily2;
    }
    ...
    public final void m4855setFontSizeR2X_6o(long j11) {
        this.fontSize = j11;
    }

    /* renamed from: setFontStyle-mLjRB2g  reason: not valid java name */
    public final void m4856setFontStylemLjRB2g(@Nullable FontStyle fontStyle2) {
        this.fontStyle = fontStyle2;
    }

    /* renamed from: setFontSynthesis-tDdu0R4  reason: not valid java name */
    public final void m4857setFontSynthesistDdu0R4(@Nullable FontSynthesis fontSynthesis2) {
        this.fontSynthesis = fontSynthesis2;
    }

    public final void setFontWeight(@Nullable FontWeight fontWeight2) {
        this.fontWeight = fontWeight2;
    }

    /* renamed from: setLetterSpacing--R2X_6o  reason: not valid java name */
    public final void m4858setLetterSpacingR2X_6o(long j11) {
        this.letterSpacing = j11;
    }

    public final void setLocaleList(@Nullable LocaleList localeList2) {
        this.localeList = localeList2;
    }
    ...
    public final void setTextGeometricTransform(@Nullable TextGeometricTransform textGeometricTransform2) {
        this.textGeometricTransform = textGeometricTransform2;
    }
