...
public final class AndroidUiDispatcher$dispatchCallback$1 implements Choreographer.FrameCallback, Runnable {
    ...
    public final /* synthetic */ AndroidUiDispatcher f10016b;

    public AndroidUiDispatcher$dispatchCallback$1(AndroidUiDispatcher androidUiDispatcher) {
        this.f10016b = androidUiDispatcher;
    }

    public void doFrame(long j11) {
        this.f10016b.handler.removeCallbacks(this);
        this.f10016b.performTrampolineDispatch();
        this.f10016b.performFrameDispatch(j11);
    }

    public void run() {
        this.f10016b.performTrampolineDispatch();
        Object access$getLock$p = this.f10016b.lock;
        AndroidUiDispatcher androidUiDispatcher = this.f10016b;
