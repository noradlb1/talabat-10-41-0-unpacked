...
final class CalculateMatrixToWindowApi29 implements CalculateMatrixToWindow {
    ...
    public void m4827calculateMatrixToWindowEL8BTi8(@NotNull View view, @NotNull float[] fArr) {
        ...
        this.tmpMatrix.postTranslate((float) (iArr2[0] - i11), (float) (iArr2[1] - i12));
        AndroidMatrixConversions_androidKt.m2789setFromtUYjHk(fArr, this.tmpMatrix);
    }
}
