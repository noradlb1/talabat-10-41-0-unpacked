...
public final class ScrollObservationScope implements OwnerScope {
    ...
    public ScrollObservationScope(int i11, @NotNull List<ScrollObservationScope> list, @Nullable Float f11, @Nullable Float f12, @Nullable ScrollAxisRange scrollAxisRange, @Nullable ScrollAxisRange scrollAxisRange2) {
