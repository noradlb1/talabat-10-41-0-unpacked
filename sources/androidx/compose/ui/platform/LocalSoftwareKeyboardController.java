...
public final class LocalSoftwareKeyboardController {
    ...
    @Composable
    private final SoftwareKeyboardController delegatingController(Composer composer, int i11) {
        ...
        int i12 = TextInputService.$stable;
    ...
    public final SoftwareKeyboardController getCurrent(@Nullable Composer composer, int i11) {
        composer.startReplaceableGroup(-1059476185);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1059476185, i11, -1, "androidx.compose.ui.platform.LocalSoftwareKeyboardController.<get-current> (LocalSoftwareKeyboardController.kt:40)");
        }
        ...
        if (softwareKeyboardController == null) {
            softwareKeyboardController = delegatingController(composer, i11 & 14);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
