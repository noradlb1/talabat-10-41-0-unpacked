...
public final class AndroidPopup_androidKt$Popup$popupLayout$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ PopupLayout f10387g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ State<Function2<Composer, Integer, Unit>> f10388h;
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1302892335, i11, -1, "androidx.compose.ui.window.Popup.<anonymous>.<anonymous>.<anonymous> (AndroidPopup.android.kt:242)");
            }
            ...
            final PopupLayout popupLayout = this.f10387g;
            Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() {
                public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                    m5731invokeozmzZPI(((IntSize) obj).m5642unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-ozmzZPI  reason: not valid java name */
                public final void m5731invokeozmzZPI(long j11) {
                    popupLayout.m5736setPopupContentSizefhxjrPA(IntSize.m5630boximpl(j11));
                    popupLayout.updatePosition();
                }
            }), this.f10387g.getCanCalculatePosition() ? 1.0f : 0.0f);
            final State<Function2<Composer, Integer, Unit>> state = this.f10388h;
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer, 606497925, true, new Function2<Composer, Integer, Unit>() {
                public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
                    invoke((Composer) obj, ((Number) obj2).intValue());
                    return Unit.INSTANCE;
                }
                ...
                public final void invoke(@Nullable Composer composer, int i11) {
                    if ((i11 & 11) != 2 || !composer.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(606497925, i11, -1, "androidx.compose.ui.window.Popup.<anonymous>.<anonymous>.<anonymous>.<anonymous> (AndroidPopup.android.kt:253)");
                        }
                        AndroidPopup_androidKt.m5727Popup$lambda1(state).invoke(composer, 0);
                        if (ComposerKt.isTraceInProgress()) {
            ...
            Updater.m2543setimpl(r72, androidPopup_androidKt$SimpleStack$1, companion.getSetMeasurePolicy());
