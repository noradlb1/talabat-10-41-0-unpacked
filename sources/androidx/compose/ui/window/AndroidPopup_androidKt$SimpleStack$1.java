...
public final class AndroidPopup_androidKt$SimpleStack$1 implements MeasurePolicy {
    ...
    public final MeasureResult m5732measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull List<? extends Measurable> list, long j11) {
        int i11;
        int i12;
        ...
        if (size != 0) {
            ...
            if (size != 1) {
                ...
                return MeasureScope.CC.p(measureScope, i12, i11, (Map) null, new AndroidPopup_androidKt$SimpleStack$1$measure$3(arrayList), 4, (Object) null);
            }
            Placeable r12 = ((Measurable) list.get(0)).m4508measureBRTryo0(j11);
            return MeasureScope.CC.p(measureScope, r12.getWidth(), r12.getHeight(), (Map) null, new AndroidPopup_androidKt$SimpleStack$1$measure$2(r12), 4, (Object) null);
        }
        return MeasureScope.CC.p(measureScope, 0, 0, (Map) null, AndroidPopup_androidKt$SimpleStack$1$measure$1.INSTANCE, 4, (Object) null);
    }
