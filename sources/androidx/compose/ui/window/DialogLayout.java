...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    @NotNull
    private final MutableState content$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m5733getLambda1$ui_release(), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public DialogLayout(@NotNull Context context, @NotNull Window window2) {
    ...
    public void Content(@Nullable Composer composer, int i11) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1735448596, i11, -1, "androidx.compose.ui.window.DialogLayout.Content (AndroidDialog.android.kt:270)");
        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new DialogLayout$Content$4(this, i11));
        }
    }
