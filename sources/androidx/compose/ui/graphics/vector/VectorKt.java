...
public final class VectorKt {
    private static final int DefaultFillType = PathFillType.Companion.m3166getNonZeroRgk1Os();
    @NotNull
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m3253getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m3264getMiterLxFBmk8();
    public static final float DefaultStrokeLineMiter = 4.0f;
    public static final float DefaultStrokeLineWidth = 0.0f;
    private static final int DefaultTintBlendMode = BlendMode.Companion.m2855getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m2954getTransparent0d7_KjU();
