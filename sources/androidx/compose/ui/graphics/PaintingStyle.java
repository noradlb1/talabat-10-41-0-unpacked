...
public final class PaintingStyle {
    ...
    public static final int Fill = m3142constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Stroke = m3142constructorimpl(1);
    ...
    public static final class Companion {
        ...
        public final int m3148getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo  reason: not valid java name */
        public final int m3149getStrokeTiuSbCo() {
    ...
    public static final /* synthetic */ PaintingStyle m3141boximpl(int i11) {
        return new PaintingStyle(i11);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m3142constructorimpl(int i11) {
        return i11;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3143equalsimpl(int i11, Object obj) {
        return (obj instanceof PaintingStyle) && i11 == ((PaintingStyle) obj).m3147unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3144equalsimpl0(int i11, int i12) {
        return i11 == i12;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3145hashCodeimpl(int i11) {
        return i11;
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3146toStringimpl(int i11) {
        if (m3144equalsimpl0(i11, Fill)) {
            return "Fill";
        }
        if (m3144equalsimpl0(i11, Stroke)) {
            return "Stroke";
        }
        return "Unknown";
    }
