...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m2782actualColorMatrixColorFilterjHGOpc(@NotNull float[] fArr) {
    ...
    public static final ColorFilter m2783actualLightingColorFilterOWjLjI(long j11, long j12) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m2974toArgb8_81llA(j11), ColorKt.m2974toArgb8_81llA(j12)));
    }

    @NotNull
    /* renamed from: actualTintColorFilter-xETnrds  reason: not valid java name */
    public static final ColorFilter m2784actualTintColorFilterxETnrds(long j11, int i11) {
        ColorFilter colorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            colorFilter = BlendModeColorFilterHelper.INSTANCE.m2859BlendModeColorFilterxETnrds(j11, i11);
        } else {
            colorFilter = new PorterDuffColorFilter(ColorKt.m2974toArgb8_81llA(j11), AndroidBlendMode_androidKt.m2769toPorterDuffModes9anfk8(i11));
        }
