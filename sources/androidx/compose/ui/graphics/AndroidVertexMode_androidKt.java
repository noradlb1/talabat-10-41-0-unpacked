...
public final class AndroidVertexMode_androidKt {
    ...
    public static final Canvas.VertexMode m2821toAndroidVertexModeJOOmi9M(int i11) {
        VertexMode.Companion companion = VertexMode.Companion;
        if (VertexMode.m3296equalsimpl0(i11, companion.m3302getTrianglesc2xauaI())) {
            return Canvas.VertexMode.TRIANGLES;
        }
        if (VertexMode.m3296equalsimpl0(i11, companion.m3301getTriangleStripc2xauaI())) {
            return Canvas.VertexMode.TRIANGLE_STRIP;
        }
        if (VertexMode.m3296equalsimpl0(i11, companion.m3300getTriangleFanc2xauaI())) {
