...
public final class SemanticsProperties {
    ...
    @NotNull
    private static final SemanticsPropertyKey<List<AnnotatedString>> Text = new SemanticsPropertyKey<>(MissionDetailsDialogFragment.Section.Text.TYPE, SemanticsProperties$Text$1.INSTANCE);
    @NotNull
