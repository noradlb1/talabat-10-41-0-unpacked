...
public final class RootMeasurePolicy$measure$4 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final /* synthetic */ List<Placeable> f9878g;
    ...
    public final void invoke(@NotNull Placeable.PlacementScope placementScope) {
        ...
        List<Placeable> list = this.f9878g;
        int size = list.size();
        for (int i11 = 0; i11 < size; i11++) {
            Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, list.get(i11), 0, 0, 0.0f, (Function1) null, 12, (Object) null);
        }
    }
}
