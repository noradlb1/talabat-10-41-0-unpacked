...
public final class BiasAlignment implements Alignment {
    ...
    public static final class Horizontal implements Alignment.Horizontal {
        ...
        public int align(int i11, int i12, @NotNull LayoutDirection layoutDirection) {
            ...
            float f12 = ((float) (i12 - i11)) / 2.0f;
            if (layoutDirection == LayoutDirection.Ltr) {
                f11 = this.bias;
            } else {
                f11 = ((float) -1) * this.bias;
            }
            return MathKt__MathJVMKt.roundToInt(f12 * (((float) 1) + f11));
        }
    ...
    public long m2556alignKFBX0sM(long j11, long j12, @NotNull LayoutDirection layoutDirection) {
        float f11;
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float r02 = ((float) (IntSize.m5638getWidthimpl(j12) - IntSize.m5638getWidthimpl(j11))) / 2.0f;
        float r32 = ((float) (IntSize.m5637getHeightimpl(j12) - IntSize.m5637getHeightimpl(j11))) / 2.0f;
        if (layoutDirection == LayoutDirection.Ltr) {
            f11 = this.horizontalBias;
        } else {
            f11 = ((float) -1) * this.horizontalBias;
        }
        float f12 = (float) 1;
        return IntOffsetKt.IntOffset(MathKt__MathJVMKt.roundToInt(r02 * (f11 + f12)), MathKt__MathJVMKt.roundToInt(r32 * (f12 + this.verticalBias)));
    }
