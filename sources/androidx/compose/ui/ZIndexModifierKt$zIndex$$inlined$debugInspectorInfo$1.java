...
public final class ZIndexModifierKt$zIndex$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f9558g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ZIndexModifierKt$zIndex$$inlined$debugInspectorInfo$1(float f11) {
        super(1);
        this.f9558g = f11;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setName(Param.Z_INDEX);
        inspectorInfo.setValue(Float.valueOf(this.f9558g));
    }
}
