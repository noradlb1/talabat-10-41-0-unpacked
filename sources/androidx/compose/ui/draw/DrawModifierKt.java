...
public final class DrawModifierKt {
    ...
    public static final Modifier drawBehind(@NotNull Modifier modifier, @NotNull Function1<? super DrawScope, Unit> function1) {
        ...
        if (InspectableValueKt.isDebugInspectorInfoEnabled()) {
            function12 = new DrawModifierKt$drawBehind$$inlined$debugInspectorInfo$1(function1);
        } else {
            function12 = InspectableValueKt.getNoInspectorInfo();
        }
        return modifier.then(new DrawBackgroundModifier(function1, function12));
    }
    ...
    public static final Modifier drawWithContent(@NotNull Modifier modifier, @NotNull Function1<? super ContentDrawScope, Unit> function1) {
        ...
        Intrinsics.checkNotNullParameter(function1, "onDraw");
        if (InspectableValueKt.isDebugInspectorInfoEnabled()) {
            function12 = new DrawModifierKt$drawWithContent$$inlined$debugInspectorInfo$1(function1);
        } else {
            function12 = InspectableValueKt.getNoInspectorInfo();
        }
        return modifier.then(new DrawWithContentModifier(function1, function12));
    }
}
