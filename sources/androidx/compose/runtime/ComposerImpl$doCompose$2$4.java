...
public final class ComposerImpl$doCompose$2$4 extends Lambda implements Function1<State<?>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ ComposerImpl f9054g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ComposerImpl$doCompose$2$4(ComposerImpl composerImpl) {
        super(1);
        this.f9054g = composerImpl;
    }
    ...
    public final void invoke(@NotNull State<?> state) {
        ...
        ComposerImpl composerImpl = this.f9054g;
