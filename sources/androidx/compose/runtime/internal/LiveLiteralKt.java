...
public final class LiveLiteralKt {
    ...
    @InternalComposeApi
    @NotNull
    public static final <T> State<T> liveLiteral(@NotNull String str, T t11) {
        Intrinsics.checkNotNullParameter(str, "key");
        HashMap<String, MutableState<Object>> hashMap = liveLiteralCache;
        MutableState<Object> mutableState = hashMap.get(str);
        if (mutableState == null) {
            mutableState = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(t11, (SnapshotMutationPolicy) null, 2, (Object) null);
