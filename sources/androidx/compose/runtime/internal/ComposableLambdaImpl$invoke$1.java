...
public final class ComposableLambdaImpl$invoke$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ ComposableLambdaImpl f9263g;
    ...
    public ComposableLambdaImpl$invoke$1(ComposableLambdaImpl composableLambdaImpl, Object obj, int i11) {
        super(2);
        this.f9263g = composableLambdaImpl;
        this.f9264h = obj;
        this.f9265i = i11;
    }
    ...
    public final void invoke(@NotNull Composer composer, int i11) {
        ...
        this.f9263g.invoke(this.f9264h, composer, this.f9265i | 1);
    }
}
