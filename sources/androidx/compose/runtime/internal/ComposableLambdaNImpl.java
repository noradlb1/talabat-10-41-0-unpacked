...
public final class ComposableLambdaNImpl implements ComposableLambdaN {
    ...
    public Object invoke(@NotNull Object... objArr) {
        ...
        Object[] array = ArraysKt___ArraysKt.slice((T[]) objArr, RangesKt___RangesKt.until(0, objArr.length - 1)).toArray(new Object[0]);
        ...
        if (startRestartGroup.changed((Object) this)) {
            i11 = ComposableLambdaKt.differentBits(realParamCount);
        } else {
            i11 = ComposableLambdaKt.sameBits(realParamCount);
        }
        ...
        spreadBuilder.add(Integer.valueOf(i12));
