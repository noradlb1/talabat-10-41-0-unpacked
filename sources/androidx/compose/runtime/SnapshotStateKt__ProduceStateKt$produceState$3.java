...
public final class SnapshotStateKt__ProduceStateKt$produceState$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ Function2<ProduceStateScope<T>, Continuation<? super Unit>, Object> f9231i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ MutableState<T> f9232j;
    ...
    public SnapshotStateKt__ProduceStateKt$produceState$3(Function2<? super ProduceStateScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2, MutableState<T> mutableState, Continuation<? super SnapshotStateKt__ProduceStateKt$produceState$3> continuation) {
        ...
        this.f9231i = function2;
        this.f9232j = mutableState;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        SnapshotStateKt__ProduceStateKt$produceState$3 snapshotStateKt__ProduceStateKt$produceState$3 = new SnapshotStateKt__ProduceStateKt$produceState$3(this.f9231i, this.f9232j, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i11 == 0) {
            ...
            Function2<ProduceStateScope<T>, Continuation<? super Unit>, Object> function2 = this.f9231i;
            ProduceStateScopeImpl produceStateScopeImpl = new ProduceStateScopeImpl(this.f9232j, ((CoroutineScope) this.L$0).getCoroutineContext());
            this.f9230h = 1;
