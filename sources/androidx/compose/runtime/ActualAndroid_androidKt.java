...
public final class ActualAndroid_androidKt {
    @NotNull
    private static final Lazy DefaultMonotonicFrameClock$delegate = LazyKt__LazyJVMKt.lazy(ActualAndroid_androidKt$DefaultMonotonicFrameClock$2.INSTANCE);
    private static final boolean DisallowDefaultMonotonicFrameClock = false;

    @NotNull
    public static final <T> SnapshotMutableState<T> createSnapshotMutableState(T t11, @NotNull SnapshotMutationPolicy<T> snapshotMutationPolicy) {
