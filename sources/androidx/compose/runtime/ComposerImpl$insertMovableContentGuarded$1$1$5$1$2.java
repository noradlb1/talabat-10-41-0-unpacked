...
public final class ComposerImpl$insertMovableContentGuarded$1$1$5$1$2 extends Lambda implements Function3<Applier<?>, SlotWriter, RememberManager, Unit> {
    ...
    public final /* synthetic */ Ref.IntRef f9076g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> f9077h;
    ...
    public final void invoke(@NotNull Applier<?> applier, @NotNull SlotWriter slotWriter, @NotNull RememberManager rememberManager) {
        ...
        int i11 = this.f9076g.element;
        if (i11 > 0) {
            applier = new OffsetApplier<>(applier, i11);
        }
        List<Function3<Applier<?>, SlotWriter, RememberManager, Unit>> list = this.f9077h;
        int size = list.size();
