...
public final class PersistentOrderedMap<K, V> extends AbstractMap<K, V> implements PersistentMap<K, V> {
    ...
    public final Set<Map.Entry<K, V>> m2550getEntries() {
        return createEntries();
    }
    ...
    public PersistentOrderedMap<K, V> put(K k11, V v11) {
        if (isEmpty()) {
            return new PersistentOrderedMap<>(k11, k11, this.hashMap.put((Object) k11, (Object) new LinkedValue(v11)));
        }
        LinkedValue linkedValue = this.hashMap.get(k11);
        if (linkedValue == null) {
            Object obj = this.lastKey;
            LinkedValue<V> linkedValue2 = this.hashMap.get(obj);
            Intrinsics.checkNotNull(linkedValue2);
            return new PersistentOrderedMap<>(this.firstKey, k11, this.hashMap.put(obj, (Object) linkedValue2.withNext(k11)).put((Object) k11, (Object) new LinkedValue(v11, obj)));
        } else if (linkedValue.getValue() == v11) {
            return this;
        } else {
            return new PersistentOrderedMap<>(this.firstKey, this.lastKey, this.hashMap.put((Object) k11, (Object) linkedValue.withValue(v11)));
        }
    }
    ...
    public PersistentOrderedMap<K, V> remove(K k11) {
        ...
        PersistentHashMap remove = this.hashMap.remove((Object) k11);
    ...
    public PersistentOrderedMap<K, V> remove(K k11, V v11) {
        ...
        return Intrinsics.areEqual(linkedValue.getValue(), (Object) v11) ? remove((Object) k11) : this;
    }
}
