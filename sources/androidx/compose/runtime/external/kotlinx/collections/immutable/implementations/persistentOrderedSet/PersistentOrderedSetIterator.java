...
public class PersistentOrderedSetIterator<E> implements Iterator<E>, KMappedMarker, j$.util.Iterator {
    private int index;
    @NotNull
    ...
    public PersistentOrderedSetIterator(@Nullable Object obj, @NotNull Map<E, Links> map2) {
