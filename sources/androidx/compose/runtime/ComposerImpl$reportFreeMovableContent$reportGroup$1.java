...
public final class ComposerImpl$reportFreeMovableContent$reportGroup$1 extends Lambda implements Function3<Applier<?>, SlotWriter, RememberManager, Unit> {
    ...
    public final /* synthetic */ ComposerImpl f9095g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ MovableContentStateReference f9096h;
    ...
    public ComposerImpl$reportFreeMovableContent$reportGroup$1(ComposerImpl composerImpl, MovableContentStateReference movableContentStateReference) {
        super(3);
        this.f9095g = composerImpl;
        this.f9096h = movableContentStateReference;
    }
    ...
    public final void invoke(@NotNull Applier<?> applier, @NotNull SlotWriter slotWriter, @NotNull RememberManager rememberManager) {
        ...
        this.f9095g.releaseMovableGroupAtCurrent(this.f9096h, slotWriter);
    }
}
