...
public final class StaticProvidableCompositionLocal<T> extends ProvidableCompositionLocal<T> {
    ...
    public State<T> provided$runtime_release(T t11, @Nullable Composer composer, int i11) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1121811719, i11, -1, "androidx.compose.runtime.StaticProvidableCompositionLocal.provided (CompositionLocal.kt:139)");
        }
        StaticValueHolder staticValueHolder = new StaticValueHolder(t11);
        if (ComposerKt.isTraceInProgress()) {
