...
public final class SwipeableState$animateInternalToOffset$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ SwipeableState<T> f5661i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ float f5662j;

    /* renamed from: k  reason: collision with root package name */
    public final /* synthetic */ AnimationSpec<Float> f5663k;
    ...
    public SwipeableState$animateInternalToOffset$2(SwipeableState<T> swipeableState, float f11, AnimationSpec<Float> animationSpec, Continuation<? super SwipeableState$animateInternalToOffset$2> continuation) {
        ...
        this.f5661i = swipeableState;
        this.f5662j = f11;
        this.f5663k = animationSpec;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        SwipeableState$animateInternalToOffset$2 swipeableState$animateInternalToOffset$2 = new SwipeableState$animateInternalToOffset$2(this.f5661i, this.f5662j, this.f5663k, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i11 == 0) {
            ...
            floatRef.element = ((Number) this.f5661i.absoluteOffset.getValue()).floatValue();
            this.f5661i.animationTarget.setValue(Boxing.boxFloat(this.f5662j));
            this.f5661i.setAnimationRunning(true);
            Animatable Animatable$default = AnimatableKt.Animatable$default(floatRef.element, 0.0f, 2, (Object) null);
            Float boxFloat = Boxing.boxFloat(this.f5662j);
            AnimationSpec<Float> animationSpec = this.f5663k;
            ...
            try {
                ...
                this.f5661i.animationTarget.setValue(null);
                this.f5661i.setAnimationRunning(false);
                throw th2;
            }
        } else {
