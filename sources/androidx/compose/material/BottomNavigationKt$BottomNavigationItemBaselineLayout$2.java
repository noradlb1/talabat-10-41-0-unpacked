...
public final class BottomNavigationKt$BottomNavigationItemBaselineLayout$2 implements MeasurePolicy {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ Function2<Composer, Integer, Unit> f4098a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ float f4099b;

    public BottomNavigationKt$BottomNavigationItemBaselineLayout$2(Function2<? super Composer, ? super Integer, Unit> function2, float f11) {
        this.f4098a = function2;
        this.f4099b = f11;
    }
    ...
    public final MeasureResult m1117measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull List<? extends Measurable> list, long j11) {
        Placeable placeable;
        ...
        for (Measurable measurable : iterable) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), (Object) "icon")) {
                ...
                placeable = null;
                if (this.f4098a == null) {
                    return BottomNavigationKt.m1115placeIcon3p2s80s(measureScope, r12, j12);
                }
                Intrinsics.checkNotNull(placeable);
                return BottomNavigationKt.m1116placeLabelAndIconDIyivk0(measureScope, placeable, r12, j11, this.f4099b);
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
