...
public final class BackdropScaffoldKt$BackdropScaffold$1$1$2$1$1 extends Lambda implements Function0<Unit> {
    ...
    public final /* synthetic */ BackdropScaffoldState f3975h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ CoroutineScope f3976i;
    ...
    public BackdropScaffoldKt$BackdropScaffold$1$1$2$1$1(boolean z11, BackdropScaffoldState backdropScaffoldState, CoroutineScope coroutineScope) {
        super(0);
        this.f3974g = z11;
        this.f3975h = backdropScaffoldState;
        this.f3976i = coroutineScope;
    }

    public final void invoke() {
        if (this.f3974g && ((Boolean) this.f3975h.getConfirmStateChange$material_release().invoke(BackdropValue.Concealed)).booleanValue()) {
            CoroutineScope coroutineScope = this.f3976i;
            final BackdropScaffoldState backdropScaffoldState = this.f3975h;
