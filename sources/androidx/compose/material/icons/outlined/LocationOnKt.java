...
public final class LocationOnKt {
    ...
    public static final ImageVector getLocationOn(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("Outlined.LocationOn", Dp.m5478constructorimpl(24.0f), Dp.m5478constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, 96, (DefaultConstructorMarker) null);
        ...
        pathBuilder6.arcToRelative(2.5f, 2.5f, 0.0f, true, true, -5.0f, 0.0f);
        ImageVector build = ImageVector.Builder.m3522addPathoIyEayM$default(builder, pathBuilder5.getNodes(), defaultFillType2, "", solidColor3, 1.0f, (Brush) null, 1.0f, 1.0f, r38, r39, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _locationOn = build;
