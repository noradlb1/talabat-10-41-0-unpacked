...
public final class PersonKt {
    ...
    public static final ImageVector getPerson(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder4 = new ImageVector.Builder("TwoTone.Person", Dp.m5478constructorimpl(24.0f), Dp.m5478constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, 96, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.arcToRelative(2.0f, 2.0f, 0.0f, true, true, -4.0f, 0.0f);
        ImageVector.Builder.m3522addPathoIyEayM$default(builder2, pathBuilder3.getNodes(), defaultFillType2, "", solidColor3, 0.3f, (Brush) null, 0.3f, 1.0f, r38, r39, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        ...
        pathBuilder5.reflectiveCurveToRelative(0.9f, -2.0f, 2.0f, -2.0f);
        pathBuilder5.close();
        ImageVector build = ImageVector.Builder.m3522addPathoIyEayM$default(builder, pathBuilder5.getNodes(), defaultFillType3, "", solidColor5, 1.0f, (Brush) null, 1.0f, 1.0f, r55, r56, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _person = build;
