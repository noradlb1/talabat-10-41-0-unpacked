...
public final class AccountCircleKt {
    ...
    public static final ImageVector getAccountCircle(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.AccountCircle", Dp.m5478constructorimpl(24.0f), Dp.m5478constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, 96, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveTo(19.38f, 15.49f, 20.0f, 13.82f, 20.0f, 12.0f);
        ...
        pathBuilder4.close();
        pathBuilder4.moveTo(7.07f, 18.28f);
        pathBuilder4.curveToRelative(0.43f, -0.9f, 3.05f, -1.78f, 4.93f, -1.78f);
        pathBuilder4.reflectiveCurveToRelative(4.51f, 0.88f, 4.93f, 1.78f);
        PathBuilder pathBuilder5 = pathBuilder4;
        pathBuilder5.curveTo(15.57f, 19.36f, 13.86f, 20.0f, 12.0f, 20.0f);
        pathBuilder4.reflectiveCurveToRelative(-3.57f, -0.64f, -4.93f, -1.72f);
        pathBuilder4.close();
        pathBuilder4.moveTo(18.36f, 16.83f);
        pathBuilder5.curveToRelative(-1.43f, -1.74f, -4.9f, -2.33f, -6.36f, -2.33f);
        pathBuilder4.reflectiveCurveToRelative(-4.93f, 0.59f, -6.36f, 2.33f);
        PathBuilder pathBuilder6 = pathBuilder4;
        pathBuilder6.curveTo(4.62f, 15.49f, 4.0f, 13.82f, 4.0f, 12.0f);
        pathBuilder6.curveToRelative(0.0f, -4.41f, 3.59f, -8.0f, 8.0f, -8.0f);
        pathBuilder4.reflectiveCurveToRelative(8.0f, 3.59f, 8.0f, 8.0f);
        pathBuilder6.curveToRelative(0.0f, 1.82f, -0.62f, 3.49f, -1.64f, 4.83f);
        pathBuilder4.close();
        pathBuilder4.moveTo(12.0f, 6.0f);
        pathBuilder6.curveToRelative(-1.94f, 0.0f, -3.5f, 1.56f, -3.5f, 3.5f);
        pathBuilder4.reflectiveCurveTo(10.06f, 13.0f, 12.0f, 13.0f);
        pathBuilder4.reflectiveCurveToRelative(3.5f, -1.56f, 3.5f, -3.5f);
        pathBuilder4.reflectiveCurveTo(13.94f, 6.0f, 12.0f, 6.0f);
        pathBuilder4.close();
        ...
        pathBuilder4.close();
        ImageVector build = ImageVector.Builder.m3522addPathoIyEayM$default(builder, pathBuilder4.getNodes(), defaultFillType2, "", solidColor3, 1.0f, (Brush) null, 1.0f, 1.0f, r38, r39, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
