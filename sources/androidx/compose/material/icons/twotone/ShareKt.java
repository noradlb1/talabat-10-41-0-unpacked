...
public final class ShareKt {
    ...
    public static final ImageVector getShare(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder5 = new ImageVector.Builder("TwoTone.Share", Dp.m5478constructorimpl(24.0f), Dp.m5478constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, 96, (DefaultConstructorMarker) null);
        ...
        pathBuilder4.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector.Builder.m3522addPathoIyEayM$default(builder3, pathBuilder3.getNodes(), defaultFillType2, "", solidColor3, 0.3f, (Brush) null, 0.3f, 1.0f, r38, r39, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        ...
        pathBuilder6.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector.Builder.m3522addPathoIyEayM$default(builder2, pathBuilder5.getNodes(), defaultFillType3, "", solidColor5, 0.3f, (Brush) null, 0.3f, 1.0f, r55, r56, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null);
        ...
        pathBuilder7.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilder7.close();
        ImageVector build = ImageVector.Builder.m3522addPathoIyEayM$default(builder, pathBuilder7.getNodes(), defaultFillType4, "", solidColor7, 1.0f, (Brush) null, 1.0f, 1.0f, r72, r73, 1.0f, 0.0f, 0.0f, 0.0f, 14336, (Object) null).build();
        _share = build;
