...
public final class ElevationKt {
    ...
    public static final Object m1245animateElevationrAjV9yQ(@NotNull Animatable<Dp, ?> animatable, float f11, @Nullable Interaction interaction, @Nullable Interaction interaction2, @NotNull Continuation<? super Unit> continuation) {
    ...
    public static /* synthetic */ Object m1246animateElevationrAjV9yQ$default(Animatable animatable, float f11, Interaction interaction, Interaction interaction2, Continuation continuation, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            interaction = null;
        }
        if ((i11 & 4) != 0) {
        ...
        return m1245animateElevationrAjV9yQ(animatable, f11, interaction, interaction2, continuation);
    }
}
