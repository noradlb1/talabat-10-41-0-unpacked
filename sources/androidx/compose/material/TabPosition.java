...
public final class TabPosition {
    ...
    public final float m1414getLeftD9Ej5fM() {
        return this.left;
    }

    /* renamed from: getRight-D9Ej5fM  reason: not valid java name */
    public final float m1415getRightD9Ej5fM() {
        return Dp.m5478constructorimpl(this.left + this.width);
    }

    /* renamed from: getWidth-D9Ej5fM  reason: not valid java name */
    public final float m1416getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public String toString() {
        return "TabPosition(left=" + Dp.m5489toStringimpl(this.left) + ", right=" + Dp.m5489toStringimpl(m1415getRightD9Ej5fM()) + ", width=" + Dp.m5489toStringimpl(this.width) + ')';
    }
}
