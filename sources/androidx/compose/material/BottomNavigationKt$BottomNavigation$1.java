...
public final class BottomNavigationKt$BottomNavigation$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function3<RowScope, Composer, Integer, Unit> f4069g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ int f4070h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BottomNavigationKt$BottomNavigation$1(Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i11) {
        super(2);
        this.f4069g = function3;
        this.f4070h = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            Modifier selectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m544height3ABfNKs(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), BottomNavigationKt.BottomNavigationHeight));
            Arrangement.HorizontalOrVertical spaceBetween = Arrangement.INSTANCE.getSpaceBetween();
            Function3<RowScope, Composer, Integer, Unit> function3 = this.f4069g;
            int i12 = ((this.f4070h >> 3) & 7168) | 48;
            composer.startReplaceableGroup(693286680);
            int i13 = i12 >> 3;
            MeasurePolicy rowMeasurePolicy = RowKt.rowMeasurePolicy(spaceBetween, Alignment.Companion.getTop(), composer, (i13 & 112) | (i13 & 14));
