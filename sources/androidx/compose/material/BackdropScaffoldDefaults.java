...
public final class BackdropScaffoldDefaults {
    ...
    private static final float FrontLayerElevation = Dp.m5478constructorimpl((float) 1);
    private static final float HeaderHeight = Dp.m5478constructorimpl((float) 48);
    @NotNull
    public static final BackdropScaffoldDefaults INSTANCE = new BackdropScaffoldDefaults();
    private static final float PeekHeight = Dp.m5478constructorimpl((float) 56);

    private BackdropScaffoldDefaults() {
    }

    /* renamed from: getFrontLayerElevation-D9Ej5fM  reason: not valid java name */
    public final float m1089getFrontLayerElevationD9Ej5fM() {
        return FrontLayerElevation;
    }

    @Composable
    @JvmName(name = "getFrontLayerScrimColor")
    public final long getFrontLayerScrimColor(@Nullable Composer composer, int i11) {
        composer.startReplaceableGroup(1806270648);
        long r02 = Color.m2918copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1183getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
    ...
    public final Shape getFrontLayerShape(@Nullable Composer composer, int i11) {
        composer.startReplaceableGroup(1580588700);
        float f11 = (float) 16;
        CornerBasedShape copy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes(composer, 6).getLarge(), CornerSizeKt.m806CornerSize0680j_4(Dp.m5478constructorimpl(f11)), CornerSizeKt.m806CornerSize0680j_4(Dp.m5478constructorimpl(f11)), (CornerSize) null, (CornerSize) null, 12, (Object) null);
        composer.endReplaceableGroup();
        return copy$default;
    }

    /* renamed from: getHeaderHeight-D9Ej5fM  reason: not valid java name */
    public final float m1090getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }

    /* renamed from: getPeekHeight-D9Ej5fM  reason: not valid java name */
    public final float m1091getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }
}
