...
public final class TextFieldImplKt$CommonDecorationBox$3$drawBorder$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ MutableState<Size> f5968g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ PaddingValues f5969h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ Function2<Composer, Integer, Unit> f5970i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ int f5971j;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TextFieldImplKt$CommonDecorationBox$3$drawBorder$1(MutableState<Size> mutableState, PaddingValues paddingValues, Function2<? super Composer, ? super Integer, Unit> function2, int i11) {
        super(2);
        this.f5968g = mutableState;
        this.f5969h = paddingValues;
        this.f5970i = function2;
        this.f5971j = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            Modifier r11 = OutlinedTextFieldKt.m1320outlineCutout12SF9DM(LayoutIdKt.layoutId(Modifier.Companion, OutlinedTextFieldKt.BorderId), this.f5968g.getValue().m2750unboximpl(), this.f5969h);
            Function2<Composer, Integer, Unit> function2 = this.f5970i;
            int i12 = this.f5971j;
