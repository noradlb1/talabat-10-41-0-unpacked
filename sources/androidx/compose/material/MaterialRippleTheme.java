...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long m1285defaultColorWaAFU9c(@Nullable Composer composer, int i11) {
        composer.startReplaceableGroup(550536719);
        long r02 = RippleTheme.Companion.m1488defaultRippleColor5vOe2sY(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m2929unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
    ...
    public RippleAlpha rippleAlpha(@Nullable Composer composer, int i11) {
        ...
        RippleAlpha r62 = RippleTheme.Companion.m1487defaultRippleAlphaDxMtmZc(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m2929unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        composer.endReplaceableGroup();
        return r62;
    }
}
