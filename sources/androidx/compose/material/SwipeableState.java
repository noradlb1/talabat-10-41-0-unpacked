...
public class SwipeableState<T> {
    ...
    public static /* synthetic */ Object animateTo$default(SwipeableState swipeableState, Object obj, AnimationSpec<Float> animationSpec2, Continuation continuation, int i11, Object obj2) {
        if (obj2 == null) {
            if ((i11 & 2) != 0) {
    ...
    @ExperimentalMaterialApi
    @Nullable
    public final Object animateTo(T t11, @NotNull AnimationSpec<Float> animationSpec2, @NotNull Continuation<? super Unit> continuation) {
    ...
    public final SwipeProgress<T> getProgress() {
        ...
        if (size == 0) {
            ...
            obj2 = MapsKt__MapsKt.getValue(getAnchors$material_release(), Float.valueOf(floatValue));
            obj = MapsKt__MapsKt.getValue(getAnchors$material_release(), Float.valueOf(floatValue2));
            f11 = (getOffset().getValue().floatValue() - floatValue) / (floatValue2 - floatValue);
        } else {
            Object value = MapsKt__MapsKt.getValue(getAnchors$material_release(), access$findBounds.get(0));
            obj = MapsKt__MapsKt.getValue(getAnchors$material_release(), access$findBounds.get(0));
            f11 = 1.0f;
            obj2 = value;
        }
    ...
    public final T getTargetValue() {
        ...
        if (value != null) {
            ...
            f11 = SwipeableKt.computeTarget(floatValue, f12, getAnchors$material_release().keySet(), getThresholds$material_release(), 0.0f, Float.POSITIVE_INFINITY);
        }
        T t11 = getAnchors$material_release().get(Float.valueOf(f11));
        if (t11 == null) {
    ...
    @Nullable
    public final Object performFling(float f11, @NotNull Continuation<? super Unit> continuation) {
    ...
    public final java.lang.Object processNewAnchors$material_release(@org.jetbrains.annotations.NotNull java.util.Map<java.lang.Float, ? extends T> r10, @org.jetbrains.annotations.NotNull java.util.Map<java.lang.Float, ? extends T> r11, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        ...
        L_0x0013:
            ...
            r0.<init>(r9, r12)
        L_0x0018:
            java.lang.Object r12 = r0.f5681k
            ...
            float r10 = r0.f5680j
            java.lang.Object r11 = r0.f5679i
            java.util.Map r11 = (java.util.Map) r11
            java.lang.Object r0 = r0.f5678h
        ...
        L_0x01bb:
            ...
            r0.f5678h = r9     // Catch:{ CancellationException -> 0x01fe, all -> 0x01fb }
            r0.f5679i = r11     // Catch:{ CancellationException -> 0x01fe, all -> 0x01fb }
            r0.f5680j = r10     // Catch:{ CancellationException -> 0x01fe, all -> 0x01fb }
            r0.f5683m = r4     // Catch:{ CancellationException -> 0x01fe, all -> 0x01fb }
        ...
        L_0x01fe:
            r2 = r9
        L_0x01ff:
            r0.f5678h = r2     // Catch:{ all -> 0x0054 }
            r0.f5679i = r11     // Catch:{ all -> 0x0054 }
            r0.f5680j = r10     // Catch:{ all -> 0x0054 }
            r0.f5683m = r3     // Catch:{ all -> 0x0054 }
    ...
    public /* synthetic */ SwipeableState(Object obj, AnimationSpec animationSpec2, Function1 function1, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(obj, (i11 & 2) != 0 ? SwipeableDefaults.INSTANCE.getAnimationSpec() : animationSpec2, (i11 & 4) != 0 ? AnonymousClass1.INSTANCE : function1);
    }
}
