...
public final class ModalBottomSheetDefaults {
    ...
    private static final float Elevation = Dp.m5478constructorimpl((float) 16);
    @NotNull
    ...
    public final float m1296getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final long getScrimColor(@Nullable Composer composer, int i11) {
        ...
        long r02 = Color.m2918copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1178getOnSurface0d7_KjU(), 0.32f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
