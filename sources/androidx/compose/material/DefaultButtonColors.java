...
final class DefaultButtonColors implements ButtonColors {
    ...
    public /* synthetic */ DefaultButtonColors(long j11, long j12, long j13, long j14, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj == null || !Intrinsics.areEqual((Object) Reflection.getOrCreateKotlinClass(DefaultButtonColors.class), (Object) Reflection.getOrCreateKotlinClass(obj.getClass()))) {
            return false;
        }
        DefaultButtonColors defaultButtonColors = (DefaultButtonColors) obj;
        if (Color.m2920equalsimpl0(this.backgroundColor, defaultButtonColors.backgroundColor) && Color.m2920equalsimpl0(this.contentColor, defaultButtonColors.contentColor) && Color.m2920equalsimpl0(this.disabledBackgroundColor, defaultButtonColors.disabledBackgroundColor) && Color.m2920equalsimpl0(this.disabledContentColor, defaultButtonColors.disabledContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Color.m2926hashCodeimpl(this.backgroundColor) * 31) + Color.m2926hashCodeimpl(this.contentColor)) * 31) + Color.m2926hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m2926hashCodeimpl(this.disabledContentColor);
    }
}
