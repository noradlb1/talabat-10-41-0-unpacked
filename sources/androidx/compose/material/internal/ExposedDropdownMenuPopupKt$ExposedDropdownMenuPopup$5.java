...
public final class ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5 extends Lambda implements Function1<LayoutCoordinates, Unit> {
    ...
    public final void invoke(@NotNull LayoutCoordinates layoutCoordinates) {
        ...
        this.f6199g.setParentBounds(IntRectKt.m5628IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt__MathJVMKt.roundToInt(Offset.m2676getXimpl(positionInWindow)), MathKt__MathJVMKt.roundToInt(Offset.m2677getYimpl(positionInWindow))), r02));
        this.f6199g.updatePosition();
    }
}
