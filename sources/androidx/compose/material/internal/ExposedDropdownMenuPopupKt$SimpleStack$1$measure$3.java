...
public final class ExposedDropdownMenuPopupKt$SimpleStack$1$measure$3 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final /* synthetic */ List<Placeable> f6212g;
    ...
    public final void invoke(@NotNull Placeable.PlacementScope placementScope) {
        ...
        int lastIndex = CollectionsKt__CollectionsKt.getLastIndex(this.f6212g);
        if (lastIndex >= 0) {
            int i11 = 0;
            while (true) {
                Placeable.PlacementScope.placeRelative$default(placementScope, this.f6212g.get(i11), 0, 0, 0.0f, 4, (Object) null);
                if (i11 != lastIndex) {
                    i11++;
                } else {
                    return;
