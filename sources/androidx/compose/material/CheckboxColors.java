...
public interface CheckboxColors {
    @NotNull
    @Composable
    State<Color> borderColor(boolean z11, @NotNull ToggleableState toggleableState, @Nullable Composer composer, int i11);

    @NotNull
    @Composable
    State<Color> boxColor(boolean z11, @NotNull ToggleableState toggleableState, @Nullable Composer composer, int i11);

    @NotNull
    @Composable
    State<Color> checkmarkColor(@NotNull ToggleableState toggleableState, @Nullable Composer composer, int i11);
}
