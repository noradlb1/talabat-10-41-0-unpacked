...
public final class SwipeProgress<T> {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) this.from, (Object) swipeProgress.from) || !Intrinsics.areEqual((Object) this.f5581to, (Object) swipeProgress.f5581to)) {
            return false;
        }
    ...
    public String toString() {
        return "SwipeProgress(from=" + this.from + ", to=" + this.f5581to + ", fraction=" + this.fraction + ')';
    }
}
