...
public abstract class Ripple implements Indication {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.bounded == ripple.bounded && Dp.m5483equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual((Object) this.color, (Object) ripple.color)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((e.a(this.bounded) * 31) + Dp.m5484hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
    ...
    public final IndicationInstance rememberUpdatedInstance(@NotNull InteractionSource interactionSource, @Nullable Composer composer, int i11) {
        ...
        if (this.color.getValue().m2929unboximpl() != Color.Companion.m2955getUnspecified0d7_KjU()) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (z11) {
            j11 = this.color.getValue().m2929unboximpl();
        } else {
            j11 = rippleTheme.m1486defaultColorWaAFU9c(composer, 0);
        }
        composer.endReplaceableGroup();
        RippleIndicationInstance r02 = m1477rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m2909boximpl(j11), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i11 & 14) | ((i11 << 12) & Opcodes.ASM7));
        EffectsKt.LaunchedEffect(r02, interactionSource, new Ripple$rememberUpdatedInstance$1(interactionSource, r02, (Continuation<? super Ripple$rememberUpdatedInstance$1>) null), composer, ((i11 << 3) & 112) | 8);
        composer.endReplaceableGroup();
        return r02;
    }
    ...
    public abstract RippleIndicationInstance m1477rememberUpdatedRippleInstance942rkJo(@NotNull InteractionSource interactionSource, boolean z11, float f11, @NotNull State<Color> state, @NotNull State<RippleAlpha> state2, @Nullable Composer composer, int i11);
}
