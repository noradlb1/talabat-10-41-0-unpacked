...
public abstract class RippleIndicationInstance implements IndicationInstance {
    ...
    public RippleIndicationInstance(boolean z11, @NotNull State<RippleAlpha> state) {
        ...
        this.stateLayer = new StateLayer(z11, state);
    }

    public abstract void addRipple(@NotNull PressInteraction.Press press, @NotNull CoroutineScope coroutineScope);

    /* renamed from: drawStateLayer-H2RKhps  reason: not valid java name */
    public final void m1484drawStateLayerH2RKhps(@NotNull DrawScope drawScope, float f11, long j11) {
        Intrinsics.checkNotNullParameter(drawScope, "$this$drawStateLayer");
        this.stateLayer.m1489drawStateLayerH2RKhps(drawScope, f11, j11);
    }
