...
public final class DefaultButtonElevation$elevation$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {

    /* renamed from: h  reason: collision with root package name */
    public int f4367h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ InteractionSource f4368i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ SnapshotStateList<Interaction> f4369j;
    ...
    public DefaultButtonElevation$elevation$1(InteractionSource interactionSource, SnapshotStateList<Interaction> snapshotStateList, Continuation<? super DefaultButtonElevation$elevation$1> continuation) {
        ...
        this.f4368i = interactionSource;
        this.f4369j = snapshotStateList;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new DefaultButtonElevation$elevation$1(this.f4368i, this.f4369j, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i11 == 0) {
            ...
            Flow<Interaction> interactions = this.f4368i.getInteractions();
            final SnapshotStateList<Interaction> snapshotStateList = this.f4369j;
