...
public final class SliderKt$rangeSliderPressDragModifier$1$1$1$1$finishInteraction$success$1 extends Lambda implements Function1<PointerInputChange, Unit> {
    ...
    public final /* synthetic */ State<Function2<Boolean, Float, Unit>> f5313g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ Ref.BooleanRef f5314h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ boolean f5315i;
    ...
    public final void invoke(@NotNull PointerInputChange pointerInputChange) {
        ...
        Function2 value = this.f5313g.getValue();
        Boolean valueOf = Boolean.valueOf(this.f5314h.element);
        if (this.f5315i) {
            r42 = -r42;
        }
