    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-713969278, i11, -1, "androidx.compose.material3.ComposableSingletons$TabRowKt.lambda-2.<anonymous> (TabRow.kt:232)");
            }
            DividerKt.m1645Divider9IZ8Weo((Modifier) null, 0.0f, 0, composer, 0, 7);
            if (ComposerKt.isTraceInProgress()) {
