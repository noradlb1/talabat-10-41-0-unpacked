...
public final class IconButtonKt$OutlinedIconToggleButton$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function2<Composer, Integer, Unit> f7204g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ int f7205h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public IconButtonKt$OutlinedIconToggleButton$3(Function2<? super Composer, ? super Integer, Unit> function2, int i11) {
        super(2);
        this.f7204g = function2;
        this.f7205h = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1207657396, i11, -1, "androidx.compose.material3.OutlinedIconToggleButton.<anonymous> (IconButton.kt:525)");
            }
            ...
            Function2<Composer, Integer, Unit> function2 = this.f7204g;
            int i12 = this.f7205h;
