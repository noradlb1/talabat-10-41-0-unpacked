...
public final class IconButtonKt$FilledIconButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ Function2<Composer, Integer, Unit> f7129g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ int f7130h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public IconButtonKt$FilledIconButton$2(Function2<? super Composer, ? super Integer, Unit> function2, int i11) {
        super(2);
        this.f7129g = function2;
        this.f7130h = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1560623888, i11, -1, "androidx.compose.material3.FilledIconButton.<anonymous> (IconButton.kt:212)");
            }
            Modifier r12 = SizeKt.m558size3ABfNKs(Modifier.Companion, FilledIconButtonTokens.INSTANCE.m2216getContainerSizeD9Ej5fM());
            Alignment center = Alignment.Companion.getCenter();
            Function2<Composer, Integer, Unit> function2 = this.f7129g;
            int i12 = this.f7130h;
