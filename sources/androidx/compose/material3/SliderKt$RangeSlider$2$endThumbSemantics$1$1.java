...
public final class SliderKt$RangeSlider$2$endThumbSemantics$1$1 extends Lambda implements Function1<Float, Unit> {
    ...
    public final /* synthetic */ State<Function1<ClosedFloatingPointRange<Float>, Unit>> f7960g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ float f7961h;
    ...
    public final void invoke(float f11) {
        this.f7960g.getValue().invoke(RangesKt__RangesKt.rangeTo(this.f7961h, f11));
    }
}
