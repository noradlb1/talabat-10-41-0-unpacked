...
public final class SnackbarHostKt {
    ...
    public static final void FadeInFadeOutWithScale(androidx.compose.material3.SnackbarData r18, androidx.compose.ui.Modifier r19, kotlin.jvm.functions.Function3<? super androidx.compose.material3.SnackbarData, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r20, androidx.compose.runtime.Composer r21, int r22, int r23) {
        /*
            r1 = r18
            r3 = r20
            r4 = r22
        ...
        L_0x018f:
            ...
            androidx.compose.runtime.Updater.m2543setimpl((androidx.compose.runtime.Composer) r6, r9, r10)
            kotlin.jvm.functions.Function2 r9 = r16.getSetDensity()
            androidx.compose.runtime.Updater.m2543setimpl((androidx.compose.runtime.Composer) r6, r13, r9)
            kotlin.jvm.functions.Function2 r9 = r16.getSetLayoutDirection()
            androidx.compose.runtime.Updater.m2543setimpl((androidx.compose.runtime.Composer) r6, r14, r9)
            kotlin.jvm.functions.Function2 r9 = r16.getSetViewConfiguration()
            androidx.compose.runtime.Updater.m2543setimpl((androidx.compose.runtime.Composer) r6, r15, r9)
            r2.enableReusing()
        ...
        L_0x0219:
            ...
            kotlin.jvm.functions.Function3 r6 = r6.component2()
    ...
    @androidx.compose.runtime.Composable
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void SnackbarHost(@org.jetbrains.annotations.NotNull androidx.compose.material3.SnackbarHostState r7, @org.jetbrains.annotations.Nullable androidx.compose.ui.Modifier r8, @org.jetbrains.annotations.Nullable kotlin.jvm.functions.Function3<? super androidx.compose.material3.SnackbarData, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r9, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r10, int r11, int r12) {
        /*
        ...
        L_0x0068:
            ...
            kotlin.jvm.functions.Function3 r9 = r9.m1631getLambda1$material3_release()
        L_0x0070:
    ...
    public static final State<Float> animatedOpacity(AnimationSpec<Float> animationSpec, boolean z11, Function0<Unit> function0, Composer composer, int i11, int i12) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1431889134, i11, -1, "androidx.compose.material3.animatedOpacity (SnackbarHost.kt:426)");
        }
        ...
        EffectsKt.LaunchedEffect((Object) Boolean.valueOf(z11), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new SnackbarHostKt$animatedOpacity$2(animatable, z11, animationSpec, function02, (Continuation<? super SnackbarHostKt$animatedOpacity$2>) null), composer, ((i11 >> 3) & 14) | 64);
    ...
    public static final State<Float> animatedScale(AnimationSpec<Float> animationSpec, boolean z11, Composer composer, int i11) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1966809761, i11, -1, "androidx.compose.material3.animatedScale (SnackbarHost.kt:443)");
        }
        composer.startReplaceableGroup(-492369756);
        Object rememberedValue = composer.rememberedValue();
        if (rememberedValue == Composer.Companion.getEmpty()) {
        ...
        composer.endReplaceableGroup();
        Animatable animatable = (Animatable) rememberedValue;
        EffectsKt.LaunchedEffect((Object) Boolean.valueOf(z11), (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new SnackbarHostKt$animatedScale$1(animatable, z11, animationSpec, (Continuation<? super SnackbarHostKt$animatedScale$1>) null), composer, ((i11 >> 3) & 14) | 64);
        State<Float> asState = animatable.asState();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
