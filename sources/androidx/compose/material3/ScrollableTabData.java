...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i11, List<TabPosition> list) {
        int r62 = density.m5441roundToPx0680j_4(((TabPosition) CollectionsKt___CollectionsKt.last(list)).m1889getRightD9Ej5fM()) + i11;
        int maxValue = r62 - this.scrollState.getMaxValue();
        return RangesKt___RangesKt.coerceIn(density.m5441roundToPx0680j_4(tabPosition.m1888getLeftD9Ej5fM()) - ((maxValue / 2) - (density.m5441roundToPx0680j_4(tabPosition.m1890getWidthD9Ej5fM()) / 2)), 0, RangesKt___RangesKt.coerceAtLeast(r62 - maxValue, 0));
    }
