...
public final class SwipeableKt {
    ...
    public static final <T> SwipeableState<T> rememberSwipeableState(@NotNull T t11, @Nullable AnimationSpec<Float> animationSpec, @Nullable Function1<? super T, Boolean> function1, @Nullable Composer composer, int i11, int i12) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(102743774, i11, -1, "androidx.compose.material3.rememberSwipeableState (Swipeable.kt:467)");
        }
    ...
    public static final <T> SwipeableState<T> rememberSwipeableStateFor(@NotNull T t11, @NotNull Function1<? super T, Unit> function1, @Nullable AnimationSpec<Float> animationSpec, @Nullable Composer composer, int i11, int i12) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1306709399, i11, -1, "androidx.compose.material3.rememberSwipeableStateFor (Swipeable.kt:496)");
        }
        ...
        int i13 = i11 & 8;
        EffectsKt.LaunchedEffect(t11, mutableState.getValue(), new SwipeableKt$rememberSwipeableStateFor$1(t11, swipeableState, (Continuation<? super SwipeableKt$rememberSwipeableStateFor$1>) null), composer, (i11 & 14) | i13 | 512);
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final <T> androidx.compose.ui.Modifier m1867swipeablepPrIpRY(@org.jetbrains.annotations.NotNull androidx.compose.ui.Modifier r16, @org.jetbrains.annotations.NotNull androidx.compose.material3.SwipeableState<T> r17, @org.jetbrains.annotations.NotNull java.util.Map<java.lang.Float, ? extends T> r18, @org.jetbrains.annotations.NotNull androidx.compose.foundation.gestures.Orientation r19, boolean r20, boolean r21, @org.jetbrains.annotations.Nullable androidx.compose.foundation.interaction.MutableInteractionSource r22, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super T, ? super T, ? extends androidx.compose.material3.ThresholdConfig> r23, @org.jetbrains.annotations.Nullable androidx.compose.material3.ResistanceConfig r24, float r25) {
        /*
            r0 = r16
        ...
        L_0x0046:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SwipeableKt.m1867swipeablepPrIpRY(androidx.compose.ui.Modifier, androidx.compose.material3.SwipeableState, java.util.Map, androidx.compose.foundation.gestures.Orientation, boolean, boolean, androidx.compose.foundation.interaction.MutableInteractionSource, kotlin.jvm.functions.Function2, androidx.compose.material3.ResistanceConfig, float):androidx.compose.ui.Modifier");
    }

    /* renamed from: swipeable-pPrIpRY$default  reason: not valid java name */
    public static /* synthetic */ Modifier m1868swipeablepPrIpRY$default(Modifier modifier, SwipeableState swipeableState, Map map, Orientation orientation, boolean z11, boolean z12, MutableInteractionSource mutableInteractionSource, Function2 function2, ResistanceConfig resistanceConfig, float f11, int i11, Object obj) {
        boolean z13;
        boolean z14;
        ...
        if ((i12 & 256) != 0) {
            f12 = SwipeableDefaults.INSTANCE.m1866getVelocityThresholdD9Ej5fM$material3_release();
        } else {
            f12 = f11;
        }
        return m1867swipeablepPrIpRY(modifier, swipeableState, map, orientation, z13, z14, mutableInteractionSource2, swipeableKt$swipeable$1, resistanceConfig2, f12);
    }
}
