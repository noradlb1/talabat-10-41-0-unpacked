...
public final class NavigationDrawerKt$ModalNavigationDrawer$2$5 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    public final /* synthetic */ DrawerState f7494h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ CoroutineScope f7495i;
    ...
    public NavigationDrawerKt$ModalNavigationDrawer$2$5(String str, DrawerState drawerState, CoroutineScope coroutineScope) {
        super(1);
        this.f7493g = str;
        this.f7494h = drawerState;
        this.f7495i = coroutineScope;
    }
    ...
    public final void invoke(@NotNull SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.setPaneTitle(semanticsPropertyReceiver, this.f7493g);
        if (this.f7494h.isOpen()) {
            final DrawerState drawerState = this.f7494h;
            final CoroutineScope coroutineScope = this.f7495i;
