...
public final class CardKt$Card$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function3<ColumnScope, Composer, Integer, Unit> f6668g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ int f6669h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CardKt$Card$1(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i11) {
        super(2);
        this.f6668g = function3;
        this.f6669h = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(664103990, i11, -1, "androidx.compose.material3.Card.<anonymous> (Card.kt:91)");
            }
            Function3<ColumnScope, Composer, Integer, Unit> function3 = this.f6668g;
            int i12 = (this.f6669h >> 6) & 7168;
