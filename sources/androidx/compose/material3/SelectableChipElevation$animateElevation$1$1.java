...
public final class SelectableChipElevation$animateElevation$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ InteractionSource f7901i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ SnapshotStateList<Interaction> f7902j;
    ...
    public SelectableChipElevation$animateElevation$1$1(InteractionSource interactionSource, SnapshotStateList<Interaction> snapshotStateList, Continuation<? super SelectableChipElevation$animateElevation$1$1> continuation) {
        ...
        this.f7901i = interactionSource;
        this.f7902j = snapshotStateList;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new SelectableChipElevation$animateElevation$1$1(this.f7901i, this.f7902j, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i11 == 0) {
            ...
            Flow<Interaction> interactions = this.f7901i.getInteractions();
            final SnapshotStateList<Interaction> snapshotStateList = this.f7902j;
