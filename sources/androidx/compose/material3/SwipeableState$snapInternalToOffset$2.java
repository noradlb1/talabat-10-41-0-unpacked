...
public final class SwipeableState$snapInternalToOffset$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ float f8463i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ SwipeableState<T> f8464j;
    ...
    public SwipeableState$snapInternalToOffset$2(float f11, SwipeableState<T> swipeableState, Continuation<? super SwipeableState$snapInternalToOffset$2> continuation) {
        ...
        this.f8463i = f11;
        this.f8464j = swipeableState;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        SwipeableState$snapInternalToOffset$2 swipeableState$snapInternalToOffset$2 = new SwipeableState$snapInternalToOffset$2(this.f8463i, this.f8464j, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.f8462h == 0) {
            ...
            ((DragScope) this.L$0).dragBy(this.f8463i - ((Number) this.f8464j.absoluteOffset.getValue()).floatValue());
