...
public final class TextFieldImplKt$CommonDecorationBox$3$containerWithId$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function2<Composer, Integer, Unit> f8759g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ int f8760h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TextFieldImplKt$CommonDecorationBox$3$containerWithId$1(Function2<? super Composer, ? super Integer, Unit> function2, int i11) {
        super(2);
        this.f8759g = function2;
        this.f8760h = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1566950173, i11, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:170)");
            }
            Modifier layoutId = LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.ContainerId);
            Function2<Composer, Integer, Unit> function2 = this.f8759g;
            int i12 = this.f8760h;
