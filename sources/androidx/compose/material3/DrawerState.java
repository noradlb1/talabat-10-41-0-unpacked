...
public final class DrawerState {
    ...
    public final Object animateTo(@NotNull DrawerValue drawerValue, @NotNull AnimationSpec<Float> animationSpec, @NotNull Continuation<? super Unit> continuation) {
        ...
        return animateTo$material3_release == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo$material3_release : Unit.INSTANCE;
    }

    @Nullable
    public final Object close(@NotNull Continuation<? super Unit> continuation) {
        Object animateTo = animateTo(DrawerValue.Closed, NavigationDrawerKt.AnimationSpec, continuation);
        return animateTo == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo : Unit.INSTANCE;
    }
    ...
    public final Object open(@NotNull Continuation<? super Unit> continuation) {
        Object animateTo = animateTo(DrawerValue.Open, NavigationDrawerKt.AnimationSpec, continuation);
        return animateTo == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? animateTo : Unit.INSTANCE;
    }
    ...
    public final Object snapTo(@NotNull DrawerValue drawerValue, @NotNull Continuation<? super Unit> continuation) {
        ...
        return snapTo$material3_release == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? snapTo$material3_release : Unit.INSTANCE;
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ DrawerState(DrawerValue drawerValue, Function1 function1, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(drawerValue, (i11 & 2) != 0 ? AnonymousClass1.INSTANCE : function1);
    }
}
