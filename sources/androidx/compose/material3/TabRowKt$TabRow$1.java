...
public final class TabRowKt$TabRow$1 extends Lambda implements Function3<List<? extends TabPosition>, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ int f8621g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TabRowKt$TabRow$1(int i11) {
        super(3);
        this.f8621g = i11;
    }
    ...
    public final void invoke(@NotNull List<TabPosition> list, @Nullable Composer composer, int i11) {
        ...
        tabRowDefaults.m1891Indicator9IZ8Weo(tabRowDefaults.tabIndicatorOffset(Modifier.Companion, list.get(this.f8621g)), 0.0f, 0, composer, KfsConstant.KFS_RSA_KEY_LEN_3072, 6);
        if (ComposerKt.isTraceInProgress()) {
