...
public final class AppBarKt$SingleRowTopAppBar$actionsRow$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function3<RowScope, Composer, Integer, Unit> f6442g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ int f6443h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AppBarKt$SingleRowTopAppBar$actionsRow$1(Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, int i11) {
        super(2);
        this.f6442g = function3;
        this.f6443h = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1520880938, i11, -1, "androidx.compose.material3.SingleRowTopAppBar.<anonymous> (AppBar.kt:1014)");
            }
            Arrangement.Horizontal end = Arrangement.INSTANCE.getEnd();
            Alignment.Vertical centerVertically = Alignment.Companion.getCenterVertically();
            Function3<RowScope, Composer, Integer, Unit> function3 = this.f6442g;
            int i12 = ((this.f6443h >> 6) & 7168) | 432;
