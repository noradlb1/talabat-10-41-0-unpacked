...
final class MinimumTouchTargetModifier implements LayoutModifier {
    ...
    public final long m1743getSizeMYxV2XQ() {
        return this.size;
    }
    ...
    public MeasureResult m1744measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j11) {
