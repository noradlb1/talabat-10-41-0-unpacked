...
public final class IconButtonColors {
    ...
    private IconButtonColors(long j11, long j12, long j13, long j14) {
    ...
    public /* synthetic */ IconButtonColors(long j11, long j12, long j13, long j14, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public final State<Color> containerColor$material3_release(boolean z11, @Nullable Composer composer, int i11) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1876083926, i11, -1, "androidx.compose.material3.IconButtonColors.containerColor (IconButton.kt:824)");
        }
        if (z11) {
    ...
    public final State<Color> contentColor$material3_release(boolean z11, @Nullable Composer composer, int i11) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(613133646, i11, -1, "androidx.compose.material3.IconButtonColors.contentColor (IconButton.kt:834)");
        }
        if (z11) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Color.m2920equalsimpl0(this.containerColor, iconButtonColors.containerColor) && Color.m2920equalsimpl0(this.contentColor, iconButtonColors.contentColor) && Color.m2920equalsimpl0(this.disabledContainerColor, iconButtonColors.disabledContainerColor) && Color.m2920equalsimpl0(this.disabledContentColor, iconButtonColors.disabledContentColor)) {
            return true;
        }
        return false;
    }
