...
public final class SelectableChipElevation {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Dp.m5483equalsimpl0(this.defaultElevation, selectableChipElevation.defaultElevation) && Dp.m5483equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m5483equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m5483equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m5483equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z11, @NotNull InteractionSource interactionSource, @Nullable Composer composer, int i11) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1888175651, i11, -1, "androidx.compose.material3.SelectableChipElevation.shadowElevation (Chip.kt:1650)");
        }
    ...
    public final State<Dp> tonalElevation$material3_release(boolean z11, @NotNull InteractionSource interactionSource, @Nullable Composer composer, int i11) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-93383461, i11, -1, "androidx.compose.material3.SelectableChipElevation.tonalElevation (Chip.kt:1631)");
        }
        State<Dp> animateElevation = animateElevation(z11, interactionSource, composer, (i11 & 896) | (i11 & 14) | (i11 & 112));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
