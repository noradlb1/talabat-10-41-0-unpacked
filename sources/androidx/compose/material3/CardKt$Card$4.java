...
public final class CardKt$Card$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function3<ColumnScope, Composer, Integer, Unit> f6678g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ int f6679h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CardKt$Card$4(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i11) {
        super(2);
        this.f6678g = function3;
        this.f6679h = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(776921067, i11, -1, "androidx.compose.material3.Card.<anonymous> (Card.kt:153)");
            }
            Function3<ColumnScope, Composer, Integer, Unit> function3 = this.f6678g;
            int i12 = (this.f6679h >> 15) & 7168;
