...
public final class AlertDialogKt$AlertDialogContent$1$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ ColumnScope f6259g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ Function2<Composer, Integer, Unit> f6260h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ int f6261i;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AlertDialogKt$AlertDialogContent$1$1$1$1(ColumnScope columnScope, Function2<? super Composer, ? super Integer, Unit> function2, int i11) {
        super(2);
        this.f6259g = columnScope;
        this.f6260h = function2;
        this.f6261i = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(934657765, i11, -1, "androidx.compose.material3.AlertDialogContent.<anonymous>.<anonymous>.<anonymous>.<anonymous> (AlertDialog.kt:64)");
            }
            ColumnScope columnScope = this.f6259g;
            ...
            Function2<Composer, Integer, Unit> function2 = this.f6260h;
            int i12 = this.f6261i;
