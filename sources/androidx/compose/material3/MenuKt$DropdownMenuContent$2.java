...
public final class MenuKt$DropdownMenuContent$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Modifier f7324g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ Function3<ColumnScope, Composer, Integer, Unit> f7325h;
    ...
    public MenuKt$DropdownMenuContent$2(Modifier modifier, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, int i11) {
        super(2);
        this.f7324g = modifier;
        this.f7325h = function3;
        this.f7326i = i11;
    }
    ...
    public final void invoke(@Nullable Composer composer, int i11) {
        if ((i11 & 11) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1651673913, i11, -1, "androidx.compose.material3.DropdownMenuContent.<anonymous> (Menu.kt:130)");
            }
            Modifier verticalScroll$default = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m488paddingVpY3zN4$default(this.f7324g, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, (Object) null), IntrinsicSize.Max), ScrollKt.rememberScrollState(0, composer, 0, 1), false, (FlingBehavior) null, false, 14, (Object) null);
            Function3<ColumnScope, Composer, Integer, Unit> function3 = this.f7325h;
            int i12 = this.f7326i & 7168;
