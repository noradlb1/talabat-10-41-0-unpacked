...
public final class SwipeableDefaults {
    ...
    public static /* synthetic */ ResistanceConfig resistanceConfig$material3_release$default(SwipeableDefaults swipeableDefaults, Set set, float f11, float f12, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            f11 = 10.0f;
        }
        if ((i11 & 4) != 0) {
        ...
        return swipeableDefaults.resistanceConfig$material3_release(set, f11, f12);
    }
    ...
    public final float m1866getVelocityThresholdD9Ej5fM$material3_release() {
        return VelocityThreshold;
    }

    @Nullable
    public final ResistanceConfig resistanceConfig$material3_release(@NotNull Set<Float> set, float f11, float f12) {
