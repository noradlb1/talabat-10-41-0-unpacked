...
public final class NavigationRailItemColors {
    ...
    private NavigationRailItemColors(long j11, long j12, long j13, long j14, long j15) {
    ...
    public /* synthetic */ NavigationRailItemColors(long j11, long j12, long j13, long j14, long j15, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (Color.m2920equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m2920equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m2920equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m2920equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m2920equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor)) {
            return true;
        }
        return false;
    }
    ...
    public final long getIndicatorColor(@Nullable Composer composer, int i11) {
        composer.startReplaceableGroup(618271448);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(618271448, i11, -1, "androidx.compose.material3.NavigationRailItemColors.<get-indicatorColor> (NavigationRail.kt:341)");
        }
        long j11 = this.selectedIndicatorColor;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> iconColor$material3_release(boolean z11, @Nullable Composer composer, int i11) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(665215869, i11, -1, "androidx.compose.material3.NavigationRailItemColors.iconColor (NavigationRail.kt:318)");
        }
        if (z11) {
        ...
        State<Color> r102 = SingleValueAnimationKt.m86animateColorAsStateKTwxG1Y(j11, AnimationSpecKt.tween$default(150, 0, (Easing) null, 6, (Object) null), (Function1<? super Color, Unit>) null, composer, 48, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> textColor$material3_release(boolean z11, @Nullable Composer composer, int i11) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(253888561, i11, -1, "androidx.compose.material3.NavigationRailItemColors.textColor (NavigationRail.kt:331)");
        }
        if (z11) {
