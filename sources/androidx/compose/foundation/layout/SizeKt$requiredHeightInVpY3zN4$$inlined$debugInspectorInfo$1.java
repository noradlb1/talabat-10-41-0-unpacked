...
public final class SizeKt$requiredHeightInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2552g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ float f2553h;
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("min", Dp.m5476boximpl(this.f2552g));
        inspectorInfo.getProperties().set(RichContentLoadTimeTracer.MAX, Dp.m5476boximpl(this.f2553h));
    }
}
