...
public final class AspectRatioKt$aspectRatio$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2445g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ boolean f2446h;
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("ratio", Float.valueOf(this.f2445g));
        inspectorInfo.getProperties().set("matchHeightConstraintsFirst", Boolean.valueOf(this.f2446h));
    }
}
