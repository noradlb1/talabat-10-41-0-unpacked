...
final class AlignmentLineOffsetTextUnit extends InspectorValueInfo implements LayoutModifier {
    ...
    private AlignmentLineOffsetTextUnit(AlignmentLine alignmentLine2, long j11, long j12, Function1<? super InspectorInfo, Unit> function1) {
        super(function1);
    ...
    public /* synthetic */ AlignmentLineOffsetTextUnit(AlignmentLine alignmentLine2, long j11, long j12, Function1 function1, DefaultConstructorMarker defaultConstructorMarker) {
        this(alignmentLine2, j11, j12, function1);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) this.alignmentLine, (Object) alignmentLineOffsetTextUnit.alignmentLine) || !TextUnit.m5656equalsimpl0(this.before, alignmentLineOffsetTextUnit.before) || !TextUnit.m5656equalsimpl0(this.after, alignmentLineOffsetTextUnit.after)) {
            return false;
        }
        return true;
    }
    ...
    public final long m381getAfterXSAIIZE() {
        return this.after;
    }
    ...
    public final long m382getBeforeXSAIIZE() {
        return this.before;
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m5660hashCodeimpl(this.before)) * 31) + TextUnit.m5660hashCodeimpl(this.after);
    }
    ...
    public MeasureResult m383measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j11) {
        float f11;
        float f12;
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        AlignmentLine alignmentLine2 = this.alignmentLine;
        if (!TextUnitKt.m5677isUnspecifiedR2X_6o(this.before)) {
            f11 = measureScope.m5442toDpGaN1DYA(this.before);
        } else {
            f11 = Dp.Companion.m5498getUnspecifiedD9Ej5fM();
        }
        float f13 = f11;
        if (!TextUnitKt.m5677isUnspecifiedR2X_6o(this.after)) {
            f12 = measureScope.m5442toDpGaN1DYA(this.after);
        } else {
            f12 = Dp.Companion.m5498getUnspecifiedD9Ej5fM();
        }
        return AlignmentLineKt.m369alignmentLineOffsetMeasuretjqqzMA(measureScope, alignmentLine2, f13, f12, measurable, j11);
    }
    ...
    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + TextUnit.m5666toStringimpl(this.before) + ", after=" + TextUnit.m5666toStringimpl(this.after) + ')';
    }
}
