...
public final class ColumnScopeInstance$weight$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2481g;
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(Float.valueOf(this.f2481g));
        inspectorInfo.getProperties().set("weight", Float.valueOf(this.f2481g));
        inspectorInfo.getProperties().set("fill", Boolean.valueOf(this.f2482h));
    }
}
