...
public final class SizeKt$requiredWidthInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2562g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ float f2563h;
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("min", Dp.m5476boximpl(this.f2562g));
        inspectorInfo.getProperties().set(RichContentLoadTimeTracer.MAX, Dp.m5476boximpl(this.f2563h));
    }
}
