...
public abstract class AlignmentLineProvider {
    ...
    public static final class Block extends AlignmentLineProvider {
        ...
        public static /* synthetic */ Block copy$default(Block block, Function1<Measured, Integer> function1, int i11, Object obj) {
            if ((i11 & 1) != 0) {
    ...
    public static final class Value extends AlignmentLineProvider {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public Value(@NotNull AlignmentLine alignmentLine2) {
            super((DefaultConstructorMarker) null);
            Intrinsics.checkNotNullParameter(alignmentLine2, "alignmentLine");
            this.alignmentLine = alignmentLine2;
        }

        public static /* synthetic */ Value copy$default(Value value, AlignmentLine alignmentLine2, int i11, Object obj) {
            if ((i11 & 1) != 0) {
        ...
        @NotNull
        public final Value copy(@NotNull AlignmentLine alignmentLine2) {
            Intrinsics.checkNotNullParameter(alignmentLine2, "alignmentLine");
