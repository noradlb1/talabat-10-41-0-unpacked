...
public final class SizeKt$sizeInqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2567g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ float f2568h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ float f2569i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ float f2570j;
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m5476boximpl(this.f2567g));
        inspectorInfo.getProperties().set("minHeight", Dp.m5476boximpl(this.f2568h));
        inspectorInfo.getProperties().set("maxWidth", Dp.m5476boximpl(this.f2569i));
        inspectorInfo.getProperties().set("maxHeight", Dp.m5476boximpl(this.f2570j));
    }
}
