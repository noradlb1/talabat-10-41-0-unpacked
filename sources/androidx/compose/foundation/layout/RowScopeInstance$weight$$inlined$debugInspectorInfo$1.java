...
public final class RowScopeInstance$weight$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2543g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ boolean f2544h;
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(Float.valueOf(this.f2543g));
        inspectorInfo.getProperties().set("weight", Float.valueOf(this.f2543g));
        inspectorInfo.getProperties().set("fill", Boolean.valueOf(this.f2544h));
    }
}
