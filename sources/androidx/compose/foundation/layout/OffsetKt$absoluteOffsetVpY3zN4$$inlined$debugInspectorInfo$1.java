...
public final class OffsetKt$absoluteOffsetVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2492g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ float f2493h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public OffsetKt$absoluteOffsetVpY3zN4$$inlined$debugInspectorInfo$1(float f11, float f12) {
        super(1);
        this.f2492g = f11;
        this.f2493h = f12;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(Param.X, Dp.m5476boximpl(this.f2492g));
        inspectorInfo.getProperties().set(Param.Y, Dp.m5476boximpl(this.f2493h));
    }
}
