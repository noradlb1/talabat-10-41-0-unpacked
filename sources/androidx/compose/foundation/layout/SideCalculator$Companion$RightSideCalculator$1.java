...
public final class SideCalculator$Companion$RightSideCalculator$1 implements SideCalculator {
    ...
    public Insets adjustInsets(@NotNull Insets insets, int i11) {
        ...
        Insets a11 = Insets.of(insets.left, insets.top, i11, insets.bottom);
        Intrinsics.checkNotNullExpressionValue(a11, "of(oldInsets.left, oldIn…wValue, oldInsets.bottom)");
        return a11;
    }

    /* renamed from: consumedOffsets-MK-Hz9U  reason: not valid java name */
    public long m538consumedOffsetsMKHz9U(long j11) {
        return OffsetKt.Offset(Offset.m2676getXimpl(j11), 0.0f);
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m539consumedVelocityQWom1Mo(long j11, float f11) {
