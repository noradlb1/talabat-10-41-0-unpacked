...
public final class SizeKt$sizeVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2565g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ float f2566h;
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", Dp.m5476boximpl(this.f2565g));
        inspectorInfo.getProperties().set("height", Dp.m5476boximpl(this.f2566h));
    }
}
