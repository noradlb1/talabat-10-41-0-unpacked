...
final class MaxIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long m464calculateContentConstraintsl58MMJ0(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j11) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m5432fixedWidthOenEA2s(measurable.maxIntrinsicWidth(Constraints.m5421getMaxHeightimpl(j11)));
    }
    ...
    public /* synthetic */ MeasureResult m465measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j11) {
