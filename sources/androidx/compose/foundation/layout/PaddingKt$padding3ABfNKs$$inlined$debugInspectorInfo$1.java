...
public final class PaddingKt$padding3ABfNKs$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2510g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PaddingKt$padding3ABfNKs$$inlined$debugInspectorInfo$1(float f11) {
        super(1);
        this.f2510g = f11;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.setValue(Dp.m5476boximpl(this.f2510g));
    }
}
