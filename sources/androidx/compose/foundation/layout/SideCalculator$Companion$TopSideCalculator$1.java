...
public final class SideCalculator$Companion$TopSideCalculator$1 implements SideCalculator {
    ...
    public Insets adjustInsets(@NotNull Insets insets, int i11) {
        ...
        Insets a11 = Insets.of(insets.left, i11, insets.right, insets.bottom);
        Intrinsics.checkNotNullExpressionValue(a11, "of(oldInsets.left, newVa….right, oldInsets.bottom)");
        return a11;
    }

    /* renamed from: consumedOffsets-MK-Hz9U  reason: not valid java name */
    public long m540consumedOffsetsMKHz9U(long j11) {
        return OffsetKt.Offset(0.0f, Offset.m2677getYimpl(j11));
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m541consumedVelocityQWom1Mo(long j11, float f11) {
