...
final class MinIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long m468calculateContentConstraintsl58MMJ0(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j11) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m5432fixedWidthOenEA2s(measurable.minIntrinsicWidth(Constraints.m5421getMaxHeightimpl(j11)));
    }
    ...
    public /* synthetic */ MeasureResult m469measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j11) {
