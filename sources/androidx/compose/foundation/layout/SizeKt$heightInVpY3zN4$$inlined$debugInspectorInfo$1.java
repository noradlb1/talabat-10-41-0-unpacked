...
public final class SizeKt$heightInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ float f2549g;
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("min", Dp.m5476boximpl(this.f2549g));
        inspectorInfo.getProperties().set(RichContentLoadTimeTracer.MAX, Dp.m5476boximpl(this.f2550h));
    }
}
