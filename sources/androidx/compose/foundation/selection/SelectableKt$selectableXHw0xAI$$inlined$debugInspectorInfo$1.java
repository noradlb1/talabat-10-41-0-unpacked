...
public final class SelectableKt$selectableXHw0xAI$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ Role f3220i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ Function0 f3221j;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SelectableKt$selectableXHw0xAI$$inlined$debugInspectorInfo$1(boolean z11, boolean z12, Role role, Function0 function0) {
        super(1);
        this.f3218g = z11;
        this.f3219h = z12;
        this.f3220i = role;
        this.f3221j = function0;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("selected", Boolean.valueOf(this.f3218g));
        inspectorInfo.getProperties().set("enabled", Boolean.valueOf(this.f3219h));
        inspectorInfo.getProperties().set("role", this.f3220i);
        inspectorInfo.getProperties().set("onClick", this.f3221j);
    }
}
