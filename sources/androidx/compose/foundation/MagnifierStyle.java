...
public final class MagnifierStyle {
    ...
    public static final class Companion {
        ...
        public final boolean isStyleSupported$foundation_release(@NotNull MagnifierStyle magnifierStyle, int i11) {
            Intrinsics.checkNotNullParameter(magnifierStyle, "style");
            if (!MagnifierKt.isPlatformMagnifierSupported(i11) || magnifierStyle.getFishEyeEnabled$foundation_release()) {
                return false;
            }
            if (magnifierStyle.getUseTextDefault$foundation_release() || Intrinsics.areEqual((Object) magnifierStyle, (Object) getDefault()) || i11 >= 29) {
                return true;
            }
            return false;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.useTextDefault == magnifierStyle.useTextDefault && DpSize.m5573equalsimpl0(this.size, magnifierStyle.size) && Dp.m5483equalsimpl0(this.cornerRadius, magnifierStyle.cornerRadius) && Dp.m5483equalsimpl0(this.elevation, magnifierStyle.elevation) && this.clippingEnabled == magnifierStyle.clippingEnabled && this.fishEyeEnabled == magnifierStyle.fishEyeEnabled) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((e.a(this.useTextDefault) * 31) + DpSize.m5578hashCodeimpl(this.size)) * 31) + Dp.m5484hashCodeimpl(this.cornerRadius)) * 31) + Dp.m5484hashCodeimpl(this.elevation)) * 31) + e.a(this.clippingEnabled)) * 31) + e.a(this.fishEyeEnabled);
    }
    ...
    public String toString() {
        ...
        return "MagnifierStyle(size=" + DpSize.m5583toStringimpl(this.size) + ", cornerRadius=" + Dp.m5489toStringimpl(this.cornerRadius) + ", elevation=" + Dp.m5489toStringimpl(this.elevation) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }
    ...
    public /* synthetic */ MagnifierStyle(long r8, float r10, float r11, boolean r12, boolean r13, int r14, kotlin.jvm.internal.DefaultConstructorMarker r15) {
        /*
            ...
            long r0 = r0.m5585getUnspecifiedMYxV2XQ()
            goto L_0x000c
        L_0x000b:
            r0 = r8
        L_0x000c:
            ...
            float r2 = r2.m5498getUnspecifiedD9Ej5fM()
            goto L_0x0018
        L_0x0017:
            r2 = r10
        L_0x0018:
            ...
            float r3 = r3.m5498getUnspecifiedD9Ej5fM()
            goto L_0x0024
        L_0x0023:
            r3 = r11
        L_0x0024:
