...
public final class ScrollKt {
    @NotNull
    public static final Modifier horizontalScroll(@NotNull Modifier modifier, @NotNull ScrollState scrollState, boolean z11, @Nullable FlingBehavior flingBehavior, boolean z12) {
        Intrinsics.checkNotNullParameter(modifier, "<this>");
        Intrinsics.checkNotNullParameter(scrollState, "state");
        return scroll(modifier, scrollState, z12, flingBehavior, z11, false);
    }
    ...
    public static final androidx.compose.foundation.ScrollState rememberScrollState(int r10, @org.jetbrains.annotations.Nullable androidx.compose.runtime.Composer r11, int r12, int r13) {
        /*
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v2, resolved type: kotlin.jvm.functions.Function1<androidx.compose.ui.platform.InspectorInfo, kotlin.Unit>} */
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final androidx.compose.ui.Modifier scroll(androidx.compose.ui.Modifier r8, androidx.compose.foundation.ScrollState r9, boolean r10, androidx.compose.foundation.gestures.FlingBehavior r11, boolean r12, boolean r13) {
        /*
        ...
        L_0x0016:
            ...
            r6 = r11
            r1.<init>(r2, r3, r4, r5, r6)
            androidx.compose.ui.Modifier r8 = androidx.compose.ui.ComposedModifierKt.composed(r8, r0, r7)
            return r8
        */
    ...
    @NotNull
    public static final Modifier verticalScroll(@NotNull Modifier modifier, @NotNull ScrollState scrollState, boolean z11, @Nullable FlingBehavior flingBehavior, boolean z12) {
        Intrinsics.checkNotNullParameter(modifier, "<this>");
        Intrinsics.checkNotNullParameter(scrollState, "state");
        return scroll(modifier, scrollState, z12, flingBehavior, z11, true);
    }
