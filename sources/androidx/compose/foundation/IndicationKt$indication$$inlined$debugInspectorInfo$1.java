...
public final class IndicationKt$indication$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ Indication f1720g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ InteractionSource f1721h;
    ...
    public IndicationKt$indication$$inlined$debugInspectorInfo$1(Indication indication, InteractionSource interactionSource) {
        super(1);
        this.f1720g = indication;
        this.f1721h = interactionSource;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("indication", this.f1720g);
        inspectorInfo.getProperties().set("interactionSource", this.f1721h);
    }
}
