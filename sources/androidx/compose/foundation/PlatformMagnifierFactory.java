...
public interface PlatformMagnifierFactory {
    @NotNull
    public static final Companion Companion = Companion.f1782a;
    ...
    public static final class Companion {
        ...
        public static final /* synthetic */ Companion f1782a = new Companion();
    ...
    @NotNull
    PlatformMagnifier create(@NotNull MagnifierStyle magnifierStyle, @NotNull View view, @NotNull Density density, float f11);
