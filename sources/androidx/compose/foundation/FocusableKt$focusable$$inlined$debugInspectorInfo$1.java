...
public final class FocusableKt$focusable$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ boolean f1629g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ MutableInteractionSource f1630h;
    ...
    public FocusableKt$focusable$$inlined$debugInspectorInfo$1(boolean z11, MutableInteractionSource mutableInteractionSource) {
        super(1);
        this.f1629g = z11;
        this.f1630h = mutableInteractionSource;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("enabled", Boolean.valueOf(this.f1629g));
        inspectorInfo.getProperties().set("interactionSource", this.f1630h);
    }
}
