...
public final class FocusableKt$focusableInNonTouchMode$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ boolean f1633g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ MutableInteractionSource f1634h;
    ...
    public FocusableKt$focusableInNonTouchMode$$inlined$debugInspectorInfo$1(boolean z11, MutableInteractionSource mutableInteractionSource) {
        super(1);
        this.f1633g = z11;
        this.f1634h = mutableInteractionSource;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("enabled", Boolean.valueOf(this.f1633g));
        inspectorInfo.getProperties().set("interactionSource", this.f1634h);
    }
}
