...
public final class LazyGridDslKt$items$3 extends Lambda implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
    ...
    public final /* synthetic */ Function2<LazyGridItemSpanScope, T, GridItemSpan> f2856g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ List<T> f2857h;
    ...
    public LazyGridDslKt$items$3(Function2<? super LazyGridItemSpanScope, ? super T, GridItemSpan> function2, List<? extends T> list) {
        super(2);
        this.f2856g = function2;
        this.f2857h = list;
    }

    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return GridItemSpan.m656boximpl(m679invoke_orMbw((LazyGridItemSpanScope) obj, ((Number) obj2).intValue()));
    }

    /* renamed from: invoke-_-orMbw  reason: not valid java name */
    public final long m679invoke_orMbw(@NotNull LazyGridItemSpanScope lazyGridItemSpanScope, int i11) {
        Intrinsics.checkNotNullParameter(lazyGridItemSpanScope, "$this$null");
        return this.f2856g.invoke(lazyGridItemSpanScope, this.f2857h.get(i11)).m663unboximpl();
    }
}
