...
public final class LazyGridDslKt$items$10 extends Lambda implements Function4<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function4<LazyGridItemScope, T, Composer, Integer, Unit> f2852g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ T[] f2853h;
    ...
    public final void invoke(@NotNull LazyGridItemScope lazyGridItemScope, int i11, @Nullable Composer composer, int i12) {
        ...
        if ((i13 & 731) != 146 || !composer.getSkipping()) {
            ...
            this.f2852g.invoke(lazyGridItemScope, this.f2853h[i11], composer, Integer.valueOf(i13 & 14));
            if (ComposerKt.isTraceInProgress()) {
