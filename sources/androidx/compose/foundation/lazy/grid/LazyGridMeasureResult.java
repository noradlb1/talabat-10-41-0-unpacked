...
public final class LazyGridMeasureResult implements LazyGridLayoutInfo, MeasureResult {
    ...
    public LazyGridMeasureResult(@Nullable LazyMeasuredLine lazyMeasuredLine, int i11, boolean z11, float f11, @NotNull MeasureResult measureResult, @NotNull List<? extends LazyGridItemInfo> list, int i12, int i13, int i14, boolean z12, @NotNull Orientation orientation2, int i15) {
    ...
    public long m700getViewportSizeYbymL2g() {
