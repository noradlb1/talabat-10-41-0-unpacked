...
public final class LazyGridDslKt$itemsIndexed$10 extends Lambda implements Function4<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function5<LazyGridItemScope, Integer, T, Composer, Integer, Unit> f2868g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ T[] f2869h;
    ...
    public final void invoke(@NotNull LazyGridItemScope lazyGridItemScope, int i11, @Nullable Composer composer, int i12) {
        ...
        if ((i13 & 731) != 146 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-911455938, i13, -1, "androidx.compose.foundation.lazy.grid.itemsIndexed.<anonymous> (LazyGridDsl.kt:489)");
            }
            this.f2868g.invoke(lazyGridItemScope, Integer.valueOf(i11), this.f2869h[i11], composer, Integer.valueOf((i13 & 14) | (i13 & 112)));
            if (ComposerKt.isTraceInProgress()) {
