...
public final class LazyListState$scrollToItem$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ LazyListState f2812i;
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new LazyListState$scrollToItem$2(this.f2812i, this.f2813j, this.f2814k, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.f2811h == 0) {
            ...
            this.f2812i.snapToItemIndexInternal$foundation_release(this.f2813j, this.f2814k);
