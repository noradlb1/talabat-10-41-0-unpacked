...
public final class LazyDslKt$itemsIndexed$8 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function5<LazyItemScope, Integer, T, Composer, Integer, Unit> f2729g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ T[] f2730h;
    ...
    public final void invoke(@NotNull LazyItemScope lazyItemScope, int i11, @Nullable Composer composer, int i12) {
        ...
        if ((i13 & 731) != 146 || !composer.getSkipping()) {
            ...
            this.f2729g.invoke(lazyItemScope, Integer.valueOf(i11), this.f2730h[i11], composer, Integer.valueOf((i13 & 14) | (i13 & 112)));
            if (ComposerKt.isTraceInProgress()) {
