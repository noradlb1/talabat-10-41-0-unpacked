...
public final class LazyDslKt$itemsIndexed$6 extends Lambda implements Function1<Integer, Object> {
    ...
    public final Object invoke(int i11) {
        return this.f2725g.invoke(Integer.valueOf(i11), this.f2726h[i11]);
    }
}
