...
public final class ComposableSingletons$LazyStaggeredGridItemProviderKt$lambda1$1 extends Lambda implements Function4<LazyStaggeredGridIntervalContent, Integer, Composer, Integer, Unit> {
    ...
    @Composable
    public final void invoke(@NotNull LazyStaggeredGridIntervalContent lazyStaggeredGridIntervalContent, int i11, @Nullable Composer composer, int i12) {
        int i13;
        Intrinsics.checkNotNullParameter(lazyStaggeredGridIntervalContent, SessionsConfigParameter.SYNC_INTERVAL);
        if ((i12 & 14) == 0) {
            i13 = (composer.changed((Object) lazyStaggeredGridIntervalContent) ? 4 : 2) | i12;
        } else {
            i13 = i12;
        }
        if ((i12 & 112) == 0) {
