...
public interface StaggeredGridCells {
    ...
    public static final class Adaptive implements StaggeredGridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(@NotNull Density density, int i11, int i12) {
            ...
            return LazyStaggeredGridCellsKt.calculateCellsCrossAxisSizeImpl(i11, Math.max((i11 + i12) / (density.m5441roundToPx0680j_4(this.minSize) + i12), 1), i12);
        }
    ...
    public static final class Fixed implements StaggeredGridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(@NotNull Density density, int i11, int i12) {
            Intrinsics.checkNotNullParameter(density, "<this>");
            return LazyStaggeredGridCellsKt.calculateCellsCrossAxisSizeImpl(i11, this.count, i12);
        }
