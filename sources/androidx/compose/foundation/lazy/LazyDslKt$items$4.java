...
public final class LazyDslKt$items$4 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function4<LazyItemScope, T, Composer, Integer, Unit> f2711g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ List<T> f2712h;
    ...
    public final void invoke(@NotNull LazyItemScope lazyItemScope, int i11, @Nullable Composer composer, int i12) {
        ...
        if ((i13 & 731) != 146 || !composer.getSkipping()) {
            ...
            this.f2711g.invoke(lazyItemScope, this.f2712h.get(i11), composer, Integer.valueOf(i13 & 14));
            if (ComposerKt.isTraceInProgress()) {
