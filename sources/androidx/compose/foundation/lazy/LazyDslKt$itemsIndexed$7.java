...
public final class LazyDslKt$itemsIndexed$7 extends Lambda implements Function1<Integer, Object> {
    ...
    public final Object invoke(int i11) {
        return this.f2727g.invoke(Integer.valueOf(i11), this.f2728h[i11]);
    }
}
