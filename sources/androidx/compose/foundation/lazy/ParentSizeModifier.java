...
final class ParentSizeModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public /* synthetic */ ParentSizeModifier(float f11, Function1 function1, State state, State state2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(f11, function1, (i11 & 4) != 0 ? null : state, (i11 & 8) != 0 ? null : state2);
    }
    ...
    public MeasureResult m651measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j11) {
        int i11;
        int i12;
        int i13;
        int i14;
        ...
        if (state == null || state.getValue().intValue() == Integer.MAX_VALUE) {
            ...
            i11 = MathKt__MathJVMKt.roundToInt(this.widthState.getValue().floatValue() * this.fraction);
        }
        State<Integer> state2 = this.heightState;
        if (state2 == null || state2.getValue().intValue() == Integer.MAX_VALUE) {
            i12 = Integer.MAX_VALUE;
        } else {
            i12 = MathKt__MathJVMKt.roundToInt(this.heightState.getValue().floatValue() * this.fraction);
        }
        if (i11 != Integer.MAX_VALUE) {
            i13 = i11;
        } else {
            i13 = Constraints.m5424getMinWidthimpl(j11);
        }
        if (i12 != Integer.MAX_VALUE) {
            i14 = i12;
        } else {
            i14 = Constraints.m5423getMinHeightimpl(j11);
        }
        if (i11 == Integer.MAX_VALUE) {
        ...
        Placeable r92 = measurable.m4508measureBRTryo0(ConstraintsKt.Constraints(i13, i11, i14, i12));
        return MeasureScope.CC.p(measureScope, r92.getWidth(), r92.getHeight(), (Map) null, new ParentSizeModifier$measure$1(r92), 4, (Object) null);
    }
    ...
    public ParentSizeModifier(float f11, @NotNull Function1<? super InspectorInfo, Unit> function1, @Nullable State<Integer> state, @Nullable State<Integer> state2) {
        super(function1);
