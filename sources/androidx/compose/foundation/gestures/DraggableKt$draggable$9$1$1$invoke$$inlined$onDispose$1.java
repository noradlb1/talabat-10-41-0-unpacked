...
public final class DraggableKt$draggable$9$1$1$invoke$$inlined$onDispose$1 implements DisposableEffectResult {
    ...
    public final /* synthetic */ MutableState f2045a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ MutableInteractionSource f2046b;
    ...
    public DraggableKt$draggable$9$1$1$invoke$$inlined$onDispose$1(MutableState mutableState, MutableInteractionSource mutableInteractionSource) {
        ...
        this.f2046b = mutableInteractionSource;
    }

    public void dispose() {
        DragInteraction.Start start = (DragInteraction.Start) this.f2045a.getValue();
        if (start != null) {
            MutableInteractionSource mutableInteractionSource = this.f2046b;
