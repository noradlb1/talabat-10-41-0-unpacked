...
final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dispatchRawDelta(float f11) {
        ...
        value.m350performRawScrollMKHz9U(value.m356toOffsettuRUvjQ(f11));
    }
    ...
    public void dragBy(float f11) {
        ScrollingLogic value = this.scrollLogic.getValue();
        value.m346dispatchScroll3eAAhYA(this.latestScrollScope, value.m356toOffsettuRUvjQ(f11), NestedScrollSource.Companion.m4218getDragWNlRxjI());
    }
