...
final class SnapApproachAnimation implements ApproachAnimation<Float, AnimationVector1D> {
    ...
    public SnapApproachAnimation(@NotNull AnimationSpec<Float> animationSpec, @NotNull SnapLayoutInfoProvider snapLayoutInfoProvider, @NotNull Density density2) {
    ...
    public Object approachAnimation(@NotNull ScrollScope scrollScope, float f11, float f12, @NotNull Continuation<? super AnimationState<Float, AnimationVector1D>> continuation) {
        Object access$animateSnap = SnapFlingBehaviorKt.animateSnap(scrollScope, (Math.abs(f11) + this.layoutInfoProvider.snapStepSize(this.density)) * Math.signum(f12), f11, AnimationStateKt.AnimationState$default(0.0f, f12, 0, 0, false, 28, (Object) null), this.snapAnimationSpec, continuation);
        return access$animateSnap == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? access$animateSnap : (AnimationState) access$animateSnap;
    }
    ...
    public Object halfStepAnimation(@NotNull ScrollScope scrollScope, float f11, @NotNull AnimationState<Float, AnimationVector1D> animationState, @NotNull Continuation<? super AnimationState<Float, AnimationVector1D>> continuation) {
        ...
        Object access$animateSnap = SnapFlingBehaviorKt.animateSnap(scrollScope, f11, SnapFlingBehaviorKt.halfStep(this.layoutInfoProvider, this.density) * Math.signum(((Number) copy$default.getVelocity()).floatValue()), copy$default, this.snapAnimationSpec, continuation);
        return access$animateSnap == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? access$animateSnap : (AnimationState) access$animateSnap;
    }
}
