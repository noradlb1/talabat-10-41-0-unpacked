...
public final class DefaultFlingBehavior$performFling$2 extends Lambda implements Function1<AnimationScope<Float, AnimationVector1D>, Unit> {
    ...
    public final /* synthetic */ Ref.FloatRef f1838g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ ScrollScope f1839h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ Ref.FloatRef f1840i;
    ...
    public DefaultFlingBehavior$performFling$2(Ref.FloatRef floatRef, ScrollScope scrollScope, Ref.FloatRef floatRef2) {
        super(1);
        this.f1838g = floatRef;
        this.f1839h = scrollScope;
        this.f1840i = floatRef2;
    }
    ...
    public final void invoke(@NotNull AnimationScope<Float, AnimationVector1D> animationScope) {
        ...
        float floatValue = animationScope.getValue().floatValue() - this.f1838g.element;
        float scrollBy = this.f1839h.scrollBy(floatValue);
        this.f1838g.element = animationScope.getValue().floatValue();
        this.f1840i.element = animationScope.getVelocity().floatValue();
