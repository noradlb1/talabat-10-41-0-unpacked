...
public final class ClickableKt$combinedClickable$4$1$1$invoke$$inlined$onDispose$1 implements DisposableEffectResult {
    ...
    public final /* synthetic */ MutableState f1500a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ MutableInteractionSource f1501b;
    ...
    public ClickableKt$combinedClickable$4$1$1$invoke$$inlined$onDispose$1(MutableState mutableState, MutableInteractionSource mutableInteractionSource) {
        this.f1500a = mutableState;
        this.f1501b = mutableInteractionSource;
    }

    public void dispose() {
        PressInteraction.Press press = (PressInteraction.Press) this.f1500a.getValue();
        if (press != null) {
            this.f1501b.tryEmit(new PressInteraction.Cancel(press));
            this.f1500a.setValue(null);
        }
    }
}
