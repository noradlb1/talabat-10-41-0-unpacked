...
public final class MaxLinesHeightModifierKt$maxLinesHeight$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ int f3532g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ TextStyle f3533h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MaxLinesHeightModifierKt$maxLinesHeight$$inlined$debugInspectorInfo$1(int i11, TextStyle textStyle) {
        super(1);
        this.f3532g = i11;
        this.f3533h = textStyle;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("maxLines", Integer.valueOf(this.f3532g));
        inspectorInfo.getProperties().set("textStyle", this.f3533h);
    }
}
