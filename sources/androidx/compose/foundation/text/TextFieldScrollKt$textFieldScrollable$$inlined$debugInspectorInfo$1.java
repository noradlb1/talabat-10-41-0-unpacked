...
public final class TextFieldScrollKt$textFieldScrollable$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final /* synthetic */ TextFieldScrollerPosition f3609g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ MutableInteractionSource f3610h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ boolean f3611i;
    ...
    public TextFieldScrollKt$textFieldScrollable$$inlined$debugInspectorInfo$1(TextFieldScrollerPosition textFieldScrollerPosition, MutableInteractionSource mutableInteractionSource, boolean z11) {
        super(1);
        this.f3609g = textFieldScrollerPosition;
        this.f3610h = mutableInteractionSource;
        this.f3611i = z11;
    }
    ...
    public final void invoke(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("scrollerPosition", this.f3609g);
        inspectorInfo.getProperties().set("interactionSource", this.f3610h);
        inspectorInfo.getProperties().set("enabled", Boolean.valueOf(this.f3611i));
    }
}
