...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public HorizontalScrollLayoutModifier(@NotNull TextFieldScrollerPosition textFieldScrollerPosition, int i11, @NotNull TransformedText transformedText2, @NotNull Function0<TextLayoutResultProxy> function0) {
    ...
    public static /* synthetic */ HorizontalScrollLayoutModifier copy$default(HorizontalScrollLayoutModifier horizontalScrollLayoutModifier, TextFieldScrollerPosition textFieldScrollerPosition, int i11, TransformedText transformedText2, Function0<TextLayoutResultProxy> function0, int i12, Object obj) {
        if ((i12 & 1) != 0) {
        ...
        return horizontalScrollLayoutModifier.copy(textFieldScrollerPosition, i11, transformedText2, function0);
    }
    ...
    @NotNull
    public final HorizontalScrollLayoutModifier copy(@NotNull TextFieldScrollerPosition textFieldScrollerPosition, int i11, @NotNull TransformedText transformedText2, @NotNull Function0<TextLayoutResultProxy> function0) {
        Intrinsics.checkNotNullParameter(textFieldScrollerPosition, "scrollerPosition");
        Intrinsics.checkNotNullParameter(transformedText2, "transformedText");
        Intrinsics.checkNotNullParameter(function0, "textLayoutResultProvider");
        return new HorizontalScrollLayoutModifier(textFieldScrollerPosition, i11, transformedText2, function0);
    }
    ...
    public MeasureResult m849measure3p2s80s(@NotNull MeasureScope measureScope, @NotNull Measurable measurable, long j11) {
        long j12;
        Intrinsics.checkNotNullParameter(measureScope, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        if (measurable.maxIntrinsicWidth(Constraints.m5421getMaxHeightimpl(j11)) < Constraints.m5422getMaxWidthimpl(j11)) {
            j12 = j11;
        } else {
            j12 = Constraints.m5413copyZbe2FdA$default(j11, 0, Integer.MAX_VALUE, 0, 0, 13, (Object) null);
        }
        Placeable r12 = measurable.m4508measureBRTryo0(j12);
        int min = Math.min(r12.getWidth(), Constraints.m5422getMaxWidthimpl(j11));
        return MeasureScope.CC.p(measureScope, min, r12.getHeight(), (Map) null, new HorizontalScrollLayoutModifier$measure$1(measureScope, this, r12, min), 4, (Object) null);
    }
