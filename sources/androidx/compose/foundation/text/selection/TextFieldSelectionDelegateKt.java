...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m1041getTextFieldSelectionbb3KNj8(@Nullable TextLayoutResult textLayoutResult, int i11, int i12, @Nullable TextRange textRange, boolean z11, @NotNull SelectionAdjustment selectionAdjustment) {
        ...
        if (textRange != null || !Intrinsics.areEqual((Object) selectionAdjustment, (Object) SelectionAdjustment.Companion.getCharacter())) {
            return selectionAdjustment.m965adjustZXO7KMw(textLayoutResult, TextRange, -1, z11, textRange);
        }
        return TextRange;
    }
}
