...
public final class SelectionAdjustment$Companion$Word$1 implements SelectionAdjustment {
    ...
    public long m973adjustZXO7KMw(@NotNull TextLayoutResult textLayoutResult, long j11, int i11, boolean z11, @Nullable TextRange textRange) {
        Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
        return SelectionAdjustment.Companion.f3662a.m967adjustByBoundaryDvylE(textLayoutResult, j11, new SelectionAdjustment$Companion$Word$1$adjust$1(textLayoutResult));
    }
}
