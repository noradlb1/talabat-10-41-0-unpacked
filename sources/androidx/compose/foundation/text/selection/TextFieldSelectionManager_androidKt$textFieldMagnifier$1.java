...
public final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final /* synthetic */ TextFieldSelectionManager f3758g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TextFieldSelectionManager_androidKt$textFieldMagnifier$1(TextFieldSelectionManager textFieldSelectionManager) {
        super(3);
        this.f3758g = textFieldSelectionManager;
    }

    /* access modifiers changed from: private */
    /* renamed from: invoke$lambda-1  reason: not valid java name */
    public static final long m1068invoke$lambda1(MutableState<IntSize> mutableState) {
        return mutableState.getValue().m5642unboximpl();
    }

    /* access modifiers changed from: private */
    /* renamed from: invoke$lambda-2  reason: not valid java name */
    public static final void m1069invoke$lambda2(MutableState<IntSize> mutableState, long j11) {
    ...
    public final Modifier invoke(@NotNull Modifier modifier, @Nullable Composer composer, int i11) {
        ...
        final TextFieldSelectionManager textFieldSelectionManager = this.f3758g;
        AnonymousClass1 r22 = new Function0<Offset>() {
            public /* bridge */ /* synthetic */ Object invoke() {
                return Offset.m2665boximpl(m1070invokeF1C5BW0());
            }

            /* renamed from: invoke-F1C5BW0  reason: not valid java name */
            public final long m1070invokeF1C5BW0() {
                return TextFieldSelectionManagerKt.m1065calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, TextFieldSelectionManager_androidKt$textFieldMagnifier$1.m1068invoke$lambda1(mutableState));
            }
        };
