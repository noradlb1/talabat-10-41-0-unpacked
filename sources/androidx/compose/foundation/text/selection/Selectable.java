...
public interface Selectable {
    ...
    long m961getHandlePositiondBAh8RU(@NotNull Selection selection, boolean z11);

    @Nullable
    LayoutCoordinates getLayoutCoordinates();

    /* renamed from: getRangeOfLineContaining--jx7JFs  reason: not valid java name */
    long m962getRangeOfLineContainingjx7JFs(int i11);
    ...
    Pair<Selection, Boolean> m963updateSelectionqCDeeow(long j11, long j12, @Nullable Offset offset, boolean z11, @NotNull LayoutCoordinates layoutCoordinates, @NotNull SelectionAdjustment selectionAdjustment, @Nullable Selection selection);
}
