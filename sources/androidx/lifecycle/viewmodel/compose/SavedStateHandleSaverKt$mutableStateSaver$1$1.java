...
public final class SavedStateHandleSaverKt$mutableStateSaver$1$1 extends Lambda implements Function2<SaverScope, MutableState<T>, MutableState<Object>> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ Saver<T, Object> f36134g;
    ...
    public final MutableState<Object> invoke(@NotNull SaverScope saverScope, @NotNull MutableState<T> mutableState) {
        ...
        if (mutableState instanceof SnapshotMutableState) {
            return SnapshotStateKt.mutableStateOf(this.f36134g.save(saverScope, mutableState.getValue()), ((SnapshotMutableState) mutableState).getPolicy());
        }
