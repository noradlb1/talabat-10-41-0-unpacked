...
public final class DispatchQueue {
    ...
    public static final void m9089dispatchAndEnqueue$lambda2$lambda1(DispatchQueue dispatchQueue, Runnable runnable) {
    ...
    public final void dispatchAndEnqueue(@NotNull CoroutineContext coroutineContext, @NotNull Runnable runnable) {
        ...
        if (immediate.isDispatchNeeded(coroutineContext) || canRun()) {
            immediate.dispatch(coroutineContext, new b(this, runnable));
        } else {
            enqueue(runnable);
        }
    }
