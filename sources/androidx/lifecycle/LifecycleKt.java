...
public final class LifecycleKt {
    ...
    public static final LifecycleCoroutineScope getCoroutineScope(@NotNull Lifecycle lifecycle) {
        ...
        do {
            LifecycleCoroutineScopeImpl lifecycleCoroutineScopeImpl2 = (LifecycleCoroutineScopeImpl) lifecycle.f36032a.get();
        ...
        } while (!b.a(lifecycle.f36032a, (Object) null, lifecycleCoroutineScopeImpl));
