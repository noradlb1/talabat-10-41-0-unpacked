...
public class TransitionInflater {
            ...
            while (true) {
                ...
                if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                    if (next == 2) {
                        ...
                        } else if (TypedValues.TransitionType.S_AUTO_TRANSITION.equals(name2)) {
                        ...
                        } else if ("arcMotion".equals(name2)) {
                            if (transition != null) {
                        ...
                        } else if (!"patternPathMotion".equals(name2)) {
        ...
        while (true) {
            ...
            if (next == 2) {
                if (xmlPullParser.getName().equals("target")) {
                    TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, Styleable.f37780a);
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) throws Resources.NotFoundException {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, Styleable.f37781b);
    ...
    public TransitionManager inflateTransitionManager(int i11, ViewGroup viewGroup) {
        XmlResourceParser xml = this.mContext.getResources().getXml(i11);
        try {
            ...
            InflateException inflateException = new InflateException(e11.getMessage());
            inflateException.initCause(e11);
            throw inflateException;
        } catch (IOException e12) {
            InflateException inflateException2 = new InflateException(xml.getPositionDescription() + ": " + e12.getMessage());
