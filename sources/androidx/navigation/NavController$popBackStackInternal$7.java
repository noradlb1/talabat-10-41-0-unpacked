...
public final class NavController$popBackStackInternal$7 extends Lambda implements Function1<NavDestination, Boolean> {
    ...
    public final Boolean invoke(@NotNull NavDestination navDestination) {
        ...
        return Boolean.valueOf(!this.f36322g.backStackMap.containsKey(Integer.valueOf(navDestination.getId())));
    }
}
