...
public final class BackStackEntryIdViewModel extends ViewModel {
    ...
    public void onCleared() {
        ...
        if (saveableStateHolder2 != null) {
            saveableStateHolder2.removeState(this.f36360id);
        }
    }

    public final void setSaveableStateHolder(@Nullable SaveableStateHolder saveableStateHolder2) {
