...
public final class DialogNavigator extends Navigator<Destination> {
    ...
    public static final class Destination extends NavDestination implements FloatingWindow {
        ...
        public /* synthetic */ Destination(DialogNavigator dialogNavigator, DialogProperties dialogProperties2, Function3 function3, int i11, DefaultConstructorMarker defaultConstructorMarker) {
            this(dialogNavigator, (i11 & 2) != 0 ? new DialogProperties(false, false, (SecureFlagPolicy) null, 7, (DefaultConstructorMarker) null) : dialogProperties2, function3);
        }
        ...
        public Destination(@NotNull DialogNavigator dialogNavigator, @NotNull DialogProperties dialogProperties2, @NotNull Function3<? super NavBackStackEntry, ? super Composer, ? super Integer, Unit> function3) {
    ...
    public Destination createDestination() {
        return new Destination(this, (DialogProperties) null, ComposableSingletons$DialogNavigatorKt.INSTANCE.m9105getLambda1$navigation_compose_release(), 2, (DefaultConstructorMarker) null);
    }
}
