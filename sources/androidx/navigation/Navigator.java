...
public abstract class Navigator<D extends NavDestination> {
    ...
    @Nullable
    public NavDestination navigate(@NotNull D d11, @Nullable Bundle bundle, @Nullable NavOptions navOptions, @Nullable Extras extras) {
    ...
    public void navigate(@NotNull List<NavBackStackEntry> list, @Nullable NavOptions navOptions, @Nullable Extras extras) {
        ...
        for (NavBackStackEntry push : SequencesKt___SequencesKt.filterNotNull(SequencesKt___SequencesKt.map(CollectionsKt___CollectionsKt.asSequence(list), new Navigator$navigate$1(this, navOptions, extras)))) {
            getState().push(push);
        }
    }
    ...
    public void popBackStack(@NotNull NavBackStackEntry navBackStackEntry, boolean z11) {
        ...
        if (value.contains(navBackStackEntry)) {
            ...
            if (navBackStackEntry2 != null) {
                getState().pop(navBackStackEntry2, z11);
                return;
            }
            return;
        }
