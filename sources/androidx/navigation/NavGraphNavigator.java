...
public class NavGraphNavigator extends Navigator<NavGraph> {
    ...
    public NavGraphNavigator(@NotNull NavigatorProvider navigatorProvider2) {
    ...
    private final void navigate(NavBackStackEntry navBackStackEntry, NavOptions navOptions, Navigator.Extras extras) {
        ...
        if ((startDestinationId == 0 && startDestinationRoute == null) ? false : true) {
            ...
            if (navDestination != null) {
                this.navigatorProvider.getNavigator(navDestination.getNavigatorName()).navigate(CollectionsKt__CollectionsJVMKt.listOf(getState().createBackStackEntry(navDestination, navDestination.addInDefaultArgs(arguments))), navOptions, extras);
                return;
            }
