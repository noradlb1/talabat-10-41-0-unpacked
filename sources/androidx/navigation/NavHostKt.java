...
public final class NavHostKt {
    ...
    public static final NavGraph createGraph(@NotNull NavHost navHost, @IdRes int i11, @IdRes int i12, @NotNull Function1<? super NavGraphBuilder, Unit> function1) {
    ...
    public static /* synthetic */ NavGraph createGraph$default(NavHost navHost, int i11, int i12, Function1 function1, int i13, Object obj) {
        if ((i13 & 1) != 0) {
            i11 = 0;
        }
        Intrinsics.checkNotNullParameter(navHost, "<this>");
    ...
    public static /* synthetic */ NavGraph createGraph$default(NavHost navHost, String str, String str2, Function1 function1, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            str2 = null;
        }
        Intrinsics.checkNotNullParameter(navHost, "<this>");
