...
public final class AppBarConfigurationKt {
    @NotNull
    public static final AppBarConfiguration AppBarConfiguration(@NotNull NavGraph navGraph, @Nullable Openable openable, @NotNull Function0<Boolean> function0) {
    ...
    public static /* synthetic */ AppBarConfiguration AppBarConfiguration$default(NavGraph navGraph, Openable openable, Function0 function0, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            openable = null;
        }
        if ((i11 & 4) != 0) {
    ...
    @NotNull
    public static final AppBarConfiguration AppBarConfiguration(@NotNull Menu menu, @Nullable Openable openable, @NotNull Function0<Boolean> function0) {
    ...
    public static /* synthetic */ AppBarConfiguration AppBarConfiguration$default(Menu menu, Openable openable, Function0 function0, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            openable = null;
        }
        if ((i11 & 4) != 0) {
    ...
    @NotNull
    public static final AppBarConfiguration AppBarConfiguration(@NotNull Set<Integer> set, @Nullable Openable openable, @NotNull Function0<Boolean> function0) {
    ...
    public static /* synthetic */ AppBarConfiguration AppBarConfiguration$default(Set set, Openable openable, Function0 function0, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            openable = null;
        }
        if ((i11 & 4) != 0) {
