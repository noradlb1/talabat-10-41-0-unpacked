...
public final class NavigationUI$setupWithNavController$9 implements NavController.OnDestinationChangedListener {
    ...
    public final /* synthetic */ WeakReference<NavigationBarView> f36446a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ NavController f36447b;

    public NavigationUI$setupWithNavController$9(WeakReference<NavigationBarView> weakReference, NavController navController) {
        this.f36446a = weakReference;
        this.f36447b = navController;
    }
    ...
    public void onDestinationChanged(@NotNull NavController navController, @NotNull NavDestination navDestination, @Nullable Bundle bundle) {
        ...
        NavigationBarView navigationBarView = this.f36446a.get();
        if (navigationBarView == null) {
            this.f36447b.removeOnDestinationChangedListener(this);
            return;
        }
