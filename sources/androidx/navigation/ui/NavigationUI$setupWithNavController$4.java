...
public final class NavigationUI$setupWithNavController$4 implements NavController.OnDestinationChangedListener {
    ...
    public final /* synthetic */ WeakReference<NavigationView> f36442a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ NavController f36443b;
    ...
    public void onDestinationChanged(@NotNull NavController navController, @NotNull NavDestination navDestination, @Nullable Bundle bundle) {
        ...
        NavigationView navigationView = this.f36442a.get();
        if (navigationView == null) {
            this.f36443b.removeOnDestinationChangedListener(this);
            return;
        }
