...
public final class FragmentNavigatorDestinationBuilderKt {
    ...
    public static final /* synthetic */ <F extends Fragment> void fragment(NavGraphBuilder navGraphBuilder, @IdRes int i11, Function1<? super FragmentNavigatorDestinationBuilder, Unit> function1) {
        Intrinsics.checkNotNullParameter(navGraphBuilder, "<this>");
        Intrinsics.checkNotNullParameter(function1, "builder");
        Intrinsics.reifiedOperationMarker(4, "F");
        FragmentNavigatorDestinationBuilder fragmentNavigatorDestinationBuilder = new FragmentNavigatorDestinationBuilder((FragmentNavigator) navGraphBuilder.getProvider().getNavigator(FragmentNavigator.class), i11, (KClass<? extends Fragment>) Reflection.getOrCreateKotlinClass(Fragment.class));
    ...
    public static final /* synthetic */ <F extends Fragment> void fragment(NavGraphBuilder navGraphBuilder, @IdRes int i11) {
        Intrinsics.checkNotNullParameter(navGraphBuilder, "<this>");
        Intrinsics.reifiedOperationMarker(4, "F");
        navGraphBuilder.destination(new FragmentNavigatorDestinationBuilder((FragmentNavigator) navGraphBuilder.getProvider().getNavigator(FragmentNavigator.class), i11, (KClass<? extends Fragment>) Reflection.getOrCreateKotlinClass(Fragment.class)));
    }
    ...
    public static final /* synthetic */ <F extends Fragment> void fragment(NavGraphBuilder navGraphBuilder, String str) {
        ...
        Intrinsics.checkNotNullParameter(str, Constants.ARG_ROUTE);
        Intrinsics.reifiedOperationMarker(4, "F");
        navGraphBuilder.destination(new FragmentNavigatorDestinationBuilder((FragmentNavigator) navGraphBuilder.getProvider().getNavigator(FragmentNavigator.class), str, (KClass<? extends Fragment>) Reflection.getOrCreateKotlinClass(Fragment.class)));
    }
}
