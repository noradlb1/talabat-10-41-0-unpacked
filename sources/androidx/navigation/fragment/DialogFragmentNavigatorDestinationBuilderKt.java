...
public final class DialogFragmentNavigatorDestinationBuilderKt {
    ...
    public static final /* synthetic */ <F extends DialogFragment> void dialog(NavGraphBuilder navGraphBuilder, @IdRes int i11, Function1<? super DialogFragmentNavigatorDestinationBuilder, Unit> function1) {
    ...
    public static final /* synthetic */ <F extends DialogFragment> void dialog(NavGraphBuilder navGraphBuilder, @IdRes int i11) {
        Intrinsics.checkNotNullParameter(navGraphBuilder, "<this>");
        Intrinsics.reifiedOperationMarker(4, "F");
        navGraphBuilder.destination(new DialogFragmentNavigatorDestinationBuilder((DialogFragmentNavigator) navGraphBuilder.getProvider().getNavigator(DialogFragmentNavigator.class), i11, (KClass<? extends DialogFragment>) Reflection.getOrCreateKotlinClass(DialogFragment.class)));
    }
    ...
    public static final /* synthetic */ <F extends DialogFragment> void dialog(NavGraphBuilder navGraphBuilder, String str) {
        ...
        Intrinsics.checkNotNullParameter(str, Constants.ARG_ROUTE);
        Intrinsics.reifiedOperationMarker(4, "F");
        navGraphBuilder.destination(new DialogFragmentNavigatorDestinationBuilder((DialogFragmentNavigator) navGraphBuilder.getProvider().getNavigator(DialogFragmentNavigator.class), str, (KClass<? extends DialogFragment>) Reflection.getOrCreateKotlinClass(DialogFragment.class)));
    }
}
