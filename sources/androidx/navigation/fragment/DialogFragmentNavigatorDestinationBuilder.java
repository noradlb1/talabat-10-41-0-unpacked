...
public final class DialogFragmentNavigatorDestinationBuilder extends NavDestinationBuilder<DialogFragmentNavigator.Destination> {
    ...
    public DialogFragmentNavigatorDestinationBuilder(@NotNull DialogFragmentNavigator dialogFragmentNavigator, @IdRes int i11, @NotNull KClass<? extends DialogFragment> kClass) {
        super(dialogFragmentNavigator, i11);
    ...
    public DialogFragmentNavigator.Destination build() {
        ...
        String name2 = JvmClassMappingKt.getJavaClass(this.fragmentClass).getName();
        Intrinsics.checkNotNullExpressionValue(name2, "fragmentClass.java.name");
