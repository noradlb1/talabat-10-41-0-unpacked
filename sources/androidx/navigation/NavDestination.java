...
public class NavDestination {
    ...
    @Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010%\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u001a\u0010\u001bJ:\u0010\t\u001a\f\u0012\b\b\u0001\u0012\u0004\u0018\u00018\u00000\u0007\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u00052\u0010\u0010\b\u001a\f\u0012\b\b\u0001\u0012\u0004\u0018\u00018\u00000\u0007H\u0005J:\u0010\n\u001a\f\u0012\b\b\u0001\u0012\u0004\u0018\u00018\u00000\u0007\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u00052\u0010\u0010\b\u001a\f\u0012\b\b\u0001\u0012\u0004\u0018\u00018\u00000\u0007H\u0007J\u0018\u0010\r\u001a\u00020\u00052\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\f\u001a\u00020\u000bH\u0007J\u0012\u0010\u000f\u001a\u00020\u00052\b\u0010\u000e\u001a\u0004\u0018\u00010\u0005H\u0007R$\u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00100\u0011*\u00020\u00108FX\u0004¢\u0006\f\u0012\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0012\u0010\u0013R$\u0010\u0018\u001a\u0012\u0012\u0004\u0012\u00020\u0005\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00070\u00178\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0018\u0010\u0019¨\u0006\u001c"}, d2 = {"Landroidx/navigation/NavDestination$Companion;", "", "C", "Landroid/content/Context;", "context", "", "name", "Ljava/lang/Class;", "expectedClassType", "a", "parseClassFromNameInternal", "", "id", "getDisplayName", "route", "createRoute", "Landroidx/navigation/NavDestination;", "Lkotlin/sequences/Sequence;", "getHierarchy", "(Landroidx/navigation/NavDestination;)Lkotlin/sequences/Sequence;", "getHierarchy$annotations", "(Landroidx/navigation/NavDestination;)V", "hierarchy", "", "classes", "Ljava/util/Map;", "<init>", "()V", "navigation-common_release"}, k = 1, mv = {1, 6, 0})
    public static final class Companion {
        ...
        @JvmStatic
        @NotNull
        public final <C> Class<? extends C> a(@NotNull Context context, @NotNull String str, @NotNull Class<? extends C> cls) {
            String str2;
        ...
        public final String getDisplayName(@NotNull Context context, int i11) {
            ...
            try {
                str = context.getResources().getResourceName(i11);
        ...
        @JvmStatic
        @NotNull
        public final <C> Class<? extends C> parseClassFromNameInternal(@NotNull Context context, @NotNull String str, @NotNull Class<? extends C> cls) {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(str, "name");
            Intrinsics.checkNotNullParameter(cls, "expectedClassType");
    ...
    public static final class DeepLinkMatch implements Comparable<DeepLinkMatch> {
        ...
        public DeepLinkMatch(@NotNull NavDestination navDestination, @Nullable Bundle bundle, boolean z11, boolean z12, int i11) {
        ...
        public int compareTo(@NotNull DeepLinkMatch deepLinkMatch) {
            Intrinsics.checkNotNullParameter(deepLinkMatch, "other");
            boolean z11 = this.isExactDeepLink;
            if (z11 && !deepLinkMatch.isExactDeepLink) {
                return 1;
            }
            if (!z11 && deepLinkMatch.isExactDeepLink) {
                return -1;
            ...
            if (z12 && !deepLinkMatch.hasMatchingAction) {
                return 1;
            }
            if (z12 || !deepLinkMatch.hasMatchingAction) {
    ...
    public final int[] buildDeepLinkIds(@Nullable NavDestination navDestination) {
        ...
        while (true) {
            ...
            NavGraph navGraph3 = navGraph2.parent;
            ...
            if (navGraph != null) {
                NavGraph navGraph4 = navDestination.parent;
                Intrinsics.checkNotNull(navGraph4);
                if (navGraph4.findNode(navGraph2.f36331id) == navGraph2) {
                    arrayDeque.addFirst(navGraph2);
                    break;
                }
            }
            if (navGraph3 == null || navGraph3.getStartDestinationId() != navGraph2.f36331id) {
                arrayDeque.addFirst(navGraph2);
            }
        ...
        Iterable<NavDestination> list = CollectionsKt___CollectionsKt.toList(arrayDeque);
        ArrayList arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(list, 10));
        for (NavDestination navDestination2 : list) {
            arrayList.add(Integer.valueOf(navDestination2.f36331id));
        }
    ...
    public boolean equals(@org.jetbrains.annotations.Nullable java.lang.Object r9) {
        ...
        L_0x0027:
            ...
            kotlin.sequences.Sequence r2 = kotlin.sequences.SequencesKt__SequencesKt.asSequence(r2)
        ...
        L_0x0086:
            ...
            java.util.Map r4 = r8.getArguments()
            kotlin.sequences.Sequence r4 = kotlin.collections.MapsKt___MapsKt.asSequence(r4)
    ...
    public final NavAction getAction(@IdRes int i11) {
        ...
        if (this.actions.isEmpty()) {
            ...
            navAction = this.actions.get(i11);
        }
        if (navAction != null) {
            return navAction;
        }
    ...
    public String getDisplayName() {
        ...
        return str == null ? String.valueOf(this.f36331id) : str;
    }
    ...
    public int hashCode() {
        ...
        while (valueIterator.hasNext()) {
            ...
            int destinationId = ((i12 * 31) + navAction.getDestinationId()) * 31;
            NavOptions navOptions = navAction.getNavOptions();
            if (navOptions != null) {
                i14 = navOptions.hashCode();
            } else {
                i14 = 0;
            }
            i12 = destinationId + i14;
        ...
        for (String str3 : getArguments().keySet()) {
            int hashCode = ((i12 * 31) + str3.hashCode()) * 31;
            NavArgument navArgument = getArguments().get(str3);
            if (navArgument != null) {
                i13 = navArgument.hashCode();
            } else {
                i13 = 0;
            }
            i12 = hashCode + i13;
    ...
    public DeepLinkMatch matchDeepLink(@NotNull NavDeepLinkRequest navDeepLinkRequest) {
        ...
        for (NavDeepLink next : this.deepLinks) {
            ...
            if (action == null || !Intrinsics.areEqual((Object) action, (Object) next.getAction())) {
                z11 = false;
            } else {
                z11 = true;
            }
            ...
            if (mimeType != null) {
                i11 = next.getMimeTypeMatchRating(mimeType);
            } else {
                i11 = -1;
            }
            if (bundle != null || z12 || i11 > -1) {
                DeepLinkMatch deepLinkMatch2 = new DeepLinkMatch(this, bundle, next.isExactDeepLink(), z12, i11);
    ...
    public void onInflate(@NotNull Context context, @NotNull AttributeSet attributeSet) {
        ...
        if (obtainAttributes.hasValue(i11)) {
            ...
            this.idName = Companion.getDisplayName(context, this.f36331id);
        }
    ...
    public final void putAction(@IdRes int i11, @IdRes int i12) {
        putAction(i11, new NavAction(i12, (NavOptions) null, (Bundle) null, 6, (DefaultConstructorMarker) null));
    }
    ...
    public String toString() {
        ...
        if (str == null) {
            sb2.append("0x");
            sb2.append(Integer.toHexString(this.f36331id));
        } else {
            sb2.append(str);
        }
        sb2.append(")");
    ...
    public boolean hasDeepLink(@NotNull NavDeepLinkRequest navDeepLinkRequest) {
        Intrinsics.checkNotNullParameter(navDeepLinkRequest, "deepLinkRequest");
        return matchDeepLink(navDeepLinkRequest) != null;
    }

    public final void putAction(@IdRes int i11, @NotNull NavAction navAction) {
        Intrinsics.checkNotNullParameter(navAction, NativeProtocol.WEB_DIALOG_ACTION);
        if (supportsActions()) {
            if (i11 != 0) {
                this.actions.put(i11, navAction);
                return;
            }
