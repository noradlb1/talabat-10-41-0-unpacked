...
public abstract class ConstraintTracker<T> {
    ...
    public final TaskExecutor f38050a;
        ...
        synchronized (this.mLock) {
            if (this.mListeners.add(constraintListener)) {
                if (this.mListeners.size() == 1) {
                    this.f38052c = getInitialState();
                    Logger.get().debug(TAG, String.format("%s: initial state = %s", new Object[]{getClass().getSimpleName(), this.f38052c}), new Throwable[0]);
                    startTracking();
                }
                constraintListener.onConstraintChanged(this.f38052c);
            }
        }
    }
    ...
    public void setState(T r4) {
        /*
            ...
            monitor-enter(r0)
            T r1 = r3.f38052c     // Catch:{ all -> 0x002b }
            ...
            goto L_0x0029
        L_0x0010:
            r3.f38052c = r4     // Catch:{ all -> 0x002b }
            ...
            androidx.work.impl.utils.taskexecutor.TaskExecutor r1 = r3.f38050a     // Catch:{ all -> 0x002b }
