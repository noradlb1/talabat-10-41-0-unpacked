...
public class SystemJobService extends JobService implements ExecutionListener {
    ...
    public boolean onStartJob(@androidx.annotation.NonNull android.app.job.JobParameters r9) {
        ...
        L_0x002f:
            ...
            monitor-enter(r3)
            java.util.Map<java.lang.String, android.app.job.JobParameters> r4 = r8.mJobParameters     // Catch:{ all -> 0x00a9 }
            boolean r4 = r4.containsKey(r0)     // Catch:{ all -> 0x00a9 }
            if (r4 == 0) goto L_0x0051
            androidx.work.Logger r9 = androidx.work.Logger.get()     // Catch:{ all -> 0x00a9 }
            java.lang.String r4 = TAG     // Catch:{ all -> 0x00a9 }
            ...
            r9.debug(r4, r0, r1)     // Catch:{ all -> 0x00a9 }
            monitor-exit(r3)     // Catch:{ all -> 0x00a9 }
            return r2
        L_0x0051:
            androidx.work.Logger r4 = androidx.work.Logger.get()     // Catch:{ all -> 0x00a9 }
            java.lang.String r5 = TAG     // Catch:{ all -> 0x00a9 }
            ...
            r4.debug(r5, r6, r2)     // Catch:{ all -> 0x00a9 }
            java.util.Map<java.lang.String, android.app.job.JobParameters> r2 = r8.mJobParameters     // Catch:{ all -> 0x00a9 }
