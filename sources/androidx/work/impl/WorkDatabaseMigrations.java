...
public class WorkDatabaseMigrations {
    ...
    public static class RescheduleMigration extends Migration {
        ...
        public RescheduleMigration(@NonNull Context context, int i11, int i12) {
            super(i11, i12);
        ...
        public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) {
            ...
            this.f38002a.getSharedPreferences(PreferenceUtils.PREFERENCES_FILE_NAME, 0).edit().putBoolean(PreferenceUtils.KEY_RESCHEDULE_NEEDED, true).apply();
        }
    }
    ...
    public static class WorkMigration9To10 extends Migration {
        ...
        public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) {
            ...
            PreferenceUtils.migrateLegacyPreferences(this.f38003a, supportSQLiteDatabase);
            IdGenerator.migrateLegacyIdGenerator(this.f38003a, supportSQLiteDatabase);
        }
    }
