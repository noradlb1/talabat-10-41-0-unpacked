...
public final class TableInfo {
    ...
    public final String f37544name;
    ...
    public static final class Column {
        ...
        /* renamed from: name  reason: collision with root package name */
        public final String f37545name;
        public final boolean notNull;
        public final int primaryKeyPosition;
        public final String type;

        @Deprecated
        public Column(String str, String str2, boolean z11, int i11) {
            this(str, str2, z11, i11, (String) null, 0);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (this.primaryKeyPosition != column.primaryKeyPosition || !this.f37545name.equals(column.f37545name) || this.notNull != column.notNull) {
                return false;
            }
            ...
            if (i11 != 0 && i11 == column.mCreatedFrom && ((str = this.defaultValue) == null ? column.defaultValue != null : !defaultValueEquals(str, column.defaultValue))) {
                return false;
            }
        ...
        public int hashCode() {
            int i11;
            int hashCode = ((this.f37545name.hashCode() * 31) + this.affinity) * 31;
            if (this.notNull) {
                i11 = 1231;
            } else {
                i11 = 1237;
            }
            return ((hashCode + i11) * 31) + this.primaryKeyPosition;
        }
        ...
        public String toString() {
            return "Column{name='" + this.f37545name + '\'' + ", type='" + this.type + '\'' + ", affinity='" + this.affinity + '\'' + ", notNull=" + this.notNull + ", primaryKeyPosition=" + this.primaryKeyPosition + ", defaultValue='" + this.defaultValue + '\'' + AbstractJsonLexerKt.END_OBJ;
        }
    ...
    public static class ForeignKeyWithSequence implements Comparable<ForeignKeyWithSequence> {
        ...
        public int compareTo(@NonNull ForeignKeyWithSequence foreignKeyWithSequence) {
            int i11 = this.f37546b - foreignKeyWithSequence.f37546b;
            return i11 == 0 ? this.f37547c - foreignKeyWithSequence.f37547c : i11;
        }
    }
    ...
    public static final class Index {
        ...
        /* renamed from: name  reason: collision with root package name */
        public final String f37550name;
        public final List<String> orders;
        public final boolean unique;

        public Index(String str, boolean z11, List<String> list) {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.f37550name.startsWith(DEFAULT_PREFIX)) {
                return index.f37550name.startsWith(DEFAULT_PREFIX);
            }
            return this.f37550name.equals(index.f37550name);
        }
        ...
        public int hashCode() {
            ...
            if (this.f37550name.startsWith(DEFAULT_PREFIX)) {
                ...
                i11 = this.f37550name.hashCode();
            }
            return (((((i11 * 31) + (this.unique ? 1 : 0)) * 31) + this.columns.hashCode()) * 31) + this.orders.hashCode();
        }

        public String toString() {
            return "Index{name='" + this.f37550name + '\'' + ", unique=" + this.unique + ", columns=" + this.columns + ", orders=" + this.orders + AbstractJsonLexerKt.END_OBJ;
        }
        ...
        try {
            if (query.getColumnCount() > 0) {
                ...
                while (query.moveToNext()) {
                    ...
                    hashMap.put(string, new Column(string, string2, z11, query.getInt(columnIndex4), query.getString(columnIndex5), 2));
                }
            }
            return hashMap;
        } finally {
            ...
            for (int i11 = 0; i11 < count; i11++) {
                ...
                if (query.getInt(columnIndex2) == 0) {
                    ...
                    for (ForeignKeyWithSequence next : readForeignKeyFieldMappings) {
                        if (next.f37546b == i12) {
                            arrayList.add(next.f37548d);
                            arrayList2.add(next.f37549e);
                        }
                    }
    ...
    @Nullable
    private static Index readIndex(SupportSQLiteDatabase supportSQLiteDatabase, String str, boolean z11) {
        String str2;
        ...
        try {
            ...
            if (!(columnIndex == -1 || columnIndex2 == -1 || columnIndex3 == -1)) {
                if (columnIndex4 != -1) {
                    ...
                    Index index = new Index(str, z11, arrayList, arrayList2);
                    query.close();
                    return index;
                }
            }
        ...
        try {
            ...
            if (!(columnIndex == -1 || columnIndex2 == -1)) {
                if (columnIndex3 != -1) {
                    HashSet hashSet = new HashSet();
                    while (query.moveToNext()) {
                        if (c.f41585a.equals(query.getString(columnIndex2))) {
                            String string = query.getString(columnIndex);
                            boolean z11 = true;
                            if (query.getInt(columnIndex3) != 1) {
                                z11 = false;
                            }
                            Index readIndex = readIndex(supportSQLiteDatabase, string, z11);
                            if (readIndex == null) {
                                query.close();
                                return null;
                            }
    ...
    public boolean equals(Object obj) {
        ...
        String str = this.f37544name;
        if (str == null ? tableInfo.f37544name != null : !str.equals(tableInfo.f37544name)) {
            return false;
        }
    ...
    public String toString() {
        return "TableInfo{name='" + this.f37544name + '\'' + ", columns=" + this.columns + ", foreignKeys=" + this.foreignKeys + ", indices=" + this.indices + AbstractJsonLexerKt.END_OBJ;
    }
