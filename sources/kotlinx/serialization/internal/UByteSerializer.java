...
public final class UByteSerializer implements KSerializer<UByte> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UByte.m6341boximpl(m7866deserializeWa3L5BU(decoder));
    }

    /* renamed from: deserialize-Wa3L5BU  reason: not valid java name */
    public byte m7866deserializeWa3L5BU(@NotNull Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UByte.m6347constructorimpl(decoder.decodeInline(getDescriptor()).decodeByte());
    }
    ...
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m7867serializeEK6454(encoder, ((UByte) obj).m6396unboximpl());
    }

    /* renamed from: serialize-EK-6454  reason: not valid java name */
    public void m7867serializeEK6454(@NotNull Encoder encoder, byte b11) {
