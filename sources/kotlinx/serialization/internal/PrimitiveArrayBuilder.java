...
public abstract class PrimitiveArrayBuilder<Array> {
    public static /* synthetic */ void ensureCapacity$kotlinx_serialization_core$default(PrimitiveArrayBuilder primitiveArrayBuilder, int i11, int i12, Object obj) {
        if (obj == null) {
            if ((i12 & 1) != 0) {
                i11 = primitiveArrayBuilder.getPosition$kotlinx_serialization_core() + 1;
            }
            primitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core(i11);
            return;
        }
    ...
    public abstract void ensureCapacity$kotlinx_serialization_core(int i11);
