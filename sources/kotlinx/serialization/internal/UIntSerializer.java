...
public final class UIntSerializer implements KSerializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UInt.m6417boximpl(m7868deserializeOGnWXxg(decoder));
    }

    /* renamed from: deserialize-OGnWXxg  reason: not valid java name */
    public int m7868deserializeOGnWXxg(@NotNull Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UInt.m6423constructorimpl(decoder.decodeInline(getDescriptor()).decodeInt());
    }
    ...
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m7869serializeQn1smSk(encoder, ((UInt) obj).m6474unboximpl());
    }

    /* renamed from: serialize-Qn1smSk  reason: not valid java name */
    public void m7869serializeQn1smSk(@NotNull Encoder encoder, int i11) {
