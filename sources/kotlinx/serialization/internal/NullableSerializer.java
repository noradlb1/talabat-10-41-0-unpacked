...
public final class NullableSerializer<T> implements KSerializer<T> {
    ...
    public T deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder.decodeNotNullMark()) {
            return decoder.decodeSerializableValue(this.serializer);
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj == null || !Intrinsics.areEqual((Object) Reflection.getOrCreateKotlinClass(NullableSerializer.class), (Object) Reflection.getOrCreateKotlinClass(obj.getClass())) || !Intrinsics.areEqual((Object) this.serializer, (Object) ((NullableSerializer) obj).serializer)) {
            return false;
        }
        return true;
    }
    ...
    public void serialize(@NotNull Encoder encoder, @Nullable T t11) {
        ...
        if (t11 != null) {
            ...
            encoder.encodeSerializableValue(this.serializer, t11);
            return;
        }
        encoder.encodeNull();
    }
