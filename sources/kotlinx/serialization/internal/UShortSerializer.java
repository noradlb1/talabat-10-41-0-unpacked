...
public final class UShortSerializer implements KSerializer<UShort> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UShort.m6601boximpl(m7872deserializeBwKQO78(decoder));
    }

    /* renamed from: deserialize-BwKQO78  reason: not valid java name */
    public short m7872deserializeBwKQO78(@NotNull Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UShort.m6607constructorimpl(decoder.decodeInline(getDescriptor()).decodeShort());
    }
    ...
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m7873serializei8woANY(encoder, ((UShort) obj).m6656unboximpl());
    }

    /* renamed from: serialize-i8woANY  reason: not valid java name */
    public void m7873serializei8woANY(@NotNull Encoder encoder, short s11) {
