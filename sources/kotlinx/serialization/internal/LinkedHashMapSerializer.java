...
public final class LinkedHashMapSerializer<K, V> extends MapLikeSerializer<K, V, Map<K, ? extends V>, LinkedHashMap<K, V>> {
    ...
    /* renamed from: e */
    public void checkCapacity(@NotNull LinkedHashMap<K, V> linkedHashMap, int i11) {
        Intrinsics.checkNotNullParameter(linkedHashMap, "<this>");
    }
    ...
    /* renamed from: h */
    public void insertKeyValuePair(@NotNull LinkedHashMap<K, V> linkedHashMap, int i11, K k11, V v11) {
        Intrinsics.checkNotNullParameter(linkedHashMap, "<this>");
