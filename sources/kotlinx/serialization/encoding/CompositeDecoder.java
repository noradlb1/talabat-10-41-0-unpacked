...
public interface CompositeDecoder {
    @NotNull
    public static final Companion Companion = Companion.f26410a;
    ...
    public static final class Companion {
        ...
        public static final /* synthetic */ Companion f26410a = new Companion();
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ Object decodeNullableSerializableElement$default(CompositeDecoder compositeDecoder, SerialDescriptor serialDescriptor, int i11, DeserializationStrategy deserializationStrategy, Object obj, int i12, Object obj2) {
            if (obj2 == null) {
                if ((i12 & 8) != 0) {
                    obj = null;
                }
                return compositeDecoder.decodeNullableSerializableElement(serialDescriptor, i11, deserializationStrategy, obj);
            }
        ...
        public static /* synthetic */ Object decodeSerializableElement$default(CompositeDecoder compositeDecoder, SerialDescriptor serialDescriptor, int i11, DeserializationStrategy deserializationStrategy, Object obj, int i12, Object obj2) {
            if (obj2 == null) {
                if ((i12 & 8) != 0) {
                    obj = null;
                }
                return compositeDecoder.decodeSerializableElement(serialDescriptor, i11, deserializationStrategy, obj);
            }
    ...
    @ExperimentalSerializationApi
    @NotNull
    Decoder decodeInlineElement(@NotNull SerialDescriptor serialDescriptor, int i11);
    ...
    @ExperimentalSerializationApi
    @Nullable
    <T> T decodeNullableSerializableElement(@NotNull SerialDescriptor serialDescriptor, int i11, @NotNull DeserializationStrategy<T> deserializationStrategy, @Nullable T t11);

    @ExperimentalSerializationApi
    boolean decodeSequentially();

    <T> T decodeSerializableElement(@NotNull SerialDescriptor serialDescriptor, int i11, @NotNull DeserializationStrategy<T> deserializationStrategy, @Nullable T t11);
