...
public abstract class AbstractDecoder implements Decoder, CompositeDecoder {
    public static /* synthetic */ Object decodeSerializableValue$default(AbstractDecoder abstractDecoder, DeserializationStrategy deserializationStrategy, Object obj, int i11, Object obj2) {
        if (obj2 == null) {
            if ((i11 & 2) != 0) {
                obj = null;
            }
    ...
    @NotNull
    public Decoder decodeInlineElement(@NotNull SerialDescriptor serialDescriptor, int i11) {
        Intrinsics.checkNotNullParameter(serialDescriptor, "descriptor");
    ...
    public final <T> T decodeNullableSerializableElement(@NotNull SerialDescriptor serialDescriptor, int i11, @NotNull DeserializationStrategy<T> deserializationStrategy, @Nullable T t11) {
        ...
        if (deserializationStrategy.getDescriptor().isNullable() || decodeNotNullMark()) {
            return decodeSerializableValue(deserializationStrategy, t11);
        }
        return decodeNull();
    }
    ...
    public <T> T decodeSerializableValue(@NotNull DeserializationStrategy<T> deserializationStrategy, @Nullable T t11) {
        Intrinsics.checkNotNullParameter(deserializationStrategy, "deserializer");
