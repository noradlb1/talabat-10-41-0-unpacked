...
public final class SerialModuleImpl extends SerializersModule {
    ...
    public SerialModuleImpl(@NotNull Map<KClass<?>, ? extends ContextualProvider> map, @NotNull Map<KClass<?>, ? extends Map<KClass<?>, ? extends KSerializer<?>>> map2, @NotNull Map<KClass<?>, ? extends Function1<?, ? extends SerializationStrategy<?>>> map3, @NotNull Map<KClass<?>, ? extends Map<String, ? extends KSerializer<?>>> map4, @NotNull Map<KClass<?>, ? extends Function1<? super String, ? extends DeserializationStrategy<?>>> map5) {
    ...
    public <T> KSerializer<T> getContextual(@NotNull KClass<T> kClass, @NotNull List<? extends KSerializer<?>> list) {
        ...
        if (contextualProvider != null) {
            kSerializer = contextualProvider.invoke(list);
        } else {
            kSerializer = null;
        }
    ...
    @Nullable
    public <T> SerializationStrategy<T> getPolymorphic(@NotNull KClass<? super T> kClass, @NotNull T t11) {
        Intrinsics.checkNotNullParameter(kClass, "baseClass");
        Intrinsics.checkNotNullParameter(t11, "value");
        if (!PlatformKt.isInstanceOf(t11, kClass)) {
            return null;
        }
        Map map = this.polyBase2Serializers.get(kClass);
        KSerializer kSerializer = map != null ? (KSerializer) map.get(Reflection.getOrCreateKotlinClass(t11.getClass())) : null;
        ...
        if (function12 != null) {
            return (SerializationStrategy) function12.invoke(t11);
        }
        return null;
    }

    @Nullable
    public <T> DeserializationStrategy<? extends T> getPolymorphic(@NotNull KClass<? super T> kClass, @Nullable String str) {
        Intrinsics.checkNotNullParameter(kClass, "baseClass");
