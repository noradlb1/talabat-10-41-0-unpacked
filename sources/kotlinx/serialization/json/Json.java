...
public abstract class Json implements StringFormat {
    ...
    public static final class Default extends Json {
        private Default() {
            super(new JsonConfiguration(false, false, false, false, false, false, (String) null, false, false, (String) null, false, false, UnixStat.PERM_MASK, (DefaultConstructorMarker) null), SerializersModuleKt.getEmptySerializersModule(), (DefaultConstructorMarker) null);
        }
    ...
    public final <T> T decodeFromJsonElement(@NotNull DeserializationStrategy<T> deserializationStrategy, @NotNull JsonElement jsonElement) {
    ...
    @NotNull
    public final <T> JsonElement encodeToJsonElement(@NotNull SerializationStrategy<? super T> serializationStrategy, T t11) {
        Intrinsics.checkNotNullParameter(serializationStrategy, "serializer");
        return TreeJsonEncoderKt.writeJson(this, t11, serializationStrategy);
    }

    @NotNull
    public final <T> String encodeToString(@NotNull SerializationStrategy<? super T> serializationStrategy, T t11) {
        Intrinsics.checkNotNullParameter(serializationStrategy, "serializer");
        JsonStringBuilder jsonStringBuilder = new JsonStringBuilder();
        try {
            new StreamingJsonEncoder(jsonStringBuilder, this, WriteMode.OBJ, new JsonEncoder[WriteMode.values().length]).encodeSerializableValue(serializationStrategy, t11);
