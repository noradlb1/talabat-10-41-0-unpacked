...
public final class StreamingJsonEncoderKt {
    @NotNull
    private static final Set<SerialDescriptor> unsignedNumberDescriptors = SetsKt__SetsKt.setOf(BuiltinSerializersKt.serializer(UInt.Companion).getDescriptor(), BuiltinSerializersKt.serializer(ULong.Companion).getDescriptor(), BuiltinSerializersKt.serializer(UByte.Companion).getDescriptor(), BuiltinSerializersKt.serializer(UShort.Companion).getDescriptor());
