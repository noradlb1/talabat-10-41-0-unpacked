...
public final class JsonIteratorKt {
    ...
    @NotNull
    public static final <T> Iterator<T> JsonIterator(@NotNull DecodeSequenceMode decodeSequenceMode, @NotNull Json json, @NotNull ReaderJsonLexer readerJsonLexer, @NotNull DeserializationStrategy<T> deserializationStrategy) {
        Intrinsics.checkNotNullParameter(decodeSequenceMode, SessionsConfigParameter.SYNC_MODE);
        Intrinsics.checkNotNullParameter(json, "json");
        Intrinsics.checkNotNullParameter(readerJsonLexer, "lexer");
        Intrinsics.checkNotNullParameter(deserializationStrategy, "deserializer");
        int i11 = WhenMappings.$EnumSwitchMapping$0[determineFormat(readerJsonLexer, decodeSequenceMode).ordinal()];
        if (i11 == 1) {
    ...
    private static final DecodeSequenceMode determineFormat(AbstractJsonLexer abstractJsonLexer, DecodeSequenceMode decodeSequenceMode) {
        int i11 = WhenMappings.$EnumSwitchMapping$0[decodeSequenceMode.ordinal()];
        if (i11 == 1) {
