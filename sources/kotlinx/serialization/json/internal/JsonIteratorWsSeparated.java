...
final class JsonIteratorWsSeparated<T> implements Iterator<T>, KMappedMarker, j$.util.Iterator {
    @NotNull
    ...
    public JsonIteratorWsSeparated(@NotNull Json json2, @NotNull ReaderJsonLexer readerJsonLexer, @NotNull DeserializationStrategy<T> deserializationStrategy) {
