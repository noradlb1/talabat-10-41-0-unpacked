...
public final class JsonElementSerializersKt$defer$1 implements SerialDescriptor {
    ...
    public List<Annotation> getElementAnnotations(int i11) {
        return getOriginal().getElementAnnotations(i11);
    }

    @NotNull
    public SerialDescriptor getElementDescriptor(int i11) {
        return getOriginal().getElementDescriptor(i11);
    }
    ...
    public String getElementName(int i11) {
        return getOriginal().getElementName(i11);
    }
    ...
    public boolean isElementOptional(int i11) {
        return getOriginal().isElementOptional(i11);
    }
