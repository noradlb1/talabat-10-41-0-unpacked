...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public static final /* synthetic */ AtomicReferenceFieldUpdater f26345d;
    @NotNull
    ...
    public static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        private final void completeSelect(Object obj) {
            ...
            if (z11) {
                ...
                obj2 = SelectKt.getNOT_SELECTED();
            }
            if (a.a(SelectBuilderImpl.f26345d, this.impl, this, obj2) && z11) {
        ...
        private final Object prepareSelectOp() {
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (a.a(SelectBuilderImpl.f26345d, this.impl, SelectKt.getNOT_SELECTED(), this)) {
                        return null;
                    }
                }
            }
        ...
        private final void undoPrepare() {
            a.a(SelectBuilderImpl.f26345d, this.impl, this, SelectKt.getNOT_SELECTED());
        }
    ...
    public static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(@Nullable Object obj) {
            ...
            if (obj != null) {
                ...
                a.a(SelectBuilderImpl.f26345d, selectBuilderImpl, this, obj2);
                return decide;
            }
    ...
    static {
        ...
        f26345d = AtomicReferenceFieldUpdater.newUpdater(cls, cls2, "_state");
        _result$FU = AtomicReferenceFieldUpdater.newUpdater(cls, cls2, "_result");
    }
    ...
    private final void doResume(Function0<? extends Object> function0, Function0<Unit> function02) {
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                if (a.a(_result$FU, this, SelectKt.UNDECIDED, function0.invoke())) {
                    return;
                }
            } else if (obj != IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                throw new IllegalStateException("Already resumed");
            } else if (a.a(_result$FU, this, IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                function02.invoke();
                return;
            }
        }
    ...
    public final void handleBuilderException(@NotNull Throwable th2) {
        if (trySelect()) {
            ...
            resumeWith(Result.m6329constructorimpl(ResultKt.createFailure(th2)));
    ...
    public void onTimeout(long j11, @NotNull Function1<? super Continuation<? super R>, ? extends Object> function1) {
        if (j11 > 0) {
            disposeOnSelect(DelayKt.getDelay(getContext()).invokeOnTimeout(j11, new SelectBuilderImpl$onTimeout$$inlined$Runnable$1(this, function1), getContext()));
        } else if (trySelect()) {
    ...
    public void resumeSelectWithException(@NotNull Throwable th2) {
        while (true) {
            Object obj = this._result;
            if (obj == SelectKt.UNDECIDED) {
                if (a.a(_result$FU, this, SelectKt.UNDECIDED, new CompletedExceptionally(th2, false, 2, (DefaultConstructorMarker) null))) {
                    return;
                }
            } else if (obj != IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                throw new IllegalStateException("Already resumed");
                ...
                Result.Companion companion = Result.Companion;
                intercepted.resumeWith(Result.m6329constructorimpl(ResultKt.createFailure(th2)));
                return;
            }
        }
    }
    ...
    public void resumeWith(@NotNull Object obj) {
        while (true) {
            ...
            if (obj2 == SelectKt.UNDECIDED) {
                if (a.a(_result$FU, this, SelectKt.UNDECIDED, CompletionStateKt.toState$default(obj, (Function1) null, 1, (Object) null))) {
                    return;
                }
                ...
                if (Result.m6335isFailureimpl(obj)) {
                    ...
                    continuation.resumeWith(Result.m6329constructorimpl(ResultKt.createFailure(r42)));
                    return;
                }
    ...
    public Object trySelectOther(@Nullable LockFreeLinkedListNode.PrepareOp prepareOp) {
        while (true) {
            ...
            if (obj == SelectKt.getNOT_SELECTED()) {
                if (prepareOp == null) {
                    if (a.a(f26345d, this, SelectKt.getNOT_SELECTED(), (Object) null)) {
                        break;
                    }
                } else {
                    PairSelectOp pairSelectOp = new PairSelectOp(prepareOp);
                    if (a.a(f26345d, this, SelectKt.getNOT_SELECTED(), pairSelectOp)) {
    ...
    public <P, Q> void invoke(@NotNull SelectClause2<? super P, ? extends Q> selectClause2, P p11, @NotNull Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
        selectClause2.registerSelectClause2(this, p11, function2);
    }
}
