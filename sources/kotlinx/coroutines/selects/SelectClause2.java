...
public interface SelectClause2<P, Q> {
    ...
    <R> void registerSelectClause2(@NotNull SelectInstance<? super R> selectInstance, P p11, @NotNull Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2);
}
