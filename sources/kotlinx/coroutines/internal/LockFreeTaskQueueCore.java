...
public final class LockFreeTaskQueueCore<E> {
    ...
    public static final class Companion {
        ...
        public final long updateHead(long j11, int i11) {
            return wo(j11, LockFreeTaskQueueCore.HEAD_MASK) | (((long) i11) << 0);
        }
        ...
        public final <T> T withState(long j11, @NotNull Function2<? super Integer, ? super Integer, ? extends T> function2) {
            return function2.invoke(Integer.valueOf((int) ((LockFreeTaskQueueCore.HEAD_MASK & j11) >> 0)), Integer.valueOf((int) ((j11 & LockFreeTaskQueueCore.TAIL_MASK) >> 30)));
        }
    ...
    private final LockFreeTaskQueueCore<E> allocateNextCopy(long j11) {
        ...
        while (true) {
            ...
            if ((i11 & i13) != (i12 & i13)) {
                ...
                lockFreeTaskQueueCore._state = Companion.wo(j11, FROZEN_MASK);
    ...
    private final LockFreeTaskQueueCore<E> allocateOrGetNextCopy(long j11) {
        while (true) {
            ...
            a.a(_next$FU, this, (Object) null, allocateNextCopy(j11));
        }
    }

    private final LockFreeTaskQueueCore<E> fillPlaceholder(int i11, E e11) {
        Object obj = this.array.get(this.mask & i11);
        if (!(obj instanceof Placeholder) || ((Placeholder) obj).index != i11) {
            return null;
        }
        this.array.set(i11 & this.mask, e11);
        return this;
    }
    ...
    public final boolean close() {
        ...
        } while (!_state$FU.compareAndSet(this, j11, j11 | CLOSED_MASK));
        return true;
    }

    public final int getSize() {
        long j11 = this._state;
        return (((int) ((j11 & TAIL_MASK) >> 30)) - ((int) ((HEAD_MASK & j11) >> 0))) & 1073741823;
    }
    ...
    public final boolean isEmpty() {
        long j11 = this._state;
        return ((int) ((HEAD_MASK & j11) >> 0)) == ((int) ((j11 & TAIL_MASK) >> 30));
    }
    ...
    public final Object removeFirstOrNull() {
        while (true) {
            ...
            int i11 = (int) ((HEAD_MASK & j11) >> 0);
            int i12 = this.mask;
            if ((((int) ((TAIL_MASK & j11) >> 30)) & i12) == (i11 & i12)) {
                return null;
            }
            Object obj = this.array.get(i12 & i11);
            if (obj == null) {
                ...
                if (_state$FU.compareAndSet(this, j11, Companion.updateHead(j11, i13))) {
                    this.array.set(this.mask & i11, (Object) null);
                    return obj;
                } else if (this.singleConsumer) {
                    LockFreeTaskQueueCore lockFreeTaskQueueCore = this;
                    do {
                        lockFreeTaskQueueCore = lockFreeTaskQueueCore.removeSlowPath(i11, i13);
