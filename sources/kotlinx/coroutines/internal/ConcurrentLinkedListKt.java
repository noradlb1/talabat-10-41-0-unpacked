...
public final class ConcurrentLinkedListKt {
    ...
    @NotNull
    public static final <N extends ConcurrentLinkedListNode<N>> N close(@NotNull N n11) {
        while (true) {
            N access$getNextOrClosed = n11.getNextOrClosed();
            if (access$getNextOrClosed == CLOSED) {
                return n11;
            }
            N n12 = (ConcurrentLinkedListNode) access$getNextOrClosed;
            if (n12 != null) {
                n11 = n12;
    ...
    private static final <S extends kotlinx.coroutines.internal.Segment<S>> java.lang.Object findSegmentInternal(S r4, long r5, kotlin.jvm.functions.Function2<? super java.lang.Long, ? super S, ? extends S> r7) {
        ...
        L_0x0000:
            ...
            goto L_0x0014
        L_0x000f:
            java.lang.Object r4 = kotlinx.coroutines.internal.SegmentOrClosed.m7844constructorimpl(r4)
            return r4
        L_0x0014:
