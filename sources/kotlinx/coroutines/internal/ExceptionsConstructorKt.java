...
public final class ExceptionsConstructorKt {
    ...
    public static /* synthetic */ int a(Class cls, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            i11 = 0;
        }
    ...
    public static final <E extends Throwable> Function1<Throwable, Throwable> createConstructor(Class<E> cls) {
        ...
        for (Constructor createSafeConstructor : ArraysKt___ArraysKt.sortedWith((T[]) cls.getConstructors(), new ExceptionsConstructorKt$createConstructor$$inlined$sortedByDescending$1())) {
    ...
    private static final Function1<Throwable, Throwable> createSafeConstructor(Constructor<?> constructor) {
        ...
        if (length == 1) {
            ...
            return null;
        } else if (length == 2 && Intrinsics.areEqual((Object) parameterTypes[0], (Object) cls) && Intrinsics.areEqual((Object) parameterTypes[1], (Object) cls2)) {
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i11) {
        ...
        try {
            ...
            num = Result.m6329constructorimpl(Integer.valueOf(a(cls, 0, 1, (Object) null)));
        } catch (Throwable th2) {
    ...
    @Nullable
    public static final <E extends Throwable> E tryCopyException(@NotNull E e11) {
        E e12;
        if (!(e11 instanceof CopyableThrowable)) {
            return (Throwable) ctorCache.get(e11.getClass()).invoke(e11);
        }
        try {
            Result.Companion companion = Result.Companion;
            e12 = Result.m6329constructorimpl(((CopyableThrowable) e11).createCopy());
        } catch (Throwable th2) {
            Result.Companion companion2 = Result.Companion;
            e12 = Result.m6329constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m6335isFailureimpl(e12)) {
            e12 = null;
        }
