...
public final class ResizableAtomicArray<T> {
    ...
    public final void setSynchronized(int i11, @Nullable T t11) {
        AtomicReferenceArray<T> atomicReferenceArray = this.array;
        ...
        AtomicReferenceArray<T> atomicReferenceArray2 = new AtomicReferenceArray<>(RangesKt___RangesKt.coerceAtLeast(i11 + 1, length * 2));
