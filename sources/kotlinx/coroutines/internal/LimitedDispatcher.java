...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public DisposableHandle invokeOnTimeout(long j11, @NotNull Runnable runnable, @NotNull CoroutineContext coroutineContext) {
        return this.$$delegate_0.invokeOnTimeout(j11, runnable, coroutineContext);
    }
    ...
    public CoroutineDispatcher limitedParallelism(int i11) {
        ...
        if (i11 >= this.parallelism) {
            return this;
        }
        return super.limitedParallelism(i11);
    }
    ...
    public void scheduleResumeAfterDelay(long j11, @NotNull CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$$delegate_0.scheduleResumeAfterDelay(j11, cancellableContinuation);
    }
}
