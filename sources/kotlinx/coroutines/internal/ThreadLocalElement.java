...
public final class ThreadLocalElement<T> implements ThreadContextElement<T> {
    ...
    public ThreadLocalElement(T t11, @NotNull ThreadLocal<T> threadLocal2) {
        this.value = t11;
    ...
    public <R> R fold(R r11, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
        return ThreadContextElement.DefaultImpls.fold(this, r11, function2);
    }
    ...
    public void restoreThreadContext(@NotNull CoroutineContext coroutineContext, T t11) {
