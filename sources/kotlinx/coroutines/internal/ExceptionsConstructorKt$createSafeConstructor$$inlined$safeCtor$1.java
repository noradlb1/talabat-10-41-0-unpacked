...
public final class ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1 extends Lambda implements Function1<Throwable, Throwable> {
    ...
    public final Throwable invoke(@NotNull Throwable th2) {
        ...
        try {
            ...
            Object newInstance = this.f26189g.newInstance(new Object[]{th2.getMessage(), th2});
            if (newInstance != null) {
                obj = Result.m6329constructorimpl((Throwable) newInstance);
