...
public interface Job extends CoroutineContext.Element {
    @NotNull
    public static final Key Key = Key.f25130b;
    ...
    public static final class DefaultImpls {
        ...
        public static <R> R fold(@NotNull Job job, R r11, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
            return CoroutineContext.Element.DefaultImpls.fold(job, r11, function2);
        }
        ...
        public static /* synthetic */ DisposableHandle invokeOnCompletion$default(Job job, boolean z11, boolean z12, Function1 function1, int i11, Object obj) {
            if (obj == null) {
                if ((i11 & 1) != 0) {
                    z11 = false;
                }
                ...
                return job.invokeOnCompletion(z11, z12, function1);
            }
    ...
    public static final class Key implements CoroutineContext.Key<Job> {
        ...
        public static final /* synthetic */ Key f25130b = new Key();
    ...
    @NotNull
    @InternalCoroutinesApi
    DisposableHandle invokeOnCompletion(boolean z11, boolean z12, @NotNull Function1<? super Throwable, Unit> function1);
