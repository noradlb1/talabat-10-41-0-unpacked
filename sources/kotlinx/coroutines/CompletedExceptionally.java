...
public class CompletedExceptionally {
    ...
    public CompletedExceptionally(@NotNull Throwable th2, boolean z11) {
        this.cause = th2;
    ...
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + '[' + this.cause + AbstractJsonLexerKt.END_LIST;
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ CompletedExceptionally(Throwable th2, boolean z11, int i11, DefaultConstructorMarker defaultConstructorMarker) {
