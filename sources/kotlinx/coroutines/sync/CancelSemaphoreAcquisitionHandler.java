...
final class CancelSemaphoreAcquisitionHandler extends CancelHandler {
    ...
    public CancelSemaphoreAcquisitionHandler(@NotNull SemaphoreSegment semaphoreSegment, int i11) {
    ...
    public String toString() {
        return "CancelSemaphoreAcquisitionHandler[" + this.segment + IndicativeSentencesGeneration.DEFAULT_SEPARATOR + this.index + AbstractJsonLexerKt.END_LIST;
    }
