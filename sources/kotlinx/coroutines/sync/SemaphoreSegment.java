...
final class SemaphoreSegment extends Segment<SemaphoreSegment> {
    ...
    public /* synthetic */ AtomicReferenceArray f26387a = new AtomicReferenceArray(SemaphoreKt.SEGMENT_SIZE);

    public SemaphoreSegment(long j11, @Nullable SemaphoreSegment semaphoreSegment, int i11) {
        super(j11, semaphoreSegment, i11);
    }

    public final void cancel(int i11) {
        this.f26387a.set(i11, SemaphoreKt.CANCELLED);
        onSlotCleaned();
    }

    public final boolean cas(int i11, @Nullable Object obj, @Nullable Object obj2) {
        return o.a(this.f26387a, i11, obj, obj2);
    }

    @Nullable
    public final Object get(int i11) {
        return this.f26387a.get(i11);
    }

    @Nullable
    public final Object getAndSet(int i11, @Nullable Object obj) {
        return this.f26387a.getAndSet(i11, obj);
    }
    ...
    public final void set(int i11, @Nullable Object obj) {
        this.f26387a.set(i11, obj);
    }
