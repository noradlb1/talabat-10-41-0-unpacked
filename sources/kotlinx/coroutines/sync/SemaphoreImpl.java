...
final class SemaphoreImpl implements Semaphore {
    ...
    public static final /* synthetic */ AtomicIntegerFieldUpdater f26381a;
    ...
    static {
        ...
        head$FU = AtomicReferenceFieldUpdater.newUpdater(cls, cls2, TtmlNode.TAG_HEAD);
        ...
        f26381a = AtomicIntegerFieldUpdater.newUpdater(cls, "_availablePermits");
    }
    ...
    public final Object acquireSlowPath(Continuation<? super Unit> continuation) {
        ...
        while (true) {
            if (!addAcquireToQueue(orCreateCancellableContinuation)) {
                if (f26381a.getAndDecrement(this) > 0) {
    ...
    public final boolean addAcquireToQueue(kotlinx.coroutines.CancellableContinuation<? super kotlin.Unit> r15) {
        ...
        L_0x0012:
            ...
            goto L_0x0026
        L_0x0021:
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m7844constructorimpl(r5)
            goto L_0x0038
        L_0x0026:
            ...
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m7844constructorimpl(r5)
        L_0x0038:
            boolean r6 = kotlinx.coroutines.internal.SegmentOrClosed.m7849isClosedimpl(r5)
            r7 = 0
            r8 = 1
            if (r6 != 0) goto L_0x007d
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m7847getSegmentimpl(r5)
        L_0x0044:
        ...
        L_0x005e:
            ...
            boolean r10 = v0.a.a(r10, r14, r9, r6)
        ...
        L_0x0073:
            ...
            goto L_0x0044
        L_0x007d:
            kotlinx.coroutines.internal.Segment r0 = kotlinx.coroutines.internal.SegmentOrClosed.m7847getSegmentimpl(r5)
            kotlinx.coroutines.sync.SemaphoreSegment r0 = (kotlinx.coroutines.sync.SemaphoreSegment) r0
            int r3 = kotlinx.coroutines.sync.SemaphoreKt.SEGMENT_SIZE
            long r3 = (long) r3
            long r1 = r1 % r3
            int r1 = (int) r1
            java.util.concurrent.atomic.AtomicReferenceArray r2 = r0.f26387a
            r3 = 0
            boolean r2 = i9.o.a(r2, r1, r3, r15)
        ...
        L_0x009c:
            ...
            java.util.concurrent.atomic.AtomicReferenceArray r0 = r0.f26387a
            boolean r0 = i9.o.a(r0, r1, r2, r3)
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        L_0x008f:
            ...
            int r1 = (int) r1
            kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.sync.SemaphoreKt.PERMIT
            java.util.concurrent.atomic.AtomicReferenceArray r3 = r0.f26387a
    ...
    public void release() {
        ...
        while (true) {
            ...
            if (z11) {
                if (f26381a.compareAndSet(this, i11, i11 + 1) && (i11 >= 0 || tryResumeNextFromQueue())) {
                    return;
                }
            } else {
    ...
    public boolean tryAcquire() {
        ...
        } while (!f26381a.compareAndSet(this, i11, i11 - 1));
        return true;
    }
}
