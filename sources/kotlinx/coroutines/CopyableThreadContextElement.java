...
public interface CopyableThreadContextElement<S> extends ThreadContextElement<S> {
    ...
    public static final class DefaultImpls {
        public static <S, R> R fold(@NotNull CopyableThreadContextElement<S> copyableThreadContextElement, R r11, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
            return ThreadContextElement.DefaultImpls.fold(copyableThreadContextElement, r11, function2);
        }
