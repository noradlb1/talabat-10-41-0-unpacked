...
public final class DelayKt {
    ...
    public static final java.lang.Object awaitCancellation(@org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<?> r4) {
        ...
        L_0x0013:
            ...
            r0.<init>(r4)
        L_0x0018:
            java.lang.Object r4 = r0.f25125h
    ...
    @Nullable
    public static final Object delay(long j11, @NotNull Continuation<? super Unit> continuation) {
        if (j11 <= 0) {
        ...
        if (j11 < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl.getContext()).scheduleResumeAfterDelay(j11, cancellableContinuationImpl);
        }
    ...
    public static final Object m7781delayVtjQ1oo(long j11, @NotNull Continuation<? super Unit> continuation) {
        Object delay = delay(m7782toDelayMillisLRDsOJo(j11), continuation);
    ...
    public static final long m7782toDelayMillisLRDsOJo(long j11) {
        if (Duration.m7616compareToLRDsOJo(j11, Duration.Companion.m7719getZEROUwyO8pc()) > 0) {
            return RangesKt___RangesKt.coerceAtLeast(Duration.m7635getInWholeMillisecondsimpl(j11), 1);
        }
        return 0;
    }
}
