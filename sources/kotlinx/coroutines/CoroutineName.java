...
public final class CoroutineName extends AbstractCoroutineContextElement {
    ...
    private final String f25124name;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof CoroutineName) && Intrinsics.areEqual((Object) this.f25124name, (Object) ((CoroutineName) obj).f25124name);
    }
    ...
    public int hashCode() {
        return this.f25124name.hashCode();
    }

    @NotNull
    public String toString() {
        return "CoroutineName(" + this.f25124name + ')';
    }
}
