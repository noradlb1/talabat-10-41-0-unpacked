...
public enum CoroutineStart {
    ...
    @InternalCoroutinesApi
    public final <R, T> void invoke(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r11, @NotNull Continuation<? super T> continuation) {
        int i11 = WhenMappings.$EnumSwitchMapping$0[ordinal()];
        if (i11 == 1) {
            CancellableKt.startCoroutineCancellable$default(function2, r11, continuation, (Function1) null, 4, (Object) null);
        } else if (i11 == 2) {
            ContinuationKt.startCoroutine(function2, r11, continuation);
        } else if (i11 == 3) {
            UndispatchedKt.startCoroutineUndispatched(function2, r11, continuation);
        } else if (i11 != 4) {
            throw new NoWhenBranchMatchedException();
        }
    }
