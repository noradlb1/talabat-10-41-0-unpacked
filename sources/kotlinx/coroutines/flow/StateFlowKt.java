...
public final class StateFlowKt {
    ...
    @NotNull
    public static final Symbol NONE = new Symbol(Profile.DataLevel.NONE);
    /* access modifiers changed from: private */
    @NotNull
    ...
    @NotNull
    public static final <T> Flow<T> fuseStateFlow(@NotNull StateFlow<? extends T> stateFlow, @NotNull CoroutineContext coroutineContext, int i11, @NotNull BufferOverflow bufferOverflow) {
        boolean z11 = false;
        if (i11 >= 0 && i11 < 2) {
            z11 = true;
        }
        ...
        return SharedFlowKt.fuseSharedFlow(stateFlow, coroutineContext, i11, bufferOverflow);
    }
