...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    public static final <T, R> Flow<R> flatMapMerge(@NotNull Flow<? extends T> flow, int i11, @NotNull Function2<? super T, ? super Continuation<? super Flow<? extends R>>, ? extends Object> function2) {
        return FlowKt.flattenMerge(new FlowKt__MergeKt$flatMapMerge$$inlined$map$1(flow, function2), i11);
    }

    public static /* synthetic */ Flow flatMapMerge$default(Flow flow, int i11, Function2 function2, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            i11 = DEFAULT_CONCURRENCY;
        }
        return FlowKt.flatMapMerge(flow, i11, function2);
    }
    ...
    public static final <T> Flow<T> flattenMerge(@NotNull Flow<? extends Flow<? extends T>> flow, int i11) {
        ...
        if (!z11) {
            ...
            return new ChannelFlowMerge(flow, i11, (CoroutineContext) null, 0, (BufferOverflow) null, 28, (DefaultConstructorMarker) null);
        }
    }
