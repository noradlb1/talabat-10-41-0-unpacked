...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final <T> Flow<T> delayEach(@NotNull Flow<? extends T> flow, long j11) {
        return FlowKt.onEach(flow, new FlowKt__MigrationKt$delayEach$1(j11, (Continuation<? super FlowKt__MigrationKt$delayEach$1>) null));
    }

    @NotNull
    @Deprecated(level = DeprecationLevel.ERROR, message = "Use 'onStart { delay(timeMillis) }'", replaceWith = @ReplaceWith(expression = "onStart { delay(timeMillis) }", imports = {}))
    public static final <T> Flow<T> delayFlow(@NotNull Flow<? extends T> flow, long j11) {
        return FlowKt.onStart(flow, new FlowKt__MigrationKt$delayFlow$1(j11, (Continuation<? super FlowKt__MigrationKt$delayFlow$1>) null));
    }
    ...
    public static /* synthetic */ Flow onErrorReturn$default(Flow flow, Object obj, Function1 function1, int i11, Object obj2) {
        if ((i11 & 2) != 0) {
    ...
    public static final <T> Flow<T> onErrorReturn(@NotNull Flow<? extends T> flow, T t11, @NotNull Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m7822catch(flow, new FlowKt__MigrationKt$onErrorReturn$2(function1, t11, (Continuation<? super FlowKt__MigrationKt$onErrorReturn$2>) null));
    }
