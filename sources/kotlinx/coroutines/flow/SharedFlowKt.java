...
public final class SharedFlowKt {
    ...
    @NotNull
    public static final <T> MutableSharedFlow<T> MutableSharedFlow(int i11, int i12, @NotNull BufferOverflow bufferOverflow) {
        boolean z11;
        boolean z12;
        boolean z13 = true;
        if (i11 >= 0) {
    ...
    @NotNull
    public static final <T> Flow<T> fuseSharedFlow(@NotNull SharedFlow<? extends T> sharedFlow, @NotNull CoroutineContext coroutineContext, int i11, @NotNull BufferOverflow bufferOverflow) {
        if ((i11 == 0 || i11 == -3) && bufferOverflow == BufferOverflow.SUSPEND) {
            return sharedFlow;
        }
        return new ChannelFlowOperatorImpl(sharedFlow, coroutineContext, i11, bufferOverflow);
    }
