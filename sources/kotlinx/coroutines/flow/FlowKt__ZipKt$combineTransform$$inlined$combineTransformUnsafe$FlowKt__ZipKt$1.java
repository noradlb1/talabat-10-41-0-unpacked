...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ Flow[] f25970i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ Function4 f25971j;
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
        ...
        /* renamed from: i  reason: collision with root package name */
        public /* synthetic */ Object f25973i;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            int i11 = this.f25972h;
            if (i11 == 0) {
                ResultKt.throwOnFailure(obj);
                Object[] objArr = (Object[]) this.f25973i;
    ...
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1(Flow[] flowArr, Continuation continuation, Function4 function4) {
        ...
        this.f25970i = flowArr;
        this.f25971j = function4;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1 flowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1 = new FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1(this.f25970i, continuation, this.f25971j);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i11 = this.f25969h;
        if (i11 == 0) {
            ResultKt.throwOnFailure(obj);
            Flow[] flowArr = this.f25970i;
            Function0 access$nullArrayFactory = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
            final Function4 function4 = this.f25971j;
