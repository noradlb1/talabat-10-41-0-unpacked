...
public final class FlowKt__ZipKt$combineTransformUnsafe$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ Flow<T>[] f26030i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> f26031j;
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        ...
        /* renamed from: i  reason: collision with root package name */
        public /* synthetic */ Object f26033i;
        ...
        public final Object invoke(@NotNull FlowCollector<? super R> flowCollector, @NotNull T[] tArr, @Nullable Continuation<? super Unit> continuation) {
            AnonymousClass1 r02 = new AnonymousClass1(r3, continuation);
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i11 == 0) {
                ...
                this.L$0 = null;
                this.f26032h = 1;
                if (function3.invoke((FlowCollector) this.L$0, (Object[]) this.f26033i, this) == coroutine_suspended) {
        ...
        public final Object invokeSuspend$$forInline(@NotNull Object obj) {
            r3.invoke((FlowCollector) this.L$0, (Object[]) this.f26033i, this);
            return Unit.INSTANCE;
        }
    }
    ...
    public FlowKt__ZipKt$combineTransformUnsafe$1(Flow<? extends T>[] flowArr, Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super FlowKt__ZipKt$combineTransformUnsafe$1> continuation) {
        ...
        this.f26030i = flowArr;
        this.f26031j = function3;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        FlowKt__ZipKt$combineTransformUnsafe$1 flowKt__ZipKt$combineTransformUnsafe$1 = new FlowKt__ZipKt$combineTransformUnsafe$1(this.f26030i, this.f26031j, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i11 == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T>[] flowArr = this.f26030i;
            Function0 access$nullArrayFactory = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
            Intrinsics.needClassReification();
            final Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> function3 = this.f26031j;
    ...
    public final Object invokeSuspend$$forInline(@NotNull Object obj) {
        ...
        Intrinsics.needClassReification();
        final Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> function3 = this.f26031j;
        AnonymousClass1 r22 = new AnonymousClass1((Continuation<? super AnonymousClass1>) null);
        InlineMarker.mark(0);
        CombineKt.combineInternal((FlowCollector) this.L$0, flowArr, access$nullArrayFactory, r22, this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
