...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m7822catch(@NotNull Flow<? extends T> flow, @NotNull Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m7829catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> concatWith(@NotNull Flow<? extends T> flow, T t11) {
    ...
    public static final <T> Flow<T> m7823debounceHG0u8IE(@NotNull Flow<? extends T> flow, long j11) {
        return FlowKt__DelayKt.m7825debounceHG0u8IE(flow, j11);
    }
    ...
    public static final <T> Flow<T> delayEach(@NotNull Flow<? extends T> flow, long j11) {
        return FlowKt__MigrationKt.delayEach(flow, j11);
    }

    @NotNull
    @Deprecated(level = DeprecationLevel.ERROR, message = "Use 'onStart { delay(timeMillis) }'", replaceWith = @ReplaceWith(expression = "onStart { delay(timeMillis) }", imports = {}))
    public static final <T> Flow<T> delayFlow(@NotNull Flow<? extends T> flow, long j11) {
    ...
    @NotNull
    public static final <T> Flow<T> drop(@NotNull Flow<? extends T> flow, int i11) {
    ...
    @NotNull
    @FlowPreview
    public static final <T, R> Flow<R> flatMapMerge(@NotNull Flow<? extends T> flow, int i11, @NotNull Function2<? super T, ? super Continuation<? super Flow<? extends R>>, ? extends Object> function2) {
        return FlowKt__MergeKt.flatMapMerge(flow, i11, function2);
    }
    ...
    @NotNull
    @FlowPreview
    public static final <T> Flow<T> flattenMerge(@NotNull Flow<? extends Flow<? extends T>> flow, int i11) {
    ...
    @Nullable
    public static final <T, R> Object fold(@NotNull Flow<? extends T> flow, R r11, @NotNull Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, @NotNull Continuation<? super R> continuation) {
        return FlowKt__ReduceKt.fold(flow, r11, function3, continuation);
    }
    ...
    public static final <T> Flow<T> onErrorReturn(@NotNull Flow<? extends T> flow, T t11) {
    ...
    @NotNull
    public static final <T> Flow<T> retry(@NotNull Flow<? extends T> flow, long j11, @NotNull Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        return FlowKt__ErrorsKt.retry(flow, j11, function2);
    }
    ...
    @NotNull
    public static final <T, R> Flow<R> runningFold(@NotNull Flow<? extends T> flow, R r11, @NotNull @BuilderInference Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3) {
        return FlowKt__TransformKt.runningFold(flow, r11, function3);
    }
    ...
    public static final <T> Flow<T> m7824sampleHG0u8IE(@NotNull Flow<? extends T> flow, long j11) {
        return FlowKt__DelayKt.m7826sampleHG0u8IE(flow, j11);
    }

    @NotNull
    public static final <T, R> Flow<R> scan(@NotNull Flow<? extends T> flow, R r11, @NotNull @BuilderInference Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3) {
        return FlowKt__TransformKt.scan(flow, r11, function3);
    }

    @NotNull
    @Deprecated(level = DeprecationLevel.ERROR, message = "Flow has less verbose 'scan' shortcut", replaceWith = @ReplaceWith(expression = "scan(initial, operation)", imports = {}))
    public static final <T, R> Flow<R> scanFold(@NotNull Flow<? extends T> flow, R r11, @NotNull @BuilderInference Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3) {
        return FlowKt__MigrationKt.scanFold(flow, r11, function3);
    }
    ...
    @NotNull
    public static final <T> SharedFlow<T> shareIn(@NotNull Flow<? extends T> flow, @NotNull CoroutineScope coroutineScope, @NotNull SharingStarted sharingStarted, int i11) {
    ...
    public static final <T> Flow<T> skip(@NotNull Flow<? extends T> flow, int i11) {
        return FlowKt__MigrationKt.skip(flow, i11);
    }

    @NotNull
    @Deprecated(level = DeprecationLevel.ERROR, message = "Flow analogue of 'startWith' is 'onStart'. Use 'onStart { emit(value) }'", replaceWith = @ReplaceWith(expression = "onStart { emit(value) }", imports = {}))
    public static final <T> Flow<T> startWith(@NotNull Flow<? extends T> flow, T t11) {
    ...
    @NotNull
    public static final <T> Flow<T> take(@NotNull Flow<? extends T> flow, int i11) {
    ...
    @Nullable
    public static final <T, C extends Collection<? super T>> Object toCollection(@NotNull Flow<? extends T> flow, @NotNull C c11, @NotNull Continuation<? super C> continuation) {
    ...
    public static final <T> Flow<T> onErrorReturn(@NotNull Flow<? extends T> flow, T t11, @NotNull Function1<? super Throwable, Boolean> function1) {
        return FlowKt__MigrationKt.onErrorReturn(flow, t11, function1);
    }

    @NotNull
    @Deprecated(level = DeprecationLevel.ERROR, message = "Flow analogue of 'publish(bufferSize)' is 'buffer' followed by 'shareIn'. \npublish().connect() is the default strategy (no extra call is needed), \npublish().autoConnect() translates to 'started = SharingStared.Lazily' argument, \npublish().refCount() translates to 'started = SharingStared.WhileSubscribed()' argument.", replaceWith = @ReplaceWith(expression = "this.buffer(bufferSize).shareIn(scope, 0)", imports = {}))
    public static final <T> Flow<T> publish(@NotNull Flow<? extends T> flow, int i11) {
        return FlowKt__MigrationKt.publish(flow, i11);
    }

    @NotNull
    @Deprecated(level = DeprecationLevel.ERROR, message = "Flow analogue of 'replay(bufferSize)' is 'shareIn' with the specified replay parameter. \nreplay().connect() is the default strategy (no extra call is needed), \nreplay().autoConnect() translates to 'started = SharingStared.Lazily' argument, \nreplay().refCount() translates to 'started = SharingStared.WhileSubscribed()' argument.", replaceWith = @ReplaceWith(expression = "this.shareIn(scope, bufferSize)", imports = {}))
    public static final <T> Flow<T> replay(@NotNull Flow<? extends T> flow, int i11) {
    ...
    @NotNull
    public static final <T> StateFlow<T> stateIn(@NotNull Flow<? extends T> flow, @NotNull CoroutineScope coroutineScope, @NotNull SharingStarted sharingStarted, T t11) {
