...
public final class CombineKt$zipImpl$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public final /* synthetic */ Flow f26120b;

    /* renamed from: c  reason: collision with root package name */
    public final /* synthetic */ Flow f26121c;

    /* renamed from: d  reason: collision with root package name */
    public final /* synthetic */ Function3 f26122d;

    public CombineKt$zipImpl$$inlined$unsafeFlow$1(Flow flow, Flow flow2, Function3 function3) {
        this.f26120b = flow;
        this.f26121c = flow2;
        this.f26122d = function3;
    }

    @Nullable
    public Object collect(@NotNull FlowCollector<? super R> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        Object coroutineScope = CoroutineScopeKt.coroutineScope(new CombineKt$zipImpl$1$1(flowCollector, this.f26120b, this.f26121c, this.f26122d, (Continuation<? super CombineKt$zipImpl$1$1>) null), continuation);
