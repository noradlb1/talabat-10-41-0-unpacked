...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T> {
    ...
    public Object invokeSuspend(@NotNull Object obj) {
        ...
        if (r02 != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(r02, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
    ...
    private final Object emit(Continuation<? super Unit> continuation, T t11) {
        ...
        Object invoke = SafeCollectorKt.emitFun.invoke(this.collector, t11, this);
