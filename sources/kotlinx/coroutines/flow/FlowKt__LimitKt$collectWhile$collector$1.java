...
public final class FlowKt__LimitKt$collectWhile$collector$1 implements FlowCollector<T> {
    ...
    public final /* synthetic */ Function2<T, Continuation<? super Boolean>, Object> f25685b;
    ...
    public java.lang.Object emit(T r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L_0x0013:
            ...
            r0.<init>(r4, r6)
        L_0x0018:
            java.lang.Object r6 = r0.f25687i
        ...
        L_0x0035:
            kotlin.ResultKt.throwOnFailure(r6)
            kotlin.jvm.functions.Function2<T, kotlin.coroutines.Continuation<? super java.lang.Boolean>, java.lang.Object> r6 = r4.f25685b
            r0.f25686h = r4
            r0.f25689k = r3
    ...
    public Object emit$$forInline(T t11, @NotNull Continuation<? super Unit> continuation) {
        ...
        InlineMarker.mark(5);
        if (((Boolean) this.f25685b.invoke(t11, continuation)).booleanValue()) {
