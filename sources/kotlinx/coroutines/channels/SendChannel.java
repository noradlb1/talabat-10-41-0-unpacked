...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e11) {
            ...
            if (ChannelResult.m7809isSuccessimpl(r02)) {
                return true;
            }
            Throwable r03 = ChannelResult.m7803exceptionOrNullimpl(r02);
            if (r03 == null) {
                return false;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(r03);
        }
    }
    ...
    Object m7820trySendJP2dKIU(E e11);
}
