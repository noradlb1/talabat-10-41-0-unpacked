...
public final class ConflatedBroadcastChannel$onSend$1 implements SelectClause2<E, SendChannel<? super E>> {
    ...
    public final /* synthetic */ ConflatedBroadcastChannel<E> f25367b;

    public ConflatedBroadcastChannel$onSend$1(ConflatedBroadcastChannel<E> conflatedBroadcastChannel) {
        this.f25367b = conflatedBroadcastChannel;
    }
    ...
    public <R> void registerSelectClause2(@NotNull SelectInstance<? super R> selectInstance, E e11, @NotNull Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
        this.f25367b.registerSelectSend(selectInstance, e11, function2);
    }
}
