...
public class SendElement<E> extends Send {
    ...
    public SendElement(E e11, @NotNull CancellableContinuation<? super Unit> cancellableContinuation) {
        this.pollResult = e11;
    ...
    public void resumeSendClosed(@NotNull Closed<?> closed) {
        ...
        cancellableContinuation.resumeWith(Result.m6329constructorimpl(ResultKt.createFailure(closed.getSendException())));
    }
    ...
    public Symbol tryResumeSend(@Nullable LockFreeLinkedListNode.PrepareOp prepareOp) {
        ...
        if (cancellableContinuation.tryResume(unit, abstractAtomicDesc) == null) {
            return null;
        }
        if (prepareOp != null) {
