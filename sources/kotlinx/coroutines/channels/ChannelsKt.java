...
public final class ChannelsKt {
    ...
    public static final <E> void sendBlocking(@NotNull SendChannel<? super E> sendChannel, E e11) {
        ChannelsKt__ChannelsKt.sendBlocking(sendChannel, e11);
    }

    @Nullable
    @PublishedApi
    public static final <E, C extends SendChannel<? super E>> Object toChannel(@NotNull ReceiveChannel<? extends E> receiveChannel, @NotNull C c11, @NotNull Continuation<? super C> continuation) {
        return ChannelsKt__DeprecatedKt.toChannel(receiveChannel, c11, continuation);
    }

    @Nullable
    @PublishedApi
    public static final <E, C extends Collection<? super E>> Object toCollection(@NotNull ReceiveChannel<? extends E> receiveChannel, @NotNull C c11, @NotNull Continuation<? super C> continuation) {
    ...
    @Nullable
    @PublishedApi
    public static final <K, V, M extends Map<? super K, ? super V>> Object toMap(@NotNull ReceiveChannel<? extends Pair<? extends K, ? extends V>> receiveChannel, @NotNull M m11, @NotNull Continuation<? super M> continuation) {
