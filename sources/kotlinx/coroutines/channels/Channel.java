...
public interface Channel<E> extends SendChannel<E>, ReceiveChannel<E> {
    ...
    @NotNull
    public static final Factory Factory = Factory.f25163a;
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull Channel<E> channel, E e11) {
            return SendChannel.DefaultImpls.offer(channel, e11);
        }
    ...
    public static final class Factory {
        ...
        public static final /* synthetic */ Factory f25163a = new Factory();
