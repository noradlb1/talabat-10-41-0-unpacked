...
public interface ChildJob extends Job {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(@NotNull ChildJob childJob, R r11, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
            return Job.DefaultImpls.fold(childJob, r11, function2);
        }
