...
public final class HandlerContext extends HandlerDispatcher {
    ...
    private final String f25143name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    private HandlerContext(Handler handler2, String str, boolean z11) {
    ...
    public static final void m7786invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
    ...
    public DisposableHandle invokeOnTimeout(long j11, @NotNull Runnable runnable, @NotNull CoroutineContext coroutineContext) {
        if (this.handler.postDelayed(runnable, RangesKt___RangesKt.coerceAtMost(j11, (long) DurationKt.MAX_MILLIS))) {
    ...
    public void scheduleResumeAfterDelay(long j11, @NotNull CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        if (this.handler.postDelayed(handlerContext$scheduleResumeAfterDelay$$inlined$Runnable$1, RangesKt___RangesKt.coerceAtMost(j11, (long) DurationKt.MAX_MILLIS))) {
    ...
    public /* synthetic */ HandlerContext(Handler handler2, String str, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(handler2, (i11 & 2) != 0 ? null : str);
    }
