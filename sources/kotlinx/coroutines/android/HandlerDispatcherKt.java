...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m6329constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th2) {
    ...
    public static final void m7787postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j11) {
