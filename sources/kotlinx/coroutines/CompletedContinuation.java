...
final class CompletedContinuation {
    ...
    public CompletedContinuation(@Nullable Object obj, @Nullable CancelHandler cancelHandler2, @Nullable Function1<? super Throwable, Unit> function1, @Nullable Object obj2, @Nullable Throwable th2) {
        this.result = obj;
    ...
    public static /* synthetic */ CompletedContinuation copy$default(CompletedContinuation completedContinuation, Object obj, CancelHandler cancelHandler2, Function1<Throwable, Unit> function1, Object obj2, Throwable th2, int i11, Object obj3) {
        if ((i11 & 1) != 0) {
        ...
        return completedContinuation.copy(obj, cancelHandler3, function12, obj4, th2);
    }
    ...
    @NotNull
    public final CompletedContinuation copy(@Nullable Object obj, @Nullable CancelHandler cancelHandler2, @Nullable Function1<? super Throwable, Unit> function1, @Nullable Object obj2, @Nullable Throwable th2) {
        return new CompletedContinuation(obj, cancelHandler2, function1, obj2, th2);
    }
    ...
    public final void invokeHandlers(@NotNull CancellableContinuationImpl<?> cancellableContinuationImpl, @NotNull Throwable th2) {
        ...
        if (cancelHandler2 != null) {
            cancellableContinuationImpl.callCancelHandler(cancelHandler2, th2);
        }
        Function1<Throwable, Unit> function1 = this.onCancellation;
        if (function1 != null) {
    ...
    public /* synthetic */ CompletedContinuation(Object obj, CancelHandler cancelHandler2, Function1 function1, Object obj2, Throwable th2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(obj, (i11 & 2) != 0 ? null : cancelHandler2, (i11 & 4) != 0 ? null : function1, (i11 & 8) != 0 ? null : obj2, (i11 & 16) != 0 ? null : th2);
    }
}
