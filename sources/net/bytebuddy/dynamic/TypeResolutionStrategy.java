...
public interface TypeResolutionStrategy {
    ...
    public static class Active implements TypeResolutionStrategy {
        ...
        public static class Resolved implements Resolved {
            ...
            public Resolved(NexusAccessor nexusAccessor2, int i11) {
            ...
            public <S extends ClassLoader> Map<TypeDescription, Class<?>> initialize(DynamicType dynamicType, S s11, ClassLoadingStrategy<? super S> classLoadingStrategy) {
                ...
                Map<TypeDescription, Class<?>> load = classLoadingStrategy.load(s11, dynamicType.getAllTypes());
    ...
    public enum Lazy implements TypeResolutionStrategy, Resolved {
        ...
        public <S extends ClassLoader> Map<TypeDescription, Class<?>> initialize(DynamicType dynamicType, S s11, ClassLoadingStrategy<? super S> classLoadingStrategy) {
            return classLoadingStrategy.load(s11, dynamicType.getAllTypes());
        }
    ...
    public interface Resolved {
        <S extends ClassLoader> Map<TypeDescription, Class<?>> initialize(DynamicType dynamicType, S s11, ClassLoadingStrategy<? super S> classLoadingStrategy);
