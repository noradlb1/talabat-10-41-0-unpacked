...
public class RedefinitionDynamicTypeBuilder<T> extends AbstractInliningDynamicTypeBuilder<T> {
    ...
    public DynamicType.Unloaded<T> make(TypeResolutionStrategy typeResolutionStrategy, TypePool typePool) {
        ...
        return TypeWriter.Default.forRedefinition(prepare, this.f27148q, this.f27133b.compile(prepare.getInstrumentedType()), this.f27135d.compile(prepare.getInstrumentedType()), this.f27136e, this.f27137f, this.f27138g, this.f27140i, this.f27141j, this.f27139h, this.f27142k, this.f27144m, this.f27146o, typePool, this.f27247r, this.f27248s).make(typeResolutionStrategy.resolve());
    }
