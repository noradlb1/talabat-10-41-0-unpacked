...
public interface FieldLocator {
    ...
    public static class ForClassHierarchy extends AbstractBase {
        ...
        public FieldList<?> a(ElementMatcher<? super FieldDescription> elementMatcher) {
    ...
    public static class ForTopLevelType extends AbstractBase {
        ...
        public FieldList<?> a(ElementMatcher<? super FieldDescription> elementMatcher) {
            return (FieldList) this.f27199b.getDeclaredFields().filter(elementMatcher);
        }
    }
    ...
    public static abstract class AbstractBase implements FieldLocator {
        ...
        public final TypeDescription f27199b;

        public AbstractBase(TypeDescription typeDescription) {
            this.f27199b = typeDescription;
        }

        public abstract FieldList<?> a(ElementMatcher<? super FieldDescription> elementMatcher);

        public boolean equals(Object obj) {
            if (this == obj) {
                return true;
            }
            return obj != null && getClass() == obj.getClass() && this.f27199b.equals(((AbstractBase) obj).f27199b);
        }

        public int hashCode() {
            return (getClass().hashCode() * 31) + this.f27199b.hashCode();
        }

        public Resolution locate(String str) {
            FieldList<?> a11 = a(ElementMatchers.named(str).and(ElementMatchers.isVisibleTo(this.f27199b)));
            return a11.size() == 1 ? new Resolution.Simple((FieldDescription) a11.getOnly()) : Resolution.Illegal.INSTANCE;
        }

        public Resolution locate(String str, TypeDescription typeDescription) {
            FieldList<?> a11 = a(ElementMatchers.named(str).and(ElementMatchers.fieldType(typeDescription)).and(ElementMatchers.isVisibleTo(this.f27199b)));
            return a11.size() == 1 ? new Resolution.Simple((FieldDescription) a11.getOnly()) : Resolution.Illegal.INSTANCE;
        }
    }
}
