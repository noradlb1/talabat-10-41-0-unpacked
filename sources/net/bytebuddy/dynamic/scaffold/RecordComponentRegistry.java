    ...
    public static class Default implements RecordComponentRegistry {
        ...
        public static class Compiled implements Compiled {
            ...
            public static class Entry implements ElementMatcher<RecordComponentDescription> {
                ...
                public Entry(ElementMatcher<? super RecordComponentDescription> elementMatcher, RecordComponentAttributeAppender recordComponentAttributeAppender2, Transformer<RecordComponentDescription> transformer2) {
            ...
            public TypeWriter.RecordComponentPool.Record target(RecordComponentDescription recordComponentDescription) {
                for (Entry next : this.entries) {
                    if (next.matches(recordComponentDescription)) {
                        return next.a(this.instrumentedType, recordComponentDescription);
                    }
                }
                return new TypeWriter.RecordComponentPool.Record.ForImplicitRecordComponent(recordComponentDescription);
            }
        ...
        public static class Entry implements LatentMatcher<RecordComponentDescription> {
            ...
            public Entry(LatentMatcher<? super RecordComponentDescription> latentMatcher, RecordComponentAttributeAppender.Factory factory, Transformer<RecordComponentDescription> transformer2) {
        ...
        public Compiled compile(TypeDescription typeDescription) {
            ...
            for (Entry next : this.entries) {
                RecordComponentAttributeAppender recordComponentAttributeAppender = (RecordComponentAttributeAppender) hashMap.get(next.a());
                if (recordComponentAttributeAppender == null) {
                    recordComponentAttributeAppender = next.a().make(typeDescription);
                    hashMap.put(next.a(), recordComponentAttributeAppender);
                }
                arrayList.add(new Compiled.Entry(next.resolve(typeDescription), recordComponentAttributeAppender, next.b()));
            }
