    ...
    public interface Handler extends InstrumentedType.Prepareable {
        ...
        public static class ForImplementation implements Handler {
            ...
            public static class Compiled implements Compiled {
                ...
                public Compiled(ByteCodeAppender byteCodeAppender2) {
    ...
    public static class Default implements MethodRegistry {
        ...
        public static class Compiled implements Compiled {
            ...
            public static class Entry {
                ...
                public Entry(Handler.Compiled compiled, MethodAttributeAppender methodAttributeAppender, MethodDescription methodDescription2, Set<MethodDescription.TypeToken> set, Visibility visibility2, boolean z11) {
            ...
            public Compiled(TypeDescription typeDescription, LoadedTypeInitializer loadedTypeInitializer2, TypeInitializer typeInitializer2, MethodList<?> methodList, LinkedHashMap<MethodDescription, Entry> linkedHashMap, boolean z11) {
                this.instrumentedType = typeDescription;
            ...
            public TypeWriter.MethodPool.Record target(MethodDescription methodDescription) {
                ...
                return entry.a(this.instrumentedType, this.supportsBridges);
            }
        }
        ...
        public static class Entry implements LatentMatcher<MethodDescription> {
            ...
            public Entry(LatentMatcher<? super MethodDescription> latentMatcher, Handler handler2, MethodAttributeAppender.Factory factory, Transformer<MethodDescription> transformer2) {
        ...
        public static class Prepared implements Prepared {
            ...
            public static class Entry {
                ...
                public Entry(Handler handler2, MethodAttributeAppender.Factory factory, MethodDescription methodDescription2, Set<MethodDescription.TypeToken> set, Visibility visibility2, boolean z11) {
                    this.handler = handler2;
                    this.attributeAppenderFactory = factory;
                    this.methodDescription = methodDescription2;
                    this.typeTokens = set;
                ...
                public static Entry a(MethodDescription methodDescription2, Visibility visibility2) {
            ...
            public Prepared(LinkedHashMap<MethodDescription, Entry> linkedHashMap, LoadedTypeInitializer loadedTypeInitializer2, TypeInitializer typeInitializer2, TypeDescription typeDescription, MethodGraph.Linked linked, MethodList<?> methodList) {
                this.implementations = linkedHashMap;
                this.loadedTypeInitializer = loadedTypeInitializer2;
                this.typeInitializer = typeInitializer2;
                this.instrumentedType = typeDescription;
            ...
            public Compiled compile(Implementation.Target.Factory factory, ClassFileVersion classFileVersion) {
                ...
                for (Map.Entry next : this.implementations.entrySet()) {
                    Handler.Compiled compiled = (Handler.Compiled) hashMap.get(((Entry) next.getValue()).c());
                    if (compiled == null) {
                        compiled = ((Entry) next.getValue()).c().compile(make);
                        hashMap.put(((Entry) next.getValue()).c(), compiled);
                    }
                    Handler.Compiled compiled2 = compiled;
                    MethodAttributeAppender methodAttributeAppender = (MethodAttributeAppender) hashMap2.get(((Entry) next.getValue()).b());
                    if (methodAttributeAppender == null) {
                        methodAttributeAppender = ((Entry) next.getValue()).b().make(this.instrumentedType);
                        hashMap2.put(((Entry) next.getValue()).b(), methodAttributeAppender);
                    }
                    linkedHashMap.put(next.getKey(), new Compiled.Entry(compiled2, methodAttributeAppender, ((Entry) next.getValue()).d(), ((Entry) next.getValue()).g(), ((Entry) next.getValue()).e(), ((Entry) next.getValue()).f()));
                }
        ...
        public net.bytebuddy.dynamic.scaffold.MethodRegistry.Prepared prepare(net.bytebuddy.dynamic.scaffold.InstrumentedType r11, net.bytebuddy.dynamic.scaffold.MethodGraph.Compiler r12, net.bytebuddy.dynamic.scaffold.TypeValidation r13, net.bytebuddy.dynamic.VisibilityBridgeStrategy r14, net.bytebuddy.matcher.LatentMatcher<? super net.bytebuddy.description.method.MethodDescription> r15) {
            ...
            L_0x0019:
                ...
                net.bytebuddy.dynamic.scaffold.MethodRegistry$Handler r5 = r4.d()
            ...
            L_0x0041:
                ...
                net.bytebuddy.dynamic.scaffold.MethodRegistry$Default$Prepared$Entry r7 = r4.c(r6)
                r1.put(r6, r7)
                r2.add(r6)
                goto L_0x0041
            L_0x005e:
            ...
            L_0x00d5:
                ...
                net.bytebuddy.dynamic.scaffold.MethodRegistry$Default$Prepared$Entry r4 = r8.a(r11, r3, r4, r7)
                r1.put(r3, r4)
                goto L_0x00fc
            L_0x00fb:
                r6 = r4
            L_0x00fc:
                ...
                net.bytebuddy.dynamic.scaffold.MethodRegistry$Default$Prepared$Entry r2 = net.bytebuddy.dynamic.scaffold.MethodRegistry.Default.Prepared.Entry.a(r3, r2)
                r1.put(r3, r2)
            L_0x0135:
                r15.add(r3)
                goto L_0x00a9
            ...
            L_0x016d:
                ...
                net.bytebuddy.dynamic.scaffold.MethodRegistry$Default$Prepared$Entry r0 = r2.b(r11, r14, r0)
                r1.put(r14, r0)
            L_0x018e:
                r15.add(r14)
                goto L_0x015b
