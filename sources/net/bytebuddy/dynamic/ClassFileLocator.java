...
public interface ClassFileLocator extends Closeable {
    ...
    public static class ForClassLoader implements ClassFileLocator {
        ...
        public static class WeaklyReferenced extends WeakReference<ClassLoader> implements ClassFileLocator {
            ...
            public Resolution locate(String str) throws IOException {
                ...
                return ForClassLoader.a(classLoader, str);
            }
        }
        ...
        public ForClassLoader(ClassLoader classLoader2) {
            this.classLoader = classLoader2;
        }

        public static Resolution a(ClassLoader classLoader2, String str) throws IOException {
        ...
        public static byte[] read(Class<?> cls) {
            try {
                ...
                return a(classLoader2, TypeDescription.ForLoadedType.getName(cls)).resolve();
            } catch (IOException e11) {
                throw new IllegalStateException("Cannot read class file for " + cls, e11);
            }
        }
    ...
    public static class ForInstrumentation implements ClassFileLocator {
        ...
        public interface ClassLoadingDelegate {
            ...
            public static class Default implements ClassLoadingDelegate {
                ...
                public boolean equals(Object obj) {
                    ...
                    return obj != null && getClass() == obj.getClass() && this.f27131a.equals(((Default) obj).f27131a);
                }
                ...
                public int hashCode() {
                    return (getClass().hashCode() * 31) + this.f27131a.hashCode();
                }

                public Class<?> locate(String str) throws ClassNotFoundException {
                    return this.f27131a.loadClass(str);
                }
            }
            ...
            public static class ForDelegatingClassLoader extends Default {
                    ...
                    public enum CreationAction implements PrivilegedAction<Initializable> {
                        ...
                        public Initializable run() {
                            try {
                                ...
                                return new Unresolved(e11.getMessage());
                            }
                        }
                    }
                    ...
                    public static class Resolved implements Dispatcher, Initializable, PrivilegedAction<Dispatcher> {
                        ...
                        public Vector<Class<?>> extract(ClassLoader classLoader) {
                            try {
                                ...
                                throw new IllegalStateException("Cannot access field", e11);
                            }
                        }
                ...
                public Class<?> locate(String str) throws ClassNotFoundException {
                    try {
                        Vector<Class<?>> extract = DISPATCHER.initialize().extract(this.f27131a);
                        if (extract.size() != 1) {
        ...
        public static class ExtractionClassFileTransformer implements ClassFileTransformer {
            ...
            public ExtractionClassFileTransformer(ClassLoader classLoader2, String str) {
                this.classLoader = classLoader2;
                this.typeName = str;
            }
        ...
        public ForInstrumentation(Instrumentation instrumentation2, ClassLoader classLoader) {
        ...
        public Resolution locate(String str) {
            ...
            try {
                ...
                byte[] a11 = extractionClassFileTransformer.a();
                if (a11 == null) {
                    resolution = new Resolution.Illegal(str);
                } else {
                    resolution = new Resolution.Explicit(a11);
                }
    ...
    public static class ForModule implements ClassFileLocator {
        ...
        public static class WeaklyReferenced extends WeakReference<Object> implements ClassFileLocator {
            ...
            public Resolution locate(String str) throws IOException {
                ...
                return ForModule.a(JavaModule.of(obj), str);
            }
        }
        ...
        public static ClassFileLocator ofBootLayer() {
            try {
                ...
                throw new IllegalStateException("Cannot process boot layer", e11);
            }
        }
    ...
    public static class ForUrl implements ClassFileLocator {
        ...
        public Resolution locate(String str) throws IOException {
            return ForClassLoader.a(this.classLoader, str);
        }
