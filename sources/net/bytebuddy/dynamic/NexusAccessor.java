...
public class NexusAccessor {
    ...
    public interface Dispatcher {
        ...
        public static class Available implements Dispatcher {
            ...
            public void register(String str, ClassLoader classLoader, ReferenceQueue<? super ClassLoader> referenceQueue, int i11, LoadedTypeInitializer loadedTypeInitializer) {
                try {
                    this.register.invoke(STATIC_METHOD, new Object[]{str, classLoader, referenceQueue, Integer.valueOf(i11), loadedTypeInitializer});
                } catch (IllegalAccessException e11) {
                    throw new IllegalStateException(e11);
                } catch (InvocationTargetException e12) {
                    throw new IllegalStateException(e12.getTargetException());
        ...
        public enum CreationAction implements PrivilegedAction<Dispatcher> {
            ...
            public Dispatcher run() {
                ...
                Class<ReferenceQueue> cls3 = ReferenceQueue.class;
                Class<ClassLoader> cls4 = ClassLoader.class;
                Class<String> cls5 = String.class;
                Class<Nexus> cls6 = Nexus.class;
                if (Boolean.getBoolean(Nexus.PROPERTY)) {
                    return new Unavailable("Nexus injection was explicitly disabled");
                }
                try {
                    Class cls7 = new ClassInjector.UsingReflection(ClassLoader.getSystemClassLoader(), ClassLoadingStrategy.NO_PROTECTION_DOMAIN).inject(Collections.singletonMap(TypeDescription.ForLoadedType.of(cls6), ClassFileLocator.ForClassLoader.read((Class<?>) cls6))).get(TypeDescription.ForLoadedType.of(cls6));
                    return new Available(cls7.getMethod("register", new Class[]{cls5, cls4, cls3, Integer.TYPE, cls2}), cls7.getMethod("clean", new Class[]{cls}));
                } catch (Exception e11) {
                    try {
                        Class<?> loadClass = ClassLoader.getSystemClassLoader().loadClass(cls6.getName());
                        return new Available(loadClass.getMethod("register", new Class[]{cls5, cls4, cls3, Integer.TYPE, cls2}), loadClass.getMethod("clean", new Class[]{cls}));
        ...
        void register(String str, ClassLoader classLoader, ReferenceQueue<? super ClassLoader> referenceQueue, int i11, LoadedTypeInitializer loadedTypeInitializer);
    }
    ...
    public static class InitializationAppender implements ByteCodeAppender {
        ...
        public InitializationAppender(int i11) {
            this.identification = i11;
        }

        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
            Class<String> cls = String.class;
            Class<ClassLoader> cls2 = ClassLoader.class;
            try {
                ...
                stackManipulationArr2[0] = MethodInvocation.invoke((MethodDescription.InDefinedShape) new MethodDescription.ForLoadedMethod(cls2.getMethod("getSystemClassLoader", new Class[0])));
                stackManipulationArr2[1] = new TextConstant(Nexus.class.getName());
                stackManipulationArr2[2] = MethodInvocation.invoke((MethodDescription.InDefinedShape) new MethodDescription.ForLoadedMethod(cls2.getMethod("loadClass", new Class[]{cls})));
                ...
                stackManipulationArr2[4] = forType.withValues(Arrays.asList(new StackManipulation[]{ClassConstant.of(TypeDescription.CLASS), ClassConstant.of(TypeDescription.ForLoadedType.of(cls3))}));
                stackManipulationArr2[5] = MethodInvocation.invoke((MethodDescription.InDefinedShape) new MethodDescription.ForLoadedMethod(Class.class.getMethod("getMethod", new Class[]{cls, Class[].class})));
    ...
    public void register(String str, ClassLoader classLoader, int i11, LoadedTypeInitializer loadedTypeInitializer) {
        if (loadedTypeInitializer.isAlive()) {
            DISPATCHER.register(str, classLoader, this.referenceQueue, i11, loadedTypeInitializer);
        }
    }
