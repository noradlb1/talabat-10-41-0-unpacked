...
public interface ClassLoadingStrategy<T extends ClassLoader> {
    ...
    public enum Default implements Configurable<ClassLoader> {
        ...
        public static class InjectionDispatcher implements Configurable<ClassLoader> {
            ...
            private InjectionDispatcher(ProtectionDomain protectionDomain2, PackageDefinitionStrategy packageDefinitionStrategy2, boolean z11) {
        ...
        public static class WrappingDispatcher implements Configurable<ClassLoader> {
            ...
            public WrappingDispatcher(ByteArrayClassLoader.PersistenceHandler persistenceHandler2, boolean z11) {
                this(ClassLoadingStrategy.NO_PROTECTION_DOMAIN, PackageDefinitionStrategy.Trivial.INSTANCE, persistenceHandler2, z11, true, true);
            }
            ...
            private WrappingDispatcher(ProtectionDomain protectionDomain2, PackageDefinitionStrategy packageDefinitionStrategy2, ByteArrayClassLoader.PersistenceHandler persistenceHandler2, boolean z11, boolean z12, boolean z13) {
                this.protectionDomain = protectionDomain2;
                this.packageDefinitionStrategy = packageDefinitionStrategy2;
                this.persistenceHandler = persistenceHandler2;
                this.childFirst = z11;
                this.forbidExisting = z12;
                this.sealed = z13;
            }
    ...
    public static class ForJnaInjection implements ClassLoadingStrategy<ClassLoader> {
        ...
        public ForJnaInjection(ProtectionDomain protectionDomain2) {
            this.protectionDomain = protectionDomain2;
        }
    }
    ...
    public static class UsingLookup implements ClassLoadingStrategy<ClassLoader> {
        ...
        public UsingLookup(ClassInjector classInjector2) {
    ...
    Map<TypeDescription, Class<?>> load(T t11, Map<TypeDescription, byte[]> map);
}
