...
public class ToStringPlugin implements Plugin, Plugin.Factory {
    ...
    public @interface Enhance {
        ...
        public enum Prefix {
            ...
            public ToStringMethod.PrefixResolver.Default a() {
    ...
    public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, TypeDescription typeDescription, ClassFileLocator classFileLocator) {
        ...
        ToStringMethod prefixedBy = ToStringMethod.prefixedBy((ToStringMethod.PrefixResolver) ((Enhance.Prefix) ofType.getValue(ENHANCE_PREFIX).load(cls.getClassLoader()).resolve(Enhance.Prefix.class)).a());
