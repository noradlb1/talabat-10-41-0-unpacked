...
public class TypeReference {
    ...
    public TypeReference(int i11) {
        this.targetTypeAndInfo = i11;
    }

    /* JADX WARNING: Code restructure failed: missing block: B:10:0x001b, code lost:
        r3.d(r0, (r2 & 16776960) >> 8);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:?, code lost:
        return;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void a(int r2, net.bytebuddy.jar.asm.ByteVector r3) {
        /*
            int r0 = r2 >>> 24
        ...
        L_0x002a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: net.bytebuddy.jar.asm.TypeReference.a(int, net.bytebuddy.jar.asm.ByteVector):void");
    }

    public static TypeReference newExceptionReference(int i11) {
        return new TypeReference((i11 << 8) | 385875968);
    }

    public static TypeReference newFormalParameterReference(int i11) {
        return new TypeReference((i11 << 16) | 369098752);
    }

    public static TypeReference newSuperTypeReference(int i11) {
        return new TypeReference(((i11 & 65535) << 8) | 268435456);
    }

    public static TypeReference newTryCatchReference(int i11) {
        return new TypeReference((i11 << 8) | 1107296256);
    }

    public static TypeReference newTypeArgumentReference(int i11, int i12) {
        return new TypeReference((i11 << 24) | i12);
    }

    public static TypeReference newTypeParameterBoundReference(int i11, int i12, int i13) {
        return new TypeReference((i11 << 24) | (i12 << 16) | (i13 << 8));
    }

    public static TypeReference newTypeParameterReference(int i11, int i12) {
        return new TypeReference((i11 << 24) | (i12 << 16));
    }

    public static TypeReference newTypeReference(int i11) {
        return new TypeReference(i11 << 24);
    }
