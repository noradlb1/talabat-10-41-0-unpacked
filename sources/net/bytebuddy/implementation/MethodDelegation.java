...
public class MethodDelegation implements Implementation.Composable {
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public Appender(Implementation.Target target, MethodDelegationBinder.Record record, MethodDelegationBinder.TerminationHandler terminationHandler2, Assigner assigner2, ImplementationDelegate.Compiled compiled2) {
    ...
    public interface ImplementationDelegate extends InstrumentedType.Prepareable {
        ...
        public interface Compiled {
            ...
            public static class ForConstruction implements Compiled {
                ...
                public ForConstruction(TypeDescription typeDescription2, List<MethodDelegationBinder.Record> list) {
            ...
            public static class ForField implements Compiled {
                ...
                public ForField(FieldDescription fieldDescription2, List<MethodDelegationBinder.Record> list) {
            ...
            public static class ForMethodReturn implements Compiled {
                ...
                public ForMethodReturn(MethodDescription methodDescription2, List<MethodDelegationBinder.Record> list) {
        ...
        public static class ForConstruction implements ImplementationDelegate {
            ...
            public static ImplementationDelegate a(TypeDescription typeDescription2, MethodList<?> methodList, MethodDelegationBinder methodDelegationBinder) {
        ...
        public static abstract class ForField implements ImplementationDelegate {
            ...
            public final MethodGraph.Compiler f27311c;

            /* renamed from: d  reason: collision with root package name */
            public final List<? extends TargetMethodAnnotationDrivenBinder.ParameterBinder<?>> f27312d;

            /* renamed from: e  reason: collision with root package name */
            public final ElementMatcher<? super MethodDescription> f27313e;
            ...
            public static class WithInstance extends ForField {
                ...
                public FieldDescription a(TypeDescription typeDescription) {
                    if (this.fieldType.asErasure().isVisibleTo(typeDescription)) {
                        return (FieldDescription) ((FieldList) typeDescription.getDeclaredFields().filter(ElementMatchers.named(this.f27310b).and(ElementMatchers.fieldType(this.fieldType.asErasure())))).getOnly();
                    }
                ...
                public InstrumentedType prepare(InstrumentedType instrumentedType) {
                    if (((FieldList) instrumentedType.getDeclaredFields().filter(ElementMatchers.named(this.f27310b).and(ElementMatchers.fieldType(this.fieldType.asErasure())))).isEmpty()) {
                        return instrumentedType.withField(new FieldDescription.Token(this.f27310b, 4169, this.fieldType)).withInitializer((LoadedTypeInitializer) new LoadedTypeInitializer.ForStaticField(this.f27310b, this.target));
                    }
                    throw new IllegalStateException("Field with name " + this.f27310b + " and type " + this.fieldType.asErasure() + " already declared by " + instrumentedType);
                }
            }
            ...
            public static class WithLookup extends ForField {
                ...
                public FieldDescription a(TypeDescription typeDescription) {
                    FieldLocator.Resolution locate = this.fieldLocatorFactory.make(typeDescription).locate(this.f27310b);
                    if (locate.isResolved()) {
                        return locate.getField();
                    }
                    throw new IllegalStateException("Could not locate " + this.f27310b + " on " + typeDescription);
                }
            ...
            public ForField(String str, MethodGraph.Compiler compiler, List<? extends TargetMethodAnnotationDrivenBinder.ParameterBinder<?>> list, ElementMatcher<? super MethodDescription> elementMatcher) {
                this.f27310b = str;
                this.f27311c = compiler;
                this.f27312d = list;
                this.f27313e = elementMatcher;
            }

            public abstract FieldDescription a(TypeDescription typeDescription);

            public Compiled compile(TypeDescription typeDescription) {
                FieldDescription a11 = a(typeDescription);
                if (a11.getType().asErasure().isVisibleTo(typeDescription)) {
                    MethodList<MethodDescription> methodList = (MethodList) this.f27311c.compile((TypeDefinition) a11.getType(), typeDescription).listNodes().asMethodList().filter(this.f27313e);
                    ArrayList arrayList = new ArrayList(methodList.size());
                    MethodDelegationBinder of2 = TargetMethodAnnotationDrivenBinder.of(this.f27312d);
                    for (MethodDescription compile : methodList) {
                        arrayList.add(of2.compile(compile));
                    }
                    return new Compiled.ForField(a11, arrayList);
                }
                throw new IllegalStateException(a11 + " is not visible to " + typeDescription);
            }
            ...
            public boolean equals(Object obj) {
                ...
                ForField forField = (ForField) obj;
                return this.f27310b.equals(forField.f27310b) && this.f27311c.equals(forField.f27311c) && this.f27312d.equals(forField.f27312d) && this.f27313e.equals(forField.f27313e);
            }

            public int hashCode() {
                return (((((((getClass().hashCode() * 31) + this.f27310b.hashCode()) * 31) + this.f27311c.hashCode()) * 31) + this.f27312d.hashCode()) * 31) + this.f27313e.hashCode();
            }
        }
        ...
        public static class ForMethodReturn implements ImplementationDelegate {
            ...
            private final String f27314name;
            ...
            public Compiled compile(TypeDescription typeDescription) {
                MethodList methodList = (MethodList) new MethodList.Explicit(CompoundList.of(typeDescription.getDeclaredMethods().filter(ElementMatchers.isStatic().or(ElementMatchers.isPrivate())), (FilterableList) this.methodGraphCompiler.compile((TypeDefinition) typeDescription).listNodes().asMethodList())).filter(ElementMatchers.named(this.f27314name).and(ElementMatchers.takesArguments(0)).and(ElementMatchers.not(ElementMatchers.returns((ElementMatcher<? super TypeDescription>) ElementMatchers.isPrimitive().or(ElementMatchers.isArray())))));
                if (methodList.size() != 1) {
                    throw new IllegalStateException(typeDescription + " does not define method without arguments with name " + this.f27314name + ": " + methodList);
            ...
            public boolean equals(Object obj) {
                ...
                ForMethodReturn forMethodReturn = (ForMethodReturn) obj;
                return this.f27314name.equals(forMethodReturn.f27314name) && this.methodGraphCompiler.equals(forMethodReturn.methodGraphCompiler) && this.parameterBinders.equals(forMethodReturn.parameterBinders) && this.matcher.equals(forMethodReturn.matcher);
            }

            public int hashCode() {
                return (((((((getClass().hashCode() * 31) + this.f27314name.hashCode()) * 31) + this.methodGraphCompiler.hashCode()) * 31) + this.parameterBinders.hashCode()) * 31) + this.matcher.hashCode();
            }
    ...
    public static class WithCustomProperties {
        ...
        public WithCustomProperties(MethodDelegationBinder.AmbiguityResolver ambiguityResolver2, List<TargetMethodAnnotationDrivenBinder.ParameterBinder<?>> list) {
        ...
        public MethodDelegation to(TypeDescription typeDescription) {
            if (typeDescription.isArray()) {
                ...
                return new MethodDelegation(ImplementationDelegate.ForStaticMethod.a((MethodList) typeDescription.getDeclaredMethods().filter(ElementMatchers.isStatic().and(this.matcher)), TargetMethodAnnotationDrivenBinder.of(this.parameterBinders)), this.parameterBinders, this.ambiguityResolver, this.bindingResolver);
            } else {
        ...
        public MethodDelegation toConstructor(TypeDescription typeDescription) {
            return new MethodDelegation(ImplementationDelegate.ForConstruction.a(typeDescription, (MethodList) typeDescription.getDeclaredMethods().filter(ElementMatchers.isConstructor().and(this.matcher)), TargetMethodAnnotationDrivenBinder.of(this.parameterBinders)), this.parameterBinders, this.ambiguityResolver, this.bindingResolver);
        }
        ...
        public MethodDelegation to(Object obj, Type type, MethodGraph.Compiler compiler) {
            return to(obj, type, "delegate$" + RandomString.hashOf(obj.getClass().hashCode() ^ obj.hashCode()), compiler);
        }
        ...
        public MethodDelegation to(Object obj, TypeDefinition typeDefinition, MethodGraph.Compiler compiler) {
            return to(obj, typeDefinition, "delegate$" + RandomString.hashOf(obj.getClass().hashCode() ^ obj.hashCode()), compiler);
        }
    ...
    public MethodDelegation(ImplementationDelegate implementationDelegate2, List<TargetMethodAnnotationDrivenBinder.ParameterBinder<?>> list, MethodDelegationBinder.AmbiguityResolver ambiguityResolver2, MethodDelegationBinder.BindingResolver bindingResolver2) {
