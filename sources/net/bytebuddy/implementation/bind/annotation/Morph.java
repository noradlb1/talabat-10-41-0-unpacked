...
public @interface Morph {
    ...
    public static class Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Morph> {
        ...
        public static class RedirectionProxy extends StackManipulation.AbstractBase implements AuxiliaryType {
                ...
                public class Appender implements ByteCodeAppender {
                    ...
                    public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context context, MethodDescription methodDescription) {
                        ...
                        for (TypeDescription.Generic assign : MethodCall.this.accessorMethod.getParameters().asTypeList()) {
                            stackManipulationArr[i11] = new StackManipulation.Compound(loadFrom, IntegerConstant.forValue(i11), ArrayAccess.REFERENCE.load(), MethodCall.this.assigner.assign(TypeDescription.Generic.OBJECT, assign, Assigner.Typing.DYNAMIC));
                            i11++;
                        }
            ...
            public RedirectionProxy(TypeDescription typeDescription, TypeDescription typeDescription2, Implementation.SpecialMethodInvocation specialMethodInvocation2, Assigner assigner2, boolean z11) {
