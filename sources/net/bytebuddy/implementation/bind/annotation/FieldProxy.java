...
public @interface FieldProxy {
    ...
    public static class Binder extends TargetMethodAnnotationDrivenBinder.ParameterBinder.ForFieldBinding<FieldProxy> {
        ...
        public class AccessorProxy extends StackManipulation.AbstractBase implements AuxiliaryType {
            ...
            public AccessorProxy(FieldDescription fieldDescription2, TypeDescription typeDescription, FieldResolver fieldResolver2, Assigner assigner2, boolean z11) {
            ...
            public int hashCode() {
                return (((((((((((getClass().hashCode() * 31) + this.fieldDescription.hashCode()) * 31) + this.instrumentedType.hashCode()) * 31) + this.fieldResolver.hashCode()) * 31) + this.assigner.hashCode()) * 31) + (this.serializableProxy ? 1 : 0)) * 31) + Binder.this.hashCode();
            }
        ...
        public static class FieldGetter implements Implementation {
            ...
            public FieldGetter(FieldDescription fieldDescription2, Assigner assigner2, MethodAccessorFactory methodAccessorFactory2) {
                this.fieldDescription = fieldDescription2;
                this.assigner = assigner2;
        ...
        public static class FieldSetter implements Implementation {
            ...
            public FieldSetter(FieldDescription fieldDescription2, Assigner assigner2, MethodAccessorFactory methodAccessorFactory2) {
                this.fieldDescription = fieldDescription2;
                this.assigner = assigner2;
                this.methodAccessorFactory = methodAccessorFactory2;
            }
