...
public @interface Super {
    ...
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Super> {
        ...
        public interface TypeLocator {
            ...
            public static class ForType implements TypeLocator {
                ...
                public static TypeLocator a(TypeDescription typeDescription2) {
        ...
        static {
            ...
            STRATEGY = (MethodDescription.InDefinedShape) ((MethodList) declaredMethods.filter(ElementMatchers.named(DefaultParallelExecutionConfigurationStrategy.CONFIG_STRATEGY_PROPERTY_NAME))).getOnly();
        ...
        public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<Super> loadable, MethodDescription methodDescription, ParameterDescription parameterDescription, Implementation.Target target, Assigner assigner, Assigner.Typing typing) {
            ...
            TypeDescription resolve = TypeLocator.ForType.a((TypeDescription) loadable.getValue(PROXY_TYPE).resolve(TypeDescription.class)).resolve(target.getInstrumentedType(), parameterDescription.getType());
            if (resolve.isFinal()) {
                ...
                return new MethodDelegationBinder.ParameterBinding.Anonymous(((Instantiation) ((EnumerationDescription) loadable.getValue(STRATEGY).resolve(EnumerationDescription.class)).load(Instantiation.class)).d(resolve, target, loadable));
            }
        }
    ...
    public enum Instantiation {
        CONSTRUCTOR {
            public StackManipulation d(TypeDescription typeDescription, Implementation.Target target, AnnotationDescription.Loadable<Super> loadable) {
        ...
        public abstract StackManipulation d(TypeDescription typeDescription, Implementation.Target target, AnnotationDescription.Loadable<Super> loadable);
    }
