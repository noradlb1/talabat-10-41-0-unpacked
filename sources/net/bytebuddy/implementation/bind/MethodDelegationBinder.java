...
public interface MethodDelegationBinder {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f27320a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f27320a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f27320a     // Catch:{ NoSuchFieldError -> 0x0033 }
    ...
    public interface AmbiguityResolver {
        ...
        public enum Resolution {
            ...
            private Resolution(boolean z11) {
                this.unresolved = z11;
            }
            ...
            public Resolution merge(Resolution resolution) {
                int i11 = AnonymousClass1.f27320a[ordinal()];
                if (i11 == 1 || i11 == 2) {
        ...
        public enum Default implements BindingResolver {
            ...
            private MethodBinding doResolve(AmbiguityResolver ambiguityResolver, MethodDescription methodDescription, List<MethodBinding> list) {
                ...
                if (size != 2) {
                    ...
                    int[] iArr = AnonymousClass1.f27320a;
                    int i11 = iArr[ambiguityResolver.resolve(methodDescription, methodBinding, methodBinding2).ordinal()];
                    if (i11 == 1) {
                        list.remove(1);
                        ...
                        int i12 = iArr[ambiguityResolver.resolve(methodDescription, methodBinding, doResolve).merge(ambiguityResolver.resolve(methodDescription, methodBinding2, doResolve)).ordinal()];
                        if (i12 != 1) {
                            if (i12 == 2) {
                                return doResolve;
                            }
                    ...
                    int i13 = AnonymousClass1.f27320a[ambiguityResolver.resolve(methodDescription, methodBinding3, methodBinding4).ordinal()];
                    if (i13 == 1) {
    ...
    public interface MethodBinding extends StackManipulation {
        ...
        public static class Builder {
            ...
            public boolean append(ParameterBinding<?> parameterBinding) {
                ...
                int i11 = this.nextParameterIndex;
                this.nextParameterIndex = i11 + 1;
                if (linkedHashMap.put(identificationToken, Integer.valueOf(i11)) == null) {
                    return true;
                }
                return false;
            }
    ...
    public interface ParameterBinding<T> extends StackManipulation {
        ...
        public static class Unique<T> implements ParameterBinding<T> {
            ...
            public Unique(StackManipulation stackManipulation, T t11) {
                this.delegate = stackManipulation;
                this.identificationToken = t11;
            }

            public static <S> Unique<S> of(StackManipulation stackManipulation, S s11) {
                return new Unique<>(stackManipulation, s11);
            }
