...
public enum MethodInvocation {
    ...
    public class DynamicInvocation extends StackManipulation.AbstractBase {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            for (JavaConstant accept : this.arguments) {
                objArr[i12] = accept.accept(JavaConstantValue.Visitor.INSTANCE);
                i12++;
            }
            ...
            if (MethodInvocation.this.handle == MethodInvocation.this.legacyHandle || context.getClassFileVersion().isAtLeast(ClassFileVersion.JAVA_V11)) {
                i11 = MethodInvocation.this.handle;
            } else {
                i11 = MethodInvocation.this.legacyHandle;
            }
            methodVisitor.visitInvokeDynamicInsn(str, sb3, new Handle(i11, this.bootstrapMethod.getDeclaringType().getInternalName(), this.bootstrapMethod.getInternalName(), this.bootstrapMethod.getDescriptor(), this.bootstrapMethod.getDeclaringType().isInterface()), objArr);
    ...
    public static class HandleInvocation extends StackManipulation.AbstractBase {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, METHOD_HANDLE, a11, str, false);
    ...
    public class Invocation extends StackManipulation.AbstractBase implements WithImplicitInvocationTargetType {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            if (MethodInvocation.this.opcode == MethodInvocation.this.legacyOpcode || context.getClassFileVersion().isAtLeast(ClassFileVersion.JAVA_V11)) {
                i11 = MethodInvocation.this.opcode;
            } else {
                i11 = MethodInvocation.this.legacyOpcode;
            }
            methodVisitor.visitMethodInsn(i11, this.typeDescription.getInternalName(), this.methodDescription.getInternalName(), this.methodDescription.getDescriptor(), this.typeDescription.isInterface());
        ...
        public Invocation(MethodDescription.InDefinedShape inDefinedShape, TypeDescription typeDescription2) {
    ...
    private MethodInvocation(int i11, int i12, int i13, int i14) {
        this.opcode = i11;
        this.handle = i12;
    ...
    public static WithImplicitInvocationTargetType invoke(MethodDescription methodDescription) {
        ...
        return OfGenericMethod.a(methodDescription, invoke(inDefinedShape));
    }
}
