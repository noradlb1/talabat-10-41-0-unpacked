...
public enum MethodVariableAccess {
    ...
    public static class MethodLoading extends StackManipulation.AbstractBase {
        ...
        public interface TypeCastingHandler {
            ...
            public static class ForBridgeTarget implements TypeCastingHandler {
                ...
                public StackManipulation ofIndex(TypeDescription typeDescription, int i11) {
                    TypeDescription asErasure = ((ParameterDescription) this.bridgeTarget.getParameters().get(i11)).getType().asErasure();
        ...
        public MethodLoading(MethodDescription methodDescription2, TypeCastingHandler typeCastingHandler2) {
    ...
    public static class OffsetIncrementing extends StackManipulation.AbstractBase {
        ...
        public OffsetIncrementing(int i11, int i12) {
            this.offset = i11;
            this.value = i12;
        }
    ...
    private MethodVariableAccess(int i11, int i12, StackSize stackSize) {
        this.loadOpcode = i11;
        this.size = stackSize;
