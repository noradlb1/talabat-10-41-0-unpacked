...
public class ArrayFactory implements CollectionFactory {
    ...
    public interface ArrayCreator extends StackManipulation {
        ...
        public enum ForPrimitiveType implements ArrayCreator {
            ...
            private ForPrimitiveType(int i11, int i12) {
    ...
    public class ArrayStackManipulation implements StackManipulation {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            for (StackManipulation apply : this.stackManipulations) {
                ...
                StackManipulation.Size aggregate2 = aggregate.aggregate(StackSize.SINGLE.toIncreasingSize()).aggregate(IntegerConstant.forValue(i11).apply(methodVisitor, context)).aggregate(apply.apply(methodVisitor, context));
    ...
    public ArrayFactory(TypeDescription.Generic generic, ArrayCreator arrayCreator2) {
