...
public enum StackSize {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        public static final /* synthetic */ int[] f27329a = null;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f27329a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f27329a     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    public StackSize maximum(StackSize stackSize) {
        int[] iArr = AnonymousClass1.f27329a;
        int i11 = iArr[ordinal()];
        if (i11 == 1) {
            return this;
        }
        if (i11 == 2) {
            int i12 = iArr[stackSize.ordinal()];
            if (i12 == 1) {
                return stackSize;
            }
            if (i12 == 2 || i12 == 3) {
    ...
    public static StackSize of(int i11) {
        if (i11 == 0) {
            return ZERO;
        }
        if (i11 == 1) {
    ...
    public static int of(Collection<? extends TypeDefinition> collection) {
        ...
        for (TypeDefinition stackSize : collection) {
            i11 += stackSize.getStackSize().getSize();
        }
        return i11;
    }
}
