...
public enum Removal implements StackManipulation {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        public static final /* synthetic */ int[] f27328a = null;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f27328a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f27328a     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    public static StackManipulation of(TypeDefinition typeDefinition) {
        int i11 = AnonymousClass2.f27328a[typeDefinition.getStackSize().ordinal()];
        if (i11 == 1) {
            return SINGLE;
        }
        if (i11 == 2) {
    ...
    private Removal(StackSize stackSize, int i11) {
