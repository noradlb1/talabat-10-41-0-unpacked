...
public class MethodCallProxy implements AuxiliaryType {
    ...
    public static class AssignableSignatureCall extends StackManipulation.AbstractBase {
        ...
        public AssignableSignatureCall(Implementation.SpecialMethodInvocation specialMethodInvocation2, boolean z11) {
            this.specialMethodInvocation = specialMethodInvocation2;
            this.serializable = z11;
        }
    ...
    public static class MethodCall implements Implementation {
        ...
        public MethodCall(MethodDescription methodDescription, Assigner assigner2) {
    ...
    public MethodCallProxy(Implementation.SpecialMethodInvocation specialMethodInvocation2, boolean z11) {
        this(specialMethodInvocation2, z11, Assigner.DEFAULT);
    }
    ...
    private static LinkedHashMap<String, TypeDescription> extractFields(MethodDescription methodDescription) {
        ...
        while (it.hasNext()) {
            linkedHashMap.put(fieldName(i11), ((ParameterDescription) it.next()).getType().asErasure());
            i11++;
        }
    ...
    public MethodCallProxy(Implementation.SpecialMethodInvocation specialMethodInvocation2, boolean z11, Assigner assigner2) {
        this.specialMethodInvocation = specialMethodInvocation2;
