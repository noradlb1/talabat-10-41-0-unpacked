...
public class TypeProxy implements AuxiliaryType {
    ...
    public static class ForDefaultMethod extends StackManipulation.AbstractBase {
        ...
        public ForDefaultMethod(TypeDescription typeDescription, Implementation.Target target, boolean z11) {
    ...
    public static class ForSuperMethodByConstructor extends StackManipulation.AbstractBase {
        ...
        public ForSuperMethodByConstructor(TypeDescription typeDescription, Implementation.Target target, List<TypeDescription> list, boolean z11, boolean z12) {
            this.proxiedType = typeDescription;
            this.implementationTarget = target;
            this.constructorParameters = list;
            this.ignoreFinalizer = z11;
            this.serializableProxy = z12;
        }
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context context) {
            ...
            for (TypeDescription of2 : this.constructorParameters) {
                stackManipulationArr[i11] = DefaultValue.of(of2);
                i11++;
            }
            Duplication duplication = Duplication.SINGLE;
    ...
    public static class ForSuperMethodByReflectionFactory extends StackManipulation.AbstractBase {
        ...
        public ForSuperMethodByReflectionFactory(TypeDescription typeDescription, Implementation.Target target, boolean z11, boolean z12) {
            this.proxiedType = typeDescription;
            this.implementationTarget = target;
            this.ignoreFinalizer = z11;
            this.serializableProxy = z12;
    ...
    public class MethodCall implements Implementation {
        ...
        public class Appender implements ByteCodeAppender {
            ...
            public class AccessorMethodInvocation implements StackManipulation {
                ...
                public AccessorMethodInvocation(MethodDescription methodDescription, Implementation.SpecialMethodInvocation specialMethodInvocation2) {
        ...
        public MethodCall(MethodAccessorFactory methodAccessorFactory2) {
    ...
    public TypeProxy(TypeDescription typeDescription, Implementation.Target target, InvocationFactory invocationFactory2, boolean z11, boolean z12) {
        this.proxiedType = typeDescription;
        this.implementationTarget = target;
