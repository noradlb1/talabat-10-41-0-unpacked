...
public class HashCodeMethod implements Implementation {
    ...
    public static class Appender implements ByteCodeAppender {
        ...
        public Appender(StackManipulation stackManipulation, int i11, List<FieldDescription.InDefinedShape> list, ElementMatcher<? super FieldDescription.InDefinedShape> elementMatcher) {
    ...
    public interface OffsetProvider {
        ...
        public enum ForStaticTypeHash implements OffsetProvider {
            ...
            public StackManipulation resolve(TypeDescription typeDescription) {
                return new StackManipulation.Compound(ClassConstant.of(typeDescription), MethodInvocation.invoke(HashCodeMethod.HASH_CODE).virtual(TypeDescription.CLASS));
            }
        }
    ...
    public HashCodeMethod(OffsetProvider offsetProvider2) {
    ...
    public static HashCodeMethod usingOffset(int i11) {
        return new HashCodeMethod(new OffsetProvider.ForFixedValue(i11));
    }
    ...
    public static HashCodeMethod usingTypeHashOffset(boolean z11) {
        return new HashCodeMethod(z11 ? OffsetProvider.ForDynamicTypeHash.INSTANCE : OffsetProvider.ForStaticTypeHash.INSTANCE);
    }
    ...
    public Implementation withMultiplier(int i11) {
        if (i11 != 0) {
            return new HashCodeMethod(this.offsetProvider, i11, this.ignored, this.nonNullable);
        }
    ...
    private HashCodeMethod(OffsetProvider offsetProvider2, int i11, ElementMatcher.Junction<? super FieldDescription.InDefinedShape> junction, ElementMatcher.Junction<? super FieldDescription.InDefinedShape> junction2) {
