    ...
    public enum ForInstrumentedType implements TypeAttributeAppender {
        ...
        public static class Differentiating implements TypeAttributeAppender {
            ...
            public void apply(ClassVisitor classVisitor, TypeDescription typeDescription, AnnotationValueFilter annotationValueFilter) {
                ...
                int i11 = this.interfaceTypeIndex;
                for (TypeDescription.Generic accept : (TypeList.Generic) interfaces.subList(i11, interfaces.size())) {
                    annotationAppender = (AnnotationAppender) accept.accept(AnnotationAppender.ForTypeAnnotations.ofInterfaceType(annotationAppender, annotationValueFilter, i11));
                    i11++;
                }
            ...
            public Differentiating(int i11, int i12, int i13) {
                this.annotationIndex = i11;
                this.typeVariableIndex = i12;
                this.interfaceTypeIndex = i13;
            }
        }
        ...
        public void apply(ClassVisitor classVisitor, TypeDescription typeDescription, AnnotationValueFilter annotationValueFilter) {
            ...
            for (TypeDescription.Generic accept : typeDescription.getInterfaces()) {
                ofTypeVariable = (AnnotationAppender) accept.accept(AnnotationAppender.ForTypeAnnotations.ofInterfaceType(ofTypeVariable, annotationValueFilter, i11));
                i11++;
            }
