...
public interface MethodAttributeAppender {
    ...
    public static class Explicit implements MethodAttributeAppender, Factory {
        ...
        public interface Target {
            ...
            public static class OnMethodParameter implements Target {
                ...
                public OnMethodParameter(int i11) {
        ...
        public Explicit(int i11, List<? extends AnnotationDescription> list) {
            this((Target) new Target.OnMethodParameter(i11), list);
        }
        ...
        public Explicit(Target target2, List<? extends AnnotationDescription> list) {
            this.target = target2;
    ...
    public enum ForInstrumentedMethod implements MethodAttributeAppender, Factory {
        EXCLUDING_RECEIVER {
            public AnnotationAppender a(AnnotationAppender annotationAppender, AnnotationValueFilter annotationValueFilter, MethodDescription methodDescription) {
        ...
        public void apply(MethodVisitor methodVisitor, MethodDescription methodDescription, AnnotationValueFilter annotationValueFilter) {
            ...
            AnnotationAppender a11 = a(ofTypeVariable, annotationValueFilter, methodDescription);
            for (TypeDescription.Generic accept : methodDescription.getExceptionTypes()) {
                a11 = (AnnotationAppender) accept.accept(AnnotationAppender.ForTypeAnnotations.ofExceptionType(a11, annotationValueFilter, i11));
                i11++;
            }
        }
