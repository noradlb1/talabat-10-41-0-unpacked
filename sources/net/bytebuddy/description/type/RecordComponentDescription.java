...
public interface RecordComponentDescription extends DeclaredByType, NamedElement.WithDescriptor, AnnotationSource, ByteCodeElement.TypeDependant<InDefinedShape, Token> {
    ...
    public static class ForLoadedRecordComponent extends InDefinedShape.AbstractBase {
        ...
        public static final RecordComponent f27117b = ((RecordComponent) doPrivileged(JavaDispatcher.of(RecordComponent.class)));
        ...
        public String getActualName() {
            return f27117b.getName(this.recordComponent);
        }
        ...
        public String getGenericSignature() {
            return f27117b.getGenericSignature(this.recordComponent);
        }
        ...
        public MethodDescription.InDefinedShape getAccessor() {
            return new MethodDescription.ForLoadedMethod(f27117b.getAccessor(this.recordComponent));
        }

        public TypeDescription getDeclaringType() {
            return TypeDescription.ForLoadedType.of(f27117b.getDeclaringRecord(this.recordComponent));
        }
    }
    ...
    public static class Latent extends InDefinedShape.AbstractBase {
        ...
        private final String f27118name;
    ...
    public static class Token implements ByteCodeElement.Token<Token> {
        ...
        /* renamed from: name  reason: collision with root package name */
        private final String f27119name;
        private final TypeDescription.Generic type;
        ...
        public boolean equals(Object obj) {
            ...
            if (!this.f27119name.equals(token.f27119name) || !this.type.equals(token.type) || !this.annotations.equals(token.annotations)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            if (this.hashCode != 0) {
                ...
                i11 = (((this.f27119name.hashCode() * 31) + this.type.hashCode()) * 31) + this.annotations.hashCode();
            }
            if (i11 == 0) {
        ...
        public Token accept(TypeDescription.Generic.Visitor<? extends TypeDescription.Generic> visitor) {
            return new Token(this.f27119name, (TypeDescription.Generic) this.type.accept(visitor), this.annotations);
        }
    }
