...
public interface TypeList extends FilterableList<TypeDescription, TypeList> {
    ...
    public static abstract class AbstractBase extends FilterableList.AbstractBase<TypeDescription, TypeList> implements TypeList {
        ...
        public String[] toInternalNames() {
            ...
            int i11 = 0;
            while (it.hasNext()) {
                strArr[i11] = ((TypeDescription) it.next()).getInternalName();
                i11++;
            }
            if (size == 0) {
    ...
    public static class Explicit extends AbstractBase {
        ...
        public TypeDescription get(int i11) {
            return (TypeDescription) this.typeDescriptions.get(i11);
        }
    }
    ...
    public static class ForLoadedTypes extends AbstractBase {
        ...
        public String[] toInternalNames() {
            ...
            for (Class internalName : this.types) {
                strArr[i11] = Type.getInternalName(internalName);
                i11++;
            }
            if (size == 0) {
                return TypeList.NO_INTERFACES;
        ...
        public TypeDescription get(int i11) {
            return TypeDescription.ForLoadedType.of((Class) this.types.get(i11));
        }
    }
    ...
    public interface Generic extends FilterableList<TypeDescription.Generic, Generic> {
        ...
        public static abstract class AbstractBase extends FilterableList.AbstractBase<TypeDescription.Generic, Generic> implements Generic {
            ...
            public int getStackSize() {
                ...
                int i11 = 0;
                while (it.hasNext()) {
                    i11 += ((TypeDescription.Generic) it.next()).getStackSize().getSize();
                }
                return i11;
            }
        }
        ...
        public static class Explicit extends AbstractBase {
            ...
            public TypeDescription.Generic get(int i11) {
                return ((TypeDefinition) this.typeDefinitions.get(i11)).asGenericType();
            }
        }
        ...
        public static class ForDetachedTypes extends AbstractBase {
            ...
            public static class OfTypeVariables extends AbstractBase {
                ...
                public static class AttachedTypeVariable extends TypeDescription.Generic.OfTypeVariable {
                    ...
                    public AttachedTypeVariable(TypeVariableSource typeVariableSource2, TypeVariableToken typeVariableToken2, TypeDescription.Generic.Visitor<? extends TypeDescription.Generic> visitor2) {
                ...
                public TypeDescription.Generic get(int i11) {
                    return new AttachedTypeVariable(this.typeVariableSource, (TypeVariableToken) this.detachedTypeVariables.get(i11), this.visitor);
                }
            }
            ...
            public static class WithResolvedErasure extends AbstractBase {
                ...
                public TypeDescription.Generic get(int i11) {
                    return new TypeDescription.Generic.LazyProjection.WithResolvedErasure((TypeDescription.Generic) this.detachedTypes.get(i11), this.visitor);
                }
            }
            ...
            public TypeDescription.Generic get(int i11) {
                return (TypeDescription.Generic) ((TypeDescription.Generic) this.detachedTypes.get(i11)).accept(this.visitor);
            }
        ...
        public static class ForLoadedTypes extends AbstractBase {
            ...
            public static class OfTypeVariables extends AbstractBase {
                ...
                public TypeDescription.Generic get(int i11) {
                    TypeVariable typeVariable = this.typeVariables.get(i11);
                    return TypeDefinition.Sort.a(typeVariable, new TypeDescription.Generic.AnnotationReader.Delegator.ForLoadedTypeVariable(typeVariable));
                }
            }
            ...
            public TypeDescription.Generic get(int i11) {
                return TypeDefinition.Sort.describe((java.lang.reflect.Type) this.types.get(i11));
            }
        }
        ...
        public static class OfConstructorExceptionTypes extends AbstractBase {
            ...
            public static class TypeProjection extends TypeDescription.Generic.LazyProjection.WithEagerNavigation.OfAnnotatedElement {
                ...
                public TypeDescription.Generic a() {
                    ...
                    if (this.resolved != null) {
                        ...
                        if (this.erasure.length == genericExceptionTypes.length) {
                            generic = TypeDefinition.Sort.a(genericExceptionTypes[this.index], b());
                        } else {
                            generic = asRawType();
                        }
                    }
                ...
                public TypeDescription.Generic.AnnotationReader b() {
                ...
                private TypeProjection(Constructor<?> constructor2, int i11, Class<?>[] clsArr) {
            ...
            public TypeDescription.Generic get(int i11) {
                ...
                return new TypeProjection(constructor2, i11, constructor2.getExceptionTypes());
            }
        }
        ...
        public static class OfLoadedInterfaceTypes extends AbstractBase {
            ...
            public static class TypeProjection extends TypeDescription.Generic.LazyProjection.WithLazyNavigation.OfAnnotatedElement {
                ...
                public TypeDescription.Generic a() {
                    ...
                    if (this.resolved != null) {
                        ...
                        if (this.erasure.length == genericInterfaces.length) {
                            generic = TypeDefinition.Sort.a(genericInterfaces[this.index], b());
                        } else {
                            generic = asRawType();
                        }
                    }
                ...
                private TypeProjection(Class<?> cls, int i11, Class<?>[] clsArr) {
                    this.type = cls;
                    this.index = i11;
                    this.erasure = clsArr;
                }
            ...
            public TypeDescription.Generic get(int i11) {
                Class<?> cls = this.type;
                return new TypeProjection(cls, i11, cls.getInterfaces());
            }
        }
        ...
        public static class OfMethodExceptionTypes extends AbstractBase {
            ...
            public static class TypeProjection extends TypeDescription.Generic.LazyProjection.WithEagerNavigation.OfAnnotatedElement {
                ...
                public TypeProjection(Method method2, int i11, Class<?>[] clsArr) {
                    this.method = method2;
                    this.index = i11;
                    this.erasure = clsArr;
                }
            ...
            public TypeDescription.Generic get(int i11) {
                ...
                return new TypeProjection(method2, i11, method2.getExceptionTypes());
            }
        }
