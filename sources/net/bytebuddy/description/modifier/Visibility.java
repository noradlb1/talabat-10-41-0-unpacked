...
public enum Visibility implements ModifierContributor.ForType, ModifierContributor.ForMethod, ModifierContributor.ForField {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        public static final /* synthetic */ int[] f27115a = null;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f27115a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f27115a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f27115a     // Catch:{ NoSuchFieldError -> 0x0033 }
    ...
    public Visibility expandTo(Visibility visibility) {
        int i11 = AnonymousClass1.f27115a[visibility.ordinal()];
        if (i11 == 1) {
            return PUBLIC;
        }
        if (i11 == 2) {
