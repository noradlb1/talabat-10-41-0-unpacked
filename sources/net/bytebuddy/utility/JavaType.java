...
public enum JavaType {
    CONSTABLE("java.lang.constant.Constable", 1537, (String) r15, (int) new TypeDefinition[0]),
    TYPE_DESCRIPTOR("java.lang.invoke.TypeDescriptor", 1537, (String) r13, (int) new TypeDefinition[0]),
    TYPE_DESCRIPTOR_OF_FIELD("java.lang.invoke.TypeDescriptor$OfField", 1537, (String) r13, (int) new TypeDefinition[]{r8.getTypeStub()}),
    TYPE_DESCRIPTOR_OF_METHOD("java.lang.invoke.TypeDescriptor$OfMethod", 1537, (String) r13, (int) new TypeDefinition[]{r8.getTypeStub()}),
    CONSTANT_DESCRIPTION("java.lang.constant.ConstantDesc", 1537, (String) r13, (int) new TypeDefinition[0]),
    DYNAMIC_CONSTANT_DESCRIPTION("java.lang.constant.DynamicConstantDesc", 1025, (String) r23, (int) new TypeDefinition[]{r8.getTypeStub()}),
    CLASS_DESCRIPTION("java.lang.constant.ClassDesc", 1537, (String) r15, (int) new TypeDefinition[]{r8.getTypeStub(), r8.getTypeStub()}),
    METHOD_TYPE_DESCRIPTION("java.lang.constant.MethodTypeDesc", 1537, (String) r13, (int) new TypeDefinition[]{r8.getTypeStub(), r8.getTypeStub()}),
    METHOD_HANDLE_DESCRIPTION("java.lang.constant.MethodHandleDesc", 1537, (String) r13, (int) new TypeDefinition[]{r8.getTypeStub()}),
    DIRECT_METHOD_HANDLE_DESCRIPTION("java.lang.constant.DirectMethodHandleDesc", 1537, (String) r13, (int) new TypeDefinition[]{r8.getTypeStub()}),
    METHOD_HANDLE("java.lang.invoke.MethodHandle", 1025, (String) r23, (int) new TypeDefinition[]{r0.getTypeStub()}),
    METHOD_HANDLES("java.lang.invoke.MethodHandles", 1, (String) Object.class, (int) new Type[0]),
    METHOD_TYPE("java.lang.invoke.MethodType", 17, (String) r23, (int) new TypeDefinition[]{r0.getTypeStub(), r8.getTypeStub(), TypeDescription.ForLoadedType.of(Serializable.class)}),
    ...
    VAR_HANDLE("java.lang.invoke.VarHandle", 1025, (String) TypeDescription.Generic.OBJECT, (int) new TypeDefinition[]{r0.getTypeStub()}),
    PARAMETER("java.lang.reflect.Parameter", 17, (String) Object.class, (int) new Type[]{r8}),
    ...
    MODULE("java.lang.Module", 17, (String) Object.class, (int) new Type[]{r8}),
    ...
    ACCESS_CONTROL_CONTEXT("java.security.AccessControlContext", 17, (String) r15, (int) new TypeDefinition[0]);
    
    private final TypeDescription typeDescription;

    public static class LatentTypeWithSimpleName extends TypeDescription.Latent {
        public LatentTypeWithSimpleName(String str, int i11, TypeDescription.Generic generic, List<? extends TypeDescription.Generic> list) {
            super(str, i11, generic, list);
        }

        public String getSimpleName() {
            String name2 = getName();
            int max = Math.max(name2.lastIndexOf(36), name2.lastIndexOf(46));
            if (max == -1) {
                return name2;
            }
            return name2.substring(max + 1);
        }
    }
    ...
    private JavaType(String str, int i11, TypeDescription.Generic generic, TypeList.Generic generic2) {
        this.typeDescription = new LatentTypeWithSimpleName(str, i11, generic, generic2);
    }
}
