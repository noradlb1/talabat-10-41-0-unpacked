...
public final class ElementMatchers {
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isGetter() {
        return takesNoArguments().and(not(returns(TypeDescription.VOID))).and(nameStartsWith("get").or(nameStartsWith("is").and(returnsGeneric((ElementMatcher<? super TypeDescription.Generic>) anyOf(Boolean.TYPE, Boolean.class)))));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> isMain() {
        return named("main").and(takesArguments((Class<?>[]) new Class[]{String[].class})).and(returns(TypeDescription.VOID).and(isStatic()).and(isPublic()));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesArgument(int i11, Class<?> cls) {
        return takesArgument(i11, TypeDescription.ForLoadedType.of(cls));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesGenericArgument(int i11, Type type) {
        return takesGenericArgument(i11, TypeDefinition.Sort.describe(type));
    }
    ...
    public static <T> ElementMatcher.Junction<T> cached(ElementMatcher<? super T> elementMatcher, int i11) {
        if (i11 >= 1) {
            return new CachingMatcher.WithInlineEviction(elementMatcher, new ConcurrentHashMap(), i11);
        }
        throw new IllegalArgumentException("Eviction size must be a positive number: " + i11);
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesArgument(int i11, TypeDescription typeDescription) {
        return takesArgument(i11, (ElementMatcher<? super TypeDescription>) is((Object) typeDescription));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesGenericArgument(int i11, TypeDescription.Generic generic) {
        return takesGenericArgument(i11, (ElementMatcher<? super TypeDescription.Generic>) is((Object) generic));
    }
    ...
    public static <T extends Iterable<? extends TypeDescription.Generic>> ElementMatcher.Junction<T> erasures(Iterable<? extends TypeDescription> iterable) {
        ...
        for (TypeDescription is2 : iterable) {
            arrayList.add(is((Object) is2));
        }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesArgument(int i11, ElementMatcher<? super TypeDescription> elementMatcher) {
        return takesGenericArgument(i11, (ElementMatcher<? super TypeDescription.Generic>) erasure(elementMatcher));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesGenericArgument(int i11, ElementMatcher<? super TypeDescription.Generic> elementMatcher) {
        return takesGenericArguments((ElementMatcher<? super Iterable<? extends TypeDescription.Generic>>) new CollectionElementMatcher(i11, elementMatcher));
    }
    ...
    public static <T extends MethodDescription> ElementMatcher.Junction<T> takesArguments(int i11) {
        return new MethodParametersMatcher(new CollectionSizeMatcher(i11));
    }
