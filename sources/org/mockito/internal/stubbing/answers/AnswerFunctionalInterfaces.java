...
public class AnswerFunctionalInterfaces {
    ...
    public static <T, A, B, C, D, E, F> Answer<T> toAnswer(final Answer6<T, A, B, C, D, E, F> answer6) {
        return new Answer<T>() {
            public T answer(InvocationOnMock invocationOnMock) throws Throwable {
                return Answer6.this.answer(invocationOnMock.getArgument(0), invocationOnMock.getArgument(1), invocationOnMock.getArgument(2), invocationOnMock.getArgument(3), invocationOnMock.getArgument(4), invocationOnMock.getArgument(5));
            }
        };
    }
    ...
    public static <A, B, C, D, E, F> Answer<Void> toAnswer(final VoidAnswer6<A, B, C, D, E, F> voidAnswer6) {
        return new Answer<Void>() {
            public Void answer(InvocationOnMock invocationOnMock) throws Throwable {
                VoidAnswer6.this.answer(invocationOnMock.getArgument(0), invocationOnMock.getArgument(1), invocationOnMock.getArgument(2), invocationOnMock.getArgument(3), invocationOnMock.getArgument(4), invocationOnMock.getArgument(5));
                return null;
            }
        };
    }
