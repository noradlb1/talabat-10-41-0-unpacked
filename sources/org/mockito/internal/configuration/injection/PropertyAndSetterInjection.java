...
public class PropertyAndSetterInjection extends MockInjectionStrategy {
    ...
    private FieldInitializationReport initializeInjectMocksField(Field field, Object obj) {
        try {
            ...
            throw Reporter.cannotInitializeForInjectMocksAnnotation(field.getName(), e11.getMessage());
        }
    }
    ...
    private boolean injectMockCandidatesOnFields(Set<Object> set, Object obj, boolean z11, List<Field> list) {
    ...
    public boolean processInjection(Field field, Object obj, Set<Object> set) {
        ...
        for (Class fieldClass = initializeInjectMocksField.fieldClass(); fieldClass != Object.class; fieldClass = fieldClass.getSuperclass()) {
            z11 |= injectMockCandidates(fieldClass, fieldInstance, Sets.newMockSafeHashSet((Iterable<Object>) set));
        }
        return z11;
    }
}
