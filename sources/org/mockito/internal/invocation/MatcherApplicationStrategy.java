...
public class MatcherApplicationStrategy {
    ...
    private static List<ArgumentMatcher<?>> appendLastMatcherNTimes(List<ArgumentMatcher<?>> list, int i11) {
    ...
    public boolean forEachMatcherAndArgument(ArgumentMatcherAction argumentMatcherAction) {
        ...
        for (int i11 = 0; i11 < arguments.length; i11++) {
            if (!argumentMatcherAction.apply(this.matchers.get(i11), arguments[i11])) {
                return false;
            }
        }
        return true;
