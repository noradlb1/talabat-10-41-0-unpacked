...
public final class VerificationStartedNotifier {
    ...
    public static class Event implements VerificationStartedEvent {
        ...
        public void setMock(Object obj) {
            if (obj == null) {
                ...
                VerificationStartedNotifier.a(obj, this.originalMockingDetails.getMockCreationSettings());
                this.mock = obj;
            } else {
    ...
    public static void a(Object obj, MockCreationSettings mockCreationSettings) {
