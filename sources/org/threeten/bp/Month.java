...
public enum Month implements TemporalAccessor, TemporalAdjuster {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        public static final /* synthetic */ int[] f63319a = null;
    ...
    public static Month from(TemporalAccessor temporalAccessor) {
        ...
        try {
            ...
            throw new DateTimeException("Unable to obtain Month from TemporalAccessor: " + temporalAccessor + ", type " + temporalAccessor.getClass().getName(), e11);
        }
    }
    ...
    public int firstDayOfYear(boolean z11) {
        switch (AnonymousClass2.f63319a[ordinal()]) {
            case 1:
                return 32;
            case 2:
                return (z11 ? 1 : 0) + true;
    ...
    public int length(boolean z11) {
        int i11 = AnonymousClass2.f63319a[ordinal()];
