...
public final class OffsetTime extends DefaultInterfaceTemporalAccessor implements Temporal, TemporalAdjuster, Comparable<OffsetTime>, Serializable {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f63322a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f63322a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f63322a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f63322a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f63322a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f63322a     // Catch:{ NoSuchFieldError -> 0x0054 }
    ...
    public static OffsetTime ofInstant(Instant instant, ZoneId zoneId) {
        ...
        return new OffsetTime(LocalTime.a(epochSecond, instant.getNano()), offset2);
    }
    ...
    public long until(Temporal temporal, TemporalUnit temporalUnit) {
        ...
        switch (AnonymousClass2.f63322a[((ChronoUnit) temporalUnit).ordinal()]) {
            case 1:
                return epochNano;
            case 2:
    ...
    public OffsetTime minus(long j11, TemporalUnit temporalUnit) {
        return j11 == Long.MIN_VALUE ? plus(Long.MAX_VALUE, temporalUnit).plus(1, temporalUnit) : plus(-j11, temporalUnit);
    }

    public OffsetTime plus(long j11, TemporalUnit temporalUnit) {
        if (temporalUnit instanceof ChronoUnit) {
            return with(this.time.plus(j11, temporalUnit), this.offset);
        }
        return (OffsetTime) temporalUnit.addTo(this, j11);
    }
    ...
    public OffsetTime with(TemporalField temporalField, long j11) {
        if (!(temporalField instanceof ChronoField)) {
            return (OffsetTime) temporalField.adjustInto(this, j11);
        }
        if (temporalField == ChronoField.OFFSET_SECONDS) {
            return with(this.time, ZoneOffset.ofTotalSeconds(((ChronoField) temporalField).checkValidIntValue(j11)));
        }
        return with(this.time.with(temporalField, j11), this.offset);
    }
}
