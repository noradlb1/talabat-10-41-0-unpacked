...
public final class JapaneseEra extends DefaultInterfaceEra implements Serializable {
    ...
    private final transient String f63341name;
    ...
    private JapaneseEra(int i11, LocalDate localDate, String str) {
        this.eraValue = i11;
    ...
    public static JapaneseEra c(DataInput dataInput) throws IOException {
        return of(dataInput.readByte());
    }

    public static JapaneseEra of(int i11) {
        JapaneseEra[] japaneseEraArr = KNOWN_ERAS.get();
        if (i11 >= MEIJI.eraValue && i11 <= japaneseEraArr[japaneseEraArr.length - 1].eraValue) {
            return japaneseEraArr[ordinal(i11)];
        }
        throw new DateTimeException("japaneseEra is invalid");
    }

    private static int ordinal(int i11) {
        return i11 + 1;
    }
    ...
    public static JapaneseEra registerEra(LocalDate localDate, String str) {
        ...
        if (japaneseEraArr.length <= 5) {
            ...
            if (localDate.isAfter(REIWA.since)) {
                ...
                if (b.a(atomicReference, japaneseEraArr, japaneseEraArr2)) {
                    return japaneseEra;
                }
    ...
    public static JapaneseEra valueOf(String str) {
        ...
        for (JapaneseEra japaneseEra : KNOWN_ERAS.get()) {
            if (str.equals(japaneseEra.f63341name)) {
                return japaneseEra;
            }
        }
    ...
    public LocalDate a() {
        ...
        return values[ordinal + 1].d().minusDays(1);
    }
