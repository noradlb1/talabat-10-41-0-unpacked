...
public final class ThaiBuddhistChronology extends Chronology implements Serializable {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f63344a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f63344a     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    public boolean isLeapYear(long j11) {
        return IsoChronology.INSTANCE.isLeapYear(j11 - 543);
    }
    ...
    public ValueRange range(ChronoField chronoField) {
        int i11 = AnonymousClass1.f63344a[chronoField.ordinal()];
        if (i11 == 1) {
    ...
    public ThaiBuddhistDate dateEpochDay(long j11) {
        return new ThaiBuddhistDate(LocalDate.ofEpochDay(j11));
    }

    public ThaiBuddhistEra eraOf(int i11) {
    ...
    public ThaiBuddhistDate resolveDate(Map<TemporalField, Long> map, ResolverStyle resolverStyle) {
        ...
        if (map.containsKey(chronoField14)) {
            ...
            ThaiBuddhistDate d11 = date(checkValidIntValue9, 1, 1).a((long) (((chronoField13.checkValidIntValue(map.remove(chronoField13).longValue()) - 1) * 7) + (chronoField14.checkValidIntValue(map.remove(chronoField14).longValue()) - 1)));
    ...
    public ThaiBuddhistDate dateYearDay(Era era, int i11, int i12) {
        return (ThaiBuddhistDate) super.dateYearDay(era, i11, i12);
    }

    public ThaiBuddhistDate date(Era era, int i11, int i12, int i13) {
        return (ThaiBuddhistDate) super.date(era, i11, i12, i13);
    }
    ...
    public ThaiBuddhistDate dateYearDay(int i11, int i12) {
        return new ThaiBuddhistDate(LocalDate.ofYearDay(i11 - 543, i12));
    }

    public ThaiBuddhistDate date(int i11, int i12, int i13) {
        return new ThaiBuddhistDate(LocalDate.of(i11 - 543, i12, i13));
    }
