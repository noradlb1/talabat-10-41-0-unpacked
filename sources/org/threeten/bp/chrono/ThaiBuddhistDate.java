...
public final class ThaiBuddhistDate extends ChronoDateImpl<ThaiBuddhistDate> {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f63345a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f63345a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f63345a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f63345a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f63345a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f63345a     // Catch:{ NoSuchFieldError -> 0x0054 }
    ...
    public static ThaiBuddhistDate of(int i11, int i12, int i13) {
        return ThaiBuddhistChronology.INSTANCE.date(i11, i12, i13);
    }
    ...
    /* renamed from: d */
    public ThaiBuddhistDate a(long j11) {
        return with(this.isoDate.plusDays(j11));
    }

    /* renamed from: e */
    public ThaiBuddhistDate b(long j11) {
    ...
    /* renamed from: f */
    public ThaiBuddhistDate c(long j11) {
    ...
    public long getLong(TemporalField temporalField) {
        ...
        int i11 = AnonymousClass1.f63345a[((ChronoField) temporalField).ordinal()];
        int i12 = 1;
        if (i11 == 4) {
    ...
    public ValueRange range(TemporalField temporalField) {
        ...
        if (isSupported(temporalField)) {
            ...
            int i11 = AnonymousClass1.f63345a[chronoField.ordinal()];
            ...
            if (getProlepticYear() <= 0) {
                j11 = (-(range.getMinimum() + 543)) + 1;
            } else {
                j11 = 543 + range.getMaximum();
            }
    ...
    public ThaiBuddhistDate minus(long j11, TemporalUnit temporalUnit) {
        return (ThaiBuddhistDate) super.minus(j11, temporalUnit);
    }
    ...
    public org.threeten.bp.chrono.ThaiBuddhistDate with(org.threeten.bp.temporal.TemporalField r8, long r9) {
        /*
            ...
            return r7
        L_0x0010:
            int[] r1 = org.threeten.bp.chrono.ThaiBuddhistDate.AnonymousClass1.f63345a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            r3 = 7
            r4 = 6
    ...
    public ThaiBuddhistDate plus(long j11, TemporalUnit temporalUnit) {
        return (ThaiBuddhistDate) super.plus(j11, temporalUnit);
    }
