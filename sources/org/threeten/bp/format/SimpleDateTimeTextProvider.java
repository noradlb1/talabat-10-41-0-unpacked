...
final class SimpleDateTimeTextProvider extends DateTimeTextProvider {
    ...
    public static final class LocaleStore {
        ...
        public String a(long j11, TextStyle textStyle) {
    ...
    /* access modifiers changed from: private */
    public static <A, B> Map.Entry<A, B> createEntry(A a11, B b11) {
        return new AbstractMap.SimpleImmutableEntry(a11, b11);
    }
    ...
    private String narrowDayOfWeek(int i11, String str, Locale locale) {
        if (locale.getLanguage().equals("zh") && locale.getCountry().equals(Profile.Country.CN)) {
            switch (i11) {
                case 1:
                    return "一";
                case 2:
    ...
    private String narrowMonth(int i11, String str, Locale locale) {
        if (locale.getLanguage().equals("zh") && locale.getCountry().equals(Profile.Country.CN)) {
            switch (i11) {
                case 1:
                    return "一";
    ...
    public String getText(TemporalField temporalField, long j11, TextStyle textStyle, Locale locale) {
        ...
        if (findStore instanceof LocaleStore) {
            return ((LocaleStore) findStore).a(j11, textStyle);
        }
        return null;
    }
    ...
    public Iterator<Map.Entry<String, Long>> getTextIterator(TemporalField temporalField, TextStyle textStyle, Locale locale) {
        Object findStore = findStore(temporalField, locale);
        if (findStore instanceof LocaleStore) {
            return ((LocaleStore) findStore).b(textStyle);
        }
        return null;
    }
}
