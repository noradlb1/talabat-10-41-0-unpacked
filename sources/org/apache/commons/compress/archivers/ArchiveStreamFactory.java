            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        throw new ArchiveException("IOException while reading tar signature", e11);
                    }
                } catch (IOException e12) {
                    throw new ArchiveException("IOException while reading dump signature", e12);
                }
            } catch (IOException e13) {
                throw new ArchiveException("IOException while reading signature.", e13);
            }
        } else {
