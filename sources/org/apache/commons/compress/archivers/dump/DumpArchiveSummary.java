...
public class DumpArchiveSummary {
    ...
    public DumpArchiveSummary(byte[] bArr, ZipEncoding zipEncoding) throws IOException {
        ...
        this.filesys = DumpArchiveUtil.a(zipEncoding, bArr, 696, 64).trim();
        this.devname = DumpArchiveUtil.a(zipEncoding, bArr, 760, 64).trim();
    ...
    public int hashCode() {
        ...
        int i12 = (int) (((long) i11) + (this.dumpDate * 31));
        String str2 = this.hostname;
        if (str2 != null) {
            i12 = (str2.hashCode() * 31) + 17;
        }
