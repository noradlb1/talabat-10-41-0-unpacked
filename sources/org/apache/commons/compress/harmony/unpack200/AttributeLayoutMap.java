...
public class AttributeLayoutMap {
    ...
    public void checkMap() throws Pack200Exception {
        ...
        while (true) {
            ...
            if (i11 < mapArr.length) {
                Collection values = mapArr[i11].values();
                ...
                int i12 = 0;
                while (i12 < list.size()) {
                    AttributeLayout attributeLayout = (AttributeLayout) list.get(i12);
                    i12++;
                    int i13 = i12;
                    while (true) {
                        if (i13 < list.size()) {
                            AttributeLayout attributeLayout2 = (AttributeLayout) list.get(i13);
    ...
    public AttributeLayout getAttributeLayout(String str, int i11) throws Pack200Exception {
        for (AttributeLayout attributeLayout : this.layouts[i11].values()) {
    ...
    public AttributeLayout getAttributeLayout(int i11, int i12) throws Pack200Exception {
        return (AttributeLayout) this.layouts[i12].get(Integer.valueOf(i11));
    }
}
