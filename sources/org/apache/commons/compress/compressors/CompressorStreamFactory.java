...
public class CompressorStreamFactory implements CompressorStreamProvider {
    ...
    public CompressorOutputStream createCompressorOutputStream(String str, OutputStream outputStream) throws CompressorException {
        ...
        try {
            ...
            throw new CompressorException("Could not create CompressorOutputStream", e11);
        }
    }
    ...
    @Deprecated
    public void setDecompressConcatenated(boolean z11) {
    ...
    public CompressorInputStream createCompressorInputStream(String str, InputStream inputStream, boolean z11) throws CompressorException {
        if (str == null || inputStream == null) {
            throw new IllegalArgumentException("Compressor name and stream must not be null.");
        }
        try {
            if (GZIP.equalsIgnoreCase(str)) {
                return new GzipCompressorInputStream(inputStream, z11);
            }
            if (BZIP2.equalsIgnoreCase(str)) {
                return new BZip2CompressorInputStream(inputStream, z11);
            }
            if ("br".equalsIgnoreCase(str)) {
                ...
                if (XZUtils.isXZCompressionAvailable()) {
                    return new XZCompressorInputStream(inputStream, z11, this.memoryLimitInKb);
                }
                ...
                if (LZ4_FRAMED.equalsIgnoreCase(str)) {
                    return new FramedLZ4CompressorInputStream(inputStream, z11);
                }
                CompressorStreamProvider compressorStreamProvider = getCompressorInputStreamProviders().get(toKey(str));
                if (compressorStreamProvider != null) {
                    return compressorStreamProvider.createCompressorInputStream(str, inputStream, z11);
                }
                throw new CompressorException("Compressor: " + str + " not found.");
            }
        } catch (IOException e11) {
    ...
    public CompressorStreamFactory(boolean z11, int i11) {
        this.decompressUntilEOF = Boolean.valueOf(z11);
        this.decompressConcatenated = z11;
        this.memoryLimitInKb = i11;
    }

    public CompressorStreamFactory(boolean z11) {
        this(z11, -1);
    }
}
