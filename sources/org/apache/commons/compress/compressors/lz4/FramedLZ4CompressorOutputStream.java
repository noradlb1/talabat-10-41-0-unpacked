...
public class FramedLZ4CompressorOutputStream extends CompressorOutputStream {
    ...
    public enum BlockSize {
        ...
        private BlockSize(int i11, int i12) {
            this.size = i11;
            this.index = i12;
        }
    ...
    public static class Parameters {
        ...
        public Parameters(BlockSize blockSize2, boolean z11, boolean z12, boolean z13) {
            this(blockSize2, z11, z12, z13, BlockLZ4CompressorOutputStream.createParameterBuilder().build());
        }

        public Parameters(BlockSize blockSize2, boolean z11, boolean z12, boolean z13, org.apache.commons.compress.compressors.lz77support.Parameters parameters) {
            this.blockSize = blockSize2;
            this.withContentChecksum = z11;
            this.withBlockChecksum = z12;
            this.withBlockDependency = z13;
    ...
    public void write(byte[] bArr, int i11, int i12) throws IOException {
        if (this.params.withContentChecksum) {
            this.contentHash.update(bArr, i11, i12);
        }
        int length = this.blockData.length;
        if (this.currentIndex + i12 > length) {
            flushBlock();
            while (i12 > length) {
                System.arraycopy(bArr, i11, this.blockData, 0, length);
                i11 += length;
                i12 -= length;
        ...
        System.arraycopy(bArr, i11, this.blockData, this.currentIndex, i12);
