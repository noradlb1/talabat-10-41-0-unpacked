...
public class ConstructorUtils {
        ...
        try {
            ...
            for (Constructor constructor3 : cls.getConstructors()) {
                if (ClassUtils.isAssignable(clsArr, (Class<?>[]) constructor3.getParameterTypes(), true) && (accessibleConstructor = getAccessibleConstructor(constructor3)) != null) {
                    MemberUtils.d(accessibleConstructor);
                    if (constructor2 == null || MemberUtils.a(accessibleConstructor.getParameterTypes(), constructor2.getParameterTypes(), clsArr) < 0) {
    ...
    public static <T> Constructor<T> getAccessibleConstructor(Constructor<T> constructor) {
        ...
        if (!MemberUtils.b(constructor) || !isAccessible(constructor.getDeclaringClass())) {
            return null;
        }
        return constructor;
    }
