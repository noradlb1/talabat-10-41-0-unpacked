...
public class DateFormatUtils {
    public static final FastDateFormat ISO_DATETIME_FORMAT = FastDateFormat.getInstance(DateConstants.DEFAULT_UTC_FORMAT);
    ...
    private static final TimeZone UTC_TIME_ZONE = DesugarTimeZone.getTimeZone("GMT");

    public static String format(long j11, String str) {
        return format(new Date(j11), str, (TimeZone) null, (Locale) null);
    }

    public static String formatUTC(long j11, String str) {
        return format(new Date(j11), str, UTC_TIME_ZONE, (Locale) null);
    }
    ...
    public static String formatUTC(long j11, String str, Locale locale) {
        return format(new Date(j11), str, UTC_TIME_ZONE, locale);
    }

    public static String format(long j11, String str, TimeZone timeZone) {
        return format(new Date(j11), str, timeZone, (Locale) null);
    }
    ...
    public static String format(long j11, String str, Locale locale) {
        return format(new Date(j11), str, (TimeZone) null, locale);
    }
    ...
    public static String format(long j11, String str, TimeZone timeZone, Locale locale) {
        return format(new Date(j11), str, timeZone, locale);
    }
