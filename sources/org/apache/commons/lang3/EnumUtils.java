...
public class EnumUtils {
    ...
    private static <E extends Enum<E>> Class<E> checkBitVectorable(Class<E> cls) {
        ...
        Validate.isTrue(z11, CANNOT_STORE_S_S_VALUES_IN_S_BITS, Integer.valueOf(enumArr.length), cls.getSimpleName(), 64);
        return cls;
    }
    ...
    public static <E extends Enum<E>> long[] generateBitVectors(Class<E> cls, Iterable<? extends E> iterable) {
        ...
        while (true) {
            ...
            Validate.isTrue(z11, NULL_ELEMENTS_NOT_PERMITTED, new Object[0]);
            noneOf.add(enumR);
        }
    ...
    public static <E extends Enum<E>> EnumSet<E> processBitVector(Class<E> cls, long j11) {
        checkBitVectorable(cls).getEnumConstants();
        return processBitVectors(cls, j11);
    }
