...
public class EntityArrays {
    ...
    static {
        ...
        strArr2[54] = new String[]{StringUtility.ELLIPSIZE, "&hellip;"};
        ...
        strArr2[106] = new String[]{"⊆", "&sube;"};
        strArr2[107] = new String[]{"⊇", "&supe;"};
        strArr2[108] = new String[]{"⊕", "&oplus;"};
        strArr2[109] = new String[]{"⊗", "&otimes;"};
        strArr2[110] = new String[]{"⊥", "&perp;"};
        strArr2[111] = new String[]{"⋅", "&sdot;"};
        strArr2[112] = new String[]{"⌈", "&lceil;"};
        strArr2[113] = new String[]{"⌉", "&rceil;"};
        strArr2[114] = new String[]{"⌊", "&lfloor;"};
        strArr2[115] = new String[]{"⌋", "&rfloor;"};
        strArr2[116] = new String[]{"〈", "&lang;"};
        strArr2[117] = new String[]{"〉", "&rang;"};
        strArr2[118] = new String[]{"◊", "&loz;"};
        strArr2[119] = new String[]{"♠", "&spades;"};
        strArr2[120] = new String[]{"♣", "&clubs;"};
        strArr2[121] = new String[]{"♥", "&hearts;"};
        strArr2[122] = new String[]{"♦", "&diams;"};
        strArr2[123] = new String[]{"Œ", "&OElig;"};
        strArr2[124] = new String[]{"œ", "&oelig;"};
        strArr2[125] = new String[]{"Š", "&Scaron;"};
        strArr2[126] = new String[]{"š", "&scaron;"};
        strArr2[127] = new String[]{"Ÿ", "&Yuml;"};
        strArr2[128] = new String[]{"ˆ", "&circ;"};
        strArr2[129] = new String[]{"˜", "&tilde;"};
        strArr2[130] = new String[]{" ", "&ensp;"};
        strArr2[131] = new String[]{" ", "&emsp;"};
        strArr2[132] = new String[]{" ", "&thinsp;"};
        strArr2[133] = new String[]{"‌", "&zwnj;"};
        strArr2[134] = new String[]{"‍", "&zwj;"};
        strArr2[135] = new String[]{"‎", "&lrm;"};
        strArr2[136] = new String[]{"‏", "&rlm;"};
        strArr2[137] = new String[]{"–", "&ndash;"};
        strArr2[138] = new String[]{"—", "&mdash;"};
        strArr2[139] = new String[]{"‘", "&lsquo;"};
        strArr2[140] = new String[]{"’", "&rsquo;"};
        strArr2[141] = new String[]{"‚", "&sbquo;"};
        strArr2[142] = new String[]{"“", "&ldquo;"};
        strArr2[143] = new String[]{"”", "&rdquo;"};
        strArr2[144] = new String[]{"„", "&bdquo;"};
        strArr2[145] = new String[]{"†", "&dagger;"};
        strArr2[146] = new String[]{"‡", "&Dagger;"};
        strArr2[147] = new String[]{"‰", "&permil;"};
        strArr2[148] = new String[]{"‹", "&lsaquo;"};
        strArr2[149] = new String[]{"›", "&rsaquo;"};
        strArr2[150] = new String[]{"€", "&euro;"};
        HTML40_EXTENDED_ESCAPE = strArr2;
        HTML40_EXTENDED_UNESCAPE = invert(strArr2);
        String[][] strArr3 = {new String[]{"\"", "&quot;"}, new String[]{ContainerUtils.FIELD_DELIMITER, "&amp;"}, new String[]{"<", "&lt;"}, new String[]{">", "&gt;"}};
    ...
    public static String[][] invert(String[][] strArr) {
        ...
        for (int i11 = 0; i11 < strArr.length; i11++) {
            strArr2[i11][0] = strArr[i11][1];
            strArr2[i11][1] = strArr[i11][0];
        }
        return strArr2;
    }
}
