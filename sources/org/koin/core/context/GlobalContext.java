...
public final class GlobalContext implements KoinContext {
    ...
    public void loadKoinModules(@NotNull Module module) {
        ...
        synchronized (this) {
            Koin.loadModules$default(INSTANCE.get(), CollectionsKt__CollectionsJVMKt.listOf(module), false, 2, (Object) null);
    ...
    public void unloadKoinModules(@NotNull Module module) {
        Intrinsics.checkNotNullParameter(module, "module");
        synchronized (this) {
            INSTANCE.get().unloadModules(CollectionsKt__CollectionsJVMKt.listOf(module));
            Unit unit = Unit.INSTANCE;
        }
    }

    @NotNull
    public KoinApplication startKoin(@NotNull Function1<? super KoinApplication, Unit> function1) {
