...
public final class ModuleExtKt {
    ...
    public static final /* synthetic */ <T extends Fragment> Pair<Module, InstanceFactory<T>> fragment(Module module, Qualifier qualifier) {
        ...
        ModuleExtKt$fragment$1 moduleExtKt$fragment$1 = new ModuleExtKt$fragment$1();
        StringQualifier rootScopeQualifier = ScopeRegistry.Companion.getRootScopeQualifier();
        Kind kind = Kind.Factory;
        List emptyList = CollectionsKt__CollectionsKt.emptyList();
        Intrinsics.reifiedOperationMarker(4, "T");
        BeanDefinition beanDefinition = new BeanDefinition(rootScopeQualifier, Reflection.getOrCreateKotlinClass(Object.class), qualifier, moduleExtKt$fragment$1, kind, emptyList);
    ...
    public static /* synthetic */ Pair fragment$default(Module module, Qualifier qualifier, Function2 function2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            qualifier = null;
        }
        Intrinsics.checkNotNullParameter(module, "<this>");
    ...
    public static final /* synthetic */ <T extends Fragment> Pair<Module, InstanceFactory<T>> fragment(Module module, Qualifier qualifier, Function2<? super Scope, ? super ParametersHolder, ? extends T> function2) {
        Intrinsics.checkNotNullParameter(module, "<this>");
        Intrinsics.checkNotNullParameter(function2, "definition");
        StringQualifier rootScopeQualifier = ScopeRegistry.Companion.getRootScopeQualifier();
        Kind kind = Kind.Factory;
    ...
    public static /* synthetic */ Pair fragment$default(Module module, Qualifier qualifier, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            qualifier = null;
        }
        Intrinsics.checkNotNullParameter(module, "<this>");
