...
class AssertThrows {
    ...
    public static <T extends Throwable> T a(Class<T> cls, Executable executable) {
        return assertThrows(cls, executable, (Object) null);
    }

    private static <T extends Throwable> T assertThrows(Class<T> cls, Executable executable, Object obj) {
        try {
            executable.execute();
    ...
    public static <T extends Throwable> T b(Class<T> cls, Executable executable, String str) {
        return assertThrows(cls, executable, str);
    }
    ...
    public static <T extends java.lang.Throwable> T c(java.lang.Class<T> r0, org.junit.jupiter.api.function.Executable r1, j$.util.function.Supplier<java.lang.String> r2) {
        /*
            java.lang.Throwable r0 = assertThrows(r0, r1, r2)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.junit.jupiter.api.AssertThrows.c(java.lang.Class, org.junit.jupiter.api.function.Executable, j$.util.function.Supplier):java.lang.Throwable");
    }
}
