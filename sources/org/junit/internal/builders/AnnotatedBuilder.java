...
public class AnnotatedBuilder extends RunnerBuilder {
    ...
    public Runner buildRunner(Class<? extends Runner> cls, Class<?> cls2) throws Exception {
        ...
        try {
            return (Runner) cls.getConstructor(new Class[]{cls3}).newInstance(new Object[]{cls2});
        } catch (NoSuchMethodException unused) {
            try {
                return (Runner) cls.getConstructor(new Class[]{cls3, RunnerBuilder.class}).newInstance(new Object[]{cls2, this.suiteBuilder});
