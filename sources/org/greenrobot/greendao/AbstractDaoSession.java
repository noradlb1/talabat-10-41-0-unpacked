...
public class AbstractDaoSession {
    ...
    private final Database f27860db;
    ...
    public AbstractDaoSession(Database database) {
        this.f27860db = database;
    }

    public <V> V callInTx(Callable<V> callable) throws Exception {
        this.f27860db.beginTransaction();
        try {
            V call = callable.call();
            this.f27860db.setTransactionSuccessful();
            return call;
        } finally {
            this.f27860db.endTransaction();
        }
    }
