...
public class MediaSessionCompat {
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (playbackStateCompat == null) {
                ...
                j11 = playbackStateCompat.getActions();
            }
            if ((j11 & 128) != 0) {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    if (i11 == 2) {
                        ...
                        i14 = volumeProviderCompat.getCurrentVolume();
                        i15 = maxVolume;
                        i13 = volumeControl;
                    } else {
                        i15 = mediaSessionImplBase.mAudioManager.getStreamMaxVolume(i12);
                        i14 = MediaSessionImplBase.this.mAudioManager.getStreamVolume(i12);
                    }
                }
                return new ParcelableVolumeInfo(i11, i12, i13, i15, i14);
            }
    ...
    public static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), j11, playbackStateCompat.getPlaybackSpeed(), elapsedRealtime).build();
    }
