...
public class SnackbarOnAnyDeniedMultiplePermissionsListener extends BaseMultiplePermissionsListener {
    ...
    public static class Builder {
        ...
        public static Builder with(View view2, @StringRes int i11) {
            return with(view2, view2.getContext().getString(i11));
        }
        ...
        public Builder withButton(@StringRes int i11, View.OnClickListener onClickListener2) {
            return withButton(this.view.getContext().getString(i11), onClickListener2);
        }
        ...
        public Builder withDuration(int i11) {
            this.duration = i11;
            return this;
        }

        public Builder withOpenSettingsButton(@StringRes int i11) {
            return withOpenSettingsButton(this.view.getContext().getString(i11));
        }
    ...
    private SnackbarOnAnyDeniedMultiplePermissionsListener(View view2, String str, String str2, View.OnClickListener onClickListener, Snackbar.Callback callback, int i11) {
        this.view = view2;
        this.text = str;
