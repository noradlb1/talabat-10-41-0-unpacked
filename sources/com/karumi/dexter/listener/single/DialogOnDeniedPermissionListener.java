...
public class DialogOnDeniedPermissionListener extends BasePermissionListener {
    ...
    public static class Builder {
        ...
        public Builder withButtonText(@StringRes int i11) {
            this.buttonText = this.context.getString(i11);
            return this;
        }
        ...
        public Builder withIcon(@DrawableRes int i11) {
            this.icon = this.context.getResources().getDrawable(i11);
            return this;
        }
        ...
        public Builder withMessage(@StringRes int i11) {
        ...
        public Builder withTitle(@StringRes int i11) {
