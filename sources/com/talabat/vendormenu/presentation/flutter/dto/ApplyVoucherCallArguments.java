...
public final class ApplyVoucherCallArguments {
    ...
    public static /* synthetic */ ApplyVoucherCallArguments copy$default(ApplyVoucherCallArguments applyVoucherCallArguments, double d11, String str, String str2, double d12, String str3, double d13, String str4, Bounds bounds2, int i11, Object obj) {
        ...
        int i12 = i11;
        return applyVoucherCallArguments.copy((i12 & 1) != 0 ? applyVoucherCallArguments2.discountValue : d11, (i12 & 2) != 0 ? applyVoucherCallArguments2.title : str, (i12 & 4) != 0 ? applyVoucherCallArguments2.f12445id : str2, (i12 & 8) != 0 ? applyVoucherCallArguments2.maxDiscountCap : d12, (i12 & 16) != 0 ? applyVoucherCallArguments2.voucherCode : str3, (i12 & 32) != 0 ? applyVoucherCallArguments2.minOrderValue : d13, (i12 & 64) != 0 ? applyVoucherCallArguments2.discountType : str4, (i12 & 128) != 0 ? applyVoucherCallArguments2.bounds : bounds2);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual((Object) Double.valueOf(this.discountValue), (Object) Double.valueOf(applyVoucherCallArguments.discountValue)) && Intrinsics.areEqual((Object) this.title, (Object) applyVoucherCallArguments.title) && Intrinsics.areEqual((Object) this.f12445id, (Object) applyVoucherCallArguments.f12445id) && Intrinsics.areEqual((Object) Double.valueOf(this.maxDiscountCap), (Object) Double.valueOf(applyVoucherCallArguments.maxDiscountCap)) && Intrinsics.areEqual((Object) this.voucherCode, (Object) applyVoucherCallArguments.voucherCode) && Intrinsics.areEqual((Object) Double.valueOf(this.minOrderValue), (Object) Double.valueOf(applyVoucherCallArguments.minOrderValue)) && Intrinsics.areEqual((Object) this.discountType, (Object) applyVoucherCallArguments.discountType) && Intrinsics.areEqual((Object) this.bounds, (Object) applyVoucherCallArguments.bounds);
    }
    ...
    public int hashCode() {
        int a11 = ((((((((((((Double.doubleToLongBits(this.discountValue) * 31) + this.title.hashCode()) * 31) + this.f12445id.hashCode()) * 31) + Double.doubleToLongBits(this.maxDiscountCap)) * 31) + this.voucherCode.hashCode()) * 31) + Double.doubleToLongBits(this.minOrderValue)) * 31) + this.discountType.hashCode()) * 31;
