...
public final class WalletCreditCardGetAllCardsItemLayoutBinding implements ViewBinding {
    @NonNull
    ...
    private WalletCreditCardGetAllCardsItemLayoutBinding(@NonNull ConstraintLayout constraintLayout, @NonNull TalabatRadioButton talabatRadioButton, @NonNull TextView textView, @NonNull ImageView imageView, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull View view, @NonNull ImageButton imageButton) {
    ...
    @NonNull
    public static WalletCreditCardGetAllCardsItemLayoutBinding bind(@NonNull View view) {
        int i11 = R.id.card_selected;
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            ...
                            if (findChildViewById != null) {
                                ...
                                if (imageButton != null) {
                                    return new WalletCreditCardGetAllCardsItemLayoutBinding((ConstraintLayout) view, talabatRadioButton, textView, imageView, textView2, textView3, findChildViewById, imageButton);
                                }
                            }
                        }
                    }
    ...
    @NonNull
    public static WalletCreditCardGetAllCardsItemLayoutBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    @NonNull
    public static WalletCreditCardGetAllCardsItemLayoutBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z11) {
        View inflate = layoutInflater.inflate(R.layout.wallet_credit_card_get_all_cards_item_layout, viewGroup, false);
        if (z11) {
