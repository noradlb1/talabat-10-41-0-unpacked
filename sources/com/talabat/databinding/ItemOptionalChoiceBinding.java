...
public final class ItemOptionalChoiceBinding implements ViewBinding {
    @NonNull
    ...
    private ItemOptionalChoiceBinding(@NonNull LinearLayout linearLayout, @NonNull ImageView imageView, @NonNull LinearLayout linearLayout2, @NonNull RecyclerView recyclerView, @NonNull TalabatTextView talabatTextView, @NonNull TalabatTextView talabatTextView2, @NonNull TalabatTextView talabatTextView3) {
    ...
    @NonNull
    public static ItemOptionalChoiceBinding bind(@NonNull View view) {
                    ...
                    if (talabatTextView != null) {
                        ...
                        if (talabatTextView2 != null) {
                            ...
                            if (talabatTextView3 != null) {
                                return new ItemOptionalChoiceBinding((LinearLayout) view, imageView, linearLayout, recyclerView, talabatTextView, talabatTextView2, talabatTextView3);
                            }
                        }
                    }
                }
    ...
    @NonNull
    public static ItemOptionalChoiceBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    @NonNull
    public static ItemOptionalChoiceBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z11) {
        View inflate = layoutInflater.inflate(R.layout.item_optional_choice, viewGroup, false);
        if (z11) {
