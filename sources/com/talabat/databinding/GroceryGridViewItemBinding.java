...
public final class GroceryGridViewItemBinding implements ViewBinding {
    @NonNull
    ...
    private GroceryGridViewItemBinding(@NonNull CardView cardView, @NonNull TalabatButton talabatButton, @NonNull LinearLayout linearLayout, @NonNull OffersTagBinding offersTagBinding, @NonNull RelativeLayout relativeLayout, @NonNull LinearLayout linearLayout2, @NonNull TalabatTextView talabatTextView, @NonNull ImageView imageView2, @NonNull TalabatTextView talabatTextView2, @NonNull TalabatTextView talabatTextView3, @NonNull LoadingIndicatorView loadingIndicatorView, @NonNull TalabatTextView talabatTextView4, @NonNull TalabatTextView talabatTextView5, @NonNull LinearLayout linearLayout3, @NonNull RelativeLayout relativeLayout2, @NonNull ProgressBar progressBar, @NonNull RelativeLayout relativeLayout3, @NonNull TalabatTextView talabatTextView6, @NonNull CardView cardView2, @NonNull LinearLayout linearLayout4) {
    ...
    @NonNull
    public static GroceryGridViewItemBinding bind(@NonNull View view) {
        View view2 = view;
    ...
    @NonNull
    public static GroceryGridViewItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    @NonNull
    public static GroceryGridViewItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z11) {
        View inflate = layoutInflater.inflate(R.layout.grocery_grid_view_item, viewGroup, false);
        if (z11) {
