...
public final class LoginMethodsDsGooglePriorityBinding implements ViewBinding {
    @NonNull
    ...
    private LoginMethodsDsGooglePriorityBinding(@NonNull LinearLayout linearLayout, @NonNull LoginButton loginButton, @NonNull DSBrandedButton dSBrandedButton, @NonNull DSFacebookBrandedButton dSFacebookBrandedButton, @NonNull DSGoogleBrandedButton dSGoogleBrandedButton, @NonNull DSBrandedButton dSBrandedButton2, @NonNull LinearLayout linearLayout2) {
    ...
    @NonNull
    public static LoginMethodsDsGooglePriorityBinding bind(@NonNull View view) {
                ...
                if (dSFacebookBrandedButton != null) {
                    ...
                    if (dSGoogleBrandedButton != null) {
                        ...
                        if (dSBrandedButton2 != null) {
                            ...
                            return new LoginMethodsDsGooglePriorityBinding(linearLayout, loginButton, dSBrandedButton, dSFacebookBrandedButton, dSGoogleBrandedButton, dSBrandedButton2, linearLayout);
                        }
                    }
                }
            }
    ...
    @NonNull
    public static LoginMethodsDsGooglePriorityBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    @NonNull
    public static LoginMethodsDsGooglePriorityBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z11) {
        View inflate = layoutInflater.inflate(R.layout.login_methods_ds_google_priority, viewGroup, false);
        if (z11) {
