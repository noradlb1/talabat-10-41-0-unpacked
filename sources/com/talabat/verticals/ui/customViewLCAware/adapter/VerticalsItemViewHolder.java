...
public final class VerticalsItemViewHolder extends RecyclerView.ViewHolder {
    ...
    public static final void m5941bindItem$lambda3(VerticalsItemViewHolder verticalsItemViewHolder, Vertical vertical, View view) {
        Intrinsics.checkNotNullParameter(verticalsItemViewHolder, "this$0");
        Intrinsics.checkNotNullParameter(vertical, "$vertical");
        verticalsItemViewHolder.getMListener().onItemCLicked(vertical.getDeeplink());
    }
    ...
    public final void bindItem(@NotNull Vertical vertical, @NotNull ItemCLickListener itemCLickListener) {
        ...
        this.itemView.setOnClickListener(new b(this, vertical));
    }
