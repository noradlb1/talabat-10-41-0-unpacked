...
public final class FwfRemoteConfigurationDataSource implements IRemoteConfigurationDataSource {
    ...
    public <T> Object getRemoteConfiguration(@NotNull FWFKey fWFKey, T t11, boolean z11, @NotNull Class<T> cls, @NotNull Continuation<? super T> continuation) {
        ...
        IFunWithFlags iFunWithFlags = this.funWithFlags;
        if (t11 != null) {
            iFunWithFlags.getVariation(fWFKey, t11, z11, new FwfRemoteConfigurationDataSource$getRemoteConfiguration$2$1(safeContinuation, this, t11, cls));
    ...
    public /* synthetic */ FwfRemoteConfigurationDataSource(IFunWithFlags iFunWithFlags, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public <T> void getRemoteConfiguration(@NotNull FWFKey fWFKey, T t11, boolean z11, @NotNull Class<T> cls, @NotNull Function1<? super T, Unit> function1) {
        ...
        IFunWithFlags iFunWithFlags = this.funWithFlags;
        if (t11 != null) {
            iFunWithFlags.getVariation(fWFKey, t11, z11, new FwfRemoteConfigurationDataSource$getRemoteConfiguration$3(function1, this, t11, cls));
            return;
        }
        throw new NullPointerException("null cannot be cast to non-null type kotlin.Any");
    }
