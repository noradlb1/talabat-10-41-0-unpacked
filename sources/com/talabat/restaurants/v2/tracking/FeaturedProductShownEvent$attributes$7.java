...
public final class FeaturedProductShownEvent$attributes$7 extends Lambda implements Function1<FeatureProductDisplayModel, CharSequence> {
    public static final FeaturedProductShownEvent$attributes$7 INSTANCE = new FeaturedProductShownEvent$attributes$7();

    public FeaturedProductShownEvent$attributes$7() {
        super(1);
    }
    ...
    public final CharSequence invoke(@NotNull FeatureProductDisplayModel featureProductDisplayModel) {
        ...
        return String.valueOf(featureProductDisplayModel.getVendor().branchId);
    }
}
