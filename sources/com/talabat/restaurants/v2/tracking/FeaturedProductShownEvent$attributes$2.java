...
public final class FeaturedProductShownEvent$attributes$2 extends Lambda implements Function1<FeatureProductDisplayModel, CharSequence> {
    public static final FeaturedProductShownEvent$attributes$2 INSTANCE = new FeaturedProductShownEvent$attributes$2();

    public FeaturedProductShownEvent$attributes$2() {
        super(1);
    }
    ...
    public final CharSequence invoke(@NotNull FeatureProductDisplayModel featureProductDisplayModel) {
        ...
        return String.valueOf(featureProductDisplayModel.getVendor().f13872id);
    }
}
