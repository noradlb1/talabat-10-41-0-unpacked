...
public final class FeaturedProductShownEvent$attributes$9 extends Lambda implements Function1<FeatureProductDisplayModel, CharSequence> {
    public static final FeaturedProductShownEvent$attributes$9 INSTANCE = new FeaturedProductShownEvent$attributes$9();

    public FeaturedProductShownEvent$attributes$9() {
        super(1);
    }
    ...
    public final CharSequence invoke(@NotNull FeatureProductDisplayModel featureProductDisplayModel) {
        ...
        return RestaurantsEventsKt.sponsoringData(featureProductDisplayModel.getVendor());
    }
}
