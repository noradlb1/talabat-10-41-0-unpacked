...
public final class FeaturedProductShownEvent$attributes$4 extends Lambda implements Function1<FeatureProductDisplayModel, CharSequence> {
    public static final FeaturedProductShownEvent$attributes$4 INSTANCE = new FeaturedProductShownEvent$attributes$4();

    public FeaturedProductShownEvent$attributes$4() {
        super(1);
    }
    ...
    public final CharSequence invoke(@NotNull FeatureProductDisplayModel featureProductDisplayModel) {
        ...
        return FeaturedProductShownEventKt.unitSalePrice(featureProductDisplayModel);
    }
}
