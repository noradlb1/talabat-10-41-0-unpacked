...
public final class FeaturedProductShownEvent$attributes$3 extends Lambda implements Function1<FeatureProductDisplayModel, CharSequence> {
    public static final FeaturedProductShownEvent$attributes$3 INSTANCE = new FeaturedProductShownEvent$attributes$3();

    public FeaturedProductShownEvent$attributes$3() {
        super(1);
    }
    ...
    public final CharSequence invoke(@NotNull FeatureProductDisplayModel featureProductDisplayModel) {
        ...
        return featureProductDisplayModel.getPrice();
    }
}
