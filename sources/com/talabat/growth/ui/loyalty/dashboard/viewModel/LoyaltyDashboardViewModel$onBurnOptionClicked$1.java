...
public final class LoyaltyDashboardViewModel$onBurnOptionClicked$1 extends Lambda implements Function1<Either<? extends Failure, ? extends BurnOptionDetailsNavigator.BurnOptionDetailsTarget>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ LoyaltyDashboardViewModel f60688g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LoyaltyDashboardViewModel$onBurnOptionClicked$1(LoyaltyDashboardViewModel loyaltyDashboardViewModel) {
        super(1);
        this.f60688g = loyaltyDashboardViewModel;
    }
    ...
    public final void invoke(@NotNull Either<? extends Failure, ? extends BurnOptionDetailsNavigator.BurnOptionDetailsTarget> either) {
        ...
        either.either(new Function1<Failure, Unit>(this.f60688g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                invoke((Failure) obj);
                return Unit.INSTANCE;
            }
        ...
        }, new Function1<BurnOptionDetailsNavigator.BurnOptionDetailsTarget, Unit>(this.f60688g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            ...
            public final void invoke(@NotNull BurnOptionDetailsNavigator.BurnOptionDetailsTarget burnOptionDetailsTarget) {
                ...
                ((LoyaltyDashboardViewModel) this.receiver).handleShouldShowBottomSheet(burnOptionDetailsTarget);
            }
        });
    }
}
