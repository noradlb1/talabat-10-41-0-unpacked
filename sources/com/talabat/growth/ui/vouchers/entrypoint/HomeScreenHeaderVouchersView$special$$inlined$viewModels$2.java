...
public final class HomeScreenHeaderVouchersView$special$$inlined$viewModels$2 extends Lambda implements Function0<ViewModelStore> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ View f60705g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HomeScreenHeaderVouchersView$special$$inlined$viewModels$2(View view) {
        super(0);
        this.f60705g = view;
    }
    ...
    public final ViewModelStore invoke() {
        ViewModelStoreOwner findViewTreeViewModelStoreOwner = ViewTreeViewModelKt.findViewTreeViewModelStoreOwner(this.f60705g);
