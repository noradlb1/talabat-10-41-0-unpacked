...
public final class RealConfigurationLocalRepository implements MutableConfigurationLocalRepository {
    ...
    public void setSelectedCountry(int i11) {
        this.selectedCountry = Country.Companion.from(i11);
    }
    ...
    public void setSelectedLanguage(@NotNull String str) {
        ...
        this.selectedLanguage = Language.Companion.from(str);
    }
}
