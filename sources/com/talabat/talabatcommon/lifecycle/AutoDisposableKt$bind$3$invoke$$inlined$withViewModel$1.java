...
public final class AutoDisposableKt$bind$3$invoke$$inlined$withViewModel$1 extends Lambda implements Function0<Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ AutoDisposable f61737g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ Function1 f61738h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AutoDisposableKt$bind$3$invoke$$inlined$withViewModel$1(AutoDisposable autoDisposable, Function1 function1) {
        super(0);
        this.f61737g = autoDisposable;
        this.f61738h = function1;
    }

    public final void invoke() {
        ViewModel viewModel;
        Context context = ((View) this.f61737g).getContext();
