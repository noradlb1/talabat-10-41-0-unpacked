...
public final class BundleKt$bundleTo$10 extends Lambda implements Function1<Bundle, Unit> {
    ...
    public BundleKt$bundleTo$10(String str, String str2) {
        super(1);
        this.f46923g = str;
        this.f46924h = str2;
    }
    ...
    public final void invoke(@NotNull Bundle bundle) {
        ...
        BundleKt.set(bundle, this.f46923g, this.f46924h);
    }
}
