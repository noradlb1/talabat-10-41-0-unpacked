...
@Metadata(d1 = {"\u0000\u001b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u0016\u0012\u0006\u0012\u0004\u0018\u00010\u0002\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u00030\u0001J-\u0010\b\u001a\u0010\u0012\f\u0012\n \u0005*\u0004\u0018\u00018\u00008\u00000\u00032\b\u0010\t\u001a\u0004\u0018\u00010\u00022\n\u0010\n\u001a\u0006\u0012\u0002\b\u00030\u000bH\u0002R\u001f\u0010\u0004\u001a\u0010\u0012\f\u0012\n \u0005*\u0004\u0018\u00018\u00008\u00000\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\f"}, d2 = {"com/talabat/talabatcommon/extentions/RxDelegatesKt$observe$1", "Lkotlin/properties/ReadOnlyProperty;", "", "Lio/reactivex/subjects/BehaviorSubject;", "data", "kotlin.jvm.PlatformType", "getData", "()Lio/reactivex/subjects/BehaviorSubject;", "getValue", "thisRef", "property", "Lkotlin/reflect/KProperty;", "com_talabat_NewArchi_TalabatCommon_TalabatCommon"}, k = 1, mv = {1, 6, 0}, xi = 48)
public final class RxDelegatesKt$observe$1 implements ReadOnlyProperty<Object, BehaviorSubject<T>> {
    @NotNull
    private final BehaviorSubject<T> data;

    public RxDelegatesKt$observe$1(final Function0<? extends T> function0, final Scheduler scheduler) {
        BehaviorSubject<T> create = BehaviorSubject.create();
        Intrinsics.checkNotNullExpressionValue(create, "create<T>()");
        this.data = create;
        RxDelegatesKt.OnValueChangeListener(new Function1<OnValueChangeListener<T>, Unit>() {
            ...
            public final void invoke(@NotNull OnValueChangeListener<T> onValueChangeListener) {
                Intrinsics.checkNotNullParameter(onValueChangeListener, "$this$OnValueChangeListener");
