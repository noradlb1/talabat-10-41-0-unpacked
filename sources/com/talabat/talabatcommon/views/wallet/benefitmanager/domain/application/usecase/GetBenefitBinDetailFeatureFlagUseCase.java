...
public final class GetBenefitBinDetailFeatureFlagUseCase {
    ...
    public GetBenefitBinDetailFeatureFlagUseCase(@NotNull ITalabatFeatureFlag iTalabatFeatureFlag, @NotNull ConfigurationLocalRepository configurationLocalRepository2) {
    ...
    public final Object invoke(@NotNull Continuation<? super Boolean> continuation) {
        return BuildersKt.withContext(Dispatchers.getIO(), new GetBenefitBinDetailFeatureFlagUseCase$invoke$2(this, (Continuation<? super GetBenefitBinDetailFeatureFlagUseCase$invoke$2>) null), continuation);
    }
}
