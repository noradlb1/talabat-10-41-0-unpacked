...
public final class SubscriptionManagementViewModelImpl$getWalletCards$1 extends Lambda implements Function1<Either<? extends Failure, ? extends WalletCardListDisplayModel>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ SubscriptionManagementViewModelImpl f11941g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SubscriptionManagementViewModelImpl$getWalletCards$1(SubscriptionManagementViewModelImpl subscriptionManagementViewModelImpl) {
        super(1);
        this.f11941g = subscriptionManagementViewModelImpl;
    }
    ...
    public final void invoke(@NotNull Either<? extends Failure, WalletCardListDisplayModel> either) {
        ...
        either.either(new Function1<Failure, Unit>(this.f11941g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                invoke((Failure) obj);
                return Unit.INSTANCE;
            }
        ...
        }, new Function1<WalletCardListDisplayModel, Unit>(this.f11941g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            ...
            public final void invoke(@NotNull WalletCardListDisplayModel walletCardListDisplayModel) {
                ...
                ((SubscriptionManagementViewModelImpl) this.receiver).handleGetWalletCards(walletCardListDisplayModel);
            }
        });
    }
}
