...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016J\u0018\u0010\t\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016¨\u0006\n"}, d2 = {"Lcom/talabat/talabatcommon/views/tabBarWithTag/RevampTabBarBinder;", "Lcom/talabat/talabatcommon/views/tabBarWithTag/TabBarBinder;", "()V", "selected", "", "context", "Landroid/content/Context;", "viewHolder", "Lcom/talabat/talabatcommon/views/tabBarWithTag/TabBarWithTagView$ViewHolder;", "unselected", "com_talabat_NewArchi_TalabatCommon_TalabatCommon"}, k = 1, mv = {1, 6, 0}, xi = 48)
public final class RevampTabBarBinder implements TabBarBinder {
    ...
    public void selected(@NotNull Context context, @NotNull TabBarWithTagView.ViewHolder viewHolder) {
        ...
        if (tabText != null) {
            tabText.setTextAppearance(R.style.DSTextAppearance_Body1Bold);
        }
        TextView tabText2 = viewHolder.getTabText();
        if (tabText2 != null) {
            tabText2.setTextColor(context.getColor(R.color.ds_neutral_100));
        }
        CardView tagContainer = viewHolder.getTagContainer();
        if (tagContainer != null) {
            tagContainer.setCardBackgroundColor(context.getColor(R.color.ds_primary_10));
        }
        TextView tagTv = viewHolder.getTagTv();
        if (tagTv != null) {
            tagTv.setTextColor(context.getColor(R.color.ds_primary_100));
        }
    }
    ...
    public void unselected(@NotNull Context context, @NotNull TabBarWithTagView.ViewHolder viewHolder) {
        ...
        TextView tabText = viewHolder.getTabText();
        if (tabText != null) {
            tabText.setTextAppearance(R.style.DSTextAppearance_Body1Compact);
        }
        TextView tabText2 = viewHolder.getTabText();
        if (tabText2 != null) {
            tabText2.setTextColor(context.getColor(R.color.ds_neutral_100));
