...
public final class WalletPaymentRepositoryImpl$topUpWallet$1 extends Lambda implements Function1<WalletPaymentResponse, WalletPaymentResponse> {
    public static final WalletPaymentRepositoryImpl$topUpWallet$1 INSTANCE = new WalletPaymentRepositoryImpl$topUpWallet$1();

    public WalletPaymentRepositoryImpl$topUpWallet$1() {
        super(1);
    }
