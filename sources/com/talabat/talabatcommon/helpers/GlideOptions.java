...
public final class GlideOptions extends RequestOptions {
    ...
    @CheckResult
    @NonNull
    public static GlideOptions encodeQualityOf(@IntRange(from = 0, to = 100) int i11) {
    ...
    @CheckResult
    @NonNull
    public static GlideOptions frameOf(@IntRange(from = 0) long j11) {
    ...
    @CheckResult
    @NonNull
    public static <T> GlideOptions option(@NonNull Option<T> option, @NonNull T t11) {
        return new GlideOptions().set((Option) option, (Object) t11);
    }
    ...
    @CheckResult
    @NonNull
    public static GlideOptions sizeMultiplierOf(@FloatRange(from = 0.0d, to = 1.0d) float f11) {
    ...
    @CheckResult
    @NonNull
    public static GlideOptions timeoutOf(@IntRange(from = 0) int i11) {
        return new GlideOptions().timeout(i11);
    }

    @CheckResult
    @NonNull
    public static GlideOptions errorOf(@DrawableRes int i11) {
    ...
    @CheckResult
    @NonNull
    public static GlideOptions placeholderOf(@DrawableRes int i11) {
    ...
    @CheckResult
    @NonNull
    public GlideOptions encodeQuality(@IntRange(from = 0, to = 100) int i11) {
    ...
    @CheckResult
    @NonNull
    public GlideOptions frame(@IntRange(from = 0) long j11) {
    ...
    @CheckResult
    @NonNull
    public <Y> GlideOptions set(@NonNull Option<Y> option, @NonNull Y y11) {
        return (GlideOptions) super.set(option, y11);
    }
    ...
    @CheckResult
    @NonNull
    public GlideOptions sizeMultiplier(@FloatRange(from = 0.0d, to = 1.0d) float f11) {
    ...
    @CheckResult
    @NonNull
    public GlideOptions timeout(@IntRange(from = 0) int i11) {
    ...
    public com.talabat.talabatcommon.helpers.GlideOptions optionalTransform(@androidx.annotation.NonNull com.bumptech.glide.load.Transformation<android.graphics.Bitmap> r1) {
        /*
            r0 = this;
            com.bumptech.glide.request.BaseRequestOptions r1 = super.optionalTransform(r1)
            com.talabat.talabatcommon.helpers.GlideOptions r1 = (com.talabat.talabatcommon.helpers.GlideOptions) r1
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.talabat.talabatcommon.helpers.GlideOptions.optionalTransform(com.bumptech.glide.load.Transformation):com.talabat.talabatcommon.helpers.GlideOptions");
    }
    ...
    @CheckResult
    @NonNull
    public GlideOptions error(@DrawableRes int i11) {
        return (GlideOptions) super.error(i11);
    }

    @CheckResult
    @NonNull
    public GlideOptions fallback(@DrawableRes int i11) {
    ...
    @CheckResult
    @NonNull
    public GlideOptions placeholder(@DrawableRes int i11) {
    ...
    @androidx.annotation.NonNull
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public com.talabat.talabatcommon.helpers.GlideOptions transform(@androidx.annotation.NonNull com.bumptech.glide.load.Transformation<android.graphics.Bitmap> r1) {
        /*
            r0 = this;
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.talabat.talabatcommon.helpers.GlideOptions.transform(com.bumptech.glide.load.Transformation):com.talabat.talabatcommon.helpers.GlideOptions");
    }
