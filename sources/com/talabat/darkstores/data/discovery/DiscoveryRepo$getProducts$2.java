...
public final class DiscoveryRepo$getProducts$2 extends Lambda implements Function1<Pair<? extends List<? extends Product>, ? extends Integer>, List<? extends Product>> {
    public static final DiscoveryRepo$getProducts$2 INSTANCE = new DiscoveryRepo$getProducts$2();

    public DiscoveryRepo$getProducts$2() {
        super(1);
    }
