...
public final class DiscoveryRepo$search$3 extends Lambda implements Function1<List<? extends SearchSuggestion>, List<? extends Product>> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ DiscoveryRepo f56188g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DiscoveryRepo$search$3(DiscoveryRepo discoveryRepo) {
        super(1);
        this.f56188g = discoveryRepo;
    }

    @NotNull
    public final List<Product> invoke(List<? extends SearchSuggestion> list) {
        DiscoveryRepo discoveryRepo = this.f56188g;
