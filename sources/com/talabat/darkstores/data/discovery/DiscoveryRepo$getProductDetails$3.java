...
public final class DiscoveryRepo$getProductDetails$3 extends Lambda implements Function1<Product, List<? extends Product>> {
    public static final DiscoveryRepo$getProductDetails$3 INSTANCE = new DiscoveryRepo$getProductDetails$3();

    public DiscoveryRepo$getProductDetails$3() {
        super(1);
    }
