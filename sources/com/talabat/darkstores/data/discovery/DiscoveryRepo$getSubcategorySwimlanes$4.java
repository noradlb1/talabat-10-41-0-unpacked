...
public final class DiscoveryRepo$getSubcategorySwimlanes$4 extends Lambda implements Function1<SubcategorySwimalnesResponse, List<? extends Product>> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ DiscoveryRepo f56186g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DiscoveryRepo$getSubcategorySwimlanes$4(DiscoveryRepo discoveryRepo) {
        super(1);
        this.f56186g = discoveryRepo;
    }

    @NotNull
    public final List<Product> invoke(SubcategorySwimalnesResponse subcategorySwimalnesResponse) {
        return this.f56186g.swimlaneGetAllProduTalabatFeatureFlagConstantscts(subcategorySwimalnesResponse.getSwimlanes());
    }
}
