...
public final class CartProductJsonAdapter extends JsonAdapter<CartProduct> {
    ...
    public CartProductJsonAdapter(@NotNull Moshi moshi) {
    ...
    @NotNull
    public CartProduct fromJson(@NotNull JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (selectName == -1) {
                ...
                JsonDataException unexpectedNull2 = Util.unexpectedNull(FirebaseAnalytics.Param.QUANTITY, "qty", jsonReader);
                Intrinsics.checkNotNullExpressionValue(unexpectedNull2, "unexpectedNull(\"quantity…qty\",\n            reader)");
        ...
        if (str == null) {
            ...
            return new CartProduct(str, num.intValue());
        } else {
            JsonDataException missingProperty2 = Util.missingProperty(FirebaseAnalytics.Param.QUANTITY, "qty", jsonReader);
            Intrinsics.checkNotNullExpressionValue(missingProperty2, "missingProperty(\"quantity\", \"qty\", reader)");
            throw missingProperty2;
        }
    }

    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable CartProduct cartProduct) {
        Intrinsics.checkNotNullParameter(jsonWriter, "writer");
        if (cartProduct != null) {
            jsonWriter.beginObject();
            jsonWriter.name(TalabatCommonUrlConstantsKt.PRODUCT_ID);
            this.stringAdapter.toJson(jsonWriter, cartProduct.getProductId());
            jsonWriter.name("qty");
            this.intAdapter.toJson(jsonWriter, Integer.valueOf(cartProduct.getQuantity()));
