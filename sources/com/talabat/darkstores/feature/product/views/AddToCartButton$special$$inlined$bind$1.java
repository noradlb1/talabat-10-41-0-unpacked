...
public final class AddToCartButton$special$$inlined$bind$1 extends Lambda implements Function1<View, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ AutoDisposable f56511g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ AddToCartButton f56512h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddToCartButton$special$$inlined$bind$1(AutoDisposable autoDisposable, AddToCartButton addToCartButton) {
        super(1);
        this.f56511g = autoDisposable;
        this.f56512h = addToCartButton;
    }
    ...
    public final void invoke(@NotNull View view) {
        ...
        final AutoDisposable autoDisposable = this.f56511g;
        if (autoDisposable instanceof View) {
            final AddToCartButton addToCartButton = this.f56512h;
            ...
            final AddToCartButton addToCartButton2 = this.f56512h;
            ...
            final AddToCartButton addToCartButton3 = this.f56512h;
            AutoDisposableKt.autoDisposeOwner(autoDisposable, new Function0<Unit>() {
                public final void invoke() {
