...
public final class CampaignProgressView$special$$inlined$bind$1 extends Lambda implements Function1<View, Unit> {
    ...
    public final /* synthetic */ AutoDisposable f56540g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ CampaignProgressView f56541h;
    ...
    public CampaignProgressView$special$$inlined$bind$1(AutoDisposable autoDisposable, CampaignProgressView campaignProgressView) {
        super(1);
        this.f56540g = autoDisposable;
        this.f56541h = campaignProgressView;
    }
    ...
    public final void invoke(@NotNull View view) {
        ...
        final AutoDisposable autoDisposable = this.f56540g;
        if (autoDisposable instanceof View) {
            final CampaignProgressView campaignProgressView = this.f56541h;
            ...
            final CampaignProgressView campaignProgressView2 = this.f56541h;
            ...
            final CampaignProgressView campaignProgressView3 = this.f56541h;
            AutoDisposableKt.autoDisposeOwner(autoDisposable, new Function0<Unit>() {
                public final void invoke() {
