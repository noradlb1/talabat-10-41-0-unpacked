...
public final class ProductFragment$observeProductExtendedInfo$2 extends Lambda implements Function1<ProductExtendedInfo, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ ProductFragment f56488g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ProductFragment$observeProductExtendedInfo$2(ProductFragment productFragment) {
        super(1);
        this.f56488g = productFragment;
    }
    ...
    public final void invoke(@NotNull ProductExtendedInfo productExtendedInfo) {
        ...
        this.f56488g.setBottomProductExtendedInfo(productExtendedInfo);
    }
}
