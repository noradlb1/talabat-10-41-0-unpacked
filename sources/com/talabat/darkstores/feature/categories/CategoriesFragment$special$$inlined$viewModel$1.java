...
public final class CategoriesFragment$special$$inlined$viewModel$1 extends Lambda implements Function0<ViewModelProvider.Factory> {
    public CategoriesFragment$special$$inlined$viewModel$1() {
        super(0);
    }
    ...
    public final ViewModelProvider.Factory invoke() {
        return new ViewModelProvider.Factory() {
            ...
            public <T extends ViewModel> T create(@NotNull Class<T> cls) {
                ...
                return InjectorKt.getAppComponent().getCategoriesFragmentViewModel();
            }
