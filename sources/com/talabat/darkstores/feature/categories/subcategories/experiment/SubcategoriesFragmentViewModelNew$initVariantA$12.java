...
public final class SubcategoriesFragmentViewModelNew$initVariantA$12 extends Lambda implements Function1<Pair<? extends List<? extends String>, ? extends List<? extends ProductTrackingModel>>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ SubcategoriesFragmentViewModelNew f56342g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SubcategoriesFragmentViewModelNew$initVariantA$12(SubcategoriesFragmentViewModelNew subcategoriesFragmentViewModelNew) {
        super(1);
        this.f56342g = subcategoriesFragmentViewModelNew;
    }
    ...
    public final void invoke(Pair<? extends List<String>, ? extends List<ProductTrackingModel>> pair) {
        ...
        this.f56342g.onReadyForInteractionTlbDefinition();
        DarkstoresEventTracker access$getDarkStoreEventTracker$p = this.f56342g.darkStoreEventTracker;
        String access$getCategoryName$p = this.f56342g.categoryName;
        String access$getTopLevelCategoryId$p = this.f56342g.topLevelCategoryId;
        boolean z11 = this.f56342g.productsSentCount > 5;
        EventOrigin access$getEventOrigin$p = this.f56342g.eventOrigin;
