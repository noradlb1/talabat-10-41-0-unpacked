...
public final class SubcategoriesFragmentViewModelNew$initControl$3 extends Lambda implements Function1<Result<SubcategoriesData>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ SubcategoriesFragmentViewModelNew f56339g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SubcategoriesFragmentViewModelNew$initControl$3(SubcategoriesFragmentViewModelNew subcategoriesFragmentViewModelNew) {
        super(1);
        this.f56339g = subcategoriesFragmentViewModelNew;
    }
    ...
    public final void invoke(Result<SubcategoriesData> result) {
        this.f56339g.subcategoriesData.postValue(result);
    }
}
