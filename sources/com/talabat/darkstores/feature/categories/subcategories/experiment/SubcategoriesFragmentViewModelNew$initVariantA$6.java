...
public final class SubcategoriesFragmentViewModelNew$initVariantA$6 extends Lambda implements Function1<Result<SubcategoriesData>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ SubcategoriesFragmentViewModelNew f56345g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SubcategoriesFragmentViewModelNew$initVariantA$6(SubcategoriesFragmentViewModelNew subcategoriesFragmentViewModelNew) {
        super(1);
        this.f56345g = subcategoriesFragmentViewModelNew;
    }
    ...
    public final void invoke(@NotNull Result<SubcategoriesData> result) {
        ...
        this.f56345g.shelfViewData.postValue(result);
    }
}
