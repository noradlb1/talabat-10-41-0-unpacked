...
public final class SubcategoriesFragmentViewModelNew$initControl$$inlined$toResult$3<T, R> implements Function {

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ SubcategoriesFragmentViewModelNew f56336b;

    public SubcategoriesFragmentViewModelNew$initControl$$inlined$toResult$3(SubcategoriesFragmentViewModelNew subcategoriesFragmentViewModelNew) {
        this.f56336b = subcategoriesFragmentViewModelNew;
    }

    public final Result<List<? extends ShelfItem>> apply(@NotNull List<? extends TagResponse> list) {
        Intrinsics.checkNotNullParameter(list, "it");
        return new Result.Success(this.f56336b.mapToShelfItems(list));
    }
}
