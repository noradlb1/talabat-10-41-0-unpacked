...
public final class SubcategoriesFragmentViewModelNew$initVariantA$$inlined$toResult$2<T, R> implements Function {
    public final Result<SubcategoriesData> apply(@NotNull List<? extends SubcategoryItem> list) {
        Intrinsics.checkNotNullParameter(list, "it");
        return new Result.Success(new SubcategoriesData(CollectionsKt__CollectionsKt.emptyList(), list));
    }
}
