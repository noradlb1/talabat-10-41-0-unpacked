...
public final class HomeFragment$special$$inlined$activityViewModel$1 extends Lambda implements Function0<ViewModelProvider.Factory> {
    public HomeFragment$special$$inlined$activityViewModel$1() {
        super(0);
    }
    ...
    public final ViewModelProvider.Factory invoke() {
        return new ViewModelProvider.Factory() {
            ...
            public <T extends ViewModel> T create(@NotNull Class<T> cls) {
                ...
                return InjectorKt.getAppComponent().getHomeFragmentViewModel();
            }
