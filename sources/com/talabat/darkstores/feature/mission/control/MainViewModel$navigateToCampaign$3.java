...
public final class MainViewModel$navigateToCampaign$3 extends Lambda implements Function1<NavDirections, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ MainViewModel f56461g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MainViewModel$navigateToCampaign$3(MainViewModel mainViewModel) {
        super(1);
        this.f56461g = mainViewModel;
    }
    ...
    public final void invoke(@NotNull NavDirections navDirections) {
        ...
        this.f56461g.navigate(navDirections);
    }
}
