...
public final class MainViewModel$navigateToCart$3 extends Lambda implements Function1<NavDirections, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ MainViewModel f56462g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MainViewModel$navigateToCart$3(MainViewModel mainViewModel) {
        super(1);
        this.f56462g = mainViewModel;
    }
    ...
    public final void invoke(@NotNull NavDirections navDirections) {
        ...
        this.f56462g.navigate(navDirections);
    }
}
