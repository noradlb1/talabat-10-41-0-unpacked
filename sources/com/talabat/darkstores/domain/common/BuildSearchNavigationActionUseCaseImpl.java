...
import com.talabat.feature.nfvinvendorsearch.presentation.navigation.PreSearchRoute;
...
public final class BuildSearchNavigationActionUseCaseImpl implements BuildSearchNavigationActionUseCase {
    ...
    public static final NavDirections m9762invoke$lambda0(Function2 function2, FlutterConfigurationParams flutterConfigurationParams) {
        ...
        return (NavDirections) function2.invoke(flutterConfigurationParams, new PreSearchRoute(flutterConfigurationParams.getVendorCode()));
    }

    @NotNull
    public Single<NavDirections> invoke(@NotNull Function2<? super FlutterConfigurationParams, ? super FlutterRoute, ? extends NavDirections> function2) {
        Intrinsics.checkNotNullParameter(function2, "buildFlutterAction");
        Single<NavDirections> fromCallable = Single.fromCallable(new s(function2, this.getFlutterConfigurationParams.invoke()));
