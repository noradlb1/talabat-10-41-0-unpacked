...
public final class SampleFiltersActivity$onCreate$2 extends Lambda implements Function1<StartForResultCallbacks<Selectables>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ SampleFiltersActivity f59590g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SampleFiltersActivity$onCreate$2(SampleFiltersActivity sampleFiltersActivity) {
        super(1);
        this.f59590g = sampleFiltersActivity;
    }
    ...
    public final void invoke(@NotNull StartForResultCallbacks<Selectables> startForResultCallbacks) {
        ...
        final SampleFiltersActivity sampleFiltersActivity = this.f59590g;
        on2.success(new Function1<Selectables, Unit>() {
            ...
            public final void invoke(@Nullable Selectables selectables) {
                ((TextView) sampleFiltersActivity._$_findCachedViewById(R.id.restaurantsSelectionTextView)).setText(sampleFiltersActivity.selectionText(selectables));
            }
        });
        StartForResultCallbacks<Selectables> on3 = startForResultCallbacks.getOn();
        final SampleFiltersActivity sampleFiltersActivity2 = this.f59590g;
        on3.cancelled(new Function0<Unit>() {
            public final void invoke() {
                Toast.makeText(sampleFiltersActivity2.getApplicationContext(), "restaurants filter cancelled", 1).show();
            }
        });
    }
}
