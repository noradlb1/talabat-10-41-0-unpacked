...
public final class GetUserWaitListState extends UseCase<TLifeOnBoardingWaitListDisplayModel, Integer> {
    ...
    public GetUserWaitListState(@NotNull NetworkHandler networkHandler2, @NotNull WaitListService waitListService, @NotNull CoroutineScope coroutineScope, @NotNull CoroutineDispatcher coroutineDispatcher) {
        ...
        this.f12057service = waitListService;
    }
    ...
    public Object run(int i11, @NotNull Continuation<? super Either<? extends Failure, TLifeOnBoardingWaitListDisplayModel>> continuation) {
        ...
        if (isConnected) {
            return RequestKt.request(WaitListApi.DefaultImpls.getUserWaitListState$default(this.f12057service, i11, 0, 2, (Object) null), GetUserWaitListState$run$2.INSTANCE, new UserWaitListRootResponse());
        }
        if (!isConnected) {
