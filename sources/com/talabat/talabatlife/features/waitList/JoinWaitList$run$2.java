...
public final class JoinWaitList$run$2 extends Lambda implements Function1<UserWaitListRootResponse, TLifeOnBoardingWaitListDisplayModel> {
    public static final JoinWaitList$run$2 INSTANCE = new JoinWaitList$run$2();

    public JoinWaitList$run$2() {
        super(1);
    }
