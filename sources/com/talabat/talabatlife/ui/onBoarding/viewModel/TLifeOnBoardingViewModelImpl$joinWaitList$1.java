...
public final class TLifeOnBoardingViewModelImpl$joinWaitList$1 extends Lambda implements Function1<Either<? extends Failure, ? extends HashMap<String, String>>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ TLifeOnBoardingViewModelImpl f12071g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TLifeOnBoardingViewModelImpl$joinWaitList$1(TLifeOnBoardingViewModelImpl tLifeOnBoardingViewModelImpl) {
        super(1);
        this.f12071g = tLifeOnBoardingViewModelImpl;
    }
    ...
    public final void invoke(@NotNull Either<? extends Failure, ? extends HashMap<String, String>> either) {
        ...
        final TLifeOnBoardingViewModelImpl tLifeOnBoardingViewModelImpl = this.f12071g;
        either.either(r02, new Function1<HashMap<String, String>, Unit>() {
            ...
            public final void invoke(@NotNull HashMap<String, String> hashMap) {
                ...
                tLifeOnBoardingViewModelImpl.sendFirebaseEvent(EventNames.WAIT_LIST_CLICKED.getEventName(), hashMap);
            }
        });
    }
}
