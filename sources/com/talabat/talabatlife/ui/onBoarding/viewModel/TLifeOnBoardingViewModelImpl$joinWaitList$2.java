...
public final class TLifeOnBoardingViewModelImpl$joinWaitList$2 extends Lambda implements Function1<Either<? extends Failure, ? extends TLifeOnBoardingWaitListDisplayModel>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ TLifeOnBoardingViewModelImpl f12073g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TLifeOnBoardingViewModelImpl$joinWaitList$2(TLifeOnBoardingViewModelImpl tLifeOnBoardingViewModelImpl) {
        super(1);
        this.f12073g = tLifeOnBoardingViewModelImpl;
    }
    ...
    public final void invoke(@NotNull Either<? extends Failure, TLifeOnBoardingWaitListDisplayModel> either) {
        ...
        either.either(new Function1<Failure, Unit>(this.f12073g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                invoke((Failure) obj);
                return Unit.INSTANCE;
            }
        ...
        }, new Function1<TLifeOnBoardingWaitListDisplayModel, Unit>(this.f12073g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            ...
            public final void invoke(@NotNull TLifeOnBoardingWaitListDisplayModel tLifeOnBoardingWaitListDisplayModel) {
                ...
                ((TLifeOnBoardingViewModelImpl) this.receiver).handleJoinWaitList(tLifeOnBoardingWaitListDisplayModel);
            }
        });
    }
}
