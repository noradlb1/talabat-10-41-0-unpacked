...
public final class VendorOffersAnalytics$Companion$fireOfferTrackingEvent$1$1 extends Lambda implements Function3<VendorDisplayModel, VendorOfferListDisplayModel, VendorBranchListDisplayModel, Unit> {
    public static final VendorOffersAnalytics$Companion$fireOfferTrackingEvent$1$1 INSTANCE = new VendorOffersAnalytics$Companion$fireOfferTrackingEvent$1$1();

    public VendorOffersAnalytics$Companion$fireOfferTrackingEvent$1$1() {
        super(3);
    }
    ...
    public final void invoke(@NotNull VendorDisplayModel vendorDisplayModel, @NotNull VendorOfferListDisplayModel vendorOfferListDisplayModel, @NotNull VendorBranchListDisplayModel vendorBranchListDisplayModel) {
        ...
        IntegrationAppTrackerTLife.Companion.onTLifeOfferDetailsLoaded(vendorDisplayModel.getCuisines(), vendorDisplayModel.getName(), String.valueOf(vendorDisplayModel.getRestaurantId()), String.valueOf(vendorBranchListDisplayModel.getBranches().size()), vendorDisplayModel.getRating().toString(), String.valueOf(vendorDisplayModel.getReviewsCount()), String.valueOf(vendorOfferListDisplayModel.getOfferList().size()), VendorOffersAnalytics.Companion.getOffersNames(vendorOfferListDisplayModel));
    }
}
