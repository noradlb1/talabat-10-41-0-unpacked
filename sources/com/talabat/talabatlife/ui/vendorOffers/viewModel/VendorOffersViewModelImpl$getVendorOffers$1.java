...
public final class VendorOffersViewModelImpl$getVendorOffers$1 extends Lambda implements Function1<Either<? extends Failure, ? extends VendorOfferListDisplayModel>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ VendorOffersViewModelImpl f12110g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VendorOffersViewModelImpl$getVendorOffers$1(VendorOffersViewModelImpl vendorOffersViewModelImpl) {
        super(1);
        this.f12110g = vendorOffersViewModelImpl;
    }
    ...
    public final void invoke(@NotNull Either<? extends Failure, VendorOfferListDisplayModel> either) {
        ...
        either.either(new Function1<Failure, Unit>(this.f12110g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                invoke((Failure) obj);
                return Unit.INSTANCE;
            }
        ...
        }, new Function1<VendorOfferListDisplayModel, Unit>(this.f12110g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            ...
            public final void invoke(@NotNull VendorOfferListDisplayModel vendorOfferListDisplayModel) {
                ...
                ((VendorOffersViewModelImpl) this.receiver).handleVendorOffersListDisplayModel(vendorOfferListDisplayModel);
            }
        });
    }
}
