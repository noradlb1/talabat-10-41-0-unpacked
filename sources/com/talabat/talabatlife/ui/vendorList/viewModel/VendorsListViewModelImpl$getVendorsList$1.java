...
public final class VendorsListViewModelImpl$getVendorsList$1 extends Lambda implements Function1<Either<? extends Failure, ? extends VendorListDisplayModel>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ VendorsListViewModelImpl f12098g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VendorsListViewModelImpl$getVendorsList$1(VendorsListViewModelImpl vendorsListViewModelImpl) {
        super(1);
        this.f12098g = vendorsListViewModelImpl;
    }
    ...
    public final void invoke(@NotNull Either<? extends Failure, VendorListDisplayModel> either) {
        ...
        either.either(new Function1<Failure, Unit>(this.f12098g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                invoke((Failure) obj);
                return Unit.INSTANCE;
            }
        ...
        }, new Function1<VendorListDisplayModel, Unit>(this.f12098g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            ...
            public final void invoke(@NotNull VendorListDisplayModel vendorListDisplayModel) {
                ...
                ((VendorsListViewModelImpl) this.receiver).handleVendorListDisplayModel(vendorListDisplayModel);
            }
        });
    }
}
