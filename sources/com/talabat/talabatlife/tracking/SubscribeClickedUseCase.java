...
public final class SubscribeClickedUseCase extends UseCase<UseCase.None, Params> {
    ...
    public SubscribeClickedUseCase(@NotNull CoroutineScope coroutineScope, @NotNull CoroutineDispatcher coroutineDispatcher, @NotNull Tracker tracker2, @NotNull Function1<? super Float, String> function1) {
    ...
    public Object run(@NotNull Params params, @NotNull Continuation<? super Either<? extends Failure, UseCase.None>> continuation) {
        Map<String, Object> createParameters = this.tracker.createParameters(ScreenNames.ON_BOARDING_SCREEN.getScreenName(), ScreenTypes.ON_BOARDING_SCREEN.getScreenType());
        ...
        this.tracker.sendEvent(EventNames.SUBSCRIPTION_CLICKED.getEventName(), createParameters);
