...
public final class EnterEmailFragment$special$$inlined$viewModels$default$5 extends Lambda implements Function0<ViewModelProvider.Factory> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ Fragment f12403g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ Lazy f12404h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public EnterEmailFragment$special$$inlined$viewModels$default$5(Fragment fragment, Lazy lazy) {
        super(0);
    ...
    public final ViewModelProvider.Factory invoke() {
        ...
        ViewModelStoreOwner r02 = FragmentViewModelLazyKt.m9081viewModels$lambda1(this.f12404h);
        ...
        if (hasDefaultViewModelProviderFactory == null || (factory = hasDefaultViewModelProviderFactory.getDefaultViewModelProviderFactory()) == null) {
            factory = this.f12403g.getDefaultViewModelProviderFactory();
        }
