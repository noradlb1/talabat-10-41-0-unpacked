...
public final class GemAnalytics$onGemOfferRejected$1 extends Lambda implements Function0<Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ GemAnalytics f59855g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GemAnalytics$onGemOfferRejected$1(GemAnalytics gemAnalytics) {
        super(0);
        this.f59855g = gemAnalytics;
    }
    ...
    public final void invoke() {
        ...
        final GemAnalytics gemAnalytics = this.f59855g;
        CoroutinesKt.runHandling(r02, new Function0<Unit>() {
            public final void invoke() {
                IntegrationKt.getLogger().logMessage("GemAnalytics", "joker_lightbox_rejected");
                TalabatGTM.Companion.onJokerModalRejected(gemAnalytics.getApplication(), gemAnalytics.getGemRemainingSecondsText());
            }
        });
    }
}
