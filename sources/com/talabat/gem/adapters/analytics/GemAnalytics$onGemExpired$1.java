...
public final class GemAnalytics$onGemExpired$1 extends Lambda implements Function0<Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ GemAnalytics f59839g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GemAnalytics$onGemExpired$1(GemAnalytics gemAnalytics) {
        super(0);
        this.f59839g = gemAnalytics;
    }
    ...
    public final void invoke() {
        ...
        final GemAnalytics gemAnalytics = this.f59839g;
        CoroutinesKt.runHandling(r02, new Function0<Unit>() {
            public final void invoke() {
                IntegrationKt.getLogger().logMessage("GemAnalytics", "joker_timeout");
                TalabatGTM.Companion.onJokerTimeOut(gemAnalytics.getApplication(), (String) gemAnalytics.pageTypeProvider.invoke());
            }
        });
    }
}
