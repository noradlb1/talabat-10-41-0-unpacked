...
public final class GemOfferMainActivity$initialize$1$5 extends Lambda implements Function0<Disposable> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ GemOfferViewModel f60249g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ GemOfferMainActivity f60250h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GemOfferMainActivity$initialize$1$5(GemOfferViewModel gemOfferViewModel, GemOfferMainActivity gemOfferMainActivity) {
        super(0);
        this.f60249g = gemOfferViewModel;
        this.f60250h = gemOfferMainActivity;
    }

    @Nullable
    public final Disposable invoke() {
        BehaviorSubject<String> counter = this.f60249g.getCounter();
        final GemOfferMainActivity gemOfferMainActivity = this.f60250h;
            ...
            public final void invoke(@NotNull ObserverCallbacks<String, Observable<String>> observerCallbacks) {
                ...
                on2.next(new Function1<String, Unit>() {
                    ...
                    public final void invoke(String str) {
                        TextView textView = (TextView) gemOfferMainActivity._$_findCachedViewById(R.id.counterTextView);
