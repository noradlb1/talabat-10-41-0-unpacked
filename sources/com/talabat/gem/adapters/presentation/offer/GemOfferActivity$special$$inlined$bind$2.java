...
public final class GemOfferActivity$special$$inlined$bind$2 extends Lambda implements Function1<AppCompatActivity, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ AutoDisposable f60183g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ GemOfferActivity f60184h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GemOfferActivity$special$$inlined$bind$2(AutoDisposable autoDisposable, GemOfferActivity gemOfferActivity) {
        super(1);
        this.f60183g = autoDisposable;
        this.f60184h = gemOfferActivity;
    }
    ...
    public final void invoke(@NotNull AppCompatActivity appCompatActivity) {
        ...
        final AutoDisposable autoDisposable = this.f60183g;
        if (autoDisposable instanceof View) {
            final GemOfferActivity gemOfferActivity = this.f60184h;
            ...
            final GemOfferActivity gemOfferActivity2 = this.f60184h;
            AutoDisposableKt.autoDisposeOwner(autoDisposable, new Function0<Unit>() {
                ...
                public final void invoke() {
                    ...
                    L_0x0028:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.talabat.gem.adapters.presentation.offer.GemOfferActivity$special$$inlined$bind$2.AnonymousClass2.invoke():void");
                }
            });
        } else if (autoDisposable instanceof Fragment) {
            final GemOfferActivity gemOfferActivity3 = this.f60184h;
            AutoDisposableKt.autoDisposeOwner(autoDisposable, new Function0<Unit>() {
                /* JADX WARNING: Code restructure failed: missing block: B:2:0x0018, code lost:
                    r1 = (com.talabat.core.navigation.domain.screen.gem.GemOffersScreen.GemOffersData) r1.getParcelableExtra("navigatorData");
                 */
                ...
                public final void invoke() {
                    ...
                    L_0x0028:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.talabat.gem.adapters.presentation.offer.GemOfferActivity$special$$inlined$bind$2.AnonymousClass3.invoke():void");
                }
            });
        } else {
