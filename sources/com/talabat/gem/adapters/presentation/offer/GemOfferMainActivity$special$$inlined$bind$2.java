...
public final class GemOfferMainActivity$special$$inlined$bind$2 extends Lambda implements Function1<AppCompatActivity, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ AutoDisposable f60228g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ GemOfferMainActivity f60229h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GemOfferMainActivity$special$$inlined$bind$2(AutoDisposable autoDisposable, GemOfferMainActivity gemOfferMainActivity) {
        super(1);
        this.f60228g = autoDisposable;
        this.f60229h = gemOfferMainActivity;
    }
    ...
    public final void invoke(@NotNull AppCompatActivity appCompatActivity) {
        ...
        final AutoDisposable autoDisposable = this.f60228g;
        if (autoDisposable instanceof View) {
            final GemOfferMainActivity gemOfferMainActivity = this.f60229h;
            ...
            final GemOfferMainActivity gemOfferMainActivity2 = this.f60229h;
            ...
            final GemOfferMainActivity gemOfferMainActivity3 = this.f60229h;
            AutoDisposableKt.autoDisposeOwner(autoDisposable, new Function0<Unit>() {
                public final void invoke() {
