...
public final class GemCheckoutFooterView$initialize$1$invoke$$inlined$bind$1 extends Lambda implements Function1<View, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ AutoDisposable f59929g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ GemCheckoutFooterView f59930h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ Context f59931i;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GemCheckoutFooterView$initialize$1$invoke$$inlined$bind$1(AutoDisposable autoDisposable, GemCheckoutFooterView gemCheckoutFooterView, Context context) {
        super(1);
        this.f59929g = autoDisposable;
        this.f59930h = gemCheckoutFooterView;
        this.f59931i = context;
    }
    ...
    public final void invoke(@NotNull View view) {
        ...
        final AutoDisposable autoDisposable = this.f59929g;
        if (autoDisposable instanceof View) {
            final GemCheckoutFooterView gemCheckoutFooterView = this.f59930h;
            final Context context = this.f59931i;
            ...
            final GemCheckoutFooterView gemCheckoutFooterView2 = this.f59930h;
            final Context context2 = this.f59931i;
            ...
            final GemCheckoutFooterView gemCheckoutFooterView3 = this.f59930h;
            final Context context3 = this.f59931i;
            AutoDisposableKt.autoDisposeOwner(autoDisposable, new Function0<Unit>() {
                public final void invoke() {
