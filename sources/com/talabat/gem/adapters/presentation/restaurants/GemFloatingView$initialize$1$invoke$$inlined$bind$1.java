...
public final class GemFloatingView$initialize$1$invoke$$inlined$bind$1 extends Lambda implements Function1<View, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ AutoDisposable f60264g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ GemFloatingView f60265h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ Context f60266i;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GemFloatingView$initialize$1$invoke$$inlined$bind$1(AutoDisposable autoDisposable, GemFloatingView gemFloatingView, Context context) {
        super(1);
        this.f60264g = autoDisposable;
        this.f60265h = gemFloatingView;
        this.f60266i = context;
    }
    ...
    public final void invoke(@NotNull View view) {
        ...
        final AutoDisposable autoDisposable = this.f60264g;
        if (autoDisposable instanceof View) {
            final GemFloatingView gemFloatingView = this.f60265h;
            final Context context = this.f60266i;
            ...
            final GemFloatingView gemFloatingView2 = this.f60265h;
            final Context context2 = this.f60266i;
            ...
            final GemFloatingView gemFloatingView3 = this.f60265h;
            final Context context3 = this.f60266i;
            AutoDisposableKt.autoDisposeOwner(autoDisposable, new Function0<Unit>() {
                public final void invoke() {
