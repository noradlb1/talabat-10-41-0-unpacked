...
public final class GemCollectionActivity$special$$inlined$bind$2 extends Lambda implements Function1<AppCompatActivity, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ AutoDisposable f60008g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ GemCollectionActivity f60009h;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GemCollectionActivity$special$$inlined$bind$2(AutoDisposable autoDisposable, GemCollectionActivity gemCollectionActivity) {
        super(1);
        this.f60008g = autoDisposable;
        this.f60009h = gemCollectionActivity;
    }
    ...
    public final void invoke(@NotNull AppCompatActivity appCompatActivity) {
        ...
        final AutoDisposable autoDisposable = this.f60008g;
        if (autoDisposable instanceof View) {
            final GemCollectionActivity gemCollectionActivity = this.f60009h;
            ...
            final GemCollectionActivity gemCollectionActivity2 = this.f60009h;
            ...
            final GemCollectionActivity gemCollectionActivity3 = this.f60009h;
            AutoDisposableKt.autoDisposeOwner(autoDisposable, new Function0<Unit>() {
                public final void invoke() {
