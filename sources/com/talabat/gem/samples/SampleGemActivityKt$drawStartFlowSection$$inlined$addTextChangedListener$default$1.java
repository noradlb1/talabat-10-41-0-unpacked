...
public final class SampleGemActivityKt$drawStartFlowSection$$inlined$addTextChangedListener$default$1 implements TextWatcher {
    public void afterTextChanged(@Nullable Editable editable) {
        SampleDataSourcesKt.setExpireAfterMinutes(StringsKt__StringNumberConversionsJVMKt.toDoubleOrNull(String.valueOf(editable)));
    }
