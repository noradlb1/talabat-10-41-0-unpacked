...
public final class SampleGemItemActivity$initialize$1 extends Lambda implements Function1<AppCompatActivity, Unit> {
    public static final SampleGemItemActivity$initialize$1 INSTANCE = new SampleGemItemActivity$initialize$1();

    public SampleGemItemActivity$initialize$1() {
        super(1);
    }
