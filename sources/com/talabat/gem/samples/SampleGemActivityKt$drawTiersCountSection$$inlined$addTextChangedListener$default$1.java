...
public final class SampleGemActivityKt$drawTiersCountSection$$inlined$addTextChangedListener$default$1 implements TextWatcher {
    public void afterTextChanged(@Nullable Editable editable) {
        SampleDataSourcesKt.setTiersCount(StringsKt__StringNumberConversionsJVMKt.toDoubleOrNull(String.valueOf(editable)));
    }
