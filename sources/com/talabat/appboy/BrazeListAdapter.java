...
public class BrazeListAdapter extends ArrayAdapter<Card> {
    ...
    public BrazeListAdapter(Context context, int i11, List<Card> list) {
    ...
    public View getView(final int i11, View view, ViewGroup viewGroup) {
        ...
        final Card card = (Card) getItem(i11);
        if (view != null) {
            String str = TAG;
        ...
        baseFeedCardView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BrazeListAdapter.this.newsFeedClickListener.onNewsFeedClick(card, i11);
            }
        });
