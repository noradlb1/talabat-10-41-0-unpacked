...
import com.talabat.feature.darkstores.vendorslanding.data.model.BasketDeliveryFeeTierInfoResponse;
import com.talabat.feature.darkstores.vendorslanding.data.model.BasketTagsResponse;
import com.talabat.feature.darkstores.vendorslanding.data.model.DeliveryFeeTierResponse;
import com.talabat.feature.darkstores.vendorslanding.data.model.TierTagsResponse;
...
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u0007\b\u0007¢\u0006\u0002\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u0002H\u0016J\u000e\u0010\u0007\u001a\u0004\u0018\u00010\b*\u00020\tH\u0002J\u000e\u0010\n\u001a\u0004\u0018\u00010\u000b*\u00020\fH\u0002J\u0018\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u000f0\u000e*\b\u0012\u0004\u0012\u00020\u00100\u000eH\u0002¨\u0006\u0011"}, d2 = {"Lcom/talabat/feature/darkstores/vendorslanding/data/mapper/VendorInfoResponseMapper;", "Lcom/talabat/mapper/ModelMapper;", "Lcom/talabat/feature/darkstores/vendorslanding/data/model/VendorInfoResponse;", "Lcom/talabat/feature/darkstoresvendor/domain/model/Vendor;", "()V", "apply", "source", "mapBasketTiers", "Lcom/talabat/feature/darkstoresvendor/domain/model/BasketDeliveryFeeTiersInfo;", "Lcom/talabat/feature/darkstores/vendorslanding/data/model/BasketDeliveryFeeTierInfoResponse;", "toTags", "Lcom/talabat/feature/darkstoresvendor/domain/model/Tags;", "Lcom/talabat/feature/darkstores/vendorslanding/data/model/BasketTagsResponse;", "toTiers", "", "Lcom/talabat/feature/darkstoresvendor/domain/model/BasketDeliveryFreeTier;", "Lcom/talabat/feature/darkstores/vendorslanding/data/model/DeliveryFeeTierResponse;", "com_talabat_feature_darkstores-vendor-landing_data_data"}, k = 1, mv = {1, 6, 0}, xi = 48)
public final class VendorInfoResponseMapper implements ModelMapper<VendorInfoResponse, Vendor> {
    ...
    @NotNull
    public Vendor apply(@NotNull VendorInfoResponse vendorInfoResponse) {
        String str;
        String str2;
        Intrinsics.checkNotNullParameter(vendorInfoResponse, "source");
        String vendorId = vendorInfoResponse.getVendorId();
        String str3 = vendorId == null ? "" : vendorId;
        String vendorCode = vendorInfoResponse.getVendorCode();
        if (vendorCode == null) {
            str = "";
        } else {
            str = vendorCode;
        }
        Float deliveryFee = vendorInfoResponse.getDeliveryFee();
        float floatValue = deliveryFee != null ? deliveryFee.floatValue() : 0.0f;
        String deliveryTime = vendorInfoResponse.getDeliveryTime();
        if (deliveryTime == null) {
            str2 = "";
        } else {
            str2 = deliveryTime;
        }
        Float minimumOrderValue = vendorInfoResponse.getMinimumOrderValue();
        float floatValue2 = minimumOrderValue != null ? minimumOrderValue.floatValue() : 0.0f;
        Boolean isTPro = vendorInfoResponse.isTPro();
        boolean booleanValue = isTPro != null ? isTPro.booleanValue() : false;
        Boolean isVendorPro = vendorInfoResponse.isVendorPro();
        boolean booleanValue2 = isVendorPro != null ? isVendorPro.booleanValue() : false;
        BasketDeliveryFeeTierInfoResponse basketDeliveryFeeTiers = vendorInfoResponse.getBasketDeliveryFeeTiers();
        return new Vendor(str3, str, floatValue, str2, floatValue2, booleanValue, booleanValue2, basketDeliveryFeeTiers != null ? mapBasketTiers(basketDeliveryFeeTiers) : null, vendorInfoResponse.getScheduleDeliveryDiscount());
    }
}
