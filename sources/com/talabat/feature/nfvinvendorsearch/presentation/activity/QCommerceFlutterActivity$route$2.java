...
public final class QCommerceFlutterActivity$route$2 extends Lambda implements Function0<FlutterRoute> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ QCommerceFlutterActivity f58618g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public QCommerceFlutterActivity$route$2(QCommerceFlutterActivity qCommerceFlutterActivity) {
        super(0);
        this.f58618g = qCommerceFlutterActivity;
    }
    ...
    public final FlutterRoute invoke() {
        ...
        Intent intent = this.f58618g.getIntent();
        if (!(intent == null || (extras = intent.getExtras()) == null)) {
            if (Build.VERSION.SDK_INT >= 33) {
                parcelable = (Parcelable) extras.getParcelable(Constants.ARG_ROUTE, FlutterRoute.class);
            } else {
                parcelable = extras.getParcelable(Constants.ARG_ROUTE);
            }
