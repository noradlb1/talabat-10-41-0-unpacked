...
public final class MissionSuccessLoadedTrackingEvent extends TalabatEvent {
    ...
    public /* synthetic */ MissionSuccessLoadedTrackingEvent(com.talabat.feature.rewards.domain.model.MissionOrigin r3, com.talabat.feature.rewards.domain.model.Mission r4, java.util.List r5, int r6, kotlin.jvm.internal.DefaultConstructorMarker r7) {
        /*
            r2 = this;
            r6 = r6 & 4
        ...
        L_0x0024:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.talabat.feature.rewards.data.tracking.events.MissionSuccessLoadedTrackingEvent.<init>(com.talabat.feature.rewards.domain.model.MissionOrigin, com.talabat.feature.rewards.domain.model.Mission, java.util.List, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
    ...
    public Map<String, Object> attributes(@NotNull PlatformName platformName) {
        ...
        Map mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.to("missionId", Integer.valueOf(i11)));
    ...
    public MissionSuccessLoadedTrackingEvent(@Nullable MissionOrigin missionOrigin, @Nullable Mission mission2, @NotNull List<? extends TrackingAttributes> list) {
