...
public final class FragmentRatingReasonsBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public static FragmentRatingReasonsBinding bind(@NonNull View view) {
                        ...
                        if (recyclerView != null) {
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null) {
                                        return new FragmentRatingReasonsBinding((ScrollView) view, imageView, dSPrimaryButton, imageView2, talabatStarRating, recyclerView, textView, textView2, textView3);
                                    }
                                }
                            }
                        }
    ...
    @NonNull
    public static FragmentRatingReasonsBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    @NonNull
    public static FragmentRatingReasonsBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z11) {
        View inflate = layoutInflater.inflate(R.layout.fragment_rating_reasons, viewGroup, false);
        if (z11) {
