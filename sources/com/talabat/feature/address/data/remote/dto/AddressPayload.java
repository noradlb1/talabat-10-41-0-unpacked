...
public final class AddressPayload {
    ...
    public static /* synthetic */ AddressPayload copy$default(AddressPayload addressPayload, String str, long j11, String str2, int i11, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, int i12, int i13, double d11, double d12, String str13, String str14, int i14, Object obj) {
        AddressPayload addressPayload2 = addressPayload;
        int i15 = i14;
        return addressPayload.copy((i15 & 1) != 0 ? addressPayload2.profileName : str, (i15 & 2) != 0 ? addressPayload2.areaId : j11, (i15 & 4) != 0 ? addressPayload2.areaName : str2, (i15 & 8) != 0 ? addressPayload2.type : i11, (i15 & 16) != 0 ? addressPayload2.block : str3, (i15 & 32) != 0 ? addressPayload2.judda : str4, (i15 & 64) != 0 ? addressPayload2.street : str5, (i15 & 128) != 0 ? addressPayload2.buildingNo : str6, (i15 & 256) != 0 ? addressPayload2.floor : str7, (i15 & 512) != 0 ? addressPayload2.suite : str8, (i15 & 1024) != 0 ? addressPayload2.extraDirections : str9, (i15 & 2048) != 0 ? addressPayload2.phoneNumber : str10, (i15 & 4096) != 0 ? addressPayload2.countryCode : str11, (i15 & 8192) != 0 ? addressPayload2.mobileNumber : str12, (i15 & 16384) != 0 ? addressPayload2.cityId : i12, (i15 & 32768) != 0 ? addressPayload2.country : i13, (i15 & 65536) != 0 ? addressPayload2.latitude : d11, (i15 & 131072) != 0 ? addressPayload2.longitude : d12, (i15 & 262144) != 0 ? addressPayload2.grl : str13, (i15 & 524288) != 0 ? addressPayload2.grlId : str14);
    }
    ...
    @NotNull
    public final AddressPayload copy(@NotNull String str, long j11, @NotNull String str2, int i11, @NotNull String str3, @NotNull String str4, @NotNull String str5, @NotNull String str6, @NotNull String str7, @NotNull String str8, @NotNull String str9, @NotNull String str10, @NotNull String str11, @NotNull String str12, int i12, int i13, double d11, double d12, @NotNull String str13, @NotNull String str14) {
        String str15 = str;
        Intrinsics.checkNotNullParameter(str15, Profile.PROFILE_NAME);
        ...
        Intrinsics.checkNotNullParameter(str14, "grlId");
        return new AddressPayload(str15, j11, str2, i11, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, i12, i13, d11, d12, str13, str14);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof AddressPayload)) {
            return false;
        }
        AddressPayload addressPayload = (AddressPayload) obj;
        return Intrinsics.areEqual((Object) this.profileName, (Object) addressPayload.profileName) && this.areaId == addressPayload.areaId && Intrinsics.areEqual((Object) this.areaName, (Object) addressPayload.areaName) && this.type == addressPayload.type && Intrinsics.areEqual((Object) this.block, (Object) addressPayload.block) && Intrinsics.areEqual((Object) this.judda, (Object) addressPayload.judda) && Intrinsics.areEqual((Object) this.street, (Object) addressPayload.street) && Intrinsics.areEqual((Object) this.buildingNo, (Object) addressPayload.buildingNo) && Intrinsics.areEqual((Object) this.floor, (Object) addressPayload.floor) && Intrinsics.areEqual((Object) this.suite, (Object) addressPayload.suite) && Intrinsics.areEqual((Object) this.extraDirections, (Object) addressPayload.extraDirections) && Intrinsics.areEqual((Object) this.phoneNumber, (Object) addressPayload.phoneNumber) && Intrinsics.areEqual((Object) this.countryCode, (Object) addressPayload.countryCode) && Intrinsics.areEqual((Object) this.mobileNumber, (Object) addressPayload.mobileNumber) && this.cityId == addressPayload.cityId && this.country == addressPayload.country && Intrinsics.areEqual((Object) Double.valueOf(this.latitude), (Object) Double.valueOf(addressPayload.latitude)) && Intrinsics.areEqual((Object) Double.valueOf(this.longitude), (Object) Double.valueOf(addressPayload.longitude)) && Intrinsics.areEqual((Object) this.grl, (Object) addressPayload.grl) && Intrinsics.areEqual((Object) this.grlId, (Object) addressPayload.grlId);
    }
    ...
    public String toString() {
        ...
        return "AddressPayload(profileName=" + str + ", areaId=" + j11 + ", areaName=" + str2 + ", type=" + i11 + ", block=" + str3 + ", judda=" + str4 + ", street=" + str5 + ", buildingNo=" + str6 + ", floor=" + str7 + ", suite=" + str8 + ", extraDirections=" + str9 + ", phoneNumber=" + str10 + ", countryCode=" + str13 + ", mobileNumber=" + str12 + ", cityId=" + i12 + ", country=" + i13 + ", latitude=" + d11 + ", longitude=" + d12 + ", grl=" + str14 + ", grlId=" + str15 + ")";
    }
}
