...
public final class RiderTipView$special$$inlined$viewModels$1 extends Lambda implements Function0<ViewModelStore> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ View f58803g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public RiderTipView$special$$inlined$viewModels$1(View view) {
        super(0);
        this.f58803g = view;
    }
    ...
    public final ViewModelStore invoke() {
        ViewModelStoreOwner findViewTreeViewModelStoreOwner = ViewTreeViewModelKt.findViewTreeViewModelStoreOwner(this.f58803g);
