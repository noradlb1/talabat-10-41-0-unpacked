...
public final class RiderTipOpened extends TalabatEvent {
    ...
    public RiderTipOpened(@Nullable Double d11, @Nullable String str, @Nullable String str2, @Nullable Integer num, @Nullable String str3) {
