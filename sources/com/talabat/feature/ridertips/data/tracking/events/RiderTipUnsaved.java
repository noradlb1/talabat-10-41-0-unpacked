...
public final class RiderTipUnsaved extends TalabatEvent {
    ...
    public RiderTipUnsaved(@Nullable Double d11, @Nullable String str, @Nullable String str2, @Nullable Integer num, @Nullable String str3) {
