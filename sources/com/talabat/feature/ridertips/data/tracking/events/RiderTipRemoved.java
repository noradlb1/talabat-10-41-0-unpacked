...
public final class RiderTipRemoved extends TalabatEvent {
    ...
    public RiderTipRemoved(@Nullable Double d11, @Nullable String str, @Nullable String str2, @Nullable Integer num, @Nullable String str3) {
