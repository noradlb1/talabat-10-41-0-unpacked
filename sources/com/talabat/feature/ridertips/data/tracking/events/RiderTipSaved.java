...
public final class RiderTipSaved extends TalabatEvent {
    ...
    public RiderTipSaved(@Nullable Double d11, @Nullable String str, @Nullable String str2, @Nullable Integer num, @Nullable String str3) {
