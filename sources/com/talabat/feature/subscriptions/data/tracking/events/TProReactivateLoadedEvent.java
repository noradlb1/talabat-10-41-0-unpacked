...
public final class TProReactivateLoadedEvent extends TProEvent {
    ...
    public TProReactivateLoadedEvent(@NotNull String str, @NotNull String str2, @NotNull String str3) {
    ...
    public String name(@NotNull PlatformName platformName) {
        Intrinsics.checkNotNullParameter(platformName, "platform");
        return TProEvent.NAME_REACTIVATE_LOADED;
    }
