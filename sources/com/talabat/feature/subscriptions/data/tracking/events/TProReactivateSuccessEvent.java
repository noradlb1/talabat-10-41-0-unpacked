...
public final class TProReactivateSuccessEvent extends TProEvent {
    ...
    public TProReactivateSuccessEvent(@NotNull String str, @NotNull String str2, @NotNull String str3) {
    ...
    public Map<String, Object> attributes(@NotNull PlatformName platformName) {
        ...
        return MapsKt__MapsKt.mutableMapOf(TuplesKt.to("screen_type", this.screenType), TuplesKt.to("screen_name", this.screenName), TuplesKt.to("userPreferences", "subscribed:" + str));
    }
    ...
    public String name(@NotNull PlatformName platformName) {
        Intrinsics.checkNotNullParameter(platformName, "platform");
        return TProEvent.NAME_REACTIVATE_SUCCESSFUL;
    }
