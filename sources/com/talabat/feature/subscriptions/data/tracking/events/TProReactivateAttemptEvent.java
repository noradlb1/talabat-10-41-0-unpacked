...
public final class TProReactivateAttemptEvent extends TProEvent {
    ...
    public TProReactivateAttemptEvent(@NotNull String str, @NotNull String str2, @NotNull String str3) {
    ...
    public String name(@NotNull PlatformName platformName) {
        Intrinsics.checkNotNullParameter(platformName, "platform");
        return TProEvent.NAME_REACTIVATE_ATTEMPTED;
    }
