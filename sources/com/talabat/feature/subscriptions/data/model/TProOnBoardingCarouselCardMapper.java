...
import com.talabat.feature.subscriptions.data.remote.model.TProOnBoardingCarouselContentResponseModel;
...
public final class TProOnBoardingCarouselCardMapper implements ModelMapper<TProOnBoardingCarouselCardResponseModel, TProOnBoardingCarouselCardModel> {
    ...
    @Inject
    public TProOnBoardingCarouselCardMapper(@NotNull TProOnBoardingCardSpanningTitleMapper tProOnBoardingCardSpanningTitleMapper2, @NotNull TProOnBoardingCardMoreContentMapper tProOnBoardingCardMoreContentMapper2) {
    ...
    @NotNull
    public TProOnBoardingCarouselCardModel apply(@NotNull TProOnBoardingCarouselCardResponseModel tProOnBoardingCarouselCardResponseModel) {
        String str;
        Intrinsics.checkNotNullParameter(tProOnBoardingCarouselCardResponseModel, "source");
        List<TProOnBoardingCarouselContentResponseModel> content = tProOnBoardingCarouselCardResponseModel.getContent();
        if (content == null) {
            content = CollectionsKt__CollectionsKt.emptyList();
        }
        List<TProOnBoardingTitleSpanningResponseModel> titleSpanning = tProOnBoardingCarouselCardResponseModel.getTitleSpanning();
        ...
        while (true) {
            ...
            String url = ((TProOnBoardingCarouselContentResponseModel) it.next()).getUrl();
            if (url != null) {
                str = url;
            }
            arrayList.add(new TProOnBoardingCarouselContentModel(str));
        }
        String topImage = tProOnBoardingCarouselCardResponseModel.getTopImage();
        String str2 = topImage == null ? str : topImage;
        String trackingId = tProOnBoardingCarouselCardResponseModel.getTrackingId();
        String str3 = trackingId == null ? str : trackingId;
        String cardBackgroundColor = tProOnBoardingCarouselCardResponseModel.getCardBackgroundColor();
        if (cardBackgroundColor == null) {
            cardBackgroundColor = str;
        }
        String cardBackgroundImage = tProOnBoardingCarouselCardResponseModel.getCardBackgroundImage();
        ...
        Boolean haveMore = tProOnBoardingCarouselCardResponseModel.getHaveMore();
        boolean booleanValue = haveMore != null ? haveMore.booleanValue() : false;
        TProOnBoardingMoreContentResponseModel moreContent = tProOnBoardingCarouselCardResponseModel.getMoreContent();
        return new TProOnBoardingCarouselCardModel(arrayList, str2, cardBackgroundColor, cardBackgroundImage, arrayList2, booleanValue, moreContent != null ? this.tProOnBoardingCardMoreContentMapper.apply(moreContent) : null, str3);
    }
}
