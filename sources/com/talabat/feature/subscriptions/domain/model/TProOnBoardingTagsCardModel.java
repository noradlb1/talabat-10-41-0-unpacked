...
public final class TProOnBoardingTagsCardModel extends TProOnBoardingCardModel {
    ...
    public TProOnBoardingTagsCardModel(@NotNull List<TProOnBoardingCardTagsModel> list, @Nullable String str, @NotNull String str2, @Nullable String str3, @NotNull List<TProOnBoardingTitleSpanningModel> list2, boolean z11, @Nullable TProOnBoardingMoreContentModel tProOnBoardingMoreContentModel, @NotNull String str4) {
        super(str4, str, str2, str3, list2, z11, tProOnBoardingMoreContentModel, TProOnBoardingCardType.TAGS, (DefaultConstructorMarker) null);
    ...
    public static /* synthetic */ TProOnBoardingTagsCardModel copy$default(TProOnBoardingTagsCardModel tProOnBoardingTagsCardModel, List list, String str, String str2, String str3, List list2, boolean z11, TProOnBoardingMoreContentModel tProOnBoardingMoreContentModel, String str4, int i11, Object obj) {
        List list3;
        int i12 = i11;
        if ((i12 & 1) != 0) {
            list3 = tProOnBoardingTagsCardModel.content;
        } else {
            TProOnBoardingTagsCardModel tProOnBoardingTagsCardModel2 = tProOnBoardingTagsCardModel;
            list3 = list;
        }
        return tProOnBoardingTagsCardModel.copy(list3, (i12 & 2) != 0 ? tProOnBoardingTagsCardModel.getTopImage() : str, (i12 & 4) != 0 ? tProOnBoardingTagsCardModel.getCardBackgroundColor() : str2, (i12 & 8) != 0 ? tProOnBoardingTagsCardModel.getCardBackgroundImage() : str3, (i12 & 16) != 0 ? tProOnBoardingTagsCardModel.getTitleSpanning() : list2, (i12 & 32) != 0 ? tProOnBoardingTagsCardModel.getHaveMore() : z11, (i12 & 64) != 0 ? tProOnBoardingTagsCardModel.getMoreContent() : tProOnBoardingMoreContentModel, (i12 & 128) != 0 ? tProOnBoardingTagsCardModel.getTrackingId() : str4);
    }
    ...
    public final TProOnBoardingTagsCardModel copy(@NotNull List<TProOnBoardingCardTagsModel> list, @Nullable String str, @NotNull String str2, @Nullable String str3, @NotNull List<TProOnBoardingTitleSpanningModel> list2, boolean z11, @Nullable TProOnBoardingMoreContentModel tProOnBoardingMoreContentModel, @NotNull String str4) {
        ...
        return new TProOnBoardingTagsCardModel(list, str, str2, str3, list2, z11, tProOnBoardingMoreContentModel, str5);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof TProOnBoardingTagsCardModel)) {
            return false;
        }
        TProOnBoardingTagsCardModel tProOnBoardingTagsCardModel = (TProOnBoardingTagsCardModel) obj;
        return Intrinsics.areEqual((Object) this.content, (Object) tProOnBoardingTagsCardModel.content) && Intrinsics.areEqual((Object) getTopImage(), (Object) tProOnBoardingTagsCardModel.getTopImage()) && Intrinsics.areEqual((Object) getCardBackgroundColor(), (Object) tProOnBoardingTagsCardModel.getCardBackgroundColor()) && Intrinsics.areEqual((Object) getCardBackgroundImage(), (Object) tProOnBoardingTagsCardModel.getCardBackgroundImage()) && Intrinsics.areEqual((Object) getTitleSpanning(), (Object) tProOnBoardingTagsCardModel.getTitleSpanning()) && getHaveMore() == tProOnBoardingTagsCardModel.getHaveMore() && Intrinsics.areEqual((Object) getMoreContent(), (Object) tProOnBoardingTagsCardModel.getMoreContent()) && Intrinsics.areEqual((Object) getTrackingId(), (Object) tProOnBoardingTagsCardModel.getTrackingId());
    }
    ...
    public String toString() {
        ...
        return "TProOnBoardingTagsCardModel(content=" + list + ", topImage=" + topImage2 + ", cardBackgroundColor=" + cardBackgroundColor2 + ", cardBackgroundImage=" + cardBackgroundImage2 + ", titleSpanning=" + titleSpanning2 + ", haveMore=" + haveMore2 + ", moreContent=" + moreContent2 + ", trackingId=" + trackingId2 + ")";
    }
}
