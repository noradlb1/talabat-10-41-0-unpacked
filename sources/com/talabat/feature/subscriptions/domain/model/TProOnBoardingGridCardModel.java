...
public final class TProOnBoardingGridCardModel extends TProOnBoardingCardModel {
    ...
    public TProOnBoardingGridCardModel(@NotNull List<TProOnBoardingGridContentModel> list, @Nullable String str, @NotNull String str2, @Nullable String str3, @NotNull List<TProOnBoardingTitleSpanningModel> list2, boolean z11, @Nullable TProOnBoardingMoreContentModel tProOnBoardingMoreContentModel, @NotNull String str4) {
        super(str4, str, str2, str3, list2, z11, tProOnBoardingMoreContentModel, TProOnBoardingCardType.GRID, (DefaultConstructorMarker) null);
        List<TProOnBoardingGridContentModel> list3 = list;
        String str5 = str2;
    ...
    public static /* synthetic */ TProOnBoardingGridCardModel copy$default(TProOnBoardingGridCardModel tProOnBoardingGridCardModel, List list, String str, String str2, String str3, List list2, boolean z11, TProOnBoardingMoreContentModel tProOnBoardingMoreContentModel, String str4, int i11, Object obj) {
        List list3;
        int i12 = i11;
        if ((i12 & 1) != 0) {
            list3 = tProOnBoardingGridCardModel.content;
        } else {
            TProOnBoardingGridCardModel tProOnBoardingGridCardModel2 = tProOnBoardingGridCardModel;
            list3 = list;
        }
        return tProOnBoardingGridCardModel.copy(list3, (i12 & 2) != 0 ? tProOnBoardingGridCardModel.getTopImage() : str, (i12 & 4) != 0 ? tProOnBoardingGridCardModel.getCardBackgroundColor() : str2, (i12 & 8) != 0 ? tProOnBoardingGridCardModel.getCardBackgroundImage() : str3, (i12 & 16) != 0 ? tProOnBoardingGridCardModel.getTitleSpanning() : list2, (i12 & 32) != 0 ? tProOnBoardingGridCardModel.getHaveMore() : z11, (i12 & 64) != 0 ? tProOnBoardingGridCardModel.getMoreContent() : tProOnBoardingMoreContentModel, (i12 & 128) != 0 ? tProOnBoardingGridCardModel.getTrackingId() : str4);
    }

    @NotNull
    public final List<TProOnBoardingGridContentModel> component1() {
        return this.content;
    }
    ...
    public final TProOnBoardingGridCardModel copy(@NotNull List<TProOnBoardingGridContentModel> list, @Nullable String str, @NotNull String str2, @Nullable String str3, @NotNull List<TProOnBoardingTitleSpanningModel> list2, boolean z11, @Nullable TProOnBoardingMoreContentModel tProOnBoardingMoreContentModel, @NotNull String str4) {
        ...
        return new TProOnBoardingGridCardModel(list, str, str2, str3, list2, z11, tProOnBoardingMoreContentModel, str5);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof TProOnBoardingGridCardModel)) {
            return false;
        }
        TProOnBoardingGridCardModel tProOnBoardingGridCardModel = (TProOnBoardingGridCardModel) obj;
        return Intrinsics.areEqual((Object) this.content, (Object) tProOnBoardingGridCardModel.content) && Intrinsics.areEqual((Object) getTopImage(), (Object) tProOnBoardingGridCardModel.getTopImage()) && Intrinsics.areEqual((Object) getCardBackgroundColor(), (Object) tProOnBoardingGridCardModel.getCardBackgroundColor()) && Intrinsics.areEqual((Object) getCardBackgroundImage(), (Object) tProOnBoardingGridCardModel.getCardBackgroundImage()) && Intrinsics.areEqual((Object) getTitleSpanning(), (Object) tProOnBoardingGridCardModel.getTitleSpanning()) && getHaveMore() == tProOnBoardingGridCardModel.getHaveMore() && Intrinsics.areEqual((Object) getMoreContent(), (Object) tProOnBoardingGridCardModel.getMoreContent()) && Intrinsics.areEqual((Object) getTrackingId(), (Object) tProOnBoardingGridCardModel.getTrackingId());
    }
    ...
    @NotNull
    public final List<TProOnBoardingGridContentModel> getContent() {
        return this.content;
    }
    ...
    public final void setContent(@NotNull List<TProOnBoardingGridContentModel> list) {
    ...
    public String toString() {
        List<TProOnBoardingGridContentModel> list = this.content;
        ...
        return "TProOnBoardingGridCardModel(content=" + list + ", topImage=" + topImage2 + ", cardBackgroundColor=" + cardBackgroundColor2 + ", cardBackgroundImage=" + cardBackgroundImage2 + ", titleSpanning=" + titleSpanning2 + ", haveMore=" + haveMore2 + ", moreContent=" + moreContent2 + ", trackingId=" + trackingId2 + ")";
    }
}
