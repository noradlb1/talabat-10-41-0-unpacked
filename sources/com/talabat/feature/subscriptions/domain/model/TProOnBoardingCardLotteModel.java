...
public final class TProOnBoardingCardLotteModel extends TProOnBoardingCardModel {
    ...
    public TProOnBoardingCardLotteModel(@NotNull List<TProOnBoardingCardLotteContentModel> list, @Nullable String str, @NotNull String str2, @Nullable String str3, @NotNull List<TProOnBoardingTitleSpanningModel> list2, boolean z11, @Nullable TProOnBoardingMoreContentModel tProOnBoardingMoreContentModel, @NotNull String str4) {
        super(str4, str, str2, str3, list2, z11, tProOnBoardingMoreContentModel, TProOnBoardingCardType.LOTTIE, (DefaultConstructorMarker) null);
        List<TProOnBoardingCardLotteContentModel> list3 = list;
        String str5 = str2;
    ...
    public static /* synthetic */ TProOnBoardingCardLotteModel copy$default(TProOnBoardingCardLotteModel tProOnBoardingCardLotteModel, List list, String str, String str2, String str3, List list2, boolean z11, TProOnBoardingMoreContentModel tProOnBoardingMoreContentModel, String str4, int i11, Object obj) {
        List list3;
        int i12 = i11;
        if ((i12 & 1) != 0) {
            list3 = tProOnBoardingCardLotteModel.content;
        } else {
            TProOnBoardingCardLotteModel tProOnBoardingCardLotteModel2 = tProOnBoardingCardLotteModel;
            list3 = list;
        }
        return tProOnBoardingCardLotteModel.copy(list3, (i12 & 2) != 0 ? tProOnBoardingCardLotteModel.getTopImage() : str, (i12 & 4) != 0 ? tProOnBoardingCardLotteModel.getCardBackgroundColor() : str2, (i12 & 8) != 0 ? tProOnBoardingCardLotteModel.getCardBackgroundImage() : str3, (i12 & 16) != 0 ? tProOnBoardingCardLotteModel.getTitleSpanning() : list2, (i12 & 32) != 0 ? tProOnBoardingCardLotteModel.getHaveMore() : z11, (i12 & 64) != 0 ? tProOnBoardingCardLotteModel.getMoreContent() : tProOnBoardingMoreContentModel, (i12 & 128) != 0 ? tProOnBoardingCardLotteModel.getTrackingId() : str4);
    }

    @NotNull
    public final List<TProOnBoardingCardLotteContentModel> component1() {
        return this.content;
    }
    ...
    @NotNull
    public final TProOnBoardingCardLotteModel copy(@NotNull List<TProOnBoardingCardLotteContentModel> list, @Nullable String str, @NotNull String str2, @Nullable String str3, @NotNull List<TProOnBoardingTitleSpanningModel> list2, boolean z11, @Nullable TProOnBoardingMoreContentModel tProOnBoardingMoreContentModel, @NotNull String str4) {
        ...
        return new TProOnBoardingCardLotteModel(list, str, str2, str3, list2, z11, tProOnBoardingMoreContentModel, str5);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof TProOnBoardingCardLotteModel)) {
            return false;
        }
        TProOnBoardingCardLotteModel tProOnBoardingCardLotteModel = (TProOnBoardingCardLotteModel) obj;
        return Intrinsics.areEqual((Object) this.content, (Object) tProOnBoardingCardLotteModel.content) && Intrinsics.areEqual((Object) getTopImage(), (Object) tProOnBoardingCardLotteModel.getTopImage()) && Intrinsics.areEqual((Object) getCardBackgroundColor(), (Object) tProOnBoardingCardLotteModel.getCardBackgroundColor()) && Intrinsics.areEqual((Object) getCardBackgroundImage(), (Object) tProOnBoardingCardLotteModel.getCardBackgroundImage()) && Intrinsics.areEqual((Object) getTitleSpanning(), (Object) tProOnBoardingCardLotteModel.getTitleSpanning()) && getHaveMore() == tProOnBoardingCardLotteModel.getHaveMore() && Intrinsics.areEqual((Object) getMoreContent(), (Object) tProOnBoardingCardLotteModel.getMoreContent()) && Intrinsics.areEqual((Object) getTrackingId(), (Object) tProOnBoardingCardLotteModel.getTrackingId());
    }
    ...
    @NotNull
    public final List<TProOnBoardingCardLotteContentModel> getContent() {
        return this.content;
    }
    ...
    public final void setContent(@NotNull List<TProOnBoardingCardLotteContentModel> list) {
    ...
    public String toString() {
        List<TProOnBoardingCardLotteContentModel> list = this.content;
        ...
        return "TProOnBoardingCardLotteModel(content=" + list + ", topImage=" + topImage2 + ", cardBackgroundColor=" + cardBackgroundColor2 + ", cardBackgroundImage=" + cardBackgroundImage2 + ", titleSpanning=" + titleSpanning2 + ", haveMore=" + haveMore2 + ", moreContent=" + moreContent2 + ", trackingId=" + trackingId2 + ")";
    }
}
