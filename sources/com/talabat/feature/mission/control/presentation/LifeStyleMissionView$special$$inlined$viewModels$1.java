...
public final class LifeStyleMissionView$special$$inlined$viewModels$1 extends Lambda implements Function0<ViewModelStore> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ View f58591g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LifeStyleMissionView$special$$inlined$viewModels$1(View view) {
        super(0);
        this.f58591g = view;
    }
    ...
    public final ViewModelStore invoke() {
        ViewModelStoreOwner findViewTreeViewModelStoreOwner = ViewTreeViewModelKt.findViewTreeViewModelStoreOwner(this.f58591g);
