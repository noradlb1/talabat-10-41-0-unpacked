...
import com.talabat.feature.mission.control.presentation.databinding.OneLifeStyleMissionItemBinding;
...
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\u00020\u0001B%\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0016\u0010\u0018\u001a\u00020\u00122\u0006\u0010\u0019\u001a\u00020\u001a2\u0006\u0010\u0011\u001a\u00020\u0007J\u0016\u0010\u0018\u001a\u00020\u00122\u0006\u0010\u0019\u001a\u00020\u001b2\u0006\u0010\u0011\u001a\u00020\u0007R\u000e\u0010\t\u001a\u00020\nX\u0004¢\u0006\u0002\n\u0000Rg\u0010\u000b\u001aO\u0012\u0013\u0012\u00110\r¢\u0006\f\b\u000e\u0012\b\b\u000f\u0012\u0004\b\b(\u0010\u0012\u0013\u0012\u00110\r¢\u0006\f\b\u000e\u0012\b\b\u000f\u0012\u0004\b\b(\u000f\u0012\u0013\u0012\u00110\u0007¢\u0006\f\b\u000e\u0012\b\b\u000f\u0012\u0004\b\b(\u0011\u0012\u0004\u0012\u00020\u0012\u0018\u00010\fj\u0004\u0018\u0001`\u0013X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0014\u0010\u0015\"\u0004\b\u0016\u0010\u0017¨\u0006\u001c"}, d2 = {"Lcom/talabat/feature/mission/control/presentation/OneLifeStyleMissionItem;", "Lcom/google/android/material/card/MaterialCardView;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "defStyle", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "binding", "Lcom/talabat/feature/mission/control/presentation/databinding/OneLifeStyleMissionItemBinding;", "missionClickListener", "Lkotlin/Function3;", "", "Lkotlin/ParameterName;", "name", "code", "position", "", "Lcom/talabat/feature/mission/control/presentation/listener/MissionClickListener;", "getMissionClickListener", "()Lkotlin/jvm/functions/Function3;", "setMissionClickListener", "(Lkotlin/jvm/functions/Function3;)V", "setContent", "lifeStyleMission", "Lcom/talabat/feature/darkstores/vendorlanding/domain/model/LifestyleMissionItem;", "Lcom/talabat/feature/mission/control/domain/model/LifeStyleMissionControlData;", "com_talabat_feature_mission-control_presentation_presentation"}, k = 1, mv = {1, 6, 0}, xi = 48)
public final class OneLifeStyleMissionItem extends MaterialCardView {
    @NotNull
    private final OneLifeStyleMissionItemBinding binding;
    @Nullable
    private Function3<? super String, ? super String, ? super Integer, Unit> missionClickListener;

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public OneLifeStyleMissionItem(@NotNull Context context) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public OneLifeStyleMissionItem(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ OneLifeStyleMissionItem(Context context, AttributeSet attributeSet, int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i12 & 2) != 0 ? null : attributeSet, (i12 & 4) != 0 ? 0 : i11);
    }

    /* access modifiers changed from: private */
    /* renamed from: setContent$lambda-1  reason: not valid java name */
    public static final void m10223setContent$lambda1(OneLifeStyleMissionItem oneLifeStyleMissionItem, LifeStyleMissionControlData lifeStyleMissionControlData, int i11, View view) {
        Intrinsics.checkNotNullParameter(oneLifeStyleMissionItem, "this$0");
        Intrinsics.checkNotNullParameter(lifeStyleMissionControlData, "$lifeStyleMission");
        Function3<? super String, ? super String, ? super Integer, Unit> function3 = oneLifeStyleMissionItem.missionClickListener;
        if (function3 != null) {
    ...
    public static final void m10224setContent$lambda3(OneLifeStyleMissionItem oneLifeStyleMissionItem, LifestyleMissionItem lifestyleMissionItem, int i11, View view) {
        Intrinsics.checkNotNullParameter(oneLifeStyleMissionItem, "this$0");
        Intrinsics.checkNotNullParameter(lifestyleMissionItem, "$lifeStyleMission");
        Function3<? super String, ? super String, ? super Integer, Unit> function3 = oneLifeStyleMissionItem.missionClickListener;
        if (function3 != null) {
    ...
    public final void setContent(@NotNull LifeStyleMissionControlData lifeStyleMissionControlData, int i11) {
        ...
        this.binding.subtitle.setText(lifeStyleMissionControlData.getText());
        TextView textView = this.binding.subtitle;
        Intrinsics.checkNotNullExpressionValue(textView, "binding.subtitle");
        textView.setVisibility(StringsKt__StringsJVMKt.isBlank(lifeStyleMissionControlData.getText()) ^ true ? 0 : 8);
        ...
        this.binding.containerView.setOnClickListener(new c(this, lifeStyleMissionControlData, i11));
    }
    ...
    @JvmOverloads
    public OneLifeStyleMissionItem(@NotNull Context context, @Nullable AttributeSet attributeSet, int i11) {
        super(context, attributeSet, i11);
        Intrinsics.checkNotNullParameter(context, "context");
        OneLifeStyleMissionItemBinding inflate = OneLifeStyleMissionItemBinding.inflate(LayoutInflater.from(context), this);
    ...
    public final void setContent(@NotNull LifestyleMissionItem lifestyleMissionItem, int i11) {
        Intrinsics.checkNotNullParameter(lifestyleMissionItem, "lifeStyleMission");
        ConstraintLayout constraintLayout = this.binding.containerView;
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "context");
        constraintLayout.setBackgroundColor(MissionControlExtensionsKt.getBackgroundColor(lifestyleMissionItem, context));
        this.binding.title.setText(lifestyleMissionItem.getName());
        this.binding.subtitle.setText(lifestyleMissionItem.getText());
        TextView textView = this.binding.subtitle;
        Intrinsics.checkNotNullExpressionValue(textView, "binding.subtitle");
        textView.setVisibility(StringsKt__StringsJVMKt.isBlank(lifestyleMissionItem.getText()) ^ true ? 0 : 8);
        AppCompatImageView appCompatImageView = this.binding.image;
        Intrinsics.checkNotNullExpressionValue(appCompatImageView, "binding.image");
        ImageViewExtensionsKt.loadCenterInsideWithGlide(appCompatImageView, lifestyleMissionItem.getImageUrl());
        this.binding.containerView.setOnClickListener(new d(this, lifestyleMissionItem, i11));
    }
}
