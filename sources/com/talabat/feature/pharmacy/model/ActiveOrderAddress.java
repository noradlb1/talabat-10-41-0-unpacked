...
public final class ActiveOrderAddress implements Serializable {
    ...
    public static /* synthetic */ ActiveOrderAddress copy$default(ActiveOrderAddress activeOrderAddress, String str, int i11, String str2, String str3, String str4, int i12, int i13, String str5, String str6, String str7, String str8, String str9, String str10, String str11, boolean z11, boolean z12, boolean z13, String str12, double d11, double d12, String str13, String str14, String str15, String str16, String str17, String str18, int i14, int i15, Object obj) {
        ActiveOrderAddress activeOrderAddress2 = activeOrderAddress;
        int i16 = i15;
        return activeOrderAddress.copy((i16 & 1) != 0 ? activeOrderAddress2.f58630id : str, (i16 & 2) != 0 ? activeOrderAddress2.areaId : i11, (i16 & 4) != 0 ? activeOrderAddress2.areaName : str2, (i16 & 8) != 0 ? activeOrderAddress2.block : str3, (i16 & 16) != 0 ? activeOrderAddress2.buildingNo : str4, (i16 & 32) != 0 ? activeOrderAddress2.cityId : i12, (i16 & 64) != 0 ? activeOrderAddress2.countyId : i13, (i16 & 128) != 0 ? activeOrderAddress2.countryName : str5, (i16 & 256) != 0 ? activeOrderAddress2.extraDirections : str6, (i16 & 512) != 0 ? activeOrderAddress2.floor : str7, (i16 & 1024) != 0 ? activeOrderAddress2.geoAddressMsg : str8, (i16 & 2048) != 0 ? activeOrderAddress2.geoAddressTitle : str9, (i16 & 4096) != 0 ? activeOrderAddress2.grl : str10, (i16 & 8192) != 0 ? activeOrderAddress2.grlid : str11, (i16 & 16384) != 0 ? activeOrderAddress2.isAreaSplit : z11, (i16 & 32768) != 0 ? activeOrderAddress2.isDeliverable : z12, (i16 & 65536) != 0 ? activeOrderAddress2.isOldAddreses : z13, (i16 & 131072) != 0 ? activeOrderAddress2.judda : str12, (i16 & 262144) != 0 ? activeOrderAddress2.latitude : d11, (i16 & 524288) != 0 ? activeOrderAddress2.longitude : d12, (i16 & 1048576) != 0 ? activeOrderAddress2.mobileNumber : str13, (2097152 & i16) != 0 ? activeOrderAddress2.mobilNumberCountryCode : str14, (i16 & 4194304) != 0 ? activeOrderAddress2.phoneNumber : str15, (i16 & 8388608) != 0 ? activeOrderAddress2.profileName : str16, (i16 & 16777216) != 0 ? activeOrderAddress2.street : str17, (i16 & 33554432) != 0 ? activeOrderAddress2.suite : str18, (i16 & 67108864) != 0 ? activeOrderAddress2.type : i14);
    }

    @NotNull
    public final String component1() {
        return this.f58630id;
    }
    ...
    @NotNull
    public final ActiveOrderAddress copy(@NotNull String str, int i11, @Nullable String str2, @Nullable String str3, @Nullable String str4, int i12, int i13, @Nullable String str5, @Nullable String str6, @Nullable String str7, @Nullable String str8, @Nullable String str9, @Nullable String str10, @Nullable String str11, boolean z11, boolean z12, boolean z13, @Nullable String str12, double d11, double d12, @Nullable String str13, @Nullable String str14, @Nullable String str15, @Nullable String str16, @Nullable String str17, @Nullable String str18, int i14) {
        String str19 = str;
        String str20 = str19;
        Intrinsics.checkNotNullParameter(str19, "id");
        return new ActiveOrderAddress(str19, i11, str2, str3, str4, i12, i13, str5, str6, str7, str8, str9, str10, str11, z11, z12, z13, str12, d11, d12, str13, str14, str15, str16, str17, str18, i14);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof ActiveOrderAddress)) {
            return false;
        }
        ActiveOrderAddress activeOrderAddress = (ActiveOrderAddress) obj;
        return Intrinsics.areEqual((Object) this.f58630id, (Object) activeOrderAddress.f58630id) && this.areaId == activeOrderAddress.areaId && Intrinsics.areEqual((Object) this.areaName, (Object) activeOrderAddress.areaName) && Intrinsics.areEqual((Object) this.block, (Object) activeOrderAddress.block) && Intrinsics.areEqual((Object) this.buildingNo, (Object) activeOrderAddress.buildingNo) && this.cityId == activeOrderAddress.cityId && this.countyId == activeOrderAddress.countyId && Intrinsics.areEqual((Object) this.countryName, (Object) activeOrderAddress.countryName) && Intrinsics.areEqual((Object) this.extraDirections, (Object) activeOrderAddress.extraDirections) && Intrinsics.areEqual((Object) this.floor, (Object) activeOrderAddress.floor) && Intrinsics.areEqual((Object) this.geoAddressMsg, (Object) activeOrderAddress.geoAddressMsg) && Intrinsics.areEqual((Object) this.geoAddressTitle, (Object) activeOrderAddress.geoAddressTitle) && Intrinsics.areEqual((Object) this.grl, (Object) activeOrderAddress.grl) && Intrinsics.areEqual((Object) this.grlid, (Object) activeOrderAddress.grlid) && this.isAreaSplit == activeOrderAddress.isAreaSplit && this.isDeliverable == activeOrderAddress.isDeliverable && this.isOldAddreses == activeOrderAddress.isOldAddreses && Intrinsics.areEqual((Object) this.judda, (Object) activeOrderAddress.judda) && Intrinsics.areEqual((Object) Double.valueOf(this.latitude), (Object) Double.valueOf(activeOrderAddress.latitude)) && Intrinsics.areEqual((Object) Double.valueOf(this.longitude), (Object) Double.valueOf(activeOrderAddress.longitude)) && Intrinsics.areEqual((Object) this.mobileNumber, (Object) activeOrderAddress.mobileNumber) && Intrinsics.areEqual((Object) this.mobilNumberCountryCode, (Object) activeOrderAddress.mobilNumberCountryCode) && Intrinsics.areEqual((Object) this.phoneNumber, (Object) activeOrderAddress.phoneNumber) && Intrinsics.areEqual((Object) this.profileName, (Object) activeOrderAddress.profileName) && Intrinsics.areEqual((Object) this.street, (Object) activeOrderAddress.street) && Intrinsics.areEqual((Object) this.suite, (Object) activeOrderAddress.suite) && this.type == activeOrderAddress.type;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f58630id.hashCode() * 31) + this.areaId) * 31;
    ...
    public final Map<String, Object> toMap() {
        return MapsKt__MapsKt.mapOf(TuplesKt.to("id", this.f58630id), TuplesKt.to("areaId", Integer.valueOf(this.areaId)), TuplesKt.to("areaName", this.areaName), TuplesKt.to("block", this.block), TuplesKt.to("buildingNo", this.buildingNo), TuplesKt.to("cityId", Integer.valueOf(this.cityId)), TuplesKt.to("countyId", Integer.valueOf(this.countyId)), TuplesKt.to("countryName", this.countryName), TuplesKt.to("extraDirections", this.extraDirections), TuplesKt.to(LogWriteConstants.FLOOR, this.floor), TuplesKt.to("geoAddressMsg", this.geoAddressMsg), TuplesKt.to("grl", this.grl), TuplesKt.to("isAreaSplit", Boolean.valueOf(this.isAreaSplit)), TuplesKt.to("isDeliverable", Boolean.valueOf(this.isDeliverable)), TuplesKt.to("isOldAddreses", Boolean.valueOf(this.isOldAddreses)), TuplesKt.to("latitude", Double.valueOf(this.latitude)), TuplesKt.to("longitude", Double.valueOf(this.longitude)), TuplesKt.to("mobileNumber", this.mobileNumber), TuplesKt.to("mobilNumberCountryCode", this.mobilNumberCountryCode), TuplesKt.to(HintConstants.AUTOFILL_HINT_PHONE_NUMBER, this.phoneNumber), TuplesKt.to(Profile.PROFILE_NAME, this.profileName), TuplesKt.to(Address.KEY_STREET, this.street), TuplesKt.to(BaseTestRunner.SUITE_METHODNAME, this.suite), TuplesKt.to("type", Integer.valueOf(this.type)));
    }

    @NotNull
    public String toString() {
        String str = this.f58630id;
        int i11 = this.areaId;
    ...
    public /* synthetic */ ActiveOrderAddress(java.lang.String r31, int r32, java.lang.String r33, java.lang.String r34, java.lang.String r35, int r36, int r37, java.lang.String r38, java.lang.String r39, java.lang.String r40, java.lang.String r41, java.lang.String r42, java.lang.String r43, java.lang.String r44, boolean r45, boolean r46, boolean r47, java.lang.String r48, double r49, double r51, java.lang.String r53, java.lang.String r54, java.lang.String r55, java.lang.String r56, java.lang.String r57, java.lang.String r58, int r59, int r60, kotlin.jvm.internal.DefaultConstructorMarker r61) {
        /*
            r30 = this;
            r0 = r60
            r1 = r0 & 1
        ...
        L_0x00ff:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.talabat.feature.pharmacy.model.ActiveOrderAddress.<init>(java.lang.String, int, java.lang.String, java.lang.String, java.lang.String, int, int, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, boolean, boolean, boolean, java.lang.String, double, double, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, int, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
}
