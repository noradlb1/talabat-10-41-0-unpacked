...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u000f\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0017\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u00062\u0006\u0010\b\u001a\u00020\tH\u0002R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lcom/talabat/feature/darkstorestooltip/domain/usecase/WasTooltipAlreadyShownImpl;", "Lcom/talabat/feature/darkstorestooltip/domain/usecase/WasTooltipAlreadyShown;", "repository", "Lcom/talabat/feature/darkstorestooltip/domain/di/DarkstoresTooltipRepository;", "(Lcom/talabat/feature/darkstorestooltip/domain/di/DarkstoresTooltipRepository;)V", "invoke", "Lio/reactivex/Single;", "", "key", "Lcom/talabat/feature/darkstorestooltip/domain/model/TooltipKey;", "com_talabat_feature_darkstores-tooltip_domain_domain"}, k = 1, mv = {1, 6, 0}, xi = 48)
public final class WasTooltipAlreadyShownImpl implements WasTooltipAlreadyShown {
    @NotNull
    private final DarkstoresTooltipRepository repository;

    @Inject
    public WasTooltipAlreadyShownImpl(@NotNull DarkstoresTooltipRepository darkstoresTooltipRepository) {
        Intrinsics.checkNotNullParameter(darkstoresTooltipRepository, "repository");
        this.repository = darkstoresTooltipRepository;
    }

    @NotNull
    public Single<Boolean> invoke(@NotNull TooltipKey tooltipKey) {
        Intrinsics.checkNotNullParameter(tooltipKey, "key");
        return this.repository.wasTooltipAlreadyShown(tooltipKey);
    }
}
