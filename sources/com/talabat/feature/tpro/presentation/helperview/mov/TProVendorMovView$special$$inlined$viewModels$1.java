...
public final class TProVendorMovView$special$$inlined$viewModels$1 extends Lambda implements Function0<ViewModelStore> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ View f59287g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TProVendorMovView$special$$inlined$viewModels$1(View view) {
        super(0);
        this.f59287g = view;
    }
    ...
    public final ViewModelStore invoke() {
        ViewModelStoreOwner findViewTreeViewModelStoreOwner = ViewTreeViewModelKt.findViewTreeViewModelStoreOwner(this.f59287g);
