...
public final class ItemCapsulesBenefitCardBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public final RecyclerView rvContentCapsule;
    @NonNull
    public final TextView tvCapsulesBanner;

    private ItemCapsulesBenefitCardBinding(@NonNull CardView cardView, @NonNull ProOnboardingButtonBinding proOnboardingButtonBinding, @NonNull ConstraintLayout constraintLayout, @NonNull Group group, @NonNull Guideline guideline, @NonNull Guideline guideline2, @NonNull Guideline guideline3, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull OnBoardingCardLearnMoreView onBoardingCardLearnMoreView, @NonNull RecyclerView recyclerView, @NonNull TextView textView) {
        ...
        this.rvContentCapsule = recyclerView;
        this.tvCapsulesBanner = textView;
    }

    @NonNull
    public static ItemCapsulesBenefitCardBinding bind(@NonNull View view) {
                                ...
                                if (imageView != null) {
                                    ...
                                    if (imageView2 != null) {
                                        ...
                                        if (onBoardingCardLearnMoreView != null) {
                                            i11 = R.id.rv_content_capsule;
                                            RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(view, i11);
                                            if (recyclerView != null) {
                                                i11 = R.id.tv_capsules_banner;
                                                TextView textView = (TextView) ViewBindings.findChildViewById(view, i11);
                                                if (textView != null) {
                                                    return new ItemCapsulesBenefitCardBinding((CardView) view, bind, constraintLayout, group, guideline, guideline2, guideline3, imageView, imageView2, onBoardingCardLearnMoreView, recyclerView, textView);
                                                }
                                            }
                                        }
                                    }
    ...
    @NonNull
    public static ItemCapsulesBenefitCardBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    @NonNull
    public static ItemCapsulesBenefitCardBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z11) {
        View inflate = layoutInflater.inflate(R.layout.item_capsules_benefit_card, viewGroup, false);
        if (z11) {
