...
public final class ItemCarouselBenefitCardBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public final AutoScrollRecyclerView rvContentCarousel;
    @NonNull
    public final TextView tvCarouselBanner;

    private ItemCarouselBenefitCardBinding(@NonNull CardView cardView, @NonNull ProOnboardingButtonBinding proOnboardingButtonBinding, @NonNull ConstraintLayout constraintLayout, @NonNull Group group, @NonNull Guideline guideline, @NonNull Guideline guideline2, @NonNull Guideline guideline3, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull OnBoardingCardLearnMoreView onBoardingCardLearnMoreView, @NonNull AutoScrollRecyclerView autoScrollRecyclerView, @NonNull TextView textView) {
        ...
        this.rvContentCarousel = autoScrollRecyclerView;
        this.tvCarouselBanner = textView;
    }

    @NonNull
    public static ItemCarouselBenefitCardBinding bind(@NonNull View view) {
                                ...
                                if (imageView != null) {
                                    ...
                                    if (imageView2 != null) {
                                        ...
                                        if (onBoardingCardLearnMoreView != null) {
                                            i11 = R.id.rv_content_carousel;
                                            AutoScrollRecyclerView autoScrollRecyclerView = (AutoScrollRecyclerView) ViewBindings.findChildViewById(view, i11);
                                            if (autoScrollRecyclerView != null) {
                                                i11 = R.id.tv_carousel_banner;
                                                TextView textView = (TextView) ViewBindings.findChildViewById(view, i11);
                                                if (textView != null) {
                                                    return new ItemCarouselBenefitCardBinding((CardView) view, bind, constraintLayout, group, guideline, guideline2, guideline3, imageView, imageView2, onBoardingCardLearnMoreView, autoScrollRecyclerView, textView);
                                                }
                                            }
                                        }
                                    }
    ...
    @NonNull
    public static ItemCarouselBenefitCardBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    @NonNull
    public static ItemCarouselBenefitCardBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z11) {
        View inflate = layoutInflater.inflate(R.layout.item_carousel_benefit_card, viewGroup, false);
        if (z11) {
