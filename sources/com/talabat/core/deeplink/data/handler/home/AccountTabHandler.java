...
public final class AccountTabHandler implements Handler {
    ...
    public void handle(@NotNull Context context, @NotNull ParsedLinkModel parsedLinkModel) {
        ...
        boolean z11 = !StringsKt__StringsJVMKt.equals(this.talabatExperiment.getStringVariant(HomePageExperimentsKeys.FLUTTER_ACCOUNT_TAB, "Control", TalabatExperimentDataSourceStrategy.FWF), "Control", true);
        Navigator navigator2 = this.navigator;
        if (z11) {
            navigationTab = HomeScreen.NavigationTab.FLUTTER_ACCOUNT;
        } else {
            navigationTab = HomeScreen.NavigationTab.ACCOUNT;
        }
        Navigator.DefaultImpls.navigateTo$default(navigator2, context, new HomeScreen(new HomeScreen.HomeScreenData(navigationTab, false, 2, (DefaultConstructorMarker) null)), (Function1) null, 4, (Object) null);
    }
}
