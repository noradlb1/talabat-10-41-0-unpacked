...
public final class WalletDashboardOldHandler implements Handler {
    ...
    @NotNull
    private final String screenName = "wdash";
    @NotNull
    private final ITalabatFeatureFlag talabatFeatureFlag;

    public WalletDashboardOldHandler(@NotNull Navigator navigator2, @NotNull ITalabatFeatureFlag iTalabatFeatureFlag, @NotNull CustomerRepository customerRepository2, @NotNull IObservabilityManager iObservabilityManager) {
