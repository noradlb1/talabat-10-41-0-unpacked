...
public final class QCommerceDarkstoreDeeplinkHandler extends QCommerceDeeplinkHandler {
    ...
    public Object canHandle(@NotNull ParsedLinkModel parsedLinkModel, @NotNull Continuation<? super Boolean> continuation) {
        if (Intrinsics.areEqual((Object) parsedLinkModel.getScreenName(), (Object) getScreenName())) {
    ...
    public void handle(@NotNull Context context, @NotNull ParsedLinkModel parsedLinkModel) {
        ...
        b(context, "nearest_darkstore", parsedLinkModel);
    }
}
