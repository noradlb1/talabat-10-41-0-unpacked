...
import com.talabat.core.navigation.domain.screen.usersupport.GlobalHelpCenterScreen;
...
public final class GlobalHelpCenterHandler implements Handler {
    ...
    public void handle(@NotNull Context context, @NotNull ParsedLinkModel parsedLinkModel) {
        ...
        this.navigator.navigateTo(context, new GlobalHelpCenterScreen((Void) null, 1, (DefaultConstructorMarker) null), new GlobalHelpCenterHandler$handle$1(parsedLinkModel, context.getPackageManager().getPackageInfo(context.getPackageName(), 0)));
    }
}
