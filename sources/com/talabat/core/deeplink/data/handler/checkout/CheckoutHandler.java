package com.talabat.core.deeplink.data.handler.checkout;
...
import com.talabat.core.navigation.domain.screen.checkout.CheckoutScreen;
...
public final class CheckoutHandler implements Handler {
    ...
    public void handle(@NotNull Context context, @NotNull ParsedLinkModel parsedLinkModel) {
        ...
        Navigator.DefaultImpls.navigateTo$default(this.navigator, context, new CheckoutScreen((Void) null, 1, (DefaultConstructorMarker) null), (Function1) null, 4, (Object) null);
    }
}
