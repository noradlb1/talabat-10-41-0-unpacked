...
public final class BNPLDashboardHandler implements Handler {
    ...
    public void handle(@NotNull Context context, @NotNull ParsedLinkModel parsedLinkModel) {
        ...
        String str = (String) Map.EL.getOrDefault(parsedLinkModel.getData(), "eo", "notifications");
        if (this.customerRepository.isLoggedIn()) {
            Navigator navigator2 = this.navigator;
            Navigator.DefaultImpls.navigateTo$default(navigator2, context, new FlutterScreen(new FlutterScreen.FlutterScreenData("bnpl-dashboard/" + str)), (Function1) null, 4, (Object) null);
            return;
        }
        this.navigator.navigateTo(context, new LoginScreen((Void) null, 1, (DefaultConstructorMarker) null), BNPLDashboardHandler$handle$1.INSTANCE);
    }
}
