package com.talabat.core.deeplink.data.handler.aboutus;
...
import com.talabat.core.navigation.domain.screen.aboutus.AboutUsScreen;
...
public final class AboutUsHandler implements Handler {
    ...
    public void handle(@NotNull Context context, @NotNull ParsedLinkModel parsedLinkModel) {
        ...
        Navigator.DefaultImpls.navigateTo$default(this.navigator, context, new AboutUsScreen(), (Function1) null, 4, (Object) null);
    }
}
