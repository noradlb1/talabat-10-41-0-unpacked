package com.talabat.core.deeplink.data.handler.referfriend;
...
import com.talabat.core.navigation.domain.screen.referfriend.ReferAFriendSenderScreen;
...
public final class ReferAFriendSenderHandler implements Handler {
    ...
    public void handle(@NotNull Context context, @NotNull ParsedLinkModel parsedLinkModel) {
        ...
        Navigator.DefaultImpls.navigateTo$default(this.navigator, context, new ReferAFriendSenderScreen((Void) null, 1, (DefaultConstructorMarker) null), (Function1) null, 4, (Object) null);
    }
}
