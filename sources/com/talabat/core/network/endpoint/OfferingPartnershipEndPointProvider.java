...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\b\b\u0007\u0018\u00002\u00020\u0001B\u0019\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0004\u001a\u00020\u0003¢\u0006\u0002\u0010\u0005R\u000e\u0010\u0006\u001a\u00020\u0003XD¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0003XD¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\u00020\u0003X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Lcom/talabat/core/network/endpoint/OfferingPartnershipEndPointProvider;", "Lcom/talabat/core/network/endpoint/EndPointProvider;", "server", "", "buildType", "(Ljava/lang/String;Ljava/lang/String;)V", "BASE_URL_PROD", "BASE_URL_QA", "baseUrl", "getBaseUrl", "()Ljava/lang/String;", "com_talabat_core_network_data_data"}, k = 1, mv = {1, 6, 0}, xi = 48)
...
public final class OfferingPartnershipEndPointProvider extends EndPointProvider {
    @NotNull
    private final String BASE_URL_PROD;
    @NotNull
    private final String BASE_URL_QA;
    @NotNull
    ...
    public OfferingPartnershipEndPointProvider() {
        this((String) null, (String) null, 3, (DefaultConstructorMarker) null);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ OfferingPartnershipEndPointProvider(String str, String str2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public OfferingPartnershipEndPointProvider(@NotNull String str, @NotNull String str2) {
        super(str, str2);
        Intrinsics.checkNotNullParameter(str, "server");
        Intrinsics.checkNotNullParameter(str2, "buildType");
        String str3 = "https://api-qa.dhhmena.com/partnership/";
        this.BASE_URL_QA = str3;
        this.BASE_URL_PROD = "https://api.talabat.com/partnership/";
        int i11 = WhenMappings.$EnumSwitchMapping$0[getEndpointEnvironment().ordinal()];
        if (i11 == 1) {
            str3 = "https://api.talabat.com/partnership/";
        } else if (i11 != 2) {
            if (i11 == 3) {
