package com.talabat.core.flutter.channels.data.vendor;
...
public final class VendorMethodChannel implements MethodChannel.MethodCallHandler, VendorChannelFlutterDomain {
    ...
    @NotNull
    private final VendorChannelCallback callback;
    @Nullable
    private MethodChannel channel;

    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lcom/talabat/core/flutter/channels/data/vendor/VendorMethodChannel$Companion;", "", "()V", "GET_VENDOR", "", "UPDATE_VENDOR", "com_talabat_core_flutter-channels_data_data"}, k = 1, mv = {1, 6, 0}, xi = 48)
    ...
    public VendorMethodChannel(@NotNull VendorChannelCallback vendorChannelCallback) {
        Intrinsics.checkNotNullParameter(vendorChannelCallback, "callback");
        this.callback = vendorChannelCallback;
    }
    ...
    public void onAttach(@NotNull BinaryMessenger binaryMessenger) {
        ...
        MethodChannel methodChannel = new MethodChannel(binaryMessenger, "com.talabat.flutter/vendor");
    ...
    public void onMethodCall(@NotNull MethodCall methodCall, @NotNull MethodChannel.Result result) {
        ...
        if (Intrinsics.areEqual((Object) str, (Object) GET_VENDOR)) {
            result.success(this.callback.getVendor());
        } else if (Intrinsics.areEqual((Object) str, (Object) UPDATE_VENDOR)) {
            this.callback.updateVendor(methodCall.arguments);
            result.success(Boolean.TRUE);
        } else {
            Reflection.getOrCreateKotlinClass(VendorMethodChannel.class).getSimpleName();
