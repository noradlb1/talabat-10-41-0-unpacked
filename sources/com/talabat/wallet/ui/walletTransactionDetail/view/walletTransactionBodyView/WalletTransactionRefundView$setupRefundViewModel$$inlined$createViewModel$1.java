...
public final class WalletTransactionRefundView$setupRefundViewModel$$inlined$createViewModel$1 extends ViewModelProvider.NewInstanceFactory {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ WalletTransactionRefundView f12835a;

    public WalletTransactionRefundView$setupRefundViewModel$$inlined$createViewModel$1(WalletTransactionRefundView walletTransactionRefundView) {
        this.f12835a = walletTransactionRefundView;
    }

    @NotNull
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        Intrinsics.checkNotNullParameter(cls, "modelClass");
        return this.f12835a.viewModelBuilder();
    }
}
