...
public final class WalletTransactionRefundView$setupPaymentViewModel$$inlined$createViewModel$1 extends ViewModelProvider.NewInstanceFactory {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ WalletTransactionRefundView f12834a;

    public WalletTransactionRefundView$setupPaymentViewModel$$inlined$createViewModel$1(WalletTransactionRefundView walletTransactionRefundView) {
        this.f12834a = walletTransactionRefundView;
    }

    @NotNull
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        Intrinsics.checkNotNullParameter(cls, "modelClass");
        return this.f12834a.paymentViewModelBuilder();
    }
}
