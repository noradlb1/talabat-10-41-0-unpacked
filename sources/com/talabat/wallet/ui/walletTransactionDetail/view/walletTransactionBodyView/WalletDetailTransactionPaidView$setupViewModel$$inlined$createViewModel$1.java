...
public final class WalletDetailTransactionPaidView$setupViewModel$$inlined$createViewModel$1 extends ViewModelProvider.NewInstanceFactory {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ WalletDetailTransactionPaidView f12832a;

    public WalletDetailTransactionPaidView$setupViewModel$$inlined$createViewModel$1(WalletDetailTransactionPaidView walletDetailTransactionPaidView) {
        this.f12832a = walletDetailTransactionPaidView;
    }

    @NotNull
    public <T extends ViewModel> T create(@NotNull Class<T> cls) {
        Intrinsics.checkNotNullParameter(cls, "modelClass");
        return this.f12832a.viewModelBuilder();
    }
}
