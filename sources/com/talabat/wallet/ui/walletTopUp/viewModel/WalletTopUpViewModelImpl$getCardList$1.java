...
public final class WalletTopUpViewModelImpl$getCardList$1 extends Lambda implements Function1<Either<? extends Failure, ? extends WalletCardListDisplayModel>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ WalletTopUpViewModelImpl f12818g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public WalletTopUpViewModelImpl$getCardList$1(WalletTopUpViewModelImpl walletTopUpViewModelImpl) {
        super(1);
        this.f12818g = walletTopUpViewModelImpl;
    }
    ...
    public final void invoke(@NotNull Either<? extends Failure, WalletCardListDisplayModel> either) {
        ...
        either.either(new Function1<Failure, Unit>(this.f12818g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                invoke((Failure) obj);
                return Unit.INSTANCE;
            }
            ...
            public final void invoke(@NotNull Failure failure) {
                ...
                ((WalletTopUpViewModelImpl) this.receiver).handleFailure(failure);
            }
        }, new Function1<WalletCardListDisplayModel, Unit>(this.f12818g) {
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            ...
            public final void invoke(@NotNull WalletCardListDisplayModel walletCardListDisplayModel) {
                ...
                ((WalletTopUpViewModelImpl) this.receiver).handleWalletCardListSuccess(walletCardListDisplayModel);
            }
        });
    }
}
