...
public final class GetBnplFakeDoorTestFeatureFlagUseCase {
    ...
    public GetBnplFakeDoorTestFeatureFlagUseCase(@NotNull ITalabatFeatureFlag iTalabatFeatureFlag, @NotNull ConfigurationLocalRepository configurationLocalRepository2, @NotNull CoroutineDispatcher coroutineDispatcher) {
    ...
    public final Object invoke(@NotNull Continuation<? super Boolean> continuation) {
        return BuildersKt.withContext(this.dispatcher, new GetBnplFakeDoorTestFeatureFlagUseCase$invoke$2(this, (Continuation<? super GetBnplFakeDoorTestFeatureFlagUseCase$invoke$2>) null), continuation);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ GetBnplFakeDoorTestFeatureFlagUseCase(ITalabatFeatureFlag iTalabatFeatureFlag, ConfigurationLocalRepository configurationLocalRepository2, CoroutineDispatcher coroutineDispatcher, int i11, DefaultConstructorMarker defaultConstructorMarker) {
