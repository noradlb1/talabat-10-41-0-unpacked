...
public final class GetWalletCanRevertRefundToBankUseCase {
    ...
    public final Object invoke(@NotNull String str, @NotNull Continuation<? super Boolean> continuation) {
        return this.walletRefundToBankRepository.getCanRefundToBankStatus(str, continuation);
    }
}
