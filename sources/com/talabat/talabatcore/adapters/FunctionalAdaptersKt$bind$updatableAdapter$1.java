...
public final class FunctionalAdaptersKt$bind$updatableAdapter$1 extends Lambda implements Function2<ViewGroup, Integer, UpdatableViewHolder<I>> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ Function1<ViewGroup, UpdatableViewHolder<I>> f12003g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FunctionalAdaptersKt$bind$updatableAdapter$1(Function1<? super ViewGroup, UpdatableViewHolder<I>> function1) {
        super(2);
        this.f12003g = function1;
    }
    ...
    public final UpdatableViewHolder<I> invoke(@NotNull ViewGroup viewGroup, int i11) {
        ...
        return this.f12003g.invoke(viewGroup);
    }
