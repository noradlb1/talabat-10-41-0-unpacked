...
public final class UseCasesKt$hasSelectedCuisines$1 extends Lambda implements Function1<CuisinesRepository, Integer> {
    public static final UseCasesKt$hasSelectedCuisines$1 INSTANCE = new UseCasesKt$hasSelectedCuisines$1();

    public UseCasesKt$hasSelectedCuisines$1() {
        super(1);
    }
    ...
    public final Integer invoke(@NotNull CuisinesRepository cuisinesRepository) {
        ...
        return cuisinesRepository.loadSelectedCuisineId();
    }
}
