...
public final class SampleCuisinesActivity$onCreate$3 extends Lambda implements Function1<StartCuisineViewForResult<Pair<? extends Cuisine, ? extends String>>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ SampleCuisinesActivity f56051g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SampleCuisinesActivity$onCreate$3(SampleCuisinesActivity sampleCuisinesActivity) {
        super(1);
        this.f56051g = sampleCuisinesActivity;
    }
    ...
    public final void invoke(@NotNull StartCuisineViewForResult<Pair<Cuisine, String>> startCuisineViewForResult) {
        ...
        final SampleCuisinesActivity sampleCuisinesActivity = this.f56051g;
        on2.success(new Function1<Pair<? extends Cuisine, ? extends String>, Unit>() {
            ...
            public final void invoke(@Nullable Pair<? extends Cuisine, String> pair) {
                String str;
                Cuisine cuisine;
                TextView textView = (TextView) sampleCuisinesActivity._$_findCachedViewById(R.id.colectionsSelectionTextView);
