...
import com.designsystem.ds_list_item_v2.DSCheckboxListItem;
...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u0003B#\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0014\b\u0002\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t0\u0007¢\u0006\u0002\u0010\nJ\u0010\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0011H\u0016R\u0014\u0010\u0004\u001a\u00020\u0005X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u001d\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t0\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\r¨\u0006\u0012"}, d2 = {"Lcom/talabat/cuisines/presentation/bottomsheet/CuisineDSBottomSheetViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Lkotlinx/android/extensions/LayoutContainer;", "Lcom/talabat/cuisines/presentation/CuisineHolder;", "containerView", "Landroid/view/View;", "isAllCuisinesItemUseCase", "Lkotlin/Function1;", "", "", "(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V", "getContainerView", "()Landroid/view/View;", "()Lkotlin/jvm/functions/Function1;", "bind", "", "model", "Lcom/talabat/cuisines/domain/SelectableCuisine;", "com_talabat_Components_cuisines_cuisines"}, k = 1, mv = {1, 6, 0}, xi = 48)
public final class CuisineDSBottomSheetViewHolder extends RecyclerView.ViewHolder implements LayoutContainer, CuisineHolder {
    @NotNull
    ...
    public /* synthetic */ CuisineDSBottomSheetViewHolder(View view, Function1 function1, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public void bind(@NotNull SelectableCuisine selectableCuisine) {
        ...
        DSCheckboxListItem dSCheckboxListItem = (DSCheckboxListItem) getContainerView().findViewById(R.id.listItem);
        if (this.isAllCuisinesItemUseCase.invoke(Integer.valueOf(selectableCuisine.getCuisine().f13848id)).booleanValue()) {
            str = dSCheckboxListItem.getContext().getString(com.talabat.localization.R.string.all_cuisines);
        } else {
            str = selectableCuisine.getCuisine().f13849name;
        }
        dSCheckboxListItem.setLabel(str);
        dSCheckboxListItem.setListItemSelected(selectableCuisine.isOn());
        dSCheckboxListItem.setOnChanged(new CuisineDSBottomSheetViewHolder$bind$1$1(selectableCuisine));
    }
    ...
    public CuisineDSBottomSheetViewHolder(@NotNull View view, @NotNull Function1<? super Integer, Boolean> function1) {
        super(view);
