package com.talabat.card_tokenization.request;
...
public final class RemoteTokenizationRequest {
    ...
    public String toString() {
        return "RemoteTokenizationRequest(cardNumber=" + this.cardNumber + ", cardHolderName=" + this.cardHolderName + ", cardExpiryMonth=" + this.cardExpiryMonth + ", cardExpiryYear=" + this.cardExpiryYear + ", cardCvv=" + this.cardCvv + ", publicKey=" + this.publicKey + ", env=" + this.env + ')';
    }
}
