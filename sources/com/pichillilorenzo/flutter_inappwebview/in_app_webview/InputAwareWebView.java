...
public class InputAwareWebView extends WebView {
    ...
    public InputAwareWebView(Context context, AttributeSet attributeSet, int i11) {
    ...
    public InputAwareWebView(Context context, View view, Boolean bool) {
        ...
        this.useHybridComposition = bool != null ? bool.booleanValue() : z11;
    }
    ...
    public void onFocusChanged(boolean z11, int i11, Rect rect) {
        ...
        } else if (Build.VERSION.SDK_INT >= 28 || !isCalledFromListPopupWindowShow() || z11) {
            super.onFocusChanged(z11, i11, rect);
        }
    }
