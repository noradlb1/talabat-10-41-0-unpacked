...
public class CustomTabActivityHelper implements ServiceConnectionCallback {
    ...
    public static void openCustomTab(Activity activity, CustomTabsIntent customTabsIntent, Uri uri, int i11) {
        customTabsIntent.intent.setData(uri);
        activity.startActivityForResult(customTabsIntent.intent, i11);
    }

    public static void openCustomTab(Activity activity, TrustedWebActivityIntent trustedWebActivityIntent, Uri uri, int i11) {
        trustedWebActivityIntent.getIntent().setData(uri);
        activity.startActivityForResult(trustedWebActivityIntent.getIntent(), i11);
    }
