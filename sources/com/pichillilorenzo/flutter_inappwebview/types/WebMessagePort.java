...
public class WebMessagePort {
    ...
    public void close(final ValueCallback<Void> valueCallback) {
        ...
        if (!this.isTransferred) {
            ...
            if (inAppWebViewInterface != null) {
                inAppWebViewInterface.evaluateJavascript("(function() {  var webMessageChannel = window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.f52881id + "'];  if (webMessageChannel != null) {      webMessageChannel." + this.f52883name + ".close();  }})();", (ContentWorld) null, new ValueCallback<String>() {
    ...
    public void postMessage(WebMessage webMessage, final ValueCallback<Void> valueCallback) {
        ...
        if (inAppWebViewInterface != null) {
            ...
            if (list != null) {
                ...
                for (WebMessagePort next : list) {
                    if (next == this) {
                        ...
                        arrayList.add("window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.f52881id + "']." + next.f52883name);
                    }
                }
                str = "[" + TextUtils.join(IndicativeSentencesGeneration.DEFAULT_SEPARATOR, arrayList) + "]";
            } else {
                str = str2;
            }
            ...
            inAppWebViewInterface.evaluateJavascript("(function() {  var webMessageChannel = window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.f52881id + "'];  if (webMessageChannel != null) {      webMessageChannel." + this.f52883name + ".postMessage('" + str2 + "', " + str + ");  }})();", (ContentWorld) null, new ValueCallback<String>() {
                public void onReceiveValue(String str) {
                    valueCallback.onReceiveValue((Object) null);
                }
            });
    ...
    public void setWebMessageCallback(final ValueCallback<Void> valueCallback) {
        ...
        if (inAppWebViewInterface != null) {
            inAppWebViewInterface.evaluateJavascript("(function() {  var webMessageChannel = window.flutter_inappwebview._webMessageChannels['" + this.webMessageChannel.f52881id + "'];  if (webMessageChannel != null) {      webMessageChannel." + this.f52883name + ".onmessage = function (event) {          window." + JavaScriptBridgeJS.JAVASCRIPT_BRIDGE_NAME + ".callHandler('onWebMessagePortMessageReceived', {              'webMessageChannelId': '" + this.webMessageChannel.f52881id + "',              'index': " + (true ^ this.f52883name.equals("port1") ? 1 : 0) + ",              'message': event.data          });      }  }})();", (ContentWorld) null, new ValueCallback<String>() {
                public void onReceiveValue(String str) {
