...
public class UserScript {
    ...
    public String toString() {
        return "UserScript{groupName='" + this.groupName + '\'' + ", source='" + this.source + '\'' + ", injectionTime=" + this.injectionTime + ", contentWorld=" + this.contentWorld + AbstractJsonLexerKt.END_OBJ;
    }
}
