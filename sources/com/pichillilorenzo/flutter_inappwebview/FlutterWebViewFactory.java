...
public class FlutterWebViewFactory extends PlatformViewFactory {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$pichillilorenzo$flutter_inappwebview$types$WebViewImplementation;
    ...
    public PlatformView create(Context context, int i11, Object obj) {
        ...
        int i12 = AnonymousClass1.$SwitchMap$com$pichillilorenzo$flutter_inappwebview$types$WebViewImplementation[WebViewImplementation.fromValue(((Integer) hashMap.get("implementation")).intValue()).ordinal()];
        FlutterWebView flutterWebView = new FlutterWebView(this.plugin, context, Integer.valueOf(i11), hashMap);
