...
public class LottieComposition {
    ...
    public static class Factory {
        ...
        @Deprecated
        public static Cancellable fromRawFile(Context context, @RawRes int i11, OnCompositionLoadedListener onCompositionLoadedListener) {
            ListenerAdapter listenerAdapter = new ListenerAdapter(onCompositionLoadedListener);
