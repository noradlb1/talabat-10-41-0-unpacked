...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public FontAssetDelegate f40429b;
    @Nullable

    /* renamed from: c  reason: collision with root package name */
    public TextDelegate f40430c;
    ...
    private FontAssetManager getFontAssetManager() {
        ...
        if (this.fontAssetManager == null) {
            this.fontAssetManager = new FontAssetManager(getCallback(), this.f40429b);
        }
    ...
    public <T> void addValueCallback(KeyPath keyPath, T t11, @Nullable LottieValueCallback<T> lottieValueCallback) {
        CompositionLayer compositionLayer2 = this.compositionLayer;
        if (compositionLayer2 == null) {
            this.lazyCompositionTasks.add(new p(this, keyPath, t11, lottieValueCallback));
            return;
        }
        boolean z11 = true;
    ...
    public void playAnimation() {
        ...
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new c(this));
            return;
        }
        computeRenderMode();
    ...
    public boolean r() {
        ...
        if (onVisibleAction2 == OnVisibleAction.PLAY || onVisibleAction2 == OnVisibleAction.RESUME) {
            return true;
        }
        return false;
    }
    ...
    public void setFontAssetDelegate(FontAssetDelegate fontAssetDelegate) {
        this.f40429b = fontAssetDelegate;
    ...
    public void setFrame(int i11) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new d(this, i11));
        } else {
    ...
    public void setMaxFrame(int i11) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new j(this, i11));
        } else {
    ...
    public void setMaxProgress(@FloatRange(from = 0.0d, to = 1.0d) float f11) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new b(this, f11));
        } else {
    ...
    public void setMinAndMaxFrame(String str) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new f(this, str));
            return;
        }
        ...
        throw new IllegalArgumentException("Cannot find marker with name " + str + RealDiscoveryConfigurationRepository.VERSION_DELIMETER);
    }

    public void setMinAndMaxProgress(@FloatRange(from = 0.0d, to = 1.0d) float f11, @FloatRange(from = 0.0d, to = 1.0d) float f12) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new g(this, f11, f12));
        } else {
    ...
    public void setMinFrame(int i11) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new h(this, i11));
        } else {
    ...
    public void setMinProgress(float f11) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new i(this, f11));
        } else {
    ...
    public void setProgress(@FloatRange(from = 0.0d, to = 1.0d) float f11) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new a(this, f11));
            return;
        }
    ...
    public boolean useTextGlyphs() {
        return this.f40430c == null && this.composition.getCharacters().size() > 0;
    }
    ...
    public void setMinFrame(String str) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new o(this, str));
            return;
        }
        Marker marker = lottieComposition.getMarker(str);
        if (marker != null) {
    ...
    public void setMinAndMaxFrame(String str, String str2, boolean z11) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new n(this, str, str2, z11));
            return;
        }
        Marker marker = lottieComposition.getMarker(str);
        if (marker != null) {
            ...
            throw new IllegalArgumentException("Cannot find marker with name " + str2 + RealDiscoveryConfigurationRepository.VERSION_DELIMETER);
        }
        throw new IllegalArgumentException("Cannot find marker with name " + str + RealDiscoveryConfigurationRepository.VERSION_DELIMETER);
    }
    ...
    public void setMinAndMaxFrame(int i11, int i12) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new e(this, i11, i12));
        } else {
