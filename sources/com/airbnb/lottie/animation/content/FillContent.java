...
public class FillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    private final String f40449name;
    ...
    public FillContent(LottieDrawable lottieDrawable2, BaseLayer baseLayer, ShapeFill shapeFill) {
        ...
        this.f40449name = shapeFill.getName();
    ...
    public void draw(Canvas canvas, Matrix matrix, int i11) {
        if (!this.hidden) {
            ...
            this.paint.setColor((MiscUtils.clamp((int) ((((((float) i11) / 255.0f) * ((float) this.opacityAnimation.getValue().intValue())) / 100.0f) * 255.0f), 0, 255) << 24) | (((ColorKeyframeAnimation) this.colorAnimation).getIntValue() & 16777215));
            BaseKeyframeAnimation<ColorFilter, ColorFilter> baseKeyframeAnimation = this.colorFilterAnimation;
            if (baseKeyframeAnimation != null) {
            ...
            if (baseKeyframeAnimation2 != null) {
                ...
                } else if (floatValue != this.f40448a) {
