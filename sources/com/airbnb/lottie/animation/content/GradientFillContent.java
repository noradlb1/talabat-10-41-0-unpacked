...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    private final String f40451name;
    ...
    public GradientFillContent(LottieDrawable lottieDrawable2, BaseLayer baseLayer, GradientFill gradientFill) {
        ...
        this.f40451name = gradientFill.getName();
    ...
    private RadialGradient getRadialGradient() {
        ...
        RadialGradient radialGradient2 = new RadialGradient(f11, f12, hypot, applyDynamicColorsIfNeeded, positions, Shader.TileMode.CLAMP);
