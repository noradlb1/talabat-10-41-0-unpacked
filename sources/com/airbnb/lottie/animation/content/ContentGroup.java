...
public class ContentGroup implements DrawingContent, PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElement {
    ...
    private final String f40446name;
    ...
    public ContentGroup(LottieDrawable lottieDrawable2, BaseLayer baseLayer, ShapeGroup shapeGroup) {
        this(lottieDrawable2, baseLayer, shapeGroup.getName(), shapeGroup.isHidden(), contentsFromModels(lottieDrawable2, baseLayer, shapeGroup.getItems()), a(shapeGroup.getItems()));
    }
        ...
        if (!this.hidden) {
            ...
            if (transformKeyframeAnimation != null) {
                ...
                if (this.transformAnimation.getOpacity() == null) {
                    ...
                    i12 = this.transformAnimation.getOpacity().getValue().intValue();
                }
                i11 = (int) ((((((float) i12) / 100.0f) * ((float) i11)) / 255.0f) * 255.0f);
            }
            if (!this.lottieDrawable.isApplyingOpacityToLayersEnabled() || !hasTwoOrMoreDrawableContent() || i11 == 255) {
                z11 = false;
            } else {
                z11 = true;
            }
    ...
    public ContentGroup(LottieDrawable lottieDrawable2, BaseLayer baseLayer, String str, boolean z11, List<Content> list, @Nullable AnimatableTransform animatableTransform) {
