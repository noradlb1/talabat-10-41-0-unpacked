...
public class MergePathsContent implements PathContent, GreedyContent {
    ...
    private final String f40453name;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f40454a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f40454a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f40454a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f40454a     // Catch:{ NoSuchFieldError -> 0x003e }
    ...
    public MergePathsContent(MergePaths mergePaths2) {
        this.f40453name = mergePaths2.getName();
    ...
    private void opFirstPathWithRest(Path.Op op2) {
        ...
        for (int size = this.pathContents.size() - 1; size >= 1; size--) {
            ...
            if (pathContent instanceof ContentGroup) {
                ...
                List<PathContent> b11 = contentGroup.b();
                for (int size2 = b11.size() - 1; size2 >= 0; size2--) {
                    Path path2 = b11.get(size2).getPath();
                    path2.transform(contentGroup.c());
        ...
        if (pathContent2 instanceof ContentGroup) {
            ...
            List<PathContent> b12 = contentGroup2.b();
            for (int i11 = 0; i11 < b12.size(); i11++) {
                Path path3 = b12.get(i11).getPath();
                path3.transform(contentGroup2.c());
    ...
    public Path getPath() {
        ...
        int i11 = AnonymousClass1.f40454a[this.mergePaths.getMode().ordinal()];
        if (i11 == 1) {
            addPaths();
        } else if (i11 == 2) {
