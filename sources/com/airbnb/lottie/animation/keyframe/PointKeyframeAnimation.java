...
public class PointKeyframeAnimation extends KeyframeAnimation<PointF> {
    ...
    /* renamed from: f */
    public PointF e(Keyframe<PointF> keyframe, float f11, float f12, float f13) {
        T t11;
        ...
        if (lottieValueCallback != null) {
            PointF pointF3 = (PointF) lottieValueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), pointF, pointF2, f11, d(), getProgress());
            if (pointF3 != null) {
                return pointF3;
            }
        }
