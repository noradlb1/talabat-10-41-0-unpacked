...
public class TextKeyframeAnimation extends KeyframeAnimation<DocumentData> {
    ...
    public DocumentData getValue(Keyframe<DocumentData> keyframe, float f11) {
        ...
        if (lottieValueCallback != null) {
            ...
            DocumentData documentData2 = (DocumentData) t12;
            T t13 = keyframe.endValue;
            if (t13 == null) {
                documentData = (DocumentData) t12;
            } else {
                documentData = (DocumentData) t13;
            }
            return (DocumentData) lottieValueCallback.getValueInternal(f13, f12, documentData2, documentData, f11, c(), getProgress());
