...
public class TextLayer extends BaseLayer {
    ...
    public static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f40676a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f40676a     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    public TextLayer(LottieDrawable lottieDrawable2, Layer layer) {
        ...
        AnimatableTextProperties p11 = layer.p();
        if (!(p11 == null || (animatableColorValue2 = p11.color) == null)) {
            BaseKeyframeAnimation<Integer, Integer> createAnimation2 = animatableColorValue2.createAnimation();
            this.colorAnimation = createAnimation2;
            createAnimation2.addUpdateListener(this);
            addAnimation(this.colorAnimation);
        }
        if (!(p11 == null || (animatableColorValue = p11.stroke) == null)) {
        ...
        if (!(p11 == null || (animatableFloatValue2 = p11.strokeWidth) == null)) {
        ...
        if (p11 != null && (animatableFloatValue = p11.f40647tracking) != null) {
    ...
    private void applyJustification(DocumentData.Justification justification, Canvas canvas, float f11) {
        int i11 = AnonymousClass3.f40676a[justification.ordinal()];
        if (i11 == 2) {
    ...
    private String codePointToString(String str, int i11) {
        ...
        if (this.codePointCache.containsKey(j11)) {
            return this.codePointCache.get(j11);
        }
        ...
        this.codePointCache.put(j11, sb2);
        return sb2;
    }
    ...
    private void drawGlyphTextLine(String str, DocumentData documentData, Matrix matrix2, Font font, Canvas canvas, float f11, float f12) {
        ...
        for (int i11 = 0; i11 < str.length(); i11++) {
            FontCharacter fontCharacter = this.composition.getCharacters().get(FontCharacter.hashFor(str.charAt(i11), font.getFamily(), font.getStyle()));
            if (fontCharacter != null) {
                drawCharacterAsGlyph(fontCharacter, matrix2, f12, documentData, canvas);
                float width = ((float) fontCharacter.getWidth()) * f12 * Utils.dpScale() * f11;
                float f13 = ((float) documentData.f40642tracking) / 10.0f;
    ...
    private float getTextLineWidthForGlyphs(String str, Font font, float f11, float f12) {
        ...
        for (int i11 = 0; i11 < str.length(); i11++) {
            FontCharacter fontCharacter = this.composition.getCharacters().get(FontCharacter.hashFor(str.charAt(i11), font.getFamily(), font.getStyle()));
            if (fontCharacter != null) {
                f13 = (float) (((double) f13) + (fontCharacter.getWidth() * ((double) f11) * ((double) Utils.dpScale()) * ((double) f12)));
            }
        }
        return f13;
    }
    ...
    private boolean isModifier(int i11) {
        if (Character.getType(i11) == 16 || Character.getType(i11) == 27 || Character.getType(i11) == 6 || Character.getType(i11) == 28 || Character.getType(i11) == 8 || Character.getType(i11) == 19) {
            return true;
        }
        return false;
    }
    ...
    public void drawLayer(Canvas canvas, Matrix matrix2, int i11) {
        ...
        int i13 = (i12 * 255) / 100;
        this.fillPaint.setAlpha(i13);
        this.strokePaint.setAlpha(i13);
