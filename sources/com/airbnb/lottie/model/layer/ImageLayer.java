...
public class ImageLayer extends BaseLayer {
    ...
    public ImageLayer(LottieDrawable lottieDrawable, Layer layer) {
        ...
        this.lottieImageAsset = lottieDrawable.getLottieImageAssetForId(layer.i());
    }
    ...
    private Bitmap getBitmap() {
        ...
        Bitmap bitmapForId = this.f40666b.getBitmapForId(this.f40667c.i());
        if (bitmapForId != null) {
            return bitmapForId;
        }
    ...
    public void drawLayer(@NonNull Canvas canvas, Matrix matrix, int i11) {
        ...
        if (bitmap != null && !bitmap.isRecycled() && this.lottieImageAsset != null) {
            ...
            if (this.f40666b.getMaintainOriginalImageBounds()) {
