...
public class DocumentDataParser implements ValueParser<DocumentData> {
    ...
    private static final JsonReader.Options NAMES = JsonReader.Options.of("t", "f", "s", j.f43085a, "tr", "lh", "ls", "fc", "sc", "sw", "of");
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(NAMES)) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    i12 = JsonUtils.a(jsonReader);
                    break;
                case 8:
                    i13 = JsonUtils.a(jsonReader);
                    break;
                case 9:
