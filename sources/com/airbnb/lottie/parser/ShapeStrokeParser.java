...
class ShapeStrokeParser {
    ...
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", c.f41585a, "w", "o", "lc", "lj", "ml", "hd", "d");
    ...
    public static ShapeStroke a(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        return new ShapeStroke(str, animatableFloatValue, arrayList, animatableColorValue, animatableIntegerValue, animatableFloatValue2, lineCapType, lineJoinType, f11, z11);
    }
}
