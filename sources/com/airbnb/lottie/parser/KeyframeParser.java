...
class KeyframeParser {
    ...
    public static JsonReader.Options f40688a = JsonReader.Options.of("t", "s", "e", "o", "i", "h", "to", "ti");

    /* renamed from: b  reason: collision with root package name */
    public static JsonReader.Options f40689b = JsonReader.Options.of(Param.X, Param.Y);
    private static SparseArrayCompat<WeakReference<Interpolator>> pathInterpolatorCache;

    public static <T> Keyframe<T> a(JsonReader jsonReader, LottieComposition lottieComposition, float f11, ValueParser<T> valueParser, boolean z11, boolean z12) throws IOException {
        if (z11 && z12) {
    ...
    private static WeakReference<Interpolator> getInterpolator(int i11) {
        ...
        synchronized (KeyframeParser.class) {
            weakReference = pathInterpolatorCache().get(i11);
        }
    ...
    private static Interpolator interpolatorFor(PointF pointF, PointF pointF2) {
        ...
        if (interpolator3 != null) {
            interpolator = interpolator3.get();
        } else {
            interpolator = null;
        }
        if (interpolator3 == null || interpolator == null) {
            try {
    ...
    private static <T> Keyframe<T> parseKeyframe(LottieComposition lottieComposition, JsonReader jsonReader, float f11, ValueParser<T> valueParser) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(f40688a)) {
                case 0:
                ...
                case 6:
                    pointF2 = JsonUtils.b(jsonReader, f11);
                    break;
                case 7:
                    pointF3 = JsonUtils.b(jsonReader, f11);
                    break;
                default:
    ...
    private static <T> com.airbnb.lottie.value.Keyframe<T> parseMultiDimensionalKeyframe(com.airbnb.lottie.LottieComposition r21, com.airbnb.lottie.parser.moshi.JsonReader r22, float r23, com.airbnb.lottie.parser.ValueParser<T> r24) throws java.io.IOException {
        ...
        L_0x0016:
            ...
            com.airbnb.lottie.parser.moshi.JsonReader$Options r4 = f40688a
        ...
        L_0x0026:
            ...
            goto L_0x01a4
        L_0x0030:
            android.graphics.PointF r3 = com.airbnb.lottie.parser.JsonUtils.b(r22, r23)
            goto L_0x0016
        L_0x0035:
            android.graphics.PointF r15 = com.airbnb.lottie.parser.JsonUtils.b(r22, r23)
            goto L_0x0016
        L_0x003a:
            int r4 = r22.nextInt()
        ...
        L_0x0053:
            ...
            r18 = r15
            com.airbnb.lottie.parser.moshi.JsonReader$Options r15 = f40689b
        ...
        L_0x00e8:
            ...
            r3 = r14
            r18 = r15
            android.graphics.PointF r8 = com.airbnb.lottie.parser.JsonUtils.b(r22, r23)
            goto L_0x01a4
        L_0x00f3:
            r19 = r3
            r3 = r14
        ...
        L_0x0107:
            ...
            com.airbnb.lottie.parser.moshi.JsonReader$Options r14 = f40689b
        ...
        L_0x017d:
            ...
            goto L_0x01a4
        L_0x017f:
            android.graphics.PointF r7 = com.airbnb.lottie.parser.JsonUtils.b(r22, r23)
            r14 = r3
            r15 = r18
            goto L_0x01a4
        L_0x0187:
    ...
    private static void putInterpolator(int i11, WeakReference<Interpolator> weakReference) {
        synchronized (KeyframeParser.class) {
            pathInterpolatorCache.put(i11, weakReference);
        }
    }
}
