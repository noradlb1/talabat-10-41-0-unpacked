...
public class ShapeDataParser implements ValueParser<ShapeData> {
    ...
    private static final JsonReader.Options NAMES = JsonReader.Options.of(c.f41585a, "v", "i", "o");
    ...
    public ShapeData parse(JsonReader jsonReader, float f11) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (selectName == 0) {
                ...
                list = JsonUtils.c(jsonReader, f11);
            } else if (selectName == 2) {
                list2 = JsonUtils.c(jsonReader, f11);
            } else if (selectName != 3) {
                jsonReader.skipName();
                jsonReader.skipValue();
            } else {
                list3 = JsonUtils.c(jsonReader, f11);
            }
        }
