...
public final class DialogsKt {
    ...
    public static final void invalidateDividers(@NotNull MaterialDialog materialDialog, boolean z11, boolean z12) {
        Intrinsics.checkParameterIsNotNull(materialDialog, "$this$invalidateDividers");
        materialDialog.getView().invalidateDividers(z11, z12);
    }

    public static final void populateIcon(@NotNull MaterialDialog materialDialog, @NotNull ImageView imageView, @Nullable @DrawableRes Integer num, @Nullable Drawable drawable) {
    ...
    public static final void populateText(@NotNull MaterialDialog materialDialog, @NotNull TextView textView, @Nullable @StringRes Integer num, @Nullable CharSequence charSequence, @StringRes int i11, @Nullable Typeface typeface, @Nullable Integer num2) {
        Intrinsics.checkParameterIsNotNull(materialDialog, "$this$populateText");
        Intrinsics.checkParameterIsNotNull(textView, "textView");
        if (charSequence == null) {
            charSequence = MDUtil.resolveString$default(MDUtil.INSTANCE, materialDialog, num, Integer.valueOf(i11), false, 8, (Object) null);
        }
        if (charSequence != null) {
    ...
    public static /* synthetic */ void populateText$default(MaterialDialog materialDialog, TextView textView, Integer num, CharSequence charSequence, int i11, Typeface typeface, Integer num2, int i12, Object obj) {
        populateText(materialDialog, textView, (i12 & 2) != 0 ? null : num, (i12 & 4) != 0 ? null : charSequence, (i12 & 8) != 0 ? 0 : i11, typeface, (i12 & 32) != 0 ? null : num2);
    }

    public static final void preShow(@NotNull MaterialDialog materialDialog) {
        ...
        DialogCallbackExtKt.invokeAll(materialDialog.getPreShowListeners$com_afollestad_material_dialogs_core(), materialDialog);
        DialogLayout view = materialDialog.getView();
        if (view.getTitleLayout().shouldNotBeVisible() && !areEqual) {
            view.getContentLayout().modifyFirstAndLastPadding(view.getFrameMarginVertical$com_afollestad_material_dialogs_core(), view.getFrameMarginVertical$com_afollestad_material_dialogs_core());
        }
        if (ViewsKt.isVisible(DialogCheckboxExtKt.getCheckBoxPrompt(materialDialog))) {
            ...
            DialogContentLayout.modifyScrollViewPadding$default(view.getContentLayout(), 0, view.getFrameMarginVerticalLess$com_afollestad_material_dialogs_core(), 1, (Object) null);
        }
    }
}
