...
public final class DialogListExtKt {
    @NotNull
    public static final MaterialDialog customListAdapter(@NotNull MaterialDialog materialDialog, @NotNull RecyclerView.Adapter<?> adapter, @Nullable RecyclerView.LayoutManager layoutManager) {
    ...
    public static /* synthetic */ MaterialDialog customListAdapter$default(MaterialDialog materialDialog, RecyclerView.Adapter adapter, RecyclerView.LayoutManager layoutManager, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            layoutManager = null;
        }
    ...
    public static final Drawable getItemSelector(@NotNull MaterialDialog materialDialog) {
        ...
        if ((resolveDrawable$default instanceof RippleDrawable) && (resolveColor$default = ColorsKt.resolveColor$default(materialDialog, (Integer) null, Integer.valueOf(R.attr.md_ripple_color), (Function0) null, 5, (Object) null)) != 0) {
    ...
    @CheckResult
    @NotNull
    public static final RecyclerView getRecyclerView(@NotNull MaterialDialog materialDialog) {
    ...
    @CheckResult
    @NotNull
    public static final MaterialDialog listItems(@NotNull MaterialDialog materialDialog, @Nullable @ArrayRes Integer num, @Nullable List<? extends CharSequence> list, @Nullable int[] iArr, boolean z11, @Nullable Function3<? super MaterialDialog, ? super Integer, ? super CharSequence, Unit> function3) {
        ...
        if (getListAdapter(materialDialog) == null) {
            return customListAdapter$default(materialDialog, new PlainListDialogAdapter(materialDialog, list2, iArr, z11, function3), (RecyclerView.LayoutManager) null, 2, (Object) null);
        }
        Log.w("MaterialDialogs", "Prefer calling updateListItems(...) over listItems(...) again.");
        return updateListItems(materialDialog, num, list, iArr, function3);
    }

    public static /* synthetic */ MaterialDialog listItems$default(MaterialDialog materialDialog, Integer num, List list, int[] iArr, boolean z11, Function3 function3, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            num = null;
        }
        if ((i11 & 2) != 0) {
        ...
        return listItems(materialDialog, num, list, iArr, z11, function3);
    }

    @NotNull
    public static final MaterialDialog updateListItems(@NotNull MaterialDialog materialDialog, @Nullable @ArrayRes Integer num, @Nullable List<? extends CharSequence> list, @Nullable int[] iArr, @Nullable Function3<? super MaterialDialog, ? super Integer, ? super CharSequence, Unit> function3) {
    ...
    public static /* synthetic */ MaterialDialog updateListItems$default(MaterialDialog materialDialog, Integer num, List list, int[] iArr, Function3 function3, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            num = null;
        }
        if ((i11 & 2) != 0) {
