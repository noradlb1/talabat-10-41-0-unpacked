...
public final class PlainListDialogAdapter extends RecyclerView.Adapter<PlainListViewHolder> implements DialogAdapter<CharSequence, Function3<? super MaterialDialog, ? super Integer, ? super CharSequence, ? extends Unit>> {
    ...
    public PlainListDialogAdapter(@NotNull MaterialDialog materialDialog, @NotNull List<? extends CharSequence> list, @Nullable int[] iArr, boolean z11, @Nullable Function3<? super MaterialDialog, ? super Integer, ? super CharSequence, Unit> function3) {
    ...
    public void onBindViewHolder(@NotNull PlainListViewHolder plainListViewHolder, int i11) {
        ...
        plainListViewHolder.getTitleView().setText((CharSequence) this.items.get(i11));
    ...
    @NotNull
    public PlainListViewHolder onCreateViewHolder(@NotNull ViewGroup viewGroup, int i11) {
        ...
        MDUtil.maybeSetTextColor$default(mDUtil, plainListViewHolder.getTitleView(), this.dialog.getWindowContext(), Integer.valueOf(R.attr.md_color_content), (Integer) null, 4, (Object) null);
