...
public interface DialogAdapter<IT, SL> {
    ...
    boolean isItemChecked(int i11);

    void positiveButtonClicked();

    void replaceItems(@NotNull List<? extends IT> list, @Nullable SL sl2);
