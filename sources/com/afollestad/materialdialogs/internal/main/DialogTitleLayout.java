...
public final class DialogTitleLayout extends BaseSubLayout {
    ...
    public /* synthetic */ DialogTitleLayout(Context context, AttributeSet attributeSet, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public void onLayout(boolean z11, int i11, int i12, int i13, int i14) {
        ...
        if (!shouldNotBeVisible()) {
            int i19 = this.frameMarginVertical;
            ...
            if (ViewsKt.isRtl(this)) {
                i15 = getMeasuredWidth() - this.frameMarginHorizontal;
                TextView textView2 = this.titleView;
                if (textView2 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("titleView");
                }
                i16 = i15 - textView2.getMeasuredWidth();
            } else {
                i16 = this.frameMarginHorizontal;
                TextView textView3 = this.titleView;
                if (textView3 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("titleView");
                }
                i15 = textView3.getMeasuredWidth() + i16;
            }
            ImageView imageView = this.iconView;
            if (imageView == null) {
                Intrinsics.throwUninitializedPropertyAccessException("iconView");
            ...
            if (ViewsKt.isVisible(imageView)) {
                ...
                if (ViewsKt.isRtl(this)) {
                    ...
                    i18 = i16 - this.iconMargin;
                    TextView textView4 = this.titleView;
                    if (textView4 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("titleView");
                    }
                    i17 = i18 - textView4.getMeasuredWidth();
                } else {
                    ...
                    int i26 = this.iconMargin + i15;
                    TextView textView5 = this.titleView;
                    if (textView5 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("titleView");
                    }
                    int measuredWidth = textView5.getMeasuredWidth() + i26;
                    i17 = i26;
                    i18 = measuredWidth;
                }
            ...
            textView6.layout(i16, i22, i15, i23);
        }
    }
    ...
    public void onMeasure(int i11, int i12) {
        ...
        int i14 = size - (this.frameMarginHorizontal * 2);
        ImageView imageView = this.iconView;
        if (imageView == null) {
            Intrinsics.throwUninitializedPropertyAccessException("iconView");
        }
        if (ViewsKt.isVisible(imageView)) {
            ...
            i14 -= imageView3.getMeasuredWidth() + this.iconMargin;
        }
        TextView textView = this.titleView;
        if (textView == null) {
            Intrinsics.throwUninitializedPropertyAccessException("titleView");
        ...
        setMeasuredDimension(size, Math.max(i13, textView2.getMeasuredHeight()) + this.frameMarginVertical + this.titleMarginBottom);
    }
