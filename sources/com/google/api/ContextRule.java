...
public final class ContextRule extends GeneratedMessageLite<ContextRule, Builder> implements ContextRuleOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ContextRule, Builder> implements ContextRuleOrBuilder {
        ...
        public String getAllowedRequestExtensions(int i11) {
            return ((ContextRule) this.instance).getAllowedRequestExtensions(i11);
        }

        public ByteString getAllowedRequestExtensionsBytes(int i11) {
            return ((ContextRule) this.instance).getAllowedRequestExtensionsBytes(i11);
        }
        ...
        public String getAllowedResponseExtensions(int i11) {
            return ((ContextRule) this.instance).getAllowedResponseExtensions(i11);
        }

        public ByteString getAllowedResponseExtensionsBytes(int i11) {
            return ((ContextRule) this.instance).getAllowedResponseExtensionsBytes(i11);
        }
        ...
        public String getProvided(int i11) {
            return ((ContextRule) this.instance).getProvided(i11);
        }

        public ByteString getProvidedBytes(int i11) {
            return ((ContextRule) this.instance).getProvidedBytes(i11);
        }
        ...
        public String getRequested(int i11) {
            return ((ContextRule) this.instance).getRequested(i11);
        }

        public ByteString getRequestedBytes(int i11) {
            return ((ContextRule) this.instance).getRequestedBytes(i11);
        }
        ...
        public Builder setAllowedRequestExtensions(int i11, String str) {
            copyOnWrite();
            ((ContextRule) this.instance).setAllowedRequestExtensions(i11, str);
            return this;
        }

        public Builder setAllowedResponseExtensions(int i11, String str) {
            copyOnWrite();
            ((ContextRule) this.instance).setAllowedResponseExtensions(i11, str);
            return this;
        }

        public Builder setProvided(int i11, String str) {
            copyOnWrite();
            ((ContextRule) this.instance).setProvided(i11, str);
            return this;
        }

        public Builder setRequested(int i11, String str) {
            copyOnWrite();
            ((ContextRule) this.instance).setRequested(i11, str);
            return this;
        }
