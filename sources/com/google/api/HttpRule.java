...
public final class HttpRule extends GeneratedMessageLite<HttpRule, Builder> implements HttpRuleOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<HttpRule, Builder> implements HttpRuleOrBuilder {
        ...
        public HttpRule getAdditionalBindings(int i11) {
            return ((HttpRule) this.instance).getAdditionalBindings(i11);
        }
        ...
        public Builder removeAdditionalBindings(int i11) {
            copyOnWrite();
            ((HttpRule) this.instance).removeAdditionalBindings(i11);
            return this;
        }

        public Builder setAdditionalBindings(int i11, HttpRule httpRule) {
            copyOnWrite();
            ((HttpRule) this.instance).setAdditionalBindings(i11, httpRule);
            return this;
        }
        ...
        public Builder addAdditionalBindings(int i11, HttpRule httpRule) {
            copyOnWrite();
            ((HttpRule) this.instance).addAdditionalBindings(i11, httpRule);
            return this;
        }

        public Builder setAdditionalBindings(int i11, Builder builder) {
            copyOnWrite();
            ((HttpRule) this.instance).setAdditionalBindings(i11, (HttpRule) builder.build());
            return this;
        }
        ...
        public Builder addAdditionalBindings(int i11, Builder builder) {
            copyOnWrite();
            ((HttpRule) this.instance).addAdditionalBindings(i11, (HttpRule) builder.build());
            return this;
        }
    }
    ...
    public HttpRuleOrBuilder getAdditionalBindingsOrBuilder(int i11) {
        return this.additionalBindings_.get(i11);
    }
