...
public final class QuotaLimit extends GeneratedMessageLite<QuotaLimit, Builder> implements QuotaLimitOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<QuotaLimit, Builder> implements QuotaLimitOrBuilder {
        ...
        public Builder putValues(String str, long j11) {
            str.getClass();
            copyOnWrite();
            ((QuotaLimit) this.instance).getMutableValuesMap().put(str, Long.valueOf(j11));
            return this;
        }
        ...
        public Builder setDefaultLimit(long j11) {
            copyOnWrite();
            ((QuotaLimit) this.instance).setDefaultLimit(j11);
            return this;
        }
        ...
        public Builder setFreeTier(long j11) {
            copyOnWrite();
            ((QuotaLimit) this.instance).setFreeTier(j11);
            return this;
        }

        public Builder setMaxLimit(long j11) {
            copyOnWrite();
            ((QuotaLimit) this.instance).setMaxLimit(j11);
            return this;
        }
