...
public final class Backend extends GeneratedMessageLite<Backend, Builder> implements BackendOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Backend, Builder> implements BackendOrBuilder {
        ...
        public BackendRule getRules(int i11) {
            return ((Backend) this.instance).getRules(i11);
        }
        ...
        public Builder removeRules(int i11) {
            copyOnWrite();
            ((Backend) this.instance).removeRules(i11);
            return this;
        }

        public Builder setRules(int i11, BackendRule backendRule) {
            copyOnWrite();
            ((Backend) this.instance).setRules(i11, backendRule);
            return this;
        }
        ...
        public Builder addRules(int i11, BackendRule backendRule) {
            copyOnWrite();
            ((Backend) this.instance).addRules(i11, backendRule);
            return this;
        }

        public Builder setRules(int i11, BackendRule.Builder builder) {
            copyOnWrite();
            ((Backend) this.instance).setRules(i11, (BackendRule) builder.build());
            return this;
        }
        ...
        public Builder addRules(int i11, BackendRule.Builder builder) {
            copyOnWrite();
            ((Backend) this.instance).addRules(i11, (BackendRule) builder.build());
            return this;
        }
    }
    ...
    public BackendRuleOrBuilder getRulesOrBuilder(int i11) {
        return this.rules_.get(i11);
    }
