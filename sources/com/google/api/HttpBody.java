...
public final class HttpBody extends GeneratedMessageLite<HttpBody, Builder> implements HttpBodyOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<HttpBody, Builder> implements HttpBodyOrBuilder {
        ...
        public Any getExtensions(int i11) {
            return ((HttpBody) this.instance).getExtensions(i11);
        }
        ...
        public Builder removeExtensions(int i11) {
            copyOnWrite();
            ((HttpBody) this.instance).removeExtensions(i11);
            return this;
        }
        ...
        public Builder setExtensions(int i11, Any any) {
            copyOnWrite();
            ((HttpBody) this.instance).setExtensions(i11, any);
            return this;
        }
        ...
        public Builder addExtensions(int i11, Any any) {
            copyOnWrite();
            ((HttpBody) this.instance).addExtensions(i11, any);
            return this;
        }

        public Builder setExtensions(int i11, Any.Builder builder) {
            copyOnWrite();
            ((HttpBody) this.instance).setExtensions(i11, (Any) builder.build());
            return this;
        }
        ...
        public Builder addExtensions(int i11, Any.Builder builder) {
            copyOnWrite();
            ((HttpBody) this.instance).addExtensions(i11, (Any) builder.build());
            return this;
        }
    }
    ...
    /* access modifiers changed from: private */
    public void removeExtensions(int i11) {
        ensureExtensionsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setExtensions(int i11, Any any) {
        any.getClass();
        ensureExtensionsIsMutable();
        this.extensions_.set(i11, any);
    }
    ...
    public AnyOrBuilder getExtensionsOrBuilder(int i11) {
        return this.extensions_.get(i11);
    }
    ...
    /* access modifiers changed from: private */
    public void addExtensions(int i11, Any any) {
        any.getClass();
        ensureExtensionsIsMutable();
        this.extensions_.add(i11, any);
    }
