...
public interface ServiceOrBuilder extends MessageLiteOrBuilder {
    ...
    Endpoint getEndpoints(int i11);

    int getEndpointsCount();

    List<Endpoint> getEndpointsList();

    Enum getEnums(int i11);
    ...
    LogDescriptor getLogs(int i11);

    int getLogsCount();

    List<LogDescriptor> getLogsList();

    MetricDescriptor getMetrics(int i11);

    int getMetricsCount();

    List<MetricDescriptor> getMetricsList();

    MonitoredResourceDescriptor getMonitoredResources(int i11);
