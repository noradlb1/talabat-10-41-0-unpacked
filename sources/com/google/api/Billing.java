...
public final class Billing extends GeneratedMessageLite<Billing, Builder> implements BillingOrBuilder {
    ...
    public static final class BillingDestination extends GeneratedMessageLite<BillingDestination, Builder> implements BillingDestinationOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<BillingDestination, Builder> implements BillingDestinationOrBuilder {
            ...
            public String getMetrics(int i11) {
                return ((BillingDestination) this.instance).getMetrics(i11);
            }

            public ByteString getMetricsBytes(int i11) {
                return ((BillingDestination) this.instance).getMetricsBytes(i11);
            }
            ...
            public Builder setMetrics(int i11, String str) {
                copyOnWrite();
                ((BillingDestination) this.instance).setMetrics(i11, str);
                return this;
            }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Billing, Builder> implements BillingOrBuilder {
        ...
        public BillingDestination getConsumerDestinations(int i11) {
            return ((Billing) this.instance).getConsumerDestinations(i11);
        }
        ...
        public Builder removeConsumerDestinations(int i11) {
            copyOnWrite();
            ((Billing) this.instance).removeConsumerDestinations(i11);
            return this;
        }

        public Builder setConsumerDestinations(int i11, BillingDestination billingDestination) {
            copyOnWrite();
            ((Billing) this.instance).setConsumerDestinations(i11, billingDestination);
            return this;
        }
        ...
        public Builder addConsumerDestinations(int i11, BillingDestination billingDestination) {
            copyOnWrite();
            ((Billing) this.instance).addConsumerDestinations(i11, billingDestination);
            return this;
        }

        public Builder setConsumerDestinations(int i11, BillingDestination.Builder builder) {
            copyOnWrite();
            ((Billing) this.instance).setConsumerDestinations(i11, (BillingDestination) builder.build());
            return this;
        }
        ...
        public Builder addConsumerDestinations(int i11, BillingDestination.Builder builder) {
            copyOnWrite();
            ((Billing) this.instance).addConsumerDestinations(i11, (BillingDestination) builder.build());
            return this;
        }
    }
    ...
    public BillingDestinationOrBuilder getConsumerDestinationsOrBuilder(int i11) {
        return this.consumerDestinations_.get(i11);
    }
