...
public final class Page extends GeneratedMessageLite<Page, Builder> implements PageOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Page, Builder> implements PageOrBuilder {
        ...
        public Page getSubpages(int i11) {
            return ((Page) this.instance).getSubpages(i11);
        }
        ...
        public Builder removeSubpages(int i11) {
            copyOnWrite();
            ((Page) this.instance).removeSubpages(i11);
            return this;
        }
        ...
        public Builder setSubpages(int i11, Page page) {
            copyOnWrite();
            ((Page) this.instance).setSubpages(i11, page);
            return this;
        }
        ...
        public Builder addSubpages(int i11, Page page) {
            copyOnWrite();
            ((Page) this.instance).addSubpages(i11, page);
            return this;
        }

        public Builder setSubpages(int i11, Builder builder) {
            copyOnWrite();
            ((Page) this.instance).setSubpages(i11, (Page) builder.build());
            return this;
        }
        ...
        public Builder addSubpages(int i11, Builder builder) {
            copyOnWrite();
            ((Page) this.instance).addSubpages(i11, (Page) builder.build());
            return this;
        }
    }
    ...
    public PageOrBuilder getSubpagesOrBuilder(int i11) {
        return this.subpages_.get(i11);
    }
