...
public final class MonitoredResourceDescriptor extends GeneratedMessageLite<MonitoredResourceDescriptor, Builder> implements MonitoredResourceDescriptorOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<MonitoredResourceDescriptor, Builder> implements MonitoredResourceDescriptorOrBuilder {
        ...
        public LabelDescriptor getLabels(int i11) {
            return ((MonitoredResourceDescriptor) this.instance).getLabels(i11);
        }
        ...
        public Builder removeLabels(int i11) {
            copyOnWrite();
            ((MonitoredResourceDescriptor) this.instance).removeLabels(i11);
            return this;
        }
        ...
        public Builder setLabels(int i11, LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((MonitoredResourceDescriptor) this.instance).setLabels(i11, labelDescriptor);
            return this;
        }
        ...
        public Builder setLaunchStageValue(int i11) {
            copyOnWrite();
            ((MonitoredResourceDescriptor) this.instance).setLaunchStageValue(i11);
            return this;
        }
        ...
        public Builder addLabels(int i11, LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((MonitoredResourceDescriptor) this.instance).addLabels(i11, labelDescriptor);
            return this;
        }

        public Builder setLabels(int i11, LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((MonitoredResourceDescriptor) this.instance).setLabels(i11, (LabelDescriptor) builder.build());
            return this;
        }
        ...
        public Builder addLabels(int i11, LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((MonitoredResourceDescriptor) this.instance).addLabels(i11, (LabelDescriptor) builder.build());
            return this;
        }
    }
