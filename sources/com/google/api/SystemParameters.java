...
public final class SystemParameters extends GeneratedMessageLite<SystemParameters, Builder> implements SystemParametersOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<SystemParameters, Builder> implements SystemParametersOrBuilder {
        ...
        public SystemParameterRule getRules(int i11) {
            return ((SystemParameters) this.instance).getRules(i11);
        }
        ...
        public Builder removeRules(int i11) {
            copyOnWrite();
            ((SystemParameters) this.instance).removeRules(i11);
            return this;
        }

        public Builder setRules(int i11, SystemParameterRule systemParameterRule) {
            copyOnWrite();
            ((SystemParameters) this.instance).setRules(i11, systemParameterRule);
            return this;
        }
        ...
        public Builder addRules(int i11, SystemParameterRule systemParameterRule) {
            copyOnWrite();
            ((SystemParameters) this.instance).addRules(i11, systemParameterRule);
            return this;
        }

        public Builder setRules(int i11, SystemParameterRule.Builder builder) {
            copyOnWrite();
            ((SystemParameters) this.instance).setRules(i11, (SystemParameterRule) builder.build());
            return this;
        }
        ...
        public Builder addRules(int i11, SystemParameterRule.Builder builder) {
            copyOnWrite();
            ((SystemParameters) this.instance).addRules(i11, (SystemParameterRule) builder.build());
            return this;
        }
    }
    ...
    public SystemParameterRuleOrBuilder getRulesOrBuilder(int i11) {
        return this.rules_.get(i11);
    }
