...
public final class LogDescriptor extends GeneratedMessageLite<LogDescriptor, Builder> implements LogDescriptorOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<LogDescriptor, Builder> implements LogDescriptorOrBuilder {
        ...
        public LabelDescriptor getLabels(int i11) {
            return ((LogDescriptor) this.instance).getLabels(i11);
        }
        ...
        public Builder removeLabels(int i11) {
            copyOnWrite();
            ((LogDescriptor) this.instance).removeLabels(i11);
            return this;
        }
        ...
        public Builder setLabels(int i11, LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((LogDescriptor) this.instance).setLabels(i11, labelDescriptor);
            return this;
        }
        ...
        public Builder addLabels(int i11, LabelDescriptor labelDescriptor) {
            copyOnWrite();
            ((LogDescriptor) this.instance).addLabels(i11, labelDescriptor);
            return this;
        }

        public Builder setLabels(int i11, LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((LogDescriptor) this.instance).setLabels(i11, (LabelDescriptor) builder.build());
            return this;
        }
        ...
        public Builder addLabels(int i11, LabelDescriptor.Builder builder) {
            copyOnWrite();
            ((LogDescriptor) this.instance).addLabels(i11, (LabelDescriptor) builder.build());
            return this;
        }
    }
