...
public final class AuthProvider extends GeneratedMessageLite<AuthProvider, Builder> implements AuthProviderOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<AuthProvider, Builder> implements AuthProviderOrBuilder {
        ...
        public JwtLocation getJwtLocations(int i11) {
            return ((AuthProvider) this.instance).getJwtLocations(i11);
        }
        ...
        public Builder removeJwtLocations(int i11) {
            copyOnWrite();
            ((AuthProvider) this.instance).removeJwtLocations(i11);
            return this;
        }
        ...
        public Builder setJwtLocations(int i11, JwtLocation jwtLocation) {
            copyOnWrite();
            ((AuthProvider) this.instance).setJwtLocations(i11, jwtLocation);
            return this;
        }
        ...
        public Builder addJwtLocations(int i11, JwtLocation jwtLocation) {
            copyOnWrite();
            ((AuthProvider) this.instance).addJwtLocations(i11, jwtLocation);
            return this;
        }

        public Builder setJwtLocations(int i11, JwtLocation.Builder builder) {
            copyOnWrite();
            ((AuthProvider) this.instance).setJwtLocations(i11, (JwtLocation) builder.build());
            return this;
        }
        ...
        public Builder addJwtLocations(int i11, JwtLocation.Builder builder) {
            copyOnWrite();
            ((AuthProvider) this.instance).addJwtLocations(i11, (JwtLocation) builder.build());
            return this;
        }
    }
    ...
    public JwtLocationOrBuilder getJwtLocationsOrBuilder(int i11) {
        return this.jwtLocations_.get(i11);
    }
