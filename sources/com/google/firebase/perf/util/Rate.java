...
public class Rate {
    ...
    public Rate(long j11, long j12, TimeUnit timeUnit2) {
        this.numTokensPerTotalTimeUnit = j11;
        this.numTimeUnits = j12;
        this.timeUnit = timeUnit2;
    }

    public double getTokensPerSeconds() {
        int i11 = AnonymousClass1.$SwitchMap$java$util$concurrent$TimeUnit[this.timeUnit.ordinal()];
        if (i11 == 1) {
