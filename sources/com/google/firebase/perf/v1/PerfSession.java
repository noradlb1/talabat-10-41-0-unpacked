...
public final class PerfSession extends GeneratedMessageLite<PerfSession, Builder> implements PerfSessionOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<PerfSession, Builder> implements PerfSessionOrBuilder {
        ...
        public SessionVerbosity getSessionVerbosity(int i11) {
            return ((PerfSession) this.instance).getSessionVerbosity(i11);
        }
        ...
        public Builder setSessionVerbosity(int i11, SessionVerbosity sessionVerbosity) {
            copyOnWrite();
            ((PerfSession) this.instance).setSessionVerbosity(i11, sessionVerbosity);
            return this;
        }
    ...
    /* access modifiers changed from: private */
    public void setSessionVerbosity(int i11, SessionVerbosity sessionVerbosity) {
        sessionVerbosity.getClass();
        ensureSessionVerbosityIsMutable();
        this.sessionVerbosity_.setInt(i11, sessionVerbosity.getNumber());
    }
