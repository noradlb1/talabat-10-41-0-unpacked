    ...
    public enum MobileSubtype implements Internal.EnumLite {
        ...
        public static final class MobileSubtypeVerifier implements Internal.EnumVerifier {
            ...
            public boolean isInRange(int i11) {
                return MobileSubtype.forNumber(i11) != null;
            }
        }
        ...
        static {
            internalValueMap = new Internal.EnumLiteMap<MobileSubtype>() {
                public MobileSubtype findValueByNumber(int i11) {
                    return MobileSubtype.forNumber(i11);
                }
            };
        }
        ...
        @Deprecated
        public static MobileSubtype valueOf(int i11) {
