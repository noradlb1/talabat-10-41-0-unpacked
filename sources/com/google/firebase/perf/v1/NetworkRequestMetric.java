...
public final class NetworkRequestMetric extends GeneratedMessageLite<NetworkRequestMetric, Builder> implements NetworkRequestMetricOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<NetworkRequestMetric, Builder> implements NetworkRequestMetricOrBuilder {
        ...
        public PerfSession getPerfSessions(int i11) {
            return ((NetworkRequestMetric) this.instance).getPerfSessions(i11);
        }
        ...
        public Builder removePerfSessions(int i11) {
            copyOnWrite();
            ((NetworkRequestMetric) this.instance).removePerfSessions(i11);
            return this;
        }
        ...
        public Builder setHttpResponseCode(int i11) {
            copyOnWrite();
        ...
        public Builder setPerfSessions(int i11, PerfSession perfSession) {
            copyOnWrite();
            ((NetworkRequestMetric) this.instance).setPerfSessions(i11, perfSession);
            return this;
        }

        public Builder setRequestPayloadBytes(long j11) {
            copyOnWrite();
        ...
        public Builder setResponsePayloadBytes(long j11) {
            copyOnWrite();
            ((NetworkRequestMetric) this.instance).setResponsePayloadBytes(j11);
            return this;
        }

        public Builder setTimeToRequestCompletedUs(long j11) {
            copyOnWrite();
            ((NetworkRequestMetric) this.instance).setTimeToRequestCompletedUs(j11);
            return this;
        }

        public Builder setTimeToResponseCompletedUs(long j11) {
            copyOnWrite();
            ((NetworkRequestMetric) this.instance).setTimeToResponseCompletedUs(j11);
            return this;
        }

        public Builder setTimeToResponseInitiatedUs(long j11) {
            copyOnWrite();
        ...
        public Builder addPerfSessions(int i11, PerfSession perfSession) {
            copyOnWrite();
            ((NetworkRequestMetric) this.instance).addPerfSessions(i11, perfSession);
            return this;
        }

        public Builder setPerfSessions(int i11, PerfSession.Builder builder) {
            copyOnWrite();
            ((NetworkRequestMetric) this.instance).setPerfSessions(i11, (PerfSession) builder.build());
            return this;
        }
        ...
        public Builder addPerfSessions(int i11, PerfSession.Builder builder) {
            copyOnWrite();
            ((NetworkRequestMetric) this.instance).addPerfSessions(i11, (PerfSession) builder.build());
            return this;
        }
    }
    ...
    public enum NetworkClientErrorReason implements Internal.EnumLite {
        ...
        private NetworkClientErrorReason(int i11) {
            this.value = i11;
        }
