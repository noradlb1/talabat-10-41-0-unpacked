...
public class AppStartTrace implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    public static /* synthetic */ int access$308(AppStartTrace appStartTrace) {
        int i11 = appStartTrace.onDrawCount;
        appStartTrace.onDrawCount = i11 + 1;
        return i11;
    }
    ...
    private void logExperimentTrace(TraceMetric.Builder builder) {
        if (this.preDrawPostTime != null && this.preDrawPostAtFrontOfQueueTime != null && this.onDrawPostAtFrontOfQueueTime != null) {
            executorService.execute(new f(this, builder));
    ...
    public synchronized void onActivityResumed(android.app.Activity r6) {
        ...
        L_0x000b:
            ...
            ia.b r2 = new ia.b     // Catch:{ all -> 0x00a1 }
            ...
            ia.c r2 = new ia.c     // Catch:{ all -> 0x00a1 }
            r2.<init>(r5)     // Catch:{ all -> 0x00a1 }
            ia.d r3 = new ia.d     // Catch:{ all -> 0x00a1 }
        ...
        L_0x003e:
            ...
            ia.e r1 = new ia.e     // Catch:{ all -> 0x00a1 }
