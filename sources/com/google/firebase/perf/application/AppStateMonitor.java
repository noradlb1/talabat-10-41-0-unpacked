...
public class AppStateMonitor implements Application.ActivityLifecycleCallbacks {
    ...
    public void incrementCount(@NonNull String str, long j11) {
        synchronized (this.metricToCountMap) {
            Long l11 = this.metricToCountMap.get(str);
            if (l11 == null) {
                this.metricToCountMap.put(str, Long.valueOf(j11));
            } else {
                this.metricToCountMap.put(str, Long.valueOf(l11.longValue() + j11));
            }
        }
    }

    public void incrementTsnsCount(int i11) {
        this.tsnsCount.addAndGet(i11);
    }
    ...
    @VisibleForTesting
    public AppStateMonitor(TransportManager transportManager2, Clock clock2, ConfigResolver configResolver2, boolean z11) {
        ...
        this.screenPerformanceRecordingSupported = z11;
    }
}
