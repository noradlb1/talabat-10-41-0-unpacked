...
public class ConfigResolver {
    ...
    private boolean isFireperfSdkVersionInList(String str) {
        ...
        for (String trim : str.split(TypesAliasesKt.separator)) {
    ...
    private boolean isSamplingRateValid(double d11) {
    ...
    public String getAndCacheLogSourceName() {
        ...
        long j11 = -1;
        if (remoteConfigFlag != null) {
            j11 = ((Long) this.remoteConfigManager.getRemoteConfigValueOrDefault(remoteConfigFlag, -1L)).longValue();
        }
        String deviceCacheFlag = instance2.getDeviceCacheFlag();
        if (!ConfigurationConstants.LogSourceName.isLogSourceKnown(j11) || (logSourceName = ConfigurationConstants.LogSourceName.getLogSourceName(j11)) == null) {
            Optional<String> deviceCacheString = getDeviceCacheString(instance2);
            if (deviceCacheString.isAvailable()) {
