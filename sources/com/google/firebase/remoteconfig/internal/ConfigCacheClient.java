...
public class ConfigCacheClient {
    ...
    private static <TResult> TResult await(Task<TResult> task, long j11, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ Task lambda$put$1(boolean z11, ConfigContainer configContainer, Void voidR) throws Exception {
        if (z11) {
    ...
    public synchronized Task<ConfigContainer> get() {
        ...
        if (task == null || (task.isComplete() && !this.cachedContainerTask.isSuccessful())) {
            ...
            this.cachedContainerTask = Tasks.call(executor2, new qa.b(configStorageClient));
        }
    ...
    public Task<ConfigContainer> put(ConfigContainer configContainer, boolean z11) {
        return Tasks.call(this.executor, new c(this, configContainer)).onSuccessTask(this.executor, new d(this, z11, configContainer));
    }
}
