...
public class ConfigAutoFetch {
    ...
    private void autoFetch(final int i11, final long j11) {
        if (i11 == 0) {
        ...
        this.scheduledExecutorService.schedule(new Runnable() {
            public void run() {
                ConfigAutoFetch.this.fetchLatestConfig(i11, j11);
            }
    ...
    private static Boolean fetchResponseIsUpToDate(ConfigFetchHandler.FetchResponse fetchResponse, long j11) {
        boolean z11 = false;
    ...
    private void handleNotifications(java.io.InputStream r10) throws java.io.IOException {
        ...
        L_0x003b:
            ...
            if (r4 == 0) goto L_0x005b
            com.google.firebase.remoteconfig.ConfigUpdateListener r4 = r9.retryCallback     // Catch:{ JSONException -> 0x007b }
            ...
            goto L_0x0095
        L_0x005b:
            boolean r4 = r9.isEventListenersEmpty()     // Catch:{ JSONException -> 0x007b }
            if (r4 == 0) goto L_0x0062
            goto L_0x0095
        L_0x0062:
            boolean r4 = r5.has(r0)     // Catch:{ JSONException -> 0x007b }
            if (r4 == 0) goto L_0x0012
            com.google.firebase.remoteconfig.internal.ConfigFetchHandler r4 = r9.configFetchHandler     // Catch:{ JSONException -> 0x007b }
            long r6 = r4.getTemplateVersionNumber()     // Catch:{ JSONException -> 0x007b }
            long r4 = r5.getLong(r0)     // Catch:{ JSONException -> 0x007b }
            int r6 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r6 <= 0) goto L_0x0012
            r6 = 3
            r9.autoFetch(r6, r4)     // Catch:{ JSONException -> 0x007b }
            goto L_0x0012
        L_0x007b:
            r4 = move-exception
    ...
    public /* synthetic */ Task lambda$fetchLatestConfig$0(Task task, Task task2, long j11, int i11, Task task3) throws Exception {
        ...
        if (!fetchResponseIsUpToDate(fetchResponse, j11).booleanValue()) {
            autoFetch(i11, j11);
    ...
    @VisibleForTesting
    public synchronized Task<Void> fetchLatestConfig(int i11, long j11) {
        int i12;
        Task<ConfigFetchHandler.FetchResponse> fetchNowWithTypeAndAttemptNumber;
        Task<ConfigContainer> task;
        i12 = i11 - 1;
        fetchNowWithTypeAndAttemptNumber = this.configFetchHandler.fetchNowWithTypeAndAttemptNumber(ConfigFetchHandler.FetchType.REALTIME, 3 - i12);
        task = this.activatedCache.get();
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{fetchNowWithTypeAndAttemptNumber, task}).continueWithTask(this.scheduledExecutorService, new a(this, fetchNowWithTypeAndAttemptNumber, task, j11, i12));
    }
