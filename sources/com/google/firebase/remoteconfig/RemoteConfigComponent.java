...
public class RemoteConfigComponent {
    ...
    public static class GlobalBackgroundListener implements BackgroundDetector.BackgroundStateChangeListener {
        ...
        public static void ensureBackgroundListenerIsRegistered(Context context) {
            ...
            if (atomicReference.get() == null) {
                ...
                if (b.a(atomicReference, (Object) null, globalBackgroundListener)) {
        ...
        public void onBackgroundStateChanged(boolean z11) {
            RemoteConfigComponent.notifyRCInstances(z11);
        }
    }
    ...
    private static boolean isAbtSupported(FirebaseApp firebaseApp2, String str) {
        if (!str.equals("firebase") || !isPrimaryApp(firebaseApp2)) {
            return false;
        }
        return true;
    }
    ...
    /* access modifiers changed from: private */
    public static synchronized void notifyRCInstances(boolean z11) {
        synchronized (RemoteConfigComponent.class) {
            for (FirebaseRemoteConfig configUpdateBackgroundState : frcNamespaceInstancesStatic.values()) {
                configUpdateBackgroundState.setConfigUpdateBackgroundState(z11);
            }
        }
    }
    ...
    public synchronized ConfigFetchHandler getFetchHandler(String str, ConfigCacheClient configCacheClient, ConfigMetadataClient configMetadataClient) {
        ...
        if (isPrimaryApp(this.firebaseApp)) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0012: CONSTRUCTOR  (r0v7 ? I:pa.k) =  call: pa.k.<init>():void type: CONSTRUCTOR in method: com.google.firebase.remoteconfig.RemoteConfigComponent.getFetchHandler(java.lang.String, com.google.firebase.remoteconfig.internal.ConfigCacheClient, com.google.firebase.remoteconfig.internal.ConfigMetadataClient):com.google.firebase.remoteconfig.internal.ConfigFetchHandler, dex: classes6.dex
            ...
            /*
                ...
                goto L_0x0015
            L_0x0010:
                pa.k r0 = new pa.k     // Catch:{ all -> 0x0034 }
                r0.<init>()     // Catch:{ all -> 0x0034 }
            L_0x0015:
                r2 = r0
                java.util.concurrent.ScheduledExecutorService r3 = r11.executor     // Catch:{ all -> 0x0034 }
                com.google.android.gms.common.util.Clock r4 = DEFAULT_CLOCK     // Catch:{ all -> 0x0034 }
        ...
        @VisibleForTesting
        public RemoteConfigComponent(Context context2, ScheduledExecutorService scheduledExecutorService, FirebaseApp firebaseApp2, FirebaseInstallationsApi firebaseInstallationsApi, FirebaseABTesting firebaseABTesting, Provider<AnalyticsConnector> provider, boolean z11) {
