        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 3002454:
                    ...
                    break;
                case 230943785:
                    if (nextName.equals(HexAttribute.HEX_ATTR_JSERROR_BUILDID)) {
                        c11 = 2;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 96801:
                    ...
                    break;
                case 107332:
                    if (nextName.equals(LogWriteConstants.LOG_TYPE)) {
                        c11 = 2;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -80231855:
                    ...
                    break;
                case 555169704:
                    if (nextName.equals(InstabugDbContract.SurveyEntry.COLUMN_CUSTOM_ATTRIBUTES)) {
                        c11 = 3;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case 3373707:
                    ...
                    break;
                case 3530753:
                    if (nextName.equals(BindingAdaptersKt.QUERY_SIZE)) {
                        c11 = 1;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -1147692044:
                    ...
                    break;
                case 3059181:
                    if (nextName.equals(Constant.PARAM_ERROR_CODE)) {
                        c11 = 1;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case 1975623094:
                    ...
                    break;
                case 1984987798:
                    if (nextName.equals(SDKCoreEvent.Session.TYPE_SESSION)) {
                        c11 = 8;
                        break;
                    }
                    break;
