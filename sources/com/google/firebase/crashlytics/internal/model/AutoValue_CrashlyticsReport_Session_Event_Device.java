...
final class AutoValue_CrashlyticsReport_Session_Event_Device extends CrashlyticsReport.Session.Event.Device {
    ...
    public int hashCode() {
        ...
        int i13 = (((i11 ^ 1000003) * 1000003) ^ this.batteryVelocity) * 1000003;
        if (this.proximityOn) {
            i12 = 1231;
        } else {
            i12 = 1237;
        ...
        return ((((((i13 ^ i12) * 1000003) ^ this.orientation) * 1000003) ^ ((int) (j11 ^ (j11 >>> 32)))) * 1000003) ^ ((int) (j12 ^ (j12 >>> 32)));
    }
    ...
    private AutoValue_CrashlyticsReport_Session_Event_Device(@Nullable Double d11, int i11, boolean z11, int i12, long j11, long j12) {
        this.batteryLevel = d11;
