...
final class AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Thread extends CrashlyticsReport.Session.Event.Application.Execution.Thread {
    ...
    private final String f47385name;
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder {
        ...
        /* renamed from: name  reason: collision with root package name */
        private String f47386name;

        public CrashlyticsReport.Session.Event.Application.Execution.Thread build() {
            String str = "";
            if (this.f47386name == null) {
                str = str + " name";
            }
            ...
            if (str.isEmpty()) {
                return new AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Thread(this.f47386name, this.importance.intValue(), this.frames);
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f47385name.equals(thread.getName()) || this.importance != thread.getImportance() || !this.frames.equals(thread.getFrames())) {
            return false;
        }
        return true;
    }
    ...
    public String getName() {
        return this.f47385name;
    }

    public int hashCode() {
        return ((((this.f47385name.hashCode() ^ 1000003) * 1000003) ^ this.importance) * 1000003) ^ this.frames.hashCode();
    }

    public String toString() {
        return "Thread{name=" + this.f47385name + ", importance=" + this.importance + ", frames=" + this.frames + "}";
    }
