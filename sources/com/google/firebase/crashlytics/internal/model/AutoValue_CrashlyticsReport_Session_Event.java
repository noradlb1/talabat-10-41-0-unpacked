...
final class AutoValue_CrashlyticsReport_Session_Event extends CrashlyticsReport.Session.Event {
    ...
    private AutoValue_CrashlyticsReport_Session_Event(long j11, String str, CrashlyticsReport.Session.Event.Application application, CrashlyticsReport.Session.Event.Device device2, @Nullable CrashlyticsReport.Session.Event.Log log2) {
        this.timestamp = j11;
        this.type = str;
        this.app = application;
        this.device = device2;
