...
final class ReportQueue {
    ...
    public void sendReport(CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, TaskCompletionSource<CrashlyticsReportWithSessionId> taskCompletionSource) {
        ...
        if (SystemClock.elapsedRealtime() - this.startTimeMs < ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.transport.schedule(Event.ofUrgent(crashlyticsReportWithSessionId.getReport()), new a(this, taskCompletionSource, z11, crashlyticsReportWithSessionId));
    }
