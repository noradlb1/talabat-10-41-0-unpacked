...
public class CommonUtils {
    ...
    private static final char[] HEX_VALUES = {'0', ExpiryDateConstantsKt.EXPIRY_DATE_ZERO_POSITION_CHECK, '2', '3', '4', '5', '6', '7', '8', '9', 'a', 'b', 'c', Advice.OffsetMapping.ForOrigin.Renderer.ForDescriptor.SYMBOL, 'e', 'f'};
    ...
    public static long convertMemInfoToBytes(String str, String str2, int i11) {
        return Long.parseLong(str.split(str2)[0].trim()) * ((long) i11);
    }
    ...
    public static String createInstanceIdFrom(String... strArr) {
        ...
        for (String str : strArr) {
            if (str != null) {
                arrayList.add(str.replace(SideMenuRewardViewHolder.DEFAULT_LOGGED_IN_USER_POINTS_VALUE, "").toLowerCase(Locale.US));
            }
        }
            ...
            if (totalRamInBytes == -1) {
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        ...
                        } else if (upperCase.endsWith(Profile.Country.GB)) {
                            convertMemInfoToBytes = convertMemInfoToBytes(upperCase, Profile.Country.GB, 1073741824);
                        } else {
                            Logger logger = Logger.getLogger();
                            logger.w("Unexpected meminfo format while computing RAM: " + upperCase);
                        }
                        j12 = convertMemInfoToBytes;
                    } catch (NumberFormatException e11) {
                        Logger logger2 = Logger.getLogger();
                        logger2.e("Unexpected meminfo format while computing RAM: " + upperCase, e11);
                    }
                }
                totalRamInBytes = j12;
            }
