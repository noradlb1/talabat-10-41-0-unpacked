...
public final class SessionDetails {
    ...
    public SessionDetails(@NotNull String str, @NotNull String str2, int i11, long j11) {
    ...
    @NotNull
    public final SessionDetails copy(@NotNull String str, @NotNull String str2, int i11, long j11) {
        Intrinsics.checkNotNullParameter(str, "sessionId");
        Intrinsics.checkNotNullParameter(str2, "firstSessionId");
