...
public final class LocalOverrideSettings implements SettingsProvider {
    ...
    public LocalOverrideSettings(@NotNull Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            bundle = context.getPackageManager().getApplicationInfo(context.getPackageName(), PackageManager.ApplicationInfoFlags.of(128)).metaData;
        } else {
    ...
    public Duration m9379getSessionRestartTimeoutFghU774() {
        if (this.metadata.containsKey(SESSION_RESTART_TIMEOUT)) {
            return Duration.m7615boximpl(DurationKt.toDuration(this.metadata.getInt(SESSION_RESTART_TIMEOUT), DurationUnit.SECONDS));
        }
        return null;
    }
