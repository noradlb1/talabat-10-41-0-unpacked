...
public final class SettingsCache {
    ...
    public final Object removeConfigs$com_google_firebase_firebase_sessions(@NotNull Continuation<? super Unit> continuation) {
        Object edit = PreferencesKt.edit(this.dataStore, new SettingsCache$removeConfigs$2(this, (Continuation<? super SettingsCache$removeConfigs$2>) null), continuation);
    ...
    @Nullable
    public final Object updateSamplingRate(@Nullable Double d11, @NotNull Continuation<? super Unit> continuation) {
        Object updateConfigValue = updateConfigValue(SAMPLING_RATE, d11, continuation);
        return updateConfigValue == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? updateConfigValue : Unit.INSTANCE;
    }
    ...
    @Nullable
    public final Object updateSessionCacheUpdatedTime(@Nullable Long l11, @NotNull Continuation<? super Unit> continuation) {
        Object updateConfigValue = updateConfigValue(CACHE_UPDATED_TIME, l11, continuation);
        return updateConfigValue == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED() ? updateConfigValue : Unit.INSTANCE;
    }
