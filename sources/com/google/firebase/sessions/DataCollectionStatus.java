...
public final class DataCollectionStatus {
    ...
    public DataCollectionStatus(@NotNull DataCollectionState dataCollectionState, @NotNull DataCollectionState dataCollectionState2, double d11) {
    ...
    @NotNull
    public final DataCollectionStatus copy(@NotNull DataCollectionState dataCollectionState, @NotNull DataCollectionState dataCollectionState2, double d11) {
        Intrinsics.checkNotNullParameter(dataCollectionState, "performance");
        Intrinsics.checkNotNullParameter(dataCollectionState2, "crashlytics");
