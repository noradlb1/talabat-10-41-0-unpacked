...
public abstract class ImmutableSortedMap<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    public abstract boolean containsKey(K k11);
    ...
    public abstract K getPredecessorKey(K k11);

    public abstract K getSuccessorKey(K k11);
    ...
    public abstract int indexOf(K k11);

    public abstract ImmutableSortedMap<K, V> insert(K k11, V v11);

    public abstract boolean isEmpty();

    public abstract Iterator<Map.Entry<K, V>> iterator();

    public abstract Iterator<Map.Entry<K, V>> iteratorFrom(K k11);

    public abstract ImmutableSortedMap<K, V> remove(K k11);

    public abstract Iterator<Map.Entry<K, V>> reverseIterator();

    public abstract Iterator<Map.Entry<K, V>> reverseIteratorFrom(K k11);
