...
public abstract class LLRBValueNode<K, V> implements LLRBNode<K, V> {
    ...
    public LLRBValueNode(K k11, V v11, LLRBNode<K, V> lLRBNode, LLRBNode<K, V> lLRBNode2) {
        this.key = k11;
        this.value = v11;
    ...
    public abstract LLRBValueNode<K, V> copy(K k11, V v11, LLRBNode<K, V> lLRBNode, LLRBNode<K, V> lLRBNode2);
    ...
    public LLRBNode<K, V> insert(K k11, V v11, Comparator<K> comparator) {
        ...
        int compare = comparator.compare(k11, this.key);
        if (compare < 0) {
            lLRBValueNode = copy((Object) null, (Object) null, this.left.insert(k11, v11, comparator), (LLRBNode<K, V>) null);
        } else if (compare == 0) {
            lLRBValueNode = copy(k11, v11, (LLRBNode) null, (LLRBNode) null);
        } else {
            lLRBValueNode = copy((Object) null, (Object) null, (LLRBNode) null, this.right.insert(k11, v11, comparator));
        }
    ...
    public LLRBNode<K, V> remove(K k11, Comparator<K> comparator) {
        ...
        if (comparator.compare(k11, this.key) < 0) {
            if (this.left.isEmpty() || this.left.isRed() || ((LLRBValueNode) this.left).left.isRed()) {
                lLRBValueNode3 = this;
            } else {
                lLRBValueNode3 = moveRedLeft();
            }
            lLRBValueNode = lLRBValueNode3.copy((Object) null, (Object) null, lLRBValueNode3.left.remove(k11, comparator), (LLRBNode<K, V>) null);
        } else {
            if (this.left.isRed()) {
            ...
            if (comparator.compare(k11, lLRBValueNode2.key) == 0) {
            ...
            lLRBValueNode = lLRBValueNode2.copy((Object) null, (Object) null, (LLRBNode) null, lLRBValueNode2.right.remove(k11, comparator));
        }
        return lLRBValueNode.fixUp();
    }
    ...
    public LLRBValueNode<K, V> copy(K k11, V v11, LLRBNode.Color color, LLRBNode<K, V> lLRBNode, LLRBNode<K, V> lLRBNode2) {
        if (k11 == null) {
            k11 = this.key;
        }
        if (v11 == null) {
