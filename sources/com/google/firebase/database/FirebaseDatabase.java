...
public class FirebaseDatabase {
    ...
    public FirebaseDatabase(@NonNull FirebaseApp firebaseApp, @NonNull RepoInfo repoInfo2, @NonNull DatabaseConfig databaseConfig) {
    ...
    public synchronized void setPersistenceCacheSizeBytes(long j11) {
        assertUnfrozen("setPersistenceCacheSizeBytes");
        this.config.setPersistenceCacheSizeBytes(j11);
    }

    public synchronized void setPersistenceEnabled(boolean z11) {
        assertUnfrozen("setPersistenceEnabled");
        this.config.setPersistenceEnabled(z11);
    }

    public void useEmulator(@NonNull String str, int i11) {
        if (this.repo == null) {
            this.emulatorSettings = new EmulatedServiceSettings(str, i11);
            return;
        }
