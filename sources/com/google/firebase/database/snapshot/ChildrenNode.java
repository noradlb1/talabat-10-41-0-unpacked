...
public class ChildrenNode implements Node {
    ...
    private static void addIndentation(StringBuilder sb2, int i11) {
        ...
        if (hashVersion == hashVersion2) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    arrayList.add(next);
                    if (z11 || !next.getNode().getPriority().isEmpty()) {
                        z11 = true;
                    }
                }
            }
    ...
    public int hashCode() {
        ...
        while (it.hasNext()) {
            NamedNode next = it.next();
            i11 = (((i11 * 31) + next.getName().hashCode()) * 17) + next.getNode().hashCode();
        }
        return i11;
    }
    ...
    public void forEachChild(final ChildVisitor childVisitor, boolean z11) {
    ...
    public Object getValue(boolean z11) {
        ...
        while (it.hasNext()) {
            ...
            hashMap.put(asString, ((Node) next.getValue()).getValue(z11));
            i11++;
            if (z12) {
    ...
    private void toString(StringBuilder sb2, int i11) {
