...
public abstract class LeafNode<T extends LeafNode> implements Node {
    ...
    public abstract int compareLeafValues(T t11);
    ...
    public String getPriorityHash(Node.HashVersion hashVersion) {
        int i11 = AnonymousClass1.$SwitchMap$com$google$firebase$database$snapshot$Node$HashVersion[hashVersion.ordinal()];
        if (i11 != 1 && i11 != 2) {
