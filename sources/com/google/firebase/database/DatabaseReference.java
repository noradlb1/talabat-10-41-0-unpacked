...
public class DatabaseReference extends Query {
    ...
    public void setHijackHash(final boolean z11) {
        this.repo.scheduleNow(new Runnable() {
            public void run() {
                DatabaseReference.this.repo.setHijackHash(z11);
            }
        });
    }
    ...
    public void runTransaction(@NonNull final Transaction.Handler handler, final boolean z11) {
        if (handler != null) {
            Validation.validateWritablePath(getPath());
            this.repo.scheduleNow(new Runnable() {
                public void run() {
                    DatabaseReference databaseReference = DatabaseReference.this;
                    databaseReference.repo.startTransaction(databaseReference.getPath(), handler, z11);
                }
            });
            return;
        }
