...
public class AndroidAppCheckTokenProvider implements TokenProvider {
    ...
    public void getToken(boolean z11, @NonNull TokenProvider.GetTokenCompletionListener getTokenCompletionListener) {
        InteropAppCheckTokenProvider interopAppCheckTokenProvider = this.internalAppCheck.get();
        if (interopAppCheckTokenProvider != null) {
            interopAppCheckTokenProvider.getToken(z11).addOnSuccessListener(new a(getTokenCompletionListener)).addOnFailureListener(new b(getTokenCompletionListener));
        } else {
