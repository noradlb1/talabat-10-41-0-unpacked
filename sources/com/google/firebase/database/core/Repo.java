...
public class Repo implements PersistentConnection.Delegate {
    ...
    public static class TransactionData implements Comparable<TransactionData> {
        ...
        public static /* synthetic */ int access$2108(TransactionData transactionData) {
            int i11 = transactionData.retryCount;
            transactionData.retryCount = i11 + 1;
            return i11;
        }

        private TransactionData(Path path2, Transaction.Handler handler2, ValueEventListener valueEventListener, TransactionStatus transactionStatus, boolean z11, long j11) {
            this.path = path2;
            this.handler = handler2;
            this.outstandingListener = valueEventListener;
            this.status = transactionStatus;
            this.retryCount = 0;
            this.applyLocally = z11;
            this.order = j11;
        ...
        public int compareTo(TransactionData transactionData) {
            long j11 = this.order;
            long j12 = transactionData.order;
            if (j11 < j12) {
                return -1;
            }
            return j11 == j12 ? 0 : 1;
    ...
    /* access modifiers changed from: private */
    public Path abortTransactions(Path path, final int i11) {
        ...
        subTree.forEachAncestor(new Tree.TreeFilter<List<TransactionData>>() {
            public boolean filterTreeNode(Tree<List<TransactionData>> tree) {
                Repo.this.abortTransactionsAtNode(tree, i11);
                return false;
            }
        });
        abortTransactionsAtNode(subTree, i11);
    ...
    /* access modifiers changed from: private */
    public void abortTransactionsAtNode(Tree<List<TransactionData>> tree, int i11) {
        ...
        if (value != null) {
            ...
            if (i12 == -9) {
                ...
                Utilities.hardAssert(z14, "Unknown transaction abort reason: " + i12);
                databaseError = DatabaseError.fromCode(-25);
            }
            int i13 = -1;
            for (int i14 = 0; i14 < value.size(); i14++) {
                final TransactionData transactionData = (TransactionData) value.get(i14);
                ...
                if (access$1800 != transactionStatus) {
                    if (transactionData.status == TransactionStatus.SENT) {
                        ...
                        if (i12 == -9) {
                            ...
                            Utilities.hardAssert(z12, "Unknown transaction abort reason: " + i12);
                        }
            ...
            if (i13 == -1) {
                ...
                tree2.setValue(value.subList(0, i13 + 1));
            }
    ...
    /* access modifiers changed from: private */
    public void ackWriteAndRerunTransactions(long j11, Path path, DatabaseError databaseError) {
        boolean z11;
        if (databaseError == null || databaseError.getCode() != -25) {
            ...
            List<? extends Event> ackUserWrite = this.serverSyncTree.ackUserWrite(j11, !z11, true, this.serverClock);
    ...
    public void deferredInitialization() {
        ...
        this.serverSyncTree = new SyncTree(this.ctx, persistenceManager, new SyncTree.ListenProvider() {
            public void startListening(QuerySpec querySpec, Tag tag, ListenHashProvider listenHashProvider, final SyncTree.CompletionListener completionListener) {
                ...
                if (tag != null) {
                    l11 = Long.valueOf(tag.getTagNumber());
                } else {
                    l11 = null;
                }
                access$200.listen(asList, wireProtocolParams, listenHashProvider, l11, new RequestResultCallback() {
    ...
    private long getNextWriteId() {
        long j11 = this.nextWriteId;
        this.nextWriteId = 1 + j11;
        return j11;
    }

    private long nextTransactionOrder() {
        long j11 = this.transactionOrder;
        this.transactionOrder = 1 + j11;
        return j11;
    }
    ...
    public void pruneCompletedTransactions(Tree<List<TransactionData>> tree) {
        ...
        if (value != null) {
            ...
            while (i11 < value.size()) {
                if (((TransactionData) value.get(i11)).status == TransactionStatus.COMPLETED) {
                    value.remove(i11);
                } else {
                    i11++;
                }
    ...
    private void rerunTransactionQueue(java.util.List<com.google.firebase.database.core.Repo.TransactionData> r23, com.google.firebase.database.core.Path r24) {
        ...
        L_0x0056:
            ...
            com.google.firebase.database.DatabaseError r0 = r6.abortReason
            int r5 = r0.getCode()
            r10 = -25
            ...
            r14 = 1
            r15 = 0
            com.google.firebase.database.core.utilities.OffsetClock r5 = r1.serverClock
            r16 = r5
            java.util.List r5 = r11.ackUserWrite(r12, r14, r15, r16)
            r8.addAll(r5)
        L_0x0080:
            r5 = r9
            goto L_0x014d
        L_0x0083:
            ...
            com.google.firebase.database.DatabaseError r0 = com.google.firebase.database.DatabaseError.fromStatus(r0)
            com.google.firebase.database.core.SyncTree r10 = r1.serverSyncTree
            long r11 = r6.currentWriteId
            r13 = 1
            r14 = 0
            com.google.firebase.database.core.utilities.OffsetClock r15 = r1.serverClock
            java.util.List r5 = r10.ackUserWrite(r11, r13, r14, r15)
            r8.addAll(r5)
            goto L_0x0080
        L_0x00ac:
            com.google.firebase.database.core.Path r0 = r6.path
            ...
            com.google.firebase.database.Transaction$Handler r12 = r6.handler     // Catch:{ all -> 0x00c5 }
            com.google.firebase.database.Transaction$Result r0 = r12.doTransaction(r0)     // Catch:{ all -> 0x00c5 }
            r12 = r11
            goto L_0x00da
        L_0x00c5:
            r0 = move-exception
        ...
        L_0x014d:
            ...
            com.google.firebase.database.core.Repo$TransactionStatus r5 = com.google.firebase.database.core.Repo.TransactionStatus.COMPLETED
            com.google.firebase.database.core.Repo.TransactionStatus unused = r6.status = r5
            com.google.firebase.database.core.Path r5 = r6.path
            com.google.firebase.database.DatabaseReference r5 = com.google.firebase.database.InternalHelpers.createReference(r1, r5)
            com.google.firebase.database.snapshot.Node r8 = r6.currentInputSnapshot
            com.google.firebase.database.snapshot.IndexedNode r8 = com.google.firebase.database.snapshot.IndexedNode.from(r8)
            com.google.firebase.database.DataSnapshot r5 = com.google.firebase.database.InternalHelpers.createDataSnapshot(r5, r8)
            com.google.firebase.database.core.Repo$20 r8 = new com.google.firebase.database.core.Repo$20
            r8.<init>(r6)
            r1.scheduleNow(r8)
            com.google.firebase.database.core.Repo$21 r8 = new com.google.firebase.database.core.Repo$21
            r8.<init>(r6, r0, r5)
            r2.add(r8)
            goto L_0x0033
        L_0x017d:
                    ...
                    public void onRequestResult(String str, String str2) {
                        ...
                        if (access$600 == null) {
                            ...
                            for (int i11 = 0; i11 < arrayList2.size(); i11++) {
                                Repo.this.postEvent((Runnable) arrayList2.get(i11));
                            }
                            return;
                        }
    ...
    private void updateInfo(ChildKey childKey, Object obj) {
        ...
        try {
            ...
            this.operationLogger.error("Failed to parse info update", e11);
        }
    }
        ...
        scheduleNow(new Runnable() {
            ...
            public void run() {
                ...
                if (persistenceServerCache.exists()) {
                    Repo.this.scheduleDelayed(new c(taskCompletionSource, persistenceServerCache), C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
                }
                Repo.this.connection.get(query.getPath().asList(), query.getSpec().getParams().getWireProtocolParams()).addOnCompleteListener((Executor) ((DefaultRunLoop) Repo.this.ctx.getRunLoop()).getExecutorService(), new d(this, taskCompletionSource, persistenceServerCache, query, this));
            }
        });
    ...
    public void keepSynced(QuerySpec querySpec, boolean z11) {
        keepSynced(querySpec, z11, false);
    }
    ...
    public void onConnectionStatus(boolean z11) {
        onServerInfoUpdate(Constants.DOT_INFO_AUTHENTICATED, Boolean.valueOf(z11));
    }

    public void onDataUpdate(List<String> list, Object obj, boolean z11, Long l11) {
        ...
        if (l11 != null) {
            try {
                ...
                this.operationLogger.error("FIREBASE INTERNAL ERROR", e11);
                return;
            }
        } else if (z11) {
    ...
    public void onRangeMergeUpdate(List<String> list, List<RangeMerge> list2, Long l11) {
        ...
        if (l11 != null) {
            list3 = this.serverSyncTree.applyTaggedRangeMerges(path, arrayList, new Tag(l11.longValue()));
        } else {
    ...
    public void scheduleDelayed(Runnable runnable, long j11) {
        this.ctx.requireStarted();
        this.ctx.getRunLoop().schedule(runnable, j11);
    }
    ...
    public void setHijackHash(boolean z11) {
        this.hijackHash = z11;
    }
    ...
    public void setValue(Path path, Node node, DatabaseReference.CompletionListener completionListener) {
        ...
        this.connection.put(path.asList(), node.getValue(true), new RequestResultCallback() {
            public void onRequestResult(String str, String str2) {
                ...
                Repo.this.ackWriteAndRerunTransactions(j11, path2, access$600);
    ...
    public void startTransaction(Path path, final Transaction.Handler handler, boolean z11) {
        final DatabaseError databaseError;
        ...
        TransactionData transactionData = new TransactionData(path, handler, r42, TransactionStatus.INITIALIZING, z11, nextTransactionOrder());
        ...
        try {
            ...
            if (result != null) {
                ...
                postEvents(this.serverSyncTree.applyUserOverwrite(path, node, resolveDeferredValueSnapshot, transactionData.currentWriteId, z11, false));
    ...
    public void updateChildren(Path path, CompoundWrite compoundWrite, DatabaseReference.CompletionListener completionListener, Map<String, Object> map) {
        ...
        this.connection.merge(path.asList(), map2, new RequestResultCallback() {
            public void onRequestResult(String str, String str2) {
                ...
                Repo.this.ackWriteAndRerunTransactions(j11, path3, access$600);
    ...
    public void keepSynced(QuerySpec querySpec, boolean z11, boolean z12) {
        Utilities.hardAssert(querySpec.getPath().isEmpty() || !querySpec.getPath().getFront().equals(Constants.DOT_INFO));
        this.serverSyncTree.keepSynced(querySpec, z11, z12);
    }
