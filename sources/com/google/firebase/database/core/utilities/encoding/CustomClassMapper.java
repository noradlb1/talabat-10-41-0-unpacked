...
public class CustomClassMapper {
    ...
    public static class BeanMapper<T> {
        ...
        private static boolean isSetterOverride(Method method, Method method2) {
            ...
            Utilities.hardAssert(z12, "Expected exactly one parameter");
        ...
        private static String serializedName(String str) {
            ...
            if (str2 != null) {
                ...
                while (i11 < charArray.length && Character.isUpperCase(charArray[i11])) {
        ...
        public Map<String, Object> serialize(T t11) {
            Object obj;
            if (this.clazz.isAssignableFrom(t11.getClass())) {
                HashMap hashMap = new HashMap();
                for (String next : this.properties.values()) {
                    if (this.getters.containsKey(next)) {
                        try {
                            obj = this.getters.get(next).invoke(t11, new Object[0]);
            ...
            throw new IllegalArgumentException("Can't serialize object of class " + t11.getClass() + " with BeanMapper for class " + this.clazz);
        }
    ...
    private static Long convertLong(Object obj) {
        ...
        if (obj instanceof Double) {
            ...
            throw new DatabaseException("Numeric value out of 64-bit long range: " + d11 + ". Did you mean to use a double instead of a long?");
        }
        ...
        if (List.class.isAssignableFrom(cls)) {
            ...
            if (actualTypeArguments.length == typeParameters.length) {
                for (int i11 = 0; i11 < typeParameters.length; i11++) {
                    hashMap2.put(typeParameters[i11], actualTypeArguments[i11]);
                }
    ...
    public static <T> T deserializeToType(Object obj, Type type) {
        ...
        if (type instanceof WildcardType) {
            ...
            if (wildcardType.getLowerBounds().length <= 0) {
                ...
                Utilities.hardAssert(z11, "Wildcard type " + type + " is not upper bounded.");
    ...
    /* access modifiers changed from: private */
    public static <T> Object serialize(T t11) {
        if (t11 == null) {
            return null;
        }
        if (t11 instanceof Number) {
            ...
            } else if ((t11 instanceof Long) || (t11 instanceof Integer)) {
                return t11;
            } else {
                throw new DatabaseException(String.format("Numbers of type %s are not supported, please use an int, long, float or double", new Object[]{t11.getClass().getSimpleName()}));
            }
        } else if ((t11 instanceof String) || (t11 instanceof Boolean)) {
            return t11;
        } else {
            ...
            } else if (t11.getClass().isArray()) {
                throw new DatabaseException("Serializing Arrays is not supported, please use Lists instead");
            } else if (t11 instanceof Enum) {
                return ((Enum) t11).name();
            } else {
                return loadOrCreateBeanMapperForClass(t11.getClass()).serialize(t11);
            }
        }
    }
