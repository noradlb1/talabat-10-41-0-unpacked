...
public final class QueryParams {
    ...
    public Map<String, Object> getWireProtocolParams() {
        ...
        if (num != null) {
            ...
            int i11 = AnonymousClass1.$SwitchMap$com$google$firebase$database$core$view$QueryParams$ViewFrom[viewFrom2.ordinal()];
            if (i11 == 1) {
    ...
    public QueryParams limitToFirst(int i11) {
        QueryParams copy = copy();
        copy.limit = Integer.valueOf(i11);
        copy.viewFrom = ViewFrom.LEFT;
        return copy;
    }

    public QueryParams limitToLast(int i11) {
        QueryParams copy = copy();
        copy.limit = Integer.valueOf(i11);
