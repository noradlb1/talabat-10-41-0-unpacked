...
public class WriteTreeRef {
    ...
    public NamedNode calcNextNodeAfterPost(Node node, NamedNode namedNode, boolean z11, Index index) {
        return this.writeTree.calcNextNodeAfterPost(this.treePath, node, namedNode, z11, index);
    }
    ...
    public Node calcCompleteEventCache(Node node, List<Long> list, boolean z11) {
        return this.writeTree.calcCompleteEventCache(this.treePath, node, list, z11);
    }
}
