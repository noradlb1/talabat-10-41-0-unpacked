...
public class PruneForest {
    ...
    public <T> T foldKeptNodes(T t11, final ImmutableTree.TreeVisitor<Void, T> treeVisitor) {
        return this.pruneForest.fold(t11, new ImmutableTree.TreeVisitor<Boolean, T>() {
            public T onNodeValue(Path path, Boolean bool, T t11) {
                return !bool.booleanValue() ? treeVisitor.onNodeValue(path, null, t11) : t11;
            }
        });
    }
