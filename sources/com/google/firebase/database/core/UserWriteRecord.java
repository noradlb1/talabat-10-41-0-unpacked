...
public final class UserWriteRecord {
    ...
    public UserWriteRecord(long j11, Path path2, Node node, boolean z11) {
        this.writeId = j11;
        this.path = path2;
        this.overwrite = node;
        this.merge = null;
    ...
    public UserWriteRecord(long j11, Path path2, CompoundWrite compoundWrite) {
        this.writeId = j11;
        this.path = path2;
        this.overwrite = null;
