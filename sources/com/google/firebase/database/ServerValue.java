...
public class ServerValue {
    ...
    @NonNull
    public static final Object increment(long j11) {
        return createParameterizedServerValuePlaceholder(ServerValues.NAME_OP_INCREMENT, Long.valueOf(j11));
    }

    @NonNull
    public static final Object increment(double d11) {
        return createParameterizedServerValuePlaceholder(ServerValues.NAME_OP_INCREMENT, Double.valueOf(d11));
    }
}
