...
public class ConnectionContext {
    ...
    public ConnectionContext(Logger logger2, ConnectionTokenProvider connectionTokenProvider, ConnectionTokenProvider connectionTokenProvider2, ScheduledExecutorService scheduledExecutorService, boolean z11, String str, String str2, String str3, String str4) {
        this.logger = logger2;
        this.authTokenProvider = connectionTokenProvider;
        this.appCheckTokenProvider = connectionTokenProvider2;
        this.executorService = scheduledExecutorService;
        this.persistenceEnabled = z11;
