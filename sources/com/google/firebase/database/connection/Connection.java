...
class Connection implements WebsocketConnection.Delegate {
    ...
    public interface Delegate {
        ...
        void onReady(long j11, String str);
    }
    ...
    private void onControlMessage(Map<String, Object> map) {
        ...
        try {
            ...
            if (this.logger.logsDebug()) {
                ...
                logWrapper4.debug("Failed to parse control message: " + e11.toString(), new Object[0]);
            }
            close();
        }
    }
    ...
    private void sendData(Map<String, Object> map, boolean z11) {
    ...
    public void onDisconnect(boolean z11) {
        this.conn = null;
        if (z11 || this.state != State.REALTIME_CONNECTING) {
            if (this.logger.logsDebug()) {
    ...
    public void onMessage(Map<String, Object> map) {
        try {
            ...
            if (this.logger.logsDebug()) {
                LogWrapper logWrapper3 = this.logger;
                logWrapper3.debug("Failed to parse server message: " + e11.toString(), new Object[0]);
            }
            close();
        }
    }
    ...
    public void sendRequest(Map<String, Object> map, boolean z11) {
        HashMap hashMap = new HashMap();
        hashMap.put("t", "d");
        hashMap.put("d", map);
        sendData(hashMap, z11);
    }
