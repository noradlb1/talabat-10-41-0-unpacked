...
public interface PersistentConnection {
    ...
    public interface Delegate {
        ...
        void onConnectionStatus(boolean z11);

        void onDataUpdate(List<String> list, Object obj, boolean z11, Long l11);

        void onDisconnect();

        void onRangeMergeUpdate(List<String> list, List<RangeMerge> list2, Long l11);
    ...
    void listen(List<String> list, Map<String, Object> map, ListenHashProvider listenHashProvider, Long l11, RequestResultCallback requestResultCallback);
