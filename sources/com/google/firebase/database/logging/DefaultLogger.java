...
public class DefaultLogger implements Logger {
    ...
    public void onLogMessage(Logger.Level level, String str, String str2, long j11) {
        if (shouldLog(level, str)) {
            String buildLogMessage = buildLogMessage(level, str, str2, j11);
            int i11 = AnonymousClass1.$SwitchMap$com$google$firebase$database$logging$Logger$Level[level.ordinal()];
            if (i11 == 1) {
