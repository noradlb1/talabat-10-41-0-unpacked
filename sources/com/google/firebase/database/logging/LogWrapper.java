...
public class LogWrapper {
    ...
    public void error(String str, Throwable th2) {
        this.logger.onLogMessage(Logger.Level.ERROR, this.component, toLog(str, new Object[0]) + StringUtils.LF + exceptionStacktrace(th2), now());
    }
    ...
    public void debug(String str, Throwable th2, Object... objArr) {
        if (logsDebug()) {
            ...
            if (th2 != null) {
                log = log + StringUtils.LF + exceptionStacktrace(th2);
            }
