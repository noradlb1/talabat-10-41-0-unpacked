...
public class DatabaseError {
    ...
    private DatabaseError(int i11, String str) {
        this(i11, str, (String) null);
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public static DatabaseError fromCode(int i11) {
        Map<Integer, String> map = errorReasons;
        if (map.containsKey(Integer.valueOf(i11))) {
            return new DatabaseError(i11, map.get(Integer.valueOf(i11)), (String) null);
        }
    ...
    private DatabaseError(int i11, String str, String str2) {
        this.code = i11;
        this.message = str;
