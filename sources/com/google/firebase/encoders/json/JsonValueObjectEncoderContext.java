...
final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    public JsonValueObjectEncoderContext(@NonNull Writer writer, @NonNull Map<Class<?>, ObjectEncoder<?>> map, @NonNull Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder, boolean z11) {
    ...
    @NonNull
    public JsonValueObjectEncoderContext add(@NonNull String str, double d11) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(d11);
    }
    ...
    @NonNull
    public JsonValueObjectEncoderContext add(@NonNull String str, int i11) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(i11);
    }
    ...
    @NonNull
    public JsonValueObjectEncoderContext add(@NonNull String str, long j11) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(j11);
    }
    ...
    @NonNull
    public JsonValueObjectEncoderContext add(@NonNull String str, boolean z11) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(z11);
    }
    ...
    @NonNull
    public JsonValueObjectEncoderContext add(@Nullable Object obj, boolean z11) throws IOException {
        Class<?> cls;
        int i11 = 0;
