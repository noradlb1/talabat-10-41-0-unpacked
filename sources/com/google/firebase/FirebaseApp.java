...
public class FirebaseApp {
    ...
    private final String f47317name;
    ...
    public FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.f47317name = Preconditions.checkNotEmpty(str);
        ...
        addBackgroundStateChangeListener(new l9.b(this));
        FirebaseTrace.popTrace();
    }
    ...
    private void notifyOnAppDeleted() {
        for (FirebaseAppLifecycleListener onDeleted : this.lifecycleListeners) {
            onDeleted.onDeleted(this.f47317name, this.options);
        }
    }
    ...
    public void delete() {
        if (this.deleted.compareAndSet(false, true)) {
            synchronized (LOCK) {
                INSTANCES.remove(this.f47317name);
            }
            notifyOnAppDeleted();
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f47317name.equals(((FirebaseApp) obj).getName());
    }
    ...
    public int hashCode() {
        return this.f47317name.hashCode();
    }
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("name", this.f47317name).add("options", this.options).toString();
    }
        ...
        synchronized (LOCK) {
            ...
            if (firebaseApp != null) {
                ...
                if (allAppNames.isEmpty()) {
                    ...
                    str2 = "Available app names: " + TextUtils.join(IndicativeSentencesGeneration.DEFAULT_SEPARATOR, allAppNames);
                }
