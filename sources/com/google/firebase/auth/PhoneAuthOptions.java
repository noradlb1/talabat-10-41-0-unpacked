    ...
    public static final class Builder {
        ...
        public PhoneAuthOptions build() {
            ...
            if (multiFactorSession == null) {
                ...
                Preconditions.checkArgument(z12, "A phoneMultiFactorInfo must be set for second factor sign-in.");
            } else if (((zzag) multiFactorSession).zzf()) {
                Preconditions.checkNotEmpty(this.zzb);
                if (this.zzi == null) {
                    z12 = true;
                }
                Preconditions.checkArgument(z12, "Invalid MultiFactorSession - use the getSession method in MultiFactorResolver to get a valid sign-in session.");
            } else {
                if (this.zzi != null) {
                    z11 = true;
                } else {
                ...
                Preconditions.checkArgument(z12, "A phone number must not be set for MFA sign-in. A PhoneMultiFactorInfo should be set instead.");
            }
        ...
        @NonNull
        public Builder requireSmsValidation(boolean z11) {
            this.zzj = z11;
            return this;
        }
        ...
        @NonNull
        public Builder setTimeout(@NonNull Long l11, @NonNull TimeUnit timeUnit) {
            this.zzc = Long.valueOf(TimeUnit.SECONDS.convert(l11.longValue(), timeUnit));
            return this;
        }
    }

    public /* synthetic */ PhoneAuthOptions(FirebaseAuth firebaseAuth, Long l11, PhoneAuthProvider.OnVerificationStateChangedCallbacks onVerificationStateChangedCallbacks, Executor executor, String str, Activity activity, PhoneAuthProvider.ForceResendingToken forceResendingToken, MultiFactorSession multiFactorSession, PhoneMultiFactorInfo phoneMultiFactorInfo, boolean z11, zzar zzar) {
