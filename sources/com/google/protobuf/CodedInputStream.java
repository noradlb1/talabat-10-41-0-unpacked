...
public abstract class CodedInputStream {
    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return ((UnsafeUtil.getByte(j11 + 3) & 255) << Ascii.CAN) | (UnsafeUtil.getByte(j11) & 255) | ((UnsafeUtil.getByte(1 + j11) & 255) << 8) | ((UnsafeUtil.getByte(2 + j11) & 255) << Ascii.DLE);
        }
            ...
            if (this.currentByteBufferLimit != j14) {
                ...
                if (b12 >= 0) {
                    ...
                    if (b13 < 0) {
                        ...
                        long j17 = j16 + 1;
                        byte b14 = b13 ^ (UnsafeUtil.getByte(j16) << Ascii.SO);
                        if (b14 >= 0) {
                            j11 = (long) (b14 ^ 16256);
                        } else {
                            j16 = j17 + 1;
                            byte b15 = b14 ^ (UnsafeUtil.getByte(j17) << Ascii.NAK);
                            if (b15 < 0) {
                                b11 = b15 ^ -2080896;
                            } else {
                                j17 = j16 + 1;
