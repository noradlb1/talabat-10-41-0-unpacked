...
public abstract class AbstractConcatenatedTimeline extends Timeline {
    ...
    public int getLastWindowIndex(boolean z11) {
        ...
        if (z11) {
            i11 = this.shuffleOrder.getLastIndex();
        } else {
            i11 = i12 - 1;
        }
        while (getTimelineByChildIndex(i11).isEmpty()) {
            i11 = getPreviousChildIndex(i11, z11);
            if (i11 == -1) {
                return -1;
            }
        }
        return getFirstWindowIndexByChildIndex(i11) + getTimelineByChildIndex(i11).getLastWindowIndex(z11);
    }
