...
public final class ParsableBitArray {
    ...
    public void putInt(int i11, int i12) {
        ...
        int i14 = (8 - i13) - min;
        byte b11 = (MotionEventCompat.ACTION_POINTER_INDEX_MASK >> i13) | ((1 << i14) - 1);
        byte[] bArr = this.data;
        int i15 = this.byteOffset;
        byte b12 = (byte) (b11 & bArr[i15]);
        bArr[i15] = b12;
        int i16 = i12 - min;
        bArr[i15] = (byte) (b12 | ((i11 >>> i16) << i14));
        int i17 = i15 + 1;
        while (i16 > 8) {
        ...
        byte b13 = (byte) (bArr2[i17] & ((1 << i18) - 1));
        bArr2[i17] = b13;
        bArr2[i17] = (byte) (((i11 & ((1 << i16) - 1)) << i18) | b13);
        skipBits(i12);
        assertValidOffset();
    }
