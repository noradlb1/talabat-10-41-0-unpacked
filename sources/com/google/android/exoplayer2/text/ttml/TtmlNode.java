...
final class TtmlNode {
    ...
    private void getEventTimes(TreeSet<Long> treeSet, boolean z11) {
        ...
        if (this.children != null) {
            for (int i11 = 0; i11 < this.children.size(); i11++) {
                TtmlNode ttmlNode = this.children.get(i11);
                if (z11 || equals) {
                    z12 = true;
                } else {
                    z12 = false;
                }
                ttmlNode.getEventTimes(treeSet, z12);
            }
        }
    }
        ...
        if (isActive(j11)) {
            ...
            while (true) {
                ...
                if (i12 != intValue) {
                    ...
                    applyStyleToOutput(map4, (Cue.Builder) Assertions.checkNotNull(map3.get(str3)), i12, intValue, ((TtmlRegion) Assertions.checkNotNull(map2.get(str2))).verticalType);
                } else {
    ...
    private void traverseForText(long j11, boolean z11, String str, Map<String, Cue.Builder> map) {
        ...
        if (!TAG_METADATA.equals(this.tag)) {
            ...
            if (this.isTextNode && z11) {
            ...
            } else if ("br".equals(this.tag) && z11) {
                ...
                for (int i11 = 0; i11 < getChildCount(); i11++) {
                    ...
                    child.traverseForText(j11, z12, str, map);
                }
                if (equals) {
