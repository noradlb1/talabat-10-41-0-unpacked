...
public final class SubripDecoder extends SimpleSubtitleDecoder {
    ...
    private static long parseTimecode(Matcher matcher, int i11) {
        ...
        if (group != null) {
            j11 = Long.parseLong(group) * 60 * 60 * 1000;
        } else {
            j11 = 0;
        }
        long parseLong = j11 + (Long.parseLong((String) Assertions.checkNotNull(matcher.group(i11 + 2))) * 60 * 1000) + (Long.parseLong((String) Assertions.checkNotNull(matcher.group(i11 + 3))) * 1000);
