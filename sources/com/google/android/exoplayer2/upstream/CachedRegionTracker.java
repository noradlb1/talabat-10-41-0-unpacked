...
public final class CachedRegionTracker implements Cache.Listener {
    ...
    public synchronized int getRegionEndTimeMs(long r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            com.google.android.exoplayer2.upstream.CachedRegionTracker$Region r0 = r8.lookupRegion     // Catch:{ all -> 0x0051 }
            r0.startOffset = r9     // Catch:{ all -> 0x0051 }
            java.util.TreeSet<com.google.android.exoplayer2.upstream.CachedRegionTracker$Region> r1 = r8.regions     // Catch:{ all -> 0x0051 }
            java.lang.Object r0 = r1.floor(r0)     // Catch:{ all -> 0x0051 }
            com.google.android.exoplayer2.upstream.CachedRegionTracker$Region r0 = (com.google.android.exoplayer2.upstream.CachedRegionTracker.Region) r0     // Catch:{ all -> 0x0051 }
            r1 = -1
    ...
    public synchronized void onSpanRemoved(com.google.android.exoplayer2.upstream.cache.Cache r7, com.google.android.exoplayer2.upstream.cache.CacheSpan r8) {
        /*
            r6 = this;
            monitor-enter(r6)
            com.google.android.exoplayer2.upstream.CachedRegionTracker$Region r7 = new com.google.android.exoplayer2.upstream.CachedRegionTracker$Region     // Catch:{ all -> 0x0061 }
            long r0 = r8.position     // Catch:{ all -> 0x0061 }
            long r2 = r8.length     // Catch:{ all -> 0x0061 }
            long r2 = r2 + r0
            r7.<init>(r0, r2)     // Catch:{ all -> 0x0061 }
            java.util.TreeSet<com.google.android.exoplayer2.upstream.CachedRegionTracker$Region> r8 = r6.regions     // Catch:{ all -> 0x0061 }
            java.lang.Object r8 = r8.floor(r7)     // Catch:{ all -> 0x0061 }
            com.google.android.exoplayer2.upstream.CachedRegionTracker$Region r8 = (com.google.android.exoplayer2.upstream.CachedRegionTracker.Region) r8     // Catch:{ all -> 0x0061 }
            ...
            return
        L_0x001e:
            java.util.TreeSet<com.google.android.exoplayer2.upstream.CachedRegionTracker$Region> r0 = r6.regions     // Catch:{ all -> 0x0061 }
            r0.remove(r8)     // Catch:{ all -> 0x0061 }
            long r0 = r8.startOffset     // Catch:{ all -> 0x0061 }
            long r2 = r7.startOffset     // Catch:{ all -> 0x0061 }
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 >= 0) goto L_0x0046
            com.google.android.exoplayer2.upstream.CachedRegionTracker$Region r4 = new com.google.android.exoplayer2.upstream.CachedRegionTracker$Region     // Catch:{ all -> 0x0061 }
