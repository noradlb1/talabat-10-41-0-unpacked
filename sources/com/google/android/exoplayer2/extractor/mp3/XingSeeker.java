...
final class XingSeeker implements Seeker {
    ...
    public static XingSeeker create(long j11, long j12, MpegAudioUtil.Header header, ParsableByteArray parsableByteArray) {
        ...
        if (j13 != -1) {
            ...
            if (j13 != j14) {
                Log.w(TAG, "XING data size mismatch: " + j13 + IndicativeSentencesGeneration.DEFAULT_SEPARATOR + j14);
            }
        }
    ...
    public long getTimeUs(long j11) {
        ...
        long[] jArr = (long[]) Assertions.checkStateNotNull(this.tableOfContents);
        double d12 = (((double) j13) * 256.0d) / ((double) this.dataSize);
        ...
        return timeUsForTableIndex + Math.round(d11 * ((double) (timeUsForTableIndex2 - timeUsForTableIndex)));
    }
