...
final class MlltSeeker implements Seeker {
    ...
    public SeekMap.SeekPoints getSeekPoints(long j11) {
        Pair<Long, Long> linearlyInterpolate = linearlyInterpolate(Util.usToMs(Util.constrainValue(j11, 0, this.durationUs)), this.referenceTimesMs, this.referencePositions);
