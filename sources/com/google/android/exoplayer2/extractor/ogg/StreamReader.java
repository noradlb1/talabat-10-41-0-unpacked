...
abstract class StreamReader {
    ...
    private int readHeadersAndUpdateState(ExtractorInput extractorInput) throws IOException {
        ...
        if (oggSeeker2 != null) {
            ...
            this.oggSeeker = new DefaultOggSeeker(this, this.payloadStartPosition, extractorInput.getLength(), (long) (pageHeader.headerSize + pageHeader.bodySize), pageHeader.granulePosition, z11);
        }
        this.state = 2;
