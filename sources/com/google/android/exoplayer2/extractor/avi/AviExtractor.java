...
public final class AviExtractor implements Extractor {
    ...
    private long peekSeekOffset(ParsableByteArray parsableByteArray) {
        ...
        long j12 = this.moviStart;
        if (((long) parsableByteArray.readLittleEndianInt()) <= j12) {
            j11 = j12 + 8;
        }
    ...
    private ChunkReader processStreamList(ListChunk listChunk, int i11) {
        ...
        if (aviStreamHeaderChunk == null) {
            ...
            if (streamNameChunk != null) {
                buildUpon.setLabel(streamNameChunk.f34932name);
            }
            ...
            ChunkReader chunkReader = new ChunkReader(i11, trackType, durationUs2, aviStreamHeaderChunk.length, track);
        ...
        switch (this.state) {
            ...
            case 3:
                ...
                if (i12 == 1179011410) {
                    extractorInput.skipFully(12);
                    return 0;
                } else if (i12 == 1414744396 && readLittleEndianInt == 1769369453) {
    ...
    public void seek(long j11, long j12) {
        ...
        for (ChunkReader seekToPosition : this.chunkReaders) {
            seekToPosition.seekToPosition(j11);
        }
        if (j11 != 0) {
            this.state = 6;
