    ...
    public static final class SampleReader {
        ...
        public void onDataEnd(long j11, int i11, boolean z11) {
            if (this.startCodeValue == 182 && z11 && this.readingSample) {
                ...
                if (j12 != C.TIME_UNSET) {
                    int i12 = (int) (j11 - this.samplePosition);
                    this.output.sampleMetadata(j12, this.sampleIsKeyframe ? 1 : 0, i12, i11, (TrackOutput.CryptoData) null);
                }
            }
        ...
        public void onStartCode(int i11, long j11) {
            ...
            this.readingSample = z11;
            if (i11 != 182) {
                z12 = false;
            }
            this.lookingForVopCodingType = z12;
            this.vopBytesRead = 0;
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            if (!this.hasOutputFormat) {
                ...
                if (this.csdBuffer.onStartCode(b11, i11)) {
            ...
            if (nalUnitTargetBuffer != null) {
                ...
                if (b11 == 178 && parsableByteArray.getData()[findNalUnit + 2] == 1) {
                    this.userData.startNalUnit(b11);
                }
            }
            int i15 = limit - findNalUnit;
            this.sampleReader.onDataEnd(this.totalBytesWritten - ((long) i15), i15, this.hasOutputFormat);
