...
public final class H264Reader implements ElementaryStreamReader {
    ...
    public static final class SampleReader {
        ...
        private void outputSample(int i11) {
            ...
            if (j11 != C.TIME_UNSET) {
                ...
                this.output.sampleMetadata(j11, z11 ? 1 : 0, (int) (this.nalUnitStartPosition - this.samplePosition), i11, (TrackOutput.CryptoData) null);
            }
        }
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            endNalUnit(j11, i13, i11, this.pesTimeUs);
    ...
    public void packetStarted(long j11, int i11) {
        ...
        boolean z12 = this.randomAccessIndicator;
        if ((i11 & 2) != 0) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.randomAccessIndicator = z12 | z11;
    }
