...
final class SefReader {
    private static final Splitter ASTERISK_SPLITTER = Splitter.on((char) TypePool.Default.LazyTypeDescription.GenericTypeToken.WILDCARD_TYPE_PATH);
        ...
        while (i12 < splitToList.size()) {
            ...
            if (splitToList2.size() == 3) {
                try {
                    ...
                    throw ParserException.createForMalformedContainer((String) null, e11);
                }
            } else {
