...
public final class DownloadManager {
    ...
    public static final class DownloadUpdate {
        ...
        public DownloadUpdate(Download download2, boolean z11, List<Download> list, @Nullable Exception exc) {
    ...
    public DownloadManager(Context context2, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context2, databaseProvider, cache, factory, new b());
    }
    ...
    public static Download mergeRequest(Download download, DownloadRequest downloadRequest, int i11, long j11) {
        ...
        int i14 = download2.state;
        if (i14 == 5 || download.isTerminalState()) {
            j12 = j11;
        } else {
            j12 = download2.startTimeMs;
        }
        if (i14 == 5 || i14 == 7) {
            i12 = 7;
        } else {
    ...
    public static final class InternalHandler extends Handler {
        ...
        private void addDownload(DownloadRequest downloadRequest, int i11) {
            int i12 = 1;
            Download download = getDownload(downloadRequest.f34976id, true);
        ...
        private int getDownloadIndex(String str) {
            for (int i11 = 0; i11 < this.downloads.size(); i11++) {
                if (this.downloads.get(i11).request.f34976id.equals(str)) {
                    return i11;
                }
            }
            return -1;
        ...
        private void onContentLengthChanged(Task task, long j11) {
            Download download = (Download) Assertions.checkNotNull(getDownload(task.request.f34976id, false));
        ...
        private void onDownloadTaskStopped(Download download, @Nullable Exception exc) {
            ...
            int i13 = i11;
            long j11 = download2.startTimeMs;
            long currentTimeMillis = System.currentTimeMillis();
            long j12 = download2.contentLength;
            int i14 = download2.stopReason;
            if (exc2 == null) {
                i12 = 0;
            } else {
                i12 = 1;
            }
            Download download3 = new Download(downloadRequest, i13, j11, currentTimeMillis, j12, i14, i12, download2.progress);
            this.downloads.remove(getDownloadIndex(download3.request.f34976id));
            try {
        ...
        private void onRemoveTaskStopped(Download download) {
            ...
            this.downloads.remove(getDownloadIndex(download.request.f34976id));
            try {
                this.downloadIndex.removeDownload(download.request.f34976id);
        ...
        private void onTaskStopped(Task task) {
            String str = task.request.f34976id;
            ...
            if (access$400 != null) {
                Log.e(DownloadManager.TAG, "Task failed: " + task.request + IndicativeSentencesGeneration.DEFAULT_SEPARATOR + access$000, access$400);
            }
        ...
        private Download putDownload(Download download) {
            ...
            int downloadIndex2 = getDownloadIndex(download.request.f34976id);
            if (downloadIndex2 == -1) {
                this.downloads.add(download);
                Collections.sort(this.downloads, new b());
            } else {
        ...
        private Task syncQueuedDownload(@Nullable Task task, Download download) {
            if (task != null) {
                ...
                this.activeTasks.put(putDownloadWithState.request.f34976id, task2);
        ...
        private void syncRemovingDownload(@Nullable Task task, Download download) {
            if (task != null) {
                ...
                this.activeTasks.put(download.request.f34976id, task2);
        ...
        private void syncTasks() {
            ...
            for (int i12 = 0; i12 < this.downloads.size(); i12++) {
                ...
                Task task = this.activeTasks.get(download.request.f34976id);
