...
public final class PlaybackStats {
    ...
    public static PlaybackStats merge(PlaybackStats... playbackStatsArr) {
        ...
        int i33 = 0;
        while (i13 < length) {
            PlaybackStats playbackStats = playbackStatsArr2[i13];
            i14 += playbackStats.playbackCount;
            ...
            i16 += playbackStats.foregroundPlaybackCount;
            ...
            if (i15 == -1) {
                i15 = playbackStats.totalInitialVideoFormatHeight;
            } else {
            ...
            i31 += playbackStats.fatalErrorPlaybackCount;
            i32 += playbackStats.fatalErrorCount;
            i33 += playbackStats.nonFatalErrorCount;
            i13++;
            length = i11;
            i12 = 16;
        }
        return new PlaybackStats(i14, jArr, Collections.emptyList(), Collections.emptyList(), j23, i16, i17, i18, i19, j24, i21, i22, i23, i24, i25, j22, i26, Collections.emptyList(), Collections.emptyList(), j11, j12, j13, j14, j15, j16, i27, i28, i15, j25, i29, j26, j17, j18, j19, j21, i31, i32, i33, Collections.emptyList(), Collections.emptyList());
    }
    ...
    public long getMeanJoinTimeMs() {
        ...
        return i11 == 0 ? C.TIME_UNSET : this.totalValidJoinTimeMs / ((long) i11);
    }
