...
public final class DefaultPlaybackSessionManager implements PlaybackSessionManager {
    public static final Supplier<String> DEFAULT_SESSION_ID_GENERATOR = new t1();
        ...
        public boolean isFinishedAtEventTime(AnalyticsListener.EventTime eventTime) {
            ...
            if (mediaPeriodId != null) {
                ...
                if (mediaPeriodId2.isAd()) {
                    ...
                    if (i11 != i13 || i12 <= mediaPeriodId4.adIndexInAdGroup) {
                        return false;
                    }
                    return true;
                }
    ...
    public synchronized void updateSessions(com.google.android.exoplayer2.analytics.AnalyticsListener.EventTime r25) {
        ...
        L_0x005d:
            ...
            long r5 = com.google.android.exoplayer2.util.Util.usToMs(r5)     // Catch:{ all -> 0x0118 }
            com.google.android.exoplayer2.Timeline$Period r7 = r1.period     // Catch:{ all -> 0x0118 }
