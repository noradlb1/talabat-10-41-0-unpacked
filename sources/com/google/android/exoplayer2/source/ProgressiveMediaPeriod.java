...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public final class ExtractingLoadable implements Loader.Loadable, IcyDataSource.Listener {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        while (i11 == 0 && !this.loadCanceled) {
                            ...
                            if (j13 > ProgressiveMediaPeriod.this.continueLoadingCheckIntervalBytes + j14) {
        ...
        public void onIcyMetadata(ParsableByteArray parsableByteArray) {
            ...
            if (!this.seenIcyMetadata) {
                ...
                j11 = Math.max(ProgressiveMediaPeriod.this.getLargestQueuedTimestampUs(true), this.seekTimeUs);
            }
            int bytesLeft = parsableByteArray.bytesLeft();
            TrackOutput trackOutput = (TrackOutput) Assertions.checkNotNull(this.icyTrackOutput);
            trackOutput.sampleData(parsableByteArray, bytesLeft);
            trackOutput.sampleMetadata(j11, 1, bytesLeft, 0, (TrackOutput.CryptoData) null);
    ...
    public static final class TrackId {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (this.f34999id == trackId.f34999id && this.isIcyTrack == trackId.isIcyTrack) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (this.f34999id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }
    ...
    public ProgressiveMediaPeriod(Uri uri2, DataSource dataSource2, ProgressiveMediaExtractor progressiveMediaExtractor2, DrmSessionManager drmSessionManager2, DrmSessionEventListener.EventDispatcher eventDispatcher, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, MediaSourceEventListener.EventDispatcher eventDispatcher2, Listener listener2, Allocator allocator2, @Nullable String str, int i11) {
        ...
        this.maybeFinishPrepareRunnable = new f(this);
        this.onContinueLoadingRequestedRunnable = new g(this);
    ...
    public void maybeFinishPrepare() {
        ...
        if (!this.released && !this.prepared && this.sampleQueuesBuilt && this.seekMap != null) {
            ...
            for (int i12 = 0; i12 < length2; i12++) {
                ...
                trackGroupArr[i12] = new TrackGroup(Integer.toString(i12), format.copyWithCryptoType(this.drmSessionManager.getCryptoType(format)));
            }
    ...
    public void lambda$seekMap$1(SeekMap seekMap2) {
        ...
        if (this.icyHeaders == null) {
            ...
            seekMap3 = new SeekMap.Unseekable(C.TIME_UNSET);
        }
        this.seekMap = seekMap3;
        this.durationUs = seekMap2.getDurationUs();
        int i11 = 1;
        if (this.isLengthKnown || seekMap2.getDurationUs() != C.TIME_UNSET) {
            z11 = false;
        } else {
            z11 = true;
        }
    ...
    public long getBufferedPositionUs() {
        ...
        if (this.haveAudioVideoTracks) {
            ...
            for (int i11 = 0; i11 < length; i11++) {
                TrackState trackState2 = this.trackState;
                if (trackState2.trackIsAudioVideoFlags[i11] && trackState2.trackEnabledStates[i11] && !this.sampleQueues[i11].isLastSampleQueued()) {
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j11) {
        ...
        for (int i13 = 0; i13 < exoTrackSelectionArr.length; i13++) {
            SampleStreamImpl sampleStreamImpl = sampleStreamArr[i13];
            if (sampleStreamImpl != null && (exoTrackSelectionArr[i13] == null || !zArr[i13])) {
        ...
        if (!this.seenFirstTrackSelection ? j11 == 0 : i11 != 0) {
            z11 = false;
        } else {
            z11 = true;
        }
        for (int i14 = 0; i14 < exoTrackSelectionArr.length; i14++) {
            if (sampleStreamArr[i14] == null && (exoTrackSelection = exoTrackSelectionArr[i14]) != null) {
                ...
                if (!z11) {
                    ...
                    if (sampleQueue.seekTo(j11, true) || sampleQueue.getReadIndex() == 0) {
                        z11 = false;
                    } else {
                        z11 = true;
                    }
    ...
    public Loader.LoadErrorAction onLoadError(ExtractingLoadable extractingLoadable, long j11, long j12, IOException iOException, int i11) {
        ...
        StatsDataSource access$100 = extractingLoadable.dataSource;
        LoadEventInfo loadEventInfo = new LoadEventInfo(extractingLoadable.loadTaskId, extractingLoadable.dataSpec, access$100.getLastOpenedUri(), access$100.getLastResponseHeaders(), j11, j12, access$100.getBytesRead());
        long retryDelayMsFor = this.loadErrorHandlingPolicy.getRetryDelayMsFor(new LoadErrorHandlingPolicy.LoadErrorInfo(loadEventInfo, new MediaLoadData(1, -1, (Format) null, 0, (Object) null, Util.usToMs(extractingLoadable.seekTimeUs), Util.usToMs(this.durationUs)), iOException, i11));
