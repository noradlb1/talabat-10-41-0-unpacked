...
public final class SingleSampleMediaSource extends BaseMediaSource {
    ...
    public static final class Factory {
        ...
        public SingleSampleMediaSource createMediaSource(MediaItem.SubtitleConfiguration subtitleConfiguration, long j11) {
            return new SingleSampleMediaSource(this.trackId, subtitleConfiguration, this.dataSourceFactory, j11, this.loadErrorHandlingPolicy, this.treatLoadErrorsAsEndOfStream, this.tag);
        }
    ...
    private SingleSampleMediaSource(@Nullable String str, MediaItem.SubtitleConfiguration subtitleConfiguration, DataSource.Factory factory, long j11, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, boolean z11, @Nullable Object obj) {
        ...
        String str2 = subtitleConfiguration2.f34902id;
