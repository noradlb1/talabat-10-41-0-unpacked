...
public final class DefaultHlsExtractorFactory implements HlsExtractorFactory {
    ...
    @Nullable
    private Extractor createExtractorByFileType(int i11, Format format, @Nullable List<Format> list, TimestampAdjuster timestampAdjuster) {
        if (i11 == 0) {
    ...
    private static TsExtractor createTsExtractor(int i11, boolean z11, Format format, @Nullable List<Format> list, TimestampAdjuster timestampAdjuster) {
        int i12 = i11 | 16;
        if (list != null) {
            i12 |= 32;
        } else if (z11) {
