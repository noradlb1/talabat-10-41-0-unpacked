...
final class HlsMediaChunk extends MediaChunk {
    ...
    public static HlsMediaChunk createInstance(HlsExtractorFactory hlsExtractorFactory, DataSource dataSource, Format format, long j11, HlsMediaPlaylist hlsMediaPlaylist, HlsChunkSource.SegmentBaseHolder segmentBaseHolder, Uri uri, @Nullable List<Format> list, int i11, @Nullable Object obj, boolean z11, TimestampAdjusterProvider timestampAdjusterProvider, @Nullable HlsMediaChunk hlsMediaChunk, @Nullable byte[] bArr, @Nullable byte[] bArr2, boolean z12, PlayerId playerId2) {
        ...
        if (hlsMediaChunk2 != null) {
            ...
            boolean z17 = dataSpec == dataSpec2 || (dataSpec != null && dataSpec2 != null && dataSpec.uri.equals(dataSpec2.uri) && dataSpec.position == hlsMediaChunk2.initDataSpec.position);
            boolean z18 = uri.equals(hlsMediaChunk2.playlistUrl) && hlsMediaChunk2.loadCompleted;
            Id3Decoder id3Decoder3 = hlsMediaChunk2.id3Decoder;
            id3Decoder2 = id3Decoder3;
            parsableByteArray = hlsMediaChunk2.scratchId3Data;
            hlsMediaChunkExtractor = (!z17 || !z18 || hlsMediaChunk2.extractorInvalidated || hlsMediaChunk2.discontinuitySequenceNumber != i12) ? null : hlsMediaChunk2.extractor;
        } else {
            Uri uri2 = uri;
    ...
    private void feedDataToExtractor(DataSource dataSource, DataSpec dataSpec, boolean z11, boolean z12) throws IOException {
        ...
        try {
            prepareExtraction = prepareExtraction(dataSource, dataSpec2, z12);
            if (z13) {
    ...
    private static byte[] getEncryptionIvArray(String str) {
        ...
        System.arraycopy(byteArray, i11, bArr, (16 - byteArray.length) + i11, byteArray.length - i11);
        return bArr;
    }
    ...
    private DefaultExtractorInput prepareExtraction(DataSource dataSource, DataSpec dataSpec, boolean z11) throws IOException {
        HlsMediaChunkExtractor hlsMediaChunkExtractor;
        long j11;
