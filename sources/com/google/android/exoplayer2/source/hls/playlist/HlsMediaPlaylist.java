...
public final class HlsMediaPlaylist extends HlsPlaylist {
    ...
    public static final class Part extends SegmentBase {
        ...
        public Part(String str, @Nullable Segment segment, long j11, int i11, long j12, @Nullable DrmInitData drmInitData, @Nullable String str2, @Nullable String str3, long j13, long j14, boolean z11, boolean z12, boolean z13) {
    ...
    public static class SegmentBase implements Comparable<Long> {
        ...
        private SegmentBase(String str, @Nullable Segment segment, long j11, int i11, long j12, @Nullable DrmInitData drmInitData2, @Nullable String str2, @Nullable String str3, long j13, long j14, boolean z11) {
            this.url = str;
    ...
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HlsMediaPlaylist(int i11, String str, List<String> list, long j11, boolean z11, long j12, boolean z12, int i12, long j13, int i13, long j14, long j15, boolean z13, boolean z14, boolean z15, @Nullable DrmInitData drmInitData, List<Segment> list2, List<Part> list3, ServerControl serverControl2, Map<Uri, RenditionReport> map) {
        super(str, list, z13);
        long j16 = j11;
        String str2 = str;
        ...
        this.hasPositiveStartOffset = j16 >= 0;
    ...
    public static final class Segment extends SegmentBase {
        ...
        public Segment(String str, long j11, long j12, @Nullable String str2, @Nullable String str3) {
            this(str, (Segment) null, "", 0, -1, C.TIME_UNSET, (DrmInitData) null, str2, str3, j11, j12, false, ImmutableList.of());
        }
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public Segment(String str, @Nullable Segment segment, String str2, long j11, int i11, long j12, @Nullable DrmInitData drmInitData, @Nullable String str3, @Nullable String str4, long j13, long j14, boolean z11, List<Part> list) {
