...
public final class UrlTemplate {
    ...
    private static int parseTemplate(String str, String[] strArr, int[] iArr, String[] strArr2) {
        ...
        while (i11 < str.length()) {
            ...
            char c11 = 65535;
            if (indexOf == -1) {
                strArr[i12] = strArr[i12] + str.substring(i11);
                i11 = str.length();
            } else if (indexOf != i11) {
                strArr[i12] = strArr[i12] + str.substring(i11, indexOf);
                i11 = indexOf;
                ...
                if (substring.equals(REPRESENTATION)) {
                    ...
                    if (indexOf3 != -1) {
                        ...
                        if (!str2.endsWith("d") && !str2.endsWith(Param.X) && !str2.endsWith("X")) {
                            str2 = str2 + "d";
                        }
