...
public class SsManifest implements FilterableManifest<SsManifest> {
    ...
    public SsManifest(int i11, int i12, long j11, long j12, long j13, int i13, boolean z11, @Nullable ProtectionElement protectionElement2, StreamElement[] streamElementArr) {
        this(i11, i12, j12 == 0 ? -9223372036854775807L : Util.scaleLargeTimestamp(j12, 1000000, j11), j13 != 0 ? Util.scaleLargeTimestamp(j13, 1000000, j11) : C.TIME_UNSET, i13, z11, protectionElement2, streamElementArr);
    }
    ...
    public static class StreamElement {
        ...
        public final String f35038name;
        public final String subType;
        public final long timescale;
        public final int type;

        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        public StreamElement(String str, String str2, int i11, String str3, long j11, String str4, int i12, int i13, int i14, int i15, @Nullable String str5, Format[] formatArr, List<Long> list, long j12) {
        ...
        public StreamElement copy(Format[] formatArr) {
            ...
            return new StreamElement(str, this.chunkTemplate, this.type, this.subType, this.timescale, this.f35038name, this.maxWidth, this.maxHeight, this.displayWidth, this.displayHeight, this.language, formatArr, this.chunkStartTimes, this.chunkStartTimesUs, this.lastChunkDurationUs);
        }
        ...
        private StreamElement(String str, String str2, int i11, String str3, long j11, String str4, int i12, int i13, int i14, int i15, @Nullable String str5, Format[] formatArr, List<Long> list, long[] jArr, long j12) {
            this.baseUri = str;
            this.chunkTemplate = str2;
            this.type = i11;
            this.subType = str3;
            this.timescale = j11;
            this.f35038name = str4;
            this.maxWidth = i12;
            this.maxHeight = i13;
    ...
    private SsManifest(int i11, int i12, long j11, long j12, int i13, boolean z11, @Nullable ProtectionElement protectionElement2, StreamElement[] streamElementArr) {
