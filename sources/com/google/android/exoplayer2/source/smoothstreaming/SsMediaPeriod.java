    ...
    private static TrackGroupArray buildTrackGroups(SsManifest ssManifest, DrmSessionManager drmSessionManager2) {
        ...
        while (true) {
            ...
            for (int i12 = 0; i12 < formatArr.length; i12++) {
                ...
                formatArr2[i12] = format.copyWithCryptoType(drmSessionManager2.getCryptoType(format));
            }
            trackGroupArr[i11] = new TrackGroup(Integer.toString(i11), formatArr2);
            i11++;
        }
    }
        ...
        for (int i11 = 0; i11 < exoTrackSelectionArr.length; i11++) {
            ...
            if (chunkSampleStream != null) {
                ...
                if (exoTrackSelectionArr[i11] == null || !zArr[i11]) {
                    ...
                    ((SsChunkSource) chunkSampleStream2.getChunkSource()).updateTrackSelection(exoTrackSelectionArr[i11]);
                    arrayList.add(chunkSampleStream2);
                }
            }
            if (sampleStreamArr[i11] == null && (exoTrackSelection = exoTrackSelectionArr[i11]) != null) {
                ChunkSampleStream<SsChunkSource> buildSampleStream = buildSampleStream(exoTrackSelection, j11);
