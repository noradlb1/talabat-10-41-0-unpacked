...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!Util.areEqual(this.f34964id, textInformationFrame.f34964id) || !Util.areEqual(this.description, textInformationFrame.description) || !this.values.equals(textInformationFrame.values)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode + i11) * 31) + this.values.hashCode();
    }
    ...
    public void populateMediaMetadata(com.google.android.exoplayer2.MediaMetadata.Builder r9) {
        /*
            r8 = this;
            java.lang.String r0 = r8.f34964id
            r0.hashCode()
            int r1 = r0.hashCode()
            r2 = 4
            r3 = 3
    ...
    public String toString() {
        return this.f34964id + ": description=" + this.description + ": values=" + this.values;
    }
