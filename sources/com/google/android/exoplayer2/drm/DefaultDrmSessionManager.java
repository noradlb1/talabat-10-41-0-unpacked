...
public class DefaultDrmSessionManager implements DrmSessionManager {
    ...
    public class PreacquiredSessionReference implements DrmSessionManager.DrmSessionReference {
        ...
        public void acquire(Format format) {
            ((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler)).post(new d(this, format));
        }

        public void release() {
            Util.postOrRun((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler), new c(this));
        }
    }
    ...
    public class ProvisioningManagerImpl implements DefaultDrmSession.ProvisioningManager {
        ...
        public void onProvisionError(Exception exc, boolean z11) {
            ...
            UnmodifiableIterator<DefaultDrmSession> it = copyOf.iterator();
            while (it.hasNext()) {
                it.next().onProvisionError(exc, z11);
            }
        }
    ...
    public class ReferenceCountListenerImpl implements DefaultDrmSession.ReferenceCountListener {
        ...
        public void onReferenceCountDecremented(DefaultDrmSession defaultDrmSession, int i11) {
            if (i11 == 1 && DefaultDrmSessionManager.this.prepareCallsCount > 0 && DefaultDrmSessionManager.this.sessionKeepaliveMs != C.TIME_UNSET) {
                ...
                ((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler)).postAtTime(new e(defaultDrmSession), defaultDrmSession, SystemClock.uptimeMillis() + DefaultDrmSessionManager.this.sessionKeepaliveMs);
            } else if (i11 == 0) {
    ...
    private DrmSession maybeAcquirePlaceholderSession(int i11, boolean z11) {
        ...
        if (exoMediaDrm2.getCryptoType() != 2 || !FrameworkCryptoConfig.WORKAROUND_DEVICE_NEEDS_KEYS_TO_CONFIGURE_CODEC) {
            z12 = false;
        } else {
            z12 = true;
        }
        if (z12 || Util.linearSearch(this.useDrmSessionsForClearContentTrackTypes, i11) == -1 || exoMediaDrm2.getCryptoType() == 1) {
            return null;
        }
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    @Deprecated
    public DefaultDrmSessionManager(UUID uuid2, ExoMediaDrm exoMediaDrm2, MediaDrmCallback mediaDrmCallback, @Nullable HashMap<String, String> hashMap, boolean z11) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    @Deprecated
    public DefaultDrmSessionManager(UUID uuid2, ExoMediaDrm exoMediaDrm2, MediaDrmCallback mediaDrmCallback, @Nullable HashMap<String, String> hashMap, boolean z11, int i11) {
