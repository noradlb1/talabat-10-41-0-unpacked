...
final class Sonic {
    ...
    private int findPitchPeriod(short[] sArr, int i11) {
        ...
        if (i15 > AMDF_FREQUENCY) {
            i12 = i15 / AMDF_FREQUENCY;
        } else {
            i12 = 1;
        }
        if (this.channelCount == 1 && i12 == 1) {
            i13 = findPitchPeriodInRange(sArr, i11, this.minPeriod, this.maxPeriod);
        } else {
            downSampleInput(sArr, i11, i12);
            int findPitchPeriodInRange = findPitchPeriodInRange(this.downSampleBuffer, 0, this.minPeriod / i12, this.maxPeriod / i12);
            if (i12 != 1) {
                int i16 = findPitchPeriodInRange * i12;
                int i17 = i12 * 4;
                int i18 = i16 - i17;
                int i19 = i16 + i17;
                ...
                if (this.channelCount == 1) {
                    i13 = findPitchPeriodInRange(sArr, i11, i18, i19);
                } else {
