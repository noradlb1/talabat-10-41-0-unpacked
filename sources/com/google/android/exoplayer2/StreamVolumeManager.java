...
final class StreamVolumeManager {
    ...
    public final class VolumeChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            StreamVolumeManager.this.eventHandler.post(new c1(StreamVolumeManager.this));
        }
    }
    ...
    private static boolean getMutedFromManager(AudioManager audioManager2, int i11) {
        ...
        if (getVolumeFromManager(audioManager2, i11) == 0) {
            return true;
        }
        return false;
    }
    ...
    public void setMuted(boolean z11) {
        ...
        if (Util.SDK_INT >= 23) {
            ...
            int i12 = this.streamType;
            if (z11) {
                i11 = -100;
            } else {
                i11 = 100;
            }
            audioManager2.adjustStreamVolume(i12, i11, 1);
        } else {
