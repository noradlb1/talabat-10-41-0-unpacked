...
public final class zzcb implements zzz {
    ...
    public zzcb(zzcy zzcy, zzdl zzdl, zzae zzae, zzak zzak, zzcx zzcx, zza zza2, zzbc zzbc, zzbg zzbg, zzbk zzbk, zzbo zzbo, byte[] bArr) {
        this.zzj = zzcy;
        this.zza = zzdl;
        this.zzb = zzae;
        this.zzc = zzak;
    ...
    public final /* synthetic */ FetchPhotoResponse zze(long j11, Task task) throws Exception {
        this.zzd.zzb(task, j11, this.zze.zza());
        return (FetchPhotoResponse) task.getResult();
    }

    public final /* synthetic */ FetchPlaceResponse zzf(long j11, Task task) throws Exception {
        this.zzd.zzd(task, j11, this.zze.zza());
        return (FetchPlaceResponse) task.getResult();
    }

    public final /* synthetic */ FindAutocompletePredictionsResponse zzg(long j11, Task task) throws Exception {
        this.zzd.zzf(task, j11, this.zze.zza());
        return (FindAutocompletePredictionsResponse) task.getResult();
    }

    public final /* synthetic */ FindCurrentPlaceResponse zzh(long j11, Task task) throws Exception {
