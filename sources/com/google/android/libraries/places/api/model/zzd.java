...
final class zzd extends AutocompletePrediction.Builder {
    ...
    public final AutocompletePrediction.Builder zza(@Nullable List<zzbb> list) {
        this.zzg = list;
        return this;
    }
    ...
    public final AutocompletePrediction.Builder zzc(@Nullable List<zzbb> list) {
        this.zzh = list;
        return this;
    }

    public final AutocompletePrediction.Builder zzd(@Nullable List<zzbb> list) {
        this.zzi = list;
        return this;
    }
