...
public final class zzlp extends zzgx {
    ...
    private final int zzas(String str) {
        if ("_ldl".equals(str)) {
            this.zzt.zzf();
            return 2048;
        } else if (InstabugDbContract.FeatureRequestEntry.COLUMN_ID.equals(str)) {
            this.zzt.zzf();
            return 256;
        ...
        if (bundle2 != null) {
            for (String next : bundle2.keySet()) {
                if (!bundle.containsKey(next)) {
                    this.zzt.zzv().zzP(bundle, next, bundle2.get(next));
                }
            }
        }
    }
    ...
    public final void zzX(String str, String str2, String str3, Bundle bundle, List list, boolean z11) {
        ...
        if (bundle2 != null) {
            ...
            zzpq.zzc();
            String str8 = null;
            if (!zzf2.zzt.zzf().zzs((String) null, zzeg.zzaz) || !zzf2.zzt.zzv().zzai(231100000, true)) {
                i11 = 0;
            } else {
                i11 = 35;
            }
            ...
            for (String str9 : new TreeSet(bundle.keySet())) {
                ...
                if (i12 != 0) {
                    ...
                    if (zzag(bundle2.get(str9))) {
                        ...
                        str5 = str9;
                        i14 = i11;
                        i15 = zza(str, str2, str9, bundle2.get(str9), bundle, list, z11, false);
                    }
                    if (i15 != 0 && !"_ev".equals(str5)) {
                        zzJ(bundle, i15, str5, str5, bundle2.get(str5));
                        bundle2.remove(str5);
                        ...
                        if (!zzai(231100000, true)) {
                            ...
                            if (i18 > i13) {
                                ...
                                if (this.zzt.zzf().zzs((String) null, zzeg.zzaz)) {
                                    this.zzt.zzaA().zze().zzc("Item can't contain more than " + i13 + " item-scoped custom params", this.zzt.zzj().zzd(str7), this.zzt.zzj().zzb(bundle2));
                                    zzaq(bundle2, 28);
                                    bundle2.remove(str5);
                                } else {
    ...
    public final int zza(java.lang.String r14, java.lang.String r15, java.lang.String r16, java.lang.Object r17, android.os.Bundle r18, java.util.List r19, boolean r20, boolean r21) {
        ...
        L_0x005e:
            ...
            com.google.android.gms.measurement.internal.zzgd r9 = r7.zzt
        ...
        if (uri2 != null) {
            try {
                if (uri.isHierarchical()) {
                    str8 = uri2.getQueryParameter(ConstantsKt.DEEPLINK_UTM_CAMPAIGN);
                    str7 = uri2.getQueryParameter(ConstantsKt.DEEPLINK_UTM_SOURCE);
                    str6 = uri2.getQueryParameter(ConstantsKt.DEEPLINK_UTM_MEDIUM);
                    str5 = uri2.getQueryParameter("gclid");
                    str4 = uri2.getQueryParameter(ConstantsKt.DEEPLINK_UTM_ID);
                ...
                String queryParameter = uri2.getQueryParameter(ConstantsKt.DEEPLINK_UTM_TERM);
                if (!TextUtils.isEmpty(queryParameter)) {
                    bundle.putString(FirebaseAnalytics.Param.TERM, queryParameter);
                }
                String queryParameter2 = uri2.getQueryParameter(ConstantsKt.DEEPLINK_UTM_CONTENT);
    ...
    public final Bundle zzt(Bundle bundle) {
        ...
        if (bundle != null) {
            for (String next : bundle.keySet()) {
                ...
                if (zzA == null) {
                    this.zzt.zzaA().zzl().zzb("Param value can't be null", this.zzt.zzj().zze(next));
                } else {
                    zzP(bundle2, next, zzA);
                }
            }
        }
        return bundle2;
