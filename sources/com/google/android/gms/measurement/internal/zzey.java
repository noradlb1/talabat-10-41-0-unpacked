...
final class zzey implements Runnable {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:76:0x016c A[SYNTHETIC, Splitter:B:76:0x016c] */
    ...
    public final void run() {
        /*
            ...
            r1 = 0
            r2 = 0
            com.google.android.gms.measurement.internal.zzez r3 = r14.zza     // Catch:{ IOException -> 0x0164, all -> 0x0125 }
            ...
            java.net.URLConnection r4 = com.newrelic.agent.android.instrumentation.URLConnectionInstrumentation.openConnection(r4)     // Catch:{ IOException -> 0x0164, all -> 0x0125 }
            ...
            com.google.android.gms.measurement.internal.zzgd r5 = r3.zzt     // Catch:{ IOException -> 0x0164, all -> 0x0125 }
            r5.zzf()     // Catch:{ IOException -> 0x0164, all -> 0x0125 }
            r5 = 60000(0xea60, float:8.4078E-41)
            r4.setConnectTimeout(r5)     // Catch:{ IOException -> 0x0164, all -> 0x0125 }
            com.google.android.gms.measurement.internal.zzgd r3 = r3.zzt     // Catch:{ IOException -> 0x0164, all -> 0x0125 }
        ...
        L_0x0063:
            ...
            com.google.android.gms.measurement.internal.zzez r5 = r14.zza     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            com.google.android.gms.measurement.internal.zzlh r5 = r5.zzf     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            com.google.android.gms.measurement.internal.zzlj r5 = r5.zzu()     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            byte[] r6 = r14.zzc     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            byte[] r5 = r5.zzz(r6)     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            com.google.android.gms.measurement.internal.zzez r6 = r14.zza     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            com.google.android.gms.measurement.internal.zzgd r6 = r6.zzt     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            com.google.android.gms.measurement.internal.zzet r6 = r6.zzaA()     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            com.google.android.gms.measurement.internal.zzer r6 = r6.zzj()     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            java.lang.String r7 = "Uploading data. size"
            int r8 = r5.length     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            java.lang.Integer r9 = java.lang.Integer.valueOf(r8)     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            r6.zzb(r7, r9)     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            ...
            r4.setFixedLengthStreamingMode(r8)     // Catch:{ IOException -> 0x0118, all -> 0x0113 }
            ...
            r3.write(r5)     // Catch:{ IOException -> 0x00ac, all -> 0x00a6 }
            r3.close()     // Catch:{ IOException -> 0x00ac, all -> 0x00a6 }
            goto L_0x00b2
        L_0x00a6:
            r5 = move-exception
            r9 = r1
