...
public class AppMeasurementDynamiteService extends zzcb {
    ...
    public void logEventAndBundle(String str, String str2, Bundle bundle, zzcf zzcf, long j11) throws RemoteException {
        ...
        this.zza.zzaB().zzp(new zzj(this, zzcf, new zzau(str2, new zzas(bundle), "app", j11), str));
    }
    ...
    public void setUserId(@NonNull String str, long j11) throws RemoteException {
        ...
        if (str == null || !TextUtils.isEmpty(str)) {
            ...
            zzq.zzX((String) null, InstabugDbContract.FeatureRequestEntry.COLUMN_ID, str, true, j11);
            return;
        }
