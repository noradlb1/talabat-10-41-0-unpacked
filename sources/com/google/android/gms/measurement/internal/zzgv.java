...
public final class zzgv extends zzei {
    ...
    public final /* synthetic */ void zzw(String str, Bundle bundle) {
        ...
        try {
            SQLiteDatabase zzh2 = zzh.zzh();
            if (!(zzh2 instanceof SQLiteDatabase)) {
                j11 = zzh2.insertWithOnConflict("default_event_params", (String) null, contentValues, 5);
            } else {
                j11 = SQLiteInstrumentation.insertWithOnConflict(zzh2, "default_event_params", (String) null, contentValues, 5);
            }
            if (j11 == -1) {
