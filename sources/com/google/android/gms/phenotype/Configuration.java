...
public class Configuration extends AbstractSafeParcelable implements Comparable<Configuration> {
    ...
    public Configuration(@SafeParcelable.Param(id = 2) int i11, @SafeParcelable.Param(id = 3) zzi[] zziArr, @SafeParcelable.Param(id = 4) String[] strArr) {
        this.zzc = i11;
        this.zzd = zziArr;
        for (zzi zzi : zziArr) {
            this.zzf.put(zzi.f44509name, zzi);
        }
        this.zze = strArr;
        if (strArr != null) {
            Arrays.sort(strArr);
