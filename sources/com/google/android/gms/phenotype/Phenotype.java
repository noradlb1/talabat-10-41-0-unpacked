...
public final class Phenotype {
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [com.google.android.gms.phenotype.zzm, com.google.android.gms.internal.phenotype.zzd] */
    static {
        Api.ClientKey<zze> clientKey = new Api.ClientKey<>();
        CLIENT_KEY = clientKey;
        zzl zzl = new zzl();
        CLIENT_BUILDER = zzl;
        API = new Api<>("Phenotype.API", zzl, clientKey);
    }
