...
public class PublicKeyCredentialRequestOptions extends RequestOptions {
    ...
    public PublicKeyCredentialRequestOptions(@SafeParcelable.Param(id = 2) @NonNull byte[] bArr, @SafeParcelable.Param(id = 3) @Nullable Double d11, @SafeParcelable.Param(id = 4) @NonNull String str, @SafeParcelable.Param(id = 5) @Nullable List list, @SafeParcelable.Param(id = 6) @Nullable Integer num, @SafeParcelable.Param(id = 7) @Nullable TokenBinding tokenBinding, @SafeParcelable.Param(id = 8) @Nullable String str2, @SafeParcelable.Param(id = 9) @Nullable AuthenticationExtensions authenticationExtensions, @SafeParcelable.Param(id = 10) @Nullable Long l11) {
        this.zza = (byte[]) Preconditions.checkNotNull(bArr);
        this.zzb = d11;
        this.zzc = (String) Preconditions.checkNotNull(str);
        this.zzd = list;
