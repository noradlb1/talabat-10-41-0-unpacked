...
public final class zzq extends AbstractSafeParcelable {
    ...
    public zzq(@SafeParcelable.Param(id = 1) long j11, @SafeParcelable.Param(id = 2) @NonNull byte[] bArr, @SafeParcelable.Param(id = 3) @NonNull byte[] bArr2, @SafeParcelable.Param(id = 4) @NonNull byte[] bArr3) {
        this.zza = j11;
