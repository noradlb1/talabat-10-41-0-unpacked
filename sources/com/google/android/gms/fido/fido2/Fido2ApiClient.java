...
public class Fido2ApiClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    @NonNull
    public Task<PendingIntent> getRegisterPendingIntent(@NonNull PublicKeyCredentialCreationOptions publicKeyCredentialCreationOptions) {
    ...
    @NonNull
    public Task<PendingIntent> getSignPendingIntent(@NonNull PublicKeyCredentialRequestOptions publicKeyCredentialRequestOptions) {
