...
public class TokenData extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public TokenData(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) @Nullable Long l11, @SafeParcelable.Param(id = 4) boolean z11, @SafeParcelable.Param(id = 5) boolean z12, @SafeParcelable.Param(id = 6) @Nullable List list, @SafeParcelable.Param(id = 7) @Nullable String str2) {
        this.zza = i11;
