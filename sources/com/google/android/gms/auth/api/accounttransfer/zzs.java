...
public final class zzs extends zzbz {
    ...
    static {
        ...
        arrayMap.put(TalabatGTM.FAILED, FastJsonResponse.Field.forStrings(TalabatGTM.FAILED, 5));
    ...
    public zzs(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) @Nullable List list, @SafeParcelable.Param(id = 3) @Nullable List list2, @SafeParcelable.Param(id = 4) @Nullable List list3, @SafeParcelable.Param(id = 5) @Nullable List list4, @SafeParcelable.Param(id = 6) @Nullable List list5) {
        this.zza = i11;
        this.zzc = list;
        this.zzd = list2;
        this.zze = list3;
