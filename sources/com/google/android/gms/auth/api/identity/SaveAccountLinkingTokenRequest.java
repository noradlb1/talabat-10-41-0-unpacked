...
public class SaveAccountLinkingTokenRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public SaveAccountLinkingTokenRequest build() {
            ...
            Preconditions.checkArgument(z11, "Consent PendingIntent cannot be null");
            ...
            Preconditions.checkArgument(z12, "scopes cannot be null");
    ...
    public SaveAccountLinkingTokenRequest(@SafeParcelable.Param(id = 1) PendingIntent pendingIntent, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) String str2, @SafeParcelable.Param(id = 4) List list, @SafeParcelable.Param(id = 5) @Nullable String str3, @SafeParcelable.Param(id = 6) int i11) {
        this.zba = pendingIntent;
        this.zbb = str;
        this.zbc = str2;
        this.zbd = list;
