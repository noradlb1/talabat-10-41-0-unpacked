...
public abstract class GmsClient<T extends IInterface> extends BaseGmsClient<T> implements Api.Client, zaj {
    ...
    @KeepForSdk
    @VisibleForTesting
    public GmsClient(@NonNull Context context, @NonNull Handler handler, int i11, @NonNull ClientSettings clientSettings) {
    ...
    @KeepForSdk
    public GmsClient(@NonNull Context context, @NonNull Looper looper, int i11, @NonNull ClientSettings clientSettings) {
