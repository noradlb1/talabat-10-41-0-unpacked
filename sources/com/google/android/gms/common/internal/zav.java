...
public final class zav extends AbstractSafeParcelable {
    ...
    public zav(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) @Nullable IBinder iBinder, @SafeParcelable.Param(id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(id = 4) boolean z11, @SafeParcelable.Param(id = 5) boolean z12) {
        this.zaa = i11;
        this.zab = iBinder;
