...
public class ConnectionTracker {
    ...
    private final boolean zzc(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i11, boolean z11, @Nullable Executor executor) {
    ...
    private static final boolean zze(Context context, Intent intent, ServiceConnection serviceConnection, int i11, @Nullable Executor executor) {
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zza(@NonNull Context context, @NonNull String str, @NonNull Intent intent, @NonNull ServiceConnection serviceConnection, int i11, @Nullable Executor executor) {
