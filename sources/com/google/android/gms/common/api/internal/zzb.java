...
@Instrumented
public final class zzb extends Fragment implements LifecycleFragment, TraceFieldInterface {
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        try {
            TraceMachine.enterMethod(this._nr_trace, "zzb#onCreate", (ArrayList<String>) null);
        } catch (NoSuchFieldError unused) {
            TraceMachine.enterMethod((Trace) null, "zzb#onCreate", (ArrayList<String>) null);
        }
