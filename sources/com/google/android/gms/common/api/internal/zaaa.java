...
final class zaaa implements zaca {
    ...
    private final PendingIntent zaz() {
        ...
        return PendingIntent.getActivity(this.zaa, System.identityHashCode(this.zab), this.zah.getSignInIntent(), zap.zaa | C.BUFFER_FLAG_FIRST_SAMPLE);
    }
