...
final class zzfv extends zzft {
    ...
    private zzfv(byte[] bArr, int i11, int i12, boolean z11) {
        super();
    ...
    private final void zzav(int i11) throws IOException {
        if (i11 >= 0) {
            int i12 = this.limit;
            int i13 = this.pos;
            if (i11 <= i12 - i13) {
    ...
    public final String readString() throws IOException {
        ...
        if (zzfa > 0) {
            ...
            int i12 = this.pos;
            if (zzfa <= i11 - i12) {
                String str = new String(this.buffer, i12, zzfa, zzgt.UTF_8);
                this.pos += zzfa;
                return str;
            }
        }
    ...
    public final void zzaq(int i11) throws zzhc {
        if (this.zzsn != i11) {
            throw zzhc.zzgq();
        }
    }

    public final boolean zzar(int i11) throws IOException {
        int zzex;
        int i12 = i11 & 7;
        int i13 = 0;
        if (i12 == 0) {
    ...
    public final int zzas(int i11) throws zzhc {
        if (i11 >= 0) {
            int zzez = i11 + zzez();
            int i12 = this.zzso;
            if (zzez <= i12) {
    ...
    public final String zzec() throws IOException {
        ...
        if (zzfa > 0) {
            ...
            int i12 = this.pos;
            if (zzfa <= i11 - i12) {
                String zzh = zzjs.zzh(this.buffer, i12, zzfa);
                this.pos += zzfa;
                return zzh;
            }
        }
    ...
    public final zzfh zzed() throws IOException {
        ...
        if (zzfa > 0) {
            ...
            int i12 = this.pos;
            if (zzfa <= i11 - i12) {
                zzfh zza = zzfh.zza(this.buffer, i12, zzfa);
                this.pos += zzfa;
                return zza;
            }
        }
    ...
    public final int zzei() throws IOException {
        return zzft.zzau(zzfa());
    }

    public final long zzej() throws IOException {
        return zzft.zzr(zzfb());
    }
    ...
    public final long zzey() throws IOException {
        ...
        for (int i11 = 0; i11 < 64; i11 += 7) {
            byte zzff = zzff();
            j11 |= ((long) (zzff & Byte.MAX_VALUE)) << i11;
            if ((zzff & 128) == 0) {
                return j11;
            }
        }
