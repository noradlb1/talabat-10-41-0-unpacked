...
final class zzjy extends zzjt {
    private static int zza(byte[] bArr, int i11, long j11, int i12) {
        if (i12 == 0) {
            return zzjs.zzbw(i11);
        }
        if (i12 == 1) {
            return zzjs.zzv(i11, zzjp.zza(bArr, j11));
        }
        if (i12 == 2) {
            return zzjs.zzd(i11, zzjp.zza(bArr, j11), zzjp.zza(bArr, j11 + 1));
        }
    ...
    public final String zzh(byte[] bArr, int i11, int i12) throws zzhc {
        if ((i11 | i12 | ((bArr.length - i11) - i12)) >= 0) {
            ...
            while (r13 < i13) {
                ...
                if (zzju.zzd(zza2)) {
                    int i17 = i15 + 1;
                    zzju.zza(zza2, cArr, i15);
                    while (i16 < i13) {
                        byte zza3 = zzjp.zza(bArr, (long) i16);
                        if (!zzju.zzd(zza3)) {
                            break;
                        }
                        i16++;
                        zzju.zza(zza3, cArr, i17);
                        i17++;
                    }
                    r13 = i16;
                    i15 = i17;
                    ...
                    if (i16 < i13) {
                        zzju.zza(zza2, zzjp.zza(bArr, (long) i16), cArr, i15);
                        r13 = i16 + 1;
                        i15++;
                    } else {
                        throw zzhc.zzgt();
                    ...
                    if (i16 < i13 - 1) {
                        int i18 = i16 + 1;
                        zzju.zza(zza2, zzjp.zza(bArr, (long) i16), zzjp.zza(bArr, (long) i18), cArr, i15);
                        r13 = i18 + 1;
                        i15++;
                    } else {
                        throw zzhc.zzgt();
                    ...
                    int i19 = i16 + 1;
                    byte zza4 = zzjp.zza(bArr, (long) i16);
                    int i21 = i19 + 1;
                    zzju.zza(zza2, zza4, zzjp.zza(bArr, (long) i19), zzjp.zza(bArr, (long) i21), cArr, i15);
                    r13 = i21 + 1;
                    i15 = i15 + 1 + 1;
                } else {
                    throw zzhc.zzgt();
