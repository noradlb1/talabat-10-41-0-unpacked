...
final class zzgh extends zzgf<zzgs.zzd> {
    public final <UT, UB> UB zza(zzis zzis, Object obj, zzgd zzgd, zzgi<zzgs.zzd> zzgi, UB ub2, zzjj<UT, UB> zzjj) throws IOException {
        Object obj2;
        Object zza;
        ArrayList arrayList;
        zzgs.zzg zzg = (zzgs.zzg) obj;
        zzgs.zzd zzd = zzg.zzxb;
        int i11 = zzd.number;
        if (!zzd.zzwi || !zzd.zzwj) {
            zzka zzka = zzd.zzwh;
            if (zzka != zzka.ENUM) {
                switch (zzgg.zzrr[zzka.ordinal()]) {
                    case 1:
                ...
                if (zzg.zzxb.zzwg.zzg(zzdy) == null) {
                    return zzit.zza(i11, zzdy, ub2, zzjj);
                }
                obj2 = Integer.valueOf(zzdy);
            }
            zzgs.zzd zzd2 = zzg.zzxb;
            if (zzd2.zzwi) {
                zzgi.zzb(zzd2, (Object) obj2);
            } else {
                int i12 = zzgg.zzrr[zzd2.zzwh.ordinal()];
                if ((i12 == 17 || i12 == 18) && (zza = zzgi.zza(zzg.zzxb)) != null) {
            ...
            switch (zzgg.zzrr[zzd.zzwh.ordinal()]) {
                ...
                case 14:
                    arrayList = new ArrayList();
                    zzis.zzl(arrayList);
                    ub2 = zzit.zza(i11, (List<Integer>) arrayList, zzg.zzxb.zzwg, ub2, zzjj);
                    break;
                default:
    ...
    public final Object zza(zzgd zzgd, zzic zzic, int i11) {
        return zzgd.zza(zzic, i11);
    }
