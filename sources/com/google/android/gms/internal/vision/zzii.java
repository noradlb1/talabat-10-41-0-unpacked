...
final class zzii<T> implements zzir<T> {
    ...
    public static <T> zzii<T> zza(zzjj<?, ?> zzjj, zzgf<?> zzgf, zzic zzic) {
        return new zzii<>(zzjj, zzgf, zzic);
    }

    public final boolean equals(T t11, T t12) {
        if (!this.zzzi.zzv(t11).equals(this.zzzi.zzv(t12))) {
            return false;
        }
        if (this.zzyz) {
            return this.zzzj.zze((Object) t11).equals(this.zzzj.zze((Object) t12));
        }
        return true;
    }

    public final int hashCode(T t11) {
        int hashCode = this.zzzi.zzv(t11).hashCode();
        if (this.zzyz) {
            return (hashCode * 53) + this.zzzj.zze((Object) t11).hashCode();
        }
        return hashCode;
    }
    ...
    public final int zzr(T t11) {
        zzjj<?, ?> zzjj = this.zzzi;
        int zzx = zzjj.zzx(zzjj.zzv(t11)) + 0;
        if (this.zzyz) {
            return zzx + this.zzzj.zze((Object) t11).zzfo();
        }
        return zzx;
    }

    public final boolean zzt(T t11) {
        return this.zzzj.zze((Object) t11).isInitialized();
    }

    public final void zza(T t11, zzkg zzkg) throws IOException {
        Iterator<Map.Entry<?, Object>> it = this.zzzj.zze((Object) t11).iterator();
        while (it.hasNext()) {
    ...
    public final void zza(T t11, zzis zzis, zzgd zzgd) throws IOException {
        boolean z11;
        zzjj<?, ?> zzjj = this.zzzi;
        zzgf<?> zzgf = this.zzzj;
        Object zzw = zzjj.zzw(t11);
        zzgi<?> zzf = zzgf.zzf(t11);
        do {
            try {
                ...
                if (tag == 11) {
                    ...
                    while (zzis.zzdu() != Integer.MAX_VALUE) {
                        ...
                        if (tag2 == 16) {
                            i11 = zzis.zzee();
                            obj = zzgf.zza(zzgd, this.zzyy, i11);
                        } else if (tag2 == 26) {
                            if (obj != null) {
