...
public class zzam {
    ...
    public static String zzc(String str, Object obj, Object obj2, Object obj3) {
        ...
        String str3 = IndicativeSentencesGeneration.DEFAULT_SEPARATOR;
        if (!isEmpty) {
            sb2.append(str2);
            sb2.append(zzb);
            str2 = str3;
    ...
    private final void zza(int i11, String str, Object obj, Object obj2, Object obj3) {
        zzap zzap = this.zzwc;
        zzci zzdd = zzap != null ? zzap.zzdd() : null;
        if (zzdd != null) {
            String str2 = zzby.zzzb.get();
            if (Log.isLoggable(str2, i11)) {
                Log.println(i11, str2, zzc(str, obj, obj2, obj3));
            }
            if (i11 >= 5) {
        ...
        if (Log.isLoggable(str3, i11)) {
            Log.println(i11, str3, zzc(str, obj, obj2, obj3));
        }
    }
