...
public final class zzby {
    ...
    public static zzbz<Long> zzzh = zzbz.zza("analytics.local_dispatch_millis", 1800000, (long) PayloadController.PAYLOAD_REQUEUE_PERIOD_MS);
    public static zzbz<Long> zzzi = zzbz.zza("analytics.initial_local_dispatch_millis", 5000, 5000);
    private static zzbz<Long> zzzj = zzbz.zza("analytics.min_local_dispatch_millis", (long) PayloadController.PAYLOAD_REQUEUE_PERIOD_MS, (long) PayloadController.PAYLOAD_REQUEUE_PERIOD_MS);
    ...
    static {
        zzbg zzbg = zzbg.BATCH_BY_COUNT;
        zzzu = zzbz.zza("analytics.batching_strategy.k", zzbg.name(), zzbg.name());
        String name2 = zzbm.GZIP.name();
        zzzv = zzbz.zza("analytics.compression_strategy.k", name2, name2);
    }
}
