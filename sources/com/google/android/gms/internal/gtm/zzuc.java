            ...
            while (r13 < i13) {
                ...
                if (zzua.zzd(b12)) {
                    ...
                    while (i16 < i13) {
                        ...
                        i16++;
                        zzua.zza(b13, cArr, i17);
                        i17++;
                    }
                    r13 = i16;
                    i15 = i17;
                } else if (zzua.zze(b12)) {
                    if (i16 < i13) {
                        zzua.zza(b12, bArr[i16], cArr, i15);
                        r13 = i16 + 1;
                        i15++;
                    } else {
                        throw zzrk.zzpw();
                    }
                } else if (zzua.zzf(b12)) {
                    if (i16 < i13 - 1) {
                        int i18 = i16 + 1;
                        zzua.zza(b12, bArr[i16], bArr[i18], cArr, i15);
                        r13 = i18 + 1;
                        i15++;
                    } else {
                        throw zzrk.zzpw();
                    ...
                    byte b14 = bArr[i16];
                    int i21 = i19 + 1;
                    zzua.zza(b12, b14, bArr[i19], bArr[i21], cArr, i15);
                    r13 = i21 + 1;
                    i15 = i15 + 1 + 1;
                } else {
                    throw zzrk.zzpw();
