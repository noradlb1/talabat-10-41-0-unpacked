...
public enum zzb {
    ...
    COMPANY("company"),
    COMPONENT(FluidHomeScreenViewModel.METADATA_COMPONENT_KEY),
    ...
    EXPERIMENT_ID(InstabugDbContract.ExperimentsEntry.COLUMN_ID),
    ...
    INTERNAL("internal"),
    INTERVAL(SessionsConfigParameter.SYNC_INTERVAL),
    ...
    MAP(Param.MAP),
    MAX(RichContentLoadTimeTracer.MAX),
    METRIC("metric"),
    MIN("min"),
    ...
    NUMBER(CardTokenizationPlugin.ARG_NUMBER_KEY),
    ...
    PRODUCT_ID(TalabatCommonUrlConstantsKt.PRODUCT_ID),
