...
final class zzua {
    ...
    /* access modifiers changed from: private */
    public static void zza(byte b11, byte b12, char[] cArr, int i11) throws zzrk {
        if (b11 < -62 || zzg(b12)) {
            throw zzrk.zzpw();
        }
    ...
    /* access modifiers changed from: private */
    public static void zza(byte b11, byte b12, byte b13, char[] cArr, int i11) throws zzrk {
    ...
    /* access modifiers changed from: private */
    public static void zza(byte b11, byte b12, byte b13, byte b14, char[] cArr, int i11) throws zzrk {
