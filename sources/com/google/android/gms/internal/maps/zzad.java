...
public interface zzad extends IInterface {
    ...
    void zzp(float f11) throws RemoteException;

    void zzq(float f11, float f12) throws RemoteException;

    void zzr(boolean z11) throws RemoteException;

    void zzs(boolean z11) throws RemoteException;
    ...
    void zzv(float f11, float f12) throws RemoteException;

    void zzw(LatLng latLng) throws RemoteException;

    void zzx(float f11) throws RemoteException;
