...
public interface zzr extends IInterface {
    ...
    void zzq(float f11) throws RemoteException;

    void zzr(float f11, float f12) throws RemoteException;
    ...
    void zzw(float f11) throws RemoteException;

    void zzx(boolean z11) throws RemoteException;

    void zzy(float f11) throws RemoteException;
