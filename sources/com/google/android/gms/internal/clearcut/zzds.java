...
final class zzds<T> implements zzef<T> {
    ...
    private zzds(int[] iArr, Object[] objArr, int i11, int i12, int i13, zzdo zzdo, boolean z11, boolean z12, int[] iArr2, int[] iArr3, int[] iArr4, zzdw zzdw, zzcy zzcy, zzex<?, ?> zzex, zzbu<?> zzbu, zzdj zzdj) {
        zzdo zzdo2 = zzdo;
        zzbu<?> zzbu2 = zzbu;
        this.zzmi = iArr;
        this.zzmj = objArr;
    ...
    private static int zza(int i11, byte[] bArr, int i12, int i13, Object obj, zzay zzay) throws IOException {
        return zzax.zza(i11, bArr, i12, i13, zzn(obj), zzay);
    }

    private static int zza(zzef<?> zzef, int i11, byte[] bArr, int i12, int i13, zzcn<?> zzcn, zzay zzay) throws IOException {
        int zza = zza((zzef) zzef, bArr, i12, i13, zzay);
        while (true) {
            zzcn.add(zzay.zzff);
            if (zza >= i13) {
                break;
            ...
            zza = zza((zzef) zzef, bArr, zza2, i13, zzay);
        }
        return zza;
    }

    private static int zza(zzef zzef, byte[] bArr, int i11, int i12, int i13, zzay zzay) throws IOException {
        zzds zzds = (zzds) zzef;
        Object newInstance = zzds.newInstance();
        int zza = zzds.zza(newInstance, bArr, i11, i12, i13, zzay);
    ...
    private static <UT, UB> int zza(zzex<UT, UB> zzex, T t11) {
        return zzex.zzm(zzex.zzq(t11));
    }
    ...
    public static <T> zzds<T> zza(Class<T> cls, zzdm zzdm, zzdw zzdw, zzcy zzcy, zzex<?, ?> zzex, zzbu<?> zzbu, zzdj zzdj) {
        ...
        if (zzdm2 instanceof zzec) {
            ...
            boolean z11 = zzec.zzcf() == zzcg.zzg.zzkm;
            ...
            if (zzco.next()) {
                ...
                int i19 = 0;
                while (true) {
                    if (zzcx >= zzec.zzcv() || i17 >= ((zzcx - i12) << 2)) {
                        if (zzco.zzda()) {
                            i16 = (int) zzfd.zza(zzco.zzdb());
                            i15 = (int) zzfd.zza(zzco.zzdc());
                            i14 = 0;
                        } else {
                            i16 = (int) zzfd.zza(zzco.zzdd());
                            if (zzco.zzde()) {
                                i15 = (int) zzfd.zza(zzco.zzdf());
                                i14 = zzco.zzdg();
                            } else {
                                i15 = 0;
                                i14 = 0;
                        ...
                        iArr[i17] = zzco.zzcx();
                        int i21 = i17 + 1;
                        iArr[i21] = (zzco.zzdi() ? 536870912 : 0) | (zzco.zzdh() ? 268435456 : 0) | (zzco.zzcy() << 20) | i16;
                        iArr[i17 + 2] = i15 | (i14 << 20);
                        if (zzco.zzdl() != null) {
                            int i22 = (i17 / 4) << 1;
                            objArr[i22] = zzco.zzdl();
                            if (zzco.zzdj() != null) {
                                objArr[i22 + 1] = zzco.zzdj();
                            } else if (zzco.zzdk() != null) {
                                objArr[i22 + 1] = zzco.zzdk();
                            }
                        } else if (zzco.zzdj() != null) {
                            objArr[((i17 / 4) << 1) + 1] = zzco.zzdj();
                        } else if (zzco.zzdk() != null) {
                            objArr[((i17 / 4) << 1) + 1] = zzco.zzdk();
                        }
                        int zzcy2 = zzco.zzcy();
            ...
            return new zzds(iArr, objArr, i12, i11, zzec.zzcv(), zzec.zzch(), z11, false, zzec.zzct(), iArr2, iArr3, zzdw, zzcy, zzex, zzbu, zzdj);
        }
        ((zzes) zzdm2).zzcf();
        throw new NoSuchMethodError();
    }

    private final <K, V, UT, UB> UB zza(int i11, int i12, Map<K, V> map, zzck<?> zzck, UB ub2, zzex<UT, UB> zzex) {
    ...
    private static void zza(int i11, Object obj, zzfr zzfr) throws IOException {
        if (obj instanceof String) {
            zzfr.zza(i11, (String) obj);
        } else {
            zzfr.zza(i11, (zzbb) obj);
        }
    }

    private static <UT, UB> void zza(zzex<UT, UB> zzex, T t11, zzfr zzfr) throws IOException {
        zzex.zza(zzex.zzq(t11), zzfr);
    }

    private final <K, V> void zza(zzfr zzfr, int i11, Object obj, int i12) throws IOException {
        if (obj != null) {
            zzfr.zza(i11, this.zzmz.zzl(zzae(i12)), this.zzmz.zzh(obj));
        }
    }

    private final void zza(T t11, T t12, int i11) {
        long zzag = (long) (zzag(i11) & 1048575);
        if (zza(t12, i11)) {
            Object zzo = zzfd.zzo(t11, zzag);
            Object zzo2 = zzfd.zzo(t12, zzag);
            if (zzo != null && zzo2 != null) {
                zzfd.zza((Object) t11, zzag, zzci.zza(zzo, zzo2));
                zzb(t11, i11);
            } else if (zzo2 != null) {
                zzfd.zza((Object) t11, zzag, zzo2);
                zzb(t11, i11);
            }
        }
    }
    ...
    private final boolean zza(T t11, int i11, int i12, int i13) {
        return this.zzmq ? zza(t11, i11) : (i12 & i13) != 0;
    }

    private static boolean zza(Object obj, int i11, zzef zzef) {
        return zzef.zzo(zzfd.zzo(obj, (long) (i11 & 1048575)));
    }

    private final zzef zzad(int i11) {
        int i12 = (i11 / 4) << 1;
        zzef zzef = (zzef) this.zzmj[i12];
        if (zzef != null) {
            return zzef;
        }
        zzef zze = zzea.zzcm().zze((Class) this.zzmj[i12 + 1]);
        this.zzmj[i12] = zze;
        return zze;
    }
    ...
    private final void zzb(T t11, T t12, int i11) {
        ...
        if (zza(t12, i12, i11)) {
            ...
            if (zzo != null && zzo2 != null) {
                zzfd.zza((Object) t11, j11, zzci.zza(zzo, zzo2));
                zzb(t11, i12, i11);
            } else if (zzo2 != null) {
                zzfd.zza((Object) t11, j11, zzo2);
                zzb(t11, i12, i11);
            }
        }
    }
    ...
    public final void zzc(T t11) {
        ...
        if (iArr != null) {
            for (int zzag : iArr) {
                ...
                Object zzo = zzfd.zzo(t11, zzag2);
                if (zzo != null) {
                    zzfd.zza((Object) t11, zzag2, this.zzmz.zzj(zzo));
                }
            }
        }
        int[] iArr2 = this.zzmu;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:81:0x0107 A[SYNTHETIC] */
    ...
    public final boolean zzo(T r17) {
        ...
        L_0x0013:
            ...
            int r12 = r12 >>> 20
            int r12 = r3 << r12
            if (r14 == r6) goto L_0x003e
            sun.misc.Unsafe r6 = zzmh
            r15 = r4
            long r3 = (long) r14
            int r8 = r6.getInt(r1, r3)
            r6 = r14
            goto L_0x0042
        L_0x003e:
            r15 = r4
