...
final class zzby<FieldDescriptorType extends zzca<FieldDescriptorType>> {
    ...
    public static int zza(zzfl zzfl, int i11, Object obj) {
    ...
    public static void zza(zzbn zzbn, zzfl zzfl, int i11, Object obj) throws IOException {
        if (zzfl == zzfl.GROUP) {
            zzdo zzdo = (zzdo) obj;
            zzci.zzf(zzdo);
            zzbn.zzb(i11, 3);
    ...
    private static int zzb(zzca<?> zzca, Object obj) {
        ...
        if (zzca.zzax()) {
            ...
            return zzbn.zzr(zzc) + i11 + zzbn.zzz(i11);
        }
        for (Object zza : list) {
            i11 += zza(zzau, zzc, zza);
        }
        return i11;
    }
    ...
    private static int zzd(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        return z11 ? zzbn.zzb(zzc, (zzcv) (zzcr) value) : zzbn.zzd(zzc, (zzdo) value);
    }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        zzby zzby = new zzby();
        for (int i11 = 0; i11 < this.zzgt.zzdr(); i11++) {
            Map.Entry<FieldDescriptorType, Object> zzak = this.zzgt.zzak(i11);
    ...
    public final void zza(zzby<FieldDescriptorType> zzby) {
        for (int i11 = 0; i11 < zzby.zzgt.zzdr(); i11++) {
            zzc(zzby.zzgt.zzak(i11));
        }
    ...
    public final int zzas() {
        int i11 = 0;
        for (int i12 = 0; i12 < this.zzgt.zzdr(); i12++) {
            Map.Entry<FieldDescriptorType, Object> zzak = this.zzgt.zzak(i12);
            i11 += zzb((zzca<?>) (zzca) zzak.getKey(), zzak.getValue());
        }
        for (Map.Entry next : this.zzgt.zzds()) {
            i11 += zzb((zzca<?>) (zzca) next.getKey(), next.getValue());
        }
        return i11;
    }
