...
public class zzap {
    ...
    public final <ContainingType extends zzck> zzbc.zzf<ContainingType, ?> zzb(ContainingType containingtype, int i11) {
        return this.zzfd.get(new zzb(containingtype, i11));
    }

    private zzap(boolean z11) {
