...
public final class zzay extends zzaw {
    ...
    private static boolean zzd(zzap zzap, zzap zzap2) {
        ...
        if (!(zzap instanceof zzat) || !(zzap2 instanceof zzat)) {
            ...
            if (Double.isNaN(doubleValue) || Double.isNaN(doubleValue2) || ((doubleValue == 0.0d && doubleValue2 == 0.0d) || ((i11 == 0 && doubleValue2 == 0.0d) || Double.compare(doubleValue, doubleValue2) >= 0))) {
                return false;
            }
            return true;
