...
interface zzgmg {
    ...
    @Deprecated
    <T> void zzC(List<T> list, zzgmo<T> zzgmo, zzgjx zzgjx) throws IOException;

    void zzD(List<Integer> list) throws IOException;

    void zzE(List<Long> list) throws IOException;

    <T> void zzF(List<T> list, zzgmo<T> zzgmo, zzgjx zzgjx) throws IOException;
    ...
    @Deprecated
    <T> T zzr(zzgmo<T> zzgmo, zzgjx zzgjx) throws IOException;

    <T> T zzs(zzgmo<T> zzgmo, zzgjx zzgjx) throws IOException;
    ...
    void zzw(List<zzgjf> list) throws IOException;
