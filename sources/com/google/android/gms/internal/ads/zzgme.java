...
final class zzgme<E> extends zzgio<E> implements RandomAccess {
    private static final zzgme<Object> zza;
    private E[] zzb;
    private int zzc;

    static {
        zzgme<Object> zzgme = new zzgme<>(new Object[0], 0);
        zza = zzgme;
        zzgme.zzb();
    }
    ...
    public final /* bridge */ /* synthetic */ zzgku zzd(int i11) {
        if (i11 >= this.zzc) {
            return new zzgme(Arrays.copyOf(this.zzb, i11), this.zzc);
        }
        throw new IllegalArgumentException();
    }

    private zzgme(E[] eArr, int i11) {
        this.zzb = eArr;
        this.zzc = i11;
    }
