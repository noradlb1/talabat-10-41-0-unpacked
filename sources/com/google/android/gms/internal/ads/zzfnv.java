...
public final class zzfnv {
    ...
    public zzfnv(@NonNull zzaoi zzaoi, @NonNull File file, @NonNull File file2, @NonNull File file3) {
        this.zza = zzaoi;
        this.zzb = file;
        this.zzc = file3;
        this.zzd = file2;
    ...
    public final boolean zzd(long j11) {
    ...
    public final byte[] zze() {
        /*
            ...
            com.google.android.gms.internal.ads.zzgjf r0 = com.google.android.gms.internal.ads.zzgjf.zzy(r2)     // Catch:{ IOException -> 0x0021, all -> 0x0018 }
