...
public interface zzdqk {
    ...
    void zzi(@Nullable zzbij zzbij);

    void zzj(View view, View view2, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, boolean z11);

    void zzk(String str);

    void zzl(Bundle bundle);

    void zzn(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, boolean z11);
    ...
    void zzr(@Nullable View view, MotionEvent motionEvent, View view2);
    ...
    void zzv(zzbif zzbif);

    void zzw(zzbqc zzbqc);
