...
final class zzgjl extends zzgjn {
    ...
    public /* synthetic */ zzgjl(InputStream inputStream, int i11, zzgjk zzgjk) {
        super((zzgjm) null);
    ...
    private final List<byte[]> zzI(int i11) throws IOException {
    ...
    public final int zzj() throws java.io.IOException {
        ...
        L_0x006c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzgjl.zzj():int");
    }
    ...
    public final zzgjf zzw() throws IOException {
        ...
        if (zzj2 <= i11 - i12 && zzj2 > 0) {
            zzgjf zzw = zzgjf.zzw(this.zzf, i12, zzj2);
            this.zzi += zzj2;
            return zzw;
        } else if (zzj2 == 0) {
            return zzgjf.zzb;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i12 = this.zzi;
            if (zzj2 <= i11 - i12) {
                String str = new String(this.zzf, i12, zzj2, zzgkv.zzb);
                this.zzi += zzj2;
                return str;
            }
        }
        ...
        if (zzj2 > this.zzg) {
            return new String(zzM(zzj2, false), zzgkv.zzb);
        }
        zzK(zzj2);
        String str2 = new String(this.zzf, this.zzi, zzj2, zzgkv.zzb);
        this.zzi += zzj2;
        return str2;
    }
    ...
    public final String zzy() throws IOException {
        ...
        return zzgnu.zzh(bArr, i11, zzj2);
    }
