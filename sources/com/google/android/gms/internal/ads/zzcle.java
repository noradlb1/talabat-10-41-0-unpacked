...
final class zzcle implements SensorEventListener {
    ...
    public final void zza(zzcld zzcld) {
        this.zzh = zzcld;
    }
    ...
    public final void zzb() {
        if (this.zzg == null) {
            ...
            handlerThread.start();
            zzfpj zzfpj = new zzfpj(handlerThread.getLooper());
            this.zzg = zzfpj;
            if (!this.zza.registerListener(this, defaultSensor, 0, zzfpj)) {
