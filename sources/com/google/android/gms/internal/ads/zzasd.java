...
final class zzasd {
    ...
    public final long zze(zzari zzari, boolean z11, boolean z12, int i11) throws IOException, InterruptedException {
        if (this.zzc == 0) {
            if (!zzari.zzh(this.zzb, 0, 1, z11)) {
                return -1;
            }
        ...
        if (i12 != 1) {
            zzari.zzh(this.zzb, 1, i12 - 1, false);
        }
        this.zzc = 0;
