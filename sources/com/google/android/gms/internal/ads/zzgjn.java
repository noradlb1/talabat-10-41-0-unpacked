...
public abstract class zzgjn {
    ...
    public /* synthetic */ zzgjn(zzgjm zzgjm) {
    }
    ...
    public static zzgjn zzH(byte[] bArr, int i11, int i12, boolean z11) {
        zzgjh zzgjh = new zzgjh(bArr, i11, i12, z11, (zzgjg) null);
        try {
            zzgjh.zze(i12);
            return zzgjh;
        } catch (zzgkx e11) {
    ...
    public abstract int zze(int i11) throws zzgkx;
    ...
    public abstract void zzz(int i11) throws zzgkx;
}
