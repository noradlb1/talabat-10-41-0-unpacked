...
public interface zzcej extends IInterface {
    ...
    void zzg(zzcen zzcen) throws RemoteException;
    ...
    void zzl(zzbho zzbho) throws RemoteException;

    void zzm(String str) throws RemoteException;

    void zzn(boolean z11) throws RemoteException;

    void zzo(zzcem zzcem) throws RemoteException;
    ...
    void zzu(zzceh zzceh) throws RemoteException;
}
