...
final class zzafz extends zzagb {
    ...
    public /* synthetic */ zzafz(InputStream inputStream, int i11, zzafy zzafy) {
        super((zzaga) null);
        byte[] bArr = zzahg.zzd;
    ...
    public final int zze(int i11) throws zzahi {
        if (i11 >= 0) {
    ...
    public final int zzj() throws java.io.IOException {
        ...
        L_0x006d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzafz.zzj():int");
    }
    ...
    public final zzafv zzw() throws IOException {
        int zzj2 = zzj();
        int i11 = this.zzg;
        int i12 = this.zzi;
        if (zzj2 <= i11 - i12 && zzj2 > 0) {
            zzafv zzn = zzafv.zzn(this.zzf, i12, zzj2);
            this.zzi += zzj2;
            return zzn;
        } else if (zzj2 == 0) {
            return zzafv.zzb;
            ...
            byte[] zzN = zzN(zzj2);
            if (zzN != null) {
                return zzafv.zzn(zzN, 0, zzN.length);
            }
            int i13 = this.zzi;
            int i14 = this.zzg;
            int i15 = i14 - i13;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i12 = this.zzi;
            if (zzj2 <= i11 - i12) {
                String str = new String(this.zzf, i12, zzj2, zzahg.zzb);
                this.zzi += zzj2;
                return str;
            }
        }
        ...
        if (zzj2 > this.zzg) {
            return new String(zzM(zzj2, false), zzahg.zzb);
        }
        zzK(zzj2);
        String str2 = new String(this.zzf, this.zzi, zzj2, zzahg.zzb);
        this.zzi += zzj2;
        return str2;
    }
    ...
    public final String zzy() throws IOException {
        ...
        return zzaka.zzd(bArr, i11, zzj2);
    }

    public final void zzz(int i11) throws zzahi {
        if (this.zzj != i11) {
            throw zzahi.zzb();
        }
    }
