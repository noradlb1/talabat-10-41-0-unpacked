...
final class zzafk extends zzafg implements RandomAccess, zzaim {
    private static final zzafk zza = new zzafk(new boolean[0], 0, false);
    private boolean[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzahg.zzd;
        collection.getClass();
        if (!(collection instanceof zzafk)) {
            return super.addAll(collection);
        }
        zzafk zzafk = (zzafk) collection;
        int i11 = zzafk.zzc;
        if (i11 == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i12 >= i11) {
            ...
            System.arraycopy(zzafk.zzb, 0, this.zzb, this.zzc, zzafk.zzc);
            this.zzc = i13;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzafk.zzc) {
            return false;
        }
        boolean[] zArr = zzafk.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i12 = 0; i12 < this.zzc; i12++) {
            i11 = (i11 * 31) + zzahg.zza(this.zzb[i12]);
        }
        return i11;
    }
    ...
    public final /* bridge */ /* synthetic */ zzahf zzd(int i11) {
        if (i11 >= this.zzc) {
            return new zzafk(Arrays.copyOf(this.zzb, i11), this.zzc, true);
        }
    ...
    private zzafk(boolean[] zArr, int i11, boolean z11) {
        super(z11);
        this.zzb = zArr;
        this.zzc = i11;
    }
