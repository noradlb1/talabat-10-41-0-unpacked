...
final class zzaka {
    private static final zzajx zza = new zzajy();

    static {
        if (zzajv.zzx() && zzajv.zzy()) {
            int i11 = zzafh.zza;
        }
    }
    ...
    public static int zzb(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        ...
        L_0x00bb:
            r1 = r4
        L_0x00bc:
            com.google.android.gms.internal.firebase-auth-api.zzajz r7 = new com.google.android.gms.internal.firebase-auth-api.zzajz
            int r1 = r1 + -1
            r7.<init>(r1, r0)
            throw r7
        L_0x00c4:
        ...
        L_0x00ff:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaka.zzb(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    public static String zzd(byte[] bArr, int i11, int i12) throws zzahi {
        int i13;
        ...
        if ((((length - i11) - i12) | i11 | i12) >= 0) {
            ...
            while (r11 < i14) {
                ...
                if (zzajw.zzd(b12)) {
                    ...
                    if (i16 < i14) {
                        zzajw.zzc(b12, bArr[i16], cArr, i13);
                        r11 = i16 + 1;
                        i13++;
                    } else {
                        throw zzahi.zzd();
                    ...
                    if (i16 < i14 - 1) {
                        int i18 = i16 + 1;
                        zzajw.zzb(b12, bArr[i16], bArr[i18], cArr, i13);
                        r11 = i18 + 1;
                        i13++;
                    } else {
                        throw zzahi.zzd();
                    ...
                    byte b14 = bArr[i16];
                    int i21 = i19 + 1;
                    zzajw.zza(b12, b14, bArr[i19], bArr[i21], cArr, i13);
                    i13 += 2;
                    r11 = i21 + 1;
                } else {
                    throw zzahi.zzd();
