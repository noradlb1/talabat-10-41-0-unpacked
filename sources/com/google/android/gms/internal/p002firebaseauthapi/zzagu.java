...
final class zzagu extends zzafg implements RandomAccess, zzaim {
    private static final zzagu zza = new zzagu(new float[0], 0, false);
    private float[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzahg.zzd;
        collection.getClass();
        if (!(collection instanceof zzagu)) {
            return super.addAll(collection);
        }
        zzagu zzagu = (zzagu) collection;
        int i11 = zzagu.zzc;
        if (i11 == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i12 >= i11) {
            ...
            System.arraycopy(zzagu.zzb, 0, this.zzb, this.zzc, zzagu.zzc);
            this.zzc = i13;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzagu.zzc) {
            return false;
        }
        float[] fArr = zzagu.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzahf zzd(int i11) {
        if (i11 >= this.zzc) {
            return new zzagu(Arrays.copyOf(this.zzb, i11), this.zzc, true);
        }
    ...
    private zzagu(float[] fArr, int i11, boolean z11) {
        super(z11);
        this.zzb = fArr;
        this.zzc = i11;
    }
