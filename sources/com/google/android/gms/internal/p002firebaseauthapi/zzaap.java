...
public final class zzaap {
    ...
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        L_0x0100:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaap.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    private static String zzc(int i11) {
        Pair pair = (Pair) zza.get(i11);
        if (pair != null) {
    ...
    private static String zze(int i11) {
        Pair pair = (Pair) zza.get(i11);
        if (pair != null) {
