...
public class AdvertisingIdClient {
    ...
    public static final class Info {
        ...
        @Deprecated
        public Info(@Nullable String str, boolean z11) {
            this.zza = str;
            this.zzb = z11;
        }
    ...
    @VisibleForTesting
    public final boolean zzc(@Nullable Info info, boolean z11, float f11, long j11, String str, @Nullable Throwable th2) {
        if (Math.random() > 0.0d) {
            return false;
        }
