...
public class AdRequest {
    ...
    protected final zzbjg zza;

    @VisibleForTesting
    public static class Builder {
        protected final zzbjf zza;

        public Builder() {
            zzbjf zzbjf = new zzbjf();
            this.zza = zzbjf;
            zzbjf.zzx("B3EEABB8EE11C2BE770B684D95219ECB");
        }
        ...
        public Builder setContentUrl(@RecentlyNonNull String str) {
            ...
            Preconditions.checkArgument(z11, "Content URL must not exceed %d in length.  Provided length was %d.", 512, Integer.valueOf(str.length()));
            this.zza.zzC(str);
            return this;
        }
    ...
    public AdRequest(@RecentlyNonNull Builder builder) {
        this.zza = new zzbjg(builder.zza, (SearchAdRequest) null);
    }
