...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public void setCheckedIconResource(@DrawableRes int i11) {
        this.cardViewHelper.setCheckedIcon(AppCompatResources.getDrawable(getContext(), i11));
    }
    ...
    public void setRippleColorResource(@ColorRes int i11) {
        this.cardViewHelper.setRippleColor(AppCompatResources.getColorStateList(getContext(), i11));
    }
