...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private TooltipDrawable(@NonNull Context context2, AttributeSet attributeSet, @AttrRes int i11, @StyleRes int i12) {
    ...
    @NonNull
    public static TooltipDrawable createFromAttributes(@NonNull Context context2, @Nullable AttributeSet attributeSet, @AttrRes int i11, @StyleRes int i12) {
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i11, @StyleRes int i12) {
        ...
        if (textAppearance != null) {
            ...
            if (obtainStyledAttributes.hasValue(i13)) {
                textAppearance.setTextColor(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, i13));
            }
        }
