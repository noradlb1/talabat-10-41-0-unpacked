...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public DropdownMenuEndIconDelegate(@NonNull TextInputLayout textInputLayout, @DrawableRes int i11) {
    ...
    private void addRippleEffectOnFilledLayout(@NonNull AutoCompleteTextView autoCompleteTextView, int i11, int[][] iArr, @NonNull MaterialShapeDrawable materialShapeDrawable) {
    ...
    private void addRippleEffectOnOutlinedLayout(@NonNull AutoCompleteTextView autoCompleteTextView, int i11, int[][] iArr, @NonNull MaterialShapeDrawable materialShapeDrawable) {
    ...
    public void initialize() {
        ...
        if (i11 == 0) {
            if (IS_LOLLIPOP) {
                ...
                i11 = R.drawable.mtrl_ic_arrow_drop_down;
            }
        }
        this.textInputLayout.setEndIconDrawable(i11);
