...
public class MaterialButtonToggleGroup extends LinearLayout {
        ...
        public void onCheckedChanged(@NonNull MaterialButton materialButton, boolean z11) {
            ...
            if (!MaterialButtonToggleGroup.this.skipCheckedStateTracker) {
                if (MaterialButtonToggleGroup.this.singleSelection) {
                    ...
                    int unused = materialButtonToggleGroup.checkedId = i11;
                }
    ...
    public interface OnButtonCheckedListener {
        void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, @IdRes int i11, boolean z11);
    }
    ...
    public class PressedStateTracker implements MaterialButton.OnPressedChangeListener {
        ...
        public void onPressedChanged(@NonNull MaterialButton materialButton, boolean z11) {
            MaterialButtonToggleGroup.this.invalidate();
        }
    }
    ...
    /* access modifiers changed from: private */
    public void dispatchOnButtonChecked(@IdRes int i11, boolean z11) {
        Iterator<OnButtonCheckedListener> it = this.onButtonCheckedListeners.iterator();
        while (it.hasNext()) {
            it.next().onButtonChecked(this, i11, z11);
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        wrap.setCollectionInfo(AccessibilityNodeInfoCompat.CollectionInfoCompat.obtain(1, visibleButtonCount, false, i11));
    }
    ...
    public void uncheck(@IdRes int i11) {
