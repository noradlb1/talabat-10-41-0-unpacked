...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void calculateChildVisibleBoundsAtEndOfExpansion(@NonNull View view, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull MotionTiming motionTiming, @NonNull MotionTiming motionTiming2, float f11, float f12, float f13, float f14, @NonNull RectF rectF) {
    ...
    @NonNull
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f11, float f12, boolean z11, @NonNull FabTransformationSpec fabTransformationSpec) {
    ...
    private float calculateValueOfAnimationAtEndOfExpansion(@NonNull FabTransformationSpec fabTransformationSpec, @NonNull MotionTiming motionTiming, float f11, float f12) {
    ...
    private void createChildrenFadeAnimation(View view, View view2, boolean z11, boolean z12, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    private void createColorAnimation(@NonNull View view, View view2, boolean z11, boolean z12, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimator;
    ...
    private void createDependencyTranslationAnimation(@NonNull View view, @NonNull View view2, boolean z11, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list) {
    ...
    @TargetApi(21)
    private void createElevationAnimation(View view, @NonNull View view2, boolean z11, boolean z12, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimator;
    ...
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z11, boolean z12, @NonNull FabTransformationSpec fabTransformationSpec, float f11, float f12, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        Animator animator;
        View view3 = view;
        View view4 = view2;
    ...
    private void createIconFadeAnimation(View view, final View view2, boolean z11, boolean z12, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimator;
    ...
    private void createPostFillRadialExpansion(View view, long j11, long j12, long j13, int i11, int i12, float f11, @NonNull List<Animator> list) {
        long j14 = j11 + j12;
        if (j14 < j13) {
    ...
    private void createPreFillRadialExpansion(View view, long j11, int i11, int i12, float f11, @NonNull List<Animator> list) {
        if (j11 > 0) {
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(view, i11, i12, f11, f11);
    ...
    private void createTranslationAnimation(@NonNull View view, @NonNull View view2, boolean z11, boolean z12, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2, @NonNull RectF rectF) {
        ObjectAnimator objectAnimator;
    ...
    @NonNull
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull View view, @NonNull View view2, boolean z11, boolean z12) {
