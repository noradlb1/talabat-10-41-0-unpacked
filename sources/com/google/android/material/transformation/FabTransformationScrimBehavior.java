...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(@NonNull View view, boolean z11, boolean z12, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    @NonNull
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull View view, @NonNull final View view2, final boolean z11, boolean z12) {
