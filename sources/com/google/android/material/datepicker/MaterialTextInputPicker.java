...
public final class MaterialTextInputPicker<S> extends PickerFragment {
    ...
    @NonNull
    public static <T> MaterialTextInputPicker<T> newInstance(DateSelector<T> dateSelector2, @StyleRes int i11, @NonNull CalendarConstraints calendarConstraints2) {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        return this.dateSelector.onCreateTextInputView(layoutInflater.cloneInContext(new ContextThemeWrapper(getContext(), this.themeResId)), viewGroup, bundle, this.calendarConstraints, new OnSelectionChangedListener<S>() {
            ...
            public void onSelectionChanged(S s11) {
                Iterator<OnSelectionChangedListener<Object>> it = MaterialTextInputPicker.this.onSelectionChangedListeners.iterator();
                while (it.hasNext()) {
                    it.next().onSelectionChanged(s11);
                }
            }
        });
    }
