...
public final class MaterialCalendar extends PickerFragment {
    ...
    /* access modifiers changed from: private */
    @Nullable
    public DateSelector<Object> dateSelector;
    /* access modifiers changed from: private */
                        ...
                        if (!(f11 == null || next.second == null)) {
                            ...
                            for (int i13 = spanCount; i13 <= spanCount2; i13++) {
                                ...
                                if (findViewByPosition3 != null) {
                                    ...
                                    if (i13 == spanCount) {
                                        i11 = findViewByPosition.getLeft() + (findViewByPosition.getWidth() / 2);
                                    } else {
                                        i11 = 0;
                                    }
                                    if (i13 == spanCount2) {
                                        i12 = findViewByPosition2.getLeft() + (findViewByPosition2.getWidth() / 2);
                                    } else {
                                        i12 = recyclerView.getWidth();
                                    }
                                    canvas.drawRect((float) i11, (float) top, (float) i12, (float) bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
    ...
    @NonNull
    public static MaterialCalendar newInstance(@NonNull DateSelector dateSelector2, @StyleRes int i11, @NonNull CalendarConstraints calendarConstraints2) {
    ...
    public boolean addOnSelectionChangedListener(@NonNull OnSelectionChangedListener<Object> onSelectionChangedListener) {
