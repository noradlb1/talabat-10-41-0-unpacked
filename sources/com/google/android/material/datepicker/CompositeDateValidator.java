...
public final class CompositeDateValidator implements CalendarConstraints.DateValidator {
    ...
    public static final Operator ALL_OPERATOR = new Operator() {
        ...
        public boolean isValid(@NonNull List<CalendarConstraints.DateValidator> list, long j11) {
    ...
    public interface Operator {
        ...
        boolean isValid(@NonNull List<CalendarConstraints.DateValidator> list, long j11);
    }
