...
class ClockHandView extends View {
    ...
    public interface OnActionUpListener {
        void onActionUp(@FloatRange(from = 0.0d, to = 360.0d) float f11, boolean z11);
    }

    public interface OnRotateListener {
        void onRotate(@FloatRange(from = 0.0d, to = 360.0d) float f11, boolean z11);
    }
    ...
    private boolean handleTouchInput(float f11, float f12, boolean z11, boolean z12, boolean z13) {
        ...
        setHandRotation(degreesFromXY, z15);
        return true;
    }

    /* access modifiers changed from: private */
    public void setHandRotationInternal(@FloatRange(from = 0.0d, to = 360.0d) float f11, boolean z11) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if ((i11 * i11) + (i12 * i12) > this.scaledTouchSlop) {
                z14 = true;
            } else {
                z14 = false;
            }
            this.isInTapRegion = z14;
            boolean z15 = this.changedDuringTouch;
            if (actionMasked == 1) {
                z13 = true;
            } else {
                z13 = false;
    ...
    public void setCircleRadius(@Dimension int i11) {
    ...
    public void setHandRotation(@FloatRange(from = 0.0d, to = 360.0d) float f11, boolean z11) {
