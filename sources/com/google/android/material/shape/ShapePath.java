...
public class ShapePath {
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i11, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f44535y - this.startY), (double) (this.operation.f44534x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f44535y - this.startY) / (this.operation.f44534x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public float f44534x;
        /* access modifiers changed from: private */

        /* renamed from: y  reason: collision with root package name */
        public float f44535y;

        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            Matrix matrix2 = this.matrix;
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f44534x, this.f44535y);
            path.transform(matrix);
        }
    }
    ...
    public void addArc(float f11, float f12, float f13, float f14, float f15, float f16) {
        ...
        addShadowCompatOperation(arcShadowOperation, f15, f17);
    ...
    public void lineTo(float f11, float f12) {
        ...
        float unused = pathLineOperation.f44534x = f11;
        float unused2 = pathLineOperation.f44535y = f12;
