...
public class ShadowRenderer {
    ...
    public void drawCornerShadow(@NonNull Canvas canvas, @Nullable Matrix matrix, @NonNull RectF rectF, int i11, float f11, float f12) {
        boolean z11;
    ...
    public void drawEdgeShadow(@NonNull Canvas canvas, @Nullable Matrix matrix, @NonNull RectF rectF, int i11) {
    ...
    public void setShadowColor(int i11) {
        this.shadowStartColor = ColorUtils.setAlphaComponent(i11, 68);
        this.shadowMiddleColor = ColorUtils.setAlphaComponent(i11, 20);
        this.shadowEndColor = ColorUtils.setAlphaComponent(i11, 0);
