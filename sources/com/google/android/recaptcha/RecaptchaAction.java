...
public final class RecaptchaAction {
    ...
    @NonNull
    public static /* synthetic */ RecaptchaAction copy$default(@NonNull RecaptchaAction recaptchaAction, @NonNull String str, int i11, @NonNull Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public boolean equals(@Nullable @NonNull Object obj) {
        if (this == obj) {
            return true;
        }
