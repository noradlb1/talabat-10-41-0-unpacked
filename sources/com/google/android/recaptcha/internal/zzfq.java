...
final class zzfq extends zzft {
    ...
    public zzfq(byte[] bArr, int i11, int i12) {
        super((zzfs) null);
        if (bArr != null) {
    ...
    public final void zzb(byte b11) throws IOException {
        try {
            ...
            throw new zzfr(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zze), Integer.valueOf(this.zzd), 1}), e11);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i11, int i12) throws IOException {
        try {
            ...
            throw new zzfr(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(i12)}), e11);
        }
    }
    ...
    public final void zze(int i11, zzfi zzfi) throws IOException {
        zzq((i11 << 3) | 2);
        zzq(zzfi.zzd());
        zzfi.zzi(this);
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzy2 == zzy) {
                int i12 = i11 + zzy2;
                this.zze = i12;
                int zzb = zzkl.zzb(str, this.zzc, i12, this.zzd - i12);
                this.zze = i11;
                zzq((zzb - i11) - zzy2);
                this.zze = zzb;
                return;
            ...
            byte[] bArr = this.zzc;
            int i13 = this.zze;
            this.zze = zzkl.zzb(str, bArr, i13, this.zzd - i13);
        } catch (zzkk e11) {
            this.zze = i11;
            zzC(str, e11);
    ...
    public final void zzs(long j11) throws IOException {
        if (!zzft.zzd || this.zzd - this.zze < 10) {
            ...
            while ((j11 & -128) != 0) {
                ...
                int i13 = this.zze;
                this.zze = i13 + 1;
                zzkg.zzn(bArr3, (long) i13, (byte) ((((int) j11) & 127) | 128));
                j11 >>>= 7;
            }
            byte[] bArr4 = this.zzc;
            int i14 = this.zze;
            this.zze = i14 + 1;
            zzkg.zzn(bArr4, (long) i14, (byte) ((int) j11));
        }
    }
}
