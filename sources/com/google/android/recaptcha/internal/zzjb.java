...
interface zzjb {
    ...
    @Deprecated
    void zzC(List list, zzjc zzjc, zzgq zzgq) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzjc zzjc, zzgq zzgq) throws IOException;
    ...
    void zzt(Object obj, zzjc zzjc, zzgq zzgq) throws IOException;

    void zzu(Object obj, zzjc zzjc, zzgq zzgq) throws IOException;
