...
final class zzkl {
    ...
    public static String zzd(byte[] bArr, int i11, int i12) throws zzhp {
        int i13;
        ...
        if ((((length - i11) - i12) | i11 | i12) >= 0) {
            ...
            while (r11 < i14) {
                ...
                if (zzkh.zzd(b12)) {
                    ...
                    if (i16 < i14) {
                        zzkh.zzc(b12, bArr[i16], cArr, i13);
                        r11 = i16 + 1;
                        i13++;
                    } else {
                        throw zzhp.zzd();
                    ...
                    if (i16 < i14 - 1) {
                        int i18 = i16 + 1;
                        zzkh.zzb(b12, bArr[i16], bArr[i18], cArr, i13);
                        r11 = i18 + 1;
                        i13++;
                    } else {
                        throw zzhp.zzd();
                    ...
                    byte b14 = bArr[i16];
                    int i21 = i19 + 1;
                    zzkh.zza(b12, b14, bArr[i19], bArr[i21], cArr, i13);
                    i13 += 2;
                    r11 = i21 + 1;
                } else {
                    throw zzhp.zzd();
