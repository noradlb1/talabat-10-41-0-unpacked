...
final class zzfk extends zzfo {
    ...
    public /* synthetic */ zzfk(byte[] bArr, int i11, int i12, boolean z11, zzfj zzfj) {
        super((zzfn) null);
        this.zze = bArr;
        this.zzf = 0;
        this.zzh = 0;
    ...
    public final int zze(int i11) throws zzhp {
        if (i11 >= 0) {
    ...
    public final zzfi zzw() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i12 = this.zzh;
            if (zzj2 <= i11 - i12) {
                zzfi zzm = zzfi.zzm(this.zze, i12, zzj2);
                this.zzh += zzj2;
                return zzm;
            }
        }
        ...
        if (zzj2 > 0) {
            ...
            if (zzj2 <= i13 - i14) {
                int i15 = zzj2 + i14;
                this.zzh = i15;
                return new zzff(Arrays.copyOfRange(this.zze, i14, i15));
            }
        }
        if (zzj2 <= 0) {
            throw zzhp.zzf();
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i12 = this.zzh;
            if (zzj2 <= i11 - i12) {
                String str = new String(this.zze, i12, zzj2, zzhn.zzb);
                this.zzh += zzj2;
                return str;
            }
        }
    ...
    public final String zzy() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i12 = this.zzh;
            if (zzj2 <= i11 - i12) {
                String zzd = zzkl.zzd(this.zze, i12, zzj2);
                this.zzh += zzj2;
                return zzd;
            }
        }
    ...
    public final void zzz(int i11) throws zzhp {
        if (this.zzi != i11) {
            throw zzhp.zzb();
        }
    }
