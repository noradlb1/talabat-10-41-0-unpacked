...
final class zzfm extends zzfo {
    ...
    public /* synthetic */ zzfm(InputStream inputStream, int i11, zzfl zzfl) {
        super((zzfn) null);
        byte[] bArr = zzhn.zzd;
    ...
    public final zzfi zzw() throws IOException {
        ...
        if (zzj2 <= i11 - i12 && zzj2 > 0) {
            zzfi zzm = zzfi.zzm(this.zzf, i12, zzj2);
            this.zzi += zzj2;
            return zzm;
        } else if (zzj2 == 0) {
            return zzfi.zzb;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i12 = this.zzi;
            if (zzj2 <= i11 - i12) {
                String str = new String(this.zzf, i12, zzj2, zzhn.zzb);
                this.zzi += zzj2;
                return str;
            }
        }
