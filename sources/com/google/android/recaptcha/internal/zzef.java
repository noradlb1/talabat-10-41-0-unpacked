...
final class zzef {
    ...
    public final int zzb(char c11) throws zzei {
        if (c11 <= 127) {
            ...
            if (c11 <= ' ' || c11 == 127) {
                throw new zzei("Unrecognized character: 0x".concat(String.valueOf(Integer.toHexString(c11))));
            }
            throw new zzei("Unrecognized character: " + c11);
        }
        throw new zzei("Unrecognized character: 0x".concat(String.valueOf(Integer.toHexString(c11))));
    }
    ...
    private zzef(String str, char[] cArr, byte[] bArr, boolean z11) {
        this.zze = str;
        cArr.getClass();
        this.zzf = cArr;
        try {
            ...
            for (int i12 = 0; i12 < this.zzd; i12++) {
                zArr[zzem.zza(i12 * 8, this.zzb, RoundingMode.CEILING)] = true;
            }
            this.zzh = zArr;
            this.zzi = false;
