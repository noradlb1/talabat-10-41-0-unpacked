...
public class FlexboxLayout extends ViewGroup implements FlexContainer {
        ...
        if (this.mDividerDrawableVertical != null || this.mDividerDrawableHorizontal != null) {
            if (this.mShowDividerHorizontal != 0 || this.mShowDividerVertical != 0) {
                ...
                if (i11 == 0) {
                    ...
                    drawDividersHorizontal(canvas, z11, z13);
                } else if (i11 == 1) {
                    if (layoutDirection != 1) {
                        z12 = true;
                    } else {
                    ...
                    drawDividersHorizontal(canvas, z12, z13);
                } else if (i11 == 2) {
                    if (layoutDirection != 1) {
                        z14 = false;
                    }
                    ...
                    drawDividersVertical(canvas, z14, false);
                } else if (i11 == 3) {
                    if (layoutDirection == 1) {
                        z13 = true;
                    }
                    ...
                    drawDividersVertical(canvas, z13, true);
                }
            }
        }
    }
    ...
    public void onLayout(boolean z11, int i11, int i12, int i13, int i14) {
        ...
        if (i15 == 0) {
            ...
            layoutHorizontal(z12, i11, i12, i13, i14);
        } else if (i15 == 1) {
            if (layoutDirection != 1) {
                z13 = true;
            } else {
            ...
            layoutHorizontal(z13, i11, i12, i13, i14);
        } else if (i15 == 2) {
            if (layoutDirection == 1) {
                z16 = true;
            }
            ...
            layoutVertical(z14, false, i11, i12, i13, i14);
        } else if (i15 == 3) {
            if (layoutDirection == 1) {
                z16 = true;
            }
            ...
            layoutVertical(z15, true, i11, i12, i13, i14);
        } else {
