...
public class FlexboxLayoutManager extends RecyclerView.LayoutManager implements FlexContainer, RecyclerView.SmoothScroller.ScrollVectorProvider {
        ...
        public void assignCoordinateFromPadding() {
            ...
            if (FlexboxLayoutManager.this.isMainAxisDirectionHorizontal() || !FlexboxLayoutManager.this.mIsRtl) {
                if (this.mLayoutFromEnd) {
                    i11 = FlexboxLayoutManager.this.mOrientationHelper.getEndAfterPadding();
                } else {
                    i11 = FlexboxLayoutManager.this.mOrientationHelper.getStartAfterPadding();
                }
                this.mCoordinate = i11;
                return;
            }
            if (this.mLayoutFromEnd) {
                i12 = FlexboxLayoutManager.this.mOrientationHelper.getEndAfterPadding();
            } else {
                i12 = FlexboxLayoutManager.this.getWidth() - FlexboxLayoutManager.this.mOrientationHelper.getStartAfterPadding();
            }
    ...
    public static class LayoutState {
        ...
        public boolean hasMore(RecyclerView.State state, List<FlexLine> list) {
            int i11;
            int i12 = this.mPosition;
            if (i12 < 0 || i12 >= state.getItemCount() || (i11 = this.mFlexLinePosition) < 0 || i11 >= list.size()) {
                return false;
            }
            return true;
        }
    ...
    private boolean canViewBeRecycledFromEnd(View view, int i11) {
        if (isMainAxisDirectionHorizontal() || !this.mIsRtl) {
            if (this.mOrientationHelper.getDecoratedStart(view) >= this.mOrientationHelper.getEnd() - i11) {
                return true;
            }
            return false;
        } else if (this.mOrientationHelper.getDecoratedEnd(view) <= i11) {
            return true;
        } else {
            return false;
        }
    ...
    private boolean canViewBeRecycledFromStart(View view, int i11) {
        if (isMainAxisDirectionHorizontal() || !this.mIsRtl) {
            if (this.mOrientationHelper.getDecoratedEnd(view) <= i11) {
                return true;
            }
            return false;
        } else if (this.mOrientationHelper.getEnd() - this.mOrientationHelper.getDecoratedStart(view) <= i11) {
            return true;
        } else {
            return false;
        }
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        if (!(state.getItemCount() == 0 || findFirstReferenceChild == null || findLastReferenceChild == null)) {
            ...
            if (!(i11 == 0 || i11 == -1)) {
                return Math.round((((float) i11) * (((float) abs) / ((float) ((iArr[position2] - i11) + 1)))) + ((float) (this.mOrientationHelper.getStartAfterPadding() - this.mOrientationHelper.getDecoratedStart(findFirstReferenceChild))));
            }
        }
        return 0;
    }
    ...
    private int fixLayoutEndGap(int i11, RecyclerView.Recycler recycler, RecyclerView.State state, boolean z11) {
        ...
        if (z12) {
            ...
            i12 = handleScrollingMainOrientation(startAfterPadding, recycler, state);
        } else {
            int endAfterPadding2 = this.mOrientationHelper.getEndAfterPadding() - i11;
            if (endAfterPadding2 <= 0) {
                return 0;
            }
            i12 = -handleScrollingMainOrientation(-endAfterPadding2, recycler, state);
        }
        int i13 = i11 + i12;
    ...
    private int fixLayoutStartGap(int i11, RecyclerView.Recycler recycler, RecyclerView.State state, boolean z11) {
        ...
        if (isMainAxisDirectionHorizontal() || !this.mIsRtl) {
            ...
            i12 = -handleScrollingMainOrientation(startAfterPadding2, recycler, state);
        } else {
            int endAfterPadding = this.mOrientationHelper.getEndAfterPadding() - i11;
            if (endAfterPadding <= 0) {
                return 0;
            }
            i12 = handleScrollingMainOrientation(-endAfterPadding, recycler, state);
        }
        int i13 = i11 + i12;
    ...
    private int handleScrollingSubOrientation(int i11) {
        ...
        if (z11) {
            int abs = Math.abs(i11);
            if (i11 < 0) {
                access$2400 = Math.min((i13 + this.mAnchorInfo.mPerpendicularCoordinate) - i12, abs);
            ...
            return Math.min((i13 - this.mAnchorInfo.mPerpendicularCoordinate) - i12, i11);
        } else {
    ...
    private void resolveInfiniteAmount() {
        ...
        boolean unused = layoutState.mInfinite = z11;
    }
    ...
    private boolean shouldMeasureChild(View view, int i11, int i12, RecyclerView.LayoutParams layoutParams) {
        if (view.isLayoutRequested() || !isMeasurementCacheEnabled() || !isMeasurementUpToDate(view.getWidth(), i11, layoutParams.width) || !isMeasurementUpToDate(view.getHeight(), i12, layoutParams.height)) {
            return true;
        }
        return false;
    }
    ...
    private void updateFlexLines(int i11) {
        ...
        if (i17 != -1 || (this.mPendingScrollPosition == -1 && !z11)) {
            if (i17 != -1) {
                i13 = Math.min(i17, this.mAnchorInfo.mPosition);
            } else {
            ...
            if (isMainAxisDirectionHorizontal()) {
                if (this.mFlexLines.size() > 0) {
                    ...
                    this.mFlexboxHelper.calculateFlexLines(this.mFlexLinesResult, makeMeasureSpec, makeMeasureSpec2, i16, i18, this.mAnchorInfo.mPosition, this.mFlexLines);
                } else {
                ...
                this.mFlexboxHelper.clearFlexLines(this.mFlexLines, i18);
                this.mFlexboxHelper.calculateFlexLines(this.mFlexLinesResult, makeMeasureSpec2, makeMeasureSpec, i16, i18, this.mAnchorInfo.mPosition, this.mFlexLines);
            } else {
                this.mFlexboxHelper.ensureIndexToFlexLine(i11);
            ...
            this.mFlexLinesResult.reset();
            if (isMainAxisDirectionHorizontal()) {
                this.mFlexboxHelper.calculateHorizontalFlexLinesToIndex(this.mFlexLinesResult, makeMeasureSpec, makeMeasureSpec2, i16, this.mAnchorInfo.mPosition, this.mFlexLines);
            } else {
                this.mFlexboxHelper.calculateVerticalFlexLinesToIndex(this.mFlexLinesResult, makeMeasureSpec, makeMeasureSpec2, i16, this.mAnchorInfo.mPosition, this.mFlexLines);
            }
            this.mFlexLines = this.mFlexLinesResult.mFlexLines;
    ...
    private void updateLayoutState(int i11, int i12) {
        ...
        if (i11 == 1) {
            ...
            if (childAt2 != null) {
                ...
                int i14 = this.mFlexboxHelper.mIndexToFlexLine[position2];
                if (i14 == -1) {
                    i14 = 0;
                }
                if (i14 > 0) {
                    int unused14 = this.mLayoutState.mPosition = position2 - this.mFlexLines.get(i14 - 1).getItemCount();
                } else {
                ...
                int unused16 = layoutState4.mFlexLinePosition = i13;
                if (z11) {
                    ...
                    int unused19 = layoutState5.mScrollingOffset = Math.max(layoutState5.mScrollingOffset, 0);
                } else {
        ...
        int unused22 = layoutState6.mAvailable = i12 - layoutState6.mScrollingOffset;
    }
    ...
    public View getFlexItemAt(int i11) {
        ...
        return this.mRecycler.getViewForPosition(i11);
    }
