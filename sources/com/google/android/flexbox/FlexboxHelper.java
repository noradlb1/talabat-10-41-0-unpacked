...
class FlexboxHelper {
    ...
    private void evaluateMinimumSizeForCompoundButton(CompoundButton compoundButton) {
        ...
        if (buttonDrawable == null) {
            ...
            i11 = buttonDrawable.getMinimumWidth();
        }
        if (buttonDrawable != null) {
            i12 = buttonDrawable.getMinimumHeight();
        }
        if (minWidth == -1) {
            minWidth = i11;
        }
    ...
    private void expandFlexItems(int i11, int i12, FlexLine flexLine, int i13, int i14, boolean z11) {
        ...
        if (f11 > 0.0f && i19 >= (i15 = flexLine2.mMainSize)) {
            ...
            int i31 = i12;
            int i32 = i15;
            if (z12 && i32 != flexLine2.mMainSize) {
    ...
    private void shrinkFlexItems(int i11, int i12, FlexLine flexLine, int i13, int i14, boolean z11) {
        ...
        if (f11 > 0.0f && i19 <= i21) {
            ...
            int i33 = i12;
            int i34 = i21;
            if (z12 && i34 != flexLine2.mMainSize) {
    ...
    public void calculateFlexLines(FlexLinesResult flexLinesResult, int i11, int i12, int i13, int i14, int i15, @Nullable List<FlexLine> list) {
        ArrayList arrayList;
        boolean z11;
        int i16;
        int i17;
        ...
        FlexLine flexLine = new FlexLine();
        int i34 = i14;
        flexLine.mFirstIndex = i34;
        int i35 = paddingEndMain + paddingStartMain;
        flexLine.mMainSize = i35;
            ...
            if (reorderedFlexItemAt != null) {
                if (reorderedFlexItemAt.getVisibility() != 8) {
                    ...
                    if (isMainAxisDirectionHorizontal) {
                        int childWidthMeasureSpec = this.mFlexContainer.getChildWidthMeasureSpec(i31, i35 + getFlexItemMarginStartMain(flexItem, true) + getFlexItemMarginEndMain(flexItem, true), flexItemSizeMain);
                        i19 = size;
                        i18 = mode;
                        int childHeightMeasureSpec = this.mFlexContainer.getChildHeightMeasureSpec(i32, paddingStartCross + paddingEndCross + getFlexItemMarginStartCross(flexItem, true) + getFlexItemMarginEndCross(flexItem, true) + i37, getFlexItemSizeCross(flexItem, true));
                        ...
                        i19 = size;
                        i18 = mode;
                        int childWidthMeasureSpec2 = this.mFlexContainer.getChildWidthMeasureSpec(i32, paddingStartCross + paddingEndCross + getFlexItemMarginStartCross(flexItem, false) + getFlexItemMarginEndCross(flexItem, false) + i37, getFlexItemSizeCross(flexItem, false));
                        int childHeightMeasureSpec2 = this.mFlexContainer.getChildHeightMeasureSpec(i31, getFlexItemMarginStartMain(flexItem, false) + i35 + getFlexItemMarginEndMain(flexItem, false), flexItemSizeMain);
                    ...
                    i38 = View.combineMeasuredStates(i38, reorderedFlexItemAt.getMeasuredState());
                    int i42 = flexLine.mMainSize;
                    ...
                    int i46 = i42;
                    int i47 = flexItemMarginEndMain;
                    int i48 = i16;
                    View view3 = view2;
                    list2 = arrayList;
                    int i49 = i48;
                    int i50 = i25;
                    if (isWrapRequired(reorderedFlexItemAt, i18, i19, i46, i47, flexItem, i48, i39, arrayList.size())) {
                        if (flexLine2.getItemCountNotGone() > 0) {
                            ...
                            addFlexLine(list2, flexLine3, i29, i43);
                            i37 = flexLine3.mCrossSize + i43;
                        } else {
                            i37 = i43;
                        }
                        if (!isMainAxisDirectionHorizontal) {
                            ...
                            if (flexItem.getWidth() == -1) {
                                FlexContainer flexContainer = this.mFlexContainer;
                                view.measure(flexContainer.getChildWidthMeasureSpec(i23, flexContainer.getPaddingLeft() + this.mFlexContainer.getPaddingRight() + flexItem.getMarginLeft() + flexItem.getMarginRight() + i37, flexItem.getWidth()), i51);
                            ...
                            i16 = i49;
                            view = view3;
                            view.measure(i50, flexContainer2.getChildHeightMeasureSpec(i23, flexContainer2.getPaddingTop() + this.mFlexContainer.getPaddingBottom() + flexItem.getMarginTop() + flexItem.getMarginBottom() + i37, flexItem.getHeight()));
                            checkSizeConstraints(view, i16);
                        } else {
                            i23 = i12;
                            view = view3;
                    ...
                    boolean z16 = flexLine.mAnyItemsHaveFlexGrow;
                    if (flexItem.getFlexGrow() != 0.0f) {
                        z13 = z12;
                    } else {
                        z13 = false;
                    }
                    flexLine.mAnyItemsHaveFlexGrow = z16 | z13;
                    boolean z17 = flexLine.mAnyItemsHaveFlexShrink;
                    if (flexItem.getFlexShrink() != 0.0f) {
                        z14 = z12;
                    } else {
                        z14 = false;
                    }
                    flexLine.mAnyItemsHaveFlexShrink = z17 | z14;
                    ...
                    if (isLastFlexItem(i16, i24, flexLine)) {
                        addFlexLine(list2, flexLine, i16, i37);
                        i37 += flexLine.mCrossSize;
                    }
                    i21 = i15;
                    if (i21 == -1 || list2.size() <= 0 || list2.get(list2.size() - (z12 ? 1 : 0)).mLastIndex < i21 || i16 < i21 || z15) {
                        i28 = i13;
                    } else {
                        i37 = -flexLine.getCrossSize();
                        i28 = i13;
                        z15 = z12;
                    }
                    if (i37 > i28 && z15) {
                    ...
                    if (isLastFlexItem(i16, flexItemCount, flexLine)) {
                        addFlexLine(arrayList, flexLine, i16, i37);
                    }
                }
            } else if (isLastFlexItem(i16, flexItemCount, flexLine)) {
                addFlexLine(arrayList, flexLine, i16, i37);
            }
            int i52 = i13;
            i19 = size;
    ...
    public void calculateHorizontalFlexLines(FlexLinesResult flexLinesResult, int i11, int i12, int i13, int i14, @Nullable List<FlexLine> list) {
        calculateFlexLines(flexLinesResult, i11, i12, i13, i14, -1, list);
    }

    public void calculateVerticalFlexLines(FlexLinesResult flexLinesResult, int i11, int i12, int i13, int i14, @Nullable List<FlexLine> list) {
    ...
    public void determineMainSize(int i11, int i12, int i13) {
        ...
        if (i13 < this.mFlexContainer.getFlexItemCount()) {
            ...
            for (int i18 = iArr != null ? iArr[i13] : 0; i18 < size2; i18++) {
                FlexLine flexLine = flexLinesInternal.get(i18);
                int i19 = flexLine.mMainSize;
                if (i19 < i15 && flexLine.mAnyItemsHaveFlexGrow) {
                    expandFlexItems(i11, i12, flexLine, i15, i17, false);
                } else if (i19 > i15 && flexLine.mAnyItemsHaveFlexShrink) {
