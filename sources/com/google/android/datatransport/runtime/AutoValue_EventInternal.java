...
final class AutoValue_EventInternal extends EventInternal {
    ...
    public int hashCode() {
        ...
        return ((((((((hashCode ^ i11) * 1000003) ^ this.encodedPayload.hashCode()) * 1000003) ^ ((int) (j11 ^ (j11 >>> 32)))) * 1000003) ^ ((int) (j12 ^ (j12 >>> 32)))) * 1000003) ^ this.autoMetadata.hashCode();
    }
    ...
    private AutoValue_EventInternal(String str, @Nullable Integer num, EncodedPayload encodedPayload2, long j11, long j12, Map<String, String> map) {
        this.transportName = str;
        this.code = num;
        this.encodedPayload = encodedPayload2;
