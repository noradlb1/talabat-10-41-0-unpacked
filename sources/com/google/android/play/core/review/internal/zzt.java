...
public final class zzt {
    ...
    public zzt(Context context, zzi zzi2, String str, Intent intent, zze zze2, @Nullable zzo zzo2, byte[] bArr) {
        this.zzb = context;
        this.zzc = zzi2;
    ...
    public final void zzp(zzj zzj2, @Nullable TaskCompletionSource taskCompletionSource) {
        synchronized (this.zzg) {
