...
public final class Help extends GeneratedMessageLite<Help, Builder> implements HelpOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Help, Builder> implements HelpOrBuilder {
        ...
        public Link getLinks(int i11) {
            return ((Help) this.instance).getLinks(i11);
        }
        ...
        public Builder removeLinks(int i11) {
            copyOnWrite();
            ((Help) this.instance).removeLinks(i11);
            return this;
        }

        public Builder setLinks(int i11, Link link) {
            copyOnWrite();
            ((Help) this.instance).setLinks(i11, link);
            return this;
        }
        ...
        public Builder addLinks(int i11, Link link) {
            copyOnWrite();
            ((Help) this.instance).addLinks(i11, link);
            return this;
        }

        public Builder setLinks(int i11, Link.Builder builder) {
            copyOnWrite();
            ((Help) this.instance).setLinks(i11, (Link) builder.build());
            return this;
        }
        ...
        public Builder addLinks(int i11, Link.Builder builder) {
            copyOnWrite();
            ((Help) this.instance).addLinks(i11, (Link) builder.build());
            return this;
        }
    }
