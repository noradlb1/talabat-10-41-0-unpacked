...
public final class AttributeContext extends GeneratedMessageLite<AttributeContext, Builder> implements AttributeContextOrBuilder {
    ...
    public static final class Auth extends GeneratedMessageLite<Auth, Builder> implements AuthOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Auth, Builder> implements AuthOrBuilder {
            ...
            public String getAccessLevels(int i11) {
                return ((Auth) this.instance).getAccessLevels(i11);
            }

            public ByteString getAccessLevelsBytes(int i11) {
                return ((Auth) this.instance).getAccessLevelsBytes(i11);
            }
            ...
            public String getAudiences(int i11) {
                return ((Auth) this.instance).getAudiences(i11);
            }

            public ByteString getAudiencesBytes(int i11) {
                return ((Auth) this.instance).getAudiencesBytes(i11);
            }
            ...
            public Builder setAccessLevels(int i11, String str) {
                copyOnWrite();
                ((Auth) this.instance).setAccessLevels(i11, str);
                return this;
            }

            public Builder setAudiences(int i11, String str) {
                copyOnWrite();
                ((Auth) this.instance).setAudiences(i11, str);
                return this;
            }
        ...
        /* access modifiers changed from: private */
        public void setAccessLevels(int i11, String str) {
            str.getClass();
            ensureAccessLevelsIsMutable();
        ...
        /* access modifiers changed from: private */
        public void setAudiences(int i11, String str) {
            str.getClass();
            ensureAudiencesIsMutable();
    ...
    public static final class Peer extends GeneratedMessageLite<Peer, Builder> implements PeerOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Peer, Builder> implements PeerOrBuilder {
            ...
            public Builder setPort(long j11) {
                copyOnWrite();
                ((Peer) this.instance).setPort(j11);
                return this;
            }
    ...
    public static final class Request extends GeneratedMessageLite<Request, Builder> implements RequestOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Request, Builder> implements RequestOrBuilder {
            ...
            public Builder setSize(long j11) {
                copyOnWrite();
                ((Request) this.instance).setSize(j11);
                return this;
            }
    ...
    public static final class Response extends GeneratedMessageLite<Response, Builder> implements ResponseOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Response, Builder> implements ResponseOrBuilder {
            ...
            public Builder setCode(long j11) {
                copyOnWrite();
                ((Response) this.instance).setCode(j11);
                return this;
            }

            public Builder setSize(long j11) {
                copyOnWrite();
                ((Response) this.instance).setSize(j11);
                return this;
            }
