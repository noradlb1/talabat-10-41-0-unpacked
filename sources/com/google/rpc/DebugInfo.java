...
public final class DebugInfo extends GeneratedMessageLite<DebugInfo, Builder> implements DebugInfoOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<DebugInfo, Builder> implements DebugInfoOrBuilder {
        ...
        public String getStackEntries(int i11) {
            return ((DebugInfo) this.instance).getStackEntries(i11);
        }

        public ByteString getStackEntriesBytes(int i11) {
            return ((DebugInfo) this.instance).getStackEntriesBytes(i11);
        }
        ...
        public Builder setStackEntries(int i11, String str) {
            copyOnWrite();
            ((DebugInfo) this.instance).setStackEntries(i11, str);
            return this;
        }
