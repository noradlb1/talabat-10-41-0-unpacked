            ...
            try {
                for (BoundField next : this.boundFields.values()) {
                    if (next.writeField(t11)) {
                        jsonWriter.name(next.f47455name);
        ...
        while (cls2 != Object.class) {
            ...
            while (i11 < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    if (boundField4 != null) {
                        throw new IllegalArgumentException(type + " declares multiple JSON fields named " + boundField4.f47455name);
                    }
                }
                i11++;
                z12 = false;
