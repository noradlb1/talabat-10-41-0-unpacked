...
public class JsonReader implements Closeable {
    ...
    private void consumeNonExecutePrefix() throws IOException {
        ...
        if (i11 + 5 <= this.limit || fillBuffer(5)) {
            ...
            if (cArr[i12] == ')' && cArr[i12 + 1] == ']' && cArr[i12 + 2] == '}' && cArr[i12 + 3] == '\'' && cArr[i12 + 4] == 10) {
                this.pos = i12 + 5;
            }
        }
    }
