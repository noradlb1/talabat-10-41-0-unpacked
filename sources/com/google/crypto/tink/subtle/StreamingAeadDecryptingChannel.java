...
class StreamingAeadDecryptingChannel implements ReadableByteChannel {
    ...
    private boolean tryLoadSegment() throws IOException {
        ...
        try {
            ...
            if (!this.endOfCiphertext) {
                ...
                this.ciphertextSegment.put(b11);
            }
            return true;
        } catch (GeneralSecurityException e11) {
            setUndefinedState();
            throw new IOException(e11.getMessage() + StringUtils.LF + toString() + "\nsegmentNr:" + this.segmentNr + " endOfCiphertext:" + this.endOfCiphertext, e11);
        }
    }
    ...
    public synchronized int read(java.nio.ByteBuffer r7) throws java.io.IOException {
        /*
            r6 = this;
            monitor-enter(r6)
            boolean r0 = r6.definedState     // Catch:{ all -> 0x0090 }
            if (r0 == 0) goto L_0x0088
            boolean r0 = r6.headerRead     // Catch:{ all -> 0x0090 }
            r1 = 1
            if (r0 != 0) goto L_0x0020
            boolean r0 = r6.tryReadHeader()     // Catch:{ all -> 0x0090 }
            if (r0 != 0) goto L_0x0013
            monitor-exit(r6)
            r7 = 0
            return r7
        L_0x0013:
            java.nio.ByteBuffer r0 = r6.ciphertextSegment     // Catch:{ all -> 0x0090 }
            r0.clear()     // Catch:{ all -> 0x0090 }
            java.nio.ByteBuffer r0 = r6.ciphertextSegment     // Catch:{ all -> 0x0090 }
            int r2 = r6.firstCiphertextSegmentSize     // Catch:{ all -> 0x0090 }
            int r2 = r2 + r1
            r0.limit(r2)     // Catch:{ all -> 0x0090 }
        L_0x0020:
            boolean r0 = r6.endOfPlaintext     // Catch:{ all -> 0x0090 }
            r2 = -1
            if (r0 == 0) goto L_0x0027
            monitor-exit(r6)
            return r2
        L_0x0027:
            int r0 = r7.position()     // Catch:{ all -> 0x0090 }
        L_0x002b:
            int r3 = r7.remaining()     // Catch:{ all -> 0x0090 }
            if (r3 <= 0) goto L_0x0079
            java.nio.ByteBuffer r3 = r6.plaintextSegment     // Catch:{ all -> 0x0090 }
            int r3 = r3.remaining()     // Catch:{ all -> 0x0090 }
            if (r3 != 0) goto L_0x0047
            boolean r3 = r6.endOfCiphertext     // Catch:{ all -> 0x0090 }
            if (r3 == 0) goto L_0x0040
            r6.endOfPlaintext = r1     // Catch:{ all -> 0x0090 }
            goto L_0x0079
        L_0x0040:
            boolean r3 = r6.tryLoadSegment()     // Catch:{ all -> 0x0090 }
            if (r3 != 0) goto L_0x0047
            goto L_0x0079
        L_0x0047:
            java.nio.ByteBuffer r3 = r6.plaintextSegment     // Catch:{ all -> 0x0090 }
            int r3 = r3.remaining()     // Catch:{ all -> 0x0090 }
            int r4 = r7.remaining()     // Catch:{ all -> 0x0090 }
            if (r3 > r4) goto L_0x0059
            java.nio.ByteBuffer r3 = r6.plaintextSegment     // Catch:{ all -> 0x0090 }
            r7.put(r3)     // Catch:{ all -> 0x0090 }
            goto L_0x002b
        L_0x0059:
            int r3 = r7.remaining()     // Catch:{ all -> 0x0090 }
            java.nio.ByteBuffer r4 = r6.plaintextSegment     // Catch:{ all -> 0x0090 }
            java.nio.ByteBuffer r4 = r4.duplicate()     // Catch:{ all -> 0x0090 }
            int r5 = r4.position()     // Catch:{ all -> 0x0090 }
            int r5 = r5 + r3
            r4.limit(r5)     // Catch:{ all -> 0x0090 }
            r7.put(r4)     // Catch:{ all -> 0x0090 }
            java.nio.ByteBuffer r4 = r6.plaintextSegment     // Catch:{ all -> 0x0090 }
            int r5 = r4.position()     // Catch:{ all -> 0x0090 }
            int r5 = r5 + r3
            r4.position(r5)     // Catch:{ all -> 0x0090 }
            goto L_0x002b
        L_0x0079:
            int r7 = r7.position()     // Catch:{ all -> 0x0090 }
            int r7 = r7 - r0
        ...
        L_0x0086:
            ...
            return r7
        L_0x0088:
            java.io.IOException r7 = new java.io.IOException     // Catch:{ all -> 0x0090 }
