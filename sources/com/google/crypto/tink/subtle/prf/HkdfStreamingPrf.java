...
public class HkdfStreamingPrf implements StreamingPrf {
    ...
    public static String getJavaxHmacName(Enums.HashType hashType2) throws GeneralSecurityException {
        int i11 = AnonymousClass1.$SwitchMap$com$google$crypto$tink$subtle$Enums$HashType[hashType2.ordinal()];
        if (i11 == 1) {
            return "HmacSha1";
        }
        if (i11 == 2) {
        ...
        public int read(byte[] bArr, int i11, int i12) throws IOException {
            try {
                ...
                while (i13 < i12) {
                    ...
                    int min = Math.min(i12 - i13, this.buffer.remaining());
                    this.buffer.get(bArr, i11, min);
                    i11 += min;
                    i13 += min;
                }
                return i13;
