...
public final class EciesHkdfSenderKem {
    ...
    public KemKey generateKey(String str, byte[] bArr, byte[] bArr2, int i11, EllipticCurves.PointFormatType pointFormatType) throws GeneralSecurityException {
        ...
        return new KemKey(pointEncode, Hkdf.computeEciesHkdfSymmetricKey(pointEncode, computeSharedSecret, str, bArr, bArr2, i11));
    }
}
