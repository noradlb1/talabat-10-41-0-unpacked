...
public final class AesCtrHmacStreaming extends NonceBasedStreamingAead {
    ...
    public class AesCtrHmacStreamDecrypter implements StreamSegmentDecrypter {
        ...
        public synchronized void decryptSegment(ByteBuffer byteBuffer, int i11, boolean z11, ByteBuffer byteBuffer2) throws GeneralSecurityException {
            ...
            byte[] access$700 = AesCtrHmacStreaming.this.nonceForSegment(this.noncePrefix, (long) i11, z11);
    ...
    public AesCtrHmacStreaming(byte[] bArr, String str, int i11, String str2, int i12, int i13, int i14) throws GeneralSecurityException {
        if (FIPS.isCompatible()) {
            validateParameters(bArr.length, i11, str2, i12, i13, i14);
            this.ikm = Arrays.copyOf(bArr, bArr.length);
            this.hkdfAlgo = str;
            this.keySizeInBytes = i11;
            this.tagAlgo = str2;
            this.tagSizeInBytes = i12;
            this.ciphertextSegmentSize = i13;
            this.firstSegmentOffset = i14;
            this.plaintextSegmentSize = i13 - i12;
            return;
        }
    ...
    /* access modifiers changed from: private */
    public byte[] nonceForSegment(byte[] bArr, long j11, boolean z11) throws GeneralSecurityException {
    ...
    private static void validateParameters(int i11, int i12, String str, int i13, int i14, int i15) throws InvalidAlgorithmParameterException {
        if (i11 < 16 || i11 < i12) {
        ...
        } else if ((str.equals("HmacSha1") && i13 > 20) || ((str.equals("HmacSha256") && i13 > 32) || (str.equals("HmacSha512") && i13 > 64))) {
            throw new InvalidAlgorithmParameterException("tag size too big");
        } else if (((((i14 - i15) - i13) - i12) - 7) - 1 <= 0) {
    ...
    public long expectedCiphertextSize(long j11) {
        ...
        if (j13 > 0) {
            return j12 + j13 + ((long) this.tagSizeInBytes);
        }
        return j12;
    }
    ...
    public class AesCtrHmacStreamEncrypter implements StreamSegmentEncrypter {
        ...
        public synchronized void encryptSegment(ByteBuffer byteBuffer, boolean z11, ByteBuffer byteBuffer2) throws GeneralSecurityException {
            ...
            byte[] access$700 = AesCtrHmacStreaming.this.nonceForSegment(this.noncePrefix, this.encryptedSegments, z11);
            this.cipher.init(1, this.keySpec, new IvParameterSpec(access$700));
