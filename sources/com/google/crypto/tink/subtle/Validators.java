...
public final class Validators {
    ...
    public static void validateAesKeySize(int i11) throws InvalidAlgorithmParameterException {
        if (i11 != 16 && i11 != 32) {
    ...
    public static void validateRsaModulusSize(int i11) throws GeneralSecurityException {
        if (i11 < 2048) {
            throw new GeneralSecurityException(String.format("Modulus size is %d; only modulus size >= 2048-bit is supported", new Object[]{Integer.valueOf(i11)}));
        } else if (TinkFipsUtil.useOnlyFips() && i11 != 2048 && i11 != 3072) {
            throw new GeneralSecurityException(String.format("Modulus size is %d; only modulus size of 2048- or 3072-bit is supported in FIPS mode.", new Object[]{Integer.valueOf(i11)}));
        }
    }
    ...
    public static void validateVersion(int i11, int i12) throws GeneralSecurityException {
        if (i11 < 0 || i11 > i12) {
            throw new GeneralSecurityException(String.format("key has version %d; only keys with version in range [0..%d] are supported", new Object[]{Integer.valueOf(i11), Integer.valueOf(i12)}));
        }
    }
}
