...
public final class JwkSetConverter {
    ...
    public static final class JwkSetWriter implements KeysetWriter {
        ...
        public /* synthetic */ JwkSetWriter(OutputStream outputStream2, AnonymousClass1 r22) {
            this(outputStream2);
        }
        ...
        private static JsonObject convertJwtEcdsaKey(Keyset.Key key) throws IOException, GeneralSecurityException {
            ...
            int i11 = AnonymousClass1.$SwitchMap$com$google$crypto$tink$proto$JwtEcdsaAlgorithm[parseFrom.getAlgorithm().ordinal()];
            if (i11 == 1) {
                str2 = "ES256";
                str = "P-256";
            } else if (i11 == 2) {
            ...
            jsonObject.addProperty(Param.X, Base64.urlSafeEncode(parseFrom.getX().toByteArray()));
            jsonObject.addProperty(Param.Y, Base64.urlSafeEncode(parseFrom.getY().toByteArray()));
        ...
        private static JsonObject convertJwtRsaSsaPkcs1(Keyset.Key key) throws IOException, GeneralSecurityException {
            ...
            int i11 = AnonymousClass1.$SwitchMap$com$google$crypto$tink$proto$JwtRsaSsaPkcs1Algorithm[parseFrom.getAlgorithm().ordinal()];
            if (i11 == 1) {
                str = "RS256";
            } else if (i11 == 2) {
                str = "RS384";
        ...
        private static JsonObject convertJwtRsaSsaPss(Keyset.Key key) throws IOException, GeneralSecurityException {
            ...
            int i11 = AnonymousClass1.$SwitchMap$com$google$crypto$tink$proto$JwtRsaSsaPssAlgorithm[parseFrom.getAlgorithm().ordinal()];
            if (i11 == 1) {
                str = "PS256";
            } else if (i11 == 2) {
                str = "PS384";
    ...
    private static KeyData convertToEcdsaKey(JsonObject jsonObject) throws IOException {
        ...
        if (!jsonObject.has("d")) {
            ...
            JwtEcdsaPublicKey.Builder y11 = JwtEcdsaPublicKey.newBuilder().setVersion(0).setAlgorithm(jwtEcdsaAlgorithm).setX(ByteString.copyFrom(Base64.urlSafeDecode(getStringItem(jsonObject, Param.X)))).setY(ByteString.copyFrom(Base64.urlSafeDecode(getStringItem(jsonObject, Param.Y))));
            if (jsonObject.has("kid")) {
                y11.setCustomKid((JwtEcdsaPublicKey.CustomKid) JwtEcdsaPublicKey.CustomKid.newBuilder().setValue(getStringItem(jsonObject, "kid")).build());
            }
            return (KeyData) KeyData.newBuilder().setTypeUrl(JWT_ECDSA_PUBLIC_KEY_URL).setValue(((JwtEcdsaPublicKey) y11.build()).toByteString()).setKeyMaterialType(KeyData.KeyMaterialType.ASYMMETRIC_PUBLIC).build();
        }
    ...
    private static KeyData convertToRsaSsaPkcs1Key(JsonObject jsonObject) throws IOException {
        ...
        validateUseIsSig(jsonObject);
        validateKeyOpsIsVerify(jsonObject);
        JwtRsaSsaPkcs1PublicKey.Builder n11 = JwtRsaSsaPkcs1PublicKey.newBuilder().setVersion(0).setAlgorithm(jwtRsaSsaPkcs1Algorithm).setE(ByteString.copyFrom(Base64.urlSafeDecode(getStringItem(jsonObject, "e")))).setN(ByteString.copyFrom(Base64.urlSafeDecode(getStringItem(jsonObject, "n"))));
        if (jsonObject.has("kid")) {
            n11.setCustomKid((JwtRsaSsaPkcs1PublicKey.CustomKid) JwtRsaSsaPkcs1PublicKey.CustomKid.newBuilder().setValue(getStringItem(jsonObject, "kid")).build());
        }
        return (KeyData) KeyData.newBuilder().setTypeUrl(JWT_RSA_SSA_PKCS1_PUBLIC_KEY_URL).setValue(((JwtRsaSsaPkcs1PublicKey) n11.build()).toByteString()).setKeyMaterialType(KeyData.KeyMaterialType.ASYMMETRIC_PUBLIC).build();
    }
    ...
    private static KeyData convertToRsaSsaPssKey(JsonObject jsonObject) throws IOException {
        ...
        validateUseIsSig(jsonObject);
        validateKeyOpsIsVerify(jsonObject);
        JwtRsaSsaPssPublicKey.Builder n11 = JwtRsaSsaPssPublicKey.newBuilder().setVersion(0).setAlgorithm(jwtRsaSsaPssAlgorithm).setE(ByteString.copyFrom(Base64.urlSafeDecode(getStringItem(jsonObject, "e")))).setN(ByteString.copyFrom(Base64.urlSafeDecode(getStringItem(jsonObject, "n"))));
        if (jsonObject.has("kid")) {
            n11.setCustomKid((JwtRsaSsaPssPublicKey.CustomKid) JwtRsaSsaPssPublicKey.CustomKid.newBuilder().setValue(getStringItem(jsonObject, "kid")).build());
        }
        return (KeyData) KeyData.newBuilder().setTypeUrl(JWT_RSA_SSA_PSS_PUBLIC_KEY_URL).setValue(((JwtRsaSsaPssPublicKey) n11.build()).toByteString()).setKeyMaterialType(KeyData.KeyMaterialType.ASYMMETRIC_PUBLIC).build();
    }
    ...
    public static String fromPublicKeysetHandle(KeysetHandle keysetHandle) throws IOException, GeneralSecurityException {
        ...
        keysetHandle.writeNoSecret(new JwkSetWriter(byteArrayOutputStream, (AnonymousClass1) null));
