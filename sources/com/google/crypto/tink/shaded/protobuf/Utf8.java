    ...
    public static abstract class Processor {
        ...
        public final int partialIsValidUtf8Default(int r7, java.nio.ByteBuffer r8, int r9, int r10) {
            ...
            L_0x006a:
                ...
                int r7 = com.google.crypto.tink.shaded.protobuf.Utf8.incompleteStateFor((int) r0, (int) r1, (int) r7)
                return r7
            L_0x0079:
                r5 = r9
                r9 = r7
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        public String decodeUtf8(byte[] bArr, int i11, int i12) throws InvalidProtocolBufferException {
            ...
            if ((i11 | i12 | ((bArr.length - i11) - i12)) >= 0) {
                int unsafeEstimateConsecutiveAscii = unsafeEstimateConsecutiveAscii(bArr, (long) i11, i12) + i11;
                int i14 = i11 + i12;
                while (i13 < i14 && UnsafeUtil.getByte(bArr, (long) i13) >= 0) {
                    unsafeEstimateConsecutiveAscii = i13 + 1;
                }
                if (i13 == i14) {
                ...
                int i15 = 0;
                while (i11 < i13) {
                    DecodeUtil.handleOneByte(UnsafeUtil.getByte(bArr, (long) i11), cArr, i15);
                    i11++;
                    i15++;
                }
                int i16 = i15;
                while (i13 < i14) {
                    int i17 = i13 + 1;
                    byte b11 = UnsafeUtil.getByte(bArr, (long) i13);
                    if (DecodeUtil.isOneByte(b11)) {
                        int i18 = i16 + 1;
                        DecodeUtil.handleOneByte(b11, cArr, i16);
                        while (i17 < i14) {
                            byte b12 = UnsafeUtil.getByte(bArr, (long) i17);
                            if (!DecodeUtil.isOneByte(b12)) {
                                break;
                            }
                            i17++;
                            DecodeUtil.handleOneByte(b12, cArr, i18);
                            i18++;
                        }
                        i16 = i18;
                        i13 = i17;
                        ...
                        if (i17 < i14) {
                            i13 = i17 + 1;
                            DecodeUtil.handleTwoBytes(b11, UnsafeUtil.getByte(bArr, (long) i17), cArr, i16);
                            i16++;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
                        }
                        ...
                        if (i17 < i14 - 1) {
                            int i19 = i17 + 1;
                            DecodeUtil.handleThreeBytes(b11, UnsafeUtil.getByte(bArr, (long) i17), UnsafeUtil.getByte(bArr, (long) i19), cArr, i16);
                            i13 = i19 + 1;
                            i16++;
                        } else {
                            throw InvalidProtocolBufferException.invalidUtf8();
                        ...
                        int i22 = i21 + 1;
                        i13 = i22 + 1;
                        DecodeUtil.handleFourBytes(b11, UnsafeUtil.getByte(bArr, (long) i17), UnsafeUtil.getByte(bArr, (long) i21), UnsafeUtil.getByte(bArr, (long) i22), cArr, i16);
                        i16 = i16 + 1 + 1;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
        ...
        public void encodeUtf8Direct(java.lang.CharSequence r22, java.nio.ByteBuffer r23) {
            ...
            L_0x00bf:
                ...
                r7 = r7 | r9
                byte r7 = (byte) r7
                com.google.crypto.tink.shaded.protobuf.UnsafeUtil.putByte(r3, r7)
                long r3 = r5 + r13
                r2 = r2 & 63
                r2 = r2 | r9
                byte r2 = (byte) r2
                com.google.crypto.tink.shaded.protobuf.UnsafeUtil.putByte(r5, r2)
                r4 = r3
            L_0x0107:
                int r1 = r1 + 1
                r12 = r9
