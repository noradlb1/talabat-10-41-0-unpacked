        ...
        if (!generatedExtension.descriptor.isRepeated() || !generatedExtension.descriptor.isPacked()) {
            if (generatedExtension.getLiteType() != WireFormat.FieldType.ENUM) {
                ...
                if (generatedExtension.descriptor.getEnumType().findValueByNumber(readInt32) == null) {
                    return SchemaUtil.storeUnknownEnum(number, readInt32, ub2, unknownFieldSchema);
                }
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 14:
                    ...
                    ub2 = SchemaUtil.filterUnknownEnumList(number, (List<Integer>) arrayList, generatedExtension.descriptor.getEnumType(), ub2, unknownFieldSchema);
                    break;
                default:
