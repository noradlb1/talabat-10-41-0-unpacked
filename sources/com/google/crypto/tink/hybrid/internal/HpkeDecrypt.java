...
final class HpkeDecrypt implements HybridDecrypt {
    ...
    private HpkeDecrypt(HpkeKemPrivateKey hpkeKemPrivateKey, HpkeKem hpkeKem, HpkeKdf hpkeKdf, HpkeAead hpkeAead, int i11) {
    ...
    private static int encodingSizeInBytes(HpkeKem hpkeKem) {
        if (AnonymousClass1.$SwitchMap$com$google$crypto$tink$proto$HpkeKem[hpkeKem.ordinal()] == 1) {
            return 32;
        }
    ...
    public byte[] decrypt(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        int i11 = this.encapsulatedKeyLength;
        if (length >= i11) {
            if (bArr2 == null) {
                bArr2 = new byte[0];
            }
