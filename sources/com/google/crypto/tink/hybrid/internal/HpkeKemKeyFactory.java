...
final class HpkeKemKeyFactory {
    ...
    public static HpkeKemPrivateKey createPrivate(HpkePrivateKey hpkePrivateKey) throws GeneralSecurityException {
        int i11 = AnonymousClass1.$SwitchMap$com$google$crypto$tink$proto$HpkeKem[hpkePrivateKey.getPublicKey().getParams().getKem().ordinal()];
    ...
    private static EllipticCurves.CurveType nistHpkeKemToCurve(HpkeKem hpkeKem) throws GeneralSecurityException {
        int i11 = AnonymousClass1.$SwitchMap$com$google$crypto$tink$proto$HpkeKem[hpkeKem.ordinal()];
        if (i11 == 1) {
