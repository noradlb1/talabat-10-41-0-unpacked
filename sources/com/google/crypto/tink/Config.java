...
public final class Config {
    ...
    public static KeyTypeEntry getTinkKeyTypeEntry(String str, String str2, String str3, int i11, boolean z11) {
        KeyTypeEntry.Builder primitiveName = KeyTypeEntry.newBuilder().setPrimitiveName(str2);
        return (KeyTypeEntry) primitiveName.setTypeUrl("type.googleapis.com/google.crypto.tink." + str3).setKeyManagerVersion(i11).setNewKeyAllowed(z11).setCatalogueName(str).build();
    }
