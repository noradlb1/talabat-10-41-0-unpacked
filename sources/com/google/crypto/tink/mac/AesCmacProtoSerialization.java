...
final class AesCmacProtoSerialization {
    ...
    static {
        ...
        PARAMETERS_SERIALIZER = ParametersSerializer.create(new a(), AesCmacParameters.class, cls);
        PARAMETERS_PARSER = ParametersParser.create(new b(), bytesFromPrintableAscii, cls);
        Class<ProtoKeySerialization> cls2 = ProtoKeySerialization.class;
        KEY_SERIALIZER = KeySerializer.create(new c(), AesCmacKey.class, cls2);
        KEY_PARSER = KeyParser.create(new d(), bytesFromPrintableAscii, cls2);
    }
