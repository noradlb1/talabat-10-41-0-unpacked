...
public final class TinkConfig {
    ...
    @Deprecated
    public static final RegistryConfig TINK_1_1_0 = ((RegistryConfig) ((RegistryConfig.Builder) ((RegistryConfig.Builder) ((RegistryConfig.Builder) ((RegistryConfig.Builder) RegistryConfig.newBuilder().mergeFrom(HybridConfig.TINK_1_1_0)).mergeFrom(SignatureConfig.TINK_1_1_0)).mergeFrom(DeterministicAeadConfig.TINK_1_1_0)).mergeFrom(StreamingAeadConfig.TINK_1_1_0)).setConfigName("TINK_1_1_0").build());
