...
public final class AesSivKeyManager extends KeyTypeManager<AesSivKey> {
    ...
    private static KeyTemplate createKeyTemplate(int i11, KeyTemplate.OutputPrefixType outputPrefixType) {
        return KeyTemplate.create(new AesSivKeyManager().getKeyType(), ((AesSivKeyFormat) AesSivKeyFormat.newBuilder().setKeySize(i11).build()).toByteArray(), outputPrefixType);
    }
    ...
    public static void register(boolean z11) throws GeneralSecurityException {
        Registry.registerKeyManager(new AesSivKeyManager(), z11);
    }
