...
public final class HpkeParams extends GeneratedMessageLite<HpkeParams, Builder> implements HpkeParamsOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<HpkeParams, Builder> implements HpkeParamsOrBuilder {
        ...
        public Builder setAeadValue(int i11) {
            copyOnWrite();
            ((HpkeParams) this.instance).setAeadValue(i11);
            return this;
        }
        ...
        public Builder setKdfValue(int i11) {
            copyOnWrite();
            ((HpkeParams) this.instance).setKdfValue(i11);
            return this;
        }
        ...
        public Builder setKemValue(int i11) {
            copyOnWrite();
            ((HpkeParams) this.instance).setKemValue(i11);
            return this;
        }
    ...
    /* access modifiers changed from: private */
    public void setAeadValue(int i11) {
        this.aead_ = i11;
    }
    ...
    /* access modifiers changed from: private */
    public void setKdfValue(int i11) {
        this.kdf_ = i11;
    }
    ...
    /* access modifiers changed from: private */
    public void setKemValue(int i11) {
        this.kem_ = i11;
    }
