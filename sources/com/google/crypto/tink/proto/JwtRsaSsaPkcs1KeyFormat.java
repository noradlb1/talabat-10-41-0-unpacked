...
public final class JwtRsaSsaPkcs1KeyFormat extends GeneratedMessageLite<JwtRsaSsaPkcs1KeyFormat, Builder> implements JwtRsaSsaPkcs1KeyFormatOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<JwtRsaSsaPkcs1KeyFormat, Builder> implements JwtRsaSsaPkcs1KeyFormatOrBuilder {
        ...
        public Builder setAlgorithmValue(int i11) {
            copyOnWrite();
            ((JwtRsaSsaPkcs1KeyFormat) this.instance).setAlgorithmValue(i11);
            return this;
        }

        public Builder setModulusSizeInBits(int i11) {
            copyOnWrite();
            ((JwtRsaSsaPkcs1KeyFormat) this.instance).setModulusSizeInBits(i11);
            return this;
        }
        ...
        public Builder setVersion(int i11) {
            copyOnWrite();
            ((JwtRsaSsaPkcs1KeyFormat) this.instance).setVersion(i11);
            return this;
        }
    ...
    /* access modifiers changed from: private */
    public void setModulusSizeInBits(int i11) {
        this.modulusSizeInBits_ = i11;
    }
