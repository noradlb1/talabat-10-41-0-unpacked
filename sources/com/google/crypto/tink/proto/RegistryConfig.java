...
public final class RegistryConfig extends GeneratedMessageLite<RegistryConfig, Builder> implements RegistryConfigOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<RegistryConfig, Builder> implements RegistryConfigOrBuilder {
        ...
        public KeyTypeEntry getEntry(int i11) {
            return ((RegistryConfig) this.instance).getEntry(i11);
        }
        ...
        public Builder removeEntry(int i11) {
            copyOnWrite();
            ((RegistryConfig) this.instance).removeEntry(i11);
            return this;
        }
        ...
        public Builder setEntry(int i11, KeyTypeEntry keyTypeEntry) {
            copyOnWrite();
            ((RegistryConfig) this.instance).setEntry(i11, keyTypeEntry);
            return this;
        }
        ...
        public Builder addEntry(int i11, KeyTypeEntry keyTypeEntry) {
            copyOnWrite();
            ((RegistryConfig) this.instance).addEntry(i11, keyTypeEntry);
            return this;
        }

        public Builder setEntry(int i11, KeyTypeEntry.Builder builder) {
            copyOnWrite();
            ((RegistryConfig) this.instance).setEntry(i11, (KeyTypeEntry) builder.build());
            return this;
        }
        ...
        public Builder addEntry(int i11, KeyTypeEntry.Builder builder) {
            copyOnWrite();
            ((RegistryConfig) this.instance).addEntry(i11, (KeyTypeEntry) builder.build());
            return this;
        }
    }
    ...
    /* access modifiers changed from: private */
    public void setEntry(int i11, KeyTypeEntry keyTypeEntry) {
        keyTypeEntry.getClass();
        ensureEntryIsMutable();
        this.entry_.set(i11, keyTypeEntry);
    }
    ...
    public KeyTypeEntryOrBuilder getEntryOrBuilder(int i11) {
        return this.entry_.get(i11);
    }
    ...
    /* access modifiers changed from: private */
    public void addEntry(int i11, KeyTypeEntry keyTypeEntry) {
        keyTypeEntry.getClass();
        ensureEntryIsMutable();
        this.entry_.add(i11, keyTypeEntry);
    }
