...
public final class KeyData extends GeneratedMessageLite<KeyData, Builder> implements KeyDataOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<KeyData, Builder> implements KeyDataOrBuilder {
        ...
        public Builder setKeyMaterialTypeValue(int i11) {
            copyOnWrite();
            ((KeyData) this.instance).setKeyMaterialTypeValue(i11);
            return this;
        }
    ...
    public enum KeyMaterialType implements Internal.EnumLite {
        ...
        public static final class KeyMaterialTypeVerifier implements Internal.EnumVerifier {
            ...
            public boolean isInRange(int i11) {
                return KeyMaterialType.forNumber(i11) != null;
            }
        }
        ...
        static {
            internalValueMap = new Internal.EnumLiteMap<KeyMaterialType>() {
                public KeyMaterialType findValueByNumber(int i11) {
                    return KeyMaterialType.forNumber(i11);
                }
            };
        }

        private KeyMaterialType(int i11) {
            this.value = i11;
        }
    ...
    /* access modifiers changed from: private */
    public void setKeyMaterialTypeValue(int i11) {
        this.keyMaterialType_ = i11;
    }
