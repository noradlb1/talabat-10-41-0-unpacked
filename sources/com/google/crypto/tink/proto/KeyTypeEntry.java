...
public final class KeyTypeEntry extends GeneratedMessageLite<KeyTypeEntry, Builder> implements KeyTypeEntryOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<KeyTypeEntry, Builder> implements KeyTypeEntryOrBuilder {
        ...
        public Builder setKeyManagerVersion(int i11) {
            copyOnWrite();
            ((KeyTypeEntry) this.instance).setKeyManagerVersion(i11);
            return this;
        }

        public Builder setNewKeyAllowed(boolean z11) {
            copyOnWrite();
            ((KeyTypeEntry) this.instance).setNewKeyAllowed(z11);
            return this;
        }
    ...
    /* access modifiers changed from: private */
    public void setKeyManagerVersion(int i11) {
        this.keyManagerVersion_ = i11;
    }

    /* access modifiers changed from: private */
    public void setNewKeyAllowed(boolean z11) {
