...
public final class HmacParams extends GeneratedMessageLite<HmacParams, Builder> implements HmacParamsOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<HmacParams, Builder> implements HmacParamsOrBuilder {
        ...
        public Builder setHashValue(int i11) {
            copyOnWrite();
            ((HmacParams) this.instance).setHashValue(i11);
            return this;
        }

        public Builder setTagSize(int i11) {
            copyOnWrite();
            ((HmacParams) this.instance).setTagSize(i11);
            return this;
        }
    ...
    /* access modifiers changed from: private */
    public void setHashValue(int i11) {
        this.hash_ = i11;
    }

    /* access modifiers changed from: private */
    public void setTagSize(int i11) {
        this.tagSize_ = i11;
    }
