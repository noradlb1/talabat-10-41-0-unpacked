...
public final class RsaSsaPssParams extends GeneratedMessageLite<RsaSsaPssParams, Builder> implements RsaSsaPssParamsOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<RsaSsaPssParams, Builder> implements RsaSsaPssParamsOrBuilder {
        ...
        public Builder setMgf1HashValue(int i11) {
            copyOnWrite();
            ((RsaSsaPssParams) this.instance).setMgf1HashValue(i11);
            return this;
        }

        public Builder setSaltLength(int i11) {
            copyOnWrite();
            ((RsaSsaPssParams) this.instance).setSaltLength(i11);
            return this;
        }
        ...
        public Builder setSigHashValue(int i11) {
            copyOnWrite();
            ((RsaSsaPssParams) this.instance).setSigHashValue(i11);
            return this;
        }
    ...
    /* access modifiers changed from: private */
    public void setMgf1HashValue(int i11) {
        this.mgf1Hash_ = i11;
    }

    /* access modifiers changed from: private */
    public void setSaltLength(int i11) {
    ...
    /* access modifiers changed from: private */
    public void setSigHashValue(int i11) {
        this.sigHash_ = i11;
    }
