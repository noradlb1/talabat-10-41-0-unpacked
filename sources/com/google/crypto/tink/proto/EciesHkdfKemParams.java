...
public final class EciesHkdfKemParams extends GeneratedMessageLite<EciesHkdfKemParams, Builder> implements EciesHkdfKemParamsOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<EciesHkdfKemParams, Builder> implements EciesHkdfKemParamsOrBuilder {
        ...
        public Builder setCurveTypeValue(int i11) {
            copyOnWrite();
            ((EciesHkdfKemParams) this.instance).setCurveTypeValue(i11);
            return this;
        }
        ...
        public Builder setHkdfHashTypeValue(int i11) {
            copyOnWrite();
            ((EciesHkdfKemParams) this.instance).setHkdfHashTypeValue(i11);
            return this;
        }
    ...
    /* access modifiers changed from: private */
    public void setCurveTypeValue(int i11) {
        this.curveType_ = i11;
    }
