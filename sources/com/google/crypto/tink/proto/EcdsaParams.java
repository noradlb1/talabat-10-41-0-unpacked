...
public final class EcdsaParams extends GeneratedMessageLite<EcdsaParams, Builder> implements EcdsaParamsOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<EcdsaParams, Builder> implements EcdsaParamsOrBuilder {
        ...
        public Builder setCurveValue(int i11) {
            copyOnWrite();
            ((EcdsaParams) this.instance).setCurveValue(i11);
            return this;
        }
        ...
        public Builder setEncodingValue(int i11) {
            copyOnWrite();
            ((EcdsaParams) this.instance).setEncodingValue(i11);
            return this;
        }
        ...
        public Builder setHashTypeValue(int i11) {
            copyOnWrite();
            ((EcdsaParams) this.instance).setHashTypeValue(i11);
            return this;
        }
    ...
    /* access modifiers changed from: private */
    public void setCurveValue(int i11) {
        this.curve_ = i11;
    }
    ...
    /* access modifiers changed from: private */
    public void setEncodingValue(int i11) {
        this.encoding_ = i11;
    }
    ...
    /* access modifiers changed from: private */
    public void setHashTypeValue(int i11) {
        this.hashType_ = i11;
    }
