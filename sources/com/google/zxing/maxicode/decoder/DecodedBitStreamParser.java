...
final class DecodedBitStreamParser {
    ...
    public static DecoderResult decode(byte[] bArr, int i11) {
        String str;
        StringBuilder sb2 = new StringBuilder(Opcodes.D2F);
        if (i11 == 2 || i11 == 3) {
            if (i11 == 2) {
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.EM, Ascii.SUB, Ascii.ESC, Ascii.FS, Ascii.GS, Ascii.RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.CR, Ascii.SO, Ascii.SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, 11, 12, 1, 2});
    }
