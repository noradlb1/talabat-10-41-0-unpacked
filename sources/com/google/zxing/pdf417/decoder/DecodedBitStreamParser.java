...
final class DecodedBitStreamParser {
    ...
    private static int byteCompaction(int i11, int[] iArr, Charset charset, int i12, StringBuilder sb2) {
        ...
        if (i16 == 901) {
            ...
            i13 = i15;
        } else if (i16 != BYTE_COMPACTION_MODE_LATCH_6) {
            i13 = i12;
        } else {
            i13 = i12;
            boolean z12 = false;
    ...
    public static int decodeMacroBlock(int[] iArr, int i11, PDF417ResultMetadata pDF417ResultMetadata) throws FormatException {
        ...
        if (i11 + 2 <= iArr[0]) {
            ...
            if (i12 != -1) {
                int i16 = textCompaction - i12;
                if (pDF417ResultMetadata.isLastSegment()) {
                    i16--;
                }
                pDF417ResultMetadata.setOptionalData(Arrays.copyOfRange(iArr, i12, i16 + i12));
            }
    ...
    private static int textCompaction(int[] iArr, int i11, StringBuilder sb2) {
        ...
        while (i11 < iArr[0] && !z11) {
            ...
            if (i15 < 900) {
                ...
                iArr2[i13 + 1] = i15 % 30;
                i13 += 2;
            } else if (i15 != MODE_SHIFT_TO_BYTE_COMPACTION_MODE) {
                if (i15 != 928) {
                    switch (i15) {
                        case 900:
                            iArr2[i13] = 900;
                ...
                iArr2[i13] = MODE_SHIFT_TO_BYTE_COMPACTION_MODE;
                i11 = i14 + 1;
                iArr3[i13] = iArr[i14];
                i13++;
            }
        ...
        decodeTextCompaction(iArr2, iArr3, i13, sb2);
        return i11;
    }
}
