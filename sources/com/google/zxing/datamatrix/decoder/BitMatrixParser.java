...
final class BitMatrixParser {
    ...
    public byte[] readCodewords() throws FormatException {
        ...
        int i13 = 4;
        while (true) {
            if (i13 == height && i11 == 0 && !z11) {
                bArr[i12] = (byte) readCorner1(height, width);
                i13 -= 2;
                i11 += 2;
                i12++;
                z11 = true;
                ...
                int i14 = height - 2;
                if (i13 == i14 && i11 == 0 && (width & 3) != 0 && !z12) {
                    bArr[i12] = (byte) readCorner2(height, width);
                    i13 -= 2;
                    i11 += 2;
                    i12++;
                    z12 = true;
                } else if (i13 == height + 4 && i11 == 2 && (width & 7) == 0 && !z13) {
                    bArr[i12] = (byte) readCorner3(height, width);
                    i13 -= 2;
                    i11 += 2;
                    i12++;
                    z13 = true;
                } else if (i13 == i14 && i11 == 0 && (width & 7) == 4 && !z14) {
                    bArr[i12] = (byte) readCorner4(height, width);
                    i13 -= 2;
                    i11 += 2;
                    i12++;
                    z14 = true;
                    ...
                    do {
                        if (i13 < height && i11 >= 0 && !this.readMappingMatrix.get(i11, i13)) {
                            bArr[i12] = (byte) readUtah(i13, i11, height, width);
                            i12++;
                        }
                        i13 -= 2;
                        i11 += 2;
                    ...
                    do {
                        if (i15 >= 0 && i16 < width && !this.readMappingMatrix.get(i16, i15)) {
                            bArr[i12] = (byte) readUtah(i15, i16, height, width);
                            i12++;
                        }
                        i15 += 2;
                        i16 -= 2;
            ...
            if (i13 >= height && i11 >= width) {
                break;
            }
        }
        if (i12 == this.version.getTotalCodewords()) {
            return bArr;
        }
        throw FormatException.getFormatInstance();
    }
