...
public final class Detector {
    ...
    public static final class ResultPointsAndTransitions {
        ...
        private final ResultPoint f47464to;
    ...
    private ResultPointsAndTransitions transitionsBetween(ResultPoint resultPoint, ResultPoint resultPoint2) {
        ...
        int i16 = 0;
        int i17 = 1;
        if (Math.abs(y12 - y11) > Math.abs(x12 - x11)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        boolean z12 = bitMatrix.get(i12, i13);
        while (x11 != x12) {
            ...
            boolean z13 = bitMatrix2.get(i14, i15);
            if (z13 != z12) {
                i16++;
                z12 = z13;
            }
