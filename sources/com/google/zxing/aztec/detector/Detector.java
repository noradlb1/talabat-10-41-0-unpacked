...
public final class Detector {
    ...
    public static final class Point {
        ...
        private final int f47461x;

        /* renamed from: y  reason: collision with root package name */
        private final int f47462y;
        ...
        public String toString() {
            return "<" + this.f47461x + ' ' + this.f47462y + Typography.greater;
        }
    }
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) throws NotFoundException {
        ...
        while (this.nbCenterLayers < 9) {
            Point firstDifferent = getFirstDifferent(point, z12, 1, -1);
            Point firstDifferent2 = getFirstDifferent(point2, z12, 1, 1);
            Point firstDifferent3 = getFirstDifferent(point3, z12, -1, 1);
            Point firstDifferent4 = getFirstDifferent(point4, z12, -1, -1);
