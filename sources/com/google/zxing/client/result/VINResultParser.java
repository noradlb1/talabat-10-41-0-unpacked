...
public final class VINResultParser extends ResultParser {
    ...
    private static int modelYear(char c11) {
        ...
        if (c11 >= '1' && c11 <= '9') {
            return (c11 - ExpiryDateConstantsKt.EXPIRY_DATE_ZERO_POSITION_CHECK) + 2001;
        }
        if (c11 >= 'A' && c11 <= 'D') {
            return (c11 - 'A') + 2010;
        }
