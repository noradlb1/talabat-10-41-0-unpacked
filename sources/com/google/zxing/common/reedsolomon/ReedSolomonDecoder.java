    ...
    private int[] findErrorMagnitudes(GenericGFPoly genericGFPoly, int[] iArr) {
        ...
        for (int i12 = 0; i12 < length; i12++) {
            ...
            for (int i14 = 0; i14 < length; i14++) {
                if (i12 != i14) {
                    int multiply = this.field.multiply(iArr[i14], inverse);
                    if ((multiply & 1) == 0) {
                        i11 = multiply | 1;
                    } else {
                        i11 = multiply & -2;
                    }
                    i13 = this.field.multiply(i13, i11);
                }
            }
            iArr2[i12] = this.field.multiply(genericGFPoly.evaluateAt(inverse), this.field.inverse(i13));
            if (this.field.getGeneratorBase() != 0) {
                iArr2[i12] = this.field.multiply(iArr2[i12], inverse);
            }
        }
        return iArr2;
    }
