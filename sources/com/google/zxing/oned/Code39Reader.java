...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, Opcodes.INSTANCEOF, 448, Opcodes.I2B, 400, 208, Opcodes.I2L, 388, 196, Opcodes.JSR, Opcodes.IF_ICMPGE, 138, 42};
            ...
            if (charAt == '+' || charAt == '$' || charAt == '%' || charAt == '/') {
                ...
                if (charAt != '$') {
                    if (charAt != '%') {
                        ...
                        i11 = charAt2 + SignatureVisitor.EXTENDS;
                    } else if (charAt2 != 'U') {
                        if (charAt2 == 'V') {
                            c11 = '@';
                        } else if (charAt2 == 'W') {
