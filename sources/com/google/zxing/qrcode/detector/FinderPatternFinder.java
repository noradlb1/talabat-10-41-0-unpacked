...
public class FinderPatternFinder {
    ...
    private float crossCheckHorizontal(int i11, int i12, int i13, int i14) {
        ...
        int[] crossCheckStateCount2 = getCrossCheckStateCount();
        int i18 = i11;
        while (i18 >= 0 && bitMatrix.get(i18, i12)) {
            crossCheckStateCount2[2] = crossCheckStateCount2[2] + 1;
            i18--;
        }
        if (i18 < 0) {
        ...
        while (i18 >= 0 && !bitMatrix.get(i18, i12)) {
            int i19 = crossCheckStateCount2[1];
            if (i19 > i13) {
                break;
            }
            crossCheckStateCount2[1] = i19 + 1;
            i18--;
        }
        if (i18 >= 0 && crossCheckStateCount2[1] <= i13) {
            while (i18 >= 0 && bitMatrix.get(i18, i12) && (i17 = crossCheckStateCount2[0]) <= i13) {
                crossCheckStateCount2[0] = i17 + 1;
                i18--;
            }
            ...
            int i21 = i11 + 1;
            while (i21 < width && bitMatrix.get(i21, i12)) {
                crossCheckStateCount2[2] = crossCheckStateCount2[2] + 1;
                i21++;
            }
            if (i21 == width) {
            ...
            while (i21 < width && !bitMatrix.get(i21, i12) && (i16 = crossCheckStateCount2[3]) < i13) {
                crossCheckStateCount2[3] = i16 + 1;
                i21++;
            }
            if (i21 != width && crossCheckStateCount2[3] < i13) {
                while (i21 < width && bitMatrix.get(i21, i12) && (i15 = crossCheckStateCount2[4]) < i13) {
                    crossCheckStateCount2[4] = i15 + 1;
                    i21++;
                }
                int i22 = crossCheckStateCount2[4];
                if (i22 < i13 && Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + i22) - i14) * 5 < i14 && foundPatternCross(crossCheckStateCount2)) {
                    return centerFromEnd(crossCheckStateCount2, i21);
                }
            }
        }
        return Float.NaN;
    ...
    private float crossCheckVertical(int i11, int i12, int i13, int i14) {
        ...
        int[] crossCheckStateCount2 = getCrossCheckStateCount();
        int i18 = i11;
        while (i18 >= 0 && bitMatrix.get(i12, i18)) {
            crossCheckStateCount2[2] = crossCheckStateCount2[2] + 1;
            i18--;
        }
        if (i18 < 0) {
        ...
        if (i18 >= 0 && crossCheckStateCount2[1] <= i13) {
            while (i18 >= 0 && bitMatrix.get(i12, i18) && (i17 = crossCheckStateCount2[0]) <= i13) {
                crossCheckStateCount2[0] = i17 + 1;
                i18--;
            }
            if (crossCheckStateCount2[0] > i13) {
            ...
            int i21 = i11 + 1;
            while (i21 < height && bitMatrix.get(i12, i21)) {
                crossCheckStateCount2[2] = crossCheckStateCount2[2] + 1;
                i21++;
            }
            if (i21 == height) {
            ...
            while (i21 < height && !bitMatrix.get(i12, i21) && (i16 = crossCheckStateCount2[3]) < i13) {
                crossCheckStateCount2[3] = i16 + 1;
                i21++;
            }
            if (i21 != height && crossCheckStateCount2[3] < i13) {
                while (i21 < height && bitMatrix.get(i12, i21) && (i15 = crossCheckStateCount2[4]) < i13) {
                    crossCheckStateCount2[4] = i15 + 1;
                    i21++;
                }
                int i22 = crossCheckStateCount2[4];
                if (i22 < i13 && Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + i22) - i14) * 5 < i14 * 2 && foundPatternCross(crossCheckStateCount2)) {
                    return centerFromEnd(crossCheckStateCount2, i21);
                }
            }
        }
