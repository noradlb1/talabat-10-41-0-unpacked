...
/* renamed from: com.google.accompanist.navigation.animation.AnimatedNavHostKt$AnimatedNavHost$lambda-4$$inlined$map$1  reason: invalid class name */
public final class AnimatedNavHostKt$AnimatedNavHost$lambda4$$inlined$map$1 implements Flow<List<? extends NavBackStackEntry>> {
    final /* synthetic */ Flow $this_unsafeTransform$inlined;

    public AnimatedNavHostKt$AnimatedNavHost$lambda4$$inlined$map$1(Flow flow) {
