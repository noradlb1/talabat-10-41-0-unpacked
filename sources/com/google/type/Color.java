...
public final class Color extends GeneratedMessageLite<Color, Builder> implements ColorOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Color, Builder> implements ColorOrBuilder {
        ...
        public Builder setBlue(float f11) {
            copyOnWrite();
            ((Color) this.instance).setBlue(f11);
            return this;
        }

        public Builder setGreen(float f11) {
            copyOnWrite();
            ((Color) this.instance).setGreen(f11);
            return this;
        }

        public Builder setRed(float f11) {
            copyOnWrite();
            ((Color) this.instance).setRed(f11);
            return this;
        }
