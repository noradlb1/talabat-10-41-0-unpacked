...
public final class Fraction extends GeneratedMessageLite<Fraction, Builder> implements FractionOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Fraction, Builder> implements FractionOrBuilder {
        ...
        public Builder setDenominator(long j11) {
            copyOnWrite();
            ((Fraction) this.instance).setDenominator(j11);
            return this;
        }

        public Builder setNumerator(long j11) {
            copyOnWrite();
            ((Fraction) this.instance).setNumerator(j11);
            return this;
        }
    ...
    public void setDenominator(long j11) {
        this.denominator_ = j11;
    }

    /* access modifiers changed from: private */
    public void setNumerator(long j11) {
        this.numerator_ = j11;
    }
