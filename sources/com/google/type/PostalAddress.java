...
public final class PostalAddress extends GeneratedMessageLite<PostalAddress, Builder> implements PostalAddressOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<PostalAddress, Builder> implements PostalAddressOrBuilder {
        ...
        public String getAddressLines(int i11) {
            return ((PostalAddress) this.instance).getAddressLines(i11);
        }

        public ByteString getAddressLinesBytes(int i11) {
            return ((PostalAddress) this.instance).getAddressLinesBytes(i11);
        }
        ...
        public String getRecipients(int i11) {
            return ((PostalAddress) this.instance).getRecipients(i11);
        }

        public ByteString getRecipientsBytes(int i11) {
            return ((PostalAddress) this.instance).getRecipientsBytes(i11);
        }
        ...
        public Builder setAddressLines(int i11, String str) {
            copyOnWrite();
            ((PostalAddress) this.instance).setAddressLines(i11, str);
            return this;
        }
        ...
        public Builder setRecipients(int i11, String str) {
            copyOnWrite();
            ((PostalAddress) this.instance).setRecipients(i11, str);
            return this;
        }
        ...
        public Builder setRevision(int i11) {
            copyOnWrite();
            ((PostalAddress) this.instance).setRevision(i11);
            return this;
        }
