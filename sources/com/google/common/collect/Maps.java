...
public final class Maps {
    ...
    public static abstract class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public boolean apply(@CheckForNull Object obj, @ParametricNullness V v11) {
    ...
    public static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        private static <X, Y> Y convert(BiMap<X, Y> biMap, X x11) {
            ...
            Preconditions.checkArgument(z11, "No non-null mapping present for input: %s", (Object) x11);
            return y11;
        }
    ...
    public interface EntryTransformer<K, V1, V2> {
        @ParametricNullness
        V2 transformEntry(@ParametricNullness K k11, @ParametricNullness V1 v12);
    }
    ...
    public static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2> {
        ...
        @CheckForNull
        public Map.Entry<K, V2> ceilingEntry(@ParametricNullness K k11) {
        ...
        @CheckForNull
        public Map.Entry<K, V2> floorEntry(@ParametricNullness K k11) {
        ...
        @CheckForNull
        public Map.Entry<K, V2> higherEntry(@ParametricNullness K k11) {
        ...
        @CheckForNull
        public Map.Entry<K, V2> lowerEntry(@ParametricNullness K k11) {
        ...
        public NavigableMap<K, V2> headMap(@ParametricNullness K k11) {
            return headMap(k11, false);
        }

        public NavigableMap<K, V2> subMap(@ParametricNullness K k11, boolean z11, @ParametricNullness K k12, boolean z12) {
            return Maps.transformEntries(fromMap().subMap(k11, z11, k12, z12), this.transformer);
        }

        public NavigableMap<K, V2> tailMap(@ParametricNullness K k11) {
            return tailMap(k11, true);
        }

        public NavigableMap<K, V2> headMap(@ParametricNullness K k11, boolean z11) {
            return Maps.transformEntries(fromMap().headMap(k11, z11), this.transformer);
        }

        public NavigableMap<K, V2> tailMap(@ParametricNullness K k11, boolean z11) {
            return Maps.transformEntries(fromMap().tailMap(k11, z11), this.transformer);
        }

        public NavigableMap<K, V2> subMap(@ParametricNullness K k11, @ParametricNullness K k12) {
            return subMap(k11, true, k12, false);
        }
    }
    ...
    public static class TransformedEntriesSortedMap<K, V1, V2> extends TransformedEntriesMap<K, V1, V2> implements SortedMap<K, V2> {
        ...
        public SortedMap<K, V2> headMap(@ParametricNullness K k11) {
        ...
        public SortedMap<K, V2> subMap(@ParametricNullness K k11, @ParametricNullness K k12) {
            return Maps.transformEntries(fromMap().subMap(k11, k12), this.transformer);
        }

        public SortedMap<K, V2> tailMap(@ParametricNullness K k11) {
    ...
    public static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        private ValueDifferenceImpl(@ParametricNullness V v11, @ParametricNullness V v12) {
            this.left = v11;
            this.right = v12;
        }

        public static <V> MapDifference.ValueDifference<V> create(@ParametricNullness V v11, @ParametricNullness V v12) {
        ...
        public String toString() {
            return "(" + this.left + IndicativeSentencesGeneration.DEFAULT_SEPARATOR + this.right + ")";
        }
    }
    ...
    public static <K, V1, V2> EntryTransformer<K, V1, V2> asEntryTransformer(final Function<? super V1, V2> function) {
        ...
        return new EntryTransformer<K, V1, V2>() {
            @ParametricNullness
            public V2 transformEntry(@ParametricNullness K k11, @ParametricNullness V1 v12) {
    ...
    public static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) {
            public Map.Entry<K, V> transform(@ParametricNullness K k11) {
                return Maps.immutableEntry(k11, function.apply(k11));
            }
        };
    }

    public static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> entryTransformer, @ParametricNullness final K k11) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<V1, V2>() {
            @ParametricNullness
            public V2 apply(@ParametricNullness V1 v12) {
                return EntryTransformer.this.transformEntry(k11, v12);
            }
        };
    }
    ...
    public static <K, V> Map.Entry<K, V> immutableEntry(@ParametricNullness K k11, @ParametricNullness V v11) {
    ...
    public static <K extends Comparable<? super K>, V> NavigableMap<K, V> subMap(NavigableMap<K, V> navigableMap, Range<K> range) {
        ...
        if (navigableMap.comparator() != null && navigableMap.comparator() != Ordering.natural() && range.hasLowerBound() && range.hasUpperBound()) {
            ...
            Preconditions.checkArgument(z12, "map is using a custom comparator which is inconsistent with the natural ordering.");
        }
        if (range.hasLowerBound() && range.hasUpperBound()) {
            ...
            return navigableMap.subMap(lowerEndpoint, z11, upperEndpoint, z13);
        } else if (range.hasLowerBound()) {
            K lowerEndpoint2 = range.lowerEndpoint();
            if (range.lowerBoundType() != BoundType.CLOSED) {
                z13 = false;
            }
            return navigableMap.tailMap(lowerEndpoint2, z13);
            ...
            return navigableMap.headMap(upperEndpoint2, z13);
        }
    }
