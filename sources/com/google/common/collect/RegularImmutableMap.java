...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
        ...
        public ImmutableList<Map.Entry<K, V>> createAsList() {
            return new ImmutableList<Map.Entry<K, V>>() {
                ...
                public Map.Entry<K, V> get(int i11) {
                    ...
                    int i12 = i11 * 2;
                    Object obj = EntrySet.this.alternatingKeysAndValues[EntrySet.this.keyOffset + i12];
                    Objects.requireNonNull(obj);
                    Object obj2 = EntrySet.this.alternatingKeysAndValues[i12 + (EntrySet.this.keyOffset ^ 1)];
    ...
    public static final class KeysOrValuesAsList extends ImmutableList<Object> {
        ...
        public Object get(int i11) {
            ...
            Object obj = this.alternatingKeysAndValues[(i11 * 2) + this.offset];
            Objects.requireNonNull(obj);
            return obj;
        }
    ...
    private RegularImmutableMap(@CheckForNull Object obj, Object[] objArr, int i11) {
        this.hashTable = obj;
        this.alternatingKeysAndValues = objArr;
        this.size = i11;
    }
    ...
    public static <K, V> RegularImmutableMap<K, V> create(int i11, Object[] objArr) {
        return create(i11, objArr, (ImmutableMap.Builder) null);
    }
    ...
    public static Object createHashTableOrThrow(Object[] objArr, int i11, int i12, int i13) {
        Object createHashTable = createHashTable(objArr, i11, i12, i13);
    ...
    public V get(@CheckForNull Object obj) {
        V v11 = get(this.hashTable, this.alternatingKeysAndValues, this.size, 0, obj);
        if (v11 == null) {
            return null;
        }
        return v11;
    ...
    public static <K, V> RegularImmutableMap<K, V> create(int i11, Object[] objArr, ImmutableMap.Builder<K, V> builder) {
        if (i11 == 0) {
        ...
        Object createHashTable = createHashTable(objArr, i11, ImmutableSet.chooseTableSize(i11), 0);
        if (createHashTable instanceof Object[]) {
        ...
        return new RegularImmutableMap<>(createHashTable, objArr, i11);
    }

    @CheckForNull
    public static Object get(@CheckForNull Object obj, Object[] objArr, int i11, int i12, @CheckForNull Object obj2) {
        if (obj2 == null) {
            return null;
        }
        if (i11 == 1) {
            ...
            if (obj instanceof byte[]) {
                ...
                while (true) {
                    ...
                    short s11 = sArr[i14] & UShort.MAX_VALUE;
                    if (s11 == 65535) {
                        return null;
                    }
                    if (obj2.equals(objArr[s11])) {
                        return objArr[s11 ^ 1];
                    }
                    smear2 = i14 + 1;
                }
