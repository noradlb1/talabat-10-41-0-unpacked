...
final class Synchronized {
    ...
    public static class SynchronizedListMultimap<K, V> extends SynchronizedMultimap<K, V> implements ListMultimap<K, V> {
        ...
        public List<V> get(K k11) {
            List<V> access$200;
            synchronized (this.mutex) {
                access$200 = Synchronized.list(delegate().get((Object) k11), this.mutex);
            }
            return access$200;
        }
        ...
        public List<V> replaceValues(K k11, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                replaceValues = delegate().replaceValues((Object) k11, (Iterable) iterable);
            }
    ...
    public static class SynchronizedSetMultimap<K, V> extends SynchronizedMultimap<K, V> implements SetMultimap<K, V> {
        ...
        public Set<V> get(K k11) {
            Set<V> set;
            synchronized (this.mutex) {
                set = Synchronized.set(delegate().get((Object) k11), this.mutex);
            }
            return set;
        }
    ...
    public static class SynchronizedSortedSetMultimap<K, V> extends SynchronizedSetMultimap<K, V> implements SortedSetMultimap<K, V> {
        ...
        public SortedSet<V> get(K k11) {
            ...
            synchronized (this.mutex) {
                access$100 = Synchronized.sortedSet(delegate().get((Object) k11), this.mutex);
            }
            return access$100;
        }
