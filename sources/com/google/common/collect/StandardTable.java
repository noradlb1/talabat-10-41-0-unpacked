...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
                    ...
                    if (((Map) next.getValue()).containsKey(Column.this.columnKey)) {
                        return new AbstractMapEntry<R, V>() {
                            ...
                            public V setValue(V v11) {
                                return NullnessCasts.uncheckedCastNullableTToT(((Map) next.getValue()).put(Column.this.columnKey, Preconditions.checkNotNull(v11)));
                            }
                        };
                    }
                }
    ...
    public class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public java.util.Iterator<Map.Entry<C, V>> entryIterator() {
            ...
            final java.util.Iterator<Map.Entry<C, V>> it = map.entrySet().iterator();
            return new Object() {
                public /* synthetic */ void forEachRemaining(Consumer consumer) {
                    Iterator.CC.$default$forEachRemaining(this, consumer);
                }
    ...
    public java.util.Iterator<Table.Cell<R, C, V>> cellIterator() {
