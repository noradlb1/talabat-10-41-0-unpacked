...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    public ImmutableSetMultimap(ImmutableMap<K, ImmutableSet<V>> immutableMap, int i11, @CheckForNull Comparator<? super V> comparator) {
    ...
    public static <K, V> ImmutableSetMultimap<K, V> fromMapEntries(Collection<? extends Map.Entry<? extends K, ? extends Collection<? extends V>>> collection, @CheckForNull Comparator<? super V> comparator) {
        ...
        return new ImmutableSetMultimap<>(builder.buildOrThrow(), i11, comparator);
    }
