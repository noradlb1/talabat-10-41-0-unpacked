...
public interface Multimap<K, V> {
    ...
    Collection<V> get(@ParametricNullness K k11);
    ...
    boolean put(@ParametricNullness K k11, @ParametricNullness V v11);

    @CanIgnoreReturnValue
    boolean putAll(Multimap<? extends K, ? extends V> multimap);

    @CanIgnoreReturnValue
    boolean putAll(@ParametricNullness K k11, Iterable<? extends V> iterable);
    ...
    @CanIgnoreReturnValue
    Collection<V> replaceValues(@ParametricNullness K k11, Iterable<? extends V> iterable);
