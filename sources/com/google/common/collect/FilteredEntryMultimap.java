...
class FilteredEntryMultimap<K, V> extends AbstractMultimap<K, V> implements FilteredMultimap<K, V> {
    ...
    public class Keys extends Multimaps.Keys<K, V> {
        ...
        public int remove(@CheckForNull Object obj, int i11) {
            ...
            Iterator it = collection.iterator();
            while (it.hasNext()) {
                if (FilteredEntryMultimap.this.satisfies(obj, it.next()) && (i12 = i12 + 1) <= i11) {
                    it.remove();
                }
            }
            return i12;
    ...
    public final class ValuePredicate implements Predicate<V> {
        ...
        public ValuePredicate(@ParametricNullness K k11) {
            this.key = k11;
        }

        public boolean apply(@ParametricNullness V v11) {
    ...
    public boolean satisfies(@ParametricNullness K k11, @ParametricNullness V v11) {
