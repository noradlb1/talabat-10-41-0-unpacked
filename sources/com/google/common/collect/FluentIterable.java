...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    public final <C extends Collection<? super E>> C copyInto(C c11) {
        ...
        if (delegate instanceof Collection) {
            c11.addAll((Collection) delegate);
        } else {
    ...
    public static <E> FluentIterable<E> of(@ParametricNullness E e11, E... eArr) {
    ...
    public static <T> FluentIterable<T> concat(final Iterable<? extends Iterable<? extends T>> iterable) {
        ...
        return new FluentIterable<T>() {
            public Iterator<T> iterator() {
                return Iterators.concat(Iterators.transform(iterable.iterator(), new b()));
            }
        };
    }
