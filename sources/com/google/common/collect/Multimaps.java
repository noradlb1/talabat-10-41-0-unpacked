...
public final class Multimaps {
    ...
    public static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        public class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            public Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new e(this));
            }
    ...
    public static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        public Set<V> get(@ParametricNullness final K k11) {
                    ...
                    return new Object() {
                        ...
                        public V next() {
                            if (hasNext()) {
                                this.f44640i++;
                                AnonymousClass1 r02 = AnonymousClass1.this;
                                return NullnessCasts.uncheckedCastNullableTToT(MapMultimap.this.map.get(k11));
                            }
    ...
    public static final class TransformedEntriesListMultimap<K, V1, V2> extends TransformedEntriesMultimap<K, V1, V2> implements ListMultimap<K, V2> {
        ...
        public List<V2> transform(@ParametricNullness K k11, Collection<V1> collection) {
    ...
    public static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new f(this));
        }
        ...
        public Collection<V2> get(@ParametricNullness K k11) {
            return lambda$createAsMap$0(k11, this.fromMultimap.get(k11));
        }
        ...
        public Collection<V2> lambda$createAsMap$0(@ParametricNullness K k11, Collection<V1> collection) {
    ...
    public static class UnmodifiableListMultimap<K, V> extends UnmodifiableMultimap<K, V> implements ListMultimap<K, V> {
        ...
        public List<V> get(@ParametricNullness K k11) {
            return Collections.unmodifiableList(delegate().get((Object) k11));
        }
    ...
    public static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            Map<K, Collection<V>> unmodifiableMap = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new g()));
    ...
    public static class UnmodifiableSetMultimap<K, V> extends UnmodifiableMultimap<K, V> implements SetMultimap<K, V> {
        ...
        public Set<V> get(@ParametricNullness K k11) {
            return Collections.unmodifiableSet(delegate().get((Object) k11));
        }
    ...
    public static class UnmodifiableSortedSetMultimap<K, V> extends UnmodifiableSetMultimap<K, V> implements SortedSetMultimap<K, V> {
        ...
        public SortedSet<V> get(@ParametricNullness K k11) {
            return Collections.unmodifiableSortedSet(delegate().get((Object) k11));
        }
