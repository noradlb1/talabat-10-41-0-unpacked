...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
    ...
    public class QueueIterator implements Iterator<E>, j$.util.Iterator {
        ...
        public void remove() {
            ...
            E e11 = this.lastFromForgetMeNot;
            Objects.requireNonNull(e11);
            Preconditions.checkState(removeExact(e11));
    ...
    public static boolean isEvenLevel(int i11) {
        ...
        Preconditions.checkState(z11, "negative index");
        if ((EVEN_POWERS_OF_TWO & i12) > (i12 & ODD_POWERS_OF_TWO)) {
            return true;
        }
        return false;
    }
