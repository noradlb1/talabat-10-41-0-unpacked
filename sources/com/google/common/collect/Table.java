...
public interface Table<R, C, V> {
    ...
    Map<R, V> column(@ParametricNullness C c11);
    ...
    V put(@ParametricNullness R r11, @ParametricNullness C c11, @ParametricNullness V v11);
    ...
    Map<C, V> row(@ParametricNullness R r11);
