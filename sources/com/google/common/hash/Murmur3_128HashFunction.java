...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    public static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        private long f44661h1;

        /* renamed from: h2  reason: collision with root package name */
        private long f44662h2;
        ...
        private void bmix64(long j11, long j12) {
            long mixK1 = mixK1(j11) ^ this.f44661h1;
            this.f44661h1 = mixK1;
            long rotateLeft = Long.rotateLeft(mixK1, 27);
            long j13 = this.f44662h2;
            this.f44661h1 = ((rotateLeft + j13) * 5) + 1390208809;
            long mixK2 = mixK2(j12) ^ j13;
            this.f44662h2 = mixK2;
            this.f44662h2 = ((Long.rotateLeft(mixK2, 31) + this.f44661h1) * 5) + 944331445;
        }
        ...
        public HashCode makeHash() {
            long j11 = this.f44661h1;
            int i11 = this.length;
            long j12 = j11 ^ ((long) i11);
            long j13 = this.f44662h2 ^ ((long) i11);
            long j14 = j12 + j13;
            this.f44661h1 = j14;
            this.f44662h2 = j13 + j14;
            this.f44661h1 = fmix64(j14);
            long fmix64 = fmix64(this.f44662h2);
            long j15 = this.f44661h1 + fmix64;
            this.f44661h1 = j15;
            this.f44662h2 = fmix64 + j15;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f44661h1).putLong(this.f44662h2).array());
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f44661h1 ^= mixK1(r2);
            r11.f44662h2 ^= mixK2(r7);
         */
        ...
        public void processRemaining(java.nio.ByteBuffer r12) {
            ...
            L_0x00eb:
                ...
                long r2 = r2 ^ r0
            L_0x00f6:
                long r0 = r11.f44661h1
                long r2 = mixK1(r2)
                long r0 = r0 ^ r2
                r11.f44661h1 = r0
                long r0 = r11.f44662h2
                long r2 = mixK2(r7)
                long r0 = r0 ^ r2
                r11.f44662h2 = r0
                return
