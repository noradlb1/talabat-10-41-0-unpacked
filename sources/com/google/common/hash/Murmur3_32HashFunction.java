...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    public static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i11, long j11) {
            ...
            this.length += i11;
            if (i13 >= 32) {
                this.f44663h1 = Murmur3_32HashFunction.mixH1(this.f44663h1, Murmur3_32HashFunction.mixK1((int) j13));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            int access$000 = this.f44663h1 ^ Murmur3_32HashFunction.mixK1((int) this.buffer);
            this.f44663h1 = access$000;
    ...
    public static long charToThreeUtf8Bytes(char c11) {
        return ((long) (c11 >>> 12)) | 224 | ((long) ((((c11 >>> 6) & 63) | 128) << 8)) | ((long) (((c11 & '?') | 128) << 16));
    }

    /* access modifiers changed from: private */
    public static long charToTwoUtf8Bytes(char c11) {
        return ((long) (c11 >>> 6)) | 192 | ((long) (((c11 & '?') | 128) << 8));
    }

    /* access modifiers changed from: private */
    public static long codePointToFourUtf8Bytes(int i11) {
        return ((long) (i11 >>> 18)) | 240 | ((((long) ((i11 >>> 12) & 63)) | 128) << 8) | ((((long) ((i11 >>> 6) & 63)) | 128) << 16) | ((((long) (i11 & 63)) | 128) << 24);
    }
