...
public abstract class HashCode {
    ...
    public static final class BytesHashCode extends HashCode implements Serializable {
        ...
        public int asInt() {
            ...
            Preconditions.checkState(z11, "HashCode#asInt() requires >= 4 bytes (it only has %s bytes).", bArr.length);
        ...
        public long asLong() {
            ...
            Preconditions.checkState(z11, "HashCode#asLong() requires >= 8 bytes (it only has %s bytes).", bArr.length);
            return padToLong();
        }
        ...
        public boolean equalsSameBits(HashCode hashCode) {
            ...
            while (true) {
                ...
                if (bArr[i11] == hashCode.getBytesInternal()[i11]) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public static HashCode fromString(String str) {
        ...
        Preconditions.checkArgument(z11, "input string (%s) must have at least 2 characters", (Object) str);
        if (str.length() % 2 != 0) {
            z12 = false;
        }
        Preconditions.checkArgument(z12, "input string (%s) must have an even number of characters", (Object) str);
