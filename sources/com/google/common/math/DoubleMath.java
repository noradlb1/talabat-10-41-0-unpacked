...
public final class DoubleMath {
    ...
    public static double factorial(int i11) {
        ...
        double d11 = 1.0d;
        for (int i12 = (i11 & -16) + 1; i12 <= i11; i12++) {
            d11 *= (double) i12;
        }
    ...
    public static boolean fuzzyEquals(double d11, double d12, double d13) {
        ...
        if (Math.copySign(d11 - d12, 1.0d) <= d13 || d11 == d12 || (Double.isNaN(d11) && Double.isNaN(d12))) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isMathematicalInteger(double d11) {
        if (!DoubleUtils.isFinite(d11) || (d11 != 0.0d && 52 - Long.numberOfTrailingZeros(DoubleUtils.getSignificand(d11)) > Math.getExponent(d11))) {
            return false;
        }
        return true;
    }
        ...
        if (DoubleUtils.isFinite(d11)) {
            switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                    ...
                    return d11;
                case 2:
                    if (d11 >= 0.0d || isMathematicalInteger(d11)) {
                        return d11;
                    }
                    return (double) (((long) d11) - 1);
                case 3:
                    if (d11 <= 0.0d || isMathematicalInteger(d11)) {
                        return d11;
                    }
                ...
                case 5:
                    ...
                    return (double) (j11 + ((long) i11));
                case 6:
                    return Math.rint(d11);
                case 7:
                    double rint = Math.rint(d11);
                    if (Math.abs(d11 - rint) == 0.5d) {
                        return d11 + Math.copySign(0.5d, d11);
                    }
                    return rint;
                case 8:
                    double rint2 = Math.rint(d11);
                    if (Math.abs(d11 - rint2) == 0.5d) {
                        return d11;
                    }
                    return rint2;
                default:
    ...
    public static int roundToInt(double d11, RoundingMode roundingMode) {
        ...
        MathPreconditions.checkInRangeForRoundingInputs(z11 & z12, d11, roundingMode);
    ...
    public static double mean(Iterator<? extends Number> it) {
        ...
        while (it.hasNext()) {
            j11++;
            checkFinite += (checkFinite(((Number) it.next()).doubleValue()) - checkFinite) / ((double) j11);
        }
        return checkFinite;
    }
}
