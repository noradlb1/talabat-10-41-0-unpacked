...
public final class Quantiles {
    ...
    public static final class ScaleAndIndex {
        ...
        public double computeInPlace(double... dArr) {
            ...
            Preconditions.checkArgument(z11, "Cannot calculate quantiles of an empty dataset");
    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                int i16 = iArr4[i11];
                if (i16 == 0) {
                    linkedHashMap2.put(Integer.valueOf(iArr7[i11]), Double.valueOf(dArr2[i15]));
                } else {
                    linkedHashMap2.put(Integer.valueOf(iArr7[i11]), Double.valueOf(Quantiles.interpolate(dArr2[i15], dArr2[i15 + 1], (double) i16, (double) this.scale)));
                }
                i11++;
            }
        }
        ...
        private ScaleAndIndexes(int i11, int[] iArr) {
            ...
            Preconditions.checkArgument(iArr.length > 0 ? true : z11, "Indexes must be a non empty array");
            this.scale = i11;
            this.indexes = iArr;
        }
