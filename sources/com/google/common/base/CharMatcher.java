...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static final class And extends CharMatcher {
        ...
        public String toString() {
            return "CharMatcher.and(" + this.first + IndicativeSentencesGeneration.DEFAULT_SEPARATOR + this.second + ")";
        }
    }
    ...
    public static final class Or extends CharMatcher {
        ...
        public String toString() {
            return "CharMatcher.or(" + this.first + IndicativeSentencesGeneration.DEFAULT_SEPARATOR + this.second + ")";
        }
    }
    ...
    private static CharMatcher precomputedPositive(int i11, BitSet bitSet, String str) {
        ...
        } else if (isSmall(i11, bitSet.length())) {
    ...
    public CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(i11, bitSet, str)) {
            public String toString() {
                return charMatcher;
            }
        };
