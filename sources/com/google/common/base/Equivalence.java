...
public abstract class Equivalence<T> {
    ...
    public static final class EquivalentToPredicate<T> implements Predicate<T>, Serializable {
        ...
        public EquivalentToPredicate(Equivalence<T> equivalence2, @CheckForNull T t11) {
    ...
    public static final class Wrapper<T> implements Serializable {
        ...
        private Wrapper(Equivalence<? super T> equivalence2, @ParametricNullness T t11) {
            this.equivalence = (Equivalence) Preconditions.checkNotNull(equivalence2);
            this.reference = t11;
        }
    }
    ...
    public final boolean equivalent(@CheckForNull T t11, @CheckForNull T t12) {
        if (t11 == t12) {
            return true;
        }
    ...
    public final Predicate<T> equivalentTo(@CheckForNull T t11) {
        return new EquivalentToPredicate(this, t11);
    }

    public final int hash(@CheckForNull T t11) {
        if (t11 == null) {
            return 0;
        }
        return doHash(t11);
