...
public final class Splitter {
    ...
    public static Splitter fixedLength(final int i11) {
        ...
        Preconditions.checkArgument(z11, "The length may not be less than 1");
    ...
    public Splitter limit(int i11) {
        ...
        Preconditions.checkArgument(z11, "must be greater than zero: %s", i11);
    ...
    public Iterable<String> split(final CharSequence charSequence) {
        ...
        return new Iterable<String>() {
            ...
            public String toString() {
                Joiner on2 = Joiner.on(IndicativeSentencesGeneration.DEFAULT_SEPARATOR);
        ...
        return new Splitter(new Strategy() {
            public SplittingIterator iterator(Splitter splitter, CharSequence charSequence) {
                return new SplittingIterator(splitter, charSequence) {
                    ...
                    public int separatorStart(int i11) {
                        return CharMatcher.this.indexIn(this.toSplit, i11);
                    }
                };
            }
        });
