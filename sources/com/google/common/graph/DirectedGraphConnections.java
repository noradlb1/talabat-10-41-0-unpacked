...
final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    public static abstract class NodeConnection<N> {
        ...
        public NodeConnection(N n11) {
            this.node = Preconditions.checkNotNull(n11);
        }
    }
    ...
    private DirectedGraphConnections(Map<N, Object> map, @CheckForNull List<NodeConnection<N>> list, int i11, int i12) {
        boolean z11;
    ...
    public static <N, V> DirectedGraphConnections<N, V> of(ElementOrder<N> elementOrder) {
        ArrayList arrayList;
        int i11 = AnonymousClass5.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i11 == 1) {
            arrayList = null;
        } else if (i11 == 2) {
    ...
    public static <N, V> DirectedGraphConnections<N, V> ofImmutable(N n11, Iterable<EndpointPair<N>> iterable, Function<N, V> function) {
        boolean z11;
        ...
        for (EndpointPair next : iterable) {
            if (next.nodeU().equals(n11) && next.nodeV().equals(n11)) {
                hashMap.put(n11, new PredAndSucc(function.apply(n11)));
                builder.add((Object) new NodeConnection.Pred(n11));
                builder.add((Object) new NodeConnection.Succ(n11));
                i11++;
            } else if (next.nodeV().equals(n11)) {
                ...
                Preconditions.checkArgument(next.nodeU().equals(n11));
        ...
        return new DirectedGraphConnections<>(hashMap, builder.build(), i11, i12);
    }
    ...
    public Iterator<EndpointPair<N>> incidentEdgeIterator(N n11) {
        final Iterator<T> it;
        Preconditions.checkNotNull(n11);
        List<NodeConnection<N>> list = this.orderedNodeConnections;
        if (list == null) {
            it = Iterators.concat(Iterators.transform(predecessors().iterator(), new f(n11)), Iterators.transform(successors().iterator(), new g(n11)));
        } else {
            it = Iterators.transform(list.iterator(), new h(n11));
        }
    ...
    public V removeSuccessor(Object obj) {
        ...
        if (v12 == null || v12 == (v11 = PRED)) {
            v12 = null;
        } else if (v12 instanceof PredAndSucc) {
            this.adjacentNodeValues.put(obj, v11);
            v12 = ((PredAndSucc) v12).successorValue;
        } else {
    ...
    public V value(N n11) {
        ...
        if (v11 instanceof PredAndSucc) {
            return ((PredAndSucc) v11).successorValue;
        }
        return v11;
    }
}
