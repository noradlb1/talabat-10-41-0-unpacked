...
public final class ImmutableValueGraph<N, V> extends StandardValueGraph<N, V> {
    ...
    private static <N, V> GraphConnections<N, V> connectionsOf(ValueGraph<N, V> valueGraph, N n11) {
        g gVar = new g(valueGraph, n11);
        if (valueGraph.isDirected()) {
            return DirectedGraphConnections.ofImmutable(n11, valueGraph.incidentEdges(n11), gVar);
        }
        return UndirectedGraphConnections.ofImmutable(Maps.asMap(valueGraph.adjacentNodes(n11), gVar));
    }
