...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    public static <N, V> UndirectedGraphConnections<N, V> of(ElementOrder<N> elementOrder) {
        int i11 = AnonymousClass1.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i11 == 1) {
    ...
    public Iterator<EndpointPair<N>> incidentEdgeIterator(N n11) {
        return Iterators.transform(this.adjacentNodeValues.keySet().iterator(), new j(n11));
    }
