...
public class CycleDetectingLockFactory {
    ...
    public final class CycleDetectingReentrantReadWriteLock extends ReentrantReadWriteLock implements CycleDetectingLock {
        ...
        private CycleDetectingReentrantReadWriteLock(CycleDetectingLockFactory cycleDetectingLockFactory, LockGraphNode lockGraphNode2, boolean z11) {
            super(z11);
    ...
    public static class LockGraphNode {
        ...
        public void checkAcquiredLock(Policy policy, LockGraphNode lockGraphNode) {
            ...
            Preconditions.checkState(z11, "Attempted to acquire multiple locks with the same rank %s", (Object) lockGraphNode.getLockName());
    ...
    public static final class WithExplicitOrdering<E extends Enum<E>> extends CycleDetectingLockFactory {
        ...
        public ReentrantLock newReentrantLock(E e11, boolean z11) {
            ...
            LockGraphNode lockGraphNode = this.lockGraphNodes.get(e11);
            Objects.requireNonNull(lockGraphNode);
            return new CycleDetectingReentrantLock(lockGraphNode, z11);
        }
        ...
        public ReentrantReadWriteLock newReentrantReadWriteLock(E e11, boolean z11) {
            ...
            LockGraphNode lockGraphNode = this.lockGraphNodes.get(e11);
            Objects.requireNonNull(lockGraphNode);
            return new CycleDetectingReentrantReadWriteLock(lockGraphNode, z11);
        }
    }
    ...
    private static String getLockName(Enum<?> enumR) {
        return enumR.getDeclaringClass().getSimpleName() + RealDiscoveryConfigurationRepository.VERSION_DELIMETER + enumR.name();
    }
    ...
    public ReentrantLock newReentrantLock(String str, boolean z11) {
        ...
        return new CycleDetectingReentrantLock(new LockGraphNode(str), z11);
    }
    ...
    public ReentrantReadWriteLock newReentrantReadWriteLock(String str, boolean z11) {
        ...
        return new CycleDetectingReentrantReadWriteLock(new LockGraphNode(str), z11);
    }
