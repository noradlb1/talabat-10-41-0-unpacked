...
public final class ClosingFuture<V> {
    ...
    public interface AsyncClosingFunction<T, U> {
        ClosingFuture<U> apply(DeferredCloser deferredCloser, @ParametricNullness T t11) throws Exception;
    }
    ...
    public static final class CloseableList extends IdentityHashMap<Closeable, Executor> implements Closeable {
        ...
        public <V, U> FluentFuture<U> applyAsyncClosingFunction(AsyncClosingFunction<V, U> asyncClosingFunction, @ParametricNullness V v11) throws Exception {
            CloseableList closeableList = new CloseableList();
            try {
                ClosingFuture<U> apply = asyncClosingFunction.apply(closeableList.closer, v11);
        ...
        public <V, U> ListenableFuture<U> applyClosingFunction(ClosingFunction<? super V, U> closingFunction, @ParametricNullness V v11) throws Exception {
            CloseableList closeableList = new CloseableList();
            try {
                return Futures.immediateFuture(closingFunction.apply(closeableList.closer, v11));
            } finally {
                add(closeableList, MoreExecutors.directExecutor());
            }
        }
    ...
    public interface ClosingFunction<T, U> {
        @ParametricNullness
        U apply(DeferredCloser deferredCloser, @ParametricNullness T t11) throws Exception;
    }
    ...
    public static class Combiner {
        ...
        private ImmutableList<FluentFuture<?>> inputFutures() {
            return FluentIterable.from(this.inputs).transform(new h()).toList();
        }
        ...
        private Combiner(boolean z11, Iterable<? extends ClosingFuture<?>> iterable) {
    ...
    public static final class DeferredCloser {
        ...
        public <C extends Closeable> C eventuallyClose(@ParametricNullness C c11, Executor executor) {
            Preconditions.checkNotNull(executor);
            if (c11 != null) {
                this.list.add((Closeable) c11, executor);
            }
            return c11;
        }
    }
    ...
    private <X extends Throwable, W extends V> ClosingFuture<V> catchingAsyncMoreGeneric(Class<X> cls, final AsyncClosingFunction<? super X, W> asyncClosingFunction, Executor executor) {
        ...
        return derive(this.future.catchingAsync(cls, new AsyncFunction<X, W>() {
            ...
            public ListenableFuture<W> apply(X x11) throws Exception {
                return ClosingFuture.this.closeables.applyAsyncClosingFunction(asyncClosingFunction, x11);
            }
        }, executor));
    }
    ...
    private <X extends Throwable, W extends V> ClosingFuture<V> catchingMoreGeneric(Class<X> cls, final ClosingFunction<? super X, W> closingFunction, Executor executor) {
        ...
        return derive(this.future.catchingAsync(cls, new AsyncFunction<X, W>() {
            ...
            public ListenableFuture<W> apply(X x11) throws Exception {
                return ClosingFuture.this.closeables.applyClosingFunction(closingFunction, x11);
            }
        }, executor));
    }
    ...
    public static void closeQuietly(@CheckForNull Closeable closeable, Executor executor) {
        if (closeable != null) {
            try {
                executor.execute(new g(closeable));
            } catch (RejectedExecutionException e11) {
                Logger logger2 = logger;
                Level level = Level.WARNING;
                if (logger2.isLoggable(level)) {
                    logger2.log(level, String.format("while submitting close to %s; will close inline", new Object[]{executor}), e11);
                }
    ...
    public static /* synthetic */ void lambda$closeQuietly$0(Closeable closeable) {
        try {
            ...
            logger.log(Level.WARNING, "thrown by close()", e11);
        }
    }
    ...
    public static <V, U> AsyncClosingFunction<V, U> withoutCloser(final AsyncFunction<V, U> asyncFunction) {
        ...
        return new AsyncClosingFunction<V, U>() {
            public ClosingFuture<U> apply(DeferredCloser deferredCloser, V v11) throws Exception {
                return ClosingFuture.from(AsyncFunction.this.apply(v11));
            }
        };
    }
    ...
    public void finishToValueAndCloser(final ValueAndCloserConsumer<? super V> valueAndCloserConsumer, Executor executor) {
        ...
        if (!compareAndUpdateState(State.OPEN, State.WILL_CREATE_VALUE_AND_CLOSER)) {
            int i11 = AnonymousClass11.$SwitchMap$com$google$common$util$concurrent$ClosingFuture$State[this.state.get().ordinal()];
            if (i11 == 1) {
    ...
    public <U> ClosingFuture<U> transform(final ClosingFunction<? super V, U> closingFunction, Executor executor) {
        ...
        return derive(this.future.transformAsync(new AsyncFunction<V, U>() {
            public ListenableFuture<U> apply(V v11) throws Exception {
                return ClosingFuture.this.closeables.applyClosingFunction(closingFunction, v11);
            }
    ...
    public <U> ClosingFuture<U> transformAsync(final AsyncClosingFunction<? super V, U> asyncClosingFunction, Executor executor) {
        ...
        return derive(this.future.transformAsync(new AsyncFunction<V, U>() {
            public ListenableFuture<U> apply(V v11) throws Exception {
                return ClosingFuture.this.closeables.applyAsyncClosingFunction(asyncClosingFunction, v11);
            }
