...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    private static void checkPositiveTimeout(long j11) {
        ...
        Preconditions.checkArgument(z11, "timeout must be positive: %s", j11);
    }
    ...
    public <T> T newProxy(T t11, Class<T> cls, long j11, TimeUnit timeUnit) {
        ...
        return newProxy(cls, new InvocationHandler() {
            ...
            public Object invoke(Object obj, Method method, @CheckForNull Object[] objArr) throws Throwable {
                return SimpleTimeLimiter.this.callWithTimeout(new o(method, t12, objArr), j12, timeUnit2, findInterruptibleMethods.contains(method));
            }
        });
    }
