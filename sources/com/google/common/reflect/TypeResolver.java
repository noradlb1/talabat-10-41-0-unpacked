...
public final class TypeResolver {
    ...
    public static class WildcardCapturer {
        ...
        private final AtomicInteger f44697id;
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f44697id) {
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f44697id);
        }
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f44697id.incrementAndGet() + "-of ? extends " + Joiner.on((char) Typography.amp).join((Object[]) typeArr), typeArr);
        }
            ...
            new TypeVisitor() {
                ...
                public void visitGenericArrayType(GenericArrayType genericArrayType) {
                    ...
                    if (!(type instanceof WildcardType)) {
                        ...
                        Preconditions.checkArgument(z11, "%s is not an array type.", (Object) type2);
                ...
                public void visitParameterizedType(ParameterizedType parameterizedType) {
                    ...
                    if (!(type instanceof WildcardType)) {
                        ...
                        Preconditions.checkArgument(z11, "%s not compatible with %s", (Object) parameterizedType, (Object) parameterizedType2);
                        for (int i11 = 0; i11 < actualTypeArguments.length; i11++) {
                ...
                public void visitWildcardType(WildcardType wildcardType) {
                    ...
                    if (type instanceof WildcardType) {
                        ...
                        Preconditions.checkArgument(z11, "Incompatible type: %s vs. %s", (Object) wildcardType, (Object) type2);
