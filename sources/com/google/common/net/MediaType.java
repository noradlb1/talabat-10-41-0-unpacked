...
public final class MediaType {
    ...
    public static final MediaType BASIC_AUDIO = createConstant("audio", BuildConfig.FLAVOR);
    ...
    public static final MediaType FONT_COLLECTION = createConstant(FONT_TYPE, GemAccessor.COMPONENT_COLLECTION);
    ...
    public static final MediaType ZIP = createConstant("application", ArchiveStreamFactory.ZIP);
    @LazyInit
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb2.append("; ");
            PARAMETER_JOINER.appendTo(sb2, (Iterable<? extends Map.Entry<?, ?>>) Multimaps.transformValues(this.parameters, new b()).entries());
        }
        return sb2.toString();
    }
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            while (tokenizer.hasMore()) {
                ...
                tokenizer.consumeCharacter((char) TypePool.Default.LazyTypeDescription.GenericTypeToken.INDEXED_TYPE_DELIMITER);
                tokenizer.consumeTokenIfPresent(charMatcher2);
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    ...
                    throw new IllegalStateException("Multiple charset values defined: " + str + IndicativeSentencesGeneration.DEFAULT_SEPARATOR + str2);
                }
            }
    ...
    public static final class Tokenizer {
        ...
        public String consumeTokenIfPresent(CharMatcher charMatcher) {
            ...
            if (hasMore()) {
                return this.input.substring(i11, this.position);
            }
            return this.input.substring(i11);
        }
