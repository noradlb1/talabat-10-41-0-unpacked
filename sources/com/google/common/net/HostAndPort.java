...
public final class HostAndPort implements Serializable {
    ...
    private static String[] getHostAndPortFromBracketedHost(String str) {
        ...
        Preconditions.checkArgument(z11, "Bracketed host-port string must start with a bracket: %s", (Object) str);
        ...
        Preconditions.checkArgument(z12, "Invalid bracketed host/port: %s", (Object) str);
        ...
        Preconditions.checkArgument(z13, "Only a colon may follow a close bracket: %s", (Object) str);
