...
public final class ChildVisibilityNotifier$onChildViewDetachedFromWindow$1 extends Lambda implements Function1<VisibilityObserver, Unit> {
    public static final ChildVisibilityNotifier$onChildViewDetachedFromWindow$1 INSTANCE = new ChildVisibilityNotifier$onChildViewDetachedFromWindow$1();

    public ChildVisibilityNotifier$onChildViewDetachedFromWindow$1() {
        super(1);
    }
