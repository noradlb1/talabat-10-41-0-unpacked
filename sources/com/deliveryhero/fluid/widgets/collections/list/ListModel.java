...
public final class ListModel implements CollectionModel<ListCell> {
    ...
    public static /* synthetic */ ListModel copy$default(ListModel listModel, Expression<List<ListCell>> expression, Expression<LogicalPixel> expression2, WidgetModel.BaseProperties baseProperties2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            expression = listModel.getCells();
        }
        if ((i11 & 2) != 0) {
            expression2 = listModel.getCellSpacing();
        }
        if ((i11 & 4) != 0) {
            baseProperties2 = listModel.getBaseProperties();
        }
        return listModel.copy(expression, expression2, baseProperties2);
    }

    @NotNull
    public final Expression<List<ListCell>> component1() {
        return getCells();
    }
    ...
    @NotNull
    public final ListModel copy(@NotNull Expression<List<ListCell>> expression, @NotNull Expression<LogicalPixel> expression2, @NotNull WidgetModel.BaseProperties baseProperties2) {
        Intrinsics.checkNotNullParameter(expression, ComponentMapper.CELLS);
        Intrinsics.checkNotNullParameter(expression2, "cellSpacing");
        Intrinsics.checkNotNullParameter(baseProperties2, "baseProperties");
        return new ListModel(expression, expression2, baseProperties2);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual((Object) getCells(), (Object) listModel.getCells()) && Intrinsics.areEqual((Object) getCellSpacing(), (Object) listModel.getCellSpacing()) && Intrinsics.areEqual((Object) getBaseProperties(), (Object) listModel.getBaseProperties());
    }
    ...
    @NotNull
    public Expression<List<ListCell>> getCells() {
        return this.cells;
    }
    ...
    public String toString() {
        return "ListModel(cells=" + getCells() + ", cellSpacing=" + getCellSpacing() + ", baseProperties=" + getBaseProperties() + ')';
    }
}
