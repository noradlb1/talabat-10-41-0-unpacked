...
public final class HttpAuthInterceptor implements Interceptor {
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) {
        ...
        Request.Builder header = chain.request().newBuilder().header("Authorization", getAuthToken());
