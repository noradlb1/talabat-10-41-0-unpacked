...
public final class RealChatSdk$unregisterDevicePushToken$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Function1<Result<Unit>, Unit> $resultListener;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public RealChatSdk$unregisterDevicePushToken$2(Function1<? super Result<Unit>, Unit> function1) {
        super(0);
