...
public final class RealChatSdk$getChannelUnreadMessagesCount$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ Function1<Result<UnreadChatDetails>, Unit> $resultListener;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public RealChatSdk$getChannelUnreadMessagesCount$1(Function1<? super Result<UnreadChatDetails>, Unit> function1) {
        super(1);
    ...
    public final void invoke(@NotNull Throwable th2) {
        ...
        Function1<Result<UnreadChatDetails>, Unit> function1 = this.$resultListener;
