...
public final class GccChatRepositoryImpl$sendFileMessage$2 extends Lambda implements Function1<Result<? extends Message>, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ GccChatRepositoryImpl f30468g;

    /* renamed from: h  reason: collision with root package name */
    public final /* synthetic */ Function1<BaseMessage, Unit> f30469h;

    /* renamed from: i  reason: collision with root package name */
    public final /* synthetic */ Function2<BaseMessage, Throwable, Unit> f30470i;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GccChatRepositoryImpl$sendFileMessage$2(GccChatRepositoryImpl gccChatRepositoryImpl, Function1<? super BaseMessage, Unit> function1, Function2<? super BaseMessage, ? super Throwable, Unit> function2) {
        super(1);
        this.f30468g = gccChatRepositoryImpl;
        this.f30469h = function1;
        this.f30470i = function2;
    }

    public final void invoke(@NotNull Object obj) {
        Function1<BaseMessage, Unit> function1 = this.f30469h;
        GccChatRepositoryImpl gccChatRepositoryImpl = this.f30468g;
        ...
        Function2<BaseMessage, Throwable, Unit> function2 = this.f30470i;
        GccChatRepositoryImpl gccChatRepositoryImpl2 = this.f30468g;
        ...
        ChatIdlingResource access$getChatIdlingResource$p = this.f30468g.chatIdlingResource;
