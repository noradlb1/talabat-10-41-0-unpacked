...
public final class ModuleProviderKt$serviceModule$1 extends Lambda implements Function1<Module, Unit> {
    public static final ModuleProviderKt$serviceModule$1 INSTANCE = new ModuleProviderKt$serviceModule$1();

    public ModuleProviderKt$serviceModule$1() {
        super(1);
    }
    ...
    public final void invoke(@NotNull Module module) {
        ...
        BeanDefinition beanDefinition = new BeanDefinition(companion.getRootScopeQualifier(), Reflection.getOrCreateKotlinClass(ChatService.class), (Qualifier) null, r11, kind, CollectionsKt__CollectionsKt.emptyList());
        ...
        BeanDefinition beanDefinition2 = new BeanDefinition(companion.getRootScopeQualifier(), Reflection.getOrCreateKotlinClass(ChannelService.class), (Qualifier) null, r16, kind, CollectionsKt__CollectionsKt.emptyList());
        ...
        BeanDefinition beanDefinition3 = new BeanDefinition(companion.getRootScopeQualifier(), Reflection.getOrCreateKotlinClass(ChatPushNotificationParser.class), (Qualifier) null, r162, kind, CollectionsKt__CollectionsKt.emptyList());
