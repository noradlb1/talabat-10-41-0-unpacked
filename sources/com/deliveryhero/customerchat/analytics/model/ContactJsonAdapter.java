...
public final class ContactJsonAdapter extends JsonAdapter<Contact> {
    ...
    public ContactJsonAdapter(@NotNull Moshi moshi) {
    ...
    public String toString() {
        ...
        sb2.append(AppEventsConstants.EVENT_NAME_CONTACT);
        sb2.append(')');
    ...
    @NotNull
    public Contact fromJson(@NotNull JsonReader jsonReader) {
        ...
        if (i11 != -3) {
            ...
            if (constructor == null) {
                constructor = Contact.class.getDeclaredConstructor(new Class[]{String.class, Map.class, Integer.TYPE, Util.DEFAULT_CONSTRUCTOR_MARKER});
    ...
    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable Contact contact) {
