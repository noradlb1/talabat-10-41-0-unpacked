...
public interface CallbackManager {
    ...
    public static final class ActivityResultParameters {
        ...
        public ActivityResultParameters(int i11, int i12, @Nullable Intent intent) {
            this.requestCode = i11;
            this.resultCode = i12;
            this.data = intent;
        }

        public static /* synthetic */ ActivityResultParameters copy$default(ActivityResultParameters activityResultParameters, int i11, int i12, Intent intent, int i13, Object obj) {
            if ((i13 & 1) != 0) {
                i11 = activityResultParameters.requestCode;
            }
            if ((i13 & 2) != 0) {
                i12 = activityResultParameters.resultCode;
            }
            if ((i13 & 4) != 0) {
                intent = activityResultParameters.data;
            }
            return activityResultParameters.copy(i11, i12, intent);
        }
        ...
        @NotNull
        public final ActivityResultParameters copy(int i11, int i12, @Nullable Intent intent) {
            return new ActivityResultParameters(i11, i12, intent);
        }
