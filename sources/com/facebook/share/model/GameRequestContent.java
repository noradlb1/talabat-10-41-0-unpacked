...
public final class GameRequestContent implements ShareModel {
    ...
    public static final class Builder implements ShareModelBuilder<GameRequestContent, Builder> {
        ...
        @NotNull
        public final Builder setActionType(@Nullable ActionType actionType2) {
            this.actionType = actionType2;
            return this;
        }

        public final void setActionType$facebook_common_release(@Nullable ActionType actionType2) {
            this.actionType = actionType2;
        }
        ...
        @NotNull
        public final Builder setFilters(@Nullable Filters filters2) {
            this.filters = filters2;
            return this;
        }

        public final void setFilters$facebook_common_release(@Nullable Filters filters2) {
            this.filters = filters2;
        }
        ...
        public final Builder setTo(@Nullable String str) {
            if (str != null) {
                this.recipients = CollectionsKt___CollectionsKt.toList(StringsKt__StringsKt.split$default((CharSequence) str, new char[]{AbstractJsonLexerKt.COMMA}, false, 0, 6, (Object) null));
            }
            return this;
        }
