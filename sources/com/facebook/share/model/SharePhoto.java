...
public final class SharePhoto extends ShareMedia<SharePhoto, Builder> {
    ...
    public static final class Builder extends ShareMedia.Builder<SharePhoto, Builder> {
        ...
        public static final class Companion {
            ...
            public final void writePhotoListTo$facebook_common_release(@NotNull Parcel parcel, int i11, @NotNull List<SharePhoto> list) {
                Intrinsics.checkNotNullParameter(parcel, "out");
                Intrinsics.checkNotNullParameter(list, "photos");
                Object[] array = list.toArray(new SharePhoto[0]);
                if (array != null) {
                    parcel.writeParcelableArray((Parcelable[]) ((SharePhoto[]) array), i11);
                    return;
                }
        ...
        @NotNull
        public final Builder setBitmap(@Nullable Bitmap bitmap2) {
            this.bitmap = bitmap2;
            return this;
        }
        ...
        @NotNull
        public final Builder setUserGenerated(boolean z11) {
