...
public abstract class ShareMedia<M extends ShareMedia<M, B>, B extends Builder<M, B>> implements ShareModel {
    ...
    public static abstract class Builder<M extends ShareMedia<M, B>, B extends Builder<M, B>> implements ShareModelBuilder<M, B> {
        ...
        public static final class Companion {
            ...
            @JvmStatic
            public final void writeListTo$facebook_common_release(@NotNull Parcel parcel, int i11, @NotNull List<? extends ShareMedia<?, ?>> list) {
        ...
        @JvmStatic
        @NotNull
        public static final List<ShareMedia<?, ?>> readListFrom$facebook_common_release(@NotNull Parcel parcel) {
            return Companion.readListFrom$facebook_common_release(parcel);
        }

        @JvmStatic
        public static final void writeListTo$facebook_common_release(@NotNull Parcel parcel, int i11, @NotNull List<? extends ShareMedia<?, ?>> list) {
            Companion.writeListTo$facebook_common_release(parcel, i11, list);
        }
        ...
        @NotNull
        public B readFrom(@Nullable M m11) {
            return m11 == null ? this : setParameters(m11.params);
        }
    }
