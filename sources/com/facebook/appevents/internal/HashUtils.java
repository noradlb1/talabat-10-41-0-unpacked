...
public final class HashUtils {
    ...
    @JvmStatic
    @Nullable
    public static final String computeChecksumWithPackageManager(@NotNull Context context, @Nullable Long l11) {
        ...
        try {
            ...
            method.invoke(context.getPackageManager(), new Object[]{context.getPackageName(), Boolean.FALSE, obj, CollectionsKt___CollectionsKt.toMutableList(mutableList), newProxyInstance});
            if (l11 == null) {
                newCondition.await();
            } else {
                newCondition.awaitNanos(l11.longValue());
            }
