...
public final class AppEventQueue {
    ...
    public static final void m8880add$lambda3(AccessTokenAppIdPair accessTokenAppIdPair, AppEvent appEvent) {
        Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "$accessTokenAppId");
        Intrinsics.checkNotNullParameter(appEvent, "$appEvent");
    ...
    @JvmStatic
    @Nullable
    public static final GraphRequest buildRequestForSession(@NotNull AccessTokenAppIdPair accessTokenAppIdPair, @NotNull SessionEventsState sessionEventsState, boolean z11, @NotNull FlushStatistics flushStatistics) {
        Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "accessTokenAppId");
    ...
    public static final void m8881buildRequestForSession$lambda4(AccessTokenAppIdPair accessTokenAppIdPair, GraphRequest graphRequest, SessionEventsState sessionEventsState, FlushStatistics flushStatistics, GraphResponse graphResponse) {
        Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "$accessTokenAppId");
    ...
    public static final void m8882flush$lambda2(FlushReason flushReason) {
        Intrinsics.checkNotNullParameter(flushReason, "$reason");
    ...
    public static final void m8883flushRunnable$lambda0() {
    ...
    public static final void handleResponse(@NotNull AccessTokenAppIdPair accessTokenAppIdPair, @NotNull GraphRequest graphRequest, @NotNull GraphResponse graphResponse, @NotNull SessionEventsState sessionEventsState, @NotNull FlushStatistics flushStatistics) {
        ...
        if (flushResult == flushResult2) {
            FacebookSdk.getExecutor().execute(new c(accessTokenAppIdPair, sessionEventsState));
        }
    ...
    public static final void m8884handleResponse$lambda5(AccessTokenAppIdPair accessTokenAppIdPair, SessionEventsState sessionEventsState) {
        Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "$accessTokenAppId");
        Intrinsics.checkNotNullParameter(sessionEventsState, "$appEvents");
    ...
    public static final void m8885persistToDisk$lambda1() {
