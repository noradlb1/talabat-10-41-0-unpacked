...
public final class InstrumentData {
    ...
    public static final class Builder {
        ...
        @JvmStatic
        @NotNull
        public static final InstrumentData build(@Nullable Throwable th2, @NotNull Type type) {
    ...
    public static final class Companion {
        ...
        public final Type getType(String str) {
            if (StringsKt__StringsJVMKt.startsWith$default(str, InstrumentUtility.CRASH_REPORT_PREFIX, false, 2, (Object) null)) {
                return Type.CrashReport;
            }
            if (StringsKt__StringsJVMKt.startsWith$default(str, InstrumentUtility.CRASH_SHIELD_PREFIX, false, 2, (Object) null)) {
                return Type.CrashShield;
            }
            if (StringsKt__StringsJVMKt.startsWith$default(str, InstrumentUtility.THREAD_CHECK_PREFIX, false, 2, (Object) null)) {
                return Type.ThreadCheck;
            }
            if (StringsKt__StringsJVMKt.startsWith$default(str, InstrumentUtility.ANALYSIS_REPORT_PREFIX, false, 2, (Object) null)) {
                return Type.Analysis;
            }
            if (StringsKt__StringsJVMKt.startsWith$default(str, InstrumentUtility.ANR_REPORT_PREFIX, false, 2, (Object) null)) {
    ...
    private final JSONObject getExceptionReportParameters() {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(PARAM_DEVICE_OS, (Object) Build.VERSION.RELEASE);
            jSONObject.put(PARAM_DEVICE_MODEL, (Object) Build.MODEL);
    ...
    private final JSONObject getParameters() {
        ...
        if (type2 == null) {
            ...
            i11 = WhenMappings.$EnumSwitchMapping$0[type2.ordinal()];
        }
        if (i11 == 1) {
    ...
    public final boolean isValid() {
        ...
        if (i11 != 1) {
            if (i11 != 2) {
                if (!(i11 == 3 || i11 == 4 || i11 == 5) || this.stackTrace == null || this.timestamp == null) {
                    return false;
                }
    ...
    public String toString() {
        ...
        String jSONObjectInstrumentation2 = JSONObjectInstrumentation.toString(parameters);
    ...
    private InstrumentData(File file) {
        ...
        this.filename = name2;
        this.type = Companion.getType(name2);
        InstrumentUtility instrumentUtility = InstrumentUtility.INSTANCE;
