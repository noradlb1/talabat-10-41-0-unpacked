...
public final class ServerProtocol {
    ...
    @JvmStatic
    @Nullable
    public static final Bundle getQueryParamsForPlatformActivityIntentWebFallback(@NotNull String str, int i11, @Nullable Bundle bundle) {
        Intrinsics.checkNotNullParameter(str, FailedBinderCallBack.CALLER_ID);
        ...
        try {
            ...
            if (convertToJSON != null) {
                if (convertToJSON2 != null) {
                    bundle2.putString(FALLBACK_DIALOG_PARAM_BRIDGE_ARGS, JSONObjectInstrumentation.toString(convertToJSON));
                    bundle2.putString(FALLBACK_DIALOG_PARAM_METHOD_ARGS, JSONObjectInstrumentation.toString(convertToJSON2));
                    return bundle2;
                }
            }
            return null;
            ...
            companion.log(loggingBehavior, 6, str2, Intrinsics.stringPlus("Error creating Url -- ", e11));
            return null;
            ...
            companion2.log(loggingBehavior2, 6, str3, Intrinsics.stringPlus("Error creating Url -- ", e12));
            return null;
        }
    }
}
