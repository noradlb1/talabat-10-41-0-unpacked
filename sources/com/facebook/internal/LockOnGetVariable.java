...
public final class LockOnGetVariable<T> {
    ...
    public LockOnGetVariable(T t11) {
        this.storedValue = t11;
    }

    /* access modifiers changed from: private */
    /* renamed from: _init_$lambda-0  reason: not valid java name */
    public static final Void m8960_init_$lambda0(LockOnGetVariable lockOnGetVariable, Callable callable) {
    ...
    public LockOnGetVariable(@NotNull Callable<T> callable) {
        Intrinsics.checkNotNullParameter(callable, "callable");
        this.initLatch = new CountDownLatch(1);
        FacebookSdk.getExecutor().execute(new FutureTask(new m(this, callable)));
    }
}
