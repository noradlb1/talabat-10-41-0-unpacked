...
public final class CallbackManagerImpl implements CallbackManager {
    ...
    public interface Callback {
        boolean onActivityResult(int i11, @Nullable Intent intent);
    }
    ...
    public static final class Companion {
        ...
        @JvmStatic
        private final synchronized Callback getStaticCallback(int i11) {
            return (Callback) CallbackManagerImpl.staticCallbacks.get(Integer.valueOf(i11));
        }

        /* access modifiers changed from: private */
        @JvmStatic
        public final boolean runStaticCallback(int i11, int i12, Intent intent) {
            Callback staticCallback = getStaticCallback(i11);
        ...
        @JvmStatic
        public final synchronized void registerStaticCallback(int i11, @NotNull Callback callback) {
    ...
    public static final synchronized void registerStaticCallback(int i11, @NotNull Callback callback) {
        synchronized (CallbackManagerImpl.class) {
            Companion.registerStaticCallback(i11, callback);
        }
    }
    ...
    public boolean onActivityResult(int i11, int i12, @Nullable Intent intent) {
        ...
        if (callback == null) {
            return Companion.runStaticCallback(i11, i12, intent);
        }
        return callback.onActivityResult(i12, intent);
    }

    public final void registerCallback(int i11, @NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        this.callbacks.put(Integer.valueOf(i11), callback);
    }

    public final void unregisterCallback(int i11) {
