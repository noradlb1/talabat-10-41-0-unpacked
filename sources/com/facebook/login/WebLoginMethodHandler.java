...
public abstract class WebLoginMethodHandler extends LoginMethodHandler {
    ...
    public Bundle addExtraParameters(@NotNull Bundle bundle, @NotNull LoginClient.Request request) {
        ...
        bundle.putString(ServerProtocol.DIALOG_PARAM_SDK_VERSION, Intrinsics.stringPlus("android-", FacebookSdk.getSdkVersion()));
    ...
    public void onComplete(@NotNull LoginClient.Request request, @Nullable Bundle bundle, @Nullable FacebookException facebookException) {
        ...
        if (bundle != null) {
            ...
            try {
                ...
                result = LoginClient.Result.Companion.createErrorResult$default(LoginClient.Result.Companion, loginClient.getPendingRequest(), (String) null, e11.getMessage(), (String) null, 8, (Object) null);
            }
