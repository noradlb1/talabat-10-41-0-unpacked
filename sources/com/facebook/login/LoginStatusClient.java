...
public final class LoginStatusClient extends PlatformServiceClient {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final LoginStatusClient newInstance$facebook_common_release(@NotNull Context context, @NotNull String str, @NotNull String str2, @NotNull String str3, long j11, @Nullable String str4) {
            Intrinsics.checkNotNullParameter(context, "context");
            Intrinsics.checkNotNullParameter(str, "applicationId");
            Intrinsics.checkNotNullParameter(str2, "loggerRef");
            Intrinsics.checkNotNullParameter(str3, "graphApiVersion");
            return new LoginStatusClient(context, str, str2, str3, j11, str4);
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LoginStatusClient(@NotNull Context context, @NotNull String str, @NotNull String str2, @NotNull String str3, long j11, @Nullable String str4) {
