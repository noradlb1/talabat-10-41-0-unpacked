...
public final class LoginResult {
    ...
    @JvmOverloads
    public LoginResult(@NotNull AccessToken accessToken2, @Nullable AuthenticationToken authenticationToken2, @NotNull Set<String> set, @NotNull Set<String> set2) {
    ...
    @JvmOverloads
    public LoginResult(@NotNull AccessToken accessToken2, @NotNull Set<String> set, @NotNull Set<String> set2) {
    ...
    public static /* synthetic */ LoginResult copy$default(LoginResult loginResult, AccessToken accessToken2, AuthenticationToken authenticationToken2, Set<String> set, Set<String> set2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    @NotNull
    public final LoginResult copy(@NotNull AccessToken accessToken2, @Nullable AuthenticationToken authenticationToken2, @NotNull Set<String> set, @NotNull Set<String> set2) {
        Intrinsics.checkNotNullParameter(accessToken2, "accessToken");
        Intrinsics.checkNotNullParameter(set, "recentlyGrantedPermissions");
        Intrinsics.checkNotNullParameter(set2, "recentlyDeniedPermissions");
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ LoginResult(AccessToken accessToken2, AuthenticationToken authenticationToken2, Set set, Set set2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(accessToken2, (i11 & 2) != 0 ? null : authenticationToken2, set, set2);
    }
}
