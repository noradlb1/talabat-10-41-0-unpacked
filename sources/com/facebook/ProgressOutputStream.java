...
public final class ProgressOutputStream extends FilterOutputStream implements RequestOutputStream {
    ...
    public ProgressOutputStream(@NotNull OutputStream outputStream, @NotNull GraphRequestBatch graphRequestBatch, @NotNull Map<GraphRequest, RequestProgress> map, long j11) {
        super(outputStream);
    ...
    private final void addProgress(long j11) {
            ...
            for (GraphRequestBatch.Callback next : this.requests.getCallbacks()) {
                if (next instanceof GraphRequestBatch.OnProgressCallback) {
                    ...
                    if (callbackHandler == null) {
                        ...
                        bool = Boolean.valueOf(callbackHandler.post(new r(next, this)));
                    }
                    if (bool == null) {
    ...
    public static final void m8874reportBatchProgress$lambda0(GraphRequestBatch.Callback callback, ProgressOutputStream progressOutputStream) {
