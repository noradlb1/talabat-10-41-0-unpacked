...
public final class BrazePlugin$onMethodCall$22 extends Lambda implements Function1<BrazeUser, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ String f43628g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BrazePlugin$onMethodCall$22(String str) {
        super(1);
        this.f43628g = str;
    }
    ...
    public final void invoke(@NotNull BrazeUser brazeUser) {
        ...
        brazeUser.setCountry(this.f43628g);
    }
}
