...
public final class BrazePlugin$onMethodCall$21 extends Lambda implements Function1<BrazeUser, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ String f43627g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BrazePlugin$onMethodCall$21(String str) {
        super(1);
        this.f43627g = str;
    }
    ...
    public final void invoke(@NotNull BrazeUser brazeUser) {
        ...
        brazeUser.setLanguage(this.f43627g);
    }
}
