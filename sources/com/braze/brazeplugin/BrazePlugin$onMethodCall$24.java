...
public final class BrazePlugin$onMethodCall$24 extends Lambda implements Function1<BrazeUser, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ String f43630g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BrazePlugin$onMethodCall$24(String str) {
        super(1);
        this.f43630g = str;
    }
    ...
    public final void invoke(@NotNull BrazeUser brazeUser) {
        ...
        brazeUser.setPhoneNumber(this.f43630g);
    }
}
