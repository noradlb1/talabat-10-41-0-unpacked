...
public final class BrazePlugin$onMethodCall$19 extends Lambda implements Function1<BrazeUser, Unit> {

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ String f43623g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BrazePlugin$onMethodCall$19(String str) {
        super(1);
        this.f43623g = str;
    }
    ...
    public final void invoke(@NotNull BrazeUser brazeUser) {
        ...
        brazeUser.setEmail(this.f43623g);
    }
}
