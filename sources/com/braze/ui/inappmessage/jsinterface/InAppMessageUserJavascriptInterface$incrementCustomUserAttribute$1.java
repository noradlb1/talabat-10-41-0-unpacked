...
public final class InAppMessageUserJavascriptInterface$incrementCustomUserAttribute$1 extends Lambda implements Function1<BrazeUser, Unit> {
    ...
    public final void invoke(@NotNull BrazeUser brazeUser) {
        ...
        BrazeUser.incrementCustomUserAttribute$default(brazeUser, this.f44104g, 0, 2, (Object) null);
    }
}
