...
public final class InAppMessageUserJavascriptInterface$setLanguage$1 extends Lambda implements Function1<BrazeUser, Unit> {
    ...
    public final void invoke(@NotNull BrazeUser brazeUser) {
        ...
        brazeUser.setLanguage(this.f44133g);
    }
}
