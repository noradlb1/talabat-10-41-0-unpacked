...
public final class InAppMessageUserJavascriptInterface$setCountry$1 extends Lambda implements Function1<BrazeUser, Unit> {
    ...
    public final void invoke(@NotNull BrazeUser brazeUser) {
        ...
        brazeUser.setCountry(this.f44108g);
    }
}
