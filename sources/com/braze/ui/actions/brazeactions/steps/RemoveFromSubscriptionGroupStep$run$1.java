...
public final class RemoveFromSubscriptionGroupStep$run$1 extends Lambda implements Function1<BrazeUser, Unit> {
    ...
    public final void invoke(@NotNull BrazeUser brazeUser) {
        ...
        brazeUser.removeFromSubscriptionGroup(this.f44033g);
    }
}
