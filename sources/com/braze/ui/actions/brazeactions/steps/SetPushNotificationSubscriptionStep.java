...
public final class SetPushNotificationSubscriptionStep extends BaseBrazeActionStep {
    ...
    public void run(@NotNull Context context, @NotNull StepData stepData) {
        ...
        if (fromValue == null) {
            BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, (Object) this, (BrazeLogger.Priority) null, (Throwable) null, false, (Function0) new SetPushNotificationSubscriptionStep$run$1(stepData), 7, (Object) null);
            return;
        }
