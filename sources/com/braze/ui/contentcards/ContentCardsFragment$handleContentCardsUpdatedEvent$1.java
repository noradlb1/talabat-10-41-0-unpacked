...
public final class ContentCardsFragment$handleContentCardsUpdatedEvent$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final /* synthetic */ ContentCardsFragment f44057i;

    /* renamed from: j  reason: collision with root package name */
    public final /* synthetic */ ContentCardsUpdatedEvent f44058j;
    ...
    public ContentCardsFragment$handleContentCardsUpdatedEvent$1(ContentCardsFragment contentCardsFragment, ContentCardsUpdatedEvent contentCardsUpdatedEvent, Continuation<? super ContentCardsFragment$handleContentCardsUpdatedEvent$1> continuation) {
        ...
        this.f44057i = contentCardsFragment;
        this.f44058j = contentCardsUpdatedEvent;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new ContentCardsFragment$handleContentCardsUpdatedEvent$1(this.f44057i, this.f44058j, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        int i11 = this.f44056h;
        if (i11 == 0) {
            ResultKt.throwOnFailure(obj);
            ContentCardsFragment contentCardsFragment = this.f44057i;
            ContentCardsUpdatedEvent contentCardsUpdatedEvent = this.f44058j;
            this.f44056h = 1;
