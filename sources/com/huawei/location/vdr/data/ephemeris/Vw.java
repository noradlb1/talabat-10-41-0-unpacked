...
public class Vw {
    ...
    public String toString() {
        return String.format(Locale.ENGLISH, "weekRound: %d weekNumber = %d weekSecond: %d", new Object[]{Integer.valueOf(this.f50286yn), Integer.valueOf(this.Vw), Integer.valueOf(this.FB)});
    }
