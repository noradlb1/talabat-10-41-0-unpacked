...
public class BdsTim {
    ...
    public static final class Builder {
        ...
        public double f50407a0;

        /* renamed from: a1  reason: collision with root package name */
        public double f50408a1;

        /* renamed from: a2  reason: collision with root package name */
        public double f50409a2;
        public int deltaT;
        public int gnssToId;
        ...
        public BdsTim build() {
            ...
            double unused = bdsTim.mA0 = this.f50407a0;
            int unused2 = bdsTim.mWeekSecond = this.weekSecond;
            double unused3 = bdsTim.mA2 = this.f50409a2;
            ...
            double unused7 = bdsTim.mA1 = this.f50408a1;
            return bdsTim;
        }

        public Builder but() {
            return aBdsTim().withWeekSecond(this.weekSecond).withWeekNumber(this.weekNumber).withA0(this.f50407a0).withA1(this.f50408a1).withA2(this.f50409a2).withGnssToId(this.gnssToId).withDeltaT(this.deltaT);
        }
