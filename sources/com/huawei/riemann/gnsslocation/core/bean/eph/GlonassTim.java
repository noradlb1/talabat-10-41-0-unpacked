...
public class GlonassTim {
    ...
    public static final class Builder {
        ...
        public double f50327a0;

        /* renamed from: a1  reason: collision with root package name */
        public double f50328a1;

        /* renamed from: a2  reason: collision with root package name */
        public double f50329a2;
        public int gnssToId;
        ...
        public GlonassTim build() {
            ...
            double unused4 = glonassTim.mA1 = this.f50328a1;
            double unused5 = glonassTim.mA0 = this.f50327a0;
            double unused6 = glonassTim.mA2 = this.f50329a2;
            return glonassTim;
        }

        public Builder but() {
            return aGlonassTim().withWeekSecond(this.weekSecond).withWeekNumber(this.weekNumber).withA0(this.f50327a0).withA1(this.f50328a1).withA2(this.f50329a2).withGnssToId(this.gnssToId);
        }
