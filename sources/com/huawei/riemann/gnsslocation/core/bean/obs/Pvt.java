...
public class Pvt {
    ...
    public String toString() {
        return "Pvt{mErrCode=" + this.mErrCode + ", mLatitude=" + this.mLatitude + ", mLongitude=" + this.mLongitude + ", mAltitude=" + this.mAltitude + ", mSpeed=" + this.mSpeed + ", mAccuracy=" + this.mAccuracy + ", mBearing=" + this.mBearing + ", mTime=" + this.mTime + AbstractJsonLexerKt.END_OBJ;
    }
}
