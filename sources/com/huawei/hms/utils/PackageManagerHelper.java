...
public class PackageManagerHelper {
    ...
    private final PackageManager f49962a;
    ...
    public PackageManagerHelper(Context context) {
        this.f49962a = context.getPackageManager();
    }

    private byte[] a(String str) {
        Signature[] signatureArr;
        try {
            PackageInfo packageInfo = this.f49962a.getPackageInfo(str, 64);
    ...
    public String getApplicationName(String str) {
        try {
            return this.f49962a.getApplicationLabel(this.f49962a.getApplicationInfo(str, 128)).toString();
    ...
    public long getPackageFirstInstallTime(String str) {
        try {
            PackageInfo packageInfo = this.f49962a.getPackageInfo(str, 128);
            if (packageInfo != null) {
    ...
    public java.lang.String getPackageSigningCertificate(java.lang.String r8) {
        ...
        L_0x000d:
            r1 = 0
            android.content.pm.PackageManager r2 = r7.f49962a     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            r3 = 134217728(0x8000000, float:3.85186E-34)
            android.content.pm.PackageInfo r8 = r2.getPackageInfo(r8, r3)     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            r2 = 2
            java.lang.Object[] r3 = new java.lang.Object[r2]     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            r4 = 0
            r3[r4] = r8     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            android.content.pm.SigningInfo r5 = r8.signingInfo     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            r6 = 1
            r3[r6] = r5     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            boolean r3 = com.huawei.hms.common.internal.Objects.isNull(r3)     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            if (r3 == 0) goto L_0x002f
            java.lang.String r8 = "packageInfo or packageInfo.signingInfo is null"
            com.huawei.hms.support.log.HMSLog.e(r0, r8)     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            return r1
        L_0x002f:
            android.content.pm.SigningInfo r8 = r8.signingInfo     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            android.content.pm.Signature[] r8 = r8.getApkContentsSigners()     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            r2[r4] = r8     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            r3 = r8[r4]     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            r2[r6] = r3     // Catch:{ AndroidException | RuntimeException -> 0x005a }
            boolean r2 = com.huawei.hms.common.internal.Objects.isNull(r2)     // Catch:{ AndroidException | RuntimeException -> 0x005a }
    ...
    public PackageStates getPackageStates(String str) {
        ...
        try {
            if (this.f49962a.getApplicationInfo(str, 128).enabled) {
    ...
    public int getPackageVersionCode(String str) {
        try {
            PackageInfo packageInfo = this.f49962a.getPackageInfo(str, 16);
            if (packageInfo != null) {
    ...
    public boolean hasProvider(String str, String str2) {
        ...
        try {
            PackageInfo packageInfo = this.f49962a.getPackageInfo(str, 8);
    ...
    public boolean verifyPackageArchive(java.lang.String r5, java.lang.String r6, java.lang.String r7) {
        /*
            ...
            java.lang.String r0 = "PackageManagerHelper"
            r1 = 0
            android.content.pm.PackageManager r2 = r4.f49962a     // Catch:{ Exception -> 0x000c }
            r3 = 64
