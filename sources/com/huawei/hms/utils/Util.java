...
public class Util {
    ...
    private static boolean f49977a = false;

    /* renamed from: b  reason: collision with root package name */
    private static boolean f49978b = false;

    /* renamed from: c  reason: collision with root package name */
    private static final Object f49979c = new Object();

    /* renamed from: d  reason: collision with root package name */
    private static String f49980d;
    ...
    public static String getProductCountry() {
        ...
        if (!TextUtils.isEmpty(systemProperties2) && (lastIndexOf = systemProperties2.lastIndexOf(SideMenuRewardViewHolder.DEFAULT_LOGGED_IN_USER_POINTS_VALUE)) != -1) {
    ...
    public static String getServiceActionMetadata(Context context) {
        ...
        if (resolveInfo != null) {
            f49980d = PackageConstants.INTERNAL_SERVICES_ACTION;
    ...
    public static boolean isAvailableLibExist(Context context) {
        ...
        synchronized (f49979c) {
            if (!f49977a) {
                ...
                if (packageManager == null) {
                    ...
                    try {
                        ApplicationInfo applicationInfo = packageManager.getPackageInfo(context.getPackageName(), 128).applicationInfo;
                        if (!(applicationInfo == null || (bundle = applicationInfo.metaData) == null || (obj = bundle.get("availableLoaded")) == null || !String.valueOf(obj).equalsIgnoreCase(UserStatusRepositoryImplKt.KEY_CALL_INVOKED))) {
        ...
        HMSLog.i("Util", "available exist: " + f49978b);
        return f49978b;
    }
