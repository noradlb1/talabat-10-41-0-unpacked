...
public class JsonUtil {
    ...
    public static com.huawei.hms.core.aidl.IMessageEntity jsonToEntity(java.lang.String r8, com.huawei.hms.core.aidl.IMessageEntity r9) {
        ...
        L_0x0006:
            ...
            r2.<init>((java.lang.String) r8)     // Catch:{ JSONException -> 0x004f }
        L_0x000f:
    ...
    private static boolean a(String str, Object obj, JSONObject jSONObject) throws JSONException, IllegalAccessException {
        if (obj instanceof String) {
            jSONObject.put(str, (Object) (String) obj);
            return true;
        } else if (obj instanceof Integer) {
            jSONObject.put(str, ((Integer) obj).intValue());
            return true;
        } else if (obj instanceof Short) {
            jSONObject.put(str, (Object) (Short) obj);
            return true;
        } else if (obj instanceof Long) {
            jSONObject.put(str, (Object) (Long) obj);
            return true;
        } else if (obj instanceof Float) {
            jSONObject.put(str, (Object) (Float) obj);
            return true;
        } else if (obj instanceof Double) {
            jSONObject.put(str, (Object) (Double) obj);
            return true;
        } else if (obj instanceof Boolean) {
            jSONObject.put(str, (Object) (Boolean) obj);
            return true;
        } else if (obj instanceof JSONObject) {
            jSONObject.put(str, (Object) (JSONObject) obj);
            return true;
            ...
            if (obj instanceof IMessageEntity) {
                try {
                    jSONObject.put(str, (Object) a((IMessageEntity) obj));
                    return true;
                } catch (IllegalAccessException e11) {
    ...
    private static void a(String str, Map map, JSONObject jSONObject) throws JSONException, IllegalAccessException {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            if (key instanceof IMessageEntity) {
                jSONArray.put((Object) a((IMessageEntity) key));
            } else {
                jSONArray.put(key);
            }
            if (value instanceof IMessageEntity) {
                jSONArray.put((Object) a((IMessageEntity) value));
            } else {
                jSONArray.put(value);
            }
        }
        ...
        jSONObject2.put("_map_", (Object) JSONArrayInstrumentation.toString(jSONArray));
    ...
    private static void a(String str, byte[] bArr, JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject2.put("_byte_", (Object) Base64.encode(bArr));
