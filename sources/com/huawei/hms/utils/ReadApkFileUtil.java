...
public class ReadApkFileUtil {
    ...
    private static final String f49964a = "ReadApkFileUtil";

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f49965b = Pattern.compile("\\s*|\t|\r|\n");

    /* renamed from: c  reason: collision with root package name */
    private static String f49966c;

    /* renamed from: d  reason: collision with root package name */
    private static String f49967d;

    /* renamed from: e  reason: collision with root package name */
    private static String f49968e;

    /* renamed from: f  reason: collision with root package name */
    private static String f49969f = null;

    /* renamed from: g  reason: collision with root package name */
    private static String f49970g = null;
    ...
    private static void b(byte[] r5) {
        ...
        L_0x002b:
            ...
            f49969f = r3     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
        L_0x004d:
            ...
            f49966c = r1     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            java.lang.String r1 = a((java.io.BufferedReader) r5)     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            goto L_0x002b
        L_0x006a:
            ...
            java.lang.String r1 = r1.substring(r3)     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            java.lang.String r1 = a((java.lang.String) r1)     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            f49967d = r1     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            java.lang.String r1 = a((java.io.BufferedReader) r5)     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            goto L_0x002b
        L_0x0087:
            ...
            java.lang.String r1 = r1.substring(r3)     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            java.lang.String r1 = a((java.lang.String) r1)     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            f49968e = r1     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            java.lang.String r1 = a((java.io.BufferedReader) r5)     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            goto L_0x002b
        L_0x00a4:
        ...
        L_0x00b2:
            ...
            f49970g = r0     // Catch:{ Exception -> 0x00bb, all -> 0x00b9 }
            goto L_0x00cd
        L_0x00b9:
            r0 = move-exception
            goto L_0x00d9
        ...
        L_0x00c4:
            r2 = r1
        L_0x00c5:
            java.lang.String r5 = f49964a     // Catch:{ all -> 0x00d4 }
    ...
    public static String bytesToString(byte[] bArr) {
        ...
        char[] cArr = {'0', ExpiryDateConstantsKt.EXPIRY_DATE_ZERO_POSITION_CHECK, '2', '3', '4', '5', '6', '7', '8', '9', 'a', 'b', 'c', Advice.OffsetMapping.ForOrigin.Renderer.ForDescriptor.SYMBOL, 'e', 'f'};
    ...
    private static boolean c() {
        try {
            if (a(Base64.decode(EMUI11_PK, 0), a(f49970g, "SHA-384"), b(f49968e), "SHA384withRSA")) {
                HMSLog.i(f49964a, "verifyMDMSignatureV3 verify successful!");
                return true;
            }
            HMSLog.i(f49964a, "verifyMDMSignatureV3 verify failure!");
            return false;
        } catch (Exception e11) {
            String str = f49964a;
    ...
    public static String getHmsPath(Context context) {
        try {
            ...
            HMSLog.e(f49964a, "HMS is not found!");
            return null;
        }
    }
    ...
    public static boolean isCertFound(java.lang.String r6) {
        ...
        L_0x0043:
            r6 = move-exception
        L_0x0044:
            java.lang.String r0 = f49964a     // Catch:{ all -> 0x0041 }
    ...
    public static boolean verifyApkHash(java.lang.String r5) {
        ...
        L_0x0016:
            ...
            java.lang.String r1 = f49969f     // Catch:{ Exception -> 0x0070, all -> 0x006e }
        ...
        L_0x0075:
            r5 = move-exception
        L_0x0076:
            java.lang.String r2 = f49964a     // Catch:{ all -> 0x0073 }
    ...
    private static byte[] a(java.util.zip.ZipFile r7, java.lang.String r8) {
        ...
        L_0x0074:
            r4 = r3
        L_0x0075:
            java.lang.String r2 = f49964a     // Catch:{ all -> 0x009c }
    ...
    private static ArrayList<String> a(byte[] bArr) {
        ...
        if (bArr == null) {
            HMSLog.e(f49964a, "manifest is null！");
            return null;
        }
        ...
        try {
            ...
            HMSLog.e(f49964a, "getManifestLinesArrary IOException!");
            return null;
        } catch (Throwable th3) {
    ...
    private static boolean b() {
        try {
            if (a(Base64.decode(EMUI10_PK, 0), a(f49970g, Constants.SHA256), b(f49967d), OidcSecurityUtil.SIGNATURE_ALGORITHM_SHA256)) {
                HMSLog.i(f49964a, "verifyMDMSignatureV2 verify successful!");
                return true;
            }
            HMSLog.i(f49964a, "verifyMDMSignatureV2 verify failure!");
            return false;
        } catch (Exception e11) {
            String str = f49964a;
    ...
    private static byte[] a(ArrayList<String> arrayList) {
        ...
        try {
            ...
            HMSLog.i(f49964a, "getManifestBytesbySorted Exception!" + e11.getMessage());
        } catch (Throwable th2) {
    ...
    private static String a(String str) {
        if (str != null) {
            return f49965b.matcher(str).replaceAll("");
        }
        return "";
    }
}
