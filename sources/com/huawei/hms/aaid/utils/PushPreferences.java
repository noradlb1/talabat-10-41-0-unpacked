...
public class PushPreferences {
    ...
    protected SharedPreferences f47735a;
    ...
    public PushPreferences(Context context, String str) {
        if (context != null) {
            ...
            if (b11 == null) {
                ...
                this.f47735a = context.getSharedPreferences(str, 0);
                return;
            }
            return;
        }
    ...
    public boolean clear() {
        SharedPreferences sharedPreferences = this.f47735a;
    ...
    public boolean removeKey(String str) {
        ...
        SharedPreferences sharedPreferences = this.f47735a;
        if (sharedPreferences == null || !sharedPreferences.contains(str) || (edit = this.f47735a.edit()) == null) {
            return false;
        }
    ...
    public boolean write(ContentValues contentValues) {
        if (this.f47735a == null || contentValues == null) {
            return false;
        }
        boolean z11 = true;
    ...
    public boolean removeKey(String[] strArr) {
        ...
        for (String str : strArr) {
            if (this.f47735a.contains(str)) {
                this.f47735a.edit().remove(str);
            }
        }
        this.f47735a.edit().commit();
        return true;
    }
}
