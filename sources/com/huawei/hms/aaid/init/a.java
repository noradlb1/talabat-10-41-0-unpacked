...
public class a implements Runnable {
    ...
    public void run() {
        /*
            ...
            r3 = 0
            android.content.Context r4 = r8.f47733a     // Catch:{ ApiException -> 0x0027 }
            com.huawei.hms.aaid.HmsInstanceId r4 = com.huawei.hms.aaid.HmsInstanceId.getInstance(r4)     // Catch:{ ApiException -> 0x0027 }
            android.content.Context r5 = r8.f47733a     // Catch:{ ApiException -> 0x0027 }
        ...
        L_0x0031:
            android.content.Context r4 = r8.f47733a     // Catch:{ NameNotFoundException -> 0x008c }
            android.content.pm.PackageManager r4 = r4.getPackageManager()     // Catch:{ NameNotFoundException -> 0x008c }
            android.content.Context r5 = r8.f47733a     // Catch:{ NameNotFoundException -> 0x008c }
            ...
            com.huawei.hms.opendevice.l r2 = new com.huawei.hms.opendevice.l     // Catch:{ NameNotFoundException -> 0x008c }
            r2.<init>()     // Catch:{ NameNotFoundException -> 0x008c }
            android.content.Context r3 = r8.f47733a     // Catch:{ NameNotFoundException -> 0x008c }
