...
public class i extends PushPreferences {
    ...
    private static final String f49649c = "i";

    /* renamed from: b  reason: collision with root package name */
    private Context f49650b;
    ...
    public String a(String str) {
        ...
        try {
            return PushEncrypter.decrypter(this.f49650b, getString(str));
        } catch (Exception e11) {
            String str2 = f49649c;
            HMSLog.e(str2, "getSecureData" + e11.getMessage());
            return "";
    ...
    public boolean a(String str, String str2) {
        ...
        try {
            return saveString(str, PushEncrypter.encrypter(this.f49650b, str2));
        } catch (Exception e11) {
            String str3 = f49649c;
