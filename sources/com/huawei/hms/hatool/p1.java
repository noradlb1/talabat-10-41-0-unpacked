...
public class p1 {
    ...
    private static String a(String str, int i11) {
        ...
        for (int i12 = 1; i12 < i11; i12++) {
            stringBuffer.append(RealDiscoveryConfigurationRepository.VERSION_DELIMETER);
    ...
    public static boolean a(String str, String str2, int i11) {
        ...
        if (TextUtils.isEmpty(a11) || TextUtils.isEmpty(str2)) {
            ...
            } else if (str2.equals(SHA.sha256Encrypt(a11))) {
                return true;
            } else {
                if (!str2.equals(SHA.sha256Encrypt(a12))) {
                    return false;
                }
                try {
    ...
    public static boolean b(String str) {
        if (p.f49092a.booleanValue()) {
            return true;
        }
        for (String a11 : f49100a) {
            if (a(str, a11, 2)) {
                return true;
            }
        }
