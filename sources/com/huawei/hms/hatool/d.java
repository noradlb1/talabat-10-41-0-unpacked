...
public class d {
    ...
    public static String c(Context context, String str) {
        ...
        if (TextUtils.isEmpty(n11)) {
            return "hms_" + str + JavaConstant.Dynamic.DEFAULT_NAME + packageName;
        }
        return "hms_" + str + JavaConstant.Dynamic.DEFAULT_NAME + packageName + JavaConstant.Dynamic.DEFAULT_NAME + n11;
    }
}
