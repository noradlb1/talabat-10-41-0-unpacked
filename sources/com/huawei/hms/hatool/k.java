...
public class k extends u0 {
    ...
    public static f0 a(String str, String str2, String str3, String str4) {
        ...
        String sha256Encrypt = SHA.sha256Encrypt(q0.f() + a12 + currentTimeMillis);
    ...
    public static l a(String str, String str2) {
        ...
        int i11 = a.f49053a[c11.a().ordinal()];
        if (i11 == 1) {
            a11.d(c11.b());
        } else if (i11 == 2) {
            a11.b(c11.b());
