...
@Instrumented
public class BridgeActivity extends Activity implements TraceFieldInterface {
    ...
    private static final int f47736b = a("ro.build.hw_emui_api_level", 0);
    public Trace _nr_trace;

    /* renamed from: a  reason: collision with root package name */
    private IBridgeActivityDelegate f47737a;

    public class a implements View.OnApplyWindowInsetsListener {

        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ ViewGroup f47738a;

        public a(ViewGroup viewGroup) {
            this.f47738a = viewGroup;
        }
        ...
        public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
            try {
                ...
                if (invoke == null) {
                    ...
                    ViewGroup viewGroup = this.f47738a;
                    if (viewGroup != null) {
    ...
    private boolean b() {
        ...
        try {
            ...
            if (stringExtra != null) {
                ...
                this.f47737a = iBridgeActivityDelegate;
                try {
    ...
    public void onActivityResult(int i11, int i12, Intent intent) {
        ...
        IBridgeActivityDelegate iBridgeActivityDelegate = this.f47737a;
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            TraceMachine.enterMethod(this._nr_trace, "BridgeActivity#onCreate", (ArrayList<String>) null);
        } catch (NoSuchFieldError unused) {
            TraceMachine.enterMethod((Trace) null, "BridgeActivity#onCreate", (ArrayList<String>) null);
        }
