...
public class UpdateAdapter implements IBridgeActivityDelegate {
    ...
    private WeakReference<Activity> f47821a;
    ...
    private Activity b() {
        WeakReference<Activity> weakReference = this.f47821a;
    ...
    public static Object invokeMethod(String str, String str2, Object[] objArr) {
        try {
            ...
            HMSLog.e("UpdateAdapter", "invoke " + str + RealDiscoveryConfigurationRepository.VERSION_DELIMETER + str2 + " fail. " + th2.getMessage());
            return null;
        }
    }
    ...
    public void onBridgeActivityCreate(Activity activity) {
        if (activity == null) {
            ...
            this.f47822b = activity.getApplicationContext();
            this.f47821a = new WeakReference<>(activity);
            if (c.f48065b.a(b())) {
                ...
                try {
                    this.f47823c = intent.getIntExtra(CommonCode.MapKey.UPDATE_VERSION, 0);
                } catch (Throwable th2) {
                ...
                if (!a(intent, activity)) {
                    try {
                        if (AvailableUtil.isInstallerLibExist(this.f47822b)) {
                            UpdateBean updateBean = (UpdateBean) a("com.huawei.hms.adapter.ui.InstallerAdapter", "setUpdateBean", new Object[]{activity, Integer.valueOf(this.f47823c), Boolean.valueOf(this.f47825e)});
                            this.f47824d = updateBean;
    ...
    public boolean onBridgeActivityResult(int i11, int i12, Intent intent) {
        ...
        if (AvailableUtil.isInstallerLibExist(this.f47822b) && i12 == 1214) {
            ...
            invokeMethod("com.huawei.hms.update.manager.UpdateManager", "startUpdate", new Object[]{b11, 1001, this.f47824d});
            this.f47824d = null;
        }
        if (i12 == -1) {
            if (intent != null) {
            ...
            if (this.f47825e || a((Context) b12, hMSPackageName, this.f47823c)) {
