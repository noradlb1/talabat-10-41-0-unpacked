...
public class HiAnalyticsUtil {
    ...
    private static final Object f49848a = new Object();

    /* renamed from: b  reason: collision with root package name */
    private static HiAnalyticsUtil f49849b;

    /* renamed from: c  reason: collision with root package name */
    private static HiAnalyticsUtils f49850c;
    ...
    public static HiAnalyticsUtil getInstance() {
        ...
        synchronized (f49848a) {
            if (f49849b == null) {
                f49849b = new HiAnalyticsUtil();
                f49850c = HiAnalyticsUtils.getInstance();
            }
            hiAnalyticsUtil = f49849b;
        }
    ...
    public void onBuoyEvent(Context context, String str, String str2) {
        f49850c.onBuoyEvent(context, str, str2);
    }

    public void onEvent(Context context, String str, Map<String, String> map) {
        f49850c.onEvent(context, str, map);
    }

    public void onEvent2(Context context, String str, String str2) {
        f49850c.onEvent2(context, str, str2);
    }

    public void onNewEvent(Context context, String str, Map map) {
        f49850c.onNewEvent(context, str, map);
    }
    ...
    public boolean hasError(Context context) {
        return f49850c.hasError(context);
    }
