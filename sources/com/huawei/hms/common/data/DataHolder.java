...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    public static class Builder {
        ...
        public final ArrayList<HashMap<String, Object>> f48131b;

        /* renamed from: c  reason: collision with root package name */
        private final String f48132c;

        /* renamed from: d  reason: collision with root package name */
        private final HashMap<Object, Integer> f48133d;
        ...
        public com.huawei.hms.common.data.DataHolder.Builder setDataForContentValuesHashMap(java.util.HashMap<java.lang.String, java.lang.Object> r4) {
            /*
                ...
                java.lang.String r0 = r3.f48132c
                if (r0 == 0) goto L_0x002e
                java.lang.Object r0 = r4.get(r0)
                if (r0 == 0) goto L_0x002e
                java.util.HashMap<java.lang.Object, java.lang.Integer> r1 = r3.f48133d
            ...
            L_0x001f:
                java.util.HashMap<java.lang.Object, java.lang.Integer> r1 = r3.f48133d
                java.util.ArrayList<java.util.HashMap<java.lang.String, java.lang.Object>> r2 = r3.f48131b
                int r2 = r2.size()
            ...
            L_0x0030:
                ...
                java.util.ArrayList<java.util.HashMap<java.lang.String, java.lang.Object>> r1 = r3.f48131b
                r1.remove(r0)
                java.util.ArrayList<java.util.HashMap<java.lang.String, java.lang.Object>> r1 = r3.f48131b
                r1.add(r0, r4)
                goto L_0x0042
            L_0x003d:
                java.util.ArrayList<java.util.HashMap<java.lang.String, java.lang.Object>> r0 = r3.f48131b
                r0.add(r4)
            L_0x0042:
                return r3
            */
        ...
        private Builder(String[] strArr, String str) {
            ...
            this.f48130a = strArr;
            this.f48131b = new ArrayList<>();
            this.f48132c = str;
            this.f48133d = new HashMap<>();
        }
    ...
    private static java.util.ArrayList<android.database.CursorWindow> iterCursorWindow(com.huawei.hms.common.data.DataHolder.Builder r10, int r11, java.util.List r12) {
        /*
            ...
            r3 = 0
            r2.<init>(r3)
            java.lang.String[] r4 = r10.f48130a
            int r4 = r4.length
            r2.setNumColumns(r4)
            r1.add(r2)
            r4 = 0
        ...
        L_0x001a:
            ...
            java.lang.String[] r2 = r10.f48130a     // Catch:{ RuntimeException -> 0x0098 }
        ...
        L_0x0047:
            ...
            r8 = r4
        L_0x004f:
            java.lang.String[] r9 = r10.f48130a     // Catch:{ RuntimeException -> 0x0097 }
            int r9 = r9.length     // Catch:{ RuntimeException -> 0x0097 }
            if (r8 >= r9) goto L_0x006a
            java.lang.String[] r7 = r10.f48130a     // Catch:{ RuntimeException -> 0x0097 }
    ...
    private static boolean putValue(CursorWindow cursorWindow, Object obj, int i11, int i12) throws IllegalArgumentException {
        ...
        if (obj instanceof Boolean) {
            ...
            return cursorWindow.putLong(j11, i11, i12);
    ...
    public final int getWindowIndex(int i11) {
        ...
        int[] iArr;
        int i12 = 0;
        if (i11 >= 0 || i11 < this.dataCount) {
            z11 = true;
        } else {
            z11 = false;
        }
        Preconditions.checkArgument(z11, "rowIndex is out of index:" + i11);
        while (true) {
    ...
    public final boolean hasNull(String str, int i11, int i12) {
        checkAvailable(str, i11);
        if (this.cursorWindows[i12].getType(i11, this.columnsBundle.getInt(str)) == 0) {
            return true;
        }
        return false;
    }
    ...
    private static CursorWindow[] getCursorWindows(Builder builder, int i11) {
        if (builder.f48130a.length == 0) {
            return new CursorWindow[0];
        }
        if (i11 < 0 || i11 >= builder.f48131b.size()) {
            i11 = builder.f48131b.size();
        }
        ArrayList<CursorWindow> iterCursorWindow = iterCursorWindow(builder, i11, builder.f48131b.subList(0, i11));
    ...
    private DataHolder(Builder builder, int i11, Bundle bundle) {
        this(builder.f48130a, getCursorWindows(builder, -1), i11, (Bundle) null);
    }

    private DataHolder(Builder builder, int i11, Bundle bundle, int i12) {
        this(builder.f48130a, getCursorWindows(builder, -1), i11, bundle);
    }
}
