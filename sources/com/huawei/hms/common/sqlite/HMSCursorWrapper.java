...
public class HMSCursorWrapper extends CursorWrapper implements CrossProcessCursor {
    ...
    private AbstractWindowedCursor f48209a;
    ...
    public HMSCursorWrapper(Cursor cursor) {
        ...
        if (cursor == null) {
            ...
            if (wrappedCursor == null) {
                ...
                this.f48209a = (AbstractWindowedCursor) wrappedCursor;
            } else {
    ...
    public void fillWindow(int i11, CursorWindow cursorWindow) {
        this.f48209a.fillWindow(i11, cursorWindow);
    }

    public CursorWindow getWindow() {
        return this.f48209a.getWindow();
    }
    ...
    public boolean onMove(int i11, int i12) {
        return this.f48209a.onMove(i11, i12);
    }

    public void setWindow(CursorWindow cursorWindow) {
        this.f48209a.setWindow(cursorWindow);
    }
}
