...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        private final List<Scope> f48014b = new ArrayList();

        /* renamed from: c  reason: collision with root package name */
        private final List<PermissionInfo> f48015c = new ArrayList();

        /* renamed from: d  reason: collision with root package name */
        private final Map<Api<?>, Api.ApiOptions> f48016d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        private OnConnectionFailedListener f48017e;

        /* renamed from: f  reason: collision with root package name */
        private ConnectionCallbacks f48018f;

        /* renamed from: g  reason: collision with root package name */
        private int f48019g;

        /* renamed from: h  reason: collision with root package name */
        private Activity f48020h;
        ...
        public Builder allowLifeCycleManagement(Activity activity, int i11, OnConnectionFailedListener onConnectionFailedListener) {
            if (i11 >= 0) {
                this.f48019g = i11;
                this.f48020h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
                return this;
            }
        ...
        public HuaweiApiClient build() {
            ...
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f48013a);
            huaweiApiClientImpl.setScopes(this.f48014b);
            huaweiApiClientImpl.setPermissionInfos(this.f48015c);
            huaweiApiClientImpl.setApiMap(this.f48016d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f48018f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f48017e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f48019g);
            if (this.f48019g >= 0) {
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f48020h).startAutoMange(this.f48019g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o11, Scope... scopeArr) {
            ...
            Checker.checkNonNull(scopeArr, "Scopes must not be null");
            this.f48016d.put(api, o11);
            if (api.getOptions() != null) {
                this.f48014b.addAll(api.getOptions().getScopeList(o11));
                this.f48015c.addAll(api.getOptions().getPermissionInfoList(o11));
            }
            this.f48014b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
