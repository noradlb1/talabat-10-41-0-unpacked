...
public class m0 extends h0<u, List<HWLocation>> {
    ...
    public void doExecute(u uVar, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<List<HWLocation>> taskCompletionSource) {
        try {
            HMSLocationLog.i("GetFromLocationTaskApiCall", this.f49189a, "doExecute");
            ...
            HMSLocationLog.e("GetFromLocationTaskApiCall", str2, "getFromLocation doExecute exception:" + e11.getMessage());
            taskCompletionSource.setException(e11);
        } catch (Exception unused) {
            HMSLocationLog.e("GetFromLocationTaskApiCall", this.f49189a, "getFromLocation doExecute exception");
            taskCompletionSource.setException(new ApiException(new Status(10000, LocationStatusCode.getStatusCodeString(10000))));
        }
    }

    public int getApiLevel() {
        int deviceFeature = DeviceInfoUtil.getDeviceFeature(this.f49202b);
