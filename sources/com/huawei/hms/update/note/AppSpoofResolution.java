...
public class AppSpoofResolution implements IBridgeActivityDelegate {
    ...
    public class a implements AbstractDialog.Callback {
        ...
        public void onCancel(AbstractDialog abstractDialog) {
            com.huawei.hms.availableupdate.a.f48058c.a(true);
            b unused = AppSpoofResolution.this.f49894b = null;
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        com.huawei.hms.availableupdate.a aVar = com.huawei.hms.availableupdate.a.f48058c;
        aVar.a(activity);
        aVar.a(false);
        b();
    }
    ...
    public void a() {
        ...
        if (activity != null && !activity.isFinishing()) {
            ...
            if (com.huawei.hms.availableupdate.a.f48058c.a().compareAndSet(true, false)) {
                SystemManager.getInstance().notifyNoticeResult(29);
            }
            activity.finish();
        }
