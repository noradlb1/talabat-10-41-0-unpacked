...
/* renamed from: com.huawei.hms.dtm.core.cc  reason: case insensitive filesystem */
public class C0355cc extends Y {
        ...
        if (list != null && list.size() == 2) {
            ...
            if (!(list.get(0) == null || list.get(1) == null)) {
                ...
                if (Double.isNaN(c11.doubleValue())) {
                    str = list.get(0).toString() + " can not be compared as a number.";
                } else {
                    Double c12 = list.get(1).c();
                    if (Double.isNaN(c12.doubleValue())) {
                        str = list.get(1).toString() + " can not be compared as a number.";
                    } else {
