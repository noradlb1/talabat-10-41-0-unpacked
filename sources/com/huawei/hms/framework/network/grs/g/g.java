...
public class g {
    ...
    public static final ExecutorService f48915b = ExecutorsUtils.newCachedThreadPool("GRS_RequestController-Task");

    /* renamed from: c  reason: collision with root package name */
    private static final Map<String, com.huawei.hms.framework.network.grs.g.j.b> f48916c = new ConcurrentHashMap(16);

    /* renamed from: d  reason: collision with root package name */
    private static final Object f48917d = new Object();
    /* access modifiers changed from: private */

    /* renamed from: a  reason: collision with root package name */
    public com.huawei.hms.framework.network.grs.e.a f48918a;

    public class a implements Callable<d> {

        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ c f48919a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ String f48920b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ com.huawei.hms.framework.network.grs.e.c f48921c;
        ...
        public d call() {
            return new c(this.f48919a, g.this.f48918a).a(g.f48915b, this.f48920b, this.f48921c);
        }
    }
    ...
    public class b implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ c f48923a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ String f48924b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ com.huawei.hms.framework.network.grs.e.c f48925c;

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ int f48926d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ com.huawei.hms.framework.network.grs.b f48927e;
        ...
        public void run() {
            g gVar = g.this;
            gVar.a(gVar.a(this.f48923a, this.f48924b, this.f48925c, this.f48926d), this.f48927e);
        }
    }
    ...
    public com.huawei.hms.framework.network.grs.g.d a(com.huawei.hms.framework.network.grs.g.j.c r9, java.lang.String r10, com.huawei.hms.framework.network.grs.e.c r11, int r12) {
        ...
        L_0x0049:
            ...
            java.util.Map<java.lang.String, com.huawei.hms.framework.network.grs.g.j.b> r5 = f48916c     // Catch:{ all -> 0x00d9 }
        ...
        L_0x006e:
            ...
            java.util.concurrent.ExecutorService r3 = f48915b     // Catch:{ all -> 0x00d9 }
    ...
    public void a(c cVar, com.huawei.hms.framework.network.grs.b bVar, String str, com.huawei.hms.framework.network.grs.e.c cVar2, int i11) {
        f48915b.execute(new b(cVar, str, cVar2, i11, bVar));
    }

    public void a(String str) {
        synchronized (f48917d) {
            f48916c.remove(str);
        }
    }
}
