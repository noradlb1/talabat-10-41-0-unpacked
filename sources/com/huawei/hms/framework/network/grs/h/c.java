...
public class c {
    ...
    private static final String f48942a = "c";

    /* JADX WARNING: Code restructure failed: missing block: B:17:0x005f, code lost:
        r6 = move-exception;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:?, code lost:
        com.huawei.hms.framework.common.Logger.w(f48942a, "local config file is not exist.filename is {%s}", r6);
     */
    ...
    public static java.lang.String a(java.lang.String r6, android.content.Context r7) {
        ...
        L_0x0031:
            com.huawei.hms.framework.common.IoUtils.closeSecure((java.io.OutputStream) r0)
            com.huawei.hms.framework.common.IoUtils.closeSecure((java.io.InputStream) r3)
            return r1
        L_0x0038:
            android.content.res.AssetManager r7 = r7.getAssets()     // Catch:{ IOException -> 0x0061 }
            java.io.InputStream r3 = r7.open(r6)     // Catch:{ IOException -> 0x0061 }
            r7 = 8192(0x2000, float:1.14794E-41)
            byte[] r7 = new byte[r7]     // Catch:{ IOException -> 0x0061 }
        L_0x0044:
            int r4 = r3.read(r7)     // Catch:{ IOException -> 0x0061 }
            r5 = -1
            if (r4 == r5) goto L_0x004f
            r0.write(r7, r2, r4)     // Catch:{ IOException -> 0x0061 }
            goto L_0x0044
        L_0x004f:
            r0.flush()     // Catch:{ IOException -> 0x0061 }
            java.lang.String r7 = "UTF-8"
            java.lang.String r6 = r0.toString(r7)     // Catch:{ IOException -> 0x0061 }
            com.huawei.hms.framework.common.IoUtils.closeSecure((java.io.OutputStream) r0)
            com.huawei.hms.framework.common.IoUtils.closeSecure((java.io.InputStream) r3)
            return r6
        L_0x005f:
            ...
            goto L_0x006e
        L_0x0061:
            java.lang.String r7 = f48942a     // Catch:{ all -> 0x005f }
