...
public class NetworkKitSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public boolean tabbleIsExistInDB(String str, String str2) {
        ...
        try {
            SQLiteDatabase openDatabase = SQLiteDatabase.openDatabase(networkKitReadableDatabase.getPath().replace(dbName, str), (SQLiteDatabase.CursorFactory) null, 0);
            String str3 = "select count(1) from " + str2;
            if (!(openDatabase instanceof SQLiteDatabase)) {
                openDatabase.rawQuery(str3, (String[]) null);
            } else {
                SQLiteInstrumentation.rawQuery(openDatabase, str3, (String[]) null);
            }
            IoUtils.closeSecure((Closeable) openDatabase);
            return true;
