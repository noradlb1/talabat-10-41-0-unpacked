...
public class b extends AGConnectInstance {
    ...
    private static List<Service> f47530a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map<String, AGConnectInstance> f47531b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    private static String f47532c;

    /* renamed from: d  reason: collision with root package name */
    private final AGConnectOptions f47533d;

    /* renamed from: e  reason: collision with root package name */
    private final d f47534e;

    /* renamed from: f  reason: collision with root package name */
    private final d f47535f;

    public b(AGConnectOptions aGConnectOptions) {
        this.f47533d = aGConnectOptions;
        if (f47530a == null) {
            Log.e("AGC_Instance", "please call `initialize()` first");
        }
        this.f47534e = new d(f47530a, aGConnectOptions.getContext());
    ...
    private static synchronized AGConnectInstance a(AGConnectOptions aGConnectOptions, boolean z11) {
        ...
        synchronized (b.class) {
            Map<String, AGConnectInstance> map = f47531b;
    ...
    public static synchronized AGConnectInstance a(String str) {
        AGConnectInstance aGConnectInstance;
        synchronized (b.class) {
            aGConnectInstance = f47531b.get(str);
    ...
    private static synchronized void a(Context context, AGConnectOptions aGConnectOptions) {
        synchronized (b.class) {
            ...
            b();
            if (f47530a == null) {
                f47530a = new c(context).a();
            }
            a(aGConnectOptions, true);
            f47532c = aGConnectOptions.getIdentifier();
    ...
    public void a(final CustomAuthProvider customAuthProvider) {
        this.f47535f.a((List<Service>) Collections.singletonList(Service.builder((Class<?>) AuthProvider.class, (Object) new AuthProvider() {
        ...
        }).build()), this.f47533d.getContext());
    }

    public void a(final CustomCredentialsProvider customCredentialsProvider) {
        this.f47535f.a((List<Service>) Collections.singletonList(Service.builder((Class<?>) CredentialsProvider.class, (Object) new CredentialsProvider() {
            public Task<Token> getTokens() {
    ...
    public Context getContext() {
        return this.f47533d.getContext();
    }

    public String getIdentifier() {
        return this.f47533d.getIdentifier();
    }
    ...
    public <T> T getService(Class<? super T> cls) {
        T a11 = this.f47535f.a((AGConnectInstance) this, (Class<?>) cls);
        return a11 != null ? a11 : this.f47534e.a((AGConnectInstance) this, (Class<?>) cls);
    }
}
