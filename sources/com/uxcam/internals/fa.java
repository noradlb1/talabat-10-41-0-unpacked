...
public class fa implements hg {

    /* renamed from: a  reason: collision with root package name */
    public final int f13305a;

    public fa(int i11, int i12) {
        this.f13305a = i12 + 2;
    }
    ...
    public void a(ek ekVar, ek ekVar2) {
        ...
        for (int i16 = 0; i16 < (ekVar3.f13283c >> 1); i16++) {
            for (int i17 = 0; i17 < (ekVar3.f13282b >> 1); i17++) {
                ...
                int[] iArr8 = iArr2[0];
                iArr8[i27] = (iArr8[i27] << 0) >> 0;
                i14 = i23 + 1;
                int[] iArr9 = iArr2[1];
                int i28 = this.f13305a;
                iArr9[i13] = (iArr9[i13] << 0) >> i28;
                int[] iArr10 = iArr2[2];
                iArr10[i13] = (iArr10[i13] << 0) >> i28;
                i13++;
                i15 += 6;
            }
            i14 += i12;
