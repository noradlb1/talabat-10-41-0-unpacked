...
public class SingleThreadFutureScheduler implements FutureScheduler {
    ...
    public class a implements RejectedExecutionHandler {
        ...
        public final void rejectedExecution(Runnable runnable, ThreadPoolExecutor threadPoolExecutor) {
            AdjustFactory.getLogger().warn("Runnable [%s] rejected from [%s] ", runnable.toString(), this.f40021a);
        }
    }
    ...
    public class b implements Callable<V> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ Callable f40022a;

        public b(Callable callable) {
            this.f40022a = callable;
        }

        public final V call() {
            try {
                return this.f40022a.call();
            } catch (Throwable th2) {
