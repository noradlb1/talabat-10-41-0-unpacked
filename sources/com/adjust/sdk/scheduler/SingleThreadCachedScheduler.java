...
public class SingleThreadCachedScheduler implements ThreadScheduler {
    ...
    public class a implements RejectedExecutionHandler {
        ...
        public final void rejectedExecution(Runnable runnable, ThreadPoolExecutor threadPoolExecutor) {
            AdjustFactory.getLogger().warn("Runnable [%s] rejected from [%s] ", runnable.toString(), this.f40015a);
        }
    }
    ...
    public class b implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ long f40016a;

        /* renamed from: b  reason: collision with root package name */
        public final /* synthetic */ Runnable f40017b;

        public b(long j11, Runnable runnable) {
            this.f40016a = j11;
            this.f40017b = runnable;
        }

        public final void run() {
            try {
                Thread.sleep(this.f40016a);
            } catch (InterruptedException e11) {
                AdjustFactory.getLogger().warn("Sleep delay exception: %s", e11.getMessage());
            }
            SingleThreadCachedScheduler.this.submit(this.f40017b);
        }
    }
