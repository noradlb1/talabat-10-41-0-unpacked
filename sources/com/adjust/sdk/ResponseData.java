...
public class ResponseData {
    ...
    public static ResponseData buildResponseData(ActivityPackage activityPackage2, Map<String, String> map) {
        ...
        int i11 = a.f39950a[activityKind2.ordinal()];
        ResponseData responseData = i11 != 1 ? i11 != 2 ? i11 != 3 ? i11 != 4 ? new ResponseData() : new EventResponseData(activityPackage2) : new AttributionResponseData() : new SdkClickResponseData() : new SessionResponseData(activityPackage2);
