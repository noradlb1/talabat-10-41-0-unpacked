...
public enum ActivityKind {
    ...
    public static /* synthetic */ class a {
        ...
        public static final /* synthetic */ int[] f39905a = null;
        ...
        static {
            ...
            L_0x0078:
                int[] r0 = f39905a     // Catch:{ NoSuchFieldError -> 0x0084 }
    ...
    public static ActivityKind fromString(String str) {
        return SDKCoreEvent.Session.TYPE_SESSION.equals(str) ? SESSION : "event".equals(str) ? EVENT : "click".equals(str) ? CLICK : "attribution".equals(str) ? ATTRIBUTION : CustomerInfoLocalDataSourceImpl.KEY.equals(str) ? INFO : "gdpr".equals(str) ? GDPR : "disable_third_party_sharing".equals(str) ? DISABLE_THIRD_PARTY_SHARING : "ad_revenue".equals(str) ? AD_REVENUE : "subscription".equals(str) ? SUBSCRIPTION : "third_party_sharing".equals(str) ? THIRD_PARTY_SHARING : "measurement_consent".equals(str) ? MEASUREMENT_CONSENT : UNKNOWN;
    }

    public String toString() {
        switch (a.f39905a[ordinal()]) {
            case 1:
                return SDKCoreEvent.Session.TYPE_SESSION;
            case 2:
                return "event";
            case 3:
                return "click";
            case 4:
                return "attribution";
            case 5:
                return CustomerInfoLocalDataSourceImpl.KEY;
            case 6:
                return "gdpr";
            case 7:
