...
public class AdjustConfig {
    ...
    private void init(Context context2, String str, String str2, boolean z11) {
        ...
        setLogLevel((!z11 || !ENVIRONMENT_PRODUCTION.equals(str2)) ? LogLevel.INFO : LogLevel.SUPRESS, str2);
        if (context2 != null) {
    ...
    public void setAppSecret(long j11, long j12, long j13, long j14, long j15) {
        this.secretId = Util.formatString(TimeModel.NUMBER_FORMAT, Long.valueOf(j11));
        this.appSecret = Util.formatString("%d%d%d%d", Long.valueOf(j12), Long.valueOf(j13), Long.valueOf(j14), Long.valueOf(j15));
    }

    public void setCoppaCompliantEnabled(boolean z11) {
        this.coppaCompliantEnabled = z11;
    }
    ...
    public void setDelayStart(double d11) {
        this.delayStart = Double.valueOf(d11);
    }

    public void setDeviceKnown(boolean z11) {
        this.deviceKnown = Boolean.valueOf(z11);
    }
    ...
    public void setNeedsCost(boolean z11) {
        this.needsCost = Boolean.valueOf(z11);
    }
    ...
    public void setPlayStoreKidsAppEnabled(boolean z11) {
        this.playStoreKidsAppEnabled = z11;
    }
    ...
    public void setPreinstallTrackingEnabled(boolean z11) {
        this.preinstallTrackingEnabled = z11;
    }
    ...
    @Deprecated
    public void setReadMobileEquipmentIdentity(boolean z11) {
    ...
    public void setSendInBackground(boolean z11) {
        this.sendInBackground = z11;
    }
