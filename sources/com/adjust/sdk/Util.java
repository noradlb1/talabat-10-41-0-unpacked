...
public class Util {
    ...
    public class a implements Callable<Object> {
        ...
        public final /* synthetic */ Context f39960a;
        ...
        public final Object call() {
            try {
                return Reflection.getAdvertisingInfoObject(this.f39960a);
    ...
    public class b implements Callable<String> {
        ...
        public final Object call() {
            return Reflection.getPlayAdId(this.f39961a, this.f39962b);
        }
    }
    ...
    public class c implements Callable<Boolean> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ Context f39963a;
        ...
        public final Object call() {
            return Reflection.isPlayTrackingEnabled(this.f39963a, this.f39964b);
        }
    }
    ...
    public class d extends AsyncTaskExecutor<Context, String> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ OnDeviceIdsRead f39965a;

        public d(OnDeviceIdsRead onDeviceIdsRead) {
            this.f39965a = onDeviceIdsRead;
        }
        ...
        public final void onPostExecute(Object obj) {
            this.f39965a.onGoogleAdIdRead((String) obj);
        }
    }
    ...
    public static String convertToHex(byte[] bArr) {
        ...
        return formatString("%0" + (bArr.length << 1) + Param.X, bigInteger);
    }
    ...
    public static int getConnectivityType(Context context) {
        ...
        try {
            ...
            getLogger().warn("Couldn't read connectivity type (%s)", e11.getMessage());
        }
    }
    ...
    public static Locale getLocale(Configuration configuration) {
        LocaleList a11;
        int i11 = Build.VERSION.SDK_INT;
        if (i11 >= 24 && (a11 = configuration.getLocales()) != null && !a11.isEmpty()) {
            return a11.get(0);
        }
        if (i11 < 24) {
    ...
    public static String getReasonString(String str, Throwable th2) {
        ...
        return formatString(LogWriteConstants.LOCATION_MSG_FORMAT, str);
    }
    ...
    public static String getRootCause(Exception exc) {
        ...
        return stringWriter2.substring(indexOf, stringWriter2.indexOf(StringUtils.LF, indexOf));
    }
    ...
    public static <T> T readObject(android.content.Context r7, java.lang.String r8, java.lang.String r9, java.lang.Class<T> r10) {
        ...
        L_0x002b:
            ...
            java.lang.Object[] r5 = new java.lang.Object[r0]     // Catch:{ FileNotFoundException -> 0x0072, Exception -> 0x006d }
            r5[r1] = r9     // Catch:{ FileNotFoundException -> 0x0072, Exception -> 0x006d }
            java.lang.String r8 = r8.getMessage()     // Catch:{ FileNotFoundException -> 0x0072, Exception -> 0x006d }
            r5[r2] = r8     // Catch:{ FileNotFoundException -> 0x0072, Exception -> 0x006d }
