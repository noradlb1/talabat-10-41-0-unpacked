...
public class AttributionHandler implements IAttributionHandler, IActivityPackageSender.ResponseDataCallbackSubscriber {
    ...
    public class c implements Runnable {
        ...
        public final /* synthetic */ SessionResponseData f39916a;

        public c(SessionResponseData sessionResponseData) {
            this.f39916a = sessionResponseData;
        }

        public final void run() {
            IActivityHandler iActivityHandler = (IActivityHandler) AttributionHandler.this.activityHandlerWeakRef.get();
            if (iActivityHandler != null) {
                AttributionHandler.this.checkSessionResponseI(iActivityHandler, this.f39916a);
            }
        }
    }
    ...
    public class d implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ SdkClickResponseData f39918a;

        public d(SdkClickResponseData sdkClickResponseData) {
            this.f39918a = sdkClickResponseData;
        }

        public final void run() {
            IActivityHandler iActivityHandler = (IActivityHandler) AttributionHandler.this.activityHandlerWeakRef.get();
            if (iActivityHandler != null) {
                AttributionHandler.this.checkSdkClickResponseI(iActivityHandler, this.f39918a);
            }
        }
    }
    ...
    public class e implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ AttributionResponseData f39920a;

        public e(AttributionResponseData attributionResponseData) {
            this.f39920a = attributionResponseData;
        }

        public final void run() {
            IActivityHandler iActivityHandler = (IActivityHandler) AttributionHandler.this.activityHandlerWeakRef.get();
            if (iActivityHandler != null) {
                AttributionHandler.this.checkAttributionResponseI(iActivityHandler, this.f39920a);
            }
        }
    }
    ...
    public class g implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ ResponseData f39923a;

        public g(ResponseData responseData) {
            this.f39923a = responseData;
        }

        public final void run() {
            IActivityHandler iActivityHandler = (IActivityHandler) AttributionHandler.this.activityHandlerWeakRef.get();
            if (iActivityHandler != null) {
                ResponseData responseData = this.f39923a;
    ...
    public void sendAttributionRequestI() {
        if (!this.activityHandlerWeakRef.get().getActivityState().isGdprForgotten) {
            ...
            this.logger.verbose(LogWriteConstants.LOCATION_MSG_FORMAT, buildAndGetAttributionPackage.getExtendedString());
