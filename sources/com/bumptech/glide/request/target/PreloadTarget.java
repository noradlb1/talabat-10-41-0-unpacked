...
public final class PreloadTarget<Z> extends CustomTarget<Z> {
    ...
    private PreloadTarget(RequestManager requestManager2, int i11, int i12) {
        super(i11, i12);
        this.requestManager = requestManager2;
    }

    public static <Z> PreloadTarget<Z> obtain(RequestManager requestManager2, int i11, int i12) {
        return new PreloadTarget<>(requestManager2, i11, i12);
    }
