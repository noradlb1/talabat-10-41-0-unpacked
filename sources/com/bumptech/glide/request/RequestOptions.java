...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, to = 100) int i11) {
        return (RequestOptions) new RequestOptions().encodeQuality(i11);
    }
    ...
    @CheckResult
    @NonNull
    public static RequestOptions frameOf(@IntRange(from = 0) long j11) {
        return (RequestOptions) new RequestOptions().frame(j11);
    }
    ...
    public static <T> RequestOptions option(@NonNull Option<T> option, @NonNull T t11) {
        return (RequestOptions) new RequestOptions().set(option, t11);
    }

    @CheckResult
    @NonNull
    public static RequestOptions overrideOf(int i11, int i12) {
        return (RequestOptions) new RequestOptions().override(i11, i12);
    }
    ...
    @CheckResult
    @NonNull
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = 0.0d, to = 1.0d) float f11) {
        return (RequestOptions) new RequestOptions().sizeMultiplier(f11);
    }
    ...
    @CheckResult
    @NonNull
    public static RequestOptions timeoutOf(@IntRange(from = 0) int i11) {
        return (RequestOptions) new RequestOptions().timeout(i11);
    }

    @CheckResult
    @NonNull
    public static RequestOptions errorOf(@DrawableRes int i11) {
        return (RequestOptions) new RequestOptions().error(i11);
    }
    ...
    @CheckResult
    @NonNull
    public static RequestOptions placeholderOf(@DrawableRes int i11) {
        return (RequestOptions) new RequestOptions().placeholder(i11);
    }
}
