...
public class ViewAnimationFactory<R> implements TransitionFactory<R> {
    ...
    public static class ResourceViewTransitionAnimationFactory implements ViewTransition.ViewTransitionAnimationFactory {
        ...
        public ResourceViewTransitionAnimationFactory(int i11) {
    ...
    public ViewAnimationFactory(int i11) {
        this((ViewTransition.ViewTransitionAnimationFactory) new ResourceViewTransitionAnimationFactory(i11));
    }
