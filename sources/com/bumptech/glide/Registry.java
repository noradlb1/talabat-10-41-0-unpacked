...
public class Registry {
    ...
    @NonNull
    public <X> DataRewinder<X> getRewinder(@NonNull X x11) {
        return this.dataRewinderRegistry.build(x11);
    }

    @NonNull
    public <X> Encoder<X> getSourceEncoder(@NonNull X x11) throws NoSourceEncoderAvailableException {
        Encoder<X> encoder = this.encoderRegistry.getEncoder(x11.getClass());
        if (encoder != null) {
            return encoder;
        }
