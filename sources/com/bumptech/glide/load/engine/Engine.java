...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    public static class DecodeJobFactory {
        ...
        public <R> DecodeJob<R> build(GlideContext glideContext, Object obj, EngineKey engineKey, Key key, int i11, int i12, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z11, boolean z12, boolean z13, Options options, DecodeJob.Callback<R> callback) {
            ...
            return decodeJob.init(glideContext, obj, engineKey, key, i11, i12, cls, cls2, priority, diskCacheStrategy, map, z11, z12, z13, options, callback, i14);
        }
    }
    ...
    public static class EngineJobFactory {
        ...
        public <R> EngineJob<R> build(Key key, boolean z11, boolean z12, boolean z13, boolean z14) {
    ...
    public class LoadStatus {
        ...
        private final ResourceCallback f44188cb;
        private final EngineJob<?> engineJob;

        public LoadStatus(ResourceCallback resourceCallback, EngineJob<?> engineJob2) {
            this.f44188cb = resourceCallback;
            this.engineJob = engineJob2;
        }

        public void cancel() {
            synchronized (Engine.this) {
                this.engineJob.removeCallback(this.f44188cb);
            }
        }
    }
    ...
    public Engine(MemoryCache memoryCache, DiskCache.Factory factory, GlideExecutor glideExecutor, GlideExecutor glideExecutor2, GlideExecutor glideExecutor3, GlideExecutor glideExecutor4, boolean z11) {
        this(memoryCache, factory, glideExecutor, glideExecutor2, glideExecutor3, glideExecutor4, (Jobs) null, (EngineKeyFactory) null, (ActiveResources) null, (EngineJobFactory) null, (DecodeJobFactory) null, (ResourceRecycler) null, z11);
    }
    ...
    private <R> LoadStatus waitForExistingOrStartNewJob(GlideContext glideContext, Object obj, Key key, int i11, int i12, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z11, boolean z12, Options options, boolean z13, boolean z14, boolean z15, boolean z16, ResourceCallback resourceCallback, Executor executor, EngineKey engineKey, long j11) {
        ...
        long j12 = j11;
        EngineJob<?> engineJob = this.jobs.get(engineKey2, z16);
        if (engineJob != null) {
            engineJob.addCallback(resourceCallback2, executor2);
            if (VERBOSE_IS_LOGGABLE) {
                logWithTimeAndKey("Added to existing load", j12, engineKey2);
            }
            return new LoadStatus(resourceCallback2, engineJob);
        }
        EngineJob build = this.engineJobFactory.build(engineKey, z13, z14, z15, z16);
        ...
        if (VERBOSE_IS_LOGGABLE) {
            logWithTimeAndKey("Started new load", j11, engineKey4);
        }
    ...
    public <R> LoadStatus load(GlideContext glideContext, Object obj, Key key, int i11, int i12, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z11, boolean z12, Options options, boolean z13, boolean z14, boolean z15, boolean z16, ResourceCallback resourceCallback, Executor executor) {
        ...
        synchronized (this) {
            ...
            if (loadFromMemory == null) {
                LoadStatus waitForExistingOrStartNewJob = waitForExistingOrStartNewJob(glideContext, obj, key, i11, i12, cls, cls2, priority, diskCacheStrategy, map, z11, z12, options, z13, z14, z15, z16, resourceCallback, executor, buildKey, logTime);
