...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    public interface Callback<R> {
        ...
        void onResourceReady(Resource<R> resource, DataSource dataSource, boolean z11);
    ...
    private void decodeFromRetrievedData() {
        Resource<R> resource;
        if (Log.isLoggable(TAG, 2)) {
            long j11 = this.startFetchTime;
            logWithTimeAndKey("Retrieved data", j11, "data: " + this.currentData + ", cache key: " + this.currentSourceKey + ", fetcher: " + this.currentFetcher);
        }
        try {
    ...
    private Stage getNextStage(Stage stage2) {
        int i11 = AnonymousClass1.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage2.ordinal()];
        if (i11 != 1) {
            if (i11 != 2) {
                if (i11 == 3 || i11 == 4) {
    ...
    private Options getOptionsWithHardwareConfig(DataSource dataSource) {
        ...
        options3.set(option, Boolean.valueOf(z11));
        return options3;
    }
    ...
    private void logWithTimeAndKey(String str, long j11) {
        logWithTimeAndKey(str, j11, (String) null);
    }

    private void notifyComplete(Resource<R> resource, DataSource dataSource, boolean z11) {
        setNotifiedOrThrow();
        this.callback.onResourceReady(resource, dataSource, z11);
    }

    private void notifyEncodeAndRelease(Resource<R> resource, DataSource dataSource, boolean z11) {
        ...
        notifyComplete(lockedResource, dataSource, z11);
    ...
    public DecodeJob<R> init(GlideContext glideContext2, Object obj, EngineKey engineKey, Key key, int i11, int i12, Class<?> cls, Class<R> cls2, Priority priority2, DiskCacheStrategy diskCacheStrategy2, Map<Class<?>, Transformation<?>> map, boolean z11, boolean z12, boolean z13, Options options2, Callback<R> callback2, int i13) {
        this.decodeHelper.init(glideContext2, obj, key, i11, i12, diskCacheStrategy2, cls, cls2, priority2, options2, map, z11, z12, this.diskCacheProvider);
    ...
    public void onDataFetcherReady(Key key, Object obj, DataFetcher<?> dataFetcher, DataSource dataSource, Key key2) {
        ...
        this.isLoadingFromAlternateCacheKey = z11;
        if (Thread.currentThread() != this.currentThread) {
    ...
    private void logWithTimeAndKey(String str, long j11, String str2) {
        ...
        if (str2 != null) {
            str3 = IndicativeSentencesGeneration.DEFAULT_SEPARATOR + str2;
        } else {
            str3 = "";
        }
        sb2.append(str3);
