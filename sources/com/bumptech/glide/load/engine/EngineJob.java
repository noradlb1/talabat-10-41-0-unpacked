...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    public class CallLoadFailed implements Runnable {
        ...
        private final ResourceCallback f44189cb;

        public CallLoadFailed(ResourceCallback resourceCallback) {
            this.f44189cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f44189cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f44189cb)) {
                        EngineJob.this.callCallbackOnLoadFailed(this.f44189cb);
                    }
    ...
    public class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb  reason: collision with root package name */
        private final ResourceCallback f44190cb;

        public CallResourceReady(ResourceCallback resourceCallback) {
            this.f44190cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f44190cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f44190cb)) {
                        EngineJob.this.engineResource.acquire();
                        EngineJob.this.callCallbackOnResourceReady(this.f44190cb);
                        EngineJob.this.removeCallback(this.f44190cb);
                    }
                    EngineJob.this.decrementPendingCallbacks();
                }
            }
    ...
    public static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb  reason: collision with root package name */
        final ResourceCallback f44191cb;
        final Executor executor;

        public ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor2) {
            this.f44191cb = resourceCallback;
            this.executor = executor2;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f44191cb.equals(((ResourceCallbackAndExecutor) obj).f44191cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f44191cb.hashCode();
        }
    }
    ...
    public synchronized void addCallback(ResourceCallback resourceCallback, Executor executor) {
        ...
        if (this.hasResource) {
            ...
            Preconditions.checkArgument(z11, "Cannot add callbacks to a cancelled EngineJob");
        }
    }
    ...
    public void decrementPendingCallbacks() {
        ...
        synchronized (this) {
            ...
            Preconditions.checkArgument(z11, "Can't decrement below 0");
            if (decrementAndGet == 0) {
    ...
    public synchronized void incrementPendingCallbacks(int i11) {
        EngineResource<?> engineResource2;
        Preconditions.checkArgument(isDone(), "Not yet complete!");
        if (this.pendingCallbacks.getAndAdd(i11) == 0 && (engineResource2 = this.engineResource) != null) {
            engineResource2.acquire();
        }
    }

    @VisibleForTesting
    public synchronized EngineJob<R> init(Key key2, boolean z11, boolean z12, boolean z13, boolean z14) {
        this.key = key2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r4, r1.f44191cb));
     */
    ...
    public void notifyCallbacksOfException() {
        ...
        L_0x0039:
            ...
            com.bumptech.glide.request.ResourceCallback r1 = r1.f44191cb
            r3.<init>(r1)
            r2.execute(r3)
            goto L_0x0039
        L_0x0052:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0055, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r5, r1.f44191cb));
     */
    ...
    public void onResourceReady(Resource<R> resource2, DataSource dataSource2, boolean z11) {
        synchronized (this) {
