...
public abstract class DiskCacheStrategy {
    public static final DiskCacheStrategy ALL = new DiskCacheStrategy() {
        ...
        public boolean isResourceCacheable(boolean z11, DataSource dataSource, EncodeStrategy encodeStrategy) {
    ...
    public abstract boolean isResourceCacheable(boolean z11, DataSource dataSource, EncodeStrategy encodeStrategy);
}
