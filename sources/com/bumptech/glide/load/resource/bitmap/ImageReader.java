...
interface ImageReader {
    ...
    public static final class InputStreamImageReader implements ImageReader {
        ...
        public Bitmap decodeBitmap(BitmapFactory.Options options) throws IOException {
            return BitmapFactoryInstrumentation.decodeStream(this.dataRewinder.rewindAndGet(), (Rect) null, options);
        }
    ...
    public static final class ParcelFileDescriptorImageReader implements ImageReader {
        ...
        @Nullable
        public Bitmap decodeBitmap(BitmapFactory.Options options) throws IOException {
            return BitmapFactoryInstrumentation.decodeFileDescriptor(this.dataRewinder.rewindAndGet().getFileDescriptor(), (Rect) null, options);
        }
