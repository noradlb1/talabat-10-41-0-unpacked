...
public final class GlideBuilder {
    ...
    public static final class ManualOverrideHardwareBitmapMaxFdCount implements GlideExperiments.Experiment {
        ...
        public ManualOverrideHardwareBitmapMaxFdCount(int i11) {
            this.fdCount = i11;
        }
    }
    ...
    public GlideBuilder setImageDecoderEnabledForBitmaps(boolean z11) {
        this.glideExperimentsBuilder.update(new EnableImageDecoderForBitmaps(), z11 && Build.VERSION.SDK_INT >= 29);
        return this;
    }
    ...
    public GlideBuilder setLogRequestOrigins(boolean z11) {
        this.glideExperimentsBuilder.update(new LogRequestOrigins(), z11);
        return this;
    }
