...
public class AdSessionConfiguration {
    ...
    private AdSessionConfiguration(CreativeType creativeType2, ImpressionType impressionType2, Owner owner, Owner owner2, boolean z11) {
        ...
        this.isolateVerificationScripts = z11;
    }

    public static AdSessionConfiguration createAdSessionConfiguration(CreativeType creativeType2, ImpressionType impressionType2, Owner owner, Owner owner2, boolean z11) {
        ...
        return new AdSessionConfiguration(creativeType2, impressionType2, owner, owner2, z11);
    }
