...
public final class StepperComposablesKt$animateFontColor$1 extends Lambda implements Function3<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Color>> {
    public static final StepperComposablesKt$animateFontColor$1 INSTANCE = new StepperComposablesKt$animateFontColor$1();

    public StepperComposablesKt$animateFontColor$1() {
        super(3);
    }
    ...
    public final FiniteAnimationSpec<Color> invoke(@NotNull Transition.Segment<Boolean> segment, @Nullable Composer composer, int i11) {
        ...
        composer.startReplaceableGroup(295449204);
