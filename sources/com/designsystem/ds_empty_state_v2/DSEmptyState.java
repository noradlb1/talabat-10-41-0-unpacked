...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0007\u0018\u00002\u00020\u0001B%\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\r\u0010\t\u001a\u00020\nH\u0017¢\u0006\u0002\u0010\u000b¨\u0006\f"}, d2 = {"Lcom/designsystem/ds_empty_state_v2/DSEmptyState;", "Lcom/designsystem/ds_empty_state_v2/DSEmptyStateV2;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "Content", "", "(Landroidx/compose/runtime/Composer;I)V", "marshmallow_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
public final class DSEmptyState extends DSEmptyStateV2 {
    ...
    public void Content(@Nullable Composer composer, int i11) {
        ...
        int i13;
        Composer startRestartGroup = composer.startRestartGroup(-445256632);
        if ((i11 & 14) == 0) {
        ...
        if (((i12 & 11) ^ 2) != 0 || !startRestartGroup.getSkipping()) {
            ...
            DSEmptyStateKt.DSEmptyState(title, (Modifier) null, details, buttonText, function0, startRestartGroup, 0, 2);
        } else {
            startRestartGroup.skipToGroupEnd();
        }
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new DSEmptyState$Content$2(this, i11));
        }
    }
