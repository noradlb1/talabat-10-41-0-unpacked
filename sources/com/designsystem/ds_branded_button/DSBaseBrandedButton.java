...
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\r\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u000b\b'\u0018\u00002\u00020\u0001B%\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR/\u0010\u000b\u001a\u0004\u0018\u00010\n2\b\u0010\t\u001a\u0004\u0018\u00010\n8B@BX\u0002¢\u0006\u0012\n\u0004\b\u0010\u0010\u0011\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000fR+\u0010\u0013\u001a\u00020\u00122\u0006\u0010\t\u001a\u00020\u00128F@FX\u0002¢\u0006\u0012\n\u0004\b\u0018\u0010\u0011\u001a\u0004\b\u0014\u0010\u0015\"\u0004\b\u0016\u0010\u0017R+\u0010\u0019\u001a\u00020\u00122\u0006\u0010\t\u001a\u00020\u00128G@GX\u0002¢\u0006\u0012\n\u0004\b\u001c\u0010\u0011\u001a\u0004\b\u001a\u0010\u0015\"\u0004\b\u001b\u0010\u0017R+\u0010\u001d\u001a\u00020\u00122\u0006\u0010\t\u001a\u00020\u00128F@FX\u0002¢\u0006\u0012\n\u0004\b\u001f\u0010\u0011\u001a\u0004\b\u001d\u0010\u0015\"\u0004\b\u001e\u0010\u0017R7\u0010\"\u001a\b\u0012\u0004\u0012\u00020!0 2\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020!0 8F@FX\u0002¢\u0006\u0012\n\u0004\b'\u0010\u0011\u001a\u0004\b#\u0010$\"\u0004\b%\u0010&R$\u0010)\u001a\u00020\n2\u0006\u0010(\u001a\u00020\n8F@FX\u000e¢\u0006\f\u001a\u0004\b*\u0010\r\"\u0004\b+\u0010\u000f¨\u0006,"}, d2 = {"Lcom/designsystem/ds_branded_button/DSBaseBrandedButton;", "Landroidx/compose/ui/platform/AbstractComposeView;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "defStyleAttr", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "<set-?>", "", "buttonTitle", "getButtonTitle", "()Ljava/lang/String;", "setButtonTitle", "(Ljava/lang/String;)V", "buttonTitle$delegate", "Landroidx/compose/runtime/MutableState;", "", "forceMM2", "getForceMM2", "()Z", "setForceMM2", "(Z)V", "forceMM2$delegate", "isEnabled", "isButtonEnabled", "setButtonEnabled", "isEnabled$delegate", "isLoading", "setLoading", "isLoading$delegate", "Lkotlin/Function0;", "", "onTap", "getOnTap", "()Lkotlin/jvm/functions/Function0;", "setOnTap", "(Lkotlin/jvm/functions/Function0;)V", "onTap$delegate", "value", "title", "getTitle", "setTitle", "marshmallow_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
public abstract class DSBaseBrandedButton extends AbstractComposeView {
    ...
    @JvmOverloads
    public DSBaseBrandedButton(@NotNull Context context) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public DSBaseBrandedButton(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ DSBaseBrandedButton(Context context, AttributeSet attributeSet, int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    @JvmOverloads
    public DSBaseBrandedButton(@NotNull Context context, @Nullable AttributeSet attributeSet, int i11) {
        ...
        this.onTap$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DSBaseBrandedButton$onTap$2.INSTANCE, (SnapshotMutationPolicy) null, 2, (Object) null);
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.DSBaseBrandedButton, 0, 0);
            Intrinsics.checkNotNullExpressionValue(obtainStyledAttributes, "context.obtainStyledAttr…SBaseBrandedButton, 0, 0)");
            setButtonTitle(obtainStyledAttributes.getString(R.styleable.DSBaseBrandedButton_bbt_title));
            setButtonEnabled(obtainStyledAttributes.getBoolean(R.styleable.DSBaseBrandedButton_bbt_is_enabled, true));
            setLoading(obtainStyledAttributes.getBoolean(R.styleable.DSBaseBrandedButton_bbt_is_loading, false));
            setForceMM2(obtainStyledAttributes.getBoolean(R.styleable.DSBaseBrandedButton_bbt_force_mm2, false));
