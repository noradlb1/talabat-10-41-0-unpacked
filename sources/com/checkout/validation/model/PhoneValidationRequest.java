...
public final class PhoneValidationRequest {
    ...
    public PhoneValidationRequest(@NotNull String str, @NotNull Country country2) {
    ...
    public static /* synthetic */ PhoneValidationRequest copy$default(PhoneValidationRequest phoneValidationRequest, String str, Country country2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = phoneValidationRequest.number;
        }
        if ((i11 & 2) != 0) {
            country2 = phoneValidationRequest.country;
        }
        return phoneValidationRequest.copy(str, country2);
    }
    ...
    @NotNull
    public final PhoneValidationRequest copy(@NotNull String str, @NotNull Country country2) {
        Intrinsics.checkNotNullParameter(str, CardTokenizationPlugin.ARG_NUMBER_KEY);
        Intrinsics.checkNotNullParameter(country2, "country");
        return new PhoneValidationRequest(str, country2);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.number, (Object) phoneValidationRequest.number) && this.country == phoneValidationRequest.country;
    }
    ...
    public String toString() {
        ...
        return "PhoneValidationRequest(number=" + str + ", country=" + country2 + ")";
    }
}
