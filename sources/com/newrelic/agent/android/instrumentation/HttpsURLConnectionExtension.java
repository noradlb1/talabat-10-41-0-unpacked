...
public class HttpsURLConnectionExtension extends HttpsURLConnection {
    ...
    /* access modifiers changed from: private */
    public final HttpsURLConnection impl;
        ...
        if (end != null) {
            if (transactionState2.isErrorOrFailure()) {
                try {
                    ...
                    agentLog.error("HttpsURLConnectionExtension.addTransactionAndErrorData: " + e11);
                }
                str = "";
        ...
        try {
            ...
            countingInputStream.addStreamCompleteListener(new StreamCompleteListener() {
                public void streamComplete(StreamCompleteEvent streamCompleteEvent) {
                    if (!transactionState2.isComplete()) {
                        try {
                            transactionState2.setStatusCode(HttpsURLConnectionExtension.this.impl.getResponseCode());
                        } catch (IOException unused) {
                            AgentLog d11 = HttpsURLConnectionExtension.log;
                            d11.error("HttpsURLConnectionExtension.getInputStream.streamComplete: " + streamCompleteEvent);
                        }
                ...
                public void streamComplete(StreamCompleteEvent streamCompleteEvent) {
                    if (!transactionState2.isComplete()) {
                        try {
                            ...
                            AgentLog d11 = HttpsURLConnectionExtension.log;
                            d11.error("HttpsURLConnectionExtension.getOutputStream.streamComplete: " + streamCompleteEvent);
                        }
