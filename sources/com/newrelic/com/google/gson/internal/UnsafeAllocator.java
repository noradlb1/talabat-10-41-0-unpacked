    ...
    public static UnsafeAllocator create() {
        ...
        try {
            ...
            try {
                ...
                final Method declaredMethod2 = cls.getDeclaredMethod(TypeProxy.SilentConstruction.Appender.NEW_INSTANCE_METHOD_NAME, new Class[]{cls2, Integer.TYPE});
                ...
                try {
                    final Method declaredMethod3 = ObjectInputStream.class.getDeclaredMethod(TypeProxy.SilentConstruction.Appender.NEW_INSTANCE_METHOD_NAME, new Class[]{cls2, cls2});
