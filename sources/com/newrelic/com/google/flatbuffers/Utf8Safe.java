...
import com.newrelic.com.google.flatbuffers.Utf8;
...
public final class Utf8Safe extends Utf8 {
    ...
    private static String decodeUtf8Array(byte[] bArr, int i11, int i12) {
        if ((i11 | i12 | ((bArr.length - i11) - i12)) >= 0) {
            ...
            while (r12 < i13) {
                ...
                if (Utf8.DecodeUtil.isOneByte(b12)) {
                    ...
                    if (i16 < i13 - 1) {
                        int i18 = i16 + 1;
                        Utf8.DecodeUtil.handleThreeBytes(b12, bArr[i16], bArr[i18], cArr, i15);
                        r12 = i18 + 1;
                        i15++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    byte b14 = bArr[i16];
                    int i21 = i19 + 1;
                    Utf8.DecodeUtil.handleFourBytes(b12, b14, bArr[i19], bArr[i21], cArr, i15);
                    r12 = i21 + 1;
                    i15 = i15 + 1 + 1;
                } else {
                    throw new IllegalArgumentException("Invalid UTF-8");
    ...
    private static String decodeUtf8Buffer(ByteBuffer byteBuffer, int i11, int i12) {
        if ((i11 | i12 | ((byteBuffer.limit() - i11) - i12)) >= 0) {
            ...
            while (r12 < i13) {
                ...
                if (Utf8.DecodeUtil.isOneByte(b12)) {
                    ...
                    if (i16 < i13 - 1) {
                        int i18 = i16 + 1;
                        Utf8.DecodeUtil.handleThreeBytes(b12, byteBuffer.get(i16), byteBuffer.get(i18), cArr, i15);
                        r12 = i18 + 1;
                        i15++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    int i21 = i19 + 1;
                    Utf8.DecodeUtil.handleFourBytes(b12, b14, byteBuffer.get(i19), byteBuffer.get(i21), cArr, i15);
                    r12 = i21 + 1;
                    i15 = i15 + 1 + 1;
                } else {
                    throw new IllegalArgumentException("Invalid UTF-8");
