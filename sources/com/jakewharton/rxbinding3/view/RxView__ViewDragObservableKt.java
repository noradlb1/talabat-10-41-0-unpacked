...
final /* synthetic */ class RxView__ViewDragObservableKt {
    @CheckResult
    @NotNull
    @JvmOverloads
    public static final Observable<DragEvent> drags(@NotNull View view) {
        return drags$default(view, (Function1) null, 1, (Object) null);
    }
    ...
    public static final Observable<DragEvent> drags(@NotNull View view, @NotNull Function1<? super DragEvent, Boolean> function1) {
        ...
        return new ViewDragObservable(view, function1);
    }

    public static /* synthetic */ Observable drags$default(View view, Function1 function1, int i11, Object obj) {
        if ((i11 & 1) != 0) {
