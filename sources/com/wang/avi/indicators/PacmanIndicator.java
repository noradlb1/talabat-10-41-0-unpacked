...
public class PacmanIndicator extends Indicator {
    ...
    private void drawPacman(Canvas canvas, Paint paint) {
        ...
        paint.setAlpha(255);
        float f11 = (-width) / 1.7f;
        float f12 = (-height) / 1.7f;
        float f13 = width / 1.7f;
        float f14 = height / 1.7f;
        Canvas canvas2 = canvas;
        Paint paint2 = paint;
        canvas2.drawArc(new RectF(f11, f12, f13, f14), 0.0f, 270.0f, true, paint2);
        canvas.restore();
        canvas.save();
        canvas.translate(width, height);
        canvas.rotate(this.degrees2);
        paint.setAlpha(255);
        canvas2.drawArc(new RectF(f11, f12, f13, f14), 90.0f, 270.0f, true, paint2);
        canvas.restore();
    }
