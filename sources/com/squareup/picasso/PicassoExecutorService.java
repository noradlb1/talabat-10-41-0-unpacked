...
class PicassoExecutorService extends ThreadPoolExecutor {
    ...
    public static final class PicassoFutureTask extends FutureTask<BitmapHunter> implements Comparable<PicassoFutureTask> {
        ...
        public int compareTo(PicassoFutureTask picassoFutureTask) {
            Picasso.Priority q11 = this.hunter.q();
            Picasso.Priority q12 = picassoFutureTask.hunter.q();
            return q11 == q12 ? this.hunter.f53371b - picassoFutureTask.hunter.f53371b : q12.ordinal() - q11.ordinal();
        }
    }
    ...
    private void setThreadCount(int i11) {
        setCorePoolSize(i11);
