...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\n"}, d2 = {"Lcoil/request/ImageRequest;", "<anonymous parameter 0>", "", "<anonymous parameter 1>", "", "<anonymous>"}, k = 3, mv = {1, 5, 1})
public final class ImageRequest$Builder$listener$3 extends Lambda implements Function2<ImageRequest, Throwable, Unit> {
    ...
    public final void invoke(@NotNull ImageRequest imageRequest, @NotNull Throwable th2) {
        Intrinsics.checkNotNullParameter(imageRequest, "$noName_0");
        Intrinsics.checkNotNullParameter(th2, "$noName_1");
    }
}
