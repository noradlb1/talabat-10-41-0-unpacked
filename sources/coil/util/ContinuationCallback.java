...
public final class ContinuationCallback implements Callback, Function1<Throwable, Unit> {
    ...
    public ContinuationCallback(@NotNull Call call2, @NotNull CancellableContinuation<? super Response> cancellableContinuation) {
    ...
    public void onFailure(@NotNull Call call2, @NotNull IOException iOException) {
        ...
        if (!call2.isCanceled()) {
            ...
            cancellableContinuation.resumeWith(Result.m6329constructorimpl(ResultKt.createFailure(iOException)));
        }
    }
    ...
    public void onResponse(@NotNull Call call2, @NotNull Response response) {
        ...
        this.continuation.resumeWith(Result.m6329constructorimpl(response));
    }
