...
public final class MemoryCacheService {
    ...
    public MemoryCacheService(@NotNull BitmapReferenceCounter bitmapReferenceCounter, @NotNull StrongMemoryCache strongMemoryCache2, @NotNull WeakMemoryCache weakMemoryCache2) {
    ...
    @Nullable
    public final RealMemoryCache.Value get(@Nullable MemoryCache.Key key) {
        if (key == null) {
            return null;
        }
