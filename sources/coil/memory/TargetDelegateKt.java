...
public final class TargetDelegateKt {
    ...
    private static final Object onError(Target target, ErrorResult errorResult, EventListener eventListener, Logger logger, Continuation<? super Unit> continuation) {
    ...
    private static final Object onSuccess(Target target, SuccessResult successResult, EventListener eventListener, Logger logger, Continuation<? super Unit> continuation) {
