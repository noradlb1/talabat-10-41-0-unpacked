...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    long indexOf(@NotNull ByteString byteString, long j11) throws IOException;

    long indexOfElement(@NotNull ByteString byteString) throws IOException;

    long indexOfElement(@NotNull ByteString byteString, long j11) throws IOException;
    ...
    boolean rangeEquals(long j11, @NotNull ByteString byteString) throws IOException;

    boolean rangeEquals(long j11, @NotNull ByteString byteString, int i11, int i12) throws IOException;
    ...
    void readFully(@NotNull Buffer buffer, long j11) throws IOException;
    ...
    @NotNull
    String readString(long j11, @NotNull Charset charset) throws IOException;
