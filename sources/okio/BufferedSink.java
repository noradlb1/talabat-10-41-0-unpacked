...
public interface BufferedSink extends Sink, WritableByteChannel {
    ...
    @NotNull
    BufferedSink write(@NotNull ByteString byteString, int i11, int i12) throws IOException;

    @NotNull
    BufferedSink write(@NotNull Source source, long j11) throws IOException;

    @NotNull
    BufferedSink write(@NotNull byte[] bArr) throws IOException;

    @NotNull
    BufferedSink write(@NotNull byte[] bArr, int i11, int i12) throws IOException;
    ...
    @NotNull
    BufferedSink writeString(@NotNull String str, int i11, int i12, @NotNull Charset charset) throws IOException;
    ...
    @NotNull
    BufferedSink writeUtf8(@NotNull String str, int i11, int i12) throws IOException;
