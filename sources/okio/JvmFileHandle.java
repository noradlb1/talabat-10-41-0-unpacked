...
public final class JvmFileHandle extends FileHandle {
    ...
    public JvmFileHandle(boolean z11, @NotNull RandomAccessFile randomAccessFile2) {
        super(z11);
    ...
    public synchronized int protectedRead(long r2, @org.jetbrains.annotations.NotNull byte[] r4, int r5, int r6) {
        /*
            r1 = this;
            monitor-enter(r1)
    ...
    public synchronized void protectedWrite(long j11, @NotNull byte[] bArr, int i11, int i12) {
