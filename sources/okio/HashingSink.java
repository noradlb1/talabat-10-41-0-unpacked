...
public final class HashingSink extends ForwardingSink {
    ...
    public HashingSink(@NotNull Sink sink, @NotNull MessageDigest messageDigest2) {
        super(sink);
        Intrinsics.checkNotNullParameter(sink, "sink");
    ...
    public final ByteString m8068deprecated_hash() {
        return hash();
    }
    ...
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HashingSink(@NotNull Sink sink, @NotNull Mac mac2) {
        super(sink);
        Intrinsics.checkNotNullParameter(sink, "sink");
