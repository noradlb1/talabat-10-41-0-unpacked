...
public abstract class FileHandle implements Closeable {
    ...
    public static final class FileHandleSink implements Sink {
        ...
        public FileHandleSink(@NotNull FileHandle fileHandle2, long j11) {
    ...
    public static final class FileHandleSource implements Source {
        ...
        public FileHandleSource(@NotNull FileHandle fileHandle2, long j11) {
            Intrinsics.checkNotNullParameter(fileHandle2, "fileHandle");
            this.fileHandle = fileHandle2;
            this.position = j11;
        }
    ...
    public final long readNoCloseCheck(long j11, Buffer buffer, long j12) {
        ...
        if (z11) {
            ...
            while (true) {
                ...
                int protectedRead = protectedRead(j14, bArr, i11, (int) Math.min(j13 - j14, (long) (8192 - i11)));
                if (protectedRead == -1) {
                    ...
                    long j15 = (long) protectedRead;
                    j14 += j15;
                    buffer2.setSize$okio(buffer.size() + j15);
                }
            }
            return j14 - j11;
        }
    ...
    public final void writeNoCloseCheck(long j11, Buffer buffer, long j12) {
        _UtilKt.checkOffsetAndCount(buffer.size(), 0, j12);
        long j13 = j12 + j11;
        while (j11 < j13) {
    ...
    public abstract int protectedRead(long j11, @NotNull byte[] bArr, int i11, int i12) throws IOException;

    public abstract void protectedResize(long j11) throws IOException;

    public abstract long protectedSize() throws IOException;

    public abstract void protectedWrite(long j11, @NotNull byte[] bArr, int i11, int i12) throws IOException;

    public final int read(long j11, @NotNull byte[] bArr, int i11, int i12) throws IOException {
    ...
    public final void reposition(@NotNull Source source, long j11) throws IOException {
        Intrinsics.checkNotNullParameter(source, "source");
        boolean z11 = false;
        if (source instanceof RealBufferedSource) {
            RealBufferedSource realBufferedSource = (RealBufferedSource) source;
    ...
    public final void write(long j11, @NotNull byte[] bArr, int i11, int i12) {
        Intrinsics.checkNotNullParameter(bArr, "array");
        if (this.readWrite) {
            synchronized (this) {
                if (!this.closed) {
    ...
    public final long read(long j11, @NotNull Buffer buffer, long j12) throws IOException {
        Intrinsics.checkNotNullParameter(buffer, "sink");
        synchronized (this) {
            if (!this.closed) {
                Unit unit = Unit.INSTANCE;
    ...
    public final void reposition(@NotNull Sink sink, long j11) throws IOException {
        Intrinsics.checkNotNullParameter(sink, "sink");
        boolean z11 = false;
        if (sink instanceof RealBufferedSink) {
            RealBufferedSink realBufferedSink = (RealBufferedSink) sink;
