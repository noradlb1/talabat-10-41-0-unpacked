...
public final class ConnectionPool {
    ...
    public ConnectionPool(@NotNull RealConnectionPool realConnectionPool) {
        Intrinsics.checkNotNullParameter(realConnectionPool, MethodDelegation.ImplementationDelegate.FIELD_NAME_PREFIX);
    ...
    public ConnectionPool(int i11, long j11, @NotNull TimeUnit timeUnit) {
