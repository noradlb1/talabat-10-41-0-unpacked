...
public interface PushObserver {
    ...
    public static final class Companion {
        ...
        public static final class PushObserverCancel implements PushObserver {
            public boolean onData(int i11, @NotNull BufferedSource bufferedSource, int i12, boolean z11) throws IOException {
                Intrinsics.checkNotNullParameter(bufferedSource, "source");
                bufferedSource.skip((long) i12);
                return true;
            }

            public boolean onHeaders(int i11, @NotNull List<Header> list, boolean z11) {
                Intrinsics.checkNotNullParameter(list, "responseHeaders");
                return true;
            }

            public boolean onRequest(int i11, @NotNull List<Header> list) {
                Intrinsics.checkNotNullParameter(list, "requestHeaders");
                return true;
            }

            public void onReset(int i11, @NotNull ErrorCode errorCode) {
    ...
    boolean onData(int i11, @NotNull BufferedSource bufferedSource, int i12, boolean z11) throws IOException;

    boolean onHeaders(int i11, @NotNull List<Header> list, boolean z11);

    boolean onRequest(int i11, @NotNull List<Header> list);

    void onReset(int i11, @NotNull ErrorCode errorCode);
}
