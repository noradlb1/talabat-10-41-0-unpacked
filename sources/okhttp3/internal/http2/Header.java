...
public final class Header {
    ...
    public final ByteString f27529name;
    @NotNull
    @JvmField
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.f27529name, (Object) header.f27529name) && Intrinsics.areEqual((Object) this.value, (Object) header.value);
    }

    public int hashCode() {
        return (this.f27529name.hashCode() * 31) + this.value.hashCode();
    }

    @NotNull
    public String toString() {
        return this.f27529name.utf8() + ": " + this.value.utf8();
    }
