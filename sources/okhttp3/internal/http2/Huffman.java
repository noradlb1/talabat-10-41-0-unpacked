...
public final class Huffman {
    ...
    private final void addCode(int i11, int i12, int i13) {
        ...
        ArraysKt___ArraysJvmKt.fill((T[]) children2, node, i16, (1 << i15) + i16);
    }

    public final void decode(@NotNull BufferedSource bufferedSource, long j11, @NotNull BufferedSink bufferedSink) {
    ...
    public final void encode(@org.jetbrains.annotations.NotNull okio.ByteString r9, @org.jetbrains.annotations.NotNull okio.BufferedSink r10) throws java.io.IOException {
        /*
            r8 = this;
