...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(@NotNull Request request) {
            ...
            while (i11 < size) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (Intrinsics.areEqual((Object) lowerCase, (Object) Http2ExchangeCodec.TE) && Intrinsics.areEqual((Object) headers.value(i11), (Object) "trailers"))) {
        ...
        public final Response.Builder readHttp2HeadersList(@NotNull Headers headers, @NotNull Protocol protocol) {
            ...
            Intrinsics.checkNotNullParameter(protocol, URLProtectionSpaceContract.FeedEntry.COLUMN_NAME_PROTOCOL);
            ...
            while (i11 < size) {
                ...
                if (Intrinsics.areEqual((Object) name2, (Object) Header.RESPONSE_STATUS_UTF8)) {
                    statusLine = StatusLine.Companion.parse(Intrinsics.stringPlus("HTTP/1.1 ", value));
                } else if (!Http2ExchangeCodec.HTTP_2_SKIPPED_RESPONSE_HEADERS.contains(name2)) {
    ...
    public void writeRequestHeaders(@NotNull Request request) {
        ...
        if (this.stream == null) {
            ...
            this.stream = this.http2Connection.newStream(Companion.http2HeadersList(request), z11);
            if (!this.canceled) {
                Http2Stream http2Stream = this.stream;
                Intrinsics.checkNotNull(http2Stream);
