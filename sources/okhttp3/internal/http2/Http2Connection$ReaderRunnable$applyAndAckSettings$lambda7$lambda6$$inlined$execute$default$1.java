...
public final class Http2Connection$ReaderRunnable$applyAndAckSettings$lambda7$lambda6$$inlined$execute$default$1 extends Task {
    ...
    public Http2Connection$ReaderRunnable$applyAndAckSettings$lambda7$lambda6$$inlined$execute$default$1(String str, boolean z11, Http2Connection http2Connection, Ref.ObjectRef objectRef) {
        super(str, z11);
        this.$name = str;
        this.$cancelable = z11;
