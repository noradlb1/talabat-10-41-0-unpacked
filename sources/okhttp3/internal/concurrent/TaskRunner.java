...
public final class TaskRunner {
    ...
    public interface Backend {
        ...
        void coordinatorWait(@NotNull TaskRunner taskRunner, long j11);
    ...
    public static final class RealBackend implements Backend {
        ...
        public void coordinatorWait(@NotNull TaskRunner taskRunner, long j11) throws InterruptedException {
            Intrinsics.checkNotNullParameter(taskRunner, "taskRunner");
    ...
    public final TaskQueue newQueue() {
        ...
        return new TaskQueue(this, Intrinsics.stringPlus("Q", Integer.valueOf(i11)));
    }
}
