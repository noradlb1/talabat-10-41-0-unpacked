...
public final class Exchange {
    ...
    public final class RequestBodySink extends ForwardingSink {
        ...
        public RequestBodySink(@NotNull Exchange exchange, Sink sink, long j11) {
            super(sink);
        ...
        private final <E extends IOException> E complete(E e11) {
            ...
            this.completed = true;
            return this.this$0.bodyComplete(this.bytesReceived, false, true, e11);
        }
    ...
    public final class ResponseBodySource extends ForwardingSource {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public ResponseBodySource(@NotNull Exchange exchange, Source source, long j11) {
            super(source);
            Intrinsics.checkNotNullParameter(exchange, "this$0");
        ...
        public final <E extends IOException> E complete(E e11) {
            ...
            return this.this$0.bodyComplete(this.bytesReceived, true, false, e11);
        }
    ...
    @NotNull
    public final Sink createRequestBody(@NotNull Request request, boolean z11) throws IOException {
