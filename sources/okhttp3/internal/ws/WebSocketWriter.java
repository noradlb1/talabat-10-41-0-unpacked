...
public final class WebSocketWriter implements Closeable {
    ...
    public WebSocketWriter(boolean z11, @NotNull BufferedSink bufferedSink, @NotNull Random random2, boolean z12, boolean z13, long j11) {
        byte[] bArr;
    ...
    public final void writeClose(int i11, @Nullable ByteString byteString) throws IOException {
    ...
    public final void writeMessageFrame(int i11, @NotNull ByteString byteString) throws IOException {
