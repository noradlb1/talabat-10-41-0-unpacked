...
public interface Interceptor {
    ...
    public interface Chain {
        ...
        @NotNull
        Chain withConnectTimeout(int i11, @NotNull TimeUnit timeUnit);

        @NotNull
        Chain withReadTimeout(int i11, @NotNull TimeUnit timeUnit);

        @NotNull
        Chain withWriteTimeout(int i11, @NotNull TimeUnit timeUnit);
