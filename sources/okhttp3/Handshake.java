...
public final class Handshake {
    ...
    public final CipherSuite m7955deprecated_cipherSuite() {
    ...
    public final List<Certificate> m7956deprecated_localCertificates() {
    ...
    public final Principal m7957deprecated_localPrincipal() {
    ...
    public final List<Certificate> m7958deprecated_peerCertificates() {
    ...
    public final Principal m7959deprecated_peerPrincipal() {
    ...
    public final TlsVersion m7960deprecated_tlsVersion() {
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof Handshake) {
            ...
            if (handshake.tlsVersion != this.tlsVersion || !Intrinsics.areEqual((Object) handshake.cipherSuite, (Object) this.cipherSuite) || !Intrinsics.areEqual((Object) handshake.peerCertificates(), (Object) peerCertificates()) || !Intrinsics.areEqual((Object) handshake.localCertificates, (Object) this.localCertificates)) {
                return false;
            }
            return true;
        }
    ...
    public String toString() {
        ...
        for (Certificate name2 : peerCertificates) {
            arrayList.add(getName(name2));
        }
        ...
        for (Certificate name3 : iterable) {
            arrayList2.add(getName(name3));
        }
    ...
    public static final class Companion {
        ...
        public final Handshake m7961deprecated_get(@NotNull SSLSession sSLSession) throws IOException {
        ...
        public final Handshake get(@NotNull SSLSession sSLSession) throws IOException {
            ...
            if (cipherSuite != null) {
                if (!(Intrinsics.areEqual((Object) cipherSuite, (Object) "TLS_NULL_WITH_NULL_NULL") ? true : Intrinsics.areEqual((Object) cipherSuite, (Object) "SSL_NULL_WITH_NULL_NULL"))) {
                    ...
                    } else if (!Intrinsics.areEqual((Object) Profile.DataLevel.NONE, (Object) protocol)) {
