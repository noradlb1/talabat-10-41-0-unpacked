...
final class RequestBuilder {
    private static final char[] HEX_DIGITS = {'0', ExpiryDateConstantsKt.EXPIRY_DATE_ZERO_POSITION_CHECK, '2', '3', '4', '5', '6', '7', '8', '9', 'A', 'B', 'C', 'D', 'E', 'F'};
    ...
    public RequestBuilder(String str, HttpUrl httpUrl, @Nullable String str2, @Nullable Headers headers, @Nullable MediaType mediaType, boolean z11, boolean z12, boolean z13) {
        this.method = str;
    ...
    public void addQueryParam(String str, @Nullable String str2, boolean z11) {
        String str3 = this.relativeUrl;
        if (str3 != null) {
