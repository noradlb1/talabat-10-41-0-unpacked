...
final class Utils {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public ParameterizedTypeImpl(@Nullable Type type, Type type2, Type... typeArr) {
            ...
            if (type2 instanceof Class) {
                ...
                if (z11 != (((Class) type2).getEnclosingClass() != null ? false : z12)) {
    ...
    public static RuntimeException methodError(Method method, @Nullable Throwable th2, String str, Object... objArr) {
        ...
        return new IllegalArgumentException(format + "\n    for method " + method.getDeclaringClass().getSimpleName() + RealDiscoveryConfigurationRepository.VERSION_DELIMETER + method.getName(), th2);
    }
