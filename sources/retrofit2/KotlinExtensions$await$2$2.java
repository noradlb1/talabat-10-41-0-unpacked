    ...
    public void onResponse(@NotNull Call<T> call, @NotNull Response<T> response) {
        ...
        if (response.isSuccessful()) {
            ...
            if (body == null) {
                ...
                CancellableContinuation cancellableContinuation = this.$continuation;
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m6329constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                return;
            }
        ...
        cancellableContinuation2.resumeWith(Result.m6329constructorimpl(ResultKt.createFailure(httpException)));
    }
}
