...
final class OkHttpCall<T> implements Call<T> {
    ...
    public static final class NoContentResponseBody extends ResponseBody {
        ...
        public NoContentResponseBody(@Nullable MediaType mediaType, long j11) {
    ...
    private Call createRawCall() throws IOException {
        ...
        if (!(factory instanceof OkHttpClient)) {
            call = factory.newCall(create);
        } else {
            call = OkHttp3Instrumentation.newCall((OkHttpClient) factory, create);
        }
        if (call != null) {
            return call;
        }
    ...
    public Response<T> parseResponse(Response response) throws IOException {
        ...
        NoContentResponseBody noContentResponseBody = new NoContentResponseBody(body.contentType(), body.contentLength());
        if (!(builder instanceof Response.Builder)) {
            builder2 = builder.body(noContentResponseBody);
        } else {
            builder2 = OkHttp3Instrumentation.body(builder, noContentResponseBody);
        }
