...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean z11) {
        ...
        if (getArguments().isEmpty()) {
            ...
            str2 = CollectionsKt___CollectionsKt.joinToString$default(getArguments(), IndicativeSentencesGeneration.DEFAULT_SEPARATOR, "<", ">", 0, (CharSequence) null, new TypeReference$asString$args$1(this), 24, (Object) null);
        }
        if (isMarkedNullable()) {
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof TypeReference) {
            ...
            if (!Intrinsics.areEqual((Object) getClassifier(), (Object) typeReference.getClassifier()) || !Intrinsics.areEqual((Object) getArguments(), (Object) typeReference.getArguments()) || !Intrinsics.areEqual((Object) this.platformTypeUpperBound, (Object) typeReference.platformTypeUpperBound) || this.flags != typeReference.flags) {
                return false;
            }
            return true;
        }
    ...
    public TypeReference(@NotNull KClassifier kClassifier, @NotNull List<KTypeProjection> list, boolean z11) {
        this(kClassifier, list, (KType) null, z11 ? 1 : 0);
        Intrinsics.checkNotNullParameter(kClassifier, "classifier");
        Intrinsics.checkNotNullParameter(list, Constant.PARAM_SQL_ARGUMENTS);
    }
