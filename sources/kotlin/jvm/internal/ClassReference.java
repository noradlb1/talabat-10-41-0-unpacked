...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (Object next : listOf) {
            ...
            arrayList.add(TuplesKt.to((Class) next, Integer.valueOf(i11)));
            i11 = i12;
        }
        ...
        for (String str : values) {
            ...
            Pair pair = TuplesKt.to(sb3, str + ".Companion");
            hashMap3.put(pair.getFirst(), pair.getSecond());
        }
        for (Map.Entry next2 : FUNCTION_CLASSES.entrySet()) {
            int intValue = ((Number) next2.getValue()).intValue();
            String name2 = ((Class) next2.getKey()).getName();
            hashMap3.put(name2, "kotlin.Function" + intValue);
        }
