...
class DurationUnitKt__DurationUnitJvmKt {
    ...
    public static final double convertDurationUnit(double d11, @NotNull DurationUnit durationUnit, @NotNull DurationUnit durationUnit2) {
    ...
    public static final long convertDurationUnitOverflow(long j11, @NotNull DurationUnit durationUnit, @NotNull DurationUnit durationUnit2) {
        Intrinsics.checkNotNullParameter(durationUnit, "sourceUnit");
        Intrinsics.checkNotNullParameter(durationUnit2, "targetUnit");
    ...
    @SinceKotlin(version = "1.5")
    public static final long convertDurationUnit(long j11, @NotNull DurationUnit durationUnit, @NotNull DurationUnit durationUnit2) {
        Intrinsics.checkNotNullParameter(durationUnit, "sourceUnit");
        Intrinsics.checkNotNullParameter(durationUnit2, "targetUnit");
        return durationUnit2.getTimeUnit$kotlin_stdlib().convert(j11, durationUnit.getTimeUnit$kotlin_stdlib());
    }
