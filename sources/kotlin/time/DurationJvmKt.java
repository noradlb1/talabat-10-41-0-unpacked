...
public final class DurationJvmKt {
    ...
    private static final DecimalFormat createFormatForDecimals(int i11) {
    ...
    public static final String formatToExactDecimals(double d11, int i11) {
        ...
        if (i11 < threadLocalArr.length) {
            ...
            if (decimalFormat2 == null) {
                decimalFormat2 = createFormatForDecimals(i11);
            ...
            decimalFormat = createFormatForDecimals(i11);
        }
    ...
    @NotNull
    public static final String formatUpToDecimals(double d11, int i11) {
        DecimalFormat createFormatForDecimals = createFormatForDecimals(0);
        createFormatForDecimals.setMaximumFractionDigits(i11);
        String format = createFormatForDecimals.format(d11);
