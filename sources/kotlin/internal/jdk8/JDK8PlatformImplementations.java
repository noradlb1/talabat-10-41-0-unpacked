...
public class JDK8PlatformImplementations extends JDK7PlatformImplementations {
    ...
    private final boolean sdkIsNullOrAtLeast(int i11) {
    ...
    public MatchGroup getMatchResultNamedGroup(@NotNull MatchResult matchResult, @NotNull String str) {
        ...
        if (matcher != null) {
            ...
            String a11 = matcher.group(str);
            Intrinsics.checkNotNullExpressionValue(a11, "matcher.group(name)");
            return new MatchGroup(a11, intRange);
        }
