...
class ExceptionsKt__ExceptionsKt {
    ...
    @HidesMembers
    public static void addSuppressed(@NotNull Throwable th2, @NotNull Throwable th3) {
    ...
    @InlineOnly
    private static final void printStackTrace(Throwable th2, PrintWriter printWriter) {
        Intrinsics.checkNotNullParameter(th2, "<this>");
    ...
    @InlineOnly
    private static final void printStackTrace(Throwable th2, PrintStream printStream) {
        Intrinsics.checkNotNullParameter(th2, "<this>");
