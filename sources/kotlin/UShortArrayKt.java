...
public final class UShortArrayKt {
    ...
    @InlineOnly
    private static final short[] UShortArray(int i11, Function1<? super Integer, UShort> function1) {
        Intrinsics.checkNotNullParameter(function1, "init");
        short[] sArr = new short[i11];
        for (int i12 = 0; i12 < i11; i12++) {
            sArr[i12] = function1.invoke(Integer.valueOf(i12)).m6656unboximpl();
        }
    ...
    private static final short[] m6675ushortArrayOfrL5Bavg(short... sArr) {
