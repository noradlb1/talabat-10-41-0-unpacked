...
public abstract class DeepRecursiveScope<T, R> {
    ...
    @Nullable
    public abstract Object callRecursive(T t11, @NotNull Continuation<? super R> continuation);

    @Nullable
    public abstract <U, S> Object callRecursive(@NotNull DeepRecursiveFunction<U, S> deepRecursiveFunction, U u11, @NotNull Continuation<? super S> continuation);
