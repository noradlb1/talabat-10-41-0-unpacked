...
public interface ClosedFloatingPointRange<T extends Comparable<? super T>> extends ClosedRange<T> {
    ...
    public static final class DefaultImpls {
        public static <T extends Comparable<? super T>> boolean contains(@NotNull ClosedFloatingPointRange<T> closedFloatingPointRange, @NotNull T t11) {
            Intrinsics.checkNotNullParameter(t11, "value");
            if (!closedFloatingPointRange.lessThanOrEquals(closedFloatingPointRange.getStart(), t11) || !closedFloatingPointRange.lessThanOrEquals(t11, closedFloatingPointRange.getEndInclusive())) {
                return false;
            }
            return true;
        }
