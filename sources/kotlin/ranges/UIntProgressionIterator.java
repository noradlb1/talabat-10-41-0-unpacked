...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker, j$.util.Iterator {
    ...
    private UIntProgressionIterator(int i11, int i12, int i13) {
        this.finalElement = i12;
        boolean z11 = true;
        int uintCompare = UnsignedKt.uintCompare(i11, i12);
        if (i13 <= 0 ? uintCompare < 0 : uintCompare > 0) {
            z11 = false;
        }
        this.hasNext = z11;
        this.step = UInt.m6423constructorimpl(i13);
        this.next = !this.hasNext ? i12 : i11;
    }

    public /* synthetic */ UIntProgressionIterator(int i11, int i12, int i13, DefaultConstructorMarker defaultConstructorMarker) {
        this(i11, i12, i13);
    }
    ...
    public /* bridge */ /* synthetic */ Object next() {
        return UInt.m6417boximpl(m9028nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA  reason: not valid java name */
    public int m9028nextpVg5ArA() {
        int i11 = this.next;
        if (i11 != this.finalElement) {
            this.next = UInt.m6423constructorimpl(this.step + i11);
