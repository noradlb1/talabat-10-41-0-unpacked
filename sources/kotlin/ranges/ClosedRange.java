...
public interface ClosedRange<T extends Comparable<? super T>> {
    ...
    public static final class DefaultImpls {
        public static <T extends Comparable<? super T>> boolean contains(@NotNull ClosedRange<T> closedRange, @NotNull T t11) {
            Intrinsics.checkNotNullParameter(t11, "value");
            if (t11.compareTo(closedRange.getStart()) < 0 || t11.compareTo(closedRange.getEndInclusive()) > 0) {
                return false;
            }
            return true;
        }
