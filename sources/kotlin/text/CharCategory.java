...
public enum CharCategory {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final CharCategory valueOf(int i11) {
            if (new IntRange(0, 16).contains(i11)) {
                return CharCategory.values()[i11];
            }
            if (new IntRange(18, 30).contains(i11)) {
                return CharCategory.values()[i11 - 1];
            }
