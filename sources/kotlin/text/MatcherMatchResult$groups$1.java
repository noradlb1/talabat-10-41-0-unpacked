...
public final class MatcherMatchResult$groups$1 extends AbstractCollection<MatchGroup> implements MatchNamedGroupCollection {
    ...
    public final /* synthetic */ MatcherMatchResult f25075b;

    public MatcherMatchResult$groups$1(MatcherMatchResult matcherMatchResult) {
        this.f25075b = matcherMatchResult;
    }
    ...
    public MatchGroup get(int i11) {
        IntRange access$range = RegexKt.range(this.f25075b.getMatchResult(), i11);
        if (access$range.getStart().intValue() < 0) {
            return null;
        }
        String group = this.f25075b.getMatchResult().group(i11);
        Intrinsics.checkNotNullExpressionValue(group, "matchResult.group(index)");
        return new MatchGroup(group, access$range);
    }

    public int getSize() {
        return this.f25075b.getMatchResult().groupCount() + 1;
    }
    ...
    public MatchGroup get(@NotNull String str) {
        ...
        return PlatformImplementationsKt.IMPLEMENTATIONS.getMatchResultNamedGroup(this.f25075b.getMatchResult(), str);
    }
}
