...
class StringsKt__AppendableKt {
    @NotNull
    public static final <T extends Appendable> T append(@NotNull T t11, @NotNull CharSequence... charSequenceArr) {
    ...
    public static <T> void appendElement(@NotNull Appendable appendable, T t11, @Nullable Function1<? super T, ? extends CharSequence> function1) {
        boolean z11;
    ...
    public static final <T extends Appendable> T appendRange(@NotNull T t11, @NotNull CharSequence charSequence, int i11, int i12) {
        Intrinsics.checkNotNullParameter(t11, "<this>");
        Intrinsics.checkNotNullParameter(charSequence, "value");
        T append = t11.append(charSequence, i11, i12);
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final Appendable appendLine(Appendable appendable, char c11) {
        Intrinsics.checkNotNullParameter(appendable, "<this>");
