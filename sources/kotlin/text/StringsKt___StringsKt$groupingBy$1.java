...
public final class StringsKt___StringsKt$groupingBy$1 implements Grouping<Character, K> {
    ...
    public final /* synthetic */ CharSequence f25099a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ Function1<Character, K> f25100b;

    public StringsKt___StringsKt$groupingBy$1(CharSequence charSequence, Function1<? super Character, ? extends K> function1) {
        this.f25099a = charSequence;
        this.f25100b = function1;
    }
    ...
    public Iterator<Character> sourceIterator() {
        return StringsKt__StringsKt.iterator(this.f25099a);
    }

    public K keyOf(char c11) {
        return this.f25100b.invoke(Character.valueOf(c11));
    }
}
