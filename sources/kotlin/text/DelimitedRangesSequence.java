...
final class DelimitedRangesSequence implements Sequence<IntRange> {
    ...
    public DelimitedRangesSequence(@NotNull CharSequence charSequence, int i11, int i12, @NotNull Function2<? super CharSequence, ? super Integer, Pair<Integer, Integer>> function2) {
