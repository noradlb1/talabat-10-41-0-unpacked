...
public final class RegexKt {
    ...
    private static final /* synthetic */ <T extends Enum<T> & FlagEnum> Set<T> fromInt(int i11) {
        Intrinsics.reifiedOperationMarker(4, "T");
        EnumSet<E> allOf = EnumSet.allOf(Enum.class);
        Intrinsics.checkNotNullExpressionValue(allOf, "fromInt$lambda$1");
        Intrinsics.needClassReification();
        boolean unused = CollectionsKt__MutableCollectionsKt.retainAll(allOf, new RegexKt$fromInt$1$1(i11));
    ...
    /* access modifiers changed from: private */
    public static final IntRange range(MatchResult matchResult, int i11) {
        return RangesKt___RangesKt.until(matchResult.start(i11), matchResult.end(i11));
    }
}
