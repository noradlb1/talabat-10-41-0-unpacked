...
public final class PropertyReferenceDelegatesKt {
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final <V> void setValue(KMutableProperty0<V> kMutableProperty0, Object obj, KProperty<?> kProperty, V v11) {
        Intrinsics.checkNotNullParameter(kMutableProperty0, "<this>");
        Intrinsics.checkNotNullParameter(kProperty, "property");
        kMutableProperty0.set(v11);
    }

    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final <T, V> V getValue(KProperty1<T, ? extends V> kProperty1, T t11, KProperty<?> kProperty) {
        Intrinsics.checkNotNullParameter(kProperty1, "<this>");
        Intrinsics.checkNotNullParameter(kProperty, "property");
        return kProperty1.get(t11);
    }

    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final <T, V> void setValue(KMutableProperty1<T, V> kMutableProperty1, T t11, KProperty<?> kProperty, V v11) {
        Intrinsics.checkNotNullParameter(kMutableProperty1, "<this>");
        Intrinsics.checkNotNullParameter(kProperty, "property");
        kMutableProperty1.set(t11, v11);
    }
}
