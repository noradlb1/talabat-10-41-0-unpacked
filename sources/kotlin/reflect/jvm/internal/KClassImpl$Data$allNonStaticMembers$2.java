...
public final class KClassImpl$Data$allNonStaticMembers$2 extends Lambda implements Function0<List<? extends KCallableImpl<?>>> {
    ...
    public final /* synthetic */ KClassImpl<T>.Data f24368g;
    ...
    public final List<KCallableImpl<?>> invoke() {
        return CollectionsKt___CollectionsKt.plus(this.f24368g.getDeclaredNonStaticMembers(), this.f24368g.getInheritedNonStaticMembers());
    }
}
