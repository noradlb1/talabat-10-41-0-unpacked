...
public class KProperty1Impl<T, V> extends KPropertyImpl<V> implements KProperty1<T, V> {
    ...
    @NotNull
    private final Lazy<Member> delegateSource = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, new KProperty1Impl$delegateSource$1(this));
    ...
    public Object getDelegate(T t11) {
        return c(this.delegateSource.getValue(), t11, (Object) null);
    }
