...
public final class DeserializedMemberScope$NoReorderImplementation$declaredProperties$2 extends Lambda implements Function0<List<? extends PropertyDescriptor>> {
    ...
    public final /* synthetic */ DeserializedMemberScope.NoReorderImplementation f24893g;
    ...
    public DeserializedMemberScope$NoReorderImplementation$declaredProperties$2(DeserializedMemberScope.NoReorderImplementation noReorderImplementation) {
        super(0);
        this.f24893g = noReorderImplementation;
    }

    @NotNull
    public final List<PropertyDescriptor> invoke() {
        return this.f24893g.computeProperties();
    }
}
