...
public final class ProtoTypeTableUtilKt {
    ...
    @Nullable
    public static final ProtoBuf.Type inlineClassUnderlyingType(@NotNull ProtoBuf.Class classR, @NotNull TypeTable typeTable) {
    ...
    public static final List<ProtoBuf.Type> supertypes(@NotNull ProtoBuf.Class classR, @NotNull TypeTable typeTable) {
        ...
        if (supertypeList == null) {
            ...
            supertypeList = new ArrayList<>(CollectionsKt__IterablesKt.collectionSizeOrDefault(iterable, 10));
    ...
    public static final List<ProtoBuf.Type> upperBounds(@NotNull ProtoBuf.TypeParameter typeParameter, @NotNull TypeTable typeTable) {
        ...
        if (upperBoundList == null) {
            ...
            upperBoundList = new ArrayList<>(CollectionsKt__IterablesKt.collectionSizeOrDefault(iterable, 10));
            for (Integer num : iterable) {
                Intrinsics.checkNotNullExpressionValue(num, "it");
