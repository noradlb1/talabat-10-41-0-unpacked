...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    public class CopyConfiguration {
        ...
        private static /* synthetic */ void $$$reportNull$$$0(int i11) {
            ...
            throw ((i12 == 1 || i12 == 2 || i12 == 3 || i12 == 5 || i12 == 7 || i12 == 9 || i12 == 11 || i12 == 19 || i12 == 13 || i12 == 14 || i12 == 16 || i12 == 17) ? new IllegalStateException(format) : new IllegalArgumentException(format));
        }
        ...
        public CopyConfiguration() {
            ...
            this.f24555name = PropertyDescriptorImpl.this.getName();
            this.returnType = PropertyDescriptorImpl.this.getType();
        }

        @Nullable
        public PropertyDescriptor build() {
            return PropertyDescriptorImpl.this.c(this);
        }
        ...
        public PropertySetterDescriptor n() {
            PropertyDescriptor propertyDescriptor = this.original;
            if (propertyDescriptor == null) {
                return null;
            }
    ...
    public static PropertyDescriptorImpl create(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Annotations annotations, @NotNull Modality modality2, @NotNull DescriptorVisibility descriptorVisibility, boolean z11, @NotNull Name name2, @NotNull CallableMemberDescriptor.Kind kind2, @NotNull SourceElement sourceElement, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16, boolean z17) {
        ...
        return new PropertyDescriptorImpl(declarationDescriptor, (PropertyDescriptor) null, annotations, modality2, descriptorVisibility, z11, name2, kind2, sourceElement, z12, z13, z14, z15, z16, z17);
    }
    ...
    private static DescriptorVisibility normalizeVisibility(DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind2) {
        if (kind2 != CallableMemberDescriptor.Kind.FAKE_OVERRIDE || !DescriptorVisibilities.isPrivate(descriptorVisibility.normalize())) {
    ...
    @NotNull
    public PropertyDescriptorImpl b(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Modality modality2, @NotNull DescriptorVisibility descriptorVisibility, @Nullable PropertyDescriptor propertyDescriptor, @NotNull CallableMemberDescriptor.Kind kind2, @NotNull Name name2, @NotNull SourceElement sourceElement) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(32);
        }
        if (modality2 == null) {
        ...
        return new PropertyDescriptorImpl(declarationDescriptor, propertyDescriptor, getAnnotations(), modality2, descriptorVisibility, isVar(), name2, kind2, sourceElement, isLateInit(), isConst(), isExpect(), isActual(), isExternal(), isDelegated());
    }

    @Nullable
    public PropertyDescriptor c(@NotNull CopyConfiguration copyConfiguration) {
        ...
        PropertyDescriptorImpl b11 = b(copyConfiguration.owner, copyConfiguration.modality, copyConfiguration.visibility, copyConfiguration.original, copyConfiguration.kind, copyConfiguration.f24555name, getSourceToUseForCopy(copyConfiguration.preserveSourceElement, copyConfiguration.original));
        ...
        TypeSubstitutor substituteTypeParameters = DescriptorSubstitutor.substituteTypeParameters(list, copyConfiguration.substitution, b11, arrayList);
        KotlinType b12 = copyConfiguration.returnType;
        KotlinType substitute = substituteTypeParameters.substitute(b12, Variance.OUT_VARIANCE);
        FieldDescriptorImpl fieldDescriptorImpl2 = null;
        if (substitute == null) {
            return null;
        }
        KotlinType substitute2 = substituteTypeParameters.substitute(b12, Variance.IN_VARIANCE);
        if (substitute2 != null) {
            b11.setInType(substitute2);
        }
        ReceiverParameterDescriptor c11 = copyConfiguration.dispatchReceiverParameter;
        if (c11 != null) {
            ReceiverParameterDescriptor substitute3 = c11.substitute(substituteTypeParameters);
            if (substitute3 == null) {
                return null;
            }
        ...
        if (receiverParameterDescriptor3 != null) {
            receiverParameterDescriptor2 = substituteParameterDescriptor(substituteTypeParameters, b11, receiverParameterDescriptor3);
        } else {
        ...
        for (ReceiverParameterDescriptor substituteContextParameterDescriptor : this.contextReceiverParameters) {
            ReceiverParameterDescriptor substituteContextParameterDescriptor2 = substituteContextParameterDescriptor(substituteTypeParameters, b11, substituteContextParameterDescriptor);
            if (substituteContextParameterDescriptor2 != null) {
                arrayList2.add(substituteContextParameterDescriptor2);
            }
        }
        b11.setType(substitute, arrayList, receiverParameterDescriptor, receiverParameterDescriptor2, arrayList2);
        if (this.getter == null) {
            propertyGetterDescriptorImpl = null;
        } else {
            propertyGetterDescriptorImpl = new PropertyGetterDescriptorImpl(b11, this.getter.getAnnotations(), copyConfiguration.modality, normalizeVisibility(this.getter.getVisibility(), copyConfiguration.kind), this.getter.isDefault(), this.getter.isExternal(), this.getter.isInline(), copyConfiguration.kind, copyConfiguration.m(), SourceElement.NO_SOURCE);
        }
        ...
        if (this.setter == null) {
            ...
            propertySetterDescriptorImpl = new PropertySetterDescriptorImpl(b11, this.setter.getAnnotations(), copyConfiguration.modality, normalizeVisibility(this.setter.getVisibility(), copyConfiguration.kind), this.setter.isDefault(), this.setter.isExternal(), this.setter.isInline(), copyConfiguration.kind, copyConfiguration.n(), SourceElement.NO_SOURCE);
        }
        ...
        if (fieldDescriptor == null) {
            ...
            fieldDescriptorImpl = new FieldDescriptorImpl(fieldDescriptor.getAnnotations(), b11);
        }
        FieldDescriptor fieldDescriptor2 = this.delegateField;
        if (fieldDescriptor2 != null) {
            fieldDescriptorImpl2 = new FieldDescriptorImpl(fieldDescriptor2.getAnnotations(), b11);
        }
        b11.initialize(propertyGetterDescriptorImpl, propertySetterDescriptorImpl, fieldDescriptorImpl, fieldDescriptorImpl2);
        ...
        if (isConst() && (function0 = this.f24562e) != null) {
            b11.setCompileTimeInitializer(this.f24561d, function0);
        }
        return b11;
    }
    ...
    @NotNull
    public PropertyDescriptor copy(DeclarationDescriptor declarationDescriptor, Modality modality2, DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind2, boolean z11) {
        PropertyDescriptor build = newCopyBuilder().setOwner(declarationDescriptor).setOriginal((CallableMemberDescriptor) null).setModality(modality2).setVisibility(descriptorVisibility).setKind(kind2).setCopyOverrides(z11).build();
        if (build == null) {
            $$$reportNull$$$0(42);
        }
        return build;
