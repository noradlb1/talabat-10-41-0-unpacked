...
public class ClassDescriptorImpl extends ClassDescriptorBase {
    ...
    public ClassDescriptorImpl(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Name name2, @NotNull Modality modality2, @NotNull ClassKind classKind, @NotNull Collection<KotlinType> collection, @NotNull SourceElement sourceElement, boolean z11, @NotNull StorageManager storageManager) {
        super(storageManager, declarationDescriptor, name2, sourceElement, z11);
