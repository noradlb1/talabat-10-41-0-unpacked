...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    public ClassDescriptor createClass(@NotNull ClassId classId) {
        ...
        PackageFragmentDescriptor packageFragmentDescriptor = (FunctionInterfacePackageFragment) CollectionsKt___CollectionsKt.firstOrNull(arrayList2);
        if (packageFragmentDescriptor == null) {
            packageFragmentDescriptor = (BuiltInsPackageFragment) CollectionsKt___CollectionsKt.first(arrayList);
        }
    ...
    public boolean shouldCreateClass(@NotNull FqName fqName, @NotNull Name name2) {
        ...
        if ((StringsKt__StringsJVMKt.startsWith$default(asString, "Function", false, 2, (Object) null) || StringsKt__StringsJVMKt.startsWith$default(asString, "KFunction", false, 2, (Object) null) || StringsKt__StringsJVMKt.startsWith$default(asString, "SuspendFunction", false, 2, (Object) null) || StringsKt__StringsJVMKt.startsWith$default(asString, "KSuspendFunction", false, 2, (Object) null)) && FunctionClassKind.Companion.parseClassName(asString, fqName) != null) {
            return true;
        }
        return false;
    }
