...
public final class JvmBuiltInClassDescriptorFactory implements ClassDescriptorFactory {
    ...
    public static final /* synthetic */ KProperty<Object>[] f24462a = {Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(JvmBuiltInClassDescriptorFactory.class), "cloneable", "getCloneable()Lorg/jetbrains/kotlin/descriptors/impl/ClassDescriptorImpl;"))};
    @NotNull
    ...
    private final ClassDescriptorImpl getCloneable() {
        return (ClassDescriptorImpl) StorageKt.getValue(this.cloneable$delegate, (Object) this, (KProperty<?>) f24462a[0]);
    }
    ...
    public boolean shouldCreateClass(@NotNull FqName fqName, @NotNull Name name2) {
        Intrinsics.checkNotNullParameter(fqName, "packageFqName");
        Intrinsics.checkNotNullParameter(name2, "name");
        if (!Intrinsics.areEqual((Object) name2, (Object) CLONEABLE_NAME) || !Intrinsics.areEqual((Object) fqName, (Object) KOTLIN_FQ_NAME)) {
            return false;
        }
        return true;
    }
    ...
    public /* synthetic */ JvmBuiltInClassDescriptorFactory(StorageManager storageManager, ModuleDescriptor moduleDescriptor2, Function1 function1, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(storageManager, moduleDescriptor2, (i11 & 4) != 0 ? AnonymousClass1.INSTANCE : function1);
    }
}
