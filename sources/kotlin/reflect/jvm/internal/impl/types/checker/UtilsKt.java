...
public final class UtilsKt {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        m7574debugInfo$lambda1$unaryPlus("type: " + typeConstructor, sb2);
        m7574debugInfo$lambda1$unaryPlus("hashCode: " + typeConstructor.hashCode(), sb2);
        m7574debugInfo$lambda1$unaryPlus("javaClass: " + typeConstructor.getClass().getCanonicalName(), sb2);
        for (DeclarationDescriptor declarationDescriptor = typeConstructor.getDeclarationDescriptor(); declarationDescriptor != null; declarationDescriptor = declarationDescriptor.getContainingDeclaration()) {
            m7574debugInfo$lambda1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(declarationDescriptor), sb2);
            m7574debugInfo$lambda1$unaryPlus("javaClass: " + declarationDescriptor.getClass().getCanonicalName(), sb2);
        }
    ...
    private static final StringBuilder m7574debugInfo$lambda1$unaryPlus(String str, StringBuilder sb2) {
