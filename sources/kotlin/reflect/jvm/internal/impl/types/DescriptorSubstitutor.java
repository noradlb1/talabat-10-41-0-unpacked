...
public class DescriptorSubstitutor {
    private static /* synthetic */ void $$$reportNull$$$0(int i11) {
        ...
        throw (i11 != 4 ? new IllegalArgumentException(format) : new IllegalStateException(format));
    }
    ...
    public static TypeSubstitutor substituteTypeParameters(@NotNull List<TypeParameterDescriptor> list, @NotNull TypeSubstitution typeSubstitution, @NotNull DeclarationDescriptor declarationDescriptor, @NotNull List<TypeParameterDescriptor> list2, @Nullable boolean[] zArr) {
        ...
        for (TypeParameterDescriptor next : list) {
            TypeParameterDescriptorImpl createForFurtherModification = TypeParameterDescriptorImpl.createForFurtherModification(declarationDescriptor, next.getAnnotations(), next.isReified(), next.getVariance(), next.getName(), i11, SourceElement.NO_SOURCE, next.getStorageManager());
