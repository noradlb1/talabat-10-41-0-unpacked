...
public class DescriptorUtils {
    ...
    private static <D extends CallableDescriptor> void collectAllOverriddenDescriptors(@NotNull D d11, @NotNull Set<D> set) {
        if (d11 == null) {
            $$$reportNull$$$0(70);
        }
        if (set == null) {
        ...
        if (!set.contains(d11)) {
            for (CallableDescriptor original : d11.getOriginal().getOverriddenDescriptors()) {
    ...
    @NotNull
    public static <D extends CallableDescriptor> Set<D> getAllOverriddenDescriptors(@NotNull D d11) {
        if (d11 == null) {
            $$$reportNull$$$0(68);
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        collectAllOverriddenDescriptors(d11.getOriginal(), linkedHashSet);
    ...
    @NotNull
    public static <D extends CallableMemberDescriptor> D unwrapFakeOverride(@NotNull D d11) {
        if (d11 == null) {
            $$$reportNull$$$0(59);
        }
        while (d11.getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            Collection overriddenDescriptors = d11.getOverriddenDescriptors();
            if (!overriddenDescriptors.isEmpty()) {
                d11 = (CallableMemberDescriptor) overriddenDescriptors.iterator().next();
            } else {
    ...
    @NotNull
    public static <D extends DeclarationDescriptorWithVisibility> D unwrapFakeOverrideToAnyDeclaration(@NotNull D d11) {
        if (d11 == null) {
            $$$reportNull$$$0(61);
        }
        if (d11 instanceof CallableMemberDescriptor) {
            return unwrapFakeOverride((CallableMemberDescriptor) d11);
        }
        if (d11 == null) {
            $$$reportNull$$$0(62);
        }
    ...
    @Nullable
    public static <D extends DeclarationDescriptor> D getParentOfType(@Nullable D d11, @NotNull Class<D> cls, boolean z11) {
        if (cls == null) {
            $$$reportNull$$$0(19);
        }
        if (d11 == null) {
        ...
        if (z11) {
            d11 = d11.getContainingDeclaration();
        }
        while (d11 != null) {
            if (cls.isInstance(d11)) {
                return d11;
            }
            d11 = d11.getContainingDeclaration();
        }
