...
public final class DescriptorResolverUtils {
    private static /* synthetic */ void $$$reportNull$$$0(int i11) {
        ...
        throw (i11 != 18 ? new IllegalArgumentException(format) : new IllegalStateException(format));
    }

    @Nullable
    public static ValueParameterDescriptor getAnnotationParameterByName(@NotNull Name name2, @NotNull ClassDescriptor classDescriptor) {
        if (name2 == null) {
            $$$reportNull$$$0(19);
        }
    ...
    private static <D extends CallableMemberDescriptor> Collection<D> resolveOverrides(@NotNull Name name2, @NotNull Collection<D> collection, @NotNull Collection<D> collection2, @NotNull ClassDescriptor classDescriptor, @NotNull final ErrorReporter errorReporter, @NotNull OverridingUtil overridingUtil, final boolean z11) {
        ...
        overridingUtil.generateOverridesInFunctionGroup(name2, collection, collection2, classDescriptor, new NonReportingOverrideStrategy() {
            private static /* synthetic */ void $$$reportNull$$$0(int i11) {
    ...
    @NotNull
    public static <D extends CallableMemberDescriptor> Collection<D> resolveOverridesForNonStaticMembers(@NotNull Name name2, @NotNull Collection<D> collection, @NotNull Collection<D> collection2, @NotNull ClassDescriptor classDescriptor, @NotNull ErrorReporter errorReporter, @NotNull OverridingUtil overridingUtil) {
        if (name2 == null) {
            $$$reportNull$$$0(0);
        }
        if (collection == null) {
        ...
        return resolveOverrides(name2, collection, collection2, classDescriptor, errorReporter, overridingUtil, false);
    }

    @NotNull
    public static <D extends CallableMemberDescriptor> Collection<D> resolveOverridesForStaticMembers(@NotNull Name name2, @NotNull Collection<D> collection, @NotNull Collection<D> collection2, @NotNull ClassDescriptor classDescriptor, @NotNull ErrorReporter errorReporter, @NotNull OverridingUtil overridingUtil) {
        if (name2 == null) {
            $$$reportNull$$$0(6);
        }
        if (collection == null) {
        ...
        return resolveOverrides(name2, collection, collection2, classDescriptor, errorReporter, overridingUtil, true);
    }
}
