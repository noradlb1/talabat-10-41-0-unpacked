...
public final class KPackageImpl$Data$scope$2 extends Lambda implements Function0<MemberScope> {
    ...
    public final /* synthetic */ KPackageImpl.Data f24412g;
    ...
    public final MemberScope invoke() {
        ReflectKotlinClass access$getKotlinClass = this.f24412g.getKotlinClass();
        if (access$getKotlinClass != null) {
            return this.f24412g.getModuleData().getPackagePartScopeCache().getPackagePartScope(access$getKotlinClass);
        }
