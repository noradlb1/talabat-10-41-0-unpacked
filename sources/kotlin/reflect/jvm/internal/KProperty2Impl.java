...
public class KProperty2Impl<D, E, V> extends KPropertyImpl<V> implements KProperty2<D, E, V> {
    ...
    @NotNull
    private final Lazy<Member> delegateSource = LazyKt__LazyJVMKt.lazy(LazyThreadSafetyMode.PUBLICATION, new KProperty2Impl$delegateSource$1(this));
    ...
    public Object getDelegate(D d11, E e11) {
        return c(this.delegateSource.getValue(), d11, e11);
    }
