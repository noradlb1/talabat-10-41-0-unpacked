...
public final class KClassImpl$Data$descriptor$2 extends Lambda implements Function0<ClassDescriptor> {
    ...
    public final /* synthetic */ KClassImpl<T> f24375g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public KClassImpl$Data$descriptor$2(KClassImpl<T> kClassImpl) {
        super(0);
        this.f24375g = kClassImpl;
    }

    public final ClassDescriptor invoke() {
        ClassDescriptor classDescriptor;
        ClassId access$getClassId = this.f24375g.getClassId();
        RuntimeModuleData moduleData = this.f24375g.getData().invoke().getModuleData();
        ...
        Void unused = this.f24375g.reportUnresolvedClass();
        throw null;
    }
}
