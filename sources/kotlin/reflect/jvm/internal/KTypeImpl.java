...
public final class KTypeImpl implements KTypeBase {
    ...
    public static final /* synthetic */ KProperty<Object>[] f24432b;
    @NotNull
    ...
    static {
        ...
        f24432b = new KProperty[]{Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(cls), "classifier", "getClassifier()Lkotlin/reflect/KClassifier;")), Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(cls), Constant.PARAM_SQL_ARGUMENTS, "getArguments()Ljava/util/List;"))};
    }
    ...
    public List<KTypeProjection> getArguments() {
        Object value = this.arguments$delegate.getValue(this, f24432b[1]);
    ...
    public KClassifier getClassifier() {
        return (KClassifier) this.classifier$delegate.getValue(this, f24432b[0]);
    }
    ...
    @NotNull
    public final KTypeImpl makeNullableAsSpecified$kotlin_reflection(boolean z11) {
        if (!FlexibleTypesKt.isFlexible(this.type) && isMarkedNullable() == z11) {
            return this;
        }
        KotlinType makeNullableAsSpecified = TypeUtils.makeNullableAsSpecified(this.type, z11);
