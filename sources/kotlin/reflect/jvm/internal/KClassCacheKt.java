...
public final class KClassCacheKt {
    ...
    public static final <T> KClassImpl<T> getOrCreateKotlinClass(@NotNull Class<T> cls) {
        ...
        Object obj = K_CLASS_CACHE.get(name2);
        Class<T> cls3 = null;
        if (obj instanceof WeakReference) {
            ...
            HashPMap<String, Object> plus = K_CLASS_CACHE.plus(name2, weakReferenceArr);
            Intrinsics.checkNotNullExpressionValue(plus, "K_CLASS_CACHE.plus(name, newArray)");
            K_CLASS_CACHE = plus;
            return kClassImpl3;
        }
        KClassImpl<T> kClassImpl4 = new KClassImpl<>(cls);
        HashPMap<String, Object> plus2 = K_CLASS_CACHE.plus(name2, new WeakReference(kClassImpl4));
