...
final class ParameterizedTypeImpl implements ParameterizedType, TypeImpl {
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof ParameterizedType) {
            ...
            if (!Intrinsics.areEqual((Object) this.rawType, (Object) parameterizedType.getRawType()) || !Intrinsics.areEqual((Object) this.ownerType, (Object) parameterizedType.getOwnerType()) || !Arrays.equals(getActualTypeArguments(), parameterizedType.getActualTypeArguments())) {
                return false;
            }
            return true;
        }
    ...
    public String getTypeName() {
        ...
        if (!z11) {
            Appendable unused = ArraysKt___ArraysKt.joinTo$default((Object[]) typeArr, (Appendable) sb2, (CharSequence) null, (CharSequence) "<", (CharSequence) ">", 0, (CharSequence) null, (Function1) ParameterizedTypeImpl$getTypeName$1$1.INSTANCE, 50, (Object) null);
        }
