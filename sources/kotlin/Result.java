...
public final class Result<T> implements Serializable {
    ...
    public static final class Companion {
        ...
        private final <T> Object failure(Throwable th2) {
            Intrinsics.checkNotNullParameter(th2, "exception");
            return Result.m6329constructorimpl(ResultKt.createFailure(th2));
        }

        @InlineOnly
        @JvmName(name = "success")
        private final <T> Object success(T t11) {
            return Result.m6329constructorimpl(t11);
        }
    }
    ...
    public static final /* synthetic */ Result m6328boximpl(Object obj) {
    ...
    public static <T> Object m6329constructorimpl(@Nullable Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m6330equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m6338unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m6331equalsimpl0(Object obj, Object obj2) {
        return Intrinsics.areEqual(obj, obj2);
    }

    @Nullable
    /* renamed from: exceptionOrNull-impl  reason: not valid java name */
    public static final Throwable m6332exceptionOrNullimpl(Object obj) {
    ...
    private static final T m6333getOrNullimpl(Object obj) {
        if (m6335isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static int m6334hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static final boolean m6335isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* renamed from: isSuccess-impl  reason: not valid java name */
    public static final boolean m6336isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m6337toStringimpl(Object obj) {
        if (obj instanceof Failure) {
    ...
    public int hashCode() {
        return m6334hashCodeimpl(this.value);
    }

    @NotNull
    public String toString() {
        return m6337toStringimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m6338unboximpl() {
        return this.value;
    }
}
