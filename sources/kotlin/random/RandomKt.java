...
public final class RandomKt {
    ...
    public static final Random Random(int i11) {
    ...
    public static final String boundsErrorMessage(@NotNull Object obj, @NotNull Object obj2) {
        ...
        return "Random range is empty: [" + obj + IndicativeSentencesGeneration.DEFAULT_SEPARATOR + obj2 + ").";
    }
    ...
    public static final long nextLong(@NotNull Random random, @NotNull LongRange longRange) {
        Intrinsics.checkNotNullParameter(random, "<this>");
        Intrinsics.checkNotNullParameter(longRange, BasketDeliveryFeeTiersInfoKeys.KEY_RANGE);
    ...
    @NotNull
    @SinceKotlin(version = "1.3")
    public static final Random Random(long j11) {
