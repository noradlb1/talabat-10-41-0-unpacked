...
class PreconditionsKt__PreconditionsKt extends PreconditionsKt__AssertionsJVMKt {
    @InlineOnly
    private static final void check(boolean z11) {
        if (!z11) {
    ...
    @InlineOnly
    private static final <T> T checkNotNull(T t11) {
        if (t11 != null) {
            return t11;
        }
    ...
    @InlineOnly
    private static final void require(boolean z11) {
        if (!z11) {
    ...
    @InlineOnly
    private static final <T> T requireNotNull(T t11) {
        if (t11 != null) {
            return t11;
        }
    ...
    @InlineOnly
    private static final void check(boolean z11, Function0<? extends Object> function0) {
    ...
    @InlineOnly
    private static final <T> T checkNotNull(T t11, Function0<? extends Object> function0) {
        Intrinsics.checkNotNullParameter(function0, "lazyMessage");
        if (t11 != null) {
            return t11;
        }
    ...
    @InlineOnly
    private static final void require(boolean z11, Function0<? extends Object> function0) {
        Intrinsics.checkNotNullParameter(function0, "lazyMessage");
        if (!z11) {
    ...
    @InlineOnly
    private static final <T> T requireNotNull(T t11, Function0<? extends Object> function0) {
        Intrinsics.checkNotNullParameter(function0, "lazyMessage");
        if (t11 != null) {
            return t11;
        }
