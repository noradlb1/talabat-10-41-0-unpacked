...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public final Object getOrThrow() {
        ...
        if (obj == coroutineSingletons) {
            if (a.a(RESULT, this, coroutineSingletons, IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public void resumeWith(@NotNull Object obj) {
        while (true) {
            ...
            if (obj2 == coroutineSingletons) {
                if (a.a(RESULT, this, coroutineSingletons, obj)) {
                    return;
                }
            } else if (obj2 != IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                throw new IllegalStateException("Already resumed");
            } else if (a.a(RESULT, this, IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
