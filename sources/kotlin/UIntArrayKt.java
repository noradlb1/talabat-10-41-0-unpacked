...
public final class UIntArrayKt {
    ...
    @InlineOnly
    private static final int[] UIntArray(int i11, Function1<? super Integer, UInt> function1) {
        Intrinsics.checkNotNullParameter(function1, "init");
        int[] iArr = new int[i11];
        for (int i12 = 0; i12 < i11; i12++) {
            iArr[i12] = function1.invoke(Integer.valueOf(i12)).m6474unboximpl();
        }
    ...
    private static final int[] m6493uintArrayOfajY9A(int... iArr) {
