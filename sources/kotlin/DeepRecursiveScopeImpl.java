...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public DeepRecursiveScopeImpl(@NotNull Function3<? super DeepRecursiveScope<T, R>, ? super T, ? super Continuation<? super R>, ? extends Object> function3, T t11) {
    ...
    @Nullable
    public Object callRecursive(T t11, @NotNull Continuation<? super R> continuation) {
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation == null) {
                ...
                return r11;
            } else if (Result.m6331equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r11)) {
                try {
                    ...
                    if (invoke != IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        continuation.resumeWith(Result.m6329constructorimpl(invoke));
                    }
                } catch (Throwable th2) {
    ...
    @Nullable
    public <U, S> Object callRecursive(@NotNull DeepRecursiveFunction<U, S> deepRecursiveFunction, U u11, @NotNull Continuation<? super S> continuation) {
