...
public final class ComparisonsKt__ComparisonsKt$thenByDescending$2<T> implements Comparator {
    ...
    public final /* synthetic */ Comparator<T> f23843b;

    /* renamed from: c  reason: collision with root package name */
    public final /* synthetic */ Comparator<? super K> f23844c;

    /* renamed from: d  reason: collision with root package name */
    public final /* synthetic */ Function1<T, K> f23845d;
    ...
    public ComparisonsKt__ComparisonsKt$thenByDescending$2(Comparator<T> comparator, Comparator<? super K> comparator2, Function1<? super T, ? extends K> function1) {
        this.f23843b = comparator;
        this.f23844c = comparator2;
        this.f23845d = function1;
    }

    public final int compare(T t11, T t12) {
        int compare = this.f23843b.compare(t11, t12);
        if (compare != 0) {
            return compare;
        }
        Comparator<? super K> comparator = this.f23844c;
        Function1<T, K> function1 = this.f23845d;
