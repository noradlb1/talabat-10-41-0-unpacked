...
public final class ComparisonsKt__ComparisonsKt$thenBy$1<T> implements Comparator {
    ...
    public final /* synthetic */ Comparator<T> f23836b;

    /* renamed from: c  reason: collision with root package name */
    public final /* synthetic */ Function1<T, Comparable<?>> f23837c;

    public ComparisonsKt__ComparisonsKt$thenBy$1(Comparator<T> comparator, Function1<? super T, ? extends Comparable<?>> function1) {
        this.f23836b = comparator;
        this.f23837c = function1;
    }

    public final int compare(T t11, T t12) {
        int compare = this.f23836b.compare(t11, t12);
        if (compare != 0) {
            return compare;
        }
        Function1<T, Comparable<?>> function1 = this.f23837c;
        return ComparisonsKt__ComparisonsKt.compareValues(function1.invoke(t11), function1.invoke(t12));
    }
}
