...
class ComparisonsKt__ComparisonsKt {
    ...
    public static final <T> int compareValuesBy(T t11, T t12, @NotNull Function1<? super T, ? extends Comparable<?>>... function1Arr) {
        Intrinsics.checkNotNullParameter(function1Arr, "selectors");
        if (function1Arr.length > 0) {
            return compareValuesByImpl$ComparisonsKt__ComparisonsKt(t11, t12, function1Arr);
        }
        throw new IllegalArgumentException("Failed requirement.".toString());
    }

    /* access modifiers changed from: private */
    public static final <T> int compareValuesByImpl$ComparisonsKt__ComparisonsKt(T t11, T t12, Function1<? super T, ? extends Comparable<?>>[] function1Arr) {
        for (Function1<? super T, ? extends Comparable<?>> function1 : function1Arr) {
            int compareValues = compareValues((Comparable) function1.invoke(t11), (Comparable) function1.invoke(t12));
            if (compareValues != 0) {
    ...
    @InlineOnly
    private static final <T> int compareValuesBy(T t11, T t12, Function1<? super T, ? extends Comparable<?>> function1) {
        Intrinsics.checkNotNullParameter(function1, "selector");
        return compareValues((Comparable) function1.invoke(t11), (Comparable) function1.invoke(t12));
    }
    ...
    @InlineOnly
    private static final <T, K> int compareValuesBy(T t11, T t12, Comparator<? super K> comparator, Function1<? super T, ? extends K> function1) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        Intrinsics.checkNotNullParameter(function1, "selector");
