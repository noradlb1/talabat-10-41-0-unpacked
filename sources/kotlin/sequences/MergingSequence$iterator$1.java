...
public final class MergingSequence$iterator$1 implements Iterator<V>, KMappedMarker, j$.util.Iterator {

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ MergingSequence<T1, T2, V> f24992b;
    @NotNull
    ...
    public V next() {
        return this.f24992b.transform.invoke(this.iterator1.next(), this.iterator2.next());
    }
