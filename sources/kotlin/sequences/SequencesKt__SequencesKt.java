...
class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    @NotNull
    public static <T> Sequence<T> generateSequence(@NotNull Function0<? extends T> function0) {
    ...
    public static <T> Sequence<T> generateSequence(@Nullable T t11, @NotNull Function1<? super T, ? extends T> function1) {
        Intrinsics.checkNotNullParameter(function1, "nextFunction");
        if (t11 == null) {
            return EmptySequence.INSTANCE;
        }
        return new GeneratorSequence(new SequencesKt__SequencesKt$generateSequence$2(t11), function1);
    }
