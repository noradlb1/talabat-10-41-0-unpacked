...
public final class TransformingSequence$iterator$1 implements Iterator<R>, KMappedMarker, j$.util.Iterator {

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ TransformingSequence<T, R> f25068b;
    @NotNull
    private final Iterator<T> iterator;

    public TransformingSequence$iterator$1(TransformingSequence<T, R> transformingSequence) {
        this.f25068b = transformingSequence;
    ...
    public R next() {
        return this.f25068b.transformer.invoke(this.iterator.next());
    }
