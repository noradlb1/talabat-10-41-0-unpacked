...
public final class FilteringSequence$iterator$1 implements Iterator<T>, KMappedMarker, j$.util.Iterator {

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ FilteringSequence<T> f24989b;
    @NotNull
    ...
    public FilteringSequence$iterator$1(FilteringSequence<T> filteringSequence) {
        this.f24989b = filteringSequence;
    ...
    private final void calcNext() {
        while (this.iterator.hasNext()) {
            ...
            if (((Boolean) this.f24989b.predicate.invoke(next)).booleanValue() == this.f24989b.sendWhen) {
                this.nextItem = next;
                this.nextState = 1;
                return;
            }
