...
public final class DropWhileSequence$iterator$1 implements Iterator<T>, KMappedMarker, j$.util.Iterator {

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ DropWhileSequence<T> f24988b;
    ...
    public DropWhileSequence$iterator$1(DropWhileSequence<T> dropWhileSequence) {
        this.f24988b = dropWhileSequence;
    ...
    private final void drop() {
        while (this.iterator.hasNext()) {
            ...
            if (!((Boolean) this.f24988b.predicate.invoke(next)).booleanValue()) {
                this.nextItem = next;
                this.dropState = 1;
                return;
            }
