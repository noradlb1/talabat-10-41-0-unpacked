...
public final class TransformingIndexedSequence$iterator$1 implements Iterator<R>, KMappedMarker, j$.util.Iterator {

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ TransformingIndexedSequence<T, R> f25067b;
    private int index;
    @NotNull
    private final Iterator<T> iterator;

    public TransformingIndexedSequence$iterator$1(TransformingIndexedSequence<T, R> transformingIndexedSequence) {
        this.f25067b = transformingIndexedSequence;
    ...
    public R next() {
        Function2 access$getTransformer$p = this.f25067b.transformer;
        int i11 = this.index;
        this.index = i11 + 1;
        if (i11 < 0) {
            CollectionsKt__CollectionsKt.throwIndexOverflow();
        }
        return access$getTransformer$p.invoke(Integer.valueOf(i11), this.iterator.next());
    }
