...
class SequencesKt__SequenceBuilderKt {
    ...
    public static <T> Iterator<T> iterator(@NotNull @BuilderInference Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
    ...
    @NotNull
    @SinceKotlin(version = "1.3")
    public static <T> Sequence<T> sequence(@NotNull @BuilderInference Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        Intrinsics.checkNotNullParameter(function2, "block");
