...
class StandardKt__StandardKt {
    ...
    @InlineOnly
    private static final <T> T also(T t11, Function1<? super T, Unit> function1) {
    ...
    @InlineOnly
    private static final <T> T apply(T t11, Function1<? super T, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "block");
        function1.invoke(t11);
        return t11;
    }
    ...
    @InlineOnly
    private static final <T, R> R let(T t11, Function1<? super T, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(function1, "block");
        return function1.invoke(t11);
    }

    @InlineOnly
    private static final void repeat(int i11, Function1<? super Integer, Unit> function1) {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <T> T takeIf(T t11, Function1<? super T, Boolean> function1) {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <T> T takeUnless(T t11, Function1<? super T, Boolean> function1) {
        Intrinsics.checkNotNullParameter(function1, "predicate");
        if (!function1.invoke(t11).booleanValue()) {
            return t11;
        }
    ...
    @InlineOnly
    private static final <T, R> R with(T t11, Function1<? super T, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(function1, "block");
        return function1.invoke(t11);
    }
    ...
    @InlineOnly
    private static final <T, R> R run(T t11, Function1<? super T, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(function1, "block");
        return function1.invoke(t11);
    }
}
