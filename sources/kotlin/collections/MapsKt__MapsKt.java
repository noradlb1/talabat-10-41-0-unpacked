...
class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    @InlineOnly
    private static final <K, V> boolean contains(Map<? extends K, ? extends V> map, K k11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return map.containsKey(k11);
    }

    @InlineOnly
    private static final <K> boolean containsKey(Map<? extends K, ?> map, K k11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return map.containsKey(k11);
    }

    @InlineOnly
    private static final <K, V> boolean containsValue(Map<K, ? extends V> map, V v11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @NotNull
    public static final <K, V, M extends Map<? super K, ? super V>> M filterNotTo(@NotNull Map<? extends K, ? extends V> map, @NotNull M m11, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, Boolean> function1) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        Intrinsics.checkNotNullParameter(function1, "predicate");
        for (Map.Entry next : map.entrySet()) {
            if (!function1.invoke(next).booleanValue()) {
                m11.put(next.getKey(), next.getValue());
            }
        }
        return m11;
    }
    ...
    @NotNull
    public static final <K, V, M extends Map<? super K, ? super V>> M filterTo(@NotNull Map<? extends K, ? extends V> map, @NotNull M m11, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, Boolean> function1) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        Intrinsics.checkNotNullParameter(function1, "predicate");
        for (Map.Entry next : map.entrySet()) {
    ...
    @InlineOnly
    private static final <K, V> V get(Map<? extends K, ? extends V> map, K k11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return map.get(k11);
    }

    @InlineOnly
    private static final <K, V> V getOrElse(Map<K, ? extends V> map, K k11, Function0<? extends V> function0) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    public static final <K, V> V getOrElseNullable(@NotNull Map<K, ? extends V> map, K k11, @NotNull Function0<? extends V> function0) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(function0, "defaultValue");
        V v11 = map.get(k11);
    ...
    public static final <K, V> V getOrPut(@NotNull Map<K, V> map, K k11, @NotNull Function0<? extends V> function0) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(function0, "defaultValue");
        V v11 = map.get(k11);
        if (v11 != null) {
    ...
    public static <K, V> V getValue(@NotNull Map<K, ? extends V> map, K k11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return MapsKt__MapWithDefaultKt.getOrImplicitDefaultNullable(map, k11);
    }
    ...
    @NotNull
    public static final <K, V, R, M extends Map<? super R, ? super V>> M mapKeysTo(@NotNull Map<? extends K, ? extends V> map, @NotNull M m11, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        Intrinsics.checkNotNullParameter(function1, "transform");
        for (T next : map.entrySet()) {
            m11.put(function1.invoke(next), ((Map.Entry) next).getValue());
        }
        return m11;
    }
    ...
    @NotNull
    public static final <K, V, R, M extends Map<? super K, ? super R>> M mapValuesTo(@NotNull Map<? extends K, ? extends V> map, @NotNull M m11, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> function1) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        Intrinsics.checkNotNullParameter(function1, "transform");
        for (T next : map.entrySet()) {
            m11.put(((Map.Entry) next).getKey(), function1.invoke(next));
        }
        return m11;
    }
    ...
    @NotNull
    @SinceKotlin(version = "1.1")
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, K k11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <K, V> void minusAssign(Map<K, V> map, K k11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        map.remove(k11);
    }
    ...
    public static <K, V> void putAll(@NotNull Map<? super K, ? super V> map, @NotNull Pair<? extends K, ? extends V>[] pairArr) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairArr, "pairs");
    ...
    @InlineOnly
    private static final <K, V> V remove(Map<? extends K, V> map, K k11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return TypeIntrinsics.asMutableMap(map).remove(k11);
    }

    @InlineOnly
    private static final <K, V> void set(Map<K, V> map, K k11, V v11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        map.put(k11, v11);
    }
    ...
    @InlineOnly
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    private static final <K, V> Map<K, V> buildMap(int i11, @BuilderInference Function1<? super Map<K, V>, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "builderAction");
        Map createMapBuilder = MapsKt__MapsJVMKt.createMapBuilder(i11);
        function1.invoke(createMapBuilder);
        return MapsKt__MapsJVMKt.build(createMapBuilder);
    }
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, @NotNull Iterable<? extends K> iterable) {
        ...
        Map mutableMap = toMutableMap(map);
        boolean unused = CollectionsKt__MutableCollectionsKt.removeAll(mutableMap.keySet(), iterable);
        return optimizeReadOnlyMap(mutableMap);
    }
    ...
    private static final <K, V> void minusAssign(Map<K, V> map, Iterable<? extends K> iterable) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(iterable, UserMetadata.KEYDATA_FILENAME);
        boolean unused = CollectionsKt__MutableCollectionsKt.removeAll(map.keySet(), iterable);
    }
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, @NotNull K[] kArr) {
        ...
        Map mutableMap = toMutableMap(map);
        boolean unused = CollectionsKt__MutableCollectionsKt.removeAll(mutableMap.keySet(), (T[]) kArr);
        return optimizeReadOnlyMap(mutableMap);
    }
    ...
    private static final <K, V> void minusAssign(Map<K, V> map, K[] kArr) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(kArr, UserMetadata.KEYDATA_FILENAME);
        boolean unused = CollectionsKt__MutableCollectionsKt.removeAll(map.keySet(), (T[]) kArr);
    }
    ...
    public static <K, V> void putAll(@NotNull Map<? super K, ? super V> map, @NotNull Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(iterable, "pairs");
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, @NotNull Sequence<? extends K> sequence) {
        ...
        Map mutableMap = toMutableMap(map);
        boolean unused = CollectionsKt__MutableCollectionsKt.removeAll(mutableMap.keySet(), sequence);
        return optimizeReadOnlyMap(mutableMap);
    }
    ...
    private static final <K, V> void minusAssign(Map<K, V> map, Sequence<? extends K> sequence) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(sequence, UserMetadata.KEYDATA_FILENAME);
        boolean unused = CollectionsKt__MutableCollectionsKt.removeAll(map.keySet(), sequence);
    }
    ...
    public static <K, V> void putAll(@NotNull Map<? super K, ? super V> map, @NotNull Sequence<? extends Pair<? extends K, ? extends V>> sequence) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(sequence, "pairs");
    ...
    @NotNull
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Iterable<? extends Pair<? extends K, ? extends V>> iterable, @NotNull M m11) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        putAll(m11, iterable);
        return m11;
    ...
    @NotNull
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Pair<? extends K, ? extends V>[] pairArr, @NotNull M m11) {
        Intrinsics.checkNotNullParameter(pairArr, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        putAll(m11, pairArr);
        return m11;
    ...
    @NotNull
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Sequence<? extends Pair<? extends K, ? extends V>> sequence, @NotNull M m11) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        putAll(m11, sequence);
        return m11;
    ...
    @NotNull
    @SinceKotlin(version = "1.1")
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Map<? extends K, ? extends V> map, @NotNull M m11) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        m11.putAll(map);
        return m11;
