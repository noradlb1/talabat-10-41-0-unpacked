...
class MapsKt__MapsJVMKt extends MapsKt__MapWithDefaultKt {
    ...
    public static final <K, V> V getOrPut(@NotNull ConcurrentMap<K, V> concurrentMap, K k11, @NotNull Function0<? extends V> function0) {
    ...
    @PublishedApi
    public static int mapCapacity(int i11) {
        if (i11 < 0) {
            return i11;
        }
        if (i11 < 3) {
    ...
    @PublishedApi
    @InlineOnly
    private static final <K, V> Map<K, V> buildMapInternal(int i11, Function1<? super Map<K, V>, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "builderAction");
        Map createMapBuilder = createMapBuilder(i11);
        function1.invoke(createMapBuilder);
        return build(createMapBuilder);
    }
    ...
    @PublishedApi
    @NotNull
    public static <K, V> Map<K, V> createMapBuilder(int i11) {
