...
class GroupingKt__GroupingKt extends GroupingKt__GroupingJVMKt {
    ...
    public static final <T, K, R> Map<K, R> aggregate(@NotNull Grouping<T, ? extends K> grouping, @NotNull Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> function4) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            linkedHashMap.put(keyOf, function4.invoke(keyOf, obj, next, Boolean.valueOf(z11)));
        }
    ...
    @NotNull
    @SinceKotlin(version = "1.1")
    public static final <T, K, R, M extends Map<? super K, R>> M aggregateTo(@NotNull Grouping<T, ? extends K> grouping, @NotNull M m11, @NotNull Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> function4) {
        boolean z11;
        Intrinsics.checkNotNullParameter(grouping, "<this>");
        ...
        while (sourceIterator.hasNext()) {
            T next = sourceIterator.next();
            Object keyOf = grouping.keyOf(next);
            Object obj = m11.get(keyOf);
            if (obj != null || m11.containsKey(keyOf)) {
                z11 = false;
            } else {
                z11 = true;
            }
            m11.put(keyOf, function4.invoke(keyOf, obj, next, Boolean.valueOf(z11)));
        }
        return m11;
    }
    ...
    @NotNull
    @SinceKotlin(version = "1.1")
    public static final <T, K, M extends Map<? super K, Integer>> M eachCountTo(@NotNull Grouping<T, ? extends K> grouping, @NotNull M m11) {
        boolean z11;
        Intrinsics.checkNotNullParameter(grouping, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        Iterator<T> sourceIterator = grouping.sourceIterator();
        while (sourceIterator.hasNext()) {
            ...
            m11.put(keyOf, Integer.valueOf(((Number) obj).intValue() + 1));
        }
        return m11;
    }
    ...
    @NotNull
    @SinceKotlin(version = "1.1")
    public static final <T, K, R, M extends Map<? super K, R>> M foldTo(@NotNull Grouping<T, ? extends K> grouping, @NotNull M m11, @NotNull Function2<? super K, ? super T, ? extends R> function2, @NotNull Function3<? super K, ? super R, ? super T, ? extends R> function3) {
        Intrinsics.checkNotNullParameter(grouping, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        Intrinsics.checkNotNullParameter(function2, "initialValueSelector");
        Intrinsics.checkNotNullParameter(function3, "operation");
        ...
        while (sourceIterator.hasNext()) {
            ...
            m11.put(keyOf, function3.invoke(keyOf, obj, next));
        }
        return m11;
    }
    ...
    @NotNull
    @SinceKotlin(version = "1.1")
    public static final <T, K, R, M extends Map<? super K, R>> M foldTo(@NotNull Grouping<T, ? extends K> grouping, @NotNull M m11, R r11, @NotNull Function2<? super R, ? super T, ? extends R> function2) {
        Intrinsics.checkNotNullParameter(grouping, "<this>");
        Intrinsics.checkNotNullParameter(m11, "destination");
        ...
        while (sourceIterator.hasNext()) {
            ...
            Object keyOf = grouping.keyOf(next);
            R r12 = m11.get(keyOf);
            if (r12 == null && !m11.containsKey(keyOf)) {
                r12 = r11;
            }
            m11.put(keyOf, function2.invoke(r12, next));
        }
        return m11;
    }
    ...
    @NotNull
    @SinceKotlin(version = "1.1")
    public static final <T, K, R> Map<K, R> fold(@NotNull Grouping<T, ? extends K> grouping, R r11, @NotNull Function2<? super R, ? super T, ? extends R> function2) {
        Intrinsics.checkNotNullParameter(grouping, "<this>");
        Intrinsics.checkNotNullParameter(function2, "operation");
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        Iterator<T> sourceIterator = grouping.sourceIterator();
        while (sourceIterator.hasNext()) {
            T next = sourceIterator.next();
            Object keyOf = grouping.keyOf(next);
            R r12 = linkedHashMap.get(keyOf);
            if (r12 == null && !linkedHashMap.containsKey(keyOf)) {
                r12 = r11;
            }
            linkedHashMap.put(keyOf, function2.invoke(r12, next));
        }
        return linkedHashMap;
    }
}
