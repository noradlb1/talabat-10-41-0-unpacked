...
class SetsKt__SetsJVMKt {
    ...
    @NotNull
    public static <T> TreeSet<T> sortedSetOf(@NotNull T... tArr) {
    ...
    @PublishedApi
    @InlineOnly
    private static final <E> Set<E> buildSetInternal(int i11, Function1<? super Set<E>, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "builderAction");
        Set createSetBuilder = createSetBuilder(i11);
        function1.invoke(createSetBuilder);
        return build(createSetBuilder);
    }
    ...
    @PublishedApi
    @NotNull
    public static <E> Set<E> createSetBuilder(int i11) {
