...
public final class AbstractMap$keys$1$iterator$1 implements Iterator<K>, KMappedMarker, j$.util.Iterator {

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ Iterator<Map.Entry<K, V>> f23752b;
    ...
    public boolean hasNext() {
        return this.f23752b.hasNext();
    }

    public K next() {
        return this.f23752b.next().getKey();
    }
