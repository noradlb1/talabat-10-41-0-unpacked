...
final class MutableMapWithDefaultImpl<K, V> implements MutableMapWithDefault<K, V> {
    ...
    private final Function1<K, V> f430default;
    @NotNull
    ...
    public V getOrImplicitDefault(K k11) {
        Map map2 = getMap();
        V v11 = map2.get(k11);
        if (v11 != null || map2.containsKey(k11)) {
            return v11;
        }
        return this.f430default.invoke(k11);
    }
