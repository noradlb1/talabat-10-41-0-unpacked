...
public final class SlidingWindowKt {
    ...
    @NotNull
    public static final <T> Iterator<List<T>> windowedIterator(@NotNull Iterator<? extends T> it, int i11, int i12, boolean z11, boolean z12) {
        Intrinsics.checkNotNullParameter(it, "iterator");
        if (!it.hasNext()) {
            return EmptyIterator.INSTANCE;
        }
        return SequencesKt__SequenceBuilderKt.iterator(new SlidingWindowKt$windowedIterator$1(i11, i12, it, z12, z11, (Continuation<? super SlidingWindowKt$windowedIterator$1>) null));
    }
    ...
    public static final <T> Sequence<List<T>> windowedSequence(@NotNull Sequence<? extends T> sequence, int i11, int i12, boolean z11, boolean z12) {
        ...
        return new SlidingWindowKt$windowedSequence$$inlined$Sequence$1(sequence, i11, i12, z11, z12);
    }
}
