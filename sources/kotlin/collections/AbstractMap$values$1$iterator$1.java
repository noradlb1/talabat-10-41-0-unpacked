...
public final class AbstractMap$values$1$iterator$1 implements Iterator<V>, KMappedMarker, j$.util.Iterator {

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ Iterator<Map.Entry<K, V>> f23755b;
    ...
    public boolean hasNext() {
        return this.f23755b.hasNext();
    }

    public V next() {
        return this.f23755b.next().getValue();
    }
