...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    private final Map.Entry<K, V> implFindEntry(K k11) {
        Object obj;
        ...
        while (true) {
            ...
            obj = it.next();
            if (Intrinsics.areEqual(((Map.Entry) obj).getKey(), (Object) k11)) {
                break;
            }
        }
    ...
    public String toString() {
        return CollectionsKt___CollectionsKt.joinToString$default(entrySet(), IndicativeSentencesGeneration.DEFAULT_SEPARATOR, "{", "}", 0, (CharSequence) null, new AbstractMap$toString$1(this), 24, (Object) null);
    }
