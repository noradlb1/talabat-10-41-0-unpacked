...
class SetsKt__SetsKt extends SetsKt__SetsJVMKt {
    ...
    public static final <T> Set<T> setOfNotNull(@Nullable T t11) {
        return t11 != null ? SetsKt__SetsJVMKt.setOf(t11) : emptySet();
    }

    @SinceKotlin(version = "1.6")
    @InlineOnly
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    private static final <E> Set<E> buildSet(int i11, @BuilderInference Function1<? super Set<E>, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "builderAction");
        Set createSetBuilder = SetsKt__SetsJVMKt.createSetBuilder(i11);
        function1.invoke(createSetBuilder);
        return SetsKt__SetsJVMKt.build(createSetBuilder);
    }
