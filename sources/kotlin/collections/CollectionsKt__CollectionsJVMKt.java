...
class CollectionsKt__CollectionsJVMKt {
    ...
    @PublishedApi
    @InlineOnly
    private static final int checkCountOverflow(int i11) {
        if (i11 < 0) {
    ...
    @PublishedApi
    @InlineOnly
    private static final int checkIndexOverflow(int i11) {
        if (i11 < 0) {
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
    ...
    @NotNull
    public static final <T> Object[] copyToArrayOfAny(@NotNull T[] tArr, boolean z11) {
        Intrinsics.checkNotNullParameter(tArr, "<this>");
        Class<Object[]> cls = Object[].class;
        if (z11 && Intrinsics.areEqual((Object) tArr.getClass(), (Object) cls)) {
            return tArr;
        }
    ...
    @PublishedApi
    @InlineOnly
    private static final <E> List<E> buildListInternal(int i11, Function1<? super List<E>, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "builderAction");
        List createListBuilder = createListBuilder(i11);
        function1.invoke(createListBuilder);
        return build(createListBuilder);
    }
    ...
    @PublishedApi
    @NotNull
    public static <E> List<E> createListBuilder(int i11) {
