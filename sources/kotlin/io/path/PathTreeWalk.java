...
public final class PathTreeWalk implements Sequence<Path> {
    ...
    private final Iterator<Path> bfsIterator() {
        return SequencesKt__SequenceBuilderKt.iterator(new PathTreeWalk$bfsIterator$1(this, (Continuation<? super PathTreeWalk$bfsIterator$1>) null));
    }

    private final Iterator<Path> dfsIterator() {
        return SequencesKt__SequenceBuilderKt.iterator(new PathTreeWalk$dfsIterator$1(this, (Continuation<? super PathTreeWalk$dfsIterator$1>) null));
    }

    /* access modifiers changed from: private */
    public final boolean getFollowLinks() {
        return ArraysKt___ArraysKt.contains((T[]) this.options, PathWalkOption.FOLLOW_LINKS);
    }

    /* access modifiers changed from: private */
    public final boolean getIncludeDirectories() {
        return ArraysKt___ArraysKt.contains((T[]) this.options, PathWalkOption.INCLUDE_DIRECTORIES);
    }
    ...
    private final boolean isBFS() {
        return ArraysKt___ArraysKt.contains((T[]) this.options, PathWalkOption.BREADTH_FIRST);
    }
