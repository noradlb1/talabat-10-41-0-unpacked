...
public final class FileTreeWalk implements Sequence<File> {
    ...
    @Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\b\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u000f\u0010\u0011B\u0007¢\u0006\u0004\b\r\u0010\u000eJ\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0002J\u000b\u0010\u0006\u001a\u0004\u0018\u00010\u0002H\u0010J\b\u0010\b\u001a\u00020\u0007H\u0014R\u001a\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\n0\t8\u0002X\u0004¢\u0006\u0006\n\u0004\b\u000b\u0010\f¨\u0006\u0012"}, d2 = {"Lkotlin/io/FileTreeWalk$FileTreeWalkIterator;", "Lkotlin/collections/AbstractIterator;", "Ljava/io/File;", "root", "Lkotlin/io/FileTreeWalk$DirectoryState;", "directoryState", "gotoNext", "", "a", "Ljava/util/ArrayDeque;", "Lkotlin/io/FileTreeWalk$WalkState;", "state", "Ljava/util/ArrayDeque;", "<init>", "(Lkotlin/io/FileTreeWalk;)V", "BottomUpDirectoryState", "SingleFileState", "TopDownDirectoryState", "kotlin-stdlib"}, k = 1, mv = {1, 7, 1})
    public final class FileTreeWalkIterator extends AbstractIterator<File> {
        ...
        public final class BottomUpDirectoryState extends DirectoryState {
            ...
            public final /* synthetic */ FileTreeWalkIterator f23867a;
            ...
            public BottomUpDirectoryState(@NotNull FileTreeWalkIterator fileTreeWalkIterator, File file) {
                super(file);
                Intrinsics.checkNotNullParameter(file, "rootDir");
                this.f23867a = fileTreeWalkIterator;
            }
        ...
        public final class SingleFileState extends WalkState {
            ...
            /* renamed from: a  reason: collision with root package name */
            public final /* synthetic */ FileTreeWalkIterator f23868a;
            ...
            public SingleFileState(@NotNull FileTreeWalkIterator fileTreeWalkIterator, File file) {
                ...
                this.f23868a = fileTreeWalkIterator;
            }
        ...
        public final class TopDownDirectoryState extends DirectoryState {
            ...
            /* renamed from: a  reason: collision with root package name */
            public final /* synthetic */ FileTreeWalkIterator f23869a;
            private int fileIndex;
            @Nullable
            private File[] fileList;
            private boolean rootVisited;
            ...
            public TopDownDirectoryState(@NotNull FileTreeWalkIterator fileTreeWalkIterator, File file) {
                super(file);
                Intrinsics.checkNotNullParameter(file, "rootDir");
                this.f23869a = fileTreeWalkIterator;
            }
            ...
            public java.io.File step() {
                /*
                    ...
                    kotlin.io.FileTreeWalk$FileTreeWalkIterator r0 = r10.f23869a
        ...
        private final DirectoryState directoryState(File file) {
            int i11 = WhenMappings.$EnumSwitchMapping$0[FileTreeWalk.this.direction.ordinal()];
            if (i11 == 1) {
    ...
    private FileTreeWalk(File file, FileWalkDirection fileWalkDirection, Function1<? super File, Boolean> function1, Function1<? super File, Unit> function12, Function2<? super File, ? super IOException, Unit> function2, int i11) {
        this.start = file;
    ...
    @NotNull
    public final FileTreeWalk maxDepth(int i11) {
        if (i11 > 0) {
            return new FileTreeWalk(this.start, this.direction, this.onEnter, this.onLeave, this.onFail, i11);
        }
    ...
    public /* synthetic */ FileTreeWalk(File file, FileWalkDirection fileWalkDirection, Function1 function1, Function1 function12, Function2 function2, int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public FileTreeWalk(@NotNull File file, @NotNull FileWalkDirection fileWalkDirection) {
        ...
        Intrinsics.checkNotNullParameter(fileWalkDirection, HiAnalyticsConstant.HaKey.BI_KEY_DIRECTION);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ FileTreeWalk(File file, FileWalkDirection fileWalkDirection, int i11, DefaultConstructorMarker defaultConstructorMarker) {
