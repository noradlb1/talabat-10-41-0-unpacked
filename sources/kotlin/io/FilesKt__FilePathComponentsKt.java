...
class FilesKt__FilePathComponentsKt {
    ...
    private static final int getRootLength$FilesKt__FilePathComponentsKt(String str) {
        ...
        if (indexOf$default2 == 0) {
            if (str.length() <= 1 || str.charAt(1) != (c11 = File.separatorChar) || (indexOf$default = StringsKt__StringsKt.indexOf$default((CharSequence) str, c11, 2, false, 4, (Object) null)) < 0) {
                return 1;
            }
            ...
            if (indexOf$default2 != -1 || !StringsKt__StringsKt.endsWith$default((CharSequence) str, (char) AbstractJsonLexerKt.COLON, false, 2, (Object) null)) {
                return 0;
            }
            return str.length();
        }
    ...
    @NotNull
    public static final File subPath(@NotNull File file, int i11, int i12) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        return toComponents(file).subPath(i11, i12);
    }
