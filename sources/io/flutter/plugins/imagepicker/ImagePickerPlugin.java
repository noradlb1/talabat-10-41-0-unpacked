...
public class ImagePickerPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {
    ...
    public class LifeCycleObserver implements Application.ActivityLifecycleCallbacks, DefaultLifecycleObserver {
        ...
        public void onActivityStopped(Activity activity) {
            if (this.thisActivity == activity) {
                ImagePickerPlugin.this.delegate.d();
            }
        }
    ...
    @VisibleForTesting
    public final ImagePickerDelegate b(Activity activity2) {
    ...
    public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
        ...
        switch (c11) {
            ...
            case 3:
                this.delegate.c(methodResultWrapper);
                return;
            default:
