...
class FileUtils {
    ...
    private static String getImageExtension(Context context, Uri uri) {
        ...
        return RealDiscoveryConfigurationRepository.VERSION_DELIMETER + str;
    }
    ...
    public java.lang.String a(android.content.Context r5, android.net.Uri r6) {
        /*
            r4 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x005d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.flutter.plugins.imagepicker.FileUtils.a(android.content.Context, android.net.Uri):java.lang.String");
    }
}
