...
public class RestorationChannel {
    ...
    public RestorationChannel(@NonNull DartExecutor dartExecutor, @NonNull boolean z11) {
    ...
    public void setRestorationData(@NonNull final byte[] bArr) {
        ...
        if (result != null) {
            ...
            this.channel.invokeMethod(Constants.PUSH, packageData(bArr), new MethodChannel.Result() {
    ...
    public RestorationChannel(MethodChannel methodChannel, @NonNull boolean z11) {
