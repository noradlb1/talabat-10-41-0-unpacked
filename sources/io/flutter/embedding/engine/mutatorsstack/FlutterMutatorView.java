...
public class FlutterMutatorView extends FrameLayout {
    ...
    public ViewTreeObserver.OnGlobalFocusChangeListener f14196b;
    private int left;
    ...
    public FlutterMutatorView(@NonNull Context context, float f11, @Nullable AndroidTouchProcessor androidTouchProcessor2) {
    ...
    public void readyToDisplay(@NonNull FlutterMutatorsStack flutterMutatorsStack, int i11, int i12, int i13, int i14) {
    ...
    public void setOnDescendantFocusChangeListener(@NonNull final View.OnFocusChangeListener onFocusChangeListener) {
        ...
        if (viewTreeObserver.isAlive() && this.f14196b == null) {
    ...
    public void unsetOnDescendantFocusChangeListener() {
        ...
        ViewTreeObserver viewTreeObserver = getViewTreeObserver();
        if (viewTreeObserver.isAlive() && (onGlobalFocusChangeListener = this.f14196b) != null) {
            this.f14196b = null;
