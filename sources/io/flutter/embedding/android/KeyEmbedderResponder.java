...
public class KeyEmbedderResponder implements KeyboardManager.Responder {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14155a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f14155a     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    private void sendKeyEvent(KeyData keyData, KeyboardManager.Responder.OnKeyEventHandledCallback onKeyEventHandledCallback) {
        ...
        if (onKeyEventHandledCallback == null) {
            ...
            iVar = new i(onKeyEventHandledCallback);
        }
        this.messenger.send(KeyData.CHANNEL, keyData.a(), iVar);
    }
    ...
    private void synthesizeEvent(boolean z11, Long l11, Long l12, long j11) {
        ...
        keyData.f14150b = type;
        keyData.f14152d = l11.longValue();
        keyData.f14151c = l12.longValue();
        keyData.f14154f = null;
        keyData.f14153e = true;
    ...
    public void d(KeyboardMap.PressingGoal pressingGoal, boolean z11, long j11, long j12, KeyEvent keyEvent, ArrayList<Runnable> arrayList) {
        ...
        while (true) {
            ...
            if (keyPair.logicalKey == j11) {
                int i12 = AnonymousClass1.f14155a[getEventType(keyEvent).ordinal()];
                if (i12 != 1) {
                    if (i12 == 2) {
                        ...
                        if (!z11) {
                            arrayList2.add(new k(this, keyPair, keyEvent));
                        } else {
                    ...
                    if (!z11) {
                        arrayList2.add(new j(this, keyPair, j12, keyEvent));
                    }
                }
            } else {
    ...
    public void e(KeyboardMap.TogglingGoal togglingGoal, boolean z11, long j11, KeyEvent keyEvent) {
    ...
    public void f(@NonNull Long l11, @Nullable Long l12) {
        if (l12 != null) {
