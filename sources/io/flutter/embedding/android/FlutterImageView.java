...
public class FlutterImageView extends View implements RenderSurface {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14133a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public FlutterImageView(@NonNull Context context, int i11, int i12, SurfaceKind surfaceKind) {
    ...
    private void updateCurrentBitmap() {
        if (Build.VERSION.SDK_INT >= 29) {
            HardwareBuffer a11 = this.currentImage.getHardwareBuffer();
            this.currentBitmap = Bitmap.wrapHardwareBuffer(a11, ColorSpace.get(ColorSpace.Named.SRGB));
            a11.close();
            return;
        }
    ...
    public void attachToRenderer(@NonNull FlutterRenderer flutterRenderer2) {
        if (AnonymousClass1.f14133a[this.kind.ordinal()] == 1) {
