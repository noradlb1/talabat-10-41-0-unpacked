...
public class AndroidTouchProcessor {
    ...
    public AndroidTouchProcessor(@NonNull FlutterRenderer flutterRenderer, boolean z11) {
    ...
    private void addPointerForIndex(MotionEvent motionEvent, int i11, int i12, int i13, Matrix matrix, ByteBuffer byteBuffer) {
        ...
        if (i16 != -1) {
            if (this.trackMotionEvents) {
                j11 = this.motionEventTracker.track(motionEvent2).getId();
            } else {
                j11 = 0;
            }
            ...
            if (pointerDeviceTypeForToolType == 1) {
                j12 = (long) (motionEvent.getButtonState() & 31);
                if (j12 == 0 && motionEvent.getSource() == 8194 && i16 == 4) {
                    this.ongoingPans.put(Integer.valueOf(motionEvent.getPointerId(i11)), fArr);
                }
            } else {
                j12 = pointerDeviceTypeForToolType == 2 ? (long) ((motionEvent.getButtonState() >> 4) & 15) : 0;
            }
            ...
            if (containsKey) {
                byteBuffer2.putLong((long) getPointerChangeForPanZoom(i16));
            ...
            if (pointerDeviceTypeForToolType == 2) {
                byteBuffer2.putDouble((double) motionEvent2.getAxisValue(24, i15));
                d13 = 0.0d;
                byteBuffer2.putDouble(0.0d);
            } else {
                d13 = 0.0d;
            ...
            byteBuffer2.putDouble(d13);
            byteBuffer2.putDouble((double) motionEvent2.getAxisValue(8, i15));
            if (pointerDeviceTypeForToolType == 2) {
                byteBuffer2.putDouble((double) motionEvent2.getAxisValue(25, i15));
            } else {
                byteBuffer2.putDouble(d13);
            }
            ...
            byteBuffer2.putDouble(d14);
            if (containsKey && getPointerChangeForPanZoom(i16) == 9) {
