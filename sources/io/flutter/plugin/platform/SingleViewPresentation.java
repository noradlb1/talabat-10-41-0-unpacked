...
class SingleViewPresentation extends Presentation {
    ...
    public static class PresentationContext extends ContextWrapper {
        ...
        private boolean isCalledFromAlertDialog() {
            ...
            while (i11 < stackTrace.length && i11 < 11) {
                if (stackTrace[i11].getClassName().equals(AlertDialog.class.getCanonicalName()) && stackTrace[i11].getMethodName().equals(MethodDescription.CONSTRUCTOR_INTERNAL_NAME)) {
                    return true;
                }
                i11++;
            }
    ...
    public static class WindowManagerHandler implements InvocationHandler {
        ...
        public FakeWindowViewGroup f14273a;
        ...
        public WindowManagerHandler(WindowManager windowManager, FakeWindowViewGroup fakeWindowViewGroup) {
            ...
            this.f14273a = fakeWindowViewGroup;
        }

        private void addView(Object[] objArr) {
            FakeWindowViewGroup fakeWindowViewGroup = this.f14273a;
        ...
        public WindowManager getWindowManager() {
            Class<WindowManager> cls = WindowManager.class;
            return (WindowManager) Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, this);
        }
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            ...
            switch (name2.hashCode()) {
                case -1148522778:
                    if (name2.equals("addView")) {
                        c11 = 0;
                        break;
                    }
                    break;
                case 542766184:
                    if (name2.equals("removeViewImmediate")) {
                        c11 = 1;
                        break;
                    }
                    break;
                case 931413976:
                    if (name2.equals("updateViewLayout")) {
                        c11 = 2;
                        break;
                    }
                    break;
                case 1098630473:
                    if (name2.equals("removeView")) {
                        c11 = 3;
                        break;
                    }
                    break;
    ...
    public SingleViewPresentation(Context context, Display display, PlatformView platformView, AccessibilityEventsDelegate accessibilityEventsDelegate2, int i11, View.OnFocusChangeListener onFocusChangeListener) {
        ...
        getWindow().setType(RequestPermissionActivity.REQUEST_MEDIA_PROJECTION_PERMISSION);
    }
