...
public class PlatformViewsController implements PlatformViewsAccessibilityDelegate {
    ...
    public final HashMap<Integer, VirtualDisplayController> f14270a = new HashMap<>();
    /* access modifiers changed from: private */
    ...
    public final HashMap<Context, View> f14271b = new HashMap<>();
    private final PlatformViewsChannel.PlatformViewsHandler channelHandler = new PlatformViewsChannel.PlatformViewsHandler() {
        ...
        @TargetApi(23)
        private long configureForTextureLayerComposition(@NonNull PlatformView platformView, @NonNull PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
            long j11;
            ...
            int u11 = PlatformViewsController.this.toPhysicalPixels(platformViewCreationRequest.logicalWidth);
            int u12 = PlatformViewsController.this.toPhysicalPixels(platformViewCreationRequest.logicalHeight);
            ...
            platformViewWrapper.setBufferSize(u11, u12);
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(u11, u12);
            int u13 = PlatformViewsController.this.toPhysicalPixels(platformViewCreationRequest.logicalTop);
            int u14 = PlatformViewsController.this.toPhysicalPixels(platformViewCreationRequest.logicalLeft);
            layoutParams.topMargin = u13;
            layoutParams.leftMargin = u14;
            platformViewWrapper.setLayoutParams(layoutParams);
            View view = platformView.getView();
            view.setLayoutParams(new FrameLayout.LayoutParams(u11, u12));
        ...
        private long configureForVirtualDisplay(@NonNull PlatformView platformView, @NonNull PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        @TargetApi(19)
        private PlatformView createPlatformView(@NonNull PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest, boolean z11) {
            Object obj;
            Context context;
            PlatformViewFactory a11 = PlatformViewsController.this.registry.a(platformViewCreationRequest.viewType);
            if (a11 != null) {
                if (platformViewCreationRequest.params != null) {
                    obj = a11.getCreateArgsCodec().decodeMessage(platformViewCreationRequest.params);
                } else {
                    obj = null;
                }
                if (z11) {
                ...
                PlatformView create = a11.create(context, platformViewCreationRequest.viewId, obj);
        ...
        public void clearFocus(int i11) {
            ...
            if (PlatformViewsController.this.usesVirtualDisplay(i11)) {
                view = PlatformViewsController.this.f14270a.get(Integer.valueOf(i11)).getView();
            } else {
        ...
        public void dispose(int i11) {
            ...
            if (PlatformViewsController.this.usesVirtualDisplay(i11)) {
                View view = PlatformViewsController.this.f14270a.get(Integer.valueOf(i11)).getView();
                if (view != null) {
                    PlatformViewsController.this.f14271b.remove(view.getContext());
                }
                PlatformViewsController.this.f14270a.remove(Integer.valueOf(i11));
                return;
            }
        ...
        public void offset(int i11, double d11, double d12) {
            if (!PlatformViewsController.this.usesVirtualDisplay(i11)) {
                ...
                int u11 = PlatformViewsController.this.toPhysicalPixels(d11);
                int u12 = PlatformViewsController.this.toPhysicalPixels(d12);
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) platformViewWrapper.getLayoutParams();
                layoutParams.topMargin = u11;
                layoutParams.leftMargin = u12;
                platformViewWrapper.setLayoutParams(layoutParams);
            }
        }
        ...
        public void onTouch(@NonNull PlatformViewsChannel.PlatformViewTouch platformViewTouch) {
            ...
            if (PlatformViewsController.this.usesVirtualDisplay(i11)) {
                PlatformViewsController.this.f14270a.get(Integer.valueOf(i11)).dispatchTouchEvent(PlatformViewsController.this.toMotionEvent(f11, platformViewTouch, true));
                return;
            }
            PlatformView platformView = (PlatformView) PlatformViewsController.this.platformViews.get(i11);
            if (platformView == null) {
        ...
        public void resize(@NonNull PlatformViewsChannel.PlatformViewResizeRequest platformViewResizeRequest, @NonNull PlatformViewsChannel.PlatformViewBufferResized platformViewBufferResized) {
            int u11 = PlatformViewsController.this.toPhysicalPixels(platformViewResizeRequest.newLogicalWidth);
            int u12 = PlatformViewsController.this.toPhysicalPixels(platformViewResizeRequest.newLogicalHeight);
            int i11 = platformViewResizeRequest.viewId;
            if (PlatformViewsController.this.usesVirtualDisplay(i11)) {
                float v11 = PlatformViewsController.this.getDisplayDensity();
                VirtualDisplayController virtualDisplayController = PlatformViewsController.this.f14270a.get(Integer.valueOf(i11));
                PlatformViewsController.this.lockInputConnection(virtualDisplayController);
                virtualDisplayController.resize(u11, u12, new c(this, virtualDisplayController, v11, platformViewBufferResized));
                return;
            }
            PlatformView platformView = (PlatformView) PlatformViewsController.this.platformViews.get(i11);
            PlatformViewWrapper platformViewWrapper = (PlatformViewWrapper) PlatformViewsController.this.viewWrappers.get(i11);
            ...
            if (u11 > platformViewWrapper.getBufferWidth() || u12 > platformViewWrapper.getBufferHeight()) {
                platformViewWrapper.setBufferSize(u11, u12);
            }
    ...
    public boolean checkInputConnectionProxy(@Nullable View view) {
        if (view == null || !this.f14271b.containsKey(view.getContext())) {
            return false;
        }
        View view2 = this.f14271b.get(view.getContext());
        if (view2 == view) {
            return true;
        }
    ...
    public void detachAccessibilityBridge() {
        this.accessibilityEventsDelegate.a((AccessibilityBridge) null);
    }
    ...
    public View getPlatformViewById(int i11) {
        if (usesVirtualDisplay(i11)) {
            return this.f14270a.get(Integer.valueOf(i11)).getView();
        }
    ...
    public void onDisplayPlatformView(int i11, int i12, int i13, int i14, int i15, int i16, int i17, @NonNull FlutterMutatorsStack flutterMutatorsStack) {
        initializeRootImageViewIfNeeded();
        x(i11);
    ...
    public void onEndFrame() {
        ...
        this.flutterViewConvertedToImageView = false;
        this.flutterView.revertImageView(new e(this));
    }
    ...
    public boolean usesVirtualDisplay(int i11) {
        return this.f14270a.containsKey(Integer.valueOf(i11));
    }
    ...
    public void x(int i11) {
        ...
        if (platformView == null) {
            ...
            if (view == null) {
                ...
                flutterMutatorView.setOnDescendantFocusChangeListener(new d(this, i11));
