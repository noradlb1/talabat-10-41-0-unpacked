...
public class PlatformPlugin {
    ...
    public final PlatformChannel.PlatformMessageHandler f14257a;
    ...
    public static /* synthetic */ class AnonymousClass3 {
        ...
        public static final /* synthetic */ int[] f14262b;

        /* renamed from: c  reason: collision with root package name */
        public static final /* synthetic */ int[] f14263c;
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f14263c     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r2 = f14262b     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0049:
                int[] r1 = f14261a     // Catch:{ NoSuchFieldError -> 0x0053 }
            ...
            L_0x0053:
                int[] r0 = f14261a     // Catch:{ NoSuchFieldError -> 0x005e }
            ...
            L_0x005e:
                int[] r0 = f14261a     // Catch:{ NoSuchFieldError -> 0x0069 }
            ...
            L_0x0069:
                int[] r0 = f14261a     // Catch:{ NoSuchFieldError -> 0x0074 }
    ...
    public void setSystemChromeEnabledSystemUIOverlays(List<PlatformChannel.SystemUiOverlay> list) {
        ...
        for (int i12 = 0; i12 < list.size(); i12++) {
            int i13 = AnonymousClass3.f14262b[list.get(i12).ordinal()];
            if (i13 == 1) {
                i11 &= -5;
            } else if (i13 == 2) {
                i11 = i11 & -513 & -3;
    ...
    public void setSystemChromeSystemUIOverlayStyle(PlatformChannel.SystemChromeStyle systemChromeStyle) {
        ...
        if (brightness != null) {
            int i12 = AnonymousClass3.f14263c[brightness.ordinal()];
            if (i12 == 1) {
        ...
        if (i11 >= 26) {
            ...
            if (brightness2 != null) {
                int i13 = AnonymousClass3.f14263c[brightness2.ordinal()];
                if (i13 == 1) {
    ...
    @VisibleForTesting
    public void n(@NonNull PlatformChannel.HapticFeedbackType hapticFeedbackType) {
        View decorView = this.activity.getWindow().getDecorView();
        int i11 = AnonymousClass3.f14261a[hapticFeedbackType.ordinal()];
        if (i11 == 1) {
    ...
    public PlatformPlugin(@NonNull Activity activity2, @NonNull PlatformChannel platformChannel2, @NonNull PlatformPluginDelegate platformPluginDelegate2) {
        AnonymousClass1 r02 = new PlatformChannel.PlatformMessageHandler() {
            ...
            public void vibrateHapticFeedback(@NonNull PlatformChannel.HapticFeedbackType hapticFeedbackType) {
                PlatformPlugin.this.n(hapticFeedbackType);
            }
        };
        this.f14257a = r02;
