...
public final class EventChannel {
    ...
    public final String f14233name;
    @Nullable
    ...
    public final class IncomingStreamRequestHandler implements BinaryMessenger.BinaryMessageHandler {
        ...
        public final class EventSinkImplementation implements EventSink {
            ...
            public final AtomicBoolean f14235a;

            private EventSinkImplementation() {
                this.f14235a = new AtomicBoolean(false);
            }

            @UiThread
            public void endOfStream() {
                if (!this.f14235a.getAndSet(true) && IncomingStreamRequestHandler.this.activeSink.get() == this) {
                    EventChannel.this.messenger.send(EventChannel.this.f14233name, (ByteBuffer) null);
                }
            }

            @UiThread
            public void error(String str, String str2, Object obj) {
                if (!this.f14235a.get() && IncomingStreamRequestHandler.this.activeSink.get() == this) {
                    EventChannel.this.messenger.send(EventChannel.this.f14233name, EventChannel.this.codec.encodeErrorEnvelope(str, str2, obj));
                }
            }
            ...
            public void success(Object obj) {
                if (!this.f14235a.get() && IncomingStreamRequestHandler.this.activeSink.get() == this) {
                    EventChannel.this.messenger.send(EventChannel.this.f14233name, EventChannel.this.codec.encodeSuccessEnvelope(obj));
                }
            }
        }
        ...
        private void onCancel(Object obj, BinaryMessenger.BinaryReply binaryReply) {
            if (this.activeSink.getAndSet((Object) null) != null) {
                try {
                    ...
                    Log.e(EventChannel.TAG + EventChannel.this.f14233name, "Failed to close event stream", e11);
        ...
        private void onListen(Object obj, BinaryMessenger.BinaryReply binaryReply) {
            ...
            if (this.activeSink.getAndSet(eventSinkImplementation) != null) {
                try {
                    ...
                    Log.e(EventChannel.TAG + EventChannel.this.f14233name, "Failed to close existing event stream", e11);
                }
            }
            try {
                ...
                Log.e(EventChannel.TAG + EventChannel.this.f14233name, "Failed to open event stream", e12);
