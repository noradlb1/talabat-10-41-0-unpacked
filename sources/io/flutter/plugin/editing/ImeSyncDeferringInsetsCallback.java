...
class ImeSyncDeferringInsetsCallback {
    ...
    public class AnimationCallback extends WindowInsetsAnimation.Callback {
        ...
        public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
            if (ImeSyncDeferringInsetsCallback.this.animating && !ImeSyncDeferringInsetsCallback.this.needsSave) {
                boolean z11 = false;
                for (WindowInsetsAnimation a11 : list) {
                    if ((a11.getTypeMask() & ImeSyncDeferringInsetsCallback.this.deferredInsetTypes) != 0) {
                        z11 = true;
                    }
                }
                if (!z11) {
                ...
                WindowInsets.Builder unused = builder.setInsets(ImeSyncDeferringInsetsCallback.this.deferredInsetTypes, Insets.of(0, 0, 0, Math.max(windowInsets.getInsets(ImeSyncDeferringInsetsCallback.this.deferredInsetTypes).bottom - windowInsets.getInsets(ImeSyncDeferringInsetsCallback.this.overlayInsetTypes).bottom, 0)));
    ...
    public ImeSyncDeferringInsetsCallback(@NonNull View view2, int i11, int i12) {
