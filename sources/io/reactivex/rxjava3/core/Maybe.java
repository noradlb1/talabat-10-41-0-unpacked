...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Maybe<T> error(@NonNull Throwable th2) {
    ...
    public static <T> Maybe<T> fromOptional(@NonNull Optional<T> optional) {
        ...
        return (Maybe) optional.map(new d()).orElseGet(new e());
    }
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Maybe<T> just(T t11) {
        Objects.requireNonNull(t11, "item is null");
        return RxJavaPlugins.onAssembly(new MaybeJust(t11));
    }
    ...
    @NonNull
    @CheckReturnValue
    public static Maybe<Long> timer(long j11, @NonNull TimeUnit timeUnit) {
    ...
    @NonNull
    @CheckReturnValue
    public final Single<T> defaultIfEmpty(@NonNull T t11) {
        Objects.requireNonNull(t11, "defaultItem is null");
        return RxJavaPlugins.onAssembly(new MaybeToSingle(this, t11));
    }

    @SchedulerSupport("io.reactivex:computation")
    @NonNull
    @CheckReturnValue
    public final Maybe<T> delay(long j11, @NonNull TimeUnit timeUnit) {
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> onErrorReturnItem(@NonNull T t11) {
        Objects.requireNonNull(t11, "item is null");
    ...
    @NonNull
    @CheckReturnValue
    public final <E extends MaybeObserver<? super T>> E subscribeWith(E e11) {
        subscribe(e11);
        return e11;
    }
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> timeout(long j11, @NonNull TimeUnit timeUnit) {
        return timeout(j11, timeUnit, Schedulers.computation());
    }
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Flowable<T> concatEager(@NonNull Iterable<? extends MaybeSource<? extends T>> iterable, int i11) {
        return Flowable.fromIterable(iterable).concatMapEagerDelayError(MaybeToPublisher.instance(), false, i11, 1);
    }
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Flowable<T> concatEagerDelayError(@NonNull Iterable<? extends MaybeSource<? extends T>> iterable, int i11) {
        return Flowable.fromIterable(iterable).concatMapEagerDelayError(MaybeToPublisher.instance(), true, i11, 1);
    }
    ...
    @NonNull
    @CheckReturnValue
    public static Maybe<Long> timer(long j11, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        Objects.requireNonNull(timeUnit, "unit is null");
        Objects.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new MaybeTimer(Math.max(0, j11), timeUnit, scheduler));
    }

    @SchedulerSupport("none")
    @NonNull
    @CheckReturnValue
    public static <T, D> Maybe<T> using(@NonNull Supplier<? extends D> supplier, @NonNull Function<? super D, ? extends MaybeSource<? extends T>> function, @NonNull Consumer<? super D> consumer, boolean z11) {
        ...
        return RxJavaPlugins.onAssembly(new MaybeUsing(supplier, function, consumer, z11));
    }
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> delay(long j11, @NonNull TimeUnit timeUnit, boolean z11) {
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> timeout(long j11, @NonNull TimeUnit timeUnit, @NonNull MaybeSource<? extends T> maybeSource) {
        Objects.requireNonNull(maybeSource, "fallback is null");
        return timeout(j11, timeUnit, Schedulers.computation(), maybeSource);
    }
    ...
    @NonNull
    @CheckReturnValue
    public final CompletionStage<T> toCompletionStage(@Nullable T t11) {
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Flowable<T> concatDelayError(@NonNull Publisher<? extends MaybeSource<? extends T>> publisher, int i11) {
        return Flowable.fromPublisher(publisher).concatMapMaybeDelayError(Functions.identity(), true, i11);
    }
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Maybe<T> fromFuture(@NonNull Future<? extends T> future, long j11, @NonNull TimeUnit timeUnit) {
        Objects.requireNonNull(future, "future is null");
        Objects.requireNonNull(timeUnit, "unit is null");
        return RxJavaPlugins.onAssembly(new MaybeFromFuture(future, j11, timeUnit));
    }
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Flowable<T> merge(@NonNull Publisher<? extends MaybeSource<? extends T>> publisher, int i11) {
        Objects.requireNonNull(publisher, "sources is null");
        ObjectHelper.verifyPositive(i11, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapMaybePublisher(publisher, Functions.identity(), false, i11));
    }
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Flowable<T> mergeDelayError(@NonNull Publisher<? extends MaybeSource<? extends T>> publisher, int i11) {
        Objects.requireNonNull(publisher, "sources is null");
        ObjectHelper.verifyPositive(i11, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapMaybePublisher(publisher, Functions.identity(), true, i11));
    }
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> delay(long j11, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> delaySubscription(long j11, @NonNull TimeUnit timeUnit) {
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> retry(long j11) {
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Flowable<T> concatEager(@NonNull Publisher<? extends MaybeSource<? extends T>> publisher, int i11) {
        return Flowable.fromPublisher(publisher).concatMapEager(MaybeToPublisher.instance(), i11, 1);
    }
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Flowable<T> concatEagerDelayError(@NonNull Publisher<? extends MaybeSource<? extends T>> publisher, int i11) {
        return Flowable.fromPublisher(publisher).concatMapEagerDelayError(MaybeToPublisher.instance(), true, i11, 1);
    }
    ...
    @NonNull
    @CheckReturnValue
    public final T blockingGet(@NonNull T t11) {
        Objects.requireNonNull(t11, "defaultValue is null");
        BlockingMultiObserver blockingMultiObserver = new BlockingMultiObserver();
        subscribe(blockingMultiObserver);
        return blockingMultiObserver.blockingGet(t11);
    }
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> delay(long j11, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler, boolean z11) {
        Objects.requireNonNull(timeUnit, "unit is null");
        Objects.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new MaybeDelay(this, Math.max(0, j11), timeUnit, scheduler, z11));
    }

    @SchedulerSupport("custom")
    @NonNull
    @CheckReturnValue
    public final Maybe<T> delaySubscription(long j11, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        return delaySubscription(Flowable.timer(j11, timeUnit, scheduler));
    }

    @SchedulerSupport("none")
    @NonNull
    @CheckReturnValue
    public final Maybe<T> retry(long j11, @NonNull Predicate<? super Throwable> predicate) {
        return toFlowable().retry(j11, predicate).singleElement();
    }
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> timeout(long j11, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler, @NonNull MaybeSource<? extends T> maybeSource) {
        Objects.requireNonNull(maybeSource, "fallback is null");
        return timeout(timer(j11, timeUnit, scheduler), maybeSource);
    }
    ...
    @NonNull
    @CheckReturnValue
    public final Maybe<T> timeout(long j11, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        return timeout(timer(j11, timeUnit, scheduler));
    }
    ...
    @NonNull
    @CheckReturnValue
    public static <T> Flowable<T> concat(@NonNull Publisher<? extends MaybeSource<? extends T>> publisher, int i11) {
        Objects.requireNonNull(publisher, "sources is null");
        ObjectHelper.verifyPositive(i11, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapMaybePublisher(publisher, Functions.identity(), ErrorMode.IMMEDIATE, i11));
    }
