...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static Maybe<Long> timer(long j11, TimeUnit timeUnit) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public final Maybe<T> defaultIfEmpty(T t11) {
    ...
    @CheckReturnValue
    @SchedulerSupport("io.reactivex:computation")
    public final Maybe<T> delay(long j11, TimeUnit timeUnit) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public final Maybe<T> onErrorReturnItem(T t11) {
        ObjectHelper.requireNonNull(t11, "item is null");
    ...
    @CheckReturnValue
    @SchedulerSupport("io.reactivex:computation")
    public final Maybe<T> timeout(long j11, TimeUnit timeUnit) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public final Single<T> toSingle(T t11) {
    ...
    @NonNull
    @SchedulerSupport("custom")
    public static Maybe<Long> timer(long j11, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T, D> Maybe<T> using(Callable<? extends D> callable, Function<? super D, ? extends MaybeSource<? extends T>> function, Consumer<? super D> consumer, boolean z11) {
        ObjectHelper.requireNonNull(callable, "resourceSupplier is null");
        ObjectHelper.requireNonNull(function, "sourceSupplier is null");
        ObjectHelper.requireNonNull(consumer, "disposer is null");
        return RxJavaPlugins.onAssembly(new MaybeUsing(callable, function, consumer, z11));
    }

    @CheckReturnValue
    @NonNull
    @SchedulerSupport("custom")
    public final Maybe<T> delay(long j11, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new MaybeDelay(this, Math.max(0, j11), timeUnit, scheduler));
    }
    ...
    @NonNull
    @SchedulerSupport("io.reactivex:computation")
    public final Maybe<T> timeout(long j11, TimeUnit timeUnit, MaybeSource<? extends T> maybeSource) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Maybe<T> fromFuture(Future<? extends T> future, long j11, TimeUnit timeUnit) {
        ObjectHelper.requireNonNull(future, "future is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Flowable<T> merge(Publisher<? extends MaybeSource<? extends T>> publisher, int i11) {
        ObjectHelper.requireNonNull(publisher, "source is null");
        ObjectHelper.verifyPositive(i11, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(publisher, MaybeToPublisher.instance(), false, i11, 1));
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Flowable<T> mergeDelayError(Publisher<? extends MaybeSource<? extends T>> publisher, int i11) {
        ObjectHelper.requireNonNull(publisher, "source is null");
        ObjectHelper.verifyPositive(i11, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(publisher, MaybeToPublisher.instance(), true, i11, 1));
    }

    @CheckReturnValue
    @SchedulerSupport("io.reactivex:computation")
    public final Maybe<T> delaySubscription(long j11, TimeUnit timeUnit) {
    ...
    @CheckReturnValue
    @SchedulerSupport("custom")
    public final Maybe<T> delaySubscription(long j11, TimeUnit timeUnit, Scheduler scheduler) {
        return delaySubscription(Flowable.timer(j11, timeUnit, scheduler));
    }

    @CheckReturnValue
    @SchedulerSupport("none")
    public final Maybe<T> retry(long j11, Predicate<? super Throwable> predicate) {
    ...
    @NonNull
    @SchedulerSupport("custom")
    public final Maybe<T> timeout(long j11, TimeUnit timeUnit, Scheduler scheduler, MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(maybeSource, "fallback is null");
    ...
    @CheckReturnValue
    @SchedulerSupport("custom")
    public final Maybe<T> timeout(long j11, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Flowable<T> concat(Publisher<? extends MaybeSource<? extends T>> publisher, int i11) {
        ObjectHelper.requireNonNull(publisher, "sources is null");
        ObjectHelper.verifyPositive(i11, "prefetch");
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(publisher, MaybeToPublisher.instance(), i11, ErrorMode.IMMEDIATE));
    }
