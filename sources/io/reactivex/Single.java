...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T, U> Single<T> using(Callable<U> callable, Function<? super U, ? extends SingleSource<? extends T>> function, Consumer<? super U> consumer, boolean z11) {
        ObjectHelper.requireNonNull(callable, "resourceSupplier is null");
        ObjectHelper.requireNonNull(function, "singleFunction is null");
        ObjectHelper.requireNonNull(consumer, "disposer is null");
        return RxJavaPlugins.onAssembly(new SingleUsing(callable, function, consumer, z11));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("custom")
    public static <T> Single<T> fromFuture(Future<? extends T> future, long j11, TimeUnit timeUnit, Scheduler scheduler) {
        return toSingle(Flowable.fromFuture(future, j11, timeUnit, scheduler));
    }
    ...
    public static <T> Flowable<T> concat(Publisher<? extends SingleSource<? extends T>> publisher, int i11) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(publisher, SingleInternalHelper.toFlowable(), i11, ErrorMode.IMMEDIATE));
    }
