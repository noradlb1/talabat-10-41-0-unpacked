...
public final class RxJavaPlugins {
    ...
    @NonNull
    public static <T, R> R apply(@NonNull Function<T, R> function, @NonNull T t11) {
        try {
    ...
    @NonNull
    public static <T, U, R> R apply(@NonNull BiFunction<T, U, R> biFunction, @NonNull T t11, @NonNull U u11) {
        try {
