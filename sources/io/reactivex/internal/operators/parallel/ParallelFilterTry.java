...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    public final ParallelFlowable<T> f18078a;

    /* renamed from: b  reason: collision with root package name */
    public final Predicate<? super T> f18079b;

    /* renamed from: c  reason: collision with root package name */
    public final BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> f18080c;
    ...
    public static abstract class BaseFilterSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        /* renamed from: b  reason: collision with root package name */
        public final Predicate<? super T> f18082b;

        /* renamed from: c  reason: collision with root package name */
        public final BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> f18083c;

        /* renamed from: d  reason: collision with root package name */
        public Subscription f18084d;
        ...
        public BaseFilterSubscriber(Predicate<? super T> predicate, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
            this.f18082b = predicate;
            this.f18083c = biFunction;
        }
        ...
        public final void onNext(T t11) {
            if (!tryOnNext(t11) && !this.f18085e) {
                this.f18084d.request(1);
            }
        }

        public final void request(long j11) {
            this.f18084d.request(j11);
        }
    }
    ...
    public static final class ParallelFilterConditionalSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public final ConditionalSubscriber<? super T> f18086f;
        ...
        public ParallelFilterConditionalSubscriber(ConditionalSubscriber<? super T> conditionalSubscriber, Predicate<? super T> predicate, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
            ...
            this.f18086f = conditionalSubscriber;
        }
        ...
        public void onError(Throwable th2) {
            ...
            this.f18085e = true;
            this.f18086f.onError(th2);
        }

        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f18084d, subscription)) {
                this.f18084d = subscription;
        ...
        public boolean tryOnNext(T r10) {
            /*
                r9 = this;
                boolean r0 = r9.f18085e
                r1 = 0
                if (r0 != 0) goto L_0x0066
                r2 = 0
            L_0x0007:
                r0 = 1
                io.reactivex.functions.Predicate<? super T> r4 = r9.f18082b     // Catch:{ all -> 0x001a }
                boolean r2 = r4.test(r10)     // Catch:{ all -> 0x001a }
                if (r2 == 0) goto L_0x0019
                io.reactivex.internal.fuseable.ConditionalSubscriber<? super T> r2 = r9.f18086f
            ...
            L_0x001a:
                ...
                r5 = 2
                io.reactivex.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.parallel.ParallelFailureHandling> r6 = r9.f18083c     // Catch:{ all -> 0x0051 }
                r7 = 1
                long r2 = r2 + r7
                ...
                int[] r7 = io.reactivex.internal.operators.parallel.ParallelFilterTry.AnonymousClass1.f18081a
                int r6 = r6.ordinal()
                r6 = r7[r6]
    ...
    public static final class ParallelFilterSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final Subscriber<? super T> f18087f;
        ...
        public ParallelFilterSubscriber(Subscriber<? super T> subscriber, Predicate<? super T> predicate, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
            super(predicate, biFunction);
            this.f18087f = subscriber;
        }

        public void onComplete() {
            if (!this.f18085e) {
                this.f18085e = true;
                this.f18087f.onComplete();
            }
        }
        ...
        public void onError(Throwable th2) {
            ...
            this.f18085e = true;
            this.f18087f.onError(th2);
        }

        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f18084d, subscription)) {
                this.f18084d = subscription;
                this.f18087f.onSubscribe(this);
            }
        }
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0007:
                r0 = 1
                io.reactivex.functions.Predicate<? super T> r4 = r9.f18082b     // Catch:{ all -> 0x0017 }
                boolean r2 = r4.test(r10)     // Catch:{ all -> 0x0017 }
                if (r2 == 0) goto L_0x0016
                org.reactivestreams.Subscriber<? super T> r1 = r9.f18087f
                r1.onNext(r10)
                return r0
            L_0x0016:
                return r1
            L_0x0017:
                ...
                io.reactivex.exceptions.Exceptions.throwIfFatal(r4)
                r5 = 2
                io.reactivex.functions.BiFunction<? super java.lang.Long, ? super java.lang.Throwable, io.reactivex.parallel.ParallelFailureHandling> r6 = r9.f18083c     // Catch:{ all -> 0x004e }
                r7 = 1
                long r2 = r2 + r7
    ...
    public ParallelFilterTry(ParallelFlowable<T> parallelFlowable, Predicate<? super T> predicate, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
        this.f18078a = parallelFlowable;
        this.f18079b = predicate;
        this.f18080c = biFunction;
    }

    public int parallelism() {
        return this.f18078a.parallelism();
    }
        ...
        if (a(subscriberArr)) {
            ...
            for (int i11 = 0; i11 < length; i11++) {
                ...
                if (conditionalSubscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i11] = new ParallelFilterConditionalSubscriber(conditionalSubscriber, this.f18079b, this.f18080c);
                } else {
                    subscriberArr2[i11] = new ParallelFilterSubscriber(conditionalSubscriber, this.f18079b, this.f18080c);
                }
            }
            this.f18078a.subscribe(subscriberArr2);
        }
    }
}
