...
public final class ObservablePublishAlt<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, ResettableConnectable {
    ...
    public final ObservableSource<T> f17471b;

    /* renamed from: c  reason: collision with root package name */
    public final AtomicReference<PublishConnection<T>> f17472c = new AtomicReference<>();
    ...
    public static final class PublishConnection<T> extends AtomicReference<InnerDisposable<T>[]> implements Observer<T>, Disposable {
        ...
        public static final InnerDisposable[] f17474f = new InnerDisposable[0];

        /* renamed from: g  reason: collision with root package name */
        public static final InnerDisposable[] f17475g = new InnerDisposable[0];
        private static final long serialVersionUID = -3251430252873581268L;

        /* renamed from: b  reason: collision with root package name */
        public final AtomicBoolean f17476b = new AtomicBoolean();

        /* renamed from: c  reason: collision with root package name */
        public final AtomicReference<PublishConnection<T>> f17477c;

        /* renamed from: d  reason: collision with root package name */
        public final AtomicReference<Disposable> f17478d;

        /* renamed from: e  reason: collision with root package name */
        public Throwable f17479e;

        public PublishConnection(AtomicReference<PublishConnection<T>> atomicReference) {
            this.f17477c = atomicReference;
        ...
        public void dispose() {
            getAndSet(f17475g);
            b.a(this.f17477c, this, (Object) null);
            DisposableHelper.dispose(this.f17478d);
        }
        ...
        public void onComplete() {
            this.f17478d.lazySet(DisposableHelper.DISPOSED);
            for (InnerDisposable innerDisposable : (InnerDisposable[]) getAndSet(f17475g)) {
                innerDisposable.f17473b.onComplete();
            }
        }
        ...
        public void onError(Throwable th2) {
            ...
            this.f17478d.lazySet(DisposableHelper.DISPOSED);
            for (InnerDisposable innerDisposable : (InnerDisposable[]) getAndSet(f17475g)) {
                innerDisposable.f17473b.onError(th2);
            }
        }

        public void onNext(T t11) {
            for (InnerDisposable innerDisposable : (InnerDisposable[]) get()) {
                innerDisposable.f17473b.onNext(t11);
            }
        }

        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f17478d, disposable);
        }
    ...
    public void connect(io.reactivex.functions.Consumer<? super io.reactivex.disposables.Disposable> r5) {
        /*
            r4 = this;
        L_0x0000:
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublishAlt$PublishConnection<T>> r0 = r4.f17472c
        ...
        L_0x0010:
            ...
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublishAlt$PublishConnection<T>> r2 = r4.f17472c
            r1.<init>(r2)
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublishAlt$PublishConnection<T>> r2 = r4.f17472c
        ...
        L_0x0020:
            r0 = r1
        L_0x0021:
            java.util.concurrent.atomic.AtomicBoolean r1 = r0.f17476b
            boolean r1 = r1.get()
            r2 = 0
        ...
        L_0x0034:
            ...
            io.reactivex.ObservableSource<T> r5 = r4.f17471b
            r5.subscribe(r0)
        L_0x003e:
            return
        L_0x003f:
    ...
    public void resetIf(Disposable disposable) {
        b.a(this.f17472c, (PublishConnection) disposable, (Object) null);
    }
    ...
    public void subscribeActual(io.reactivex.Observer<? super T> r4) {
        /*
            r3 = this;
        L_0x0000:
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublishAlt$PublishConnection<T>> r0 = r3.f17472c
            java.lang.Object r0 = r0.get()
            io.reactivex.internal.operators.observable.ObservablePublishAlt$PublishConnection r0 = (io.reactivex.internal.operators.observable.ObservablePublishAlt.PublishConnection) r0
            if (r0 != 0) goto L_0x001b
            io.reactivex.internal.operators.observable.ObservablePublishAlt$PublishConnection r1 = new io.reactivex.internal.operators.observable.ObservablePublishAlt$PublishConnection
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublishAlt$PublishConnection<T>> r2 = r3.f17472c
            r1.<init>(r2)
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublishAlt$PublishConnection<T>> r2 = r3.f17472c
            boolean r0 = i.b.a(r2, r0, r1)
        ...
        L_0x0032:
            return
        L_0x0033:
            java.lang.Throwable r0 = r0.f17479e
